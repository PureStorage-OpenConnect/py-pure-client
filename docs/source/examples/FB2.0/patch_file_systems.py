from pypureclient.flashblade import FileSystemPatch, NfsPatch, Http, Smb, MultiProtocol
...
# change access control style to independent and disable safeguard acls
...
new_attr = FileSystemPatch(provisioned=1024, hard_limit_enabled=True,
                           ...
                           http=Http(enabled=False), smb=Smb(enabled=True),
