...
REQUIRES = ['urllib3 == 1.26.5', 'six >= 1.10, <= 1.15.0', 'certifi >= 14.05.14, <= 2020.12.5',
            'python-dateutil >= 2.5.3, <= 2.8.1', 'paramiko == 2.11.0',
            'PyJWT >= 2.0.0, <=2.4.0', 'requests >= 2.20.1, <= 2.25.1', 'typing >=3.7.4.1, <= 3.7.4.3']
...
setup(
    ...
    download_url='https://github.com/PureStorage-OpenConnect/py-pure-client/archive/1.31.0.tar.gz',
