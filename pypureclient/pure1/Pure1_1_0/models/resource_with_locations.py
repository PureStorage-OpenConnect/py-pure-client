...
class ResourceWithLocations(BaseModel):
    ...
    locations: Optional[List[FixedReference]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "locations": [FixedReference.from_dict(_item) for _item in obj["locations"]] if obj.get("locations") is not None else None
        })
        return _obj
