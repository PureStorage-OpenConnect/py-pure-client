...
class SubscriptionLicense(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_as_of", "id", "name", "average_on_demand", "expiration_date", "marketplace_partner", "reservation", "resources", "service_tier", "start_date", "subscription", "usage"]
