...
class Pod(BaseModel):
    ...
    arrays: Optional[Annotated[List[PodArrayStatus], Field(min_length=1)]] = Field(default=None, description="A list of arrays that share this pod. If two or more arrays are specified, all data in the pod is synchronously mirrored between them.")
    ...
    __properties: ClassVar[List[str]] = ["_as_of", "id", "name", "arrays", "mediator", "source"]
