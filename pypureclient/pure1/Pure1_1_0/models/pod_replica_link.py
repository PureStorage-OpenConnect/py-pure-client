...
class PodReplicaLink(BaseModel):
    ...
    members: Optional[List[ResourceWithLocations]] = Field(default=None, description="The union of source and target pods in the replica link.")
    sources: Optional[List[ResourceWithLocations]] = Field(default=None, description="The source pods in the replica link.")
    targets: Optional[List[ResourceWithLocations]] = Field(default=None, description="The target pods in the replica link.")
    __properties: ClassVar[List[str]] = ["_as_of", "id", "lag", "paused", "recovery_point", "status", "members", "sources", "targets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "members": [ResourceWithLocations.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
            "sources": [ResourceWithLocations.from_dict(_item) for _item in obj["sources"]] if obj.get("sources") is not None else None,
            "targets": [ResourceWithLocations.from_dict(_item) for _item in obj["targets"]] if obj.get("targets") is not None else None
        })
        return _obj
