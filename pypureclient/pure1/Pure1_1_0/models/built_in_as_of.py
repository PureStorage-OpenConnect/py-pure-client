...
class BuiltInAsOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BuiltInAsOf:
        """Create an instance of BuiltInAsOf from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> BuiltInAsOf:
        """Create an instance of BuiltInAsOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BuiltInAsOf.parse_obj(obj)

        _obj = BuiltInAsOf.construct(_fields_set=None, **{
