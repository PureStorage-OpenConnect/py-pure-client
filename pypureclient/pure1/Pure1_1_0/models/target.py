...
class Target(BaseModel):
    """
    An external target system.  # noqa: E501
    """
    ...
    status: Optional[StrictStr] = Field(default=None, description="Status of the connection. Values include `connected` and `connecting`.")
    ...
    __properties = ["_as_of", "id", "name", "arrays", "address", "status", "status_details"]
