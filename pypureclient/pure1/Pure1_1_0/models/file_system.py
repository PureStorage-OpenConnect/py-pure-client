...
from pypureclient.pure1.Pure1_1_0.models.http import Http
from pypureclient.pure1.Pure1_1_0.models.nfs import Nfs
from pypureclient.pure1.Pure1_1_0.models.smb import Smb
...
class FileSystem(BaseModel):
    ...
    arrays: Optional[conlist(FixedReference)] = Field(default=None, description="The list of arrays where this resource exists. Many resources are on a single array, but some resources, such as pods, can be shared across multiple arrays.")
    ...
    def from_dict(cls, obj: dict) -> FileSystem:
        ...
        _obj = FileSystem.construct(_fields_set=None, **{
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "arrays": [FixedReference.from_dict(_item) for _item in obj.get("arrays")] if obj.get("arrays") is not None else None,
