...
from pypureclient.pure1.Pure1_1_0.models.resource_with_location import ResourceWithLocation
...
class BucketReplicaLink(BaseModel):
    ...
    members: Optional[List[ResourceWithLocation]] = Field(default=None, description="The union of source and target buckets in the replica link.")
    sources: Optional[List[ResourceWithLocation]] = Field(default=None, description="The source buckets in the replica link.")
    targets: Optional[List[ResourceWithLocation]] = Field(default=None, description="The target buckets in the replica link.")
