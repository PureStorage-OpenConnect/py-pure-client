...
class Resource(BaseModel):
    """
    An ordinary (as opposed to built-in) resource that can be created, named, renamed, or deleted by the user. This might be a virtual resource (e.g., a volume), or correspond to something in the physical environment, like a host or a server.  # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Resource:
        ...
        _obj = Resource.construct(_fields_set=None, **{
