...
from pypureclient.pure1.Pure1_1_0.models.object_store_account_get_response import ObjectStoreAccountGetResponse
from typing import Optional
...
class ObjectStoreAccountsApi:
    ...
    def api10_object_store_accounts_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api10_object_store_accounts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
