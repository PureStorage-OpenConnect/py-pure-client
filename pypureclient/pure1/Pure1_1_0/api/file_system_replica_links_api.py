...
class FileSystemReplicaLinksApi:
    ...
    @validate_call
    def api10_file_system_replica_links_get_with_http_info(
        self,
        ...
        _param = self._api10_file_system_replica_links_get_serialize(
            ...
            offset = offset,
            sort = sort,
            source_ids = quote_strings(source_ids),
            source_names = quote_strings(source_names),
            target_ids = quote_strings(target_ids),
            target_names = quote_strings(target_names),
        )
    ...
    def _api10_file_system_replica_links_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        if target_ids is not None:
            ...
            _query_params.append(('target_ids', target_ids))
            
        if target_names is not None:
            
            _query_params.append(('target_names', target_names))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.0/file-system-replica-links',
    ...
    @validate_call
    def api10_file_system_replica_links_policies_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        _param = self._api10_file_system_replica_links_policies_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = quote_strings(continuation_token),
            filter = filter,
    ...
    def _api10_file_system_replica_links_policies_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.0/file-system-replica-links/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
