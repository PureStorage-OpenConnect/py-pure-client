    ...
    def api10_file_system_replica_links_get_with_http_info(
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api10_file_system_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('member_ids') is not None:  # noqa: E501
            _query_params.append(('member_ids', quote_string_parameter(_params['member_ids'])))
            _collection_formats['member_ids'] = 'csv'

        if _params.get('member_names') is not None:  # noqa: E501
            _query_params.append(('member_names', quote_string_parameter(_params['member_names'])))
        ...
        if _params.get('source_ids') is not None:  # noqa: E501
            _query_params.append(('source_ids', quote_string_parameter(_params['source_ids'])))
            _collection_formats['source_ids'] = 'csv'

        if _params.get('source_names') is not None:  # noqa: E501
            _query_params.append(('source_names', quote_string_parameter(_params['source_names'])))
            _collection_formats['source_names'] = 'csv'

        if _params.get('target_ids') is not None:  # noqa: E501
            _query_params.append(('target_ids', quote_string_parameter(_params['target_ids'])))
            _collection_formats['target_ids'] = 'csv'

        if _params.get('target_names') is not None:  # noqa: E501
            _query_params.append(('target_names', quote_string_parameter(_params['target_names'])))
            _collection_formats['target_names'] = 'csv'
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api10_file_system_replica_links_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('policy_ids') is not None:  # noqa: E501
            _query_params.append(('policy_ids', quote_string_parameter(_params['policy_ids'])))
            _collection_formats['policy_ids'] = 'csv'

        if _params.get('policy_names') is not None:  # noqa: E501
            _query_params.append(('policy_names', quote_string_parameter(_params['policy_names'])))
