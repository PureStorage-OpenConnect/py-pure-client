...
class MetricsApi:
    ...
    def api10_metrics_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api10_metrics_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, resource_types, sort, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: tuple(MetricGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api10_metrics_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('resource_types') is not None:  # noqa: E501
            _query_params.append(('resource_types', quote_strings(_params['resource_types'])))
            _collection_formats['resource_types'] = 'csv'
    ...
    def api10_metrics_history_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api10_metrics_history_get_with_http_info(aggregation, end_time, resolution, start_time, authorization, x_request_id, ids, names, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(MetricHistoryGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api10_metrics_history_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('aggregation') is not None:  # noqa: E501
            _query_params.append(('aggregation', quote_strings(_params['aggregation'])))
