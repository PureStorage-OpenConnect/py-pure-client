...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_0.models.metric_get_response import MetricGetResponse
from pypureclient.pure1.Pure1_1_0.models.metric_history_get_response import MetricHistoryGetResponse
from pypureclient.pure1.Pure1_1_0.api_client import ApiClient as _TransportApiClient, RequestSerialized
from pypureclient.pure1.Pure1_1_0.api_response import ApiResponse
from pypureclient.pure1.Pure1_1_0.rest import RESTResponseType
...
class MetricsApi:
    ...
    def api10_metrics_get_with_http_info(
        ...
        :type offset: int
        :param resource_types: The resource types to list the available metrics. Valid values are `arrays`, `buckets`, `directories`, `file-systems`, `pods`, `subscription-licenses` and `volumes`. A metric can belong to a combination of resources, e.g., write-iops from array to pod. In that case, query by ['arrays', 'pods']. Single quotes are required around all strings.
        ...
        _param = self._api10_metrics_get_serialize(
            ...
            offset = offset,
            resource_types = quote_strings(resource_types),
            sort = sort,
        )

        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MetricGetResponse",
            '400': "Error",
            '403': "ErrorNoContext",
            '404': "Error",
            '429': "ErrorNoContext",
    ...
    def _api10_metrics_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        if resource_types is not None:
            ...
            _query_params.append(('resource_types', resource_types))
    ...
    def api10_metrics_history_get_with_http_info(
        ...
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[MetricHistoryGetResponse]:
        """Get metrics history
        ...
        :param end_time: Timestamp of when the time window ends. Measured in milliseconds since the UNIX epoch. (required)
        :type end_time: int
        :param resolution: The duration of time between individual data points, in milliseconds. (required)
        :type resolution: int
        :param start_time: Timestamp of when the time window starts. Measured in milliseconds since the UNIX epoch. (required)
        :type start_time: int
        :param authorization: Access token (in JWT format) required to use any API endpoint (except `/oauth2`)
        :type authorization: str
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        :param ids: REQUIRED: either `ids` or `names`. A comma-separated list of object IDs. If there is not at least one resource that matches each `id` element, an error is returned. Single quotes are required around all strings.
        :type ids: List[str]
        :param names: REQUIRED: either `names` or `ids`. A comma-separated list of resource names. If there is not at least one resource that matches each `name` element, an error is returned. Single quotes are required around all strings.
        :type names: List[str]
        ...
        _param = self._api10_metrics_history_get_serialize(
            aggregation = quote_strings(aggregation),
            end_time = end_time,
    ...
    def _api10_metrics_history_get_serialize(
        self,
        aggregation,
        end_time,
        resolution,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.0/metrics/history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
