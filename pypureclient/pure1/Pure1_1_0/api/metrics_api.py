    ...
    def api10_metrics_get_with_http_info(
        ...
        **kwargs
        ...
        if _params.get('resource_types') is not None:  # noqa: E501
            _query_params.append(('resource_types', quote_string_parameter(_params['resource_types'])))
    ...
    def api10_metrics_history_get_with_http_info(
        ...
        **kwargs
        ...
        if _params.get('aggregation') is not None:  # noqa: E501
            _query_params.append(('aggregation', quote_string_parameter(_params['aggregation'])))
