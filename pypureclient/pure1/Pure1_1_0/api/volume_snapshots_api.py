...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_0.models.volume_snapshot_get_response import VolumeSnapshotGetResponse
...
class VolumeSnapshotsApi:
    ...
    @validate_call
    def api10_volume_snapshots_get_with_http_info(
        self,
        ...
        _param = self._api10_volume_snapshots_get_serialize(
    ...
    def _api10_volume_snapshots_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.0/volume-snapshots',
