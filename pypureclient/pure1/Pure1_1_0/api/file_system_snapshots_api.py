...
class FileSystemSnapshotsApi:
    ...
    def api10_file_system_snapshots_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api10_file_system_snapshots_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, source_ids, source_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api10_file_system_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api10_file_system_snapshots_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api10_file_system_snapshots_policies_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api10_file_system_snapshots_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
