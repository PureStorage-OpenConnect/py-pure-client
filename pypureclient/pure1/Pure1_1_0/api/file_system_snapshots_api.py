...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_0.models.file_system_snapshot_get_response import FileSystemSnapshotGetResponse
...
class FileSystemSnapshotsApi:
    ...
    def api10_file_system_snapshots_get_with_http_info(
        ...
        _param = self._api10_file_system_snapshots_get_serialize(
    ...
    def _api10_file_system_snapshots_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.0/file-system-snapshots',
    ...
    def api10_file_system_snapshots_policies_get_with_http_info(
        ...
        _param = self._api10_file_system_snapshots_policies_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = quote_strings(continuation_token),
            filter = filter,
    ...
    def _api10_file_system_snapshots_policies_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.0/file-system-snapshots/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
