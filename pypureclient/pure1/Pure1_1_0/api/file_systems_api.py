...
from pypureclient.pure1.Pure1_1_0.models.file_system_get_response import FileSystemGetResponse
...
class FileSystemsApi:
    ...
    def api10_file_systems_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api10_file_systems_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api10_file_systems_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api10_file_systems_policies_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api10_file_systems_policies_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api10_file_systems_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/1.0/file-systems/policies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
