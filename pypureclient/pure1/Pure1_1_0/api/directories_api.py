...
class DirectoriesApi:
    ...
    def api10_directories_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api10_directories_get_with_http_info(authorization, x_request_id, continuation_token, file_system_ids, file_system_names, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api10_directories_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
