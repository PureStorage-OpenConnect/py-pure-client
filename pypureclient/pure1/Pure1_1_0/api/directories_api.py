...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_0.models.directory_get_response import DirectoryGetResponse
...
class DirectoriesApi:
    ...
    def api10_directories_get_with_http_info(
        ...
        _param = self._api10_directories_get_serialize(
    ...
    def _api10_directories_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.0/directories',
