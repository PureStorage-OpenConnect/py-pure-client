...
class ArraysApi(object):
    ...
    def api10_arrays_tags_batch_put_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api10_arrays_tags_batch_put_with_http_info(error_unknown, async_req=True)
        >>> result = thread.get()
        ...
        if error_unknown is None:
            raise TypeError("Missing the required parameter `error_unknown` when calling `api10_arrays_tags_batch_put`")
