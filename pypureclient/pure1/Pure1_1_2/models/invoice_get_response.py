...
from pypureclient.pure1.Pure1_1_2.models.invoice import Invoice
...
class InvoiceGetResponse(BaseModel):
    ...
    items: Optional[conlist(Invoice)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvoiceGetResponse:
        """Create an instance of InvoiceGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> InvoiceGetResponse:
        """Create an instance of InvoiceGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvoiceGetResponse.parse_obj(obj)

        _obj = InvoiceGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [Invoice.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
