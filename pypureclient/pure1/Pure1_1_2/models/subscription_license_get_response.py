...
class SubscriptionLicenseGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        items=None,  # type: List[models.SubscriptionLicense]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `SubscriptionLicenseGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(SubscriptionLicenseGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubscriptionLicenseGetResponse):
            return False
