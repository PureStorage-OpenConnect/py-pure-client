...
from pypureclient.pure1.Pure1_1_2.models.invoice_line_component import InvoiceLineComponent
from pypureclient.pure1.Pure1_1_2.models.tax import Tax
...
class InvoiceLine(BaseModel):
    ...
    quantity: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The quantity of current invoice item.")
    ...
    components: Optional[List[InvoiceLineComponent]] = Field(default=None, description="The sub-components of current invoice item.")
    ...
    __properties: ClassVar[List[str]] = ["item", "quantity", "description", "start_date", "end_date", "components", "unit_price", "amount", "tax"]
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.components and (include_readonly or "components" not in excluded_fields):
            _items = []
        ...
        if self.tax and (include_readonly or "tax" not in excluded_fields):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "components": [InvoiceLineComponent.from_dict(_item) for _item in obj["components"]] if obj.get("components") is not None else None,
