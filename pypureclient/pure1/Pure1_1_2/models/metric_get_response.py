...
from pypureclient.pure1.Pure1_1_2.models.metric import Metric
...
class MetricGetResponse(BaseModel):
    ...
    items: Optional[conlist(Metric)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MetricGetResponse:
        """Create an instance of MetricGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> MetricGetResponse:
        """Create an instance of MetricGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MetricGetResponse.parse_obj(obj)

        _obj = MetricGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [Metric.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
