...
class CurrentMetric(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data", "metric", "unit"]
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.metric and (include_readonly or "metric" not in excluded_fields):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            "data": obj.get("data"),
            "metric": FixedReference.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
            "unit": obj.get("unit")
        })
        return _obj
