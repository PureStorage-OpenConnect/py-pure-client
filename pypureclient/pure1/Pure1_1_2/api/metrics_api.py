...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_2.models.metric_get_response import MetricGetResponse
from pypureclient.pure1.Pure1_1_2.models.metric_history_get_response import MetricHistoryGetResponse
...
class MetricsApi:
    ...
    def api12_metrics_get_with_http_info(
        ...
        _param = self._api12_metrics_get_serialize(
    ...
    def _api12_metrics_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api12_metrics_history_get_with_http_info(
        ...
        _param = self._api12_metrics_history_get_serialize(
    ...
    def _api12_metrics_history_get_serialize(
        self,
        aggregation,
        end_time,
        resolution,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.2/metrics/history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
