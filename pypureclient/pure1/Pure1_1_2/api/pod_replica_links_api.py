...
class PodReplicaLinksApi:
    ...
    @validate_call
    def api12_pod_replica_links_get_with_http_info(
        self,
        ...
        _param = self._api12_pod_replica_links_get_serialize(
    ...
    def _api12_pod_replica_links_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.2/pod-replica-links',
