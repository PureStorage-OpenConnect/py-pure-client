...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_2.models.sustainability_array_get_response import SustainabilityArrayGetResponse
from pypureclient.pure1.Pure1_1_2.models.sustainability_insight_array_get_response import SustainabilityInsightArrayGetResponse
...
class SustainabilityApi:
    ...
    @validate_call
    def api12_assessment_sustainability_arrays_get_with_http_info(
        self,
    ...
    ) -> ApiResponse[SustainabilityArrayGetResponse]:
        ...
        _param = self._api12_assessment_sustainability_arrays_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SustainabilityArrayGetResponse",
            '400': "Error",
            '403': "ErrorNoContext",
            '404': "Error",
            '429': "ErrorNoContext",
    ...
    def _api12_assessment_sustainability_arrays_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.2/assessment/sustainability/arrays',
    ...
    @validate_call
    def api12_assessment_sustainability_insights_arrays_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        sort: Annotated[Optional[List[Annotated[str, Field(strict=True)]]], Field(description="Sort the response by the specified fields (in descending order if '-' is appended to the field name). If you provide a sort you will not get a continuation token in the response.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[SustainabilityInsightArrayGetResponse]:
        ...
        _param = self._api12_assessment_sustainability_insights_arrays_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = quote_strings(continuation_token),
            filter = filter,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SustainabilityInsightArrayGetResponse",
            '400': "Error",
            '403': "ErrorNoContext",
            '404': "Error",
            '429': "ErrorNoContext",
    ...
    def _api12_assessment_sustainability_insights_arrays_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.2/assessment/sustainability/insights/arrays',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
