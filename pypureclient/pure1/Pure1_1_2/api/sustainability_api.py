    ...
    def api12_assessment_sustainability_arrays_get_with_http_info(
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api12_assessment_sustainability_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/1.2/assessment/sustainability/arrays', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api12_assessment_sustainability_insights_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/1.2/assessment/sustainability/insights/arrays', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
