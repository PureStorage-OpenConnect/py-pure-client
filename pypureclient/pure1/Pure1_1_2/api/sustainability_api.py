...
class SustainabilityApi(object):
    ...
    def api12_assessment_sustainability_arrays_get_with_http_info(
        ...
        >>> thread = api.api12_assessment_sustainability_arrays_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: SustainabilityArrayGetResponse
        ...
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api12_assessment_sustainability_arrays_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            ...
            response_type='SustainabilityArrayGetResponse',
    ...
    def api12_assessment_sustainability_insights_arrays_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api12_assessment_sustainability_insights_arrays_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param int _request_timeout: Total request timeout in seconds.
                 It can also be a tuple of (connection time, read time) timeouts.
        :return: SustainabilityInsightArrayGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        continuation_token = models.quoteString(continuation_token)
        ...
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api12_assessment_sustainability_insights_arrays_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SustainabilityInsightArrayGetResponse',
            auth_settings=auth_settings,
            async_req=async_req,
            _return_http_data_only=_return_http_data_only,
            _preload_content=_preload_content,
