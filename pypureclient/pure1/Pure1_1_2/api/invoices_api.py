...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_2.models.invoice_get_response import InvoiceGetResponse
...
class InvoicesApi:
    ...
    @validate_call
    def api12_invoices_get_with_http_info(
        self,
    ...
    ) -> ApiResponse[InvoiceGetResponse]:
        """Get invoices
        ...
        _param = self._api12_invoices_get_serialize(
            ...
            offset = offset,
            sort = sort,
            partner_purchase_orders = quote_strings(partner_purchase_orders),
    ...
    def _api12_invoices_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        if partner_purchase_orders is not None:
            ...
            _query_params.append(('partner_purchase_orders', partner_purchase_orders))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.2/invoices',
