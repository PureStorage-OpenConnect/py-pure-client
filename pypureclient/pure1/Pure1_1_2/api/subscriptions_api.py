...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_2.models.subscription_asset_get_response import SubscriptionAssetGetResponse
from pypureclient.pure1.Pure1_1_2.models.subscription_get_response import SubscriptionGetResponse
from pypureclient.pure1.Pure1_1_2.models.subscription_license_get_response import SubscriptionLicenseGetResponse
...
class SubscriptionsApi:
    ...
    def api12_subscription_assets_get_with_http_info(
    ...
    ) -> ApiResponse[SubscriptionAssetGetResponse]:
        ...
        :type sort: List[str]
        :param advanced_space: If `true`, returns the `advanced_space` field containing physical and effective space information.
        ...
        :param license_ids: A comma-separated list of subscriptionLicense IDs. If there is not at least one resource that matches each `license.id` element, an error is returned. Single quotes are required around all strings.
        :type license_ids: List[str]
        :param license_names: A comma-separated list of subscriptionLicense names. If there is not at least one resource that matches each `license.name` element, an error is returned. Single quotes are required around all strings.
        ...
        _param = self._api12_subscription_assets_get_serialize(
            ...
            subscription_ids = quote_strings(subscription_ids),
            subscription_names = quote_strings(subscription_names),
            license_ids = quote_strings(license_ids),
            license_names = quote_strings(license_names),
        )

        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SubscriptionAssetGetResponse",
            '400': "Error",
            '403': "ErrorNoContext",
            '404': "Error",
            '429': "ErrorNoContext",
    ...
    def _api12_subscription_assets_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        if advanced_space is not None:
            ...
            _query_params.append(('advanced_space', advanced_space))
        ...
        if subscription_names is not None:
            ...
            _query_params.append(('subscription_names', subscription_names))
            
        if license_ids is not None:
            
            _query_params.append(('license_ids', license_ids))
            
        if license_names is not None:
            
            _query_params.append(('license_names', license_names))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.2/subscription-assets',
    ...
    def api12_subscription_licenses_get_with_http_info(
        ...
        subscription_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of subscription names. If there is not at least one resource that matches each `subscription.name` element, an error is returned. Single quotes are required around all strings.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[SubscriptionLicenseGetResponse]:
        ...
        :param limit: Limit the size of the response to the specified number of resources. A limit of 0 can be used to get the number of resources without getting all of the resources. It will be returned in the total_item_count field. If a client asks for a page size larger than the maximum number, the request is still valid. In that case the server just returns the maximum number of items, disregarding the client's page size request. If not specified, defaults to 1000.
        :type limit: int
        :param marketplace_partner_reference_ids: A comma-separated list of marketplace partner reference IDs. If there is not at least one resource that matches each `marketplace_partner.reference_id` element, an error is returned. Single quotes are required around all strings.
        ...
        _param = self._api12_subscription_licenses_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = quote_strings(continuation_token),
            filter = filter,
            ids = quote_strings(ids),
            limit = limit,
            marketplace_partner_reference_ids = quote_strings(marketplace_partner_reference_ids),
            names = quote_strings(names),
            offset = offset,
            sort = sort,
            subscription_ids = quote_strings(subscription_ids),
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SubscriptionLicenseGetResponse",
            '400': "Error",
            '403': "ErrorNoContext",
            '404': "Error",
            '429': "ErrorNoContext",
    ...
    def _api12_subscription_licenses_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        _collection_formats: Dict[str, str] = {
            'ids': 'csv',
            'marketplace_partner_reference_ids': 'csv',
            'names': 'csv',
            'sort': 'csv',
            'subscription_ids': 'csv',
            'subscription_names': 'csv',
        ...
        if marketplace_partner_reference_ids is not None:
            ...
            _query_params.append(('marketplace_partner_reference_ids', marketplace_partner_reference_ids))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.2/subscription-licenses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api12_subscriptions_get_with_http_info(
        ...
        sort: Annotated[Optional[List[Annotated[str, Field(strict=True)]]], Field(description="Sort the response by the specified fields (in descending order if '-' is appended to the field name). If you provide a sort you will not get a continuation token in the response.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[SubscriptionGetResponse]:
        """Get subscriptions
        ...
        _param = self._api12_subscriptions_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = quote_strings(continuation_token),
            filter = filter,
    ...
    def _api12_subscriptions_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.2/subscriptions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
