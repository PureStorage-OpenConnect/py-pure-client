...
class VolumeSnapshotsApi(object):
    ...
    def api12_volume_snapshots_get_with_http_info(
        ...
        >>> thread = api.api12_volume_snapshots_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api12_volume_snapshots_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
