...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_2.models.file_system_snapshot_get_response import FileSystemSnapshotGetResponse
from pypureclient.pure1.Pure1_1_2.models.policy_members_get_response import PolicyMembersGetResponse
...
class FileSystemSnapshotsApi:
    ...
    @validate_call
    def api12_file_system_snapshots_get_with_http_info(
        self,
        ...
        :type sort: List[str]
        :param source_ids: A comma-separated list of ids for the source of the object. If there is not at least one resource that matches each `source_id` element, an error is returned. Single quotes are required around all strings.
        :type source_ids: List[str]
        :param source_names: A comma-separated list of names for the source of the object. If there is not at least one resource that matches each `source_name` element, an error is returned. Single quotes are required around all strings.
        ...
        _param = self._api12_file_system_snapshots_get_serialize(
    ...
    def _api12_file_system_snapshots_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.2/file-system-snapshots',
    ...
    @validate_call
    def api12_file_system_snapshots_policies_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        _param = self._api12_file_system_snapshots_policies_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = quote_strings(continuation_token),
            filter = filter,
    ...
    def _api12_file_system_snapshots_policies_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.2/file-system-snapshots/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
