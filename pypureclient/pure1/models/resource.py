...
class Resource(object):
    ...
    @property
    def as_of(self):
        """Gets the as_of of this Resource.  # noqa: E501

        The freshness of the data (timestamp in millis since epoch)  # noqa: E501

        :return: The as_of of this Resource.  # noqa: E501
        :rtype: int
        """
        return self._as_of
    ...
    def as_of(self, as_of):
        """Sets the as_of of this Resource.

        The freshness of the data (timestamp in millis since epoch)  # noqa: E501

        :param as_of: The as_of of this Resource.  # noqa: E501
        :type: int
        """
        if as_of is None:
