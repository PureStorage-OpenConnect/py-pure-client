...
class ArraysBuiltIn(object):
    ...
    def __init__(self, as_of=None, id=None, name=None, arrays=None):  # noqa: E501
        """ArraysBuiltIn - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def as_of(self):
        """Gets the as_of of this ArraysBuiltIn.  # noqa: E501

        The freshness of the data (timestamp in millis since epoch)  # noqa: E501

        :return: The as_of of this ArraysBuiltIn.  # noqa: E501
        :rtype: int
        """
        return self._as_of
    ...
    def as_of(self, as_of):
        """Sets the as_of of this ArraysBuiltIn.

        The freshness of the data (timestamp in millis since epoch)  # noqa: E501

        :param as_of: The as_of of this ArraysBuiltIn.  # noqa: E501
        :type: int
        """
        if as_of is None:
    ...
    @property
    def id(self):
        """Gets the id of this ArraysBuiltIn.  # noqa: E501

        A non-modifiable, globally unique ID chosen by the system.  # noqa: E501

        :return: The id of this ArraysBuiltIn.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ArraysBuiltIn.

        A non-modifiable, globally unique ID chosen by the system.  # noqa: E501

        :param id: The id of this ArraysBuiltIn.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ArraysBuiltIn.  # noqa: E501

        A non-modifiable, locally unique name chosen by the system.  # noqa: E501

        :return: The name of this ArraysBuiltIn.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ArraysBuiltIn.

        A non-modifiable, locally unique name chosen by the system.  # noqa: E501

        :param name: The name of this ArraysBuiltIn.  # noqa: E501
        :type: str
        """
    ...
    @property
    def arrays(self):
        """Gets the arrays of this ArraysBuiltIn.  # noqa: E501
        ...
        :return: The arrays of this ArraysBuiltIn.  # noqa: E501
    ...
    def arrays(self, arrays):
        """Sets the arrays of this ArraysBuiltIn.

        The list of arrays where this resource exists. Many resources are on a single array, but some resources - for example pods - can be stretched across multiple arrays.  # noqa: E501

        :param arrays: The arrays of this ArraysBuiltIn.  # noqa: E501
