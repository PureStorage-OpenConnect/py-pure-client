...
class PodGetResponse(object):
    ...
    def __init__(self, continuation_token=None, total_item_count=None, items=None):  # noqa: E501
        """PodGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def continuation_token(self):
        """Gets the continuation_token of this PodGetResponse.  # noqa: E501
        ...
        :return: The continuation_token of this PodGetResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def continuation_token(self, continuation_token):
        """Sets the continuation_token of this PodGetResponse.

        Continuation token that can be provided in the continuation_token query param to get the next page of data. If you use the continuation token to page through data you are guaranteed to get all items exactly once regardless of how items are modified. If an item is added or deleted during the pagination then it may or may not be returned. The continuation token is generated if the limit is less than the remaining number of items, and the default sort is used (no sort is specified).  # noqa: E501

        :param continuation_token: The continuation_token of this PodGetResponse.  # noqa: E501
        :type: str
        """
    ...
    def total_item_count(self):
        """Gets the total_item_count of this PodGetResponse.  # noqa: E501

        total number of items after applying filter params  # noqa: E501

        :return: The total_item_count of this PodGetResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def total_item_count(self, total_item_count):
        """Sets the total_item_count of this PodGetResponse.

        total number of items after applying filter params  # noqa: E501

        :param total_item_count: The total_item_count of this PodGetResponse.  # noqa: E501
        :type: int
        """
    ...
    @property
    def items(self):
        """Gets the items of this PodGetResponse.  # noqa: E501


        :return: The items of this PodGetResponse.  # noqa: E501
        :rtype: list[Pod]
        """
        return self._items
    ...
    def items(self, items):
        """Sets the items of this PodGetResponse.


        :param items: The items of this PodGetResponse.  # noqa: E501
        :type: list[Pod]
        """
