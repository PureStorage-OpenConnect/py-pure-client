...
class PodReplicaLink(object):
    ...
    def __init__(
        ...
        recovery_point=None,  # type: models.ERRORUNKNOWN
        ...
        Keyword args:
            ...
            recovery_point (ERRORUNKNOWN): Time when the last piece of data was replicated, in milliseconds since the UNIX epoch, and the recovery point if the target pod is promoted. If the pod is currently baselining then the value is `null`.
