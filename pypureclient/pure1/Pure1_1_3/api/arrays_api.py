...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_3.models.array_get_response import ArrayGetResponse
from pypureclient.pure1.Pure1_1_3.models.support_contract_get_response import SupportContractGetResponse
...
class ArraysApi:
    ...
    def api13_arrays_get_with_http_info(
        ...
        _param = self._api13_arrays_get_serialize(
    ...
    def _api13_arrays_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api13_arrays_support_contracts_get_with_http_info(
        ...
        _param = self._api13_arrays_support_contracts_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = quote_strings(continuation_token),
            filter = filter,
    ...
    def _api13_arrays_support_contracts_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.3/arrays/support-contracts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api13_arrays_tags_batch_put_with_http_info(
        ...
        _param = self._api13_arrays_tags_batch_put_serialize(
            tag = tag,
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api13_arrays_tags_batch_put_serialize(
        self,
        tag,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/1.3/arrays/tags/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api13_arrays_tags_delete_with_http_info(
        ...
        _param = self._api13_arrays_tags_delete_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api13_arrays_tags_delete_serialize(
        self,
        authorization,
        x_request_id,
        keys,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/1.3/arrays/tags',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api13_arrays_tags_get_with_http_info(
        ...
        _param = self._api13_arrays_tags_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = quote_strings(continuation_token),
            filter = filter,
    ...
    def _api13_arrays_tags_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
