...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_3.models.pod_replica_link_get_response import PodReplicaLinkGetResponse
...
class PodReplicaLinksApi:
    ...
    @validate_call
    def api13_pod_replica_links_get_with_http_info(
        self,
        ...
        _param = self._api13_pod_replica_links_get_serialize(
    ...
    def _api13_pod_replica_links_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.3/pod-replica-links',
