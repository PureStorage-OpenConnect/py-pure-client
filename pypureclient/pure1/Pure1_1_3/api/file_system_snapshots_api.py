...
class FileSystemSnapshotsApi:
    ...
    def api13_file_system_snapshots_get_with_http_info(
        ...
        _param = self._api13_file_system_snapshots_get_serialize(
    ...
    def _api13_file_system_snapshots_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.3/file-system-snapshots',
    ...
    def api13_file_system_snapshots_policies_get_with_http_info(
        ...
        _param = self._api13_file_system_snapshots_policies_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = quote_strings(continuation_token),
            filter = filter,
    ...
    def _api13_file_system_snapshots_policies_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.3/file-system-snapshots/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
