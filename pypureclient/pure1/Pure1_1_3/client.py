...
class Client(object):
    ...
    def get_alerts(
        ...
        endpoint = self._alerts_api.api13_alerts_get_with_http_info
    ...
    def get_arrays(
        ...
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria. Single quotes are required around all strings inside the filters.")] = None,
        fqdns: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource FQDNs. If there is not at least one resource that matches each `fqdn` element, an error is returned. Single quotes are required around all strings.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If there is not at least one resource that matches each `id` element, an error is returned. Single quotes are required around all strings.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Limit the size of the response to the specified number of resources. A limit of 0 can be used to get the number of resources without getting all of the resources. It will be returned in the total_item_count field. If a client asks for a page size larger than the maximum number, the request is still valid. In that case the server just returns the maximum number of items, disregarding the client's page size request. If not specified, defaults to 1000.")] = None,
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each `name` element, an error is returned. Single quotes are required around all strings.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The offset of the first resource to return from a collection.")] = None,
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._arrays_api.api13_arrays_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_arrays_support_contracts(
        self,
        resources: Optional[Union[models.ReferenceType, List[models.ReferenceType]]] = None,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria. Single quotes are required around all strings inside the filters.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Limit the size of the response to the specified number of resources. A limit of 0 can be used to get the number of resources without getting all of the resources. It will be returned in the total_item_count field. If a client asks for a page size larger than the maximum number, the request is still valid. In that case the server just returns the maximum number of items, disregarding the client's page size request. If not specified, defaults to 1000.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The offset of the first resource to return from a collection.")] = None,
        resource_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If there is not at least one resource that matches each `resource_id` element, an error is returned. Single quotes are required around all strings.")] = None,
        resource_fqdns: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource FQDNs. If there is not at least one resource that matches each `resource_fqdn` element, an error is returned. Single quotes are required around all strings.")] = None,
        resource_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each `resource_name` element, an error is returned. Single quotes are required around all strings.")] = None,
        sort: Annotated[Optional[List[Annotated[str, Field(strict=True)]]], Field(description="Sort the response by the specified fields (in descending order if '-' is appended to the field name). If you provide a sort you will not get a continuation token in the response.")] = None,
    ) -> Union[ValidResponse, ErrorResponse]:
        ...
        :param resources: A list of resources to query for. Overrides resource_ids and resource_fqdns and resource_names keyword arguments.
        :type resources: Optional[Union[models.ReferenceType, List[models.ReferenceType]]]
        :param authorization: Deprecated. Please use Client level authorization
        :type authorization: str
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._arrays_api.api13_arrays_support_contracts_get_with_http_info
        _process_references(resources, ['resource_ids', 'resource_fqdns', 'resource_names'], kwargs)
        return self._call_api(endpoint, kwargs)

    @validate_call
    def put_arrays_tags(
        self,
        tag: Annotated[List[models.TagPut], Field(description="A list of tags to be upserted.")],
        resources: Optional[Union[models.ReferenceType, List[models.ReferenceType]]] = None,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        namespaces: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of namespaces. Single quotes are required around all strings.")] = None,
        resource_ids: Annotated[Optional[List[StrictStr]], Field(description="REQUIRED: either `resource_ids` or `resource_names`. A comma-separated list of resource IDs. If there is not at least one resource that matches each `resource_id` element, an error is returned. Single quotes are required around all strings.")] = None,
        ...
        :param tag: A list of tags to be upserted. (required)
        :type tag: List[models.TagPut]
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._arrays_api.api13_arrays_tags_batch_put_with_http_info
    ...
    def delete_arrays_tags(
        ...
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        keys: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of tag keys. Single quotes are required around all strings.")] = None,
        namespaces: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of namespaces. Single quotes are required around all strings.")] = None,
        resource_ids: Annotated[Optional[List[StrictStr]], Field(description="REQUIRED: either `resource_ids` or `resource_names`. A comma-separated list of resource IDs. If there is not at least one resource that matches each `resource_id` element, an error is returned. Single quotes are required around all strings.")] = None,
        resource_names: Annotated[Optional[List[StrictStr]], Field(description="REQUIRED: either `resource_ids` or `resource_names`. A comma-separated list of resource names. If there is not at least one resource that matches each `resource_name` element, an error is returned. Single quotes are required around all strings.")] = None,
    ) -> Union[ValidResponse, ErrorResponse]:
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._arrays_api.api13_arrays_tags_delete_with_http_info
        _process_references(resources, ['resource_ids', 'resource_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_arrays_tags(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._arrays_api.api13_arrays_tags_get_with_http_info
        _process_references(resources, ['resource_ids', 'resource_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_audits(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._audits_api.api13_audits_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_blades(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._blades_api.api13_blades_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_bucket_replica_links(
        self,
        targets: Optional[Union[models.ReferenceType, List[models.ReferenceType]]] = None,
        ...
        :type targets: Optional[Union[models.ReferenceType, List[models.ReferenceType]]]
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._bucket_replica_links_api.api13_bucket_replica_links_get_with_http_info
    ...
    def get_buckets(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._buckets_api.api13_buckets_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_controllers(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._controllers_api.api13_controllers_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_directories(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._directories_api.api13_directories_get_with_http_info
    ...
    def get_drives(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._drives_api.api13_drives_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_file_system_replica_links(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._file_system_replica_links_api.api13_file_system_replica_links_get_with_http_info
        _process_references(references, ['ids'], kwargs)
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(sources, ['source_ids', 'source_names'], kwargs)
        _process_references(targets, ['target_ids', 'target_names'], kwargs)
    ...
    def get_file_system_replica_links_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._file_system_replica_links_api.api13_file_system_replica_links_policies_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
    ...
    def get_file_system_snapshots(
        ...
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The offset of the first resource to return from a collection.")] = None,
        sort: Annotated[Optional[List[Annotated[str, Field(strict=True)]]], Field(description="Sort the response by the specified fields (in descending order if '-' is appended to the field name). If you provide a sort you will not get a continuation token in the response.")] = None,
        source_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of ids for the source of the object. If there is not at least one resource that matches each `source_id` element, an error is returned. Single quotes are required around all strings.")] = None,
        source_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of names for the source of the object. If there is not at least one resource that matches each `source_name` element, an error is returned. Single quotes are required around all strings.")] = None,
    ) -> Union[ValidResponse, ErrorResponse]:
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._file_system_snapshots_api.api13_file_system_snapshots_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        _process_references(sources, ['source_ids', 'source_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_file_system_snapshots_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._file_system_snapshots_api.api13_file_system_snapshots_policies_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_file_systems(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._file_systems_api.api13_file_systems_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_file_systems_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._file_systems_api.api13_file_systems_policies_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_hardware(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._hardware_api.api13_hardware_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_hardware_connectors(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._hardware_connectors_api.api13_hardware_connectors_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_invoices(
        self,
        subscriptions: Optional[Union[models.ReferenceType, List[models.ReferenceType]]] = None,
        references: Optional[Union[models.ReferenceType, List[models.ReferenceType]]] = None,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The offset of the first resource to return from a collection.")] = None,
        sort: Annotated[Optional[List[Annotated[str, Field(strict=True)]]], Field(description="Sort the response by the specified fields (in descending order if '-' is appended to the field name). If you provide a sort you will not get a continuation token in the response.")] = None,
        partner_purchase_orders: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of partner purchase order numbers. If there is not at least one resource that matches each `partner_purchase_order` element, an error is returned. Single quotes are required around all strings.")] = None,
        subscription_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of subscription IDs. If there is not at least one resource that matches each `subscription.id` element, an error is returned. Single quotes are required around all strings.")] = None,
        subscription_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of subscription names. If there is not at least one resource that matches each `subscription.name` element, an error is returned. Single quotes are required around all strings.")] = None,
    ) -> Union[ValidResponse, ErrorResponse]:
        """Get invoices
        ...
        :type subscriptions: Optional[Union[models.ReferenceType, List[models.ReferenceType]]]
        :param references: A list of references to query for. Overrides ids keyword argument.
        :type references: Optional[Union[models.ReferenceType, List[models.ReferenceType]]]
        :param authorization: Deprecated. Please use Client level authorization
        :type authorization: str
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._invoices_api.api13_invoices_get_with_http_info
        _process_references(references, ['ids'], kwargs)
    ...
    def get_metrics(
        ...
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each `name` element, an error is returned. Single quotes are required around all strings.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The offset of the first resource to return from a collection.")] = None,
        resource_types: Annotated[Optional[List[StrictStr]], Field(description="The resource types to list the available metrics. Valid values are `arrays`, `buckets`, `directories`, `file-systems`, `pods`, `subscription-licenses` and `volumes`. A metric can belong to a combination of resources, e.g., write-iops from array to pod. In that case, query by ['arrays', 'pods']. Single quotes are required around all strings.")] = None,
        sort: Annotated[Optional[List[Annotated[str, Field(strict=True)]]], Field(description="Sort the response by the specified fields (in descending order if '-' is appended to the field name). If you provide a sort you will not get a continuation token in the response.")] = None,
    ) -> Union[ValidResponse, ErrorResponse]:
        """Get metrics
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._metrics_api.api13_metrics_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_metrics_history(
        ...
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="REQUIRED: either `ids` or `names`. A comma-separated list of object IDs. If there is not at least one resource that matches each `id` element, an error is returned. Single quotes are required around all strings.")] = None,
        names: Annotated[Optional[List[StrictStr]], Field(description="REQUIRED: either `names` or `ids`. A comma-separated list of resource names. If there is not at least one resource that matches each `name` element, an error is returned. Single quotes are required around all strings.")] = None,
        resource_ids: Annotated[Optional[List[StrictStr]], Field(description="REQUIRED: either `resource_ids` or `resource_names`. A comma-separated list of resource IDs. If there is not at least one resource that matches each `resource_id` element, an error is returned. Single quotes are required around all strings.")] = None,
        resource_names: Annotated[Optional[List[StrictStr]], Field(description="REQUIRED: either `resource_ids` or `resource_names`. A comma-separated list of resource names. If there is not at least one resource that matches each `resource_name` element, an error is returned. Single quotes are required around all strings.")] = None,
    ) -> Union[ValidResponse, ErrorResponse]:
        """Get metrics history
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._metrics_api.api13_metrics_history_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        _process_references(resources, ['resource_ids', 'resource_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_network_interfaces(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._network_interfaces_api.api13_network_interfaces_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_object_store_accounts(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._object_store_accounts_api.api13_object_store_accounts_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_pod_replica_links(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._pod_replica_links_api.api13_pod_replica_links_get_with_http_info
        _process_references(references, ['ids'], kwargs)
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(sources, ['source_ids', 'source_names'], kwargs)
        _process_references(targets, ['target_ids', 'target_names'], kwargs)
    ...
    def get_pods(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._pods_api.api13_pods_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies_file_system_replica_links(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies_api.api13_policies_file_system_replica_links_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies_file_system_snapshots(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies_api.api13_policies_file_system_snapshots_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies_file_systems(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies_api.api13_policies_file_systems_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies_api.api13_policies_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies_members(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies_api.api13_policies_members_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_ports(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._ports_api.api13_ports_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_subscription_assets(
        self,
        licenses: Optional[Union[models.ReferenceType, List[models.ReferenceType]]] = None,
        subscriptions: Optional[Union[models.ReferenceType, List[models.ReferenceType]]] = None,
        references: Optional[Union[models.ReferenceType, List[models.ReferenceType]]] = None,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        subscription_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of subscription IDs. If there is not at least one resource that matches each `subscription.id` element, an error is returned. Single quotes are required around all strings.")] = None,
        subscription_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of subscription names. If there is not at least one resource that matches each `subscription.name` element, an error is returned. Single quotes are required around all strings.")] = None,
        license_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of subscriptionLicense IDs. If there is not at least one resource that matches each `license.id` element, an error is returned. Single quotes are required around all strings.")] = None,
        license_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of subscriptionLicense names. If there is not at least one resource that matches each `license.name` element, an error is returned. Single quotes are required around all strings.")] = None,
    ) -> Union[ValidResponse, ErrorResponse]:
        ...
        :type licenses: Optional[Union[models.ReferenceType, List[models.ReferenceType]]]
        :param subscriptions: A list of subscriptions to query for. Overrides subscription_ids and subscription_names keyword arguments.
        :type subscriptions: Optional[Union[models.ReferenceType, List[models.ReferenceType]]]
        :param references: A list of references to query for. Overrides ids and names keyword arguments.
        :type references: Optional[Union[models.ReferenceType, List[models.ReferenceType]]]
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._subscriptions_api.api13_subscription_assets_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        _process_references(subscriptions, ['subscription_ids', 'subscription_names'], kwargs)
    ...
    def get_subscription_licenses(
        self,
        subscriptions: Optional[Union[models.ReferenceType, List[models.ReferenceType]]] = None,
        marketplace_partner_references: Optional[Union[models.ReferenceType, List[models.ReferenceType]]] = None,
        references: Optional[Union[models.ReferenceType, List[models.ReferenceType]]] = None,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        :param subscriptions: A list of subscriptions to query for. Overrides subscription_ids and subscription_names keyword arguments.
        :type subscriptions: Optional[Union[models.ReferenceType, List[models.ReferenceType]]]
        :param marketplace_partner_references: A list of marketplace_partner_references to query for. Overrides  keyword argument.
        :type marketplace_partner_references: Optional[Union[models.ReferenceType, List[models.ReferenceType]]]
        :param references: A list of references to query for. Overrides ids and names keyword arguments.
        :type references: Optional[Union[models.ReferenceType, List[models.ReferenceType]]]
        :param authorization: Deprecated. Please use Client level authorization
        :type authorization: str
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._subscriptions_api.api13_subscription_licenses_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        _process_references(marketplace_partner_references, [], kwargs)
        _process_references(subscriptions, ['subscription_ids', 'subscription_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_subscriptions(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._subscriptions_api.api13_subscriptions_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_assessment_sustainability_arrays(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._sustainability_api.api13_assessment_sustainability_arrays_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_assessment_sustainability_insights_arrays(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._sustainability_api.api13_assessment_sustainability_insights_arrays_get_with_http_info
        return self._call_api(endpoint, kwargs)
    ...
    def get_targets(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._targets_api.api13_targets_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_volume_snapshots(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._volume_snapshots_api.api13_volume_snapshots_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        _process_references(sources, ['source_ids', 'source_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_volumes(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._volumes_api.api13_volumes_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
