...
class Controller(BaseModel):
    ...
    mode: Optional[StrictStr] = Field(default=None, description="Mode of the controller. Values include `not present`, `offline`, `primary`, and `secondary`.")
    model: Optional[StrictStr] = Field(default=None, description="Model of the controller.")
    status: Optional[StrictStr] = Field(default=None, description="Status of the controller. Values include `not ready`, `ready`, `unknown`, and `updating`.")
    type: Optional[StrictStr] = Field(default=None, description="Type of the controller. Values include `array_controller` and `shelf_controller`.")
    version: Optional[StrictStr] = Field(default=None, description="Version of the controller.")
    __properties: ClassVar[List[str]] = ["_as_of", "id", "name", "arrays", "mode", "model", "status", "type", "version"]
