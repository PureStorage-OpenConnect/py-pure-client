...
from pypureclient.pure1.Pure1_1_3.models.object_store_account import ObjectStoreAccount
...
class ObjectStoreAccountGetResponse(BaseModel):
    ...
    items: Optional[conlist(ObjectStoreAccount)] = Field(default=None, description="A list of object store accounts.")
