...
class Volume(BaseModel):
    ...
    provisioned: Optional[Annotated[int, Field(le=4503599627370496, strict=True, ge=1048576)]] = Field(default=None, description="Provisioned size of the volume in bytes.")
    ...
    __properties: ClassVar[List[str]] = ["_as_of", "id", "name", "arrays", "created", "destroyed", "eradicated", "pod", "provisioned", "serial", "source"]
