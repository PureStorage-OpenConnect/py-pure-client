...
class ResourceWithLocation(BaseModel):
    ...
    location: Optional[FixedReferenceFqdn] = None
    __properties = ["id", "name", "resource_type", "location"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceWithLocation:
        """Create an instance of ResourceWithLocation from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourceWithLocation:
        """Create an instance of ResourceWithLocation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceWithLocation.parse_obj(obj)

        _obj = ResourceWithLocation.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "resource_type": obj.get("resource_type"),
            "location": FixedReferenceFqdn.from_dict(obj.get("location")) if obj.get("location") is not None else None
        })
        return _obj
