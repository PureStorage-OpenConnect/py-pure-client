...
class ResourceWithLocation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "resource_type", "location"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "location": FixedReferenceFqdn.from_dict(obj["location"]) if obj.get("location") is not None else None
        })
        return _obj
