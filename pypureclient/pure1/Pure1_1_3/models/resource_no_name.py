...
class ResourceNoName(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceNoName:
        """Create an instance of ResourceNoName from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourceNoName:
        """Create an instance of ResourceNoName from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceNoName.parse_obj(obj)

        _obj = ResourceNoName.construct(_fields_set=None, **{
