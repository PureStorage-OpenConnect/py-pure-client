...
class ResourceWithLocations(BaseModel):
    ...
    locations: Optional[List[FixedReferenceFqdn]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "resource_type", "locations"]
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded, if `include_readonly` is `False`.
        ...
        if self.locations and (include_readonly or "locations" not in excluded_fields):
            _items = []
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "locations": [FixedReferenceFqdn.from_dict(_item) for _item in obj["locations"]] if obj.get("locations") is not None else None
        })
        return _obj
