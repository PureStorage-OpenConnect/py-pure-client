...
class SubscriptionAsset(BaseModel):
    ...
    install_address: Optional[Dict[str, Any]] = Field(default=None, description="The address where the appliance is installed. This address is also where replacement parts will be shipped to.")
    ...
    organization: Optional[AssetOrg] = Field(default=None, description="The Pure1 organization for the asset.")
    __properties: ClassVar[List[str]] = ["_as_of", "id", "name", "install_address", "activation_date", "end_of_life_date", "array", "subscription", "license", "organization"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "install_address": obj.get("install_address"),
            ...
            "organization": AssetOrg.from_dict(obj["organization"]) if obj.get("organization") is not None else None
        })
        return _obj
