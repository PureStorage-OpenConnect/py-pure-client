...
class MetricHistory(BaseModel):
    ...
    resources: Optional[conlist(FixedReferenceFqdn)] = Field(default=None, description="The references to the resources that the metric data is for. For example, write-iops metric for an array will have one element in this list referencing the array entity. the write-iops from an array to a pod will contain two elements in this list - first element pointing to the array, and second element pointing to the pod.")
    ...
    def from_dict(cls, obj: dict) -> MetricHistory:
        ...
        _obj = MetricHistory.construct(_fields_set=None, **{
            ...
            "resources": [FixedReferenceFqdn.from_dict(_item) for _item in obj.get("resources")] if obj.get("resources") is not None else None,
            "unit": obj.get("unit")
        })
        return _obj
