...
from pypureclient.pure1.Pure1_1_4.models.subscription_all_of_service_details import SubscriptionAllOfServiceDetails
...
class Subscription(BaseModel):
    ...
    __properties = ["_as_of", "id", "name", "expiration_date", "initial_name", "last_updated_date", "organization", "partner_name", "service", "service_details", "start_date", "status", "subscription_term"]
