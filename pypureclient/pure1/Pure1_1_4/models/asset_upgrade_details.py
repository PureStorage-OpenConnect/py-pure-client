...
class AssetUpgradeDetails(object):
    """
    Attributes:
    ...
    def __init__(
        self,
        upgrade_eligibility_date=None,  # type: int
        commitment_date=None,  # type: int
        action_needed=None,  # type: str
    ):
        """
        Keyword args:
        ...
        """
        if upgrade_eligibility_date is not None:
            self.upgrade_eligibility_date = upgrade_eligibility_date
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `AssetUpgradeDetails`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(AssetUpgradeDetails, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssetUpgradeDetails):
            return False
