...
class Client(object):
    ...
    def get_alerts(
        ...
        endpoint = self._alerts_api.api14_alerts_get_with_http_info
    ...
    def get_arrays(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._arrays_api.api14_arrays_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_arrays_support_contracts(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._arrays_api.api14_arrays_support_contracts_get_with_http_info
    ...
    def put_arrays_tags(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._arrays_api.api14_arrays_tags_batch_put_with_http_info
        _process_references(resources, ['resource_ids', 'resource_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def delete_arrays_tags(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._arrays_api.api14_arrays_tags_delete_with_http_info
        _process_references(resources, ['resource_ids', 'resource_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_arrays_tags(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._arrays_api.api14_arrays_tags_get_with_http_info
        _process_references(resources, ['resource_ids', 'resource_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_audits(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._audits_api.api14_audits_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_blades(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._blades_api.api14_blades_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_bucket_replica_links(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._bucket_replica_links_api.api14_bucket_replica_links_get_with_http_info
    ...
    def get_buckets(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._buckets_api.api14_buckets_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_controllers(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._controllers_api.api14_controllers_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_directories(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._directories_api.api14_directories_get_with_http_info
    ...
    def get_drives(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._drives_api.api14_drives_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_file_system_replica_links(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._file_system_replica_links_api.api14_file_system_replica_links_get_with_http_info
        _process_references(references, ['ids'], kwargs)
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(sources, ['source_ids', 'source_names'], kwargs)
        _process_references(targets, ['target_ids', 'target_names'], kwargs)
    ...
    def get_file_system_replica_links_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._file_system_replica_links_api.api14_file_system_replica_links_policies_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
    ...
    def get_file_system_snapshots(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._file_system_snapshots_api.api14_file_system_snapshots_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        _process_references(sources, ['source_ids', 'source_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_file_system_snapshots_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._file_system_snapshots_api.api14_file_system_snapshots_policies_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_file_systems(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._file_systems_api.api14_file_systems_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_file_systems_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._file_systems_api.api14_file_systems_policies_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_hardware(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._hardware_api.api14_hardware_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_hardware_connectors(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._hardware_connectors_api.api14_hardware_connectors_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_invoices(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._invoices_api.api14_invoices_get_with_http_info
        _process_references(references, ['ids'], kwargs)
    ...
    def get_metrics(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._metrics_api.api14_metrics_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_metrics_history(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._metrics_api.api14_metrics_history_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        _process_references(resources, ['resource_ids', 'resource_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_network_interfaces(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._network_interfaces_api.api14_network_interfaces_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_object_store_accounts(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._object_store_accounts_api.api14_object_store_accounts_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_pod_replica_links(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._pod_replica_links_api.api14_pod_replica_links_get_with_http_info
        _process_references(references, ['ids'], kwargs)
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(sources, ['source_ids', 'source_names'], kwargs)
        _process_references(targets, ['target_ids', 'target_names'], kwargs)
    ...
    def get_pods(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._pods_api.api14_pods_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies_file_system_replica_links(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies_api.api14_policies_file_system_replica_links_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies_file_system_snapshots(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies_api.api14_policies_file_system_snapshots_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies_file_systems(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies_api.api14_policies_file_systems_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies_api.api14_policies_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies_members(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies_api.api14_policies_members_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_ports(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._ports_api.api14_ports_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_subscription_licenses(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._subscriptions_api.api14_subscription_licenses_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
    ...
    def get_subscriptions(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._subscriptions_api.api14_subscriptions_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_assessment_sustainability_arrays(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._sustainability_api.api14_assessment_sustainability_arrays_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_assessment_sustainability_insights_arrays(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._sustainability_api.api14_assessment_sustainability_insights_arrays_get_with_http_info
        return self._call_api(endpoint, kwargs)
    ...
    def get_targets(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._targets_api.api14_targets_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_volume_snapshots(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._volume_snapshots_api.api14_volume_snapshots_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        _process_references(sources, ['source_ids', 'source_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_volumes(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._volumes_api.api14_volumes_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
