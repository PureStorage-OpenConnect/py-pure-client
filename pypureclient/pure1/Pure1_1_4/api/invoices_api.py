...
class InvoicesApi:
    ...
    def api14_invoices_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api14_invoices_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, offset, partner_purchase_orders, sort, subscription_ids, subscription_names, async_req=True)
        >>> result = thread.get()
