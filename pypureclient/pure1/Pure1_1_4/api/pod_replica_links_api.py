...
from pypureclient.pure1.Pure1_1_4.models.pod_replica_link_get_response import PodReplicaLinkGetResponse
...
class PodReplicaLinksApi:
    ...
    def api14_pod_replica_links_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api14_pod_replica_links_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, member_ids, member_names, offset, sort, source_ids, source_names, target_ids, target_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api14_pod_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
