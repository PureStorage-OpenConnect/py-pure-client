...
class MetricsApi:
    ...
    def api14_metrics_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api14_metrics_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, resource_types, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api14_metrics_history_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api14_metrics_history_get_with_http_info(aggregation, end_time, resolution, start_time, authorization, x_request_id, ids, names, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
