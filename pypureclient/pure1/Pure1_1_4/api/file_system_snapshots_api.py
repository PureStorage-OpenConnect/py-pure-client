...
class FileSystemSnapshotsApi(object):
    ...
    def api14_file_system_snapshots_get_with_http_info(
        ...
        >>> thread = api.api14_file_system_snapshots_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api14_file_system_snapshots_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api14_file_system_snapshots_policies_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api14_file_system_snapshots_policies_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api14_file_system_snapshots_policies_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
