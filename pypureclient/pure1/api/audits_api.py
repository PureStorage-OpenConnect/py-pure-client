...
class AuditsApi(object):
    ...
    def api10_audits_get(self, **kwargs):
        """Get audits

        Retrieves audit objects. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api10_audits_get(async_req=True)
        >>> result = thread.get()
        ...
        :return: AuditsGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api10_audits_get_with_http_info(**kwargs)
        else:
            (data) = self.api10_audits_get_with_http_info(**kwargs)
            return data

    def api10_audits_get_with_http_info(self, **kwargs):
        """Get audits

        Retrieves audit objects. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api10_audits_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api10_audits_get" % key
                )
            params[key] = val
        del params['kwargs']

        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api10_audits_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            response_type='AuditsGetResponse',
