...
class VolumeSnapshotsApi(object):
    ...
    def api10_volume_snapshots_get(self, **kwargs):  # noqa: E501
        """api10_volume_snapshots_get  # noqa: E501

        Get snapshots of volumes.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api10_volume_snapshots_get(async_req=True)
        >>> result = thread.get()
        ...
        :return: VolumeSnapshotsGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api10_volume_snapshots_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.api10_volume_snapshots_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def api10_volume_snapshots_get_with_http_info(self, **kwargs):  # noqa: E501
        """api10_volume_snapshots_get  # noqa: E501

        Get snapshots of volumes.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api10_volume_snapshots_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'x_request_id', 'continuation_token', 'filter', 'ids', 'limit', 'names', 'offset', 'sort', 'source_ids', 'source_names']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api10_volume_snapshots_get" % key
                )
            params[key] = val
        del params['kwargs']

        if 'offset' in params and params['offset'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `offset` when calling `api10_volume_snapshots_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        if 'source_ids' in params:
            query_params.append(('source_ids', params['source_ids']))  # noqa: E501
            collection_formats['source_ids'] = 'multi'  # noqa: E501
        if 'source_names' in params:
            query_params.append(('source_names', params['source_names']))  # noqa: E501
            collection_formats['source_names'] = 'multi'  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='VolumeSnapshotsGetResponse',  # noqa: E501
