...
class VolumeSnapshotsApi(object):
    ...
    def api10_volume_snapshots_get(self, **kwargs):
        ...
        if kwargs.get('async_req'):
            return self.api10_volume_snapshots_get_with_http_info(**kwargs)
        else:
            (data) = self.api10_volume_snapshots_get_with_http_info(**kwargs)
            return data

    def api10_volume_snapshots_get_with_http_info(self, **kwargs):
        """Get volume snapshots
        ...
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api10_volume_snapshots_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
