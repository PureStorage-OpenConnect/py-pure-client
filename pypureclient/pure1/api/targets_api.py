...
class TargetsApi(object):
    ...
    def api10_targets_get(self, **kwargs):
        """Get targets

        Retrieves information about targets. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api10_targets_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api10_targets_get_with_http_info(**kwargs)
        else:
            (data) = self.api10_targets_get_with_http_info(**kwargs)
            return data

    def api10_targets_get_with_http_info(self, **kwargs):
        """Get targets

        Retrieves information about targets. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api10_targets_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api10_targets_get" % key
                )
            params[key] = val
        del params['kwargs']

        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api10_targets_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
