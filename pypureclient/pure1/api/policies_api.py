...
class PoliciesApi(object):
    ...
    def api10_policies_file_system_replica_links_get(self, **kwargs):
        ...
        >>> thread = api.api10_policies_file_system_replica_links_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api10_policies_file_system_replica_links_get_with_http_info(**kwargs)
        else:
            (data) = self.api10_policies_file_system_replica_links_get_with_http_info(**kwargs)
            return data

    def api10_policies_file_system_replica_links_get_with_http_info(self, **kwargs):
        """Get policy / file system replica link pairs
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api10_policies_file_system_replica_links_get" % key
                )
            params[key] = val
        del params['kwargs']

        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api10_policies_file_system_replica_links_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
