...
class VolumesApi(object):
    ...
    def api10_volumes_get(self, **kwargs):  # noqa: E501
        """api10_volumes_get  # noqa: E501

        Get FlashArray volume objects.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api10_volumes_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api10_volumes_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.api10_volumes_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def api10_volumes_get_with_http_info(self, **kwargs):  # noqa: E501
        """api10_volumes_get  # noqa: E501

        Get FlashArray volume objects.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api10_volumes_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api10_volumes_get" % key
                )
            params[key] = val
        del params['kwargs']

        if 'offset' in params and params['offset'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `offset` when calling `api10_volumes_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            response_type='VolumeGetResponse',  # noqa: E501
