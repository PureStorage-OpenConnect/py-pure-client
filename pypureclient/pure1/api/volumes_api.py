...
class VolumesApi(object):
    ...
    def api10_volumes_get(self, **kwargs):
        """Get volumes
        ...
        if kwargs.get('async_req'):
            return self.api10_volumes_get_with_http_info(**kwargs)
        else:
            (data) = self.api10_volumes_get_with_http_info(**kwargs)
            return data

    def api10_volumes_get_with_http_info(self, **kwargs):
        """Get volumes
        ...
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api10_volumes_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
