...
class ObjectStoreAccountsApi(object):
    ...
    def api10_object_store_accounts_get(self, **kwargs):
        """Get object store accounts

        Retrieves object store accounts. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api10_object_store_accounts_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api10_object_store_accounts_get_with_http_info(**kwargs)
        else:
            (data) = self.api10_object_store_accounts_get_with_http_info(**kwargs)
            return data

    def api10_object_store_accounts_get_with_http_info(self, **kwargs):
        """Get object store accounts

        Retrieves object store accounts. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api10_object_store_accounts_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api10_object_store_accounts_get" % key
                )
            params[key] = val
        del params['kwargs']

        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api10_object_store_accounts_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/api/1.0/object-store-accounts', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
