...
class FileSystemsApi(object):
    ...
    def api10_file_systems_get(self, **kwargs):
        """Get file systems
        ...
        if kwargs.get('async_req'):
            return self.api10_file_systems_get_with_http_info(**kwargs)
        else:
            (data) = self.api10_file_systems_get_with_http_info(**kwargs)
            return data

    def api10_file_systems_get_with_http_info(self, **kwargs):
        """Get file systems
    ...
    def api10_file_systems_policies_get(self, **kwargs):
        """Get file system / policy pairs

        Retrieves pairs of file system members and their policies. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api10_file_systems_policies_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api10_file_systems_policies_get_with_http_info(**kwargs)
        else:
            (data) = self.api10_file_systems_policies_get_with_http_info(**kwargs)
            return data

    def api10_file_systems_policies_get_with_http_info(self, **kwargs):
        """Get file system / policy pairs
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api10_file_systems_policies_get" % key
                )
            params[key] = val
        del params['kwargs']
