...
from pypureclient.pure1.configuration import Configuration
import pypureclient.pure1.models
from pypureclient.pure1 import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pypureclient.pure1.models, klass)
