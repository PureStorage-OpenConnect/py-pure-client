...
from pypureclient.pure1.Pure1_1_6.models.audits_get_response import AuditsGetResponse
from typing import Optional
...
class AuditsApi:
    ...
    def api16_audits_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        :rtype: tuple(AuditsGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api16_audits_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
