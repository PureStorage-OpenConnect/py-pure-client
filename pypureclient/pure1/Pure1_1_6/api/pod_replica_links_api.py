...
from pypureclient.pure1.Pure1_1_6.models.pod_replica_link_get_response import PodReplicaLinkGetResponse
from typing import Optional
...
class PodReplicaLinksApi:
    ...
    def api16_pod_replica_links_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api16_pod_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
