...
from pypureclient.pure1.Pure1_1_6.models.volume_get_response import VolumeGetResponse
from typing import Optional
...
class VolumesApi:
    ...
    def api16_volumes_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api16_volumes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
