...
from pypureclient.pure1.Pure1_1_6.models.invoice_get_response import InvoiceGetResponse
from typing import Optional
...
class InvoicesApi:
    ...
    def api16_invoices_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api16_invoices_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
