...
from pypureclient.pure1.Pure1_1_5.models.alert import Alert
...
class AlertsGetResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertsGetResponse:
        """Create an instance of AlertsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AlertsGetResponse:
        """Create an instance of AlertsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlertsGetResponse.parse_obj(obj)

        _obj = AlertsGetResponse.construct(_fields_set=None, **{
