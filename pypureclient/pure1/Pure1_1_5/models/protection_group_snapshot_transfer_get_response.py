...
from pypureclient.pure1.Pure1_1_5.models.protection_group_snapshot_transfer import ProtectionGroupSnapshotTransfer
...
class ProtectionGroupSnapshotTransferGetResponse(BaseModel):
    ...
    items: Optional[conlist(ProtectionGroupSnapshotTransfer)] = None
