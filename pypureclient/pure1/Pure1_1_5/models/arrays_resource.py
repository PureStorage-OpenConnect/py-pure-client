...
class ArraysResource(BaseModel):
    """
    A built-in resource that exists on one or multiple arrays.  # noqa: E501
    """
    ...
    __properties = ["_as_of", "id", "name", "arrays"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArraysResource:
        """Create an instance of ArraysResource from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArraysResource:
        """Create an instance of ArraysResource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArraysResource.parse_obj(obj)

        _obj = ArraysResource.construct(_fields_set=None, **{
