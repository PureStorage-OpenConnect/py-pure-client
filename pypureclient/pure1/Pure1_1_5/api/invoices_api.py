...
from pypureclient.pure1.Pure1_1_5.models.invoice_get_response import InvoiceGetResponse
from typing import Optional
...
class InvoicesApi:
    ...
    def api15_invoices_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api15_invoices_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('partner_purchase_orders') is not None:  # noqa: E501
            _query_params.append(('partner_purchase_orders', quote_string_parameter(_params['partner_purchase_orders'])))
