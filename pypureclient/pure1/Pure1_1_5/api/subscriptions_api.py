    ...
    def api15_subscription_assets_get_with_http_info(
        ...
        **kwargs
        ...
        if _params.get('license_ids') is not None:  # noqa: E501
            _query_params.append(('license_ids', quote_string_parameter(_params['license_ids'])))
            _collection_formats['license_ids'] = 'csv'

        if _params.get('license_names') is not None:  # noqa: E501
            _query_params.append(('license_names', quote_string_parameter(_params['license_names'])))
        ...
        if _params.get('subscription_ids') is not None:  # noqa: E501
            _query_params.append(('subscription_ids', quote_string_parameter(_params['subscription_ids'])))
            _collection_formats['subscription_ids'] = 'csv'

        if _params.get('subscription_names') is not None:  # noqa: E501
            _query_params.append(('subscription_names', quote_string_parameter(_params['subscription_names'])))
    ...
    def api15_subscription_licenses_get_with_http_info(
        ...
        **kwargs
        ...
        if _params.get('marketplace_partner_reference_ids') is not None:  # noqa: E501
            _query_params.append(('marketplace_partner_reference_ids', quote_string_parameter(_params['marketplace_partner_reference_ids'])))
