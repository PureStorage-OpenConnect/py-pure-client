...
from pypureclient.pure1.Pure1_1_5.models.subscription_asset_get_response import SubscriptionAssetGetResponse
from pypureclient.pure1.Pure1_1_5.models.subscription_get_response import SubscriptionGetResponse
from pypureclient.pure1.Pure1_1_5.models.subscription_license_get_response import SubscriptionLicenseGetResponse
...
class SubscriptionsApi:
    ...
    def api15_subscription_assets_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api15_subscription_assets_get_with_http_info(authorization, x_request_id, advanced_space, continuation_token, filter, ids, license_ids, license_names, limit, names, offset, sort, subscription_ids, subscription_names, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: tuple(SubscriptionAssetGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api15_subscription_assets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _query_params = []
        if _params.get('advanced_space') is not None:  # noqa: E501
            _query_params.append(('advanced_space', _params['advanced_space']))
        ...
        if _params.get('license_ids') is not None:  # noqa: E501
            _query_params.append(('license_ids', quote_strings(_params['license_ids'])))
            _collection_formats['license_ids'] = 'csv'

        if _params.get('license_names') is not None:  # noqa: E501
            _query_params.append(('license_names', quote_strings(_params['license_names'])))
            _collection_formats['license_names'] = 'csv'
        ...
        return self.api_client.call_api(
            '/api/1.5/subscription-assets', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api15_subscription_licenses_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api15_subscription_licenses_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, marketplace_partner_reference_ids, names, offset, sort, subscription_ids, subscription_names, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SubscriptionLicenseGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api15_subscription_licenses_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('marketplace_partner_reference_ids') is not None:  # noqa: E501
            _query_params.append(('marketplace_partner_reference_ids', quote_strings(_params['marketplace_partner_reference_ids'])))
            _collection_formats['marketplace_partner_reference_ids'] = 'csv'
        ...
        return self.api_client.call_api(
            '/api/1.5/subscription-licenses', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api15_subscriptions_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api15_subscriptions_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SubscriptionGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api15_subscriptions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
