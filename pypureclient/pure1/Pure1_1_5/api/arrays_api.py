...
class ArraysApi:
    ...
    def api15_arrays_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api15_arrays_get_with_http_info(authorization, x_request_id, continuation_token, filter, fqdns, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('fqdns') is not None:  # noqa: E501
            _query_params.append(('fqdns', quote_strings(_params['fqdns'])))
        ...
        if _params.get('names') is not None:  # noqa: E501
            _query_params.append(('names', quote_strings(_params['names'])))
    ...
    def api15_arrays_support_contracts_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api15_arrays_support_contracts_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, offset, resource_fqdns, resource_ids, resource_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('resource_fqdns') is not None:  # noqa: E501
            _query_params.append(('resource_fqdns', quote_strings(_params['resource_fqdns'])))
            _collection_formats['resource_fqdns'] = 'csv'

        if _params.get('resource_ids') is not None:  # noqa: E501
            _query_params.append(('resource_ids', quote_strings(_params['resource_ids'])))
            _collection_formats['resource_ids'] = 'csv'

        if _params.get('resource_names') is not None:  # noqa: E501
            _query_params.append(('resource_names', quote_strings(_params['resource_names'])))
    ...
    def api15_arrays_tags_batch_put_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api15_arrays_tags_batch_put_with_http_info(tag_put, authorization, x_request_id, namespaces, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('namespaces') is not None:  # noqa: E501
            _query_params.append(('namespaces', quote_strings(_params['namespaces'])))
    ...
    def api15_arrays_tags_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api15_arrays_tags_delete_with_http_info(authorization, x_request_id, keys, namespaces, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('keys') is not None:  # noqa: E501
            _query_params.append(('keys', quote_strings(_params['keys'])))
    ...
    def api15_arrays_tags_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api15_arrays_tags_get_with_http_info(authorization, x_request_id, continuation_token, filter, keys, limit, namespaces, offset, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
