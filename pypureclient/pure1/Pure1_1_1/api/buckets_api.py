...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_1.models.bucket_get_response import BucketGetResponse
...
class BucketsApi:
    ...
    @validate_call
    def api11_buckets_get_with_http_info(
        self,
        ...
        _param = self._api11_buckets_get_serialize(
    ...
    def _api11_buckets_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
