...
class PodReplicaLinksApi:
    ...
    def api11_pod_replica_links_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api11_pod_replica_links_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, member_ids, member_names, offset, sort, source_ids, source_names, target_ids, target_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api11_pod_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('source_ids') is not None:  # noqa: E501
            _query_params.append(('source_ids', quote_strings(_params['source_ids'])))
            _collection_formats['source_ids'] = 'csv'

        if _params.get('source_names') is not None:  # noqa: E501
            _query_params.append(('source_names', quote_strings(_params['source_names'])))
            _collection_formats['source_names'] = 'csv'

        if _params.get('target_ids') is not None:  # noqa: E501
            _query_params.append(('target_ids', quote_strings(_params['target_ids'])))
            _collection_formats['target_ids'] = 'csv'

        if _params.get('target_names') is not None:  # noqa: E501
            _query_params.append(('target_names', quote_strings(_params['target_names'])))
