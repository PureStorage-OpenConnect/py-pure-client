...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_1.models.directory_get_response import DirectoryGetResponse
...
class DirectoriesApi:
    ...
    @validate_call
    def api11_directories_get_with_http_info(
        self,
        ...
        :param file_system_ids: Performs the operation on the file system ID specified. Enter multiple file system IDs in comma-separated format. The `file_system_ids` and `file_system_names` parameters cannot be provided together. Single quotes are required around all strings.
        :type file_system_ids: List[str]
        :param file_system_names: Performs the operation on the file system name specified. Enter multiple file system names in comma-separated format. For example, `filesystem1,filesystem2`. The `file_system_ids` and `file_system_names` parameters cannot be provided together. Single quotes are required around all strings.
        ...
        _param = self._api11_directories_get_serialize(
    ...
    def _api11_directories_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.1/directories',
