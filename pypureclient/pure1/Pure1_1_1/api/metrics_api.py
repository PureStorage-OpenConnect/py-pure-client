...
class MetricsApi:
    ...
    def api11_metrics_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api11_metrics_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, resource_types, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api11_metrics_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api11_metrics_history_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api11_metrics_history_get_with_http_info(aggregation, end_time, resolution, start_time, authorization, x_request_id, ids, names, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api11_metrics_history_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
