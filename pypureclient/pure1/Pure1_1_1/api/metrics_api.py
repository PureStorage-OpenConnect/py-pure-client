...
from typing_extensions import Annotated
from pypureclient.pure1.Pure1_1_1.models.metric_get_response import MetricGetResponse
from pypureclient.pure1.Pure1_1_1.models.metric_history_get_response import MetricHistoryGetResponse
from pypureclient.pure1.Pure1_1_1.api_client import ApiClient as _TransportApiClient, RequestSerialized
from pypureclient.pure1.Pure1_1_1.api_response import ApiResponse
from pypureclient.pure1.Pure1_1_1.rest import RESTResponseType
...
class MetricsApi:
    ...
    def api11_metrics_get_with_http_info(
        ...
        _param = self._api11_metrics_get_serialize(
    ...
    def _api11_metrics_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api11_metrics_history_get_with_http_info(
        ...
        _param = self._api11_metrics_history_get_serialize(
    ...
    def _api11_metrics_history_get_serialize(
        self,
        aggregation,
        end_time,
        resolution,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.1/metrics/history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
