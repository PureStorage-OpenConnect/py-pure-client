...
class SustainabilityApi:
    ...
    def api11_assessment_sustainability_arrays_get_with_http_info(
        ...
        _param = self._api11_assessment_sustainability_arrays_get_serialize(
    ...
    def _api11_assessment_sustainability_arrays_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.1/assessment/sustainability/arrays',
    ...
    def api11_assessment_sustainability_insights_arrays_get_with_http_info(
        ...
        _param = self._api11_assessment_sustainability_insights_arrays_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = quote_strings(continuation_token),
            filter = filter,
    ...
    def _api11_assessment_sustainability_insights_arrays_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.1/assessment/sustainability/insights/arrays',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
