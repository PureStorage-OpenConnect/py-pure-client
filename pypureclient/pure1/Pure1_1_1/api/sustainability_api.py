...
class SustainabilityApi(object):
    ...
    def api11_assessment_sustainability_arrays_get_with_http_info(
        ...
        >>> thread = api.api11_assessment_sustainability_arrays_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api11_assessment_sustainability_arrays_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api11_assessment_sustainability_insights_arrays_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api11_assessment_sustainability_insights_arrays_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api11_assessment_sustainability_insights_arrays_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
