...
class SustainabilityApi:
    ...
    def api11_assessment_sustainability_arrays_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api11_assessment_sustainability_arrays_get_with_http_info(authorization, x_request_id, continuation_token, filter, fqdns, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api11_assessment_sustainability_insights_arrays_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api11_assessment_sustainability_insights_arrays_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, offset, sort, async_req=True)
        >>> result = thread.get()
