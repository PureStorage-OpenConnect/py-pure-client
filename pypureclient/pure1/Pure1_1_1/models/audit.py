...
class Audit(BaseModel):
    ...
    arguments: Optional[StrictStr] = Field(default=None, description="Arguments provided to the command.")
    command: Optional[StrictStr] = Field(default=None, description="The command that was executed.")
    origin: Optional[StrictStr] = Field(default=None, description="Origin of the action. Valid values are `array` and `Pure1`.")
    subcommand: Optional[StrictStr] = Field(default=None, description="The subcommand that was executed.")
    time: Optional[StrictInt] = Field(default=None, description="Time at which the command was run in milliseconds since UNIX epoch.")
    user: Optional[StrictStr] = Field(default=None, description="The user who ran the command.")
    __properties: ClassVar[List[str]] = ["_as_of", "id", "name", "arrays", "arguments", "command", "origin", "subcommand", "time", "user"]
