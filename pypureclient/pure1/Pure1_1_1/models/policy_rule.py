...
class PolicyRule(BaseModel):
    ...
    keep_for: Optional[StrictInt] = Field(default=None, description="How long to keep snapshots, in milliseconds.")
    time_zone: Optional[StrictStr] = Field(default=None, description="The time zone in which the `at` rule is applied.")
