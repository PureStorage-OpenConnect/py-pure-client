...
from pypureclient.pure1.Pure1_1_1.models.resource_with_location import ResourceWithLocation
...
class FileSystemReplicaLink(BaseModel):
    ...
    members: Optional[conlist(ResourceWithLocation)] = Field(default=None, description="The union of source and target file systems in the replica link.")
    sources: Optional[conlist(ResourceWithLocation)] = Field(default=None, description="The source file systems in the replica link.")
    ...
    targets: Optional[conlist(ResourceWithLocation)] = Field(default=None, description="The target file systems in the replica link.")
