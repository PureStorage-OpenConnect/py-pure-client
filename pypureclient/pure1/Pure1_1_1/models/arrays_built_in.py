...
class ArraysBuiltIn(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArraysBuiltIn:
        """Create an instance of ArraysBuiltIn from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArraysBuiltIn:
        """Create an instance of ArraysBuiltIn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArraysBuiltIn.parse_obj(obj)

        _obj = ArraysBuiltIn.construct(_fields_set=None, **{
