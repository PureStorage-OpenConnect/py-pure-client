...
class NetworkInterface(BaseModel):
    ...
    subinterfaces: Optional[conlist(StrictStr)] = None
    __properties = ["_as_of", "id", "name", "arrays", "address", "enabled", "gateway", "hwaddr", "mtu", "netmask", "services", "speed", "subinterfaces"]
