...
class Alert(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_as_of", "id", "name", "arrays", "actual", "category", "closed", "code", "component_name", "component_type", "created", "description", "expected", "knowledge_base_url", "notified", "origin", "severity", "state", "summary", "updated"]
