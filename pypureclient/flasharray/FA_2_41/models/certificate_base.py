...
class CertificateBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["certificate", "common_name", "certificate_type", "country", "email", "intermediate_certificate", "issued_by", "issued_to", "locality", "organization", "organizational_unit", "state", "status", "subject_alternative_names", "key_algorithm", "key_size", "valid_from", "valid_to"]
