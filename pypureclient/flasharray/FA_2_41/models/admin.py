...
from pypureclient.flasharray.FA_2_41.models.api_token import ApiToken
...
class Admin(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "api_token", "is_local", "locked", "lockout_remaining", "password", "public_key", "role", "management_access_policies"]
