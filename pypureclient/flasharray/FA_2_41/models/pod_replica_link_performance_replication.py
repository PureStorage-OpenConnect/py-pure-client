...
class PodReplicaLinkPerformanceReplication(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "bytes_per_sec_from_remote", "bytes_per_sec_to_remote", "bytes_per_sec_total", "direction", "local_pod", "remotes", "remote_pod", "time", "context"]
