...
from pypureclient.flasharray.FA_2_41.models.preset_workload_constraints_resource_reference_allowed_values import PresetWorkloadConstraintsResourceReferenceAllowedValues
...
class PresetWorkloadConstraintsResourceReference(BaseModel):
    ...
    """ # noqa: E501
    allowed_values: List[PresetWorkloadConstraintsResourceReferenceAllowedValues] = Field(description="The valid values that can be supplied to the parameter. Exactly one value must be specified.")
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.default and (include_readonly or "default" not in excluded_fields):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            "allowed_values": [PresetWorkloadConstraintsResourceReferenceAllowedValues.from_dict(_item) for _item in obj["allowed_values"]] if obj.get("allowed_values") is not None else None,
            "default": ReferenceWithType.from_dict(obj["default"]) if obj.get("default") is not None else None
        })
        return _obj
