...
from pypureclient.flasharray.FA_2_41.models.remote_pod import RemotePod
...
class RemotePodsResponse(BaseModel):
    ...
    items: Optional[List[RemotePod]] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name where meaningful.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [RemotePod.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
