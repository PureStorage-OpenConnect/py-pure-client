...
class PresetWorkloadPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "revision", "workload_type", "parameters", "workload_tags", "placement_configurations", "qos_configurations", "snapshot_configurations", "periodic_replication_configurations", "volume_configurations"]
