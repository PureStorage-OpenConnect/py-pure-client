...
class WorkloadPlacementRecommendationTargetCapacityUsedProjections(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["projection", "days_until_full"]
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.projection and (include_readonly or "projection" not in excluded_fields):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            "projection": WorkloadPlacementRecommendationProjection.from_dict(obj["projection"]) if obj.get("projection") is not None else None,
