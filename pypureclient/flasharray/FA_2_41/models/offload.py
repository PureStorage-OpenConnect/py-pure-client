...
from pypureclient.flasharray.FA_2_41.models.offload_azure import OffloadAzure
from pypureclient.flasharray.FA_2_41.models.offload_google_cloud import OffloadGoogleCloud
from pypureclient.flasharray.FA_2_41.models.offload_nfs import OffloadNfs
from pypureclient.flasharray.FA_2_41.models.offload_s3 import OffloadS3
...
class Offload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["nfs", "s3", "azure", "google-cloud", "name", "context", "protocol", "target_id", "space", "status"]
