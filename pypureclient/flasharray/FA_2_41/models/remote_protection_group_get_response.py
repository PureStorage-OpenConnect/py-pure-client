...
class RemoteProtectionGroupGetResponse(BaseModel):
    ...
    items: Optional[List[RemoteProtectionGroup]] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name where meaningful.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [RemoteProtectionGroup.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
