...
class VolumePost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["destroyed", "provisioned", "qos", "priority_adjustment", "source", "subtype", "protocol_endpoint", "tags", "workload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "workload": WorkloadConfigurationReference.from_dict(obj["workload"]) if obj.get("workload") is not None else None
        })
        return _obj
