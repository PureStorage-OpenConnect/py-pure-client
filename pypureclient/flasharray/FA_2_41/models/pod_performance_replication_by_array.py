...
class PodPerformanceReplicationByArray(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["context", "continuous_bytes_per_sec", "resync_bytes_per_sec", "sync_bytes_per_sec", "periodic_bytes_per_sec", "total_bytes_per_sec", "pod", "time", "array"]
