...
class PolicyAssignmentPost(BaseModel):
    ...
    """ # noqa: E501
    policies: Optional[List[PolicyAssignmentPostPolicy]] = Field(default=None, description="A list of policies to apply to the resource. One of `id` or `name` is required in each `policy`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            "policies": [PolicyAssignmentPostPolicy.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj
