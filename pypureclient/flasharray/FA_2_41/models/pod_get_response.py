...
from pypureclient.flasharray.FA_2_41.models.pod import Pod
...
class PodGetResponse(BaseModel):
    ...
    total: Optional[conlist(Pod)] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field, if meaningful.")
