...
class SyslogServer(BaseModel):
    ...
    services: Optional[List[StrictStr]] = Field(default=None, description="Valid values are `data-audit` and `management`. If not specified, defaults to `management`.")
    __properties: ClassVar[List[str]] = ["name", "context", "target_type", "uri", "services"]
