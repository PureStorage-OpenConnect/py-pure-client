...
from pypureclient.flasharray.FA_2_41.models.container_eradication_config import ContainerEradicationConfig
from pypureclient.flasharray.FA_2_41.models.container_qos import ContainerQos
from pypureclient.flasharray.FA_2_41.models.space_no_deprecated_physical_or_effective import SpaceNoDeprecatedPhysicalOrEffective
...
class Realm(BaseModel):
    ...
    quota_limit: Optional[Annotated[int, Field(le=4503599627370496, strict=True)]] = Field(default=None, description="The logical quota limit of the realm, measured in bytes.")
    qos: Optional[ContainerQos] = Field(default=None, description="Displays QoS limit information.")
    __properties: ClassVar[List[str]] = ["id", "name", "created", "destroyed", "space", "time_remaining", "eradication_config", "quota_limit", "qos"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "space": SpaceNoDeprecatedPhysicalOrEffective.from_dict(obj["space"]) if obj.get("space") is not None else None,
            ...
            "qos": ContainerQos.from_dict(obj["qos"]) if obj.get("qos") is not None else None
        })
        return _obj
