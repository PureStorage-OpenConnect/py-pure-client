...
class PresetWorkloadSnapshotConfiguration(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the snapshot configuration, by which other configuration objects in the preset can reference it. Name must be unique across all configuration objects in the preset.")
