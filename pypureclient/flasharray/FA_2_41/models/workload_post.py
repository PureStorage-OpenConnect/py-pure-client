...
class WorkloadPost(BaseModel):
    ...
    WorkloadPost
    """ # noqa: E501
    parameters: Optional[List[WorkloadParameter]] = Field(default=None, description="The parameter values to pass to the preset when creating the workload. Value must be supplied for all parameters that do not have a default defined in the preset.")
