...
class ArrayPerformanceByLinkGetResponse(BaseModel):
    ...
    items: Optional[List[ArrayPerformanceByLink]] = Field(default=None, description="Array-level front-end I/O performance metrics grouped by link. A link represents a set of arrays that an I/O operation depends on.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [ArrayPerformanceByLink.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
