...
from pypureclient.flasharray.FA_2_41.models.audit import Audit
...
class AuditGetResponse(BaseModel):
    ...
    items: Optional[List[Audit]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [Audit.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
