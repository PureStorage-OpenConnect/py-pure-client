...
class AuditGetResponse(BaseModel):
    ...
    items: Optional[conlist(Audit)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditGetResponse:
        """Create an instance of AuditGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditGetResponse:
        """Create an instance of AuditGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditGetResponse.parse_obj(obj)

        _obj = AuditGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Audit.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
