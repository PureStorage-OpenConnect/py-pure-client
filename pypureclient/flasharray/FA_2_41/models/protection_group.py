...
from pypureclient.flasharray.FA_2_41.models.replication_schedule import ReplicationSchedule
from pypureclient.flasharray.FA_2_41.models.retention_policy import RetentionPolicy
from pypureclient.flasharray.FA_2_41.models.snapshot_schedule import SnapshotSchedule
from pypureclient.flasharray.FA_2_41.models.space import Space
from pypureclient.flasharray.FA_2_41.models.workload_configuration_fixed_reference_workload import WorkloadConfigurationFixedReferenceWorkload
...
class ProtectionGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "context", "workload", "destroyed", "host_count", "host_group_count", "is_local", "pod", "replication_schedule", "snapshot_schedule", "source", "source_retention", "space", "target_retention", "target_count", "time_remaining", "volume_count", "eradication_config", "retention_lock"]
