...
class PresetWorkloadQosConfiguration(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the QoS configuration, by which other configuration objects in the preset can reference it. Name must be unique across all configuration objects in the preset.")
    ...
    __properties: ClassVar[List[str]] = ["name", "iops_limit", "bandwidth_limit"]
