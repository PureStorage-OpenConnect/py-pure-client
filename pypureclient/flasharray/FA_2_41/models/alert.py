...
class Alert(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "context", "actual", "category", "closed", "code", "component_name", "component_type", "created", "description", "expected", "flagged", "issue", "knowledge_base_url", "notified", "severity", "state", "summary", "updated"]
