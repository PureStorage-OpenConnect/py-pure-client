...
from pypureclient.flasharray.FA_2_41.models.member_no_id_member import MemberNoIdMember


class MemberNoIdMemberGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(MemberNoIdMember)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MemberNoIdMemberGetResponse:
        """Create an instance of MemberNoIdMemberGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> MemberNoIdMemberGetResponse:
        """Create an instance of MemberNoIdMemberGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MemberNoIdMemberGetResponse.parse_obj(obj)

        _obj = MemberNoIdMemberGetResponse.construct(_fields_set=None, **{
            ...
            "items": [MemberNoIdMember.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
