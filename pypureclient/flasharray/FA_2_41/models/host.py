...
from pypureclient.flasharray.FA_2_41.models.host_port_connectivity import HostPortConnectivity
...
class Host(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "context", "chap", "connection_count", "host_group", "iqns", "nqns", "personality", "port_connectivity", "space", "preferred_arrays", "wwns", "is_local", "vlan", "destroyed", "time_remaining"]
