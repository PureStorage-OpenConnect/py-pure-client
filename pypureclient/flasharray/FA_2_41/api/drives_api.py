...
from pypureclient.flasharray.FA_2_41.models.drive_get_response import DriveGetResponse
from pypureclient.flasharray.FA_2_41.models.drive_response import DriveResponse
...
class DrivesApi:
    ...
    def api241_drives_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_drives_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api241_drives_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_drives_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_drives_patch_with_http_info(authorization, x_request_id, admit, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_drives_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
