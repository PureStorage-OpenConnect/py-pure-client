...
from pypureclient.flasharray.FA_2_41.models.workload_get_response import WorkloadGetResponse
from pypureclient.flasharray.FA_2_41.models.workload_patch import WorkloadPatch
from pypureclient.flasharray.FA_2_41.models.workload_placement_recommendation import WorkloadPlacementRecommendation
from pypureclient.flasharray.FA_2_41.models.workload_placement_recommendation_get_response import WorkloadPlacementRecommendationGetResponse
from pypureclient.flasharray.FA_2_41.models.workload_placement_recommendation_response import WorkloadPlacementRecommendationResponse
from pypureclient.flasharray.FA_2_41.models.workload_post import WorkloadPost
from pypureclient.flasharray.FA_2_41.models.workload_response import WorkloadResponse
...
class WorkloadsApi:
    ...
    def api241_workloads_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_workloads_delete_with_http_info(authorization, x_request_id, context_names, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api241_workloads_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_workloads_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_workloads_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, destroyed, ids, limit, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_workloads_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_workloads_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_workloads_patch_with_http_info(workload, authorization, x_request_id, context_names, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_workloads_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_workloads_placement_recommendations_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_workloads_placement_recommendations_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, ids, limit, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_workloads_placement_recommendations_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_workloads_placement_recommendations_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_workloads_placement_recommendations_post_with_http_info(inputs, authorization, x_request_id, context_names, placement_names, preset_ids, preset_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_workloads_placement_recommendations_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_workloads_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_workloads_post_with_http_info(names, workload, authorization, x_request_id, context_names, preset_ids, preset_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_workloads_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_workloads_tags_batch_put_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_workloads_tags_batch_put_with_http_info(tag, authorization, x_request_id, context_names, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_workloads_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_workloads_tags_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_workloads_tags_delete_with_http_info(authorization, x_request_id, context_names, keys, namespaces, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_workloads_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_workloads_tags_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_workloads_tags_get_with_http_info(authorization, x_request_id, allow_errors, context_names, namespaces, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_workloads_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
