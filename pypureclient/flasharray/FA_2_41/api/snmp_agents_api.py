...
from pypureclient.flasharray.FA_2_41.models.snmp_agent_get_response import SnmpAgentGetResponse
from pypureclient.flasharray.FA_2_41.models.snmp_agent_mib_get_response import SnmpAgentMibGetResponse
from pypureclient.flasharray.FA_2_41.models.snmp_agent_patch import SnmpAgentPatch
from pypureclient.flasharray.FA_2_41.models.snmp_agent_response import SnmpAgentResponse
...
class SNMPAgentsApi:
    ...
    def api241_snmp_agents_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_snmp_agents_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api241_snmp_agents_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_snmp_agents_mib_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_snmp_agents_mib_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_snmp_agents_mib_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_snmp_agents_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_snmp_agents_patch_with_http_info(snmp_agent, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_snmp_agents_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
