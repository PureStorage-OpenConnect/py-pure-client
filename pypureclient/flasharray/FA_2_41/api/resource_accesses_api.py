...
from pypureclient.flasharray.FA_2_41.models.resource_accesses_get_response import ResourceAccessesGetResponse
from pypureclient.flasharray.FA_2_41.models.resource_accesses_response import ResourceAccessesResponse
from pypureclient.flasharray.FA_2_41.models.resource_accesses_status_get_response import ResourceAccessesStatusGetResponse
...
class ResourceAccessesApi:
    ...
    def api241_resource_accesses_batch_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_resource_accesses_batch_post_with_http_info(items, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api241_resource_accesses_batch_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_resource_accesses_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_resource_accesses_delete_with_http_info(authorization, x_request_id, ids, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_resource_accesses_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_resource_accesses_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_resource_accesses_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_resource_accesses_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_resource_accesses_status_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_resource_accesses_status_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_resource_accesses_status_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
