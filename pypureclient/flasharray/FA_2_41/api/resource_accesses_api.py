...
class ResourceAccessesApi:
    ...
    def api241_resource_accesses_batch_post_with_http_info(
        ...
        _param = self._api241_resource_accesses_batch_post_serialize(
            items = items,
    ...
    def _api241_resource_accesses_batch_post_serialize(
        self,
        items,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2.41/resource-accesses/batch',
    ...
    def api241_resource_accesses_delete_with_http_info(
        ...
        _param = self._api241_resource_accesses_delete_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            ids = ids,
        )
    ...
    def _api241_resource_accesses_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.41/resource-accesses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api241_resource_accesses_get_with_http_info(
        ...
        _param = self._api241_resource_accesses_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api241_resource_accesses_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api241_resource_accesses_status_get_with_http_info(
        ...
        _param = self._api241_resource_accesses_status_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api241_resource_accesses_status_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.41/resource-accesses/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
