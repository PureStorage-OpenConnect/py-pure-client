...
class RemoteArraysApi:
    ...
    def api241_remote_arrays_get_with_http_info(
    ...
    ) -> ApiResponse[RemoteArraysResponse]:
        """List remote arrays
        ...
        _param = self._api241_remote_arrays_get_serialize(
    ...
    def _api241_remote_arrays_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        if current_fleet_only is not None:
            
            _query_params.append(('current_fleet_only', current_fleet_only))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.41/remote-arrays',
