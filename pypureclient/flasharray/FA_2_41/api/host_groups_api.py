...
from pypureclient.flasharray.FA_2_41.models.host_group_get_response import HostGroupGetResponse
from pypureclient.flasharray.FA_2_41.models.host_group_patch import HostGroupPatch
from pypureclient.flasharray.FA_2_41.models.host_group_post import HostGroupPost
from pypureclient.flasharray.FA_2_41.models.host_group_response import HostGroupResponse
...
class HostGroupsApi:
    ...
    def api241_host_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_delete_with_http_info(authorization, x_request_id, context_names, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api241_host_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, destroyed, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_hosts_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_hosts_delete_with_http_info(authorization, x_request_id, context_names, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_hosts_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_hosts_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, group_names, limit, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_hosts_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_hosts_post_with_http_info(authorization, x_request_id, context_names, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_patch_with_http_info(host_group, authorization, x_request_id, context_names, from_member_ids, from_member_names, modify_resource_access, names, to_member_ids, to_member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_performance_by_array_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_performance_by_array_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, end_time, filter, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_performance_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, end_time, filter, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_post_with_http_info(authorization, x_request_id, context_names, names, host_group, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_protection_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_protection_groups_delete_with_http_info(authorization, x_request_id, context_names, group_ids, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_protection_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_protection_groups_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, group_ids, group_names, limit, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_protection_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_protection_groups_post_with_http_info(authorization, x_request_id, context_names, group_ids, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_space_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_space_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_tags_batch_put_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_tags_batch_put_with_http_info(tag, authorization, x_request_id, context_names, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_tags_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_tags_delete_with_http_info(authorization, x_request_id, context_names, keys, namespaces, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api241_host_groups_tags_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api241_host_groups_tags_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, limit, namespaces, offset, resource_destroyed, resource_ids, resource_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api241_host_groups_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
