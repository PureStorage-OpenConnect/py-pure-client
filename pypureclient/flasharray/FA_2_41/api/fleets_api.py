...
class FleetsApi:
    ...
    def api241_fleets_delete_with_http_info(
        ...
        _param = self._api241_fleets_delete_serialize(
    ...
    def _api241_fleets_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
    ...
    def api241_fleets_fleet_key_get_with_http_info(
        ...
        _param = self._api241_fleets_fleet_key_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api241_fleets_fleet_key_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.41/fleets/fleet-key',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api241_fleets_fleet_key_post_with_http_info(
        ...
        _param = self._api241_fleets_fleet_key_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
        )
    ...
    def _api241_fleets_fleet_key_post_serialize(
        self,
        authorization,
        x_request_id,
    ) -> RequestSerialized:
    ...
    def api241_fleets_get_with_http_info(
        ...
        _param = self._api241_fleets_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api241_fleets_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api241_fleets_members_delete_with_http_info(
        ...
        _param = self._api241_fleets_members_delete_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api241_fleets_members_delete_serialize(
        self,
        authorization,
        x_request_id,
        member_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.41/fleets/members',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api241_fleets_members_get_with_http_info(
        ...
        _param = self._api241_fleets_members_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api241_fleets_members_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api241_fleets_members_post_with_http_info(
        ...
        _param = self._api241_fleets_members_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            fleet_ids = fleet_ids,
            fleet_names = fleet_names,
    ...
    def _api241_fleets_members_post_serialize(
        self,
        authorization,
        x_request_id,
        fleet_ids,
    ...
    def api241_fleets_patch_with_http_info(
        ...
        _param = self._api241_fleets_patch_serialize(
            fleet = fleet,
            authorization = authorization,
            x_request_id = x_request_id,
            ids = ids,
    ...
    def _api241_fleets_patch_serialize(
        self,
        fleet,
        authorization,
        x_request_id,
    ...
    def api241_fleets_post_with_http_info(
        ...
        _param = self._api241_fleets_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api241_fleets_post_serialize(
        self,
        authorization,
        x_request_id,
        names,
