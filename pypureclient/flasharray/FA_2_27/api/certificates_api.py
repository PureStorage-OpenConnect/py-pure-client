...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_27.models.certificate_get_response import CertificateGetResponse
from pypureclient.flasharray.FA_2_27.models.certificate_post import CertificatePost
from pypureclient.flasharray.FA_2_27.models.certificate_response import CertificateResponse
from pypureclient.flasharray.FA_2_27.models.certificate_signing_request_post import CertificateSigningRequestPost
from pypureclient.flasharray.FA_2_27.models.certificate_signing_request_response import CertificateSigningRequestResponse
...
class CertificatesApi:
    ...
    def api227_certificates_certificate_signing_requests_post_with_http_info(
        ...
        _param = self._api227_certificates_certificate_signing_requests_post_serialize(
    ...
    def _api227_certificates_certificate_signing_requests_post_serialize(
        self,
        certificate,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2.27/certificates/certificate-signing-requests',
    ...
    def api227_certificates_delete_with_http_info(
        ...
        _param = self._api227_certificates_delete_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api227_certificates_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.27/certificates',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api227_certificates_get_with_http_info(
        ...
        _param = self._api227_certificates_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api227_certificates_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api227_certificates_patch_with_http_info(
        ...
        _param = self._api227_certificates_patch_serialize(
            certificate = certificate,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api227_certificates_patch_serialize(
        self,
        certificate,
        authorization,
        x_request_id,
    ...
    def api227_certificates_post_with_http_info(
        ...
        _param = self._api227_certificates_post_serialize(
            certificate = certificate,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api227_certificates_post_serialize(
        self,
        certificate,
        authorization,
        x_request_id,
