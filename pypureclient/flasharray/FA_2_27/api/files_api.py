...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_27.models.file_post import FilePost
...
class FilesApi:
    ...
    def api227_files_post_with_http_info(
        ...
        _param = self._api227_files_post_serialize(
    ...
    def _api227_files_post_serialize(
        self,
        source_file,
        authorization,
        x_request_id,
