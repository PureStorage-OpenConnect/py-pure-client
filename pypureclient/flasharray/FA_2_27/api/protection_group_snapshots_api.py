...
class ProtectionGroupSnapshotsApi:
    ...
    def api227_protection_group_snapshots_delete_with_http_info(
        ...
        _param = self._api227_protection_group_snapshots_delete_serialize(
    ...
    def _api227_protection_group_snapshots_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.27/protection-group-snapshots',
    ...
    def api227_protection_group_snapshots_get_with_http_info(
        ...
        _param = self._api227_protection_group_snapshots_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api227_protection_group_snapshots_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api227_protection_group_snapshots_patch_with_http_info(
        ...
        _param = self._api227_protection_group_snapshots_patch_serialize(
    ...
    def _api227_protection_group_snapshots_patch_serialize(
        self,
    ...
    def api227_protection_group_snapshots_post_with_http_info(
        ...
        _param = self._api227_protection_group_snapshots_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api227_protection_group_snapshots_post_serialize(
        self,
        authorization,
        x_request_id,
        apply_retention,
    ...
    def api227_protection_group_snapshots_replica_post_with_http_info(
        ...
        ids: Annotated[Optional[List[StrictStr]], Field(description="Performs the operation on the unique resource IDs specified. Enter multiple resource IDs in comma-separated format. The `ids` or `names` parameter is required, but they cannot be set together.")] = None,
        names: Annotated[Optional[List[StrictStr]], Field(description="Performs the operation on the unique name specified. Enter multiple names in comma-separated format. For example, `name01,name02`.")] = None,
        on: Annotated[Optional[List[StrictStr]], Field(description="Performs the operation locally with the target names specified as the destinations of the operation. Enter multiple target names in comma-separated format. For example, `targetName01,targetName02`.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[ProtectionGroupSnapshotReplicaResponse]:
        ...
        _param = self._api227_protection_group_snapshots_replica_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api227_protection_group_snapshots_replica_post_serialize(
        self,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2.27/protection-group-snapshots/replica',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api227_protection_group_snapshots_test_post_with_http_info(
        ...
        _param = self._api227_protection_group_snapshots_test_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            apply_retention = apply_retention,
            for_replication = for_replication,
    ...
    def _api227_protection_group_snapshots_test_post_serialize(
        self,
        authorization,
        x_request_id,
        apply_retention,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2.27/protection-group-snapshots/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api227_protection_group_snapshots_transfer_get_with_http_info(
        ...
        _param = self._api227_protection_group_snapshots_transfer_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            destroyed = destroyed,
            filter = filter,
    ...
    def _api227_protection_group_snapshots_transfer_get_serialize(
        self,
        authorization,
        x_request_id,
        destroyed,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.27/protection-group-snapshots/transfer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
