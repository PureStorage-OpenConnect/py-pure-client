...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_27.models.audit_get_response import AuditGetResponse
...
class AuditsApi:
    ...
    def api227_audits_get_with_http_info(
        ...
        _param = self._api227_audits_get_serialize(
    ...
    def _api227_audits_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
