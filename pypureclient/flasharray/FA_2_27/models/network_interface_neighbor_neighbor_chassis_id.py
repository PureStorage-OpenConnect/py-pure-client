...
class NetworkInterfaceNeighborNeighborChassisId(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkInterfaceNeighborNeighborChassisId:
        """Create an instance of NetworkInterfaceNeighborNeighborChassisId from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkInterfaceNeighborNeighborChassisId:
        """Create an instance of NetworkInterfaceNeighborNeighborChassisId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkInterfaceNeighborNeighborChassisId.parse_obj(obj)

        _obj = NetworkInterfaceNeighborNeighborChassisId.construct(_fields_set=None, **{
            "type": obj.get("type"),
            "value": obj.get("value")
        })
        return _obj
