...
from pypureclient.flasharray.FA_2_27.models.networkinterfacepost_eth import NetworkinterfacepostEth
...
class NetworkInterfacePost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "services", "eth"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "eth": NetworkinterfacepostEth.from_dict(obj["eth"]) if obj.get("eth") is not None else None
        })
        return _obj
