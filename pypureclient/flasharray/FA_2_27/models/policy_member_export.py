...
from pypureclient.flasharray.FA_2_27.models.fixed_reference_with_type import FixedReferenceWithType
...
class PolicyMemberExport(BaseModel):
    ...
    export_name: Optional[StrictStr] = Field(default=None, description="The export name used to access this export.")
    __properties = ["destroyed", "enabled", "member", "policy", "time_remaining", "export_name"]
