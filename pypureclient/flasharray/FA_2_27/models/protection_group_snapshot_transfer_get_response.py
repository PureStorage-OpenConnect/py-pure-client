...
class ProtectionGroupSnapshotTransferGetResponse(BaseModel):
    ...
    items: Optional[List[ProtectionGroupSnapshotTransfer]] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
