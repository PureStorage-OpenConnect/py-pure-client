...
from pypureclient.flasharray.FA_2_27.models.protection_group_snapshot_transfer import ProtectionGroupSnapshotTransfer
...
class ProtectionGroupSnapshotTransferGetResponse(BaseModel):
    ...
    items: Optional[conlist(ProtectionGroupSnapshotTransfer)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
