...
class NetworkinterfacepostEth(BaseModel):
    ...
    subinterfaces: Optional[List[ReferenceNoId]] = Field(default=None, description="List of network interfaces configured to be a subinterface of the specified network interface.")
    ...
    __properties: ClassVar[List[str]] = ["address", "subinterfaces", "subnet", "subtype"]
