...
class ProtectionGroupSnapshotGetResponse(BaseModel):
    ...
    items: Optional[List[ProtectionGroupSnapshot]] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
