...
from pypureclient.flasharray.FA_2_22.models.kmip_get_response import KmipGetResponse
from pypureclient.flasharray.FA_2_22.models.kmip_patch import KmipPatch
from pypureclient.flasharray.FA_2_22.models.kmip_post import KmipPost
from pypureclient.flasharray.FA_2_22.models.kmip_response import KmipResponse
from pypureclient.flasharray.FA_2_22.models.kmip_test_result_get_response import KmipTestResultGetResponse
...
class KMIPApi:
    ...
    def api222_kmip_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_kmip_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api222_kmip_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_kmip_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_kmip_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_kmip_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_kmip_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_kmip_patch_with_http_info(kmip, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_kmip_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_kmip_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_kmip_post_with_http_info(kmip, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_kmip_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_kmip_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_kmip_test_get_with_http_info(names, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_kmip_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
