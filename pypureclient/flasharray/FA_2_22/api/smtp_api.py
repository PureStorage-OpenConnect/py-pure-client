...
class SMTPApi:
    ...
    def api222_smtp_servers_get_with_http_info(
    ...
    ) -> ApiResponse[SmtpServerGetResponse]:
        ...
        _param = self._api222_smtp_servers_get_serialize(
    ...
    def _api222_smtp_servers_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.22/smtp-servers',
    ...
    def api222_smtp_servers_patch_with_http_info(
        ...
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[SmtpServerResponse]:
        ...
        _param = self._api222_smtp_servers_patch_serialize(
            smtp = smtp,
            authorization = authorization,
            x_request_id = x_request_id,
        )
    ...
    def _api222_smtp_servers_patch_serialize(
        self,
        smtp,
        authorization,
        x_request_id,
