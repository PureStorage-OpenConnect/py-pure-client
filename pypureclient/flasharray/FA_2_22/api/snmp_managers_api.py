...
from pypureclient.flasharray.FA_2_22.models.snmp_manager_get_response import SnmpManagerGetResponse
from pypureclient.flasharray.FA_2_22.models.snmp_manager_patch import SnmpManagerPatch
from pypureclient.flasharray.FA_2_22.models.snmp_manager_post import SnmpManagerPost
from pypureclient.flasharray.FA_2_22.models.snmp_manager_response import SnmpManagerResponse
...
class SNMPManagersApi:
    ...
    def api222_snmp_managers_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_snmp_managers_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api222_snmp_managers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_snmp_managers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_snmp_managers_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_snmp_managers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_snmp_managers_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_snmp_managers_patch_with_http_info(snmp_manager, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_snmp_managers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_snmp_managers_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_snmp_managers_post_with_http_info(snmp_manager, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_snmp_managers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_snmp_managers_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_snmp_managers_test_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_snmp_managers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
