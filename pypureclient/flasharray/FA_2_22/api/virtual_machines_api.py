...
from pypureclient.flasharray.FA_2_22.models.virtual_machine_get_response import VirtualMachineGetResponse
from pypureclient.flasharray.FA_2_22.models.virtual_machine_post import VirtualMachinePost
from pypureclient.flasharray.FA_2_22.models.virtual_machine_response import VirtualMachineResponse
...
class VirtualMachinesApi:
    ...
    def api222_virtual_machine_snapshots_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_virtual_machine_snapshots_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, limit, offset, sort, total_item_count, vm_ids, vm_type, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api222_virtual_machine_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_virtual_machines_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_virtual_machines_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, limit, offset, sort, total_item_count, vm_ids, vm_type, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_virtual_machines_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_virtual_machines_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_virtual_machines_patch_with_http_info(virtual_machine, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_virtual_machines_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_virtual_machines_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api222_virtual_machines_post_with_http_info(virtual_machine, authorization, x_request_id, overwrite, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_virtual_machines_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
