...
class NetworkInterfacesApi:
    ...
    def api222_network_interfaces_delete_with_http_info(
        ...
        _param = self._api222_network_interfaces_delete_serialize(
    ...
    def _api222_network_interfaces_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.22/network-interfaces',
    ...
    def api222_network_interfaces_get_with_http_info(
        ...
        _param = self._api222_network_interfaces_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api222_network_interfaces_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api222_network_interfaces_neighbors_get_with_http_info(
        ...
        filter: Annotated[Optional[StrictStr], Field(description="Narrows down the results to only the response objects that satisfy the filter criteria.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Limits the size of the response to the specified number of objects on each page. To return the total number of resources, set `limit=0`. The total number of resources is returned as a `total_item_count` value. If the page size requested is larger than the system maximum limit, the server returns the maximum limit, disregarding the requested page size.")] = None,
        local_port_names: Annotated[Optional[List[StrictStr]], Field(description="Performs the operation on the unique local port name specified. Enter multiple names in comma-separated format. For example, `ct0.eth0,ct1.eth0`.")] = None,
        sort: Annotated[Optional[List[Annotated[str, Field(strict=True)]]], Field(description="Returns the response objects in the order specified. Set `sort` to the name in the response by which to sort. Sorting can be performed on any of the names in the response, and the objects can be sorted in ascending or descending order. By default, the response objects are sorted in ascending order. To sort in descending order, append the minus sign (`-`) to the name. A single request can be sorted on multiple objects. For example, you can sort all volumes from largest to smallest volume size, and then sort volumes of the same size in ascending order by volume name. To sort on multiple names, list the names as comma-separated values.")] = None,
        total_item_count: Annotated[Optional[StrictBool], Field(description="If set to `true`, the `total_item_count` matching the specified query parameters is calculated and returned in the response. If set to `false`, the `total_item_count` is `null` in the response. This may speed up queries where the `total_item_count` is large. If not specified, defaults to `false`.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[NetworkInterfaceNeighborGetResponse]:
        ...
        _param = self._api222_network_interfaces_neighbors_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api222_network_interfaces_neighbors_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        if local_port_names is not None:
            ...
            _query_params.append(('local_port_names', local_port_names))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.22/network-interfaces/neighbors',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api222_network_interfaces_patch_with_http_info(
        ...
        _param = self._api222_network_interfaces_patch_serialize(
            network = network,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api222_network_interfaces_patch_serialize(
        self,
        network,
        authorization,
        x_request_id,
    ...
    def api222_network_interfaces_performance_get_with_http_info(
        ...
        _param = self._api222_network_interfaces_performance_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            end_time = end_time,
    ...
    def _api222_network_interfaces_performance_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.22/network-interfaces/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api222_network_interfaces_port_details_get_with_http_info(
        ...
        total_item_count: Annotated[Optional[StrictBool], Field(description="If set to `true`, the `total_item_count` matching the specified query parameters is calculated and returned in the response. If set to `false`, the `total_item_count` is `null` in the response. This may speed up queries where the `total_item_count` is large. If not specified, defaults to `false`.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[NetworkInterfacesPortDetailsGetResponse]:
        ...
        _param = self._api222_network_interfaces_port_details_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api222_network_interfaces_port_details_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.22/network-interfaces/port-details',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api222_network_interfaces_post_with_http_info(
        ...
        _param = self._api222_network_interfaces_post_serialize(
            network = network,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api222_network_interfaces_post_serialize(
        self,
        network,
        authorization,
        x_request_id,
