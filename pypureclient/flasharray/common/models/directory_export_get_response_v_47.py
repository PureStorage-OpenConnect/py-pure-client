...
from pypureclient.flasharray.common.models.export_policy_attachment_mixin_v_32 import ExportPolicyAttachmentMixin
...
from pypureclient.flasharray.common.models.server_reference_v_44 import ServerReference
...
from pypureclient.flasharray.common.models.directory_export_v_47 import DirectoryExport
from pypureclient.flasharray.common.models.errorcontextresponse_errors_v_38 import ErrorcontextresponseErrors


class DirectoryExportGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(DirectoryExport)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryExportGetResponse:
        """Create an instance of DirectoryExportGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryExportGetResponse:
        """Create an instance of DirectoryExportGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryExportGetResponse.parse_obj(obj)

        _obj = DirectoryExportGetResponse.construct(_fields_set=None, **{
            ...
            "items": [DirectoryExport.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
