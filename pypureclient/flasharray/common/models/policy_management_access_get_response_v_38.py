...
from pypureclient.flasharray.common.models.policyrulemanagementaccess_rules_v_36 import PolicyrulemanagementaccessRules
...
from pypureclient.flasharray.common.models.policy_management_access_v_38 import PolicyManagementAccess


class PolicyManagementAccessGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyManagementAccess)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyManagementAccessGetResponse:
        """Create an instance of PolicyManagementAccessGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyManagementAccessGetResponse:
        """Create an instance of PolicyManagementAccessGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyManagementAccessGetResponse.parse_obj(obj)

        _obj = PolicyManagementAccessGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyManagementAccess.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
