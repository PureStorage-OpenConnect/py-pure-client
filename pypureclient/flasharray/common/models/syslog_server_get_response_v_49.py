...
from pypureclient.flasharray.common.models.log_target_v_49 import LogTarget
from pypureclient.flasharray.common.models.context_v_49 import Context
from pypureclient.flasharray.common.models.fixed_name_resource_no_id_v_2 import FixedNameResourceNoId
...
class SyslogServerGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SyslogServer)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyslogServerGetResponse:
        """Create an instance of SyslogServerGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SyslogServerGetResponse:
        """Create an instance of SyslogServerGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyslogServerGetResponse.parse_obj(obj)

        _obj = SyslogServerGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SyslogServer.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
