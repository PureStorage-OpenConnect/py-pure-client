...
from pypureclient.flasharray.common.models.policy_smb_v_49 import PolicySmb


class PolicySmbGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicySmb)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicySmbGetResponse:
        """Create an instance of PolicySmbGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicySmbGetResponse:
        """Create an instance of PolicySmbGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicySmbGetResponse.parse_obj(obj)

        _obj = PolicySmbGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicySmb.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
