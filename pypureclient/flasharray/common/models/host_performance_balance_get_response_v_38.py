...
from pypureclient.flasharray.common.models.port_initiator_target_v_38 import PortInitiatorTarget
from pypureclient.flasharray.common.models.base_port_v_38 import BasePort
...
from pypureclient.flasharray.common.models.port_common_v_2 import PortCommon
...
from pypureclient.flasharray.common.models.host_performance_balance_v_38 import HostPerformanceBalance


class HostPerformanceBalanceGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(HostPerformanceBalance)] = Field(default=None, description="A list of entries indicating count and percentage of I/O operations across various data paths between the host and the array.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HostPerformanceBalanceGetResponse:
        """Create an instance of HostPerformanceBalanceGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> HostPerformanceBalanceGetResponse:
        """Create an instance of HostPerformanceBalanceGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HostPerformanceBalanceGetResponse.parse_obj(obj)

        _obj = HostPerformanceBalanceGetResponse.construct(_fields_set=None, **{
            ...
            "items": [HostPerformanceBalance.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
