...
from pypureclient.flasharray.common.models.protection_group_performance_array_v_38 import ProtectionGroupPerformanceArray
...
class ProtectionGroupPerformanceArrayResponse(BaseModel):
    ...
    items: Optional[conlist(ProtectionGroupPerformanceArray)] = Field(default=None, description="Lists performance data, broken down by array.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProtectionGroupPerformanceArrayResponse:
        """Create an instance of ProtectionGroupPerformanceArrayResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ProtectionGroupPerformanceArrayResponse:
        """Create an instance of ProtectionGroupPerformanceArrayResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProtectionGroupPerformanceArrayResponse.parse_obj(obj)

        _obj = ProtectionGroupPerformanceArrayResponse.construct(_fields_set=None, **{
            ...
            "items": [ProtectionGroupPerformanceArray.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
