...
from pypureclient.flasharray.common.models.directory_quota_v_42 import DirectoryQuota
from pypureclient.flasharray.common.models.errorcontextresponse_errors_v_38 import ErrorcontextresponseErrors


class DirectoryQuotasGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(DirectoryQuota)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryQuotasGetResponse:
        """Create an instance of DirectoryQuotasGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryQuotasGetResponse:
        """Create an instance of DirectoryQuotasGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryQuotasGetResponse.parse_obj(obj)

        _obj = DirectoryQuotasGetResponse.construct(_fields_set=None, **{
            ...
            "items": [DirectoryQuota.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
