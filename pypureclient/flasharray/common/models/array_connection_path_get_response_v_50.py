...
from pypureclient.flasharray.common.models.array_connection_path_v_50 import ArrayConnectionPath
from pypureclient.flasharray.common.models.errorcontextresponse_errors_v_49 import ErrorcontextresponseErrors


class ArrayConnectionPathGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ArrayConnectionPath)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayConnectionPathGetResponse:
        """Create an instance of ArrayConnectionPathGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayConnectionPathGetResponse:
        """Create an instance of ArrayConnectionPathGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayConnectionPathGetResponse.parse_obj(obj)

        _obj = ArrayConnectionPathGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ArrayConnectionPath.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
