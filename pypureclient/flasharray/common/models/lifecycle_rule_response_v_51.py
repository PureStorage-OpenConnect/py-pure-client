...
class LifecycleRuleResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LifecycleRuleResponse:
        """Create an instance of LifecycleRuleResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LifecycleRuleResponse:
        """Create an instance of LifecycleRuleResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LifecycleRuleResponse.parse_obj(obj)

        _obj = LifecycleRuleResponse.construct(_fields_set=None, **{
