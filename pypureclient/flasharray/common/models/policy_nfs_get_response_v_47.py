...
from pypureclient.flasharray.common.models.policy_nfs_v_47 import PolicyNfs


class PolicyNfsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyNfs)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyNfsGetResponse:
        """Create an instance of PolicyNfsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyNfsGetResponse:
        """Create an instance of PolicyNfsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyNfsGetResponse.parse_obj(obj)

        _obj = PolicyNfsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyNfs.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
