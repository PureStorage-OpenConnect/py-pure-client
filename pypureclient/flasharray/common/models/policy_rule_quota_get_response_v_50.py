...
from pypureclient.flasharray.common.models.policy_rule_quota_v_50 import PolicyRuleQuota


class PolicyRuleQuotaGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyRuleQuota)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleQuotaGetResponse:
        """Create an instance of PolicyRuleQuotaGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleQuotaGetResponse:
        """Create an instance of PolicyRuleQuotaGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleQuotaGetResponse.parse_obj(obj)

        _obj = PolicyRuleQuotaGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyRuleQuota.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
