...
from pypureclient.flasharray.common.models.volume_common_v_10 import VolumeCommon
from pypureclient.flasharray.common.models.volume_space_common_v_9 import VolumeSpaceCommon
...
from pypureclient.flasharray.common.models.volume_v_10 import Volume
...
class VolumeGetResponse(BaseModel):
    ...
    items: Optional[conlist(Volume)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful. If `total_only=true`, the `items` list is empty.")
    total: Optional[conlist(Volume)] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field, if meaningful.")
