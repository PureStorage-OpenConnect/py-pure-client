...
class Bucket(BaseModel):
    ...
    account: Optional[FixedReferenceWithType] = None
    created: Optional[StrictInt] = Field(default=None, description="The bucket creation time in milliseconds since the UNIX epoch.")
    destroyed: Optional[StrictBool] = Field(default=None, description="Returns `true` if the bucket has been destroyed and is pending eradication. The `time_remaining` value displays the amount of time left until the destroyed bucket is permanently eradicated. Once the `time_remaining` period has elapsed, the bucket is permanently eradicated and can no longer be recovered.")
    object_count: Optional[StrictInt] = Field(default=None, description="The count of objects within the bucket.")
    time_remaining: Optional[StrictInt] = Field(default=None, description="The time in milliseconds before the bucket is eradicated. Returns `null` if the bucket is not destroyed.")
    ...
    space: Optional[Space] = Field(default=None, description="The size and space consumption details.")
    __properties = ["id", "name", "context", "account", "created", "destroyed", "object_count", "time_remaining", "versioning", "space"]
