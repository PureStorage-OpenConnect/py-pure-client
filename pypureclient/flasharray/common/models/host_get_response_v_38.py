...
from pypureclient.flasharray.common.models.host_v_38 import Host
...
class HostGetResponse(BaseModel):
    ...
    items: Optional[conlist(Host)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HostGetResponse:
        """Create an instance of HostGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> HostGetResponse:
        """Create an instance of HostGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HostGetResponse.parse_obj(obj)

        _obj = HostGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Host.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
