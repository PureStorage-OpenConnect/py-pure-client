...
from pypureclient.flasharray.common.models.policy_v_47 import Policy
...
from pypureclient.flasharray.common.models.policy_audit_file_v_47 import PolicyAuditFile


class PolicyAuditFileGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyAuditFile)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyAuditFileGetResponse:
        """Create an instance of PolicyAuditFileGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyAuditFileGetResponse:
        """Create an instance of PolicyAuditFileGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyAuditFileGetResponse.parse_obj(obj)

        _obj = PolicyAuditFileGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyAuditFile.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
