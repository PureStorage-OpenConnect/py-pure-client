...
from pypureclient.flasharray.common.models.member_no_id_all_v_47 import MemberNoIdAll


class MemberNoIdAllGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(MemberNoIdAll)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name where meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MemberNoIdAllGetResponse:
        """Create an instance of MemberNoIdAllGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> MemberNoIdAllGetResponse:
        """Create an instance of MemberNoIdAllGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MemberNoIdAllGetResponse.parse_obj(obj)

        _obj = MemberNoIdAllGetResponse.construct(_fields_set=None, **{
            ...
            "items": [MemberNoIdAll.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
