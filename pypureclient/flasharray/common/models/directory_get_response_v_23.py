...
from pypureclient.flasharray.common.models.limited_by_v_7 import LimitedBy
...
from pypureclient.flasharray.common.models.directory_v_23 import Directory
...
class DirectoryGetResponse(BaseModel):
    ...
    items: Optional[conlist(Directory)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if applicable.")
    total: Optional[conlist(Directory)] = Field(default=None, description="The aggregate value of all items after filtering. If applicable, the average value is displayed instead. The values are displayed for each field, if applicable.")
