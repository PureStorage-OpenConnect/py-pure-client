...
from pypureclient.flasharray.common.models.space_v_23 import Space
...
from pypureclient.flasharray.common.models.protection_group_snapshot_v_23 import ProtectionGroupSnapshot
...
class ProtectionGroupSnapshotGetResponse(BaseModel):
    ...
    items: Optional[conlist(ProtectionGroupSnapshot)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
