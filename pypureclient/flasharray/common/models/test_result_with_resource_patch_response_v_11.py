...
from pypureclient.flasharray.common.models.test_result_with_resource_v_2 import TestResultWithResource


class TestResultWithResourcePatchResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultWithResourcePatchResponse:
        """Create an instance of TestResultWithResourcePatchResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TestResultWithResourcePatchResponse:
        """Create an instance of TestResultWithResourcePatchResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultWithResourcePatchResponse.parse_obj(obj)

        _obj = TestResultWithResourcePatchResponse.construct(_fields_set=None, **{
