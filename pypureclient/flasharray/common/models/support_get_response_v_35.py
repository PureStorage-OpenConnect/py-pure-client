...
from pypureclient.flasharray.common.models.support_v_35 import Support
...
class SupportGetResponse(BaseModel):
    ...
    items: Optional[conlist(Support)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupportGetResponse:
        """Create an instance of SupportGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SupportGetResponse:
        """Create an instance of SupportGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupportGetResponse.parse_obj(obj)

        _obj = SupportGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Support.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
