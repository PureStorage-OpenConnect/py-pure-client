...
class PodPerformance(BaseModel):
    """
    PodPerformance
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PodPerformance:
        """Create an instance of PodPerformance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PodPerformance:
        """Create an instance of PodPerformance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PodPerformance.parse_obj(obj)

        _obj = PodPerformance.construct(_fields_set=None, **{
