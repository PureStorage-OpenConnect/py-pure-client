...
class ErrorContextResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ErrorContextResponse:
        """Create an instance of ErrorContextResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ErrorContextResponse:
        """Create an instance of ErrorContextResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ErrorContextResponse.parse_obj(obj)

        _obj = ErrorContextResponse.construct(_fields_set=None, **{
