...
from pypureclient.flasharray.common.models.network_interface_eth_v_4 import NetworkInterfaceEth
from pypureclient.flasharray.common.models.network_interface_fc_v_4 import NetworkInterfaceFc
...
from pypureclient.flasharray.common.models.network_interface_v_50 import NetworkInterface


class NetworkInterfaceGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(NetworkInterface)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkInterfaceGetResponse:
        """Create an instance of NetworkInterfaceGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkInterfaceGetResponse:
        """Create an instance of NetworkInterfaceGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkInterfaceGetResponse.parse_obj(obj)

        _obj = NetworkInterfaceGetResponse.construct(_fields_set=None, **{
            ...
            "items": [NetworkInterface.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
