...
from pypureclient.flasharray.common.models.policy_rule_alert_watcher_v_33 import PolicyRuleAlertWatcher
...
class PolicyRuleAlertWatcherGetResponse(BaseModel):
    ...
    items: Optional[conlist(PolicyRuleAlertWatcher)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name, if meaningful.")
