...
class ResourcePerformanceNoId(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourcePerformanceNoId:
        """Create an instance of ResourcePerformanceNoId from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourcePerformanceNoId:
        """Create an instance of ResourcePerformanceNoId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourcePerformanceNoId.parse_obj(obj)

        _obj = ResourcePerformanceNoId.construct(_fields_set=None, **{
