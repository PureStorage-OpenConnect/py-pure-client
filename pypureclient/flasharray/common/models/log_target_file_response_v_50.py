...
class LogTargetFileResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogTargetFileResponse:
        """Create an instance of LogTargetFileResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LogTargetFileResponse:
        """Create an instance of LogTargetFileResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogTargetFileResponse.parse_obj(obj)

        _obj = LogTargetFileResponse.construct(_fields_set=None, **{
