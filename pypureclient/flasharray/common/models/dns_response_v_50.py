...
from pypureclient.flasharray.common.models.dns_v_50 import Dns
...
class DnsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DnsResponse:
        """Create an instance of DnsResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DnsResponse:
        """Create an instance of DnsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DnsResponse.parse_obj(obj)

        _obj = DnsResponse.construct(_fields_set=None, **{
