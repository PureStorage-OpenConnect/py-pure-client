...
from pypureclient.flasharray.common.models.volume_group_v_47 import VolumeGroup


class VolumeGroupGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(VolumeGroup)] = None
    ...
    total: Optional[conlist(VolumeGroup)] = Field(default=None, description="The aggregate value of all items after filtering. Where meaningful, the average value is displayed instead. If applicable, the values are displayed for each field.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VolumeGroupGetResponse:
        """Create an instance of VolumeGroupGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VolumeGroupGetResponse:
        """Create an instance of VolumeGroupGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VolumeGroupGetResponse.parse_obj(obj)

        _obj = VolumeGroupGetResponse.construct(_fields_set=None, **{
            ...
            "items": [VolumeGroup.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "errors": [ErrorcontextresponseErrors.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None,
            "total": [VolumeGroup.from_dict(_item) for _item in obj.get("total")] if obj.get("total") is not None else None
        })
        return _obj
