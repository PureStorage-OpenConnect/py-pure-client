...
from pypureclient.flasharray.common.models.port_initiator_encryption_v_49 import PortInitiatorEncryption
...
from pypureclient.flasharray.common.models.port_initiator_v_49 import PortInitiator


class PortInitiatorsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PortInitiator)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PortInitiatorsGetResponse:
        """Create an instance of PortInitiatorsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PortInitiatorsGetResponse:
        """Create an instance of PortInitiatorsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PortInitiatorsGetResponse.parse_obj(obj)

        _obj = PortInitiatorsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PortInitiator.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
