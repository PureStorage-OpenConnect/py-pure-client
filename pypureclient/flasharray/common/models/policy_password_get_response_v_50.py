...
from pypureclient.flasharray.common.models.policy_password_v_50 import PolicyPassword
...
class PolicyPasswordGetResponse(BaseModel):
    ...
    items: Optional[conlist(PolicyPassword)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
