...
from pypureclient.flasharray.common.models.member_v_47 import Member
...
class MemberGetResponse(BaseModel):
    ...
    items: Optional[conlist(Member)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name where meaningful. If `total_only=true`, the `items` list will be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MemberGetResponse:
        """Create an instance of MemberGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> MemberGetResponse:
        """Create an instance of MemberGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MemberGetResponse.parse_obj(obj)

        _obj = MemberGetResponse.construct(_fields_set=None, **{
