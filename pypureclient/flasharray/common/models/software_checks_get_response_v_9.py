...
from pypureclient.flasharray.common.models.software_checks_checks_v_9 import SoftwareChecksChecks
...
from pypureclient.flasharray.common.models.software_check_v_9 import SoftwareCheck


class SoftwareChecksGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SoftwareCheck)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SoftwareChecksGetResponse:
        """Create an instance of SoftwareChecksGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SoftwareChecksGetResponse:
        """Create an instance of SoftwareChecksGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SoftwareChecksGetResponse.parse_obj(obj)

        _obj = SoftwareChecksGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SoftwareCheck.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
