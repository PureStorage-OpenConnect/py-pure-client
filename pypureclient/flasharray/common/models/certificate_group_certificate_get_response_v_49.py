...
from pypureclient.flasharray.common.models.member_with_type_v_49 import MemberWithType


class CertificateGroupCertificateGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificateGroupCertificateGetResponse:
        """Create an instance of CertificateGroupCertificateGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CertificateGroupCertificateGetResponse:
        """Create an instance of CertificateGroupCertificateGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CertificateGroupCertificateGetResponse.parse_obj(obj)

        _obj = CertificateGroupCertificateGetResponse.construct(_fields_set=None, **{
