...
class WorkloadPlacementRecommendation(BaseModel):
    ...
    recommendation_engine: Optional[StrictStr] = Field(default=None, description="This parameter defines which engine to use for recommendations. Possible values include `pure1`, `local`, and `best-available`. If not specified, defaults to `best-available` which may mix results of different engines, while `pure1` and `local` restrict the used engine.")
    ...
    __properties = ["context", "additional_constraints", "created", "expires", "id", "more_results_available", "name", "parameters", "placement_names", "preset", "progress", "projection_months", "recommendation_engine", "results", "results_limit", "status"]
    ...
    def from_dict(cls, obj: dict) -> WorkloadPlacementRecommendation:
        ...
        _obj = WorkloadPlacementRecommendation.construct(_fields_set=None, **{
            ...
            "recommendation_engine": obj.get("recommendation_engine"),
