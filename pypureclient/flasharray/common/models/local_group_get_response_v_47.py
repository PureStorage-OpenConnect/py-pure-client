...
from pypureclient.flasharray.common.models.local_directory_service_reference_v_44 import LocalDirectoryServiceReference
...
from pypureclient.flasharray.common.models.local_group_v_47 import LocalGroup


class LocalGroupGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(LocalGroup)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LocalGroupGetResponse:
        """Create an instance of LocalGroupGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LocalGroupGetResponse:
        """Create an instance of LocalGroupGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LocalGroupGetResponse.parse_obj(obj)

        _obj = LocalGroupGetResponse.construct(_fields_set=None, **{
            ...
            "items": [LocalGroup.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
