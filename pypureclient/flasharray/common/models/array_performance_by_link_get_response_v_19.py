...
from pypureclient.flasharray.common.models.array_performance_v_4 import ArrayPerformance
...
from pypureclient.flasharray.common.models.array_performance_by_link_v_19 import ArrayPerformanceByLink


class ArrayPerformanceByLinkGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayPerformanceByLinkGetResponse:
        """Create an instance of ArrayPerformanceByLinkGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayPerformanceByLinkGetResponse:
        """Create an instance of ArrayPerformanceByLinkGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayPerformanceByLinkGetResponse.parse_obj(obj)

        _obj = ArrayPerformanceByLinkGetResponse.construct(_fields_set=None, **{
