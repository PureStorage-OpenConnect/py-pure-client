...
from pypureclient.flasharray.common.models.protection_group_performance_v_38 import ProtectionGroupPerformance
...
class ProtectionGroupPerformanceResponse(BaseModel):
    ...
    items: Optional[conlist(ProtectionGroupPerformance)] = Field(default=None, description="A list of protection group performance objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProtectionGroupPerformanceResponse:
        """Create an instance of ProtectionGroupPerformanceResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ProtectionGroupPerformanceResponse:
        """Create an instance of ProtectionGroupPerformanceResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProtectionGroupPerformanceResponse.parse_obj(obj)

        _obj = ProtectionGroupPerformanceResponse.construct(_fields_set=None, **{
            ...
            "items": [ProtectionGroupPerformance.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
