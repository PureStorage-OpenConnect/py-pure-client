...
from pypureclient.flasharray.common.models.resource_space_no_id_v_38 import ResourceSpaceNoId
...
class ResourceSpaceNoIdGetResponse(BaseModel):
    ...
    items: Optional[conlist(ResourceSpaceNoId)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceSpaceNoIdGetResponse:
        """Create an instance of ResourceSpaceNoIdGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourceSpaceNoIdGetResponse:
        """Create an instance of ResourceSpaceNoIdGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceSpaceNoIdGetResponse.parse_obj(obj)

        _obj = ResourceSpaceNoIdGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ResourceSpaceNoId.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
