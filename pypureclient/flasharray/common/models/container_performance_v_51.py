...
class ContainerPerformance(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContainerPerformance:
        """Create an instance of ContainerPerformance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ContainerPerformance:
        """Create an instance of ContainerPerformance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContainerPerformance.parse_obj(obj)

        _obj = ContainerPerformance.construct(_fields_set=None, **{
