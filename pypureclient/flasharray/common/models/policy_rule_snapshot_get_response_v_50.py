...
from pypureclient.flasharray.common.models.policy_rule_snapshot_v_50 import PolicyRuleSnapshot


class PolicyRuleSnapshotGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyRuleSnapshot)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleSnapshotGetResponse:
        """Create an instance of PolicyRuleSnapshotGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleSnapshotGetResponse:
        """Create an instance of PolicyRuleSnapshotGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleSnapshotGetResponse.parse_obj(obj)

        _obj = PolicyRuleSnapshotGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyRuleSnapshot.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
