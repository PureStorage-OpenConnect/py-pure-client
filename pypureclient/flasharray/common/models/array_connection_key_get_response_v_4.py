...
from pypureclient.flasharray.common.models.array_connection_key_v_4 import ArrayConnectionKey


class ArrayConnectionKeyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ArrayConnectionKey)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayConnectionKeyGetResponse:
        """Create an instance of ArrayConnectionKeyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayConnectionKeyGetResponse:
        """Create an instance of ArrayConnectionKeyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayConnectionKeyGetResponse.parse_obj(obj)

        _obj = ArrayConnectionKeyGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ArrayConnectionKey.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
