...
from pypureclient.flasharray.common.models.policy_member_v_47 import PolicyMember


class PolicyMemberGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyMember)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyMemberGetResponse:
        """Create an instance of PolicyMemberGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyMemberGetResponse:
        """Create an instance of PolicyMemberGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyMemberGetResponse.parse_obj(obj)

        _obj = PolicyMemberGetResponse.construct(_fields_set=None, **{
