...
from pypureclient.flasharray.common.models.local_user_v_47 import LocalUser


class LocalUserGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(LocalUser)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LocalUserGetResponse:
        """Create an instance of LocalUserGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LocalUserGetResponse:
        """Create an instance of LocalUserGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LocalUserGetResponse.parse_obj(obj)

        _obj = LocalUserGetResponse.construct(_fields_set=None, **{
            ...
            "items": [LocalUser.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
