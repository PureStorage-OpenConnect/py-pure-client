...
from pypureclient.flasharray.common.models.directory_service_role_v_49 import DirectoryServiceRole
from pypureclient.flasharray.common.models.errorcontextresponse_errors_v_49 import ErrorcontextresponseErrors


class DirectoryServiceRoleGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(DirectoryServiceRole)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryServiceRoleGetResponse:
        """Create an instance of DirectoryServiceRoleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryServiceRoleGetResponse:
        """Create an instance of DirectoryServiceRoleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryServiceRoleGetResponse.parse_obj(obj)

        _obj = DirectoryServiceRoleGetResponse.construct(_fields_set=None, **{
            ...
            "items": [DirectoryServiceRole.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
