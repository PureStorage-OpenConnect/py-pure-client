...
from pypureclient.flasharray.common.models.resource_space_v_23 import ResourceSpace
...
class ResourceSpaceGetResponse(BaseModel):
    ...
    items: Optional[conlist(ResourceSpace)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name, if applicable. If `total_only=true`, the `items` list will be empty.")
    total: Optional[conlist(ResourceSpace)] = Field(default=None, description="The aggregate value of all items after filtering. If applicable, the average value is displayed instead. If applicable, the values are displayed for each field.")
