...
from pypureclient.flasharray.common.models.realm_v_50 import Realm
...
class RealmGetResponse(BaseModel):
    ...
    total: Optional[conlist(Realm)] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field, if meaningful.")
    ...
    def from_dict(cls, obj: dict) -> RealmGetResponse:
        ...
        _obj = RealmGetResponse.construct(_fields_set=None, **{
            ...
            "total": [Realm.from_dict(_item) for _item in obj.get("total")] if obj.get("total") is not None else None
        })
        return _obj
