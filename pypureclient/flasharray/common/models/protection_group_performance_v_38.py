...
class ProtectionGroupPerformance(BaseModel):
    """
    ...
    __properties = ["id", "name", "bytes_per_sec", "context", "time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProtectionGroupPerformance:
        """Create an instance of ProtectionGroupPerformance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ProtectionGroupPerformance:
        """Create an instance of ProtectionGroupPerformance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProtectionGroupPerformance.parse_obj(obj)

        _obj = ProtectionGroupPerformance.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
