...
from pypureclient.flasharray.common.models.connection_v_38 import Connection
...
class ConnectionGetResponse(BaseModel):
    ...
    items: Optional[conlist(Connection)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConnectionGetResponse:
        """Create an instance of ConnectionGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ConnectionGetResponse:
        """Create an instance of ConnectionGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConnectionGetResponse.parse_obj(obj)

        _obj = ConnectionGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Connection.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
