...
from pypureclient.flasharray.common.models.policy_member_clean_v_49 import PolicyMemberClean


class PolicyMemberCleanGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyMemberClean)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyMemberCleanGetResponse:
        """Create an instance of PolicyMemberCleanGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyMemberCleanGetResponse:
        """Create an instance of PolicyMemberCleanGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyMemberCleanGetResponse.parse_obj(obj)

        _obj = PolicyMemberCleanGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyMemberClean.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
