...
class Performance(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Performance:
        """Create an instance of Performance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> Performance:
        """Create an instance of Performance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Performance.parse_obj(obj)

        _obj = Performance.construct(_fields_set=None, **{
