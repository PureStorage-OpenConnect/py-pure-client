...
class PolicyPasswordGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyPassword)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyPasswordGetResponse:
        """Create an instance of PolicyPasswordGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyPasswordGetResponse:
        """Create an instance of PolicyPasswordGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyPasswordGetResponse.parse_obj(obj)

        _obj = PolicyPasswordGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyPassword.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
