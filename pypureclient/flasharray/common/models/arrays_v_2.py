...
from pypureclient.flasharray.common.models.space_v_2 import Space
...
class Arrays(BaseModel):
    ...
    __properties = ["id", "name", "banner", "capacity", "console_lock_enabled", "idle_timeout", "ntp_servers", "os", "parity", "scsi_timeout", "space", "version"]
