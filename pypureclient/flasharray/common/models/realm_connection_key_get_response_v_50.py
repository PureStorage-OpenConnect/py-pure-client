...
from pypureclient.flasharray.common.models.realm_connection_key_v_50 import RealmConnectionKey


class RealmConnectionKeyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(RealmConnectionKey)] = Field(default=None, description="A list of realm connection key objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RealmConnectionKeyGetResponse:
        """Create an instance of RealmConnectionKeyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RealmConnectionKeyGetResponse:
        """Create an instance of RealmConnectionKeyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RealmConnectionKeyGetResponse.parse_obj(obj)

        _obj = RealmConnectionKeyGetResponse.construct(_fields_set=None, **{
            ...
            "items": [RealmConnectionKey.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
