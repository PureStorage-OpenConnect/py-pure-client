...
from pypureclient.flasharray.common.models.remote_volume_snapshot_v_49 import RemoteVolumeSnapshot


class RemoteVolumeSnapshotGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(RemoteVolumeSnapshot)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoteVolumeSnapshotGetResponse:
        """Create an instance of RemoteVolumeSnapshotGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RemoteVolumeSnapshotGetResponse:
        """Create an instance of RemoteVolumeSnapshotGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoteVolumeSnapshotGetResponse.parse_obj(obj)

        _obj = RemoteVolumeSnapshotGetResponse.construct(_fields_set=None, **{
            ...
            "items": [RemoteVolumeSnapshot.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
