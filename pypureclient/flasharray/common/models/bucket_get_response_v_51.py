...
from pypureclient.flasharray.common.models.bucket_base_v_51 import BucketBase
...
from pypureclient.flasharray.common.models.bucket_v_51 import Bucket
...
class BucketGetResponse(BaseModel):
    ...
    total: Optional[conlist(Bucket)] = Field(default=None, description="If `total_only` query param is `true`, then this field will be a total of all records after filtering and no items will be returned. If `total_only` is `false`, then it will be a total of all records on this page.")
    ...
    def from_dict(cls, obj: dict) -> BucketGetResponse:
        ...
        _obj = BucketGetResponse.construct(_fields_set=None, **{
            ...
            "total": [Bucket.from_dict(_item) for _item in obj.get("total")] if obj.get("total") is not None else None
        })
        return _obj
