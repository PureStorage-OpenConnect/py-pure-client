...
from pypureclient.flasharray.common.models.target_protection_group_v_49 import TargetProtectionGroup


class ProtectionGroupTargetGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(TargetProtectionGroup)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProtectionGroupTargetGetResponse:
        """Create an instance of ProtectionGroupTargetGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ProtectionGroupTargetGetResponse:
        """Create an instance of ProtectionGroupTargetGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProtectionGroupTargetGetResponse.parse_obj(obj)

        _obj = ProtectionGroupTargetGetResponse.construct(_fields_set=None, **{
            ...
            "items": [TargetProtectionGroup.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
