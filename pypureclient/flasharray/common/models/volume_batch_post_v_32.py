...
class VolumeBatchPost(BaseModel):
    ...
    add_to_protection_groups: Optional[conlist(Reference)] = Field(default=None, description="Specifies a list of protection group that will compose the initial protection for the volume.")
    name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the volume.")
    tags: Optional[conlist(Tag)] = Field(default=None, description="The list of tags of this volume to be upserted.")
    __properties = ["destroyed", "priority_adjustment", "provisioned", "qos", "source", "subtype", "add_to_protection_groups", "name", "tags"]
