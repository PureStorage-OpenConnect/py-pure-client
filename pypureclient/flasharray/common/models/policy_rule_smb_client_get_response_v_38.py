...
from pypureclient.flasharray.common.models.policy_rule_smb_client_v_38 import PolicyRuleSmbClient


class PolicyRuleSmbClientGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyRuleSmbClient)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleSmbClientGetResponse:
        """Create an instance of PolicyRuleSmbClientGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleSmbClientGetResponse:
        """Create an instance of PolicyRuleSmbClientGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleSmbClientGetResponse.parse_obj(obj)

        _obj = PolicyRuleSmbClientGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyRuleSmbClient.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
