...
from pypureclient.flasharray.common.models.directory_service_common_v_47 import DirectoryServiceCommon
...
from pypureclient.flasharray.common.models.directory_service_v_47 import DirectoryService


class DirectoryServiceResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryServiceResponse:
        """Create an instance of DirectoryServiceResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryServiceResponse:
        """Create an instance of DirectoryServiceResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryServiceResponse.parse_obj(obj)

        _obj = DirectoryServiceResponse.construct(_fields_set=None, **{
