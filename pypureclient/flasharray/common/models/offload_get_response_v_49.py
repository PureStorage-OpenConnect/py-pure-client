...
from pypureclient.flasharray.common.models.offload_post_v_25 import OffloadPost
...
from pypureclient.flasharray.common.models.offload_azure_v_25 import OffloadAzure
...
from pypureclient.flasharray.common.models.offload_v_49 import Offload


class OffloadGetResponse(BaseModel):
    """
    OffloadGetResponse
    """
    ...
    items: Optional[conlist(Offload)] = None
    ...
    total: Optional[conlist(Offload)] = Field(default=None, description="The aggregate value of all items after filtering. Where meaningful, the average value is displayed instead. If applicable, the values are displayed for each field.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OffloadGetResponse:
        """Create an instance of OffloadGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> OffloadGetResponse:
        """Create an instance of OffloadGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OffloadGetResponse.parse_obj(obj)

        _obj = OffloadGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Offload.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "errors": [ErrorcontextresponseErrors.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None,
            "total": [Offload.from_dict(_item) for _item in obj.get("total")] if obj.get("total") is not None else None
        })
        return _obj
