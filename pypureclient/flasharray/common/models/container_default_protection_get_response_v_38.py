...
from pypureclient.flasharray.common.models.default_protection_reference_v_26 import DefaultProtectionReference
...
class ContainerDefaultProtectionGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ContainerDefaultProtection)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContainerDefaultProtectionGetResponse:
        """Create an instance of ContainerDefaultProtectionGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ContainerDefaultProtectionGetResponse:
        """Create an instance of ContainerDefaultProtectionGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContainerDefaultProtectionGetResponse.parse_obj(obj)

        _obj = ContainerDefaultProtectionGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ContainerDefaultProtection.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
