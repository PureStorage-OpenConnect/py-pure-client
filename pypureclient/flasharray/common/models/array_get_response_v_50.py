...
from pypureclient.flasharray.common.models.eradication_config_v_26 import EradicationConfig
...
class ArrayGetResponse(BaseModel):
    ...
    items: Optional[conlist(Arrays)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayGetResponse:
        """Create an instance of ArrayGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayGetResponse:
        """Create an instance of ArrayGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayGetResponse.parse_obj(obj)

        _obj = ArrayGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Arrays.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
