...
class CloudCapacityGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloudCapacityGetResponse:
        """Create an instance of CloudCapacityGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CloudCapacityGetResponse:
        """Create an instance of CloudCapacityGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CloudCapacityGetResponse.parse_obj(obj)

        _obj = CloudCapacityGetResponse.construct(_fields_set=None, **{
