...
from pypureclient.flasharray.common.models.policy_audit_file_v_49 import PolicyAuditFile


class PolicyAuditFileResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyAuditFileResponse:
        """Create an instance of PolicyAuditFileResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyAuditFileResponse:
        """Create an instance of PolicyAuditFileResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyAuditFileResponse.parse_obj(obj)

        _obj = PolicyAuditFileResponse.construct(_fields_set=None, **{
