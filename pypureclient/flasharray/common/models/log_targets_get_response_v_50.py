...
from pypureclient.flasharray.common.models.log_target_v_50 import LogTarget


class LogTargetsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(LogTarget)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogTargetsGetResponse:
        """Create an instance of LogTargetsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LogTargetsGetResponse:
        """Create an instance of LogTargetsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogTargetsGetResponse.parse_obj(obj)

        _obj = LogTargetsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [LogTarget.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
