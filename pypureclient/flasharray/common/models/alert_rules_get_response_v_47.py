...
class AlertRulesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(AlertRules)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertRulesGetResponse:
        """Create an instance of AlertRulesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AlertRulesGetResponse:
        """Create an instance of AlertRulesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlertRulesGetResponse.parse_obj(obj)

        _obj = AlertRulesGetResponse.construct(_fields_set=None, **{
            ...
            "items": [AlertRules.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
