...
from pypureclient.flasharray.common.models.workload_placement_recommendation_resource_reference_v_49 import WorkloadPlacementRecommendationResourceReference
