...
from pypureclient.flasharray.common.models.policy_rule_alert_watcher_v_50 import PolicyRuleAlertWatcher


class PolicyRuleAlertWatcherGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyRuleAlertWatcher)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleAlertWatcherGetResponse:
        """Create an instance of PolicyRuleAlertWatcherGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleAlertWatcherGetResponse:
        """Create an instance of PolicyRuleAlertWatcherGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleAlertWatcherGetResponse.parse_obj(obj)

        _obj = PolicyRuleAlertWatcherGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyRuleAlertWatcher.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
