...
from pypureclient.flasharray.common.models.virtual_machine_v_49 import VirtualMachine


class VirtualMachineGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(VirtualMachine)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VirtualMachineGetResponse:
        """Create an instance of VirtualMachineGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VirtualMachineGetResponse:
        """Create an instance of VirtualMachineGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VirtualMachineGetResponse.parse_obj(obj)

        _obj = VirtualMachineGetResponse.construct(_fields_set=None, **{
            ...
            "items": [VirtualMachine.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
