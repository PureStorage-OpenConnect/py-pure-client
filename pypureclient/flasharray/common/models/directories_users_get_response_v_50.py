...
from pypureclient.flasharray.common.models.directory_user_v_50 import DirectoryUser
from pypureclient.flasharray.common.models.errorcontextresponse_errors_v_49 import ErrorcontextresponseErrors


class DirectoriesUsersGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(DirectoryUser)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoriesUsersGetResponse:
        """Create an instance of DirectoriesUsersGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoriesUsersGetResponse:
        """Create an instance of DirectoriesUsersGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoriesUsersGetResponse.parse_obj(obj)

        _obj = DirectoriesUsersGetResponse.construct(_fields_set=None, **{
            ...
            "items": [DirectoryUser.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
