...
class ProtectionGroupGetResponse(BaseModel):
    ...
    total: Optional[conlist(ProtectionGroup)] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field where applicable.")
