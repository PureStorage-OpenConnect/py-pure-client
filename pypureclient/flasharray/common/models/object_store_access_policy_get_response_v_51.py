...
from pypureclient.flasharray.common.models.policy_rule_object_store_access_v_51 import PolicyRuleObjectStoreAccess
...
from pypureclient.flasharray.common.models.policy_rule_object_store_access_base_v_51 import PolicyRuleObjectStoreAccessBase
...
from pypureclient.flasharray.common.models.object_store_access_policy_v_51 import ObjectStoreAccessPolicy


class ObjectStoreAccessPolicyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ObjectStoreAccessPolicy)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreAccessPolicyGetResponse:
        """Create an instance of ObjectStoreAccessPolicyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreAccessPolicyGetResponse:
        """Create an instance of ObjectStoreAccessPolicyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreAccessPolicyGetResponse.parse_obj(obj)

        _obj = ObjectStoreAccessPolicyGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ObjectStoreAccessPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
