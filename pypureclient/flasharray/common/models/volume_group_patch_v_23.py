...
class VolumeGroupPatch(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VolumeGroupPatch:
        """Create an instance of VolumeGroupPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VolumeGroupPatch:
        """Create an instance of VolumeGroupPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VolumeGroupPatch.parse_obj(obj)

        _obj = VolumeGroupPatch.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
