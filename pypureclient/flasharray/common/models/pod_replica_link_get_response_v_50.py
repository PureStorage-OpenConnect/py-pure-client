...
from pypureclient.flasharray.common.models.pod_replica_link_v_50 import PodReplicaLink


class PodReplicaLinkGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PodReplicaLink)] = Field(default=None, description="A list of pod replica link objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PodReplicaLinkGetResponse:
        """Create an instance of PodReplicaLinkGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PodReplicaLinkGetResponse:
        """Create an instance of PodReplicaLinkGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PodReplicaLinkGetResponse.parse_obj(obj)

        _obj = PodReplicaLinkGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PodReplicaLink.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
