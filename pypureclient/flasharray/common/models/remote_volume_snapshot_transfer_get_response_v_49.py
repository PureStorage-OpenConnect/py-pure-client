...
from pypureclient.flasharray.common.models.remote_volume_snapshot_transfer_v_49 import RemoteVolumeSnapshotTransfer


class RemoteVolumeSnapshotTransferGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(RemoteVolumeSnapshotTransfer)] = None
    ...
    total: Optional[conlist(RemoteVolumeSnapshotTransfer)] = Field(default=None, description="The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field where meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoteVolumeSnapshotTransferGetResponse:
        """Create an instance of RemoteVolumeSnapshotTransferGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RemoteVolumeSnapshotTransferGetResponse:
        """Create an instance of RemoteVolumeSnapshotTransferGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoteVolumeSnapshotTransferGetResponse.parse_obj(obj)

        _obj = RemoteVolumeSnapshotTransferGetResponse.construct(_fields_set=None, **{
            ...
            "items": [RemoteVolumeSnapshotTransfer.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "errors": [ErrorcontextresponseErrors.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None,
            "total": [RemoteVolumeSnapshotTransfer.from_dict(_item) for _item in obj.get("total")] if obj.get("total") is not None else None
        })
        return _obj
