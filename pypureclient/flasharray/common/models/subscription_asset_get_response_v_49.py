...
from pypureclient.flasharray.common.models.subscription_asset_subscription_v_26 import SubscriptionAssetSubscription
...
from pypureclient.flasharray.common.models.subscription_asset_v_49 import SubscriptionAsset


class SubscriptionAssetGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SubscriptionAsset)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionAssetGetResponse:
        """Create an instance of SubscriptionAssetGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionAssetGetResponse:
        """Create an instance of SubscriptionAssetGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionAssetGetResponse.parse_obj(obj)

        _obj = SubscriptionAssetGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SubscriptionAsset.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
