...
class NetworkInterfaceResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkInterfaceResponse:
        """Create an instance of NetworkInterfaceResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkInterfaceResponse:
        """Create an instance of NetworkInterfaceResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkInterfaceResponse.parse_obj(obj)

        _obj = NetworkInterfaceResponse.construct(_fields_set=None, **{
