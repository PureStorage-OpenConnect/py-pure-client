...
from pypureclient.flasharray.common.models.lifecycle_rule_base_v_51 import LifecycleRuleBase
...
from pypureclient.flasharray.common.models.lifecycle_rule_v_51 import LifecycleRule


class LifecycleRuleGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(LifecycleRule)] = Field(default=None, description="A list of lifecycle rule objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LifecycleRuleGetResponse:
        """Create an instance of LifecycleRuleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LifecycleRuleGetResponse:
        """Create an instance of LifecycleRuleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LifecycleRuleGetResponse.parse_obj(obj)

        _obj = LifecycleRuleGetResponse.construct(_fields_set=None, **{
            ...
            "items": [LifecycleRule.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
