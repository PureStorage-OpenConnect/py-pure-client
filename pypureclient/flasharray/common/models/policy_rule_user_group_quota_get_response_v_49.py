...
from pypureclient.flasharray.common.models.policy_rule_user_group_quota_v_49 import PolicyRuleUserGroupQuota


class PolicyRuleUserGroupQuotaGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyRuleUserGroupQuota)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleUserGroupQuotaGetResponse:
        """Create an instance of PolicyRuleUserGroupQuotaGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleUserGroupQuotaGetResponse:
        """Create an instance of PolicyRuleUserGroupQuotaGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleUserGroupQuotaGetResponse.parse_obj(obj)

        _obj = PolicyRuleUserGroupQuotaGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyRuleUserGroupQuota.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
