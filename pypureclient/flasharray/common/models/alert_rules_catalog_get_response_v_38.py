...
from pypureclient.flasharray.common.models.alert_rules_catalog_v_38 import AlertRulesCatalog
from pypureclient.flasharray.common.models.errorcontextresponse_errors_v_38 import ErrorcontextresponseErrors


class AlertRulesCatalogGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(AlertRulesCatalog)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertRulesCatalogGetResponse:
        """Create an instance of AlertRulesCatalogGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AlertRulesCatalogGetResponse:
        """Create an instance of AlertRulesCatalogGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlertRulesCatalogGetResponse.parse_obj(obj)

        _obj = AlertRulesCatalogGetResponse.construct(_fields_set=None, **{
            ...
            "items": [AlertRulesCatalog.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
