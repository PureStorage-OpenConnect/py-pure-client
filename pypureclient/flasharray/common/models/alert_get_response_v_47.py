...
class AlertGetResponse(BaseModel):
    ...
    items: Optional[conlist(Alert)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertGetResponse:
        """Create an instance of AlertGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AlertGetResponse:
        """Create an instance of AlertGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlertGetResponse.parse_obj(obj)

        _obj = AlertGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Alert.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
