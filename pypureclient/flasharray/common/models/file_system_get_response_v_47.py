...
from pypureclient.flasharray.common.models.file_system_v_47 import FileSystem
...
class FileSystemGetResponse(BaseModel):
    ...
    items: Optional[conlist(FileSystem)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
