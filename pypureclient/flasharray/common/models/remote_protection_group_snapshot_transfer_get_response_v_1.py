...
from pypureclient.flasharray.common.models.remote_protection_group_snapshot_transfer_v_1 import RemoteProtectionGroupSnapshotTransfer
...
class RemoteProtectionGroupSnapshotTransferGetResponse(BaseModel):
    ...
    total: Optional[conlist(RemoteProtectionGroupSnapshotTransfer)] = Field(default=None, description="The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field where meaningful.")
