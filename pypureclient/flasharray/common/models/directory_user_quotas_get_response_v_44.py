...
from pypureclient.flasharray.common.models.directory_user_quota_v_44 import DirectoryUserQuota
from pypureclient.flasharray.common.models.errorcontextresponse_errors_v_38 import ErrorcontextresponseErrors


class DirectoryUserQuotasGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(DirectoryUserQuota)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryUserQuotasGetResponse:
        """Create an instance of DirectoryUserQuotasGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryUserQuotasGetResponse:
        """Create an instance of DirectoryUserQuotasGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryUserQuotasGetResponse.parse_obj(obj)

        _obj = DirectoryUserQuotasGetResponse.construct(_fields_set=None, **{
            ...
            "items": [DirectoryUserQuota.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
