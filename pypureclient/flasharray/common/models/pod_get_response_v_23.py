...
from pypureclient.flasharray.common.models.pod_eradication_config_v_13 import PodEradicationConfig
from pypureclient.flasharray.common.models.fixed_reference_v_0 import FixedReference
from pypureclient.flasharray.common.models.pod_space_v_23 import PodSpace
from pypureclient.flasharray.common.models.pod_array_status_v_1 import PodArrayStatus
...
from pypureclient.flasharray.common.models.pod_v_23 import Pod


class PodGetResponse(BaseModel):
    """
    PodGetResponse
    """
    ...
    items: Optional[conlist(Pod)] = None
    total: Optional[conlist(Pod)] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field, if applicable.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PodGetResponse:
        """Create an instance of PodGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PodGetResponse:
        """Create an instance of PodGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PodGetResponse.parse_obj(obj)

        _obj = PodGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Pod.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "total": [Pod.from_dict(_item) for _item in obj.get("total")] if obj.get("total") is not None else None
        })
        return _obj
