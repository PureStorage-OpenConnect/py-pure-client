...
from pypureclient.flasharray.common.models.connection_v_0 import Connection
...
class ConnectionGetResponse(BaseModel):
    ...
    items: Optional[conlist(Connection)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful. If `total_only=true`, the `items` list will be empty.")
