...
from pypureclient.flasharray.common.models.array_connection_v_47 import ArrayConnection
from pypureclient.flasharray.common.models.errorcontextresponse_errors_v_38 import ErrorcontextresponseErrors


class ArrayConnectionGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ArrayConnection)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayConnectionGetResponse:
        """Create an instance of ArrayConnectionGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayConnectionGetResponse:
        """Create an instance of ArrayConnectionGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayConnectionGetResponse.parse_obj(obj)

        _obj = ArrayConnectionGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ArrayConnection.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
