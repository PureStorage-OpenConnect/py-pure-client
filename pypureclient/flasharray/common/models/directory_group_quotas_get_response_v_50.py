...
from pypureclient.flasharray.common.models.directory_user_quota_rule_v_49 import DirectoryUserQuotaRule
...
from pypureclient.flasharray.common.models.directory_group_quota_v_50 import DirectoryGroupQuota
from pypureclient.flasharray.common.models.errorcontextresponse_errors_v_49 import ErrorcontextresponseErrors


class DirectoryGroupQuotasGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(DirectoryGroupQuota)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    __properties = ["continuation_token", "more_items_remaining", "total_item_count", "items", "errors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryGroupQuotasGetResponse:
        """Create an instance of DirectoryGroupQuotasGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryGroupQuotasGetResponse:
        """Create an instance of DirectoryGroupQuotasGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryGroupQuotasGetResponse.parse_obj(obj)

        _obj = DirectoryGroupQuotasGetResponse.construct(_fields_set=None, **{
            ...
            "items": [DirectoryGroupQuota.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
