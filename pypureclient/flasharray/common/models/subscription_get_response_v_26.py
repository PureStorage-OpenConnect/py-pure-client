...
from pypureclient.flasharray.common.models.subscription_v_26 import Subscription
...
class SubscriptionGetResponse(BaseModel):
    ...
    items: Optional[conlist(Subscription)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionGetResponse:
        """Create an instance of SubscriptionGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionGetResponse:
        """Create an instance of SubscriptionGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionGetResponse.parse_obj(obj)

        _obj = SubscriptionGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Subscription.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
