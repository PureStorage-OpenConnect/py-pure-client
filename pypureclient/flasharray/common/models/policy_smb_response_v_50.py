...
class PolicySmbResponse(BaseModel):
    """
    PolicySmbResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicySmbResponse:
        """Create an instance of PolicySmbResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicySmbResponse:
        """Create an instance of PolicySmbResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicySmbResponse.parse_obj(obj)

        _obj = PolicySmbResponse.construct(_fields_set=None, **{
