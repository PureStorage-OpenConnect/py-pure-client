...
from pypureclient.flasharray.common.models.volume_diff_v_38 import VolumeDiff


class VolumesDiffGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(VolumeDiff)] = Field(default=None, description="A list of different chunks between specified volumes.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VolumesDiffGetResponse:
        """Create an instance of VolumesDiffGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VolumesDiffGetResponse:
        """Create an instance of VolumesDiffGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VolumesDiffGetResponse.parse_obj(obj)

        _obj = VolumesDiffGetResponse.construct(_fields_set=None, **{
            ...
            "items": [VolumeDiff.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
