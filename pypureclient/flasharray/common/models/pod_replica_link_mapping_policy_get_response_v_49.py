...
from pypureclient.flasharray.common.models.pod_replica_link_reference_v_49 import PodReplicaLinkReference
...
from pypureclient.flasharray.common.models.mapping_policy_v_49 import MappingPolicy


class PodReplicaLinkMappingPolicyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(MappingPolicy)] = Field(default=None, description="A list of policy mappings.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PodReplicaLinkMappingPolicyGetResponse:
        """Create an instance of PodReplicaLinkMappingPolicyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PodReplicaLinkMappingPolicyGetResponse:
        """Create an instance of PodReplicaLinkMappingPolicyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PodReplicaLinkMappingPolicyGetResponse.parse_obj(obj)

        _obj = PodReplicaLinkMappingPolicyGetResponse.construct(_fields_set=None, **{
            ...
            "items": [MappingPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
