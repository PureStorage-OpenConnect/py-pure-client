...
from pypureclient.flasharray.common.models.virtual_machine_volume_snapshot_v_49 import VirtualMachineVolumeSnapshot


class VirtualMachineVolumeSnapshotResponse(BaseModel):
    """
    ...
    items: Optional[conlist(VirtualMachineVolumeSnapshot)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VirtualMachineVolumeSnapshotResponse:
        """Create an instance of VirtualMachineVolumeSnapshotResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VirtualMachineVolumeSnapshotResponse:
        """Create an instance of VirtualMachineVolumeSnapshotResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VirtualMachineVolumeSnapshotResponse.parse_obj(obj)

        _obj = VirtualMachineVolumeSnapshotResponse.construct(_fields_set=None, **{
            ...
            "items": [VirtualMachineVolumeSnapshot.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
