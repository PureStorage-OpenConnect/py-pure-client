...
from pypureclient.flasharray.common.models.admin_role_v_36 import AdminRole
from pypureclient.flasharray.common.models.api_token_v_2 import ApiToken
...
from pypureclient.flasharray.common.models.admin_v_36 import Admin
...
class AdminGetResponse(BaseModel):
    ...
    items: Optional[conlist(Admin)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdminGetResponse:
        """Create an instance of AdminGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AdminGetResponse:
        """Create an instance of AdminGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdminGetResponse.parse_obj(obj)

        _obj = AdminGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Admin.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
