...
from pypureclient.flasharray.common.models.pod_performance_replication_v_2 import PodPerformanceReplication


class PodPerformanceReplicationGetResponse(BaseModel):
    """
    ...
    total: Optional[conlist(PodPerformanceReplication)] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PodPerformanceReplicationGetResponse:
        """Create an instance of PodPerformanceReplicationGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PodPerformanceReplicationGetResponse:
        """Create an instance of PodPerformanceReplicationGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PodPerformanceReplicationGetResponse.parse_obj(obj)

        _obj = PodPerformanceReplicationGetResponse.construct(_fields_set=None, **{
