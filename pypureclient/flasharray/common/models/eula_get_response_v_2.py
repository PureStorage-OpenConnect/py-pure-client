...
from pypureclient.flasharray.common.models.eula_signature_v_2 import EulaSignature
...
class EulaGetResponse(BaseModel):
    """
    EulaGetResponse
    """
    ...
    items: Optional[conlist(Eula)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EulaGetResponse:
        """Create an instance of EulaGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> EulaGetResponse:
        """Create an instance of EulaGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EulaGetResponse.parse_obj(obj)

        _obj = EulaGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Eula.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
