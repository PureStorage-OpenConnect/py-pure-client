...
class WorkloadConfigurationFixedReferenceWorkload(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkloadConfigurationFixedReferenceWorkload:
        """Create an instance of WorkloadConfigurationFixedReferenceWorkload from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> WorkloadConfigurationFixedReferenceWorkload:
        """Create an instance of WorkloadConfigurationFixedReferenceWorkload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkloadConfigurationFixedReferenceWorkload.parse_obj(obj)

        _obj = WorkloadConfigurationFixedReferenceWorkload.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
