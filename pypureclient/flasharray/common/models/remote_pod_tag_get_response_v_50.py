...
from pypureclient.flasharray.common.models.stretched_tag_pod_v_50 import StretchedTagPod


class RemotePodTagGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(StretchedTagPod)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemotePodTagGetResponse:
        """Create an instance of RemotePodTagGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RemotePodTagGetResponse:
        """Create an instance of RemotePodTagGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemotePodTagGetResponse.parse_obj(obj)

        _obj = RemotePodTagGetResponse.construct(_fields_set=None, **{
            ...
            "items": [StretchedTagPod.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
