...
from pypureclient.flasharray.common.models.alert_event_v_47 import AlertEvent
from pypureclient.flasharray.common.models.errorcontextresponse_errors_v_38 import ErrorcontextresponseErrors


class AlertEventGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(AlertEvent)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertEventGetResponse:
        """Create an instance of AlertEventGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AlertEventGetResponse:
        """Create an instance of AlertEventGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlertEventGetResponse.parse_obj(obj)

        _obj = AlertEventGetResponse.construct(_fields_set=None, **{
            ...
            "items": [AlertEvent.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
