...
from pypureclient.flasharray.common.models.pod_remote_array_status_v_50 import PodRemoteArrayStatus
...
from pypureclient.flasharray.common.models.remote_pod_v_50 import RemotePod


class RemotePodsResponse(BaseModel):
    """
    RemotePodsResponse
    """
    ...
    items: Optional[conlist(RemotePod)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name where meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemotePodsResponse:
        """Create an instance of RemotePodsResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RemotePodsResponse:
        """Create an instance of RemotePodsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemotePodsResponse.parse_obj(obj)

        _obj = RemotePodsResponse.construct(_fields_set=None, **{
            ...
            "items": [RemotePod.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
