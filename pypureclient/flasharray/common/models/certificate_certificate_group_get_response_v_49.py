...
class CertificateCertificateGroupGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificateCertificateGroupGetResponse:
        """Create an instance of CertificateCertificateGroupGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CertificateCertificateGroupGetResponse:
        """Create an instance of CertificateCertificateGroupGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CertificateCertificateGroupGetResponse.parse_obj(obj)

        _obj = CertificateCertificateGroupGetResponse.construct(_fields_set=None, **{
