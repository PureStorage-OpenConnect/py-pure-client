...
from pypureclient.flasharray.common.models.user_group_quota_limited_by_v_49 import UserGroupQuotaLimitedBy
...
from pypureclient.flasharray.common.models.directory_group_v_50 import DirectoryGroup
from pypureclient.flasharray.common.models.errorcontextresponse_errors_v_49 import ErrorcontextresponseErrors


class DirectoriesGroupsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(DirectoryGroup)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoriesGroupsGetResponse:
        """Create an instance of DirectoriesGroupsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoriesGroupsGetResponse:
        """Create an instance of DirectoriesGroupsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoriesGroupsGetResponse.parse_obj(obj)

        _obj = DirectoriesGroupsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [DirectoryGroup.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
