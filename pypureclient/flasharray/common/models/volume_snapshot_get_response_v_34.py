...
from pypureclient.flasharray.common.models.volume_snapshot_v_34 import VolumeSnapshot
...
class VolumeSnapshotGetResponse(BaseModel):
    ...
    items: Optional[conlist(VolumeSnapshot)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name. If `total_only=true`, the `items` list will be empty.")
