...
from pypureclient.flasharray.common.models.port_v_47 import Port
...
class PortGetResponse(BaseModel):
    ...
    items: Optional[conlist(Port)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PortGetResponse:
        """Create an instance of PortGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PortGetResponse:
        """Create an instance of PortGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PortGetResponse.parse_obj(obj)

        _obj = PortGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Port.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
