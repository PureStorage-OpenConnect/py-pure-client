...
from pypureclient.flasharray.common.models.test_result_with_resource_v_47 import TestResultWithResource


class TestResultWithResourcePostResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultWithResourcePostResponse:
        """Create an instance of TestResultWithResourcePostResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TestResultWithResourcePostResponse:
        """Create an instance of TestResultWithResourcePostResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultWithResourcePostResponse.parse_obj(obj)

        _obj = TestResultWithResourcePostResponse.construct(_fields_set=None, **{
