...
from pypureclient.flasharray.common.models.directory_service_common_v_49 import DirectoryServiceCommon
...
from pypureclient.flasharray.common.models.directory_service_v_49 import DirectoryService
from pypureclient.flasharray.common.models.errorcontextresponse_errors_v_49 import ErrorcontextresponseErrors


class DirectoryServiceGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(DirectoryService)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryServiceGetResponse:
        """Create an instance of DirectoryServiceGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryServiceGetResponse:
        """Create an instance of DirectoryServiceGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryServiceGetResponse.parse_obj(obj)

        _obj = DirectoryServiceGetResponse.construct(_fields_set=None, **{
            ...
            "items": [DirectoryService.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
