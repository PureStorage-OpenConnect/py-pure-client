...
from pypureclient.flasharray.common.models.policy_rule_nfs_client_v_47 import PolicyRuleNfsClient


class PolicyRuleNfsClientGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyRuleNfsClient)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleNfsClientGetResponse:
        """Create an instance of PolicyRuleNfsClientGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleNfsClientGetResponse:
        """Create an instance of PolicyRuleNfsClientGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleNfsClientGetResponse.parse_obj(obj)

        _obj = PolicyRuleNfsClientGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyRuleNfsClient.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
