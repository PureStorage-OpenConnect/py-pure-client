...
from pypureclient.flasharray.common.models.object_store_virtual_host_v_51 import ObjectStoreVirtualHost


class ObjectStoreVirtualHostGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ObjectStoreVirtualHost)] = Field(default=None, description="A list of object store virtual host objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreVirtualHostGetResponse:
        """Create an instance of ObjectStoreVirtualHostGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreVirtualHostGetResponse:
        """Create an instance of ObjectStoreVirtualHostGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreVirtualHostGetResponse.parse_obj(obj)

        _obj = ObjectStoreVirtualHostGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ObjectStoreVirtualHost.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
