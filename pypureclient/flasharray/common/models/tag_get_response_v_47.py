...
class TagGetResponse(BaseModel):
    ...
    items: Optional[conlist(Tag)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TagGetResponse:
        """Create an instance of TagGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TagGetResponse:
        """Create an instance of TagGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TagGetResponse.parse_obj(obj)

        _obj = TagGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Tag.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
