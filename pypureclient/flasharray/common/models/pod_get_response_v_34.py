...
from pypureclient.flasharray.common.models.pod_space_v_34 import PodSpace
...
from pypureclient.flasharray.common.models.pod_v_34 import Pod
...
class PodGetResponse(BaseModel):
    ...
    total: Optional[conlist(Pod)] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. If applicable, the values are displayed for each field.")
