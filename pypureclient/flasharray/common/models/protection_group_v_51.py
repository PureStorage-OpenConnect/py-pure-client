...
class ProtectionGroup(BaseModel):
    ...
    __properties = ["context", "id", "name", "destroyed", "eradication_config", "host_count", "host_group_count", "is_local", "pod", "replication_schedule", "retention_lock", "snapshot_schedule", "source", "source_retention", "space", "target_count", "target_retention", "time_remaining", "volume_count", "workload"]
