...
from pypureclient.flasharray.common.models.remote_array_fleet_v_49 import RemoteArrayFleet
...
from pypureclient.flasharray.common.models.remote_array_v_51 import RemoteArray


class RemoteArraysResponse(BaseModel):
    """
    ...
    items: Optional[conlist(RemoteArray)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoteArraysResponse:
        """Create an instance of RemoteArraysResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RemoteArraysResponse:
        """Create an instance of RemoteArraysResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoteArraysResponse.parse_obj(obj)

        _obj = RemoteArraysResponse.construct(_fields_set=None, **{
            ...
            "items": [RemoteArray.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
