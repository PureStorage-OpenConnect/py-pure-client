...
from pypureclient.flasharray.common.models.host_v_0 import Host
...
class HostResponse(BaseModel):
    ...
    HostResponse
    """
    items: Optional[conlist(Host)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful. If `total_only=true`, the `items` list will be empty.")
    __properties = ["items"]
