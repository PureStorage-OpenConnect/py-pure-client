...
class PresetWorkloadSnapshotConfiguration(BaseModel):
    """
    ...
    rules: conlist(PresetWorkloadSnapshotRule, max_items=2, min_items=1) = Field(default=..., description="The rules defining the frequency and retention of snapshots taken by the configuration.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PresetWorkloadSnapshotConfiguration:
        """Create an instance of PresetWorkloadSnapshotConfiguration from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PresetWorkloadSnapshotConfiguration:
        """Create an instance of PresetWorkloadSnapshotConfiguration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PresetWorkloadSnapshotConfiguration.parse_obj(obj)
