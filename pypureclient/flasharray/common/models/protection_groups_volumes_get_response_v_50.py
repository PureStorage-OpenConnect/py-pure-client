...
from pypureclient.flasharray.common.models.protection_groups_volumes_member_v_49 import ProtectionGroupsVolumesMember
...
from pypureclient.flasharray.common.models.protection_groups_volumes_v_50 import ProtectionGroupsVolumes


class ProtectionGroupsVolumesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ProtectionGroupsVolumes)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProtectionGroupsVolumesGetResponse:
        """Create an instance of ProtectionGroupsVolumesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ProtectionGroupsVolumesGetResponse:
        """Create an instance of ProtectionGroupsVolumesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProtectionGroupsVolumesGetResponse.parse_obj(obj)

        _obj = ProtectionGroupsVolumesGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ProtectionGroupsVolumes.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
