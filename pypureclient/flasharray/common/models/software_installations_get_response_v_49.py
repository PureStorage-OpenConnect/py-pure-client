...
from pypureclient.flasharray.common.models.upgrade_parameters_v_37 import UpgradeParameters
...
from pypureclient.flasharray.common.models.software_installation_v_49 import SoftwareInstallation


class SoftwareInstallationsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SoftwareInstallation)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SoftwareInstallationsGetResponse:
        """Create an instance of SoftwareInstallationsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SoftwareInstallationsGetResponse:
        """Create an instance of SoftwareInstallationsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SoftwareInstallationsGetResponse.parse_obj(obj)

        _obj = SoftwareInstallationsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SoftwareInstallation.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
