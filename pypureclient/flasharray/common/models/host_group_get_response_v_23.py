...
from pypureclient.flasharray.common.models.host_group_v_23 import HostGroup
...
class HostGroupGetResponse(BaseModel):
    ...
    items: Optional[conlist(HostGroup)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name, if applicable.")
