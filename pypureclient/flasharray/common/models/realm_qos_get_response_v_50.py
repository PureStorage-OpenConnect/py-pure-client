...
from pypureclient.flasharray.common.models.qos_metrics_v_50 import QosMetrics


class RealmQosGetResponse(BaseModel):
    """
    RealmQosGetResponse
    """
    ...
    items: Optional[conlist(QosMetrics)] = Field(default=None, description="QoS configuration data.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RealmQosGetResponse:
        """Create an instance of RealmQosGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RealmQosGetResponse:
        """Create an instance of RealmQosGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RealmQosGetResponse.parse_obj(obj)

        _obj = RealmQosGetResponse.construct(_fields_set=None, **{
            ...
            "items": [QosMetrics.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
