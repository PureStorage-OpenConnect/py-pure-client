...
from pypureclient.flasharray.common.models.performance_v_49 import Performance
...
class PodPerformanceByArray(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PodPerformanceByArray:
        """Create an instance of PodPerformanceByArray from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PodPerformanceByArray:
        """Create an instance of PodPerformanceByArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PodPerformanceByArray.parse_obj(obj)

        _obj = PodPerformanceByArray.construct(_fields_set=None, **{
