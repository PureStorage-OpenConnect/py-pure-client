...
from pypureclient.flasharray.common.models.host_get_response_v_49 import HostGetResponse
from pypureclient.flasharray.common.models.host_patch_v_49 import HostPatch
from pypureclient.flasharray.common.models.host_performance_balance_get_response_v_49 import HostPerformanceBalanceGetResponse
from pypureclient.flasharray.common.models.host_post_v_49 import HostPost
from pypureclient.flasharray.common.models.host_response_v_49 import HostResponse
from pypureclient.flasharray.common.models.member_no_id_all_get_response_v_49 import MemberNoIdAllGetResponse
from pypureclient.flasharray.common.models.member_no_id_all_response_v_49 import MemberNoIdAllResponse
from pypureclient.flasharray.common.models.member_no_id_member_get_response_v_49 import MemberNoIdMemberGetResponse
from pypureclient.flasharray.common.models.member_no_id_member_response_v_49 import MemberNoIdMemberResponse
from pypureclient.flasharray.common.models.non_copyable_tag_batch_v_49 import NonCopyableTagBatch
from pypureclient.flasharray.common.models.resource_performance_no_id_by_array_get_response_v_49 import ResourcePerformanceNoIdByArrayGetResponse
from pypureclient.flasharray.common.models.resource_performance_no_id_get_response_v_49 import ResourcePerformanceNoIdGetResponse
from pypureclient.flasharray.common.models.resource_space_no_id_get_response_v_49 import ResourceSpaceNoIdGetResponse
...
class HostsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api249_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_host_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_host_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_host_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_performance_balance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_hosts_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api249_hosts_delete_with_http_info = hosts_delete_with_http_info
    api249_hosts_get_with_http_info = hosts_get_with_http_info
    api249_hosts_host_groups_delete_with_http_info = hosts_host_groups_delete_with_http_info
    api249_hosts_host_groups_get_with_http_info = hosts_host_groups_get_with_http_info
    api249_hosts_host_groups_post_with_http_info = hosts_host_groups_post_with_http_info
    api249_hosts_patch_with_http_info = hosts_patch_with_http_info
    api249_hosts_performance_balance_get_with_http_info = hosts_performance_balance_get_with_http_info
    api249_hosts_performance_by_array_get_with_http_info = hosts_performance_by_array_get_with_http_info
    api249_hosts_performance_get_with_http_info = hosts_performance_get_with_http_info
    api249_hosts_post_with_http_info = hosts_post_with_http_info
    api249_hosts_protection_groups_delete_with_http_info = hosts_protection_groups_delete_with_http_info
    api249_hosts_protection_groups_get_with_http_info = hosts_protection_groups_get_with_http_info
    api249_hosts_protection_groups_post_with_http_info = hosts_protection_groups_post_with_http_info
    api249_hosts_space_get_with_http_info = hosts_space_get_with_http_info
    api249_hosts_tags_batch_put_with_http_info = hosts_tags_batch_put_with_http_info
    api249_hosts_tags_delete_with_http_info = hosts_tags_delete_with_http_info
    api249_hosts_tags_get_with_http_info = hosts_tags_get_with_http_info
