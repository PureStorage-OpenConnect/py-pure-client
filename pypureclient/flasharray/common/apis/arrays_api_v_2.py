...
class ArraysApi:
    ...
    api22_arrays_ntp_test_get_with_http_info = arrays_ntp_test_get_with_http_info
    ...
    api23_arrays_ntp_test_get_with_http_info = arrays_ntp_test_get_with_http_info
