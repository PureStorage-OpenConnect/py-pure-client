...
from pypureclient.flasharray.common.models.host_get_response_v_0 import HostGetResponse
...
from pypureclient.flasharray.common.models.host_response_v_0 import HostResponse
from pypureclient.flasharray.common.models.member_no_id_all_get_response_v_0 import MemberNoIdAllGetResponse
from pypureclient.flasharray.common.models.resource_performance_no_id_by_array_get_response_v_0 import ResourcePerformanceNoIdByArrayGetResponse
from pypureclient.flasharray.common.models.resource_performance_no_id_get_response_v_0 import ResourcePerformanceNoIdGetResponse
...
class HostsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api20_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_hosts_host_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_hosts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_hosts_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_hosts_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api20_hosts_delete_with_http_info = hosts_delete_with_http_info
    api20_hosts_get_with_http_info = hosts_get_with_http_info
    api20_hosts_host_groups_get_with_http_info = hosts_host_groups_get_with_http_info
    api20_hosts_patch_with_http_info = hosts_patch_with_http_info
    api20_hosts_performance_by_array_get_with_http_info = hosts_performance_by_array_get_with_http_info
    api20_hosts_performance_get_with_http_info = hosts_performance_get_with_http_info
    api20_hosts_post_with_http_info = hosts_post_with_http_info
