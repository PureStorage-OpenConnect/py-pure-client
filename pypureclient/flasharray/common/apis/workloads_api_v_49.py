...
from pypureclient.flasharray.common.models.workload_get_response_v_49 import WorkloadGetResponse
from pypureclient.flasharray.common.models.workload_patch_v_40 import WorkloadPatch
from pypureclient.flasharray.common.models.workload_placement_recommendation_get_response_v_49 import WorkloadPlacementRecommendationGetResponse
from pypureclient.flasharray.common.models.workload_placement_recommendation_response_v_49 import WorkloadPlacementRecommendationResponse
from pypureclient.flasharray.common.models.workload_placement_recommendation_v_49 import WorkloadPlacementRecommendation
from pypureclient.flasharray.common.models.workload_post_v_40 import WorkloadPost
from pypureclient.flasharray.common.models.workload_response_v_49 import WorkloadResponse
...
class WorkloadsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api249_workloads_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_workloads_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_workloads_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_workloads_placement_recommendations_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_workloads_placement_recommendations_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_workloads_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_workloads_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_workloads_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_workloads_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api249_workloads_delete_with_http_info = workloads_delete_with_http_info
    api249_workloads_get_with_http_info = workloads_get_with_http_info
    api249_workloads_patch_with_http_info = workloads_patch_with_http_info
    api249_workloads_placement_recommendations_get_with_http_info = workloads_placement_recommendations_get_with_http_info
    api249_workloads_placement_recommendations_post_with_http_info = workloads_placement_recommendations_post_with_http_info
    api249_workloads_post_with_http_info = workloads_post_with_http_info
    api249_workloads_tags_batch_put_with_http_info = workloads_tags_batch_put_with_http_info
    api249_workloads_tags_delete_with_http_info = workloads_tags_delete_with_http_info
    api249_workloads_tags_get_with_http_info = workloads_tags_get_with_http_info
