...
class FleetsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api236_fleets_fleet_key_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_fleets_fleet_key_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_fleets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_fleets_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_fleets_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_fleets_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_fleets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api236_fleets_fleet_key_get_with_http_info = fleets_fleet_key_get_with_http_info
    api236_fleets_fleet_key_post_with_http_info = fleets_fleet_key_post_with_http_info
    api236_fleets_get_with_http_info = fleets_get_with_http_info
    api236_fleets_members_delete_with_http_info = fleets_members_delete_with_http_info
    api236_fleets_members_get_with_http_info = fleets_members_get_with_http_info
    api236_fleets_members_post_with_http_info = fleets_members_post_with_http_info
    api236_fleets_post_with_http_info = fleets_post_with_http_info
    api237_fleets_fleet_key_get_with_http_info = fleets_fleet_key_get_with_http_info
    api237_fleets_fleet_key_post_with_http_info = fleets_fleet_key_post_with_http_info
    api237_fleets_get_with_http_info = fleets_get_with_http_info
    api237_fleets_members_delete_with_http_info = fleets_members_delete_with_http_info
    api237_fleets_members_get_with_http_info = fleets_members_get_with_http_info
    api237_fleets_members_post_with_http_info = fleets_members_post_with_http_info
    api237_fleets_post_with_http_info = fleets_post_with_http_info
