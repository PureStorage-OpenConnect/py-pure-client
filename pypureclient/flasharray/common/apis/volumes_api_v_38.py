...
from pypureclient.flasharray.common.models.resource_performance_by_array_get_response_v_38 import ResourcePerformanceByArrayGetResponse
from pypureclient.flasharray.common.models.resource_performance_get_response_v_38 import ResourcePerformanceGetResponse
...
from pypureclient.flasharray.common.models.volume_batch_post_v_38 import VolumeBatchPost
from pypureclient.flasharray.common.models.volume_get_response_v_38 import VolumeGetResponse
from pypureclient.flasharray.common.models.volume_patch_v_33 import VolumePatch
from pypureclient.flasharray.common.models.volume_post_v_33 import VolumePost
from pypureclient.flasharray.common.models.volume_response_v_38 import VolumeResponse
from pypureclient.flasharray.common.models.volume_space_get_response_v_38 import VolumeSpaceGetResponse
from pypureclient.flasharray.common.models.volumes_batch_response_v_38 import VolumesBatchResponse
from pypureclient.flasharray.common.models.volumes_diff_get_response_v_38 import VolumesDiffGetResponse
...
class VolumesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api238_volumes_batch_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_batch_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_diff_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def volumes_tags_batch_put_with_http_info(
        self,
        tag: Annotated[conlist(Tag, max_items=30, min_items=1, unique_items=True), Field(..., description="A list of tags to be created or, if one already exists, updated.")],
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_volumes_volume_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api238_volumes_batch_post_with_http_info = volumes_batch_post_with_http_info
    api238_volumes_batch_test_post_with_http_info = volumes_batch_test_post_with_http_info
    api238_volumes_delete_with_http_info = volumes_delete_with_http_info
    api238_volumes_diff_get_with_http_info = volumes_diff_get_with_http_info
    api238_volumes_get_with_http_info = volumes_get_with_http_info
    api238_volumes_patch_with_http_info = volumes_patch_with_http_info
    api238_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api238_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api238_volumes_post_with_http_info = volumes_post_with_http_info
    api238_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api238_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api238_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api238_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api238_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api238_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api238_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api238_volumes_test_post_with_http_info = volumes_test_post_with_http_info
    api238_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api239_volumes_batch_post_with_http_info = volumes_batch_post_with_http_info
    api239_volumes_batch_test_post_with_http_info = volumes_batch_test_post_with_http_info
    api239_volumes_delete_with_http_info = volumes_delete_with_http_info
    api239_volumes_diff_get_with_http_info = volumes_diff_get_with_http_info
    api239_volumes_get_with_http_info = volumes_get_with_http_info
    api239_volumes_patch_with_http_info = volumes_patch_with_http_info
    api239_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api239_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api239_volumes_post_with_http_info = volumes_post_with_http_info
    api239_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api239_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api239_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api239_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api239_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api239_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api239_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api239_volumes_test_post_with_http_info = volumes_test_post_with_http_info
    api239_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api240_volumes_batch_post_with_http_info = volumes_batch_post_with_http_info
    api240_volumes_batch_test_post_with_http_info = volumes_batch_test_post_with_http_info
    api240_volumes_delete_with_http_info = volumes_delete_with_http_info
    api240_volumes_diff_get_with_http_info = volumes_diff_get_with_http_info
    api240_volumes_get_with_http_info = volumes_get_with_http_info
    api240_volumes_patch_with_http_info = volumes_patch_with_http_info
    api240_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api240_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api240_volumes_post_with_http_info = volumes_post_with_http_info
    api240_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api240_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api240_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api240_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api240_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api240_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api240_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api240_volumes_test_post_with_http_info = volumes_test_post_with_http_info
    api240_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api241_volumes_batch_post_with_http_info = volumes_batch_post_with_http_info
    api241_volumes_batch_test_post_with_http_info = volumes_batch_test_post_with_http_info
    api241_volumes_delete_with_http_info = volumes_delete_with_http_info
    api241_volumes_diff_get_with_http_info = volumes_diff_get_with_http_info
    api241_volumes_get_with_http_info = volumes_get_with_http_info
    api241_volumes_patch_with_http_info = volumes_patch_with_http_info
    api241_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api241_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api241_volumes_post_with_http_info = volumes_post_with_http_info
    api241_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api241_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api241_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api241_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api241_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api241_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api241_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api241_volumes_test_post_with_http_info = volumes_test_post_with_http_info
    api241_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api242_volumes_batch_post_with_http_info = volumes_batch_post_with_http_info
    api242_volumes_batch_test_post_with_http_info = volumes_batch_test_post_with_http_info
    api242_volumes_delete_with_http_info = volumes_delete_with_http_info
    api242_volumes_diff_get_with_http_info = volumes_diff_get_with_http_info
    api242_volumes_get_with_http_info = volumes_get_with_http_info
    api242_volumes_patch_with_http_info = volumes_patch_with_http_info
    api242_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api242_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api242_volumes_post_with_http_info = volumes_post_with_http_info
    api242_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api242_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api242_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api242_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api242_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api242_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api242_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api242_volumes_test_post_with_http_info = volumes_test_post_with_http_info
    api242_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
