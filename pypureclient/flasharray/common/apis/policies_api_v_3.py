...
from pypureclient.flasharray.common.models.policy_get_response_v_3 import PolicyGetResponse
...
from pypureclient.flasharray.common.models.policy_response_v_3 import PolicyResponse
...
from pypureclient.flasharray.common.models.policy_rule_snapshot_get_response_v_3 import PolicyRuleSnapshotGetResponse
from pypureclient.flasharray.common.models.policy_rule_snapshot_post_v_3 import PolicyRuleSnapshotPost
from pypureclient.flasharray.common.models.policy_rule_snapshot_response_v_3 import PolicyRuleSnapshotResponse
...
class PoliciesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api23_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_nfs_client_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_nfs_client_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_nfs_client_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_nfs_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_nfs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_nfs_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_nfs_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_nfs_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_nfs_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_nfs_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_smb_client_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_smb_client_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_smb_client_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_smb_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_smb_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_smb_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_smb_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_smb_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_smb_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_smb_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_snapshot_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_snapshot_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_snapshot_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_snapshot_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_snapshot_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_snapshot_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_snapshot_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_snapshot_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_snapshot_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_policies_snapshot_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api23_policies_get_with_http_info = policies_get_with_http_info
    api23_policies_members_get_with_http_info = policies_members_get_with_http_info
    api23_policies_nfs_client_rules_delete_with_http_info = policies_nfs_client_rules_delete_with_http_info
    api23_policies_nfs_client_rules_get_with_http_info = policies_nfs_client_rules_get_with_http_info
    api23_policies_nfs_client_rules_post_with_http_info = policies_nfs_client_rules_post_with_http_info
    api23_policies_nfs_delete_with_http_info = policies_nfs_delete_with_http_info
    api23_policies_nfs_get_with_http_info = policies_nfs_get_with_http_info
    api23_policies_nfs_members_delete_with_http_info = policies_nfs_members_delete_with_http_info
    api23_policies_nfs_members_get_with_http_info = policies_nfs_members_get_with_http_info
    api23_policies_nfs_members_post_with_http_info = policies_nfs_members_post_with_http_info
    api23_policies_nfs_patch_with_http_info = policies_nfs_patch_with_http_info
    api23_policies_nfs_post_with_http_info = policies_nfs_post_with_http_info
    api23_policies_smb_client_rules_delete_with_http_info = policies_smb_client_rules_delete_with_http_info
    api23_policies_smb_client_rules_get_with_http_info = policies_smb_client_rules_get_with_http_info
    api23_policies_smb_client_rules_post_with_http_info = policies_smb_client_rules_post_with_http_info
    api23_policies_smb_delete_with_http_info = policies_smb_delete_with_http_info
    api23_policies_smb_get_with_http_info = policies_smb_get_with_http_info
    api23_policies_smb_members_delete_with_http_info = policies_smb_members_delete_with_http_info
    api23_policies_smb_members_get_with_http_info = policies_smb_members_get_with_http_info
    api23_policies_smb_members_post_with_http_info = policies_smb_members_post_with_http_info
    api23_policies_smb_patch_with_http_info = policies_smb_patch_with_http_info
    api23_policies_smb_post_with_http_info = policies_smb_post_with_http_info
    api23_policies_snapshot_delete_with_http_info = policies_snapshot_delete_with_http_info
    api23_policies_snapshot_get_with_http_info = policies_snapshot_get_with_http_info
    api23_policies_snapshot_members_delete_with_http_info = policies_snapshot_members_delete_with_http_info
    api23_policies_snapshot_members_get_with_http_info = policies_snapshot_members_get_with_http_info
    api23_policies_snapshot_members_post_with_http_info = policies_snapshot_members_post_with_http_info
    api23_policies_snapshot_patch_with_http_info = policies_snapshot_patch_with_http_info
    api23_policies_snapshot_post_with_http_info = policies_snapshot_post_with_http_info
    api23_policies_snapshot_rules_delete_with_http_info = policies_snapshot_rules_delete_with_http_info
    api23_policies_snapshot_rules_get_with_http_info = policies_snapshot_rules_get_with_http_info
    api23_policies_snapshot_rules_post_with_http_info = policies_snapshot_rules_post_with_http_info
