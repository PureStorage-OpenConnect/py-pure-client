...
from pypureclient.flasharray.common.models.dns_get_response_v_48 import DnsGetResponse
from pypureclient.flasharray.common.models.dns_patch_v_38 import DnsPatch
from pypureclient.flasharray.common.models.dns_post_v_38 import DnsPost
from pypureclient.flasharray.common.models.dns_response_v_48 import DnsResponse
...
class DNSApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api248_dns_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api248_dns_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api248_dns_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api248_dns_delete_with_http_info = dns_delete_with_http_info
    api248_dns_get_with_http_info = dns_get_with_http_info
    api248_dns_patch_with_http_info = dns_patch_with_http_info
    api248_dns_post_with_http_info = dns_post_with_http_info
