...
from pypureclient.flasharray.common.models.volume_group_get_response_v_38 import VolumeGroupGetResponse
...
from pypureclient.flasharray.common.models.volume_group_response_v_38 import VolumeGroupResponse
...
class VolumeGroupsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api239_volume_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_volume_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_volume_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_volume_groups_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_volume_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_volume_groups_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_volume_groups_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_volume_groups_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_volume_groups_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_volume_groups_volumes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api239_volume_groups_delete_with_http_info = volume_groups_delete_with_http_info
    api239_volume_groups_get_with_http_info = volume_groups_get_with_http_info
    api239_volume_groups_patch_with_http_info = volume_groups_patch_with_http_info
    api239_volume_groups_performance_get_with_http_info = volume_groups_performance_get_with_http_info
    api239_volume_groups_post_with_http_info = volume_groups_post_with_http_info
    api239_volume_groups_space_get_with_http_info = volume_groups_space_get_with_http_info
    api239_volume_groups_tags_batch_put_with_http_info = volume_groups_tags_batch_put_with_http_info
    api239_volume_groups_tags_delete_with_http_info = volume_groups_tags_delete_with_http_info
    api239_volume_groups_tags_get_with_http_info = volume_groups_tags_get_with_http_info
    api239_volume_groups_volumes_get_with_http_info = volume_groups_volumes_get_with_http_info
    api240_volume_groups_delete_with_http_info = volume_groups_delete_with_http_info
    api240_volume_groups_get_with_http_info = volume_groups_get_with_http_info
    api240_volume_groups_patch_with_http_info = volume_groups_patch_with_http_info
    api240_volume_groups_performance_get_with_http_info = volume_groups_performance_get_with_http_info
    api240_volume_groups_post_with_http_info = volume_groups_post_with_http_info
    api240_volume_groups_space_get_with_http_info = volume_groups_space_get_with_http_info
    api240_volume_groups_tags_batch_put_with_http_info = volume_groups_tags_batch_put_with_http_info
    api240_volume_groups_tags_delete_with_http_info = volume_groups_tags_delete_with_http_info
    api240_volume_groups_tags_get_with_http_info = volume_groups_tags_get_with_http_info
    api240_volume_groups_volumes_get_with_http_info = volume_groups_volumes_get_with_http_info
    api241_volume_groups_delete_with_http_info = volume_groups_delete_with_http_info
    api241_volume_groups_get_with_http_info = volume_groups_get_with_http_info
    api241_volume_groups_patch_with_http_info = volume_groups_patch_with_http_info
    api241_volume_groups_performance_get_with_http_info = volume_groups_performance_get_with_http_info
    api241_volume_groups_post_with_http_info = volume_groups_post_with_http_info
    api241_volume_groups_space_get_with_http_info = volume_groups_space_get_with_http_info
    api241_volume_groups_tags_batch_put_with_http_info = volume_groups_tags_batch_put_with_http_info
    api241_volume_groups_tags_delete_with_http_info = volume_groups_tags_delete_with_http_info
    api241_volume_groups_tags_get_with_http_info = volume_groups_tags_get_with_http_info
    api241_volume_groups_volumes_get_with_http_info = volume_groups_volumes_get_with_http_info
    api242_volume_groups_delete_with_http_info = volume_groups_delete_with_http_info
    api242_volume_groups_get_with_http_info = volume_groups_get_with_http_info
    api242_volume_groups_patch_with_http_info = volume_groups_patch_with_http_info
    api242_volume_groups_performance_get_with_http_info = volume_groups_performance_get_with_http_info
    api242_volume_groups_post_with_http_info = volume_groups_post_with_http_info
    api242_volume_groups_space_get_with_http_info = volume_groups_space_get_with_http_info
    api242_volume_groups_tags_batch_put_with_http_info = volume_groups_tags_batch_put_with_http_info
    api242_volume_groups_tags_delete_with_http_info = volume_groups_tags_delete_with_http_info
    api242_volume_groups_tags_get_with_http_info = volume_groups_tags_get_with_http_info
    api242_volume_groups_volumes_get_with_http_info = volume_groups_volumes_get_with_http_info
    api243_volume_groups_delete_with_http_info = volume_groups_delete_with_http_info
    api243_volume_groups_get_with_http_info = volume_groups_get_with_http_info
    api243_volume_groups_patch_with_http_info = volume_groups_patch_with_http_info
    api243_volume_groups_performance_get_with_http_info = volume_groups_performance_get_with_http_info
    api243_volume_groups_post_with_http_info = volume_groups_post_with_http_info
    api243_volume_groups_space_get_with_http_info = volume_groups_space_get_with_http_info
    api243_volume_groups_tags_batch_put_with_http_info = volume_groups_tags_batch_put_with_http_info
    api243_volume_groups_tags_delete_with_http_info = volume_groups_tags_delete_with_http_info
    api243_volume_groups_tags_get_with_http_info = volume_groups_tags_get_with_http_info
    api243_volume_groups_volumes_get_with_http_info = volume_groups_volumes_get_with_http_info
    api244_volume_groups_delete_with_http_info = volume_groups_delete_with_http_info
    api244_volume_groups_get_with_http_info = volume_groups_get_with_http_info
    api244_volume_groups_patch_with_http_info = volume_groups_patch_with_http_info
    api244_volume_groups_performance_get_with_http_info = volume_groups_performance_get_with_http_info
    api244_volume_groups_post_with_http_info = volume_groups_post_with_http_info
    api244_volume_groups_space_get_with_http_info = volume_groups_space_get_with_http_info
    api244_volume_groups_tags_batch_put_with_http_info = volume_groups_tags_batch_put_with_http_info
    api244_volume_groups_tags_delete_with_http_info = volume_groups_tags_delete_with_http_info
    api244_volume_groups_tags_get_with_http_info = volume_groups_tags_get_with_http_info
    api244_volume_groups_volumes_get_with_http_info = volume_groups_volumes_get_with_http_info
    api245_volume_groups_delete_with_http_info = volume_groups_delete_with_http_info
    api245_volume_groups_get_with_http_info = volume_groups_get_with_http_info
    api245_volume_groups_patch_with_http_info = volume_groups_patch_with_http_info
    api245_volume_groups_performance_get_with_http_info = volume_groups_performance_get_with_http_info
    api245_volume_groups_post_with_http_info = volume_groups_post_with_http_info
    api245_volume_groups_space_get_with_http_info = volume_groups_space_get_with_http_info
    api245_volume_groups_tags_batch_put_with_http_info = volume_groups_tags_batch_put_with_http_info
    api245_volume_groups_tags_delete_with_http_info = volume_groups_tags_delete_with_http_info
    api245_volume_groups_tags_get_with_http_info = volume_groups_tags_get_with_http_info
    api245_volume_groups_volumes_get_with_http_info = volume_groups_volumes_get_with_http_info
    api246_volume_groups_delete_with_http_info = volume_groups_delete_with_http_info
    api246_volume_groups_get_with_http_info = volume_groups_get_with_http_info
    api246_volume_groups_patch_with_http_info = volume_groups_patch_with_http_info
    api246_volume_groups_performance_get_with_http_info = volume_groups_performance_get_with_http_info
    api246_volume_groups_post_with_http_info = volume_groups_post_with_http_info
    api246_volume_groups_space_get_with_http_info = volume_groups_space_get_with_http_info
    api246_volume_groups_tags_batch_put_with_http_info = volume_groups_tags_batch_put_with_http_info
    api246_volume_groups_tags_delete_with_http_info = volume_groups_tags_delete_with_http_info
    api246_volume_groups_tags_get_with_http_info = volume_groups_tags_get_with_http_info
    api246_volume_groups_volumes_get_with_http_info = volume_groups_volumes_get_with_http_info
    api247_volume_groups_delete_with_http_info = volume_groups_delete_with_http_info
    api247_volume_groups_get_with_http_info = volume_groups_get_with_http_info
    api247_volume_groups_patch_with_http_info = volume_groups_patch_with_http_info
    api247_volume_groups_performance_get_with_http_info = volume_groups_performance_get_with_http_info
    api247_volume_groups_post_with_http_info = volume_groups_post_with_http_info
    api247_volume_groups_space_get_with_http_info = volume_groups_space_get_with_http_info
    api247_volume_groups_tags_batch_put_with_http_info = volume_groups_tags_batch_put_with_http_info
    api247_volume_groups_tags_delete_with_http_info = volume_groups_tags_delete_with_http_info
    api247_volume_groups_tags_get_with_http_info = volume_groups_tags_get_with_http_info
    api247_volume_groups_volumes_get_with_http_info = volume_groups_volumes_get_with_http_info
    api248_volume_groups_delete_with_http_info = volume_groups_delete_with_http_info
    api248_volume_groups_get_with_http_info = volume_groups_get_with_http_info
    api248_volume_groups_patch_with_http_info = volume_groups_patch_with_http_info
    api248_volume_groups_performance_get_with_http_info = volume_groups_performance_get_with_http_info
    api248_volume_groups_post_with_http_info = volume_groups_post_with_http_info
    api248_volume_groups_space_get_with_http_info = volume_groups_space_get_with_http_info
    api248_volume_groups_tags_batch_put_with_http_info = volume_groups_tags_batch_put_with_http_info
    api248_volume_groups_tags_delete_with_http_info = volume_groups_tags_delete_with_http_info
    api248_volume_groups_tags_get_with_http_info = volume_groups_tags_get_with_http_info
    api248_volume_groups_volumes_get_with_http_info = volume_groups_volumes_get_with_http_info
