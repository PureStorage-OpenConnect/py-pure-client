...
class VolumesApi:
    ...
    # Method Aliases
    api21_volumes_delete_with_http_info = volumes_delete_with_http_info
    api21_volumes_get_with_http_info = volumes_get_with_http_info
    api21_volumes_patch_with_http_info = volumes_patch_with_http_info
    api21_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api21_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api21_volumes_post_with_http_info = volumes_post_with_http_info
    api21_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api21_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api21_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api21_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api21_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
