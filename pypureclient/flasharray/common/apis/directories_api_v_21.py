...
class DirectoriesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api221_directories_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_locks_nlm_reclamations_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_policies_nfs_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_policies_nfs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_policies_nfs_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_policies_quota_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_policies_quota_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_policies_quota_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_policies_smb_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_policies_smb_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_policies_smb_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_policies_snapshot_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_policies_snapshot_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_policies_snapshot_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directories_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api221_directories_delete_with_http_info = directories_delete_with_http_info
    api221_directories_get_with_http_info = directories_get_with_http_info
    api221_directories_locks_nlm_reclamations_post_with_http_info = directories_locks_nlm_reclamations_post_with_http_info
    api221_directories_patch_with_http_info = directories_patch_with_http_info
    api221_directories_performance_get_with_http_info = directories_performance_get_with_http_info
    api221_directories_policies_get_with_http_info = directories_policies_get_with_http_info
    api221_directories_policies_nfs_delete_with_http_info = directories_policies_nfs_delete_with_http_info
    api221_directories_policies_nfs_get_with_http_info = directories_policies_nfs_get_with_http_info
    api221_directories_policies_nfs_post_with_http_info = directories_policies_nfs_post_with_http_info
    api221_directories_policies_quota_delete_with_http_info = directories_policies_quota_delete_with_http_info
    api221_directories_policies_quota_get_with_http_info = directories_policies_quota_get_with_http_info
    api221_directories_policies_quota_post_with_http_info = directories_policies_quota_post_with_http_info
    api221_directories_policies_smb_delete_with_http_info = directories_policies_smb_delete_with_http_info
    api221_directories_policies_smb_get_with_http_info = directories_policies_smb_get_with_http_info
    api221_directories_policies_smb_post_with_http_info = directories_policies_smb_post_with_http_info
    api221_directories_policies_snapshot_delete_with_http_info = directories_policies_snapshot_delete_with_http_info
    api221_directories_policies_snapshot_get_with_http_info = directories_policies_snapshot_get_with_http_info
    api221_directories_policies_snapshot_post_with_http_info = directories_policies_snapshot_post_with_http_info
    api221_directories_post_with_http_info = directories_post_with_http_info
    api221_directories_space_get_with_http_info = directories_space_get_with_http_info
    api222_directories_delete_with_http_info = directories_delete_with_http_info
    api222_directories_get_with_http_info = directories_get_with_http_info
    api222_directories_locks_nlm_reclamations_post_with_http_info = directories_locks_nlm_reclamations_post_with_http_info
    api222_directories_patch_with_http_info = directories_patch_with_http_info
    api222_directories_performance_get_with_http_info = directories_performance_get_with_http_info
    api222_directories_policies_get_with_http_info = directories_policies_get_with_http_info
    api222_directories_policies_nfs_delete_with_http_info = directories_policies_nfs_delete_with_http_info
    api222_directories_policies_nfs_get_with_http_info = directories_policies_nfs_get_with_http_info
    api222_directories_policies_nfs_post_with_http_info = directories_policies_nfs_post_with_http_info
    api222_directories_policies_quota_delete_with_http_info = directories_policies_quota_delete_with_http_info
    api222_directories_policies_quota_get_with_http_info = directories_policies_quota_get_with_http_info
    api222_directories_policies_quota_post_with_http_info = directories_policies_quota_post_with_http_info
    api222_directories_policies_smb_delete_with_http_info = directories_policies_smb_delete_with_http_info
    api222_directories_policies_smb_get_with_http_info = directories_policies_smb_get_with_http_info
    api222_directories_policies_smb_post_with_http_info = directories_policies_smb_post_with_http_info
    api222_directories_policies_snapshot_delete_with_http_info = directories_policies_snapshot_delete_with_http_info
    api222_directories_policies_snapshot_get_with_http_info = directories_policies_snapshot_get_with_http_info
    api222_directories_policies_snapshot_post_with_http_info = directories_policies_snapshot_post_with_http_info
    api222_directories_post_with_http_info = directories_post_with_http_info
    api222_directories_space_get_with_http_info = directories_space_get_with_http_info
