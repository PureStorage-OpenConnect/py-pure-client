...
from pypureclient.flasharray.common.models.connection_get_response_v_0 import ConnectionGetResponse
from pypureclient.flasharray.common.models.connection_post_v_0 import ConnectionPost
from pypureclient.flasharray.common.models.connection_response_v_0 import ConnectionResponse
...
class ConnectionsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api20_connections_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_connections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_connections_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api20_connections_delete_with_http_info = connections_delete_with_http_info
    api20_connections_get_with_http_info = connections_get_with_http_info
    api20_connections_post_with_http_info = connections_post_with_http_info
