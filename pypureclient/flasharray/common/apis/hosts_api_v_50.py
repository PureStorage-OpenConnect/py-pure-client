...
from pypureclient.flasharray.common.models.host_get_response_v_50 import HostGetResponse
from pypureclient.flasharray.common.models.host_patch_v_50 import HostPatch
from pypureclient.flasharray.common.models.host_performance_balance_get_response_v_50 import HostPerformanceBalanceGetResponse
from pypureclient.flasharray.common.models.host_post_v_50 import HostPost
from pypureclient.flasharray.common.models.host_qos_get_response_v_50 import HostQosGetResponse
from pypureclient.flasharray.common.models.host_response_v_50 import HostResponse
...
class HostsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api250_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_host_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_host_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_host_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_performance_balance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "HostPerformanceBalanceGetResponse",
        }
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def hosts_qos_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        """List host QoS config

        Displays real-time and historical QoS config data for each host.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(HostQosGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_qos_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "HostQosGetResponse",
            '207': "HostQosGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/hosts/qos', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_hosts_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api250_hosts_delete_with_http_info = hosts_delete_with_http_info
    api250_hosts_get_with_http_info = hosts_get_with_http_info
    api250_hosts_host_groups_delete_with_http_info = hosts_host_groups_delete_with_http_info
    api250_hosts_host_groups_get_with_http_info = hosts_host_groups_get_with_http_info
    api250_hosts_host_groups_post_with_http_info = hosts_host_groups_post_with_http_info
    api250_hosts_patch_with_http_info = hosts_patch_with_http_info
    api250_hosts_performance_balance_get_with_http_info = hosts_performance_balance_get_with_http_info
    api250_hosts_performance_by_array_get_with_http_info = hosts_performance_by_array_get_with_http_info
    api250_hosts_performance_get_with_http_info = hosts_performance_get_with_http_info
    api250_hosts_post_with_http_info = hosts_post_with_http_info
    api250_hosts_protection_groups_delete_with_http_info = hosts_protection_groups_delete_with_http_info
    api250_hosts_protection_groups_get_with_http_info = hosts_protection_groups_get_with_http_info
    api250_hosts_protection_groups_post_with_http_info = hosts_protection_groups_post_with_http_info
    api250_hosts_qos_get_with_http_info = hosts_qos_get_with_http_info
    api250_hosts_space_get_with_http_info = hosts_space_get_with_http_info
    api250_hosts_tags_batch_put_with_http_info = hosts_tags_batch_put_with_http_info
    api250_hosts_tags_delete_with_http_info = hosts_tags_delete_with_http_info
    api250_hosts_tags_get_with_http_info = hosts_tags_get_with_http_info
    api251_hosts_delete_with_http_info = hosts_delete_with_http_info
    api251_hosts_get_with_http_info = hosts_get_with_http_info
    api251_hosts_host_groups_delete_with_http_info = hosts_host_groups_delete_with_http_info
    api251_hosts_host_groups_get_with_http_info = hosts_host_groups_get_with_http_info
    api251_hosts_host_groups_post_with_http_info = hosts_host_groups_post_with_http_info
    api251_hosts_patch_with_http_info = hosts_patch_with_http_info
    api251_hosts_performance_balance_get_with_http_info = hosts_performance_balance_get_with_http_info
    api251_hosts_performance_by_array_get_with_http_info = hosts_performance_by_array_get_with_http_info
    api251_hosts_performance_get_with_http_info = hosts_performance_get_with_http_info
    api251_hosts_post_with_http_info = hosts_post_with_http_info
    api251_hosts_protection_groups_delete_with_http_info = hosts_protection_groups_delete_with_http_info
    api251_hosts_protection_groups_get_with_http_info = hosts_protection_groups_get_with_http_info
    api251_hosts_protection_groups_post_with_http_info = hosts_protection_groups_post_with_http_info
    api251_hosts_qos_get_with_http_info = hosts_qos_get_with_http_info
    api251_hosts_space_get_with_http_info = hosts_space_get_with_http_info
    api251_hosts_tags_batch_put_with_http_info = hosts_tags_batch_put_with_http_info
    api251_hosts_tags_delete_with_http_info = hosts_tags_delete_with_http_info
    api251_hosts_tags_get_with_http_info = hosts_tags_get_with_http_info
