...
class HostsApi:
    ...
    # Method Aliases
    api238_hosts_delete_with_http_info = hosts_delete_with_http_info
    api238_hosts_get_with_http_info = hosts_get_with_http_info
    api238_hosts_host_groups_delete_with_http_info = hosts_host_groups_delete_with_http_info
    api238_hosts_host_groups_get_with_http_info = hosts_host_groups_get_with_http_info
    api238_hosts_host_groups_post_with_http_info = hosts_host_groups_post_with_http_info
    api238_hosts_patch_with_http_info = hosts_patch_with_http_info
    api238_hosts_performance_balance_get_with_http_info = hosts_performance_balance_get_with_http_info
    api238_hosts_performance_by_array_get_with_http_info = hosts_performance_by_array_get_with_http_info
    api238_hosts_performance_get_with_http_info = hosts_performance_get_with_http_info
    api238_hosts_post_with_http_info = hosts_post_with_http_info
    api238_hosts_protection_groups_delete_with_http_info = hosts_protection_groups_delete_with_http_info
    api238_hosts_protection_groups_get_with_http_info = hosts_protection_groups_get_with_http_info
    api238_hosts_protection_groups_post_with_http_info = hosts_protection_groups_post_with_http_info
    api238_hosts_space_get_with_http_info = hosts_space_get_with_http_info
    api238_hosts_tags_batch_put_with_http_info = hosts_tags_batch_put_with_http_info
    api238_hosts_tags_delete_with_http_info = hosts_tags_delete_with_http_info
    api238_hosts_tags_get_with_http_info = hosts_tags_get_with_http_info
