...
from pypureclient.flasharray.common.models.software_get_response_v_2 import SoftwareGetResponse
from pypureclient.flasharray.common.models.software_installation_patch_v_2 import SoftwareInstallationPatch
from pypureclient.flasharray.common.models.software_installation_post_v_2 import SoftwareInstallationPost
...
from pypureclient.flasharray.common.models.software_installations_get_response_v_2 import SoftwareInstallationsGetResponse
from pypureclient.flasharray.common.models.software_installations_response_v_2 import SoftwareInstallationsResponse
...
class SoftwareApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api22_software_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_software_installation_steps_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_software_installations_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_software_installations_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_software_installations_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api22_software_get_with_http_info = software_get_with_http_info
    api22_software_installation_steps_get_with_http_info = software_installation_steps_get_with_http_info
    api22_software_installations_get_with_http_info = software_installations_get_with_http_info
    api22_software_installations_patch_with_http_info = software_installations_patch_with_http_info
    api22_software_installations_post_with_http_info = software_installations_post_with_http_info
    api23_software_get_with_http_info = software_get_with_http_info
    api23_software_installation_steps_get_with_http_info = software_installation_steps_get_with_http_info
    api23_software_installations_get_with_http_info = software_installations_get_with_http_info
    api23_software_installations_patch_with_http_info = software_installations_patch_with_http_info
    api23_software_installations_post_with_http_info = software_installations_post_with_http_info
