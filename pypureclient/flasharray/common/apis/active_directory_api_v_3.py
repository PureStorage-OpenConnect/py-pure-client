...
from pypureclient.flasharray.common.models.active_directory_get_response_v_3 import ActiveDirectoryGetResponse
from pypureclient.flasharray.common.models.active_directory_post_v_3 import ActiveDirectoryPost
from pypureclient.flasharray.common.models.active_directory_response_v_3 import ActiveDirectoryResponse
...
class ActiveDirectoryApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api23_active_directory_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_active_directory_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_active_directory_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api214_active_directory_delete_with_http_info = active_directory_delete_with_http_info
    api214_active_directory_get_with_http_info = active_directory_get_with_http_info
    api214_active_directory_post_with_http_info = active_directory_post_with_http_info
