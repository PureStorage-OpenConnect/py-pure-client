...
from pypureclient.flasharray.common.models.admin_cache_get_response_v_49 import AdminCacheGetResponse
from pypureclient.flasharray.common.models.admin_cache_response_v_49 import AdminCacheResponse
from pypureclient.flasharray.common.models.admin_get_response_v_49 import AdminGetResponse
from pypureclient.flasharray.common.models.admin_patch_v_49 import AdminPatch
from pypureclient.flasharray.common.models.admin_post_v_49 import AdminPost
from pypureclient.flasharray.common.models.admin_response_v_49 import AdminResponse
from pypureclient.flasharray.common.models.admin_settings_get_response_v_32 import AdminSettingsGetResponse
from pypureclient.flasharray.common.models.admin_settings_response_v_32 import AdminSettingsResponse
from pypureclient.flasharray.common.models.admin_settings_v_32 import AdminSettings
from pypureclient.flasharray.common.models.policy_assignment_post_v_49 import PolicyAssignmentPost
from pypureclient.flasharray.common.models.policy_member_clean_get_response_v_49 import PolicyMemberCleanGetResponse
from pypureclient.flasharray.common.models.policy_member_clean_response_v_49 import PolicyMemberCleanResponse
...
class AdministratorsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api249_admins_api_tokens_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_api_tokens_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_api_tokens_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_cache_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_cache_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_cache_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def admins_policies_management_access_delete_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_policies_management_access_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/admins/policies/management-access', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def admins_policies_management_access_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_policies_management_access_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/admins/policies/management-access', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def admins_policies_management_access_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_policies_management_access_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/admins/policies/management-access', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_admins_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api249_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api249_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api249_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api249_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api249_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api249_admins_cache_put_with_http_info = admins_cache_put_with_http_info
    api249_admins_delete_with_http_info = admins_delete_with_http_info
    api249_admins_get_with_http_info = admins_get_with_http_info
    api249_admins_patch_with_http_info = admins_patch_with_http_info
    api249_admins_policies_management_access_delete_with_http_info = admins_policies_management_access_delete_with_http_info
    api249_admins_policies_management_access_get_with_http_info = admins_policies_management_access_get_with_http_info
    api249_admins_policies_management_access_post_with_http_info = admins_policies_management_access_post_with_http_info
    api249_admins_post_with_http_info = admins_post_with_http_info
    api249_admins_settings_get_with_http_info = admins_settings_get_with_http_info
    api249_admins_settings_patch_with_http_info = admins_settings_patch_with_http_info
    api250_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api250_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api250_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api250_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api250_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api250_admins_cache_put_with_http_info = admins_cache_put_with_http_info
    api250_admins_delete_with_http_info = admins_delete_with_http_info
    api250_admins_get_with_http_info = admins_get_with_http_info
    api250_admins_patch_with_http_info = admins_patch_with_http_info
    api250_admins_policies_management_access_delete_with_http_info = admins_policies_management_access_delete_with_http_info
    api250_admins_policies_management_access_get_with_http_info = admins_policies_management_access_get_with_http_info
    api250_admins_policies_management_access_post_with_http_info = admins_policies_management_access_post_with_http_info
    api250_admins_post_with_http_info = admins_post_with_http_info
    api250_admins_settings_get_with_http_info = admins_settings_get_with_http_info
    api250_admins_settings_patch_with_http_info = admins_settings_patch_with_http_info
    api251_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api251_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api251_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api251_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api251_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api251_admins_cache_put_with_http_info = admins_cache_put_with_http_info
    api251_admins_delete_with_http_info = admins_delete_with_http_info
    api251_admins_get_with_http_info = admins_get_with_http_info
    api251_admins_patch_with_http_info = admins_patch_with_http_info
    api251_admins_policies_management_access_delete_with_http_info = admins_policies_management_access_delete_with_http_info
    api251_admins_policies_management_access_get_with_http_info = admins_policies_management_access_get_with_http_info
    api251_admins_policies_management_access_post_with_http_info = admins_policies_management_access_post_with_http_info
    api251_admins_post_with_http_info = admins_post_with_http_info
    api251_admins_settings_get_with_http_info = admins_settings_get_with_http_info
    api251_admins_settings_patch_with_http_info = admins_settings_patch_with_http_info
