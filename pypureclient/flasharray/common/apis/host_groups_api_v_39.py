...
class HostGroupsApi:
    ...
    # Method Aliases
    api239_host_groups_delete_with_http_info = host_groups_delete_with_http_info
    api239_host_groups_get_with_http_info = host_groups_get_with_http_info
    api239_host_groups_hosts_delete_with_http_info = host_groups_hosts_delete_with_http_info
    api239_host_groups_hosts_get_with_http_info = host_groups_hosts_get_with_http_info
    api239_host_groups_hosts_post_with_http_info = host_groups_hosts_post_with_http_info
    api239_host_groups_patch_with_http_info = host_groups_patch_with_http_info
    api239_host_groups_performance_by_array_get_with_http_info = host_groups_performance_by_array_get_with_http_info
    api239_host_groups_performance_get_with_http_info = host_groups_performance_get_with_http_info
    api239_host_groups_post_with_http_info = host_groups_post_with_http_info
    api239_host_groups_protection_groups_delete_with_http_info = host_groups_protection_groups_delete_with_http_info
    api239_host_groups_protection_groups_get_with_http_info = host_groups_protection_groups_get_with_http_info
    api239_host_groups_protection_groups_post_with_http_info = host_groups_protection_groups_post_with_http_info
    api239_host_groups_space_get_with_http_info = host_groups_space_get_with_http_info
    api239_host_groups_tags_batch_put_with_http_info = host_groups_tags_batch_put_with_http_info
    api239_host_groups_tags_delete_with_http_info = host_groups_tags_delete_with_http_info
    api239_host_groups_tags_get_with_http_info = host_groups_tags_get_with_http_info
