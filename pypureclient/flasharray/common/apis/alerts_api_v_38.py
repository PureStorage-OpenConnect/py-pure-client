...
from pypureclient.flasharray.common.models.alert_event_get_response_v_38 import AlertEventGetResponse
from pypureclient.flasharray.common.models.alert_get_response_v_38 import AlertGetResponse
from pypureclient.flasharray.common.models.alert_response_v_38 import AlertResponse
from pypureclient.flasharray.common.models.alert_rules_catalog_get_response_v_38 import AlertRulesCatalogGetResponse
from pypureclient.flasharray.common.models.alert_rules_get_response_v_38 import AlertRulesGetResponse
from pypureclient.flasharray.common.models.alert_rules_response_v_38 import AlertRulesResponse
from pypureclient.flasharray.common.models.alert_rules_v_38 import AlertRules
from pypureclient.flasharray.common.models.alert_v_38 import Alert
...
class AlertsApi:
    ...
    def alerts_events_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api238_alerts_events_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/alerts/events', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_alerts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def alerts_patch_with_http_info(
        self,
        alert: Alert,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_alerts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/alerts', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def alerts_rules_catalog_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_alerts_rules_catalog_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/alerts/rules/catalog', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def alerts_rules_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_alerts_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/alerts/rules', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def alerts_rules_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_alerts_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/alerts/rules', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def alerts_rules_patch_with_http_info(
        self,
        code: Annotated[StrictInt, Field(..., description="The alert code that the rule applies to. Available alert codes for customization can be found in the alert rules catalog.")],
        parameter: Annotated[StrictStr, Field(..., description="The parameter of the custom alert rule to modify. Values include `info` and `warning`. Available parameter values can be found in the alert rules catalog.")],
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_alerts_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/alerts/rules', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def alerts_rules_post_with_http_info(
        self,
        code: Annotated[StrictInt, Field(..., description="The alert code that the rule applies to. Available alert codes for customization can be found in the alert rules catalog.")],
        parameter: Annotated[StrictStr, Field(..., description="The parameter of the custom alert rule to modify. Values include `info` and `warning`. Available parameter values can be found in the alert rules catalog.")],
        alert_rule: AlertRules,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_alerts_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/alerts/rules', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api238_alerts_events_get_with_http_info = alerts_events_get_with_http_info
    api238_alerts_get_with_http_info = alerts_get_with_http_info
    api238_alerts_patch_with_http_info = alerts_patch_with_http_info
    api238_alerts_rules_catalog_get_with_http_info = alerts_rules_catalog_get_with_http_info
    api238_alerts_rules_delete_with_http_info = alerts_rules_delete_with_http_info
    api238_alerts_rules_get_with_http_info = alerts_rules_get_with_http_info
    api238_alerts_rules_patch_with_http_info = alerts_rules_patch_with_http_info
    api238_alerts_rules_post_with_http_info = alerts_rules_post_with_http_info
    api239_alerts_events_get_with_http_info = alerts_events_get_with_http_info
    api239_alerts_get_with_http_info = alerts_get_with_http_info
    api239_alerts_patch_with_http_info = alerts_patch_with_http_info
    api239_alerts_rules_catalog_get_with_http_info = alerts_rules_catalog_get_with_http_info
    api239_alerts_rules_delete_with_http_info = alerts_rules_delete_with_http_info
    api239_alerts_rules_get_with_http_info = alerts_rules_get_with_http_info
    api239_alerts_rules_patch_with_http_info = alerts_rules_patch_with_http_info
    api239_alerts_rules_post_with_http_info = alerts_rules_post_with_http_info
    api240_alerts_events_get_with_http_info = alerts_events_get_with_http_info
    api240_alerts_get_with_http_info = alerts_get_with_http_info
    api240_alerts_patch_with_http_info = alerts_patch_with_http_info
    api240_alerts_rules_catalog_get_with_http_info = alerts_rules_catalog_get_with_http_info
    api240_alerts_rules_delete_with_http_info = alerts_rules_delete_with_http_info
    api240_alerts_rules_get_with_http_info = alerts_rules_get_with_http_info
    api240_alerts_rules_patch_with_http_info = alerts_rules_patch_with_http_info
    api240_alerts_rules_post_with_http_info = alerts_rules_post_with_http_info
    api241_alerts_events_get_with_http_info = alerts_events_get_with_http_info
    api241_alerts_get_with_http_info = alerts_get_with_http_info
    api241_alerts_patch_with_http_info = alerts_patch_with_http_info
    api241_alerts_rules_catalog_get_with_http_info = alerts_rules_catalog_get_with_http_info
    api241_alerts_rules_delete_with_http_info = alerts_rules_delete_with_http_info
    api241_alerts_rules_get_with_http_info = alerts_rules_get_with_http_info
    api241_alerts_rules_patch_with_http_info = alerts_rules_patch_with_http_info
    api241_alerts_rules_post_with_http_info = alerts_rules_post_with_http_info
    api242_alerts_events_get_with_http_info = alerts_events_get_with_http_info
    api242_alerts_get_with_http_info = alerts_get_with_http_info
    api242_alerts_patch_with_http_info = alerts_patch_with_http_info
    api242_alerts_rules_catalog_get_with_http_info = alerts_rules_catalog_get_with_http_info
    api242_alerts_rules_delete_with_http_info = alerts_rules_delete_with_http_info
    api242_alerts_rules_get_with_http_info = alerts_rules_get_with_http_info
    api242_alerts_rules_patch_with_http_info = alerts_rules_patch_with_http_info
    api242_alerts_rules_post_with_http_info = alerts_rules_post_with_http_info
    api243_alerts_events_get_with_http_info = alerts_events_get_with_http_info
    api243_alerts_get_with_http_info = alerts_get_with_http_info
    api243_alerts_patch_with_http_info = alerts_patch_with_http_info
    api243_alerts_rules_catalog_get_with_http_info = alerts_rules_catalog_get_with_http_info
    api243_alerts_rules_delete_with_http_info = alerts_rules_delete_with_http_info
    api243_alerts_rules_get_with_http_info = alerts_rules_get_with_http_info
    api243_alerts_rules_patch_with_http_info = alerts_rules_patch_with_http_info
    api243_alerts_rules_post_with_http_info = alerts_rules_post_with_http_info
    api244_alerts_events_get_with_http_info = alerts_events_get_with_http_info
    api244_alerts_get_with_http_info = alerts_get_with_http_info
    api244_alerts_patch_with_http_info = alerts_patch_with_http_info
    api244_alerts_rules_catalog_get_with_http_info = alerts_rules_catalog_get_with_http_info
    api244_alerts_rules_delete_with_http_info = alerts_rules_delete_with_http_info
    api244_alerts_rules_get_with_http_info = alerts_rules_get_with_http_info
    api244_alerts_rules_patch_with_http_info = alerts_rules_patch_with_http_info
    api244_alerts_rules_post_with_http_info = alerts_rules_post_with_http_info
    api245_alerts_events_get_with_http_info = alerts_events_get_with_http_info
    api245_alerts_get_with_http_info = alerts_get_with_http_info
    api245_alerts_patch_with_http_info = alerts_patch_with_http_info
    api245_alerts_rules_catalog_get_with_http_info = alerts_rules_catalog_get_with_http_info
    api245_alerts_rules_delete_with_http_info = alerts_rules_delete_with_http_info
    api245_alerts_rules_get_with_http_info = alerts_rules_get_with_http_info
    api245_alerts_rules_patch_with_http_info = alerts_rules_patch_with_http_info
    api245_alerts_rules_post_with_http_info = alerts_rules_post_with_http_info
    api246_alerts_events_get_with_http_info = alerts_events_get_with_http_info
    api246_alerts_get_with_http_info = alerts_get_with_http_info
    api246_alerts_patch_with_http_info = alerts_patch_with_http_info
    api246_alerts_rules_catalog_get_with_http_info = alerts_rules_catalog_get_with_http_info
    api246_alerts_rules_delete_with_http_info = alerts_rules_delete_with_http_info
    api246_alerts_rules_get_with_http_info = alerts_rules_get_with_http_info
    api246_alerts_rules_patch_with_http_info = alerts_rules_patch_with_http_info
    api246_alerts_rules_post_with_http_info = alerts_rules_post_with_http_info
    api247_alerts_events_get_with_http_info = alerts_events_get_with_http_info
    api247_alerts_get_with_http_info = alerts_get_with_http_info
    api247_alerts_patch_with_http_info = alerts_patch_with_http_info
    api247_alerts_rules_catalog_get_with_http_info = alerts_rules_catalog_get_with_http_info
    api247_alerts_rules_delete_with_http_info = alerts_rules_delete_with_http_info
    api247_alerts_rules_get_with_http_info = alerts_rules_get_with_http_info
    api247_alerts_rules_patch_with_http_info = alerts_rules_patch_with_http_info
    api247_alerts_rules_post_with_http_info = alerts_rules_post_with_http_info
    api248_alerts_events_get_with_http_info = alerts_events_get_with_http_info
    api248_alerts_get_with_http_info = alerts_get_with_http_info
    api248_alerts_patch_with_http_info = alerts_patch_with_http_info
    api248_alerts_rules_catalog_get_with_http_info = alerts_rules_catalog_get_with_http_info
    api248_alerts_rules_delete_with_http_info = alerts_rules_delete_with_http_info
    api248_alerts_rules_get_with_http_info = alerts_rules_get_with_http_info
    api248_alerts_rules_patch_with_http_info = alerts_rules_patch_with_http_info
    api248_alerts_rules_post_with_http_info = alerts_rules_post_with_http_info
