...
from pypureclient.flasharray.common.models.certificate_certificate_group_get_response_v_36 import CertificateCertificateGroupGetResponse
from pypureclient.flasharray.common.models.certificate_certificate_group_response_v_36 import CertificateCertificateGroupResponse
...
class CertificatesApi:
    ...
    def certificates_certificate_groups_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api236_certificates_certificate_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/certificates/certificate-groups', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def certificates_certificate_groups_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        certificate_group_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of certificate group ids. If there is not at least one resource that matches each of the elements of `certificate_group_ids`, then an error is returned. This cannot be provided in conjunction with the `certificate_group_names` parameter.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CertificateCertificateGroupGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_certificates_certificate_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "CertificateCertificateGroupGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/certificates/certificate-groups', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def certificates_certificate_groups_post_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        certificate_group_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of certificate group ids. If there is not at least one resource that matches each of the elements of `certificate_group_ids`, then an error is returned. This cannot be provided in conjunction with the `certificate_group_names` parameter.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_certificates_certificate_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/certificates/certificate-groups', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_certificates_certificate_signing_requests_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_certificates_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_certificates_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_certificates_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_certificates_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api236_certificates_certificate_groups_delete_with_http_info = certificates_certificate_groups_delete_with_http_info
    api236_certificates_certificate_groups_get_with_http_info = certificates_certificate_groups_get_with_http_info
    api236_certificates_certificate_groups_post_with_http_info = certificates_certificate_groups_post_with_http_info
    api236_certificates_certificate_signing_requests_post_with_http_info = certificates_certificate_signing_requests_post_with_http_info
    api236_certificates_delete_with_http_info = certificates_delete_with_http_info
    api236_certificates_get_with_http_info = certificates_get_with_http_info
    api236_certificates_patch_with_http_info = certificates_patch_with_http_info
    api236_certificates_post_with_http_info = certificates_post_with_http_info
    api237_certificates_certificate_groups_delete_with_http_info = certificates_certificate_groups_delete_with_http_info
    api237_certificates_certificate_groups_get_with_http_info = certificates_certificate_groups_get_with_http_info
    api237_certificates_certificate_groups_post_with_http_info = certificates_certificate_groups_post_with_http_info
    api237_certificates_certificate_signing_requests_post_with_http_info = certificates_certificate_signing_requests_post_with_http_info
    api237_certificates_delete_with_http_info = certificates_delete_with_http_info
    api237_certificates_get_with_http_info = certificates_get_with_http_info
    api237_certificates_patch_with_http_info = certificates_patch_with_http_info
    api237_certificates_post_with_http_info = certificates_post_with_http_info
    api238_certificates_certificate_groups_delete_with_http_info = certificates_certificate_groups_delete_with_http_info
    api238_certificates_certificate_groups_get_with_http_info = certificates_certificate_groups_get_with_http_info
    api238_certificates_certificate_groups_post_with_http_info = certificates_certificate_groups_post_with_http_info
    api238_certificates_certificate_signing_requests_post_with_http_info = certificates_certificate_signing_requests_post_with_http_info
    api238_certificates_delete_with_http_info = certificates_delete_with_http_info
    api238_certificates_get_with_http_info = certificates_get_with_http_info
    api238_certificates_patch_with_http_info = certificates_patch_with_http_info
    api238_certificates_post_with_http_info = certificates_post_with_http_info
    api239_certificates_certificate_groups_delete_with_http_info = certificates_certificate_groups_delete_with_http_info
    api239_certificates_certificate_groups_get_with_http_info = certificates_certificate_groups_get_with_http_info
    api239_certificates_certificate_groups_post_with_http_info = certificates_certificate_groups_post_with_http_info
    api239_certificates_certificate_signing_requests_post_with_http_info = certificates_certificate_signing_requests_post_with_http_info
    api239_certificates_delete_with_http_info = certificates_delete_with_http_info
    api239_certificates_get_with_http_info = certificates_get_with_http_info
    api239_certificates_patch_with_http_info = certificates_patch_with_http_info
    api239_certificates_post_with_http_info = certificates_post_with_http_info
    api240_certificates_certificate_groups_delete_with_http_info = certificates_certificate_groups_delete_with_http_info
    api240_certificates_certificate_groups_get_with_http_info = certificates_certificate_groups_get_with_http_info
    api240_certificates_certificate_groups_post_with_http_info = certificates_certificate_groups_post_with_http_info
    api240_certificates_certificate_signing_requests_post_with_http_info = certificates_certificate_signing_requests_post_with_http_info
    api240_certificates_delete_with_http_info = certificates_delete_with_http_info
    api240_certificates_get_with_http_info = certificates_get_with_http_info
    api240_certificates_patch_with_http_info = certificates_patch_with_http_info
    api240_certificates_post_with_http_info = certificates_post_with_http_info
