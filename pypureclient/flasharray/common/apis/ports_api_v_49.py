...
from pypureclient.flasharray.common.models.port_get_response_v_49 import PortGetResponse
from pypureclient.flasharray.common.models.port_initiators_get_response_v_49 import PortInitiatorsGetResponse
...
class PortsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api249_ports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_ports_initiators_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api249_ports_get_with_http_info = ports_get_with_http_info
    api249_ports_initiators_get_with_http_info = ports_initiators_get_with_http_info
    api250_ports_get_with_http_info = ports_get_with_http_info
