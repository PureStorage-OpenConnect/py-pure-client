...
class AdministratorsApi:
    ...
    # Method Aliases
    api236_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api236_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api236_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api236_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api236_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api236_admins_cache_put_with_http_info = admins_cache_put_with_http_info
    api236_admins_delete_with_http_info = admins_delete_with_http_info
    api236_admins_get_with_http_info = admins_get_with_http_info
    api236_admins_patch_with_http_info = admins_patch_with_http_info
    api236_admins_policies_management_access_delete_with_http_info = admins_policies_management_access_delete_with_http_info
    api236_admins_policies_management_access_get_with_http_info = admins_policies_management_access_get_with_http_info
    api236_admins_policies_management_access_post_with_http_info = admins_policies_management_access_post_with_http_info
    api236_admins_post_with_http_info = admins_post_with_http_info
    api236_admins_settings_get_with_http_info = admins_settings_get_with_http_info
    api236_admins_settings_patch_with_http_info = admins_settings_patch_with_http_info
