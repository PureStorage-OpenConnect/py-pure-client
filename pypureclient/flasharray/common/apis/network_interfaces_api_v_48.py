...
from pypureclient.flasharray.common.models.network_interface_get_response_v_48 import NetworkInterfaceGetResponse
...
from pypureclient.flasharray.common.models.network_interface_response_v_48 import NetworkInterfaceResponse
...
class NetworkInterfacesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api248_network_interfaces_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api248_network_interfaces_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api248_network_interfaces_neighbors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api248_network_interfaces_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api248_network_interfaces_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api248_network_interfaces_port_details_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api248_network_interfaces_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api248_network_interfaces_delete_with_http_info = network_interfaces_delete_with_http_info
    api248_network_interfaces_get_with_http_info = network_interfaces_get_with_http_info
    api248_network_interfaces_neighbors_get_with_http_info = network_interfaces_neighbors_get_with_http_info
    api248_network_interfaces_patch_with_http_info = network_interfaces_patch_with_http_info
    api248_network_interfaces_performance_get_with_http_info = network_interfaces_performance_get_with_http_info
    api248_network_interfaces_port_details_get_with_http_info = network_interfaces_port_details_get_with_http_info
    api248_network_interfaces_post_with_http_info = network_interfaces_post_with_http_info
