...
from pypureclient.flasharray.common.models.admin_get_response_v_32 import AdminGetResponse
from pypureclient.flasharray.common.models.admin_patch_v_32 import AdminPatch
from pypureclient.flasharray.common.models.admin_post_v_2 import AdminPost
from pypureclient.flasharray.common.models.admin_response_v_32 import AdminResponse
...
class AdministratorsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api232_admins_api_tokens_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api232_admins_api_tokens_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api232_admins_api_tokens_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api232_admins_cache_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api232_admins_cache_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api232_admins_cache_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api232_admins_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api232_admins_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api232_admins_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api232_admins_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api232_admins_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api232_admins_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api232_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api232_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api232_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api232_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api232_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api232_admins_cache_put_with_http_info = admins_cache_put_with_http_info
    api232_admins_delete_with_http_info = admins_delete_with_http_info
    api232_admins_get_with_http_info = admins_get_with_http_info
    api232_admins_patch_with_http_info = admins_patch_with_http_info
    api232_admins_post_with_http_info = admins_post_with_http_info
    api232_admins_settings_get_with_http_info = admins_settings_get_with_http_info
    api232_admins_settings_patch_with_http_info = admins_settings_patch_with_http_info
    api233_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api233_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api233_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api233_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api233_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api233_admins_cache_put_with_http_info = admins_cache_put_with_http_info
    api233_admins_delete_with_http_info = admins_delete_with_http_info
    api233_admins_get_with_http_info = admins_get_with_http_info
    api233_admins_patch_with_http_info = admins_patch_with_http_info
    api233_admins_post_with_http_info = admins_post_with_http_info
    api233_admins_settings_get_with_http_info = admins_settings_get_with_http_info
    api233_admins_settings_patch_with_http_info = admins_settings_patch_with_http_info
    api234_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api234_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api234_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api234_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api234_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api234_admins_cache_put_with_http_info = admins_cache_put_with_http_info
    api234_admins_delete_with_http_info = admins_delete_with_http_info
    api234_admins_get_with_http_info = admins_get_with_http_info
    api234_admins_patch_with_http_info = admins_patch_with_http_info
    api234_admins_post_with_http_info = admins_post_with_http_info
    api234_admins_settings_get_with_http_info = admins_settings_get_with_http_info
    api234_admins_settings_patch_with_http_info = admins_settings_patch_with_http_info
    api235_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api235_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api235_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api235_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api235_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api235_admins_cache_put_with_http_info = admins_cache_put_with_http_info
    api235_admins_delete_with_http_info = admins_delete_with_http_info
    api235_admins_get_with_http_info = admins_get_with_http_info
    api235_admins_patch_with_http_info = admins_patch_with_http_info
    api235_admins_post_with_http_info = admins_post_with_http_info
    api235_admins_settings_get_with_http_info = admins_settings_get_with_http_info
    api235_admins_settings_patch_with_http_info = admins_settings_patch_with_http_info
