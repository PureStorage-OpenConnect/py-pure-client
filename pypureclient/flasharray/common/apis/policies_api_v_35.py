...
from pypureclient.flasharray.common.models.policy_audit_file_get_response_v_35 import PolicyAuditFileGetResponse
from pypureclient.flasharray.common.models.policy_audit_file_patch_v_35 import PolicyAuditFilePatch
from pypureclient.flasharray.common.models.policy_audit_file_post_v_35 import PolicyAuditFilePost
from pypureclient.flasharray.common.models.policy_audit_file_response_v_35 import PolicyAuditFileResponse
from pypureclient.flasharray.common.models.policy_get_response_v_24 import PolicyGetResponse
from pypureclient.flasharray.common.models.policy_member_export_get_response_v_32 import PolicyMemberExportGetResponse
from pypureclient.flasharray.common.models.policy_member_export_post_v_32 import PolicyMemberExportPost
from pypureclient.flasharray.common.models.policy_member_export_response_v_32 import PolicyMemberExportResponse
...
from pypureclient.flasharray.common.models.policy_nfs_get_response_v_32 import PolicyNfsGetResponse
from pypureclient.flasharray.common.models.policy_nfs_patch_v_29 import PolicyNfsPatch
from pypureclient.flasharray.common.models.policy_nfs_post_v_32 import PolicyNfsPost
from pypureclient.flasharray.common.models.policy_nfs_response_v_32 import PolicyNfsResponse
from pypureclient.flasharray.common.models.policy_password_get_response_v_34 import PolicyPasswordGetResponse
from pypureclient.flasharray.common.models.policy_password_response_v_34 import PolicyPasswordResponse
from pypureclient.flasharray.common.models.policy_password_v_34 import PolicyPassword
...
from pypureclient.flasharray.common.models.policy_response_v_24 import PolicyResponse
from pypureclient.flasharray.common.models.policy_rule_alert_watcher_get_response_v_33 import PolicyRuleAlertWatcherGetResponse
from pypureclient.flasharray.common.models.policy_rule_alert_watcher_patch_v_33 import PolicyRuleAlertWatcherPatch
from pypureclient.flasharray.common.models.policy_rule_alert_watcher_post_v_33 import PolicyRuleAlertWatcherPost
from pypureclient.flasharray.common.models.policy_rule_alert_watcher_response_v_33 import PolicyRuleAlertWatcherResponse
from pypureclient.flasharray.common.models.policy_rule_nfs_client_get_response_v_29 import PolicyRuleNfsClientGetResponse
from pypureclient.flasharray.common.models.policy_rule_nfs_client_post_v_29 import PolicyRuleNfsClientPost
from pypureclient.flasharray.common.models.policy_rule_nfs_client_response_v_29 import PolicyRuleNfsClientResponse
from pypureclient.flasharray.common.models.policy_rule_quota_get_response_v_21 import PolicyRuleQuotaGetResponse
from pypureclient.flasharray.common.models.policy_rule_quota_patch_v_21 import PolicyRuleQuotaPatch
from pypureclient.flasharray.common.models.policy_rule_quota_post_v_21 import PolicyRuleQuotaPost
from pypureclient.flasharray.common.models.policy_rule_quota_response_v_21 import PolicyRuleQuotaResponse
from pypureclient.flasharray.common.models.policy_rule_smb_client_get_response_v_21 import PolicyRuleSmbClientGetResponse
from pypureclient.flasharray.common.models.policy_rule_smb_client_post_v_3 import PolicyRuleSmbClientPost
from pypureclient.flasharray.common.models.policy_rule_smb_client_response_v_21 import PolicyRuleSmbClientResponse
from pypureclient.flasharray.common.models.policy_rule_snapshot_get_response_v_21 import PolicyRuleSnapshotGetResponse
from pypureclient.flasharray.common.models.policy_rule_snapshot_post_v_21 import PolicyRuleSnapshotPost
from pypureclient.flasharray.common.models.policy_rule_snapshot_response_v_21 import PolicyRuleSnapshotResponse
from pypureclient.flasharray.common.models.policy_smb_get_response_v_32 import PolicySmbGetResponse
from pypureclient.flasharray.common.models.policy_smb_patch_v_4 import PolicySmbPatch
from pypureclient.flasharray.common.models.policy_smb_post_v_32 import PolicySmbPost
from pypureclient.flasharray.common.models.policy_smb_response_v_32 import PolicySmbResponse
...
class PoliciesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api235_policies_alert_watcher_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_alert_watcher_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_alert_watcher_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_alert_watcher_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_alert_watcher_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_alert_watcher_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_alert_watcher_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_alert_watcher_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_alert_watcher_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_alert_watcher_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_alert_watcher_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_alert_watcher_rules_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_audit_file_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_audit_file_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_audit_file_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_audit_file_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_audit_file_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_audit_file_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_audit_file_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_autodir_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_autodir_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_autodir_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_autodir_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_autodir_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_autodir_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_autodir_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_nfs_client_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_nfs_client_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_nfs_client_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_nfs_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_nfs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_nfs_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_nfs_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_nfs_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_nfs_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_nfs_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_password_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_password_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_quota_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_quota_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_quota_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_quota_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_quota_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_quota_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_quota_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_quota_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_quota_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_quota_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_quota_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_smb_client_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_smb_client_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_smb_client_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_smb_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_smb_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_smb_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_smb_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_smb_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_smb_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_smb_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_snapshot_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_snapshot_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_snapshot_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_snapshot_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_snapshot_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_snapshot_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_snapshot_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_snapshot_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_snapshot_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_policies_snapshot_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api235_policies_alert_watcher_delete_with_http_info = policies_alert_watcher_delete_with_http_info
    api235_policies_alert_watcher_get_with_http_info = policies_alert_watcher_get_with_http_info
    api235_policies_alert_watcher_members_delete_with_http_info = policies_alert_watcher_members_delete_with_http_info
    api235_policies_alert_watcher_members_get_with_http_info = policies_alert_watcher_members_get_with_http_info
    api235_policies_alert_watcher_members_post_with_http_info = policies_alert_watcher_members_post_with_http_info
    api235_policies_alert_watcher_patch_with_http_info = policies_alert_watcher_patch_with_http_info
    api235_policies_alert_watcher_post_with_http_info = policies_alert_watcher_post_with_http_info
    api235_policies_alert_watcher_rules_delete_with_http_info = policies_alert_watcher_rules_delete_with_http_info
    api235_policies_alert_watcher_rules_get_with_http_info = policies_alert_watcher_rules_get_with_http_info
    api235_policies_alert_watcher_rules_patch_with_http_info = policies_alert_watcher_rules_patch_with_http_info
    api235_policies_alert_watcher_rules_post_with_http_info = policies_alert_watcher_rules_post_with_http_info
    api235_policies_alert_watcher_rules_test_get_with_http_info = policies_alert_watcher_rules_test_get_with_http_info
    api235_policies_audit_file_delete_with_http_info = policies_audit_file_delete_with_http_info
    api235_policies_audit_file_get_with_http_info = policies_audit_file_get_with_http_info
    api235_policies_audit_file_members_delete_with_http_info = policies_audit_file_members_delete_with_http_info
    api235_policies_audit_file_members_get_with_http_info = policies_audit_file_members_get_with_http_info
    api235_policies_audit_file_members_post_with_http_info = policies_audit_file_members_post_with_http_info
    api235_policies_audit_file_patch_with_http_info = policies_audit_file_patch_with_http_info
    api235_policies_audit_file_post_with_http_info = policies_audit_file_post_with_http_info
    api235_policies_autodir_delete_with_http_info = policies_autodir_delete_with_http_info
    api235_policies_autodir_get_with_http_info = policies_autodir_get_with_http_info
    api235_policies_autodir_members_delete_with_http_info = policies_autodir_members_delete_with_http_info
    api235_policies_autodir_members_get_with_http_info = policies_autodir_members_get_with_http_info
    api235_policies_autodir_members_post_with_http_info = policies_autodir_members_post_with_http_info
    api235_policies_autodir_patch_with_http_info = policies_autodir_patch_with_http_info
    api235_policies_autodir_post_with_http_info = policies_autodir_post_with_http_info
    api235_policies_get_with_http_info = policies_get_with_http_info
    api235_policies_members_get_with_http_info = policies_members_get_with_http_info
    api235_policies_nfs_client_rules_delete_with_http_info = policies_nfs_client_rules_delete_with_http_info
    api235_policies_nfs_client_rules_get_with_http_info = policies_nfs_client_rules_get_with_http_info
    api235_policies_nfs_client_rules_post_with_http_info = policies_nfs_client_rules_post_with_http_info
    api235_policies_nfs_delete_with_http_info = policies_nfs_delete_with_http_info
    api235_policies_nfs_get_with_http_info = policies_nfs_get_with_http_info
    api235_policies_nfs_members_delete_with_http_info = policies_nfs_members_delete_with_http_info
    api235_policies_nfs_members_get_with_http_info = policies_nfs_members_get_with_http_info
    api235_policies_nfs_members_post_with_http_info = policies_nfs_members_post_with_http_info
    api235_policies_nfs_patch_with_http_info = policies_nfs_patch_with_http_info
    api235_policies_nfs_post_with_http_info = policies_nfs_post_with_http_info
    api235_policies_password_get_with_http_info = policies_password_get_with_http_info
    api235_policies_password_patch_with_http_info = policies_password_patch_with_http_info
    api235_policies_quota_delete_with_http_info = policies_quota_delete_with_http_info
    api235_policies_quota_get_with_http_info = policies_quota_get_with_http_info
    api235_policies_quota_members_delete_with_http_info = policies_quota_members_delete_with_http_info
    api235_policies_quota_members_get_with_http_info = policies_quota_members_get_with_http_info
    api235_policies_quota_members_post_with_http_info = policies_quota_members_post_with_http_info
    api235_policies_quota_patch_with_http_info = policies_quota_patch_with_http_info
    api235_policies_quota_post_with_http_info = policies_quota_post_with_http_info
    api235_policies_quota_rules_delete_with_http_info = policies_quota_rules_delete_with_http_info
    api235_policies_quota_rules_get_with_http_info = policies_quota_rules_get_with_http_info
    api235_policies_quota_rules_patch_with_http_info = policies_quota_rules_patch_with_http_info
    api235_policies_quota_rules_post_with_http_info = policies_quota_rules_post_with_http_info
    api235_policies_smb_client_rules_delete_with_http_info = policies_smb_client_rules_delete_with_http_info
    api235_policies_smb_client_rules_get_with_http_info = policies_smb_client_rules_get_with_http_info
    api235_policies_smb_client_rules_post_with_http_info = policies_smb_client_rules_post_with_http_info
    api235_policies_smb_delete_with_http_info = policies_smb_delete_with_http_info
    api235_policies_smb_get_with_http_info = policies_smb_get_with_http_info
    api235_policies_smb_members_delete_with_http_info = policies_smb_members_delete_with_http_info
    api235_policies_smb_members_get_with_http_info = policies_smb_members_get_with_http_info
    api235_policies_smb_members_post_with_http_info = policies_smb_members_post_with_http_info
    api235_policies_smb_patch_with_http_info = policies_smb_patch_with_http_info
    api235_policies_smb_post_with_http_info = policies_smb_post_with_http_info
    api235_policies_snapshot_delete_with_http_info = policies_snapshot_delete_with_http_info
    api235_policies_snapshot_get_with_http_info = policies_snapshot_get_with_http_info
    api235_policies_snapshot_members_delete_with_http_info = policies_snapshot_members_delete_with_http_info
    api235_policies_snapshot_members_get_with_http_info = policies_snapshot_members_get_with_http_info
    api235_policies_snapshot_members_post_with_http_info = policies_snapshot_members_post_with_http_info
    api235_policies_snapshot_patch_with_http_info = policies_snapshot_patch_with_http_info
    api235_policies_snapshot_post_with_http_info = policies_snapshot_post_with_http_info
    api235_policies_snapshot_rules_delete_with_http_info = policies_snapshot_rules_delete_with_http_info
    api235_policies_snapshot_rules_get_with_http_info = policies_snapshot_rules_get_with_http_info
    api235_policies_snapshot_rules_post_with_http_info = policies_snapshot_rules_post_with_http_info
