...
from pypureclient.flasharray.common.models.policy_nfs_get_response_v_15 import PolicyNfsGetResponse
from pypureclient.flasharray.common.models.policy_nfs_patch_v_15 import PolicyNfsPatch
from pypureclient.flasharray.common.models.policy_nfs_post_v_15 import PolicyNfsPost
from pypureclient.flasharray.common.models.policy_nfs_response_v_15 import PolicyNfsResponse
...
from pypureclient.flasharray.common.models.policy_rule_nfs_client_get_response_v_21 import PolicyRuleNfsClientGetResponse
from pypureclient.flasharray.common.models.policy_rule_nfs_client_post_v_16 import PolicyRuleNfsClientPost
from pypureclient.flasharray.common.models.policy_rule_nfs_client_response_v_21 import PolicyRuleNfsClientResponse
...
class PoliciesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api221_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_nfs_client_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_nfs_client_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_nfs_client_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_nfs_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_nfs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_nfs_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_nfs_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_nfs_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_nfs_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_nfs_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_quota_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_quota_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_quota_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_quota_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_quota_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_quota_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_quota_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_quota_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_quota_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_quota_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_quota_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_smb_client_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_smb_client_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_smb_client_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_smb_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_smb_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_smb_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_smb_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_smb_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_smb_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_smb_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_snapshot_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_snapshot_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_snapshot_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_snapshot_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_snapshot_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_snapshot_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_snapshot_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_snapshot_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_snapshot_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_policies_snapshot_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api221_policies_get_with_http_info = policies_get_with_http_info
    api221_policies_members_get_with_http_info = policies_members_get_with_http_info
    api221_policies_nfs_client_rules_delete_with_http_info = policies_nfs_client_rules_delete_with_http_info
    api221_policies_nfs_client_rules_get_with_http_info = policies_nfs_client_rules_get_with_http_info
    api221_policies_nfs_client_rules_post_with_http_info = policies_nfs_client_rules_post_with_http_info
    api221_policies_nfs_delete_with_http_info = policies_nfs_delete_with_http_info
    api221_policies_nfs_get_with_http_info = policies_nfs_get_with_http_info
    api221_policies_nfs_members_delete_with_http_info = policies_nfs_members_delete_with_http_info
    api221_policies_nfs_members_get_with_http_info = policies_nfs_members_get_with_http_info
    api221_policies_nfs_members_post_with_http_info = policies_nfs_members_post_with_http_info
    api221_policies_nfs_patch_with_http_info = policies_nfs_patch_with_http_info
    api221_policies_nfs_post_with_http_info = policies_nfs_post_with_http_info
    api221_policies_quota_delete_with_http_info = policies_quota_delete_with_http_info
    api221_policies_quota_get_with_http_info = policies_quota_get_with_http_info
    api221_policies_quota_members_delete_with_http_info = policies_quota_members_delete_with_http_info
    api221_policies_quota_members_get_with_http_info = policies_quota_members_get_with_http_info
    api221_policies_quota_members_post_with_http_info = policies_quota_members_post_with_http_info
    api221_policies_quota_patch_with_http_info = policies_quota_patch_with_http_info
    api221_policies_quota_post_with_http_info = policies_quota_post_with_http_info
    api221_policies_quota_rules_delete_with_http_info = policies_quota_rules_delete_with_http_info
    api221_policies_quota_rules_get_with_http_info = policies_quota_rules_get_with_http_info
    api221_policies_quota_rules_patch_with_http_info = policies_quota_rules_patch_with_http_info
    api221_policies_quota_rules_post_with_http_info = policies_quota_rules_post_with_http_info
    api221_policies_smb_client_rules_delete_with_http_info = policies_smb_client_rules_delete_with_http_info
    api221_policies_smb_client_rules_get_with_http_info = policies_smb_client_rules_get_with_http_info
    api221_policies_smb_client_rules_post_with_http_info = policies_smb_client_rules_post_with_http_info
    api221_policies_smb_delete_with_http_info = policies_smb_delete_with_http_info
    api221_policies_smb_get_with_http_info = policies_smb_get_with_http_info
    api221_policies_smb_members_delete_with_http_info = policies_smb_members_delete_with_http_info
    api221_policies_smb_members_get_with_http_info = policies_smb_members_get_with_http_info
    api221_policies_smb_members_post_with_http_info = policies_smb_members_post_with_http_info
    api221_policies_smb_patch_with_http_info = policies_smb_patch_with_http_info
    api221_policies_smb_post_with_http_info = policies_smb_post_with_http_info
    api221_policies_snapshot_delete_with_http_info = policies_snapshot_delete_with_http_info
    api221_policies_snapshot_get_with_http_info = policies_snapshot_get_with_http_info
    api221_policies_snapshot_members_delete_with_http_info = policies_snapshot_members_delete_with_http_info
    api221_policies_snapshot_members_get_with_http_info = policies_snapshot_members_get_with_http_info
    api221_policies_snapshot_members_post_with_http_info = policies_snapshot_members_post_with_http_info
    api221_policies_snapshot_patch_with_http_info = policies_snapshot_patch_with_http_info
    api221_policies_snapshot_post_with_http_info = policies_snapshot_post_with_http_info
    api221_policies_snapshot_rules_delete_with_http_info = policies_snapshot_rules_delete_with_http_info
    api221_policies_snapshot_rules_get_with_http_info = policies_snapshot_rules_get_with_http_info
    api221_policies_snapshot_rules_post_with_http_info = policies_snapshot_rules_post_with_http_info
    api222_policies_get_with_http_info = policies_get_with_http_info
    api222_policies_members_get_with_http_info = policies_members_get_with_http_info
    api222_policies_nfs_client_rules_delete_with_http_info = policies_nfs_client_rules_delete_with_http_info
    api222_policies_nfs_client_rules_get_with_http_info = policies_nfs_client_rules_get_with_http_info
    api222_policies_nfs_client_rules_post_with_http_info = policies_nfs_client_rules_post_with_http_info
    api222_policies_nfs_delete_with_http_info = policies_nfs_delete_with_http_info
    api222_policies_nfs_get_with_http_info = policies_nfs_get_with_http_info
    api222_policies_nfs_members_delete_with_http_info = policies_nfs_members_delete_with_http_info
    api222_policies_nfs_members_get_with_http_info = policies_nfs_members_get_with_http_info
    api222_policies_nfs_members_post_with_http_info = policies_nfs_members_post_with_http_info
    api222_policies_nfs_patch_with_http_info = policies_nfs_patch_with_http_info
    api222_policies_nfs_post_with_http_info = policies_nfs_post_with_http_info
    api222_policies_quota_delete_with_http_info = policies_quota_delete_with_http_info
    api222_policies_quota_get_with_http_info = policies_quota_get_with_http_info
    api222_policies_quota_members_delete_with_http_info = policies_quota_members_delete_with_http_info
    api222_policies_quota_members_get_with_http_info = policies_quota_members_get_with_http_info
    api222_policies_quota_members_post_with_http_info = policies_quota_members_post_with_http_info
    api222_policies_quota_patch_with_http_info = policies_quota_patch_with_http_info
    api222_policies_quota_post_with_http_info = policies_quota_post_with_http_info
    api222_policies_quota_rules_delete_with_http_info = policies_quota_rules_delete_with_http_info
    api222_policies_quota_rules_get_with_http_info = policies_quota_rules_get_with_http_info
    api222_policies_quota_rules_patch_with_http_info = policies_quota_rules_patch_with_http_info
    api222_policies_quota_rules_post_with_http_info = policies_quota_rules_post_with_http_info
    api222_policies_smb_client_rules_delete_with_http_info = policies_smb_client_rules_delete_with_http_info
    api222_policies_smb_client_rules_get_with_http_info = policies_smb_client_rules_get_with_http_info
    api222_policies_smb_client_rules_post_with_http_info = policies_smb_client_rules_post_with_http_info
    api222_policies_smb_delete_with_http_info = policies_smb_delete_with_http_info
    api222_policies_smb_get_with_http_info = policies_smb_get_with_http_info
    api222_policies_smb_members_delete_with_http_info = policies_smb_members_delete_with_http_info
    api222_policies_smb_members_get_with_http_info = policies_smb_members_get_with_http_info
    api222_policies_smb_members_post_with_http_info = policies_smb_members_post_with_http_info
    api222_policies_smb_patch_with_http_info = policies_smb_patch_with_http_info
    api222_policies_smb_post_with_http_info = policies_smb_post_with_http_info
    api222_policies_snapshot_delete_with_http_info = policies_snapshot_delete_with_http_info
    api222_policies_snapshot_get_with_http_info = policies_snapshot_get_with_http_info
    api222_policies_snapshot_members_delete_with_http_info = policies_snapshot_members_delete_with_http_info
    api222_policies_snapshot_members_get_with_http_info = policies_snapshot_members_get_with_http_info
    api222_policies_snapshot_members_post_with_http_info = policies_snapshot_members_post_with_http_info
    api222_policies_snapshot_patch_with_http_info = policies_snapshot_patch_with_http_info
    api222_policies_snapshot_post_with_http_info = policies_snapshot_post_with_http_info
    api222_policies_snapshot_rules_delete_with_http_info = policies_snapshot_rules_delete_with_http_info
    api222_policies_snapshot_rules_get_with_http_info = policies_snapshot_rules_get_with_http_info
    api222_policies_snapshot_rules_post_with_http_info = policies_snapshot_rules_post_with_http_info
    api223_policies_get_with_http_info = policies_get_with_http_info
    api223_policies_members_get_with_http_info = policies_members_get_with_http_info
    api223_policies_nfs_client_rules_delete_with_http_info = policies_nfs_client_rules_delete_with_http_info
    api223_policies_nfs_client_rules_get_with_http_info = policies_nfs_client_rules_get_with_http_info
    api223_policies_nfs_client_rules_post_with_http_info = policies_nfs_client_rules_post_with_http_info
    api223_policies_nfs_delete_with_http_info = policies_nfs_delete_with_http_info
    api223_policies_nfs_get_with_http_info = policies_nfs_get_with_http_info
    api223_policies_nfs_members_delete_with_http_info = policies_nfs_members_delete_with_http_info
    api223_policies_nfs_members_get_with_http_info = policies_nfs_members_get_with_http_info
    api223_policies_nfs_members_post_with_http_info = policies_nfs_members_post_with_http_info
    api223_policies_nfs_patch_with_http_info = policies_nfs_patch_with_http_info
    api223_policies_nfs_post_with_http_info = policies_nfs_post_with_http_info
    api223_policies_quota_delete_with_http_info = policies_quota_delete_with_http_info
    api223_policies_quota_get_with_http_info = policies_quota_get_with_http_info
    api223_policies_quota_members_delete_with_http_info = policies_quota_members_delete_with_http_info
    api223_policies_quota_members_get_with_http_info = policies_quota_members_get_with_http_info
    api223_policies_quota_members_post_with_http_info = policies_quota_members_post_with_http_info
    api223_policies_quota_patch_with_http_info = policies_quota_patch_with_http_info
    api223_policies_quota_post_with_http_info = policies_quota_post_with_http_info
    api223_policies_quota_rules_delete_with_http_info = policies_quota_rules_delete_with_http_info
    api223_policies_quota_rules_get_with_http_info = policies_quota_rules_get_with_http_info
    api223_policies_quota_rules_patch_with_http_info = policies_quota_rules_patch_with_http_info
    api223_policies_quota_rules_post_with_http_info = policies_quota_rules_post_with_http_info
    api223_policies_smb_client_rules_delete_with_http_info = policies_smb_client_rules_delete_with_http_info
    api223_policies_smb_client_rules_get_with_http_info = policies_smb_client_rules_get_with_http_info
    api223_policies_smb_client_rules_post_with_http_info = policies_smb_client_rules_post_with_http_info
    api223_policies_smb_delete_with_http_info = policies_smb_delete_with_http_info
    api223_policies_smb_get_with_http_info = policies_smb_get_with_http_info
    api223_policies_smb_members_delete_with_http_info = policies_smb_members_delete_with_http_info
    api223_policies_smb_members_get_with_http_info = policies_smb_members_get_with_http_info
    api223_policies_smb_members_post_with_http_info = policies_smb_members_post_with_http_info
    api223_policies_smb_patch_with_http_info = policies_smb_patch_with_http_info
    api223_policies_smb_post_with_http_info = policies_smb_post_with_http_info
    api223_policies_snapshot_delete_with_http_info = policies_snapshot_delete_with_http_info
    api223_policies_snapshot_get_with_http_info = policies_snapshot_get_with_http_info
    api223_policies_snapshot_members_delete_with_http_info = policies_snapshot_members_delete_with_http_info
    api223_policies_snapshot_members_get_with_http_info = policies_snapshot_members_get_with_http_info
    api223_policies_snapshot_members_post_with_http_info = policies_snapshot_members_post_with_http_info
    api223_policies_snapshot_patch_with_http_info = policies_snapshot_patch_with_http_info
    api223_policies_snapshot_post_with_http_info = policies_snapshot_post_with_http_info
    api223_policies_snapshot_rules_delete_with_http_info = policies_snapshot_rules_delete_with_http_info
    api223_policies_snapshot_rules_get_with_http_info = policies_snapshot_rules_get_with_http_info
    api223_policies_snapshot_rules_post_with_http_info = policies_snapshot_rules_post_with_http_info
