...
class NetworkInterfacesApi:
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_network_interfaces_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_network_interfaces_port_details_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api216_network_interfaces_delete_with_http_info = network_interfaces_delete_with_http_info
    api216_network_interfaces_get_with_http_info = network_interfaces_get_with_http_info
    api216_network_interfaces_patch_with_http_info = network_interfaces_patch_with_http_info
    api216_network_interfaces_performance_get_with_http_info = network_interfaces_performance_get_with_http_info
    api216_network_interfaces_port_details_get_with_http_info = network_interfaces_port_details_get_with_http_info
    api216_network_interfaces_post_with_http_info = network_interfaces_post_with_http_info
    api217_network_interfaces_delete_with_http_info = network_interfaces_delete_with_http_info
    api217_network_interfaces_get_with_http_info = network_interfaces_get_with_http_info
    api217_network_interfaces_patch_with_http_info = network_interfaces_patch_with_http_info
    api217_network_interfaces_performance_get_with_http_info = network_interfaces_performance_get_with_http_info
    api217_network_interfaces_port_details_get_with_http_info = network_interfaces_port_details_get_with_http_info
    api217_network_interfaces_post_with_http_info = network_interfaces_post_with_http_info
    ...
    api219_network_interfaces_performance_get_with_http_info = network_interfaces_performance_get_with_http_info
    api219_network_interfaces_port_details_get_with_http_info = network_interfaces_port_details_get_with_http_info
    ...
    api220_network_interfaces_performance_get_with_http_info = network_interfaces_performance_get_with_http_info
    api220_network_interfaces_port_details_get_with_http_info = network_interfaces_port_details_get_with_http_info
    ...
    api221_network_interfaces_performance_get_with_http_info = network_interfaces_performance_get_with_http_info
    api221_network_interfaces_port_details_get_with_http_info = network_interfaces_port_details_get_with_http_info
