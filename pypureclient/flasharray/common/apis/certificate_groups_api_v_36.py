...
class CertificateGroupsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api236_certificate_groups_certificates_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_certificate_groups_certificates_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_certificate_groups_certificates_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_certificate_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_certificate_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_certificate_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api236_certificate_groups_certificates_delete_with_http_info = certificate_groups_certificates_delete_with_http_info
    api236_certificate_groups_certificates_get_with_http_info = certificate_groups_certificates_get_with_http_info
    api236_certificate_groups_certificates_post_with_http_info = certificate_groups_certificates_post_with_http_info
    api236_certificate_groups_delete_with_http_info = certificate_groups_delete_with_http_info
    api236_certificate_groups_get_with_http_info = certificate_groups_get_with_http_info
    api236_certificate_groups_post_with_http_info = certificate_groups_post_with_http_info
    api237_certificate_groups_certificates_delete_with_http_info = certificate_groups_certificates_delete_with_http_info
    api237_certificate_groups_certificates_get_with_http_info = certificate_groups_certificates_get_with_http_info
    api237_certificate_groups_certificates_post_with_http_info = certificate_groups_certificates_post_with_http_info
    api237_certificate_groups_delete_with_http_info = certificate_groups_delete_with_http_info
    api237_certificate_groups_get_with_http_info = certificate_groups_get_with_http_info
    api237_certificate_groups_post_with_http_info = certificate_groups_post_with_http_info
    api238_certificate_groups_certificates_delete_with_http_info = certificate_groups_certificates_delete_with_http_info
    api238_certificate_groups_certificates_get_with_http_info = certificate_groups_certificates_get_with_http_info
    api238_certificate_groups_certificates_post_with_http_info = certificate_groups_certificates_post_with_http_info
    api238_certificate_groups_delete_with_http_info = certificate_groups_delete_with_http_info
    api238_certificate_groups_get_with_http_info = certificate_groups_get_with_http_info
    api238_certificate_groups_post_with_http_info = certificate_groups_post_with_http_info
    api239_certificate_groups_certificates_delete_with_http_info = certificate_groups_certificates_delete_with_http_info
    api239_certificate_groups_certificates_get_with_http_info = certificate_groups_certificates_get_with_http_info
    api239_certificate_groups_certificates_post_with_http_info = certificate_groups_certificates_post_with_http_info
    api239_certificate_groups_delete_with_http_info = certificate_groups_delete_with_http_info
    api239_certificate_groups_get_with_http_info = certificate_groups_get_with_http_info
    api239_certificate_groups_post_with_http_info = certificate_groups_post_with_http_info
    api240_certificate_groups_certificates_delete_with_http_info = certificate_groups_certificates_delete_with_http_info
    api240_certificate_groups_certificates_get_with_http_info = certificate_groups_certificates_get_with_http_info
    api240_certificate_groups_certificates_post_with_http_info = certificate_groups_certificates_post_with_http_info
    api240_certificate_groups_delete_with_http_info = certificate_groups_delete_with_http_info
    api240_certificate_groups_get_with_http_info = certificate_groups_get_with_http_info
    api240_certificate_groups_post_with_http_info = certificate_groups_post_with_http_info
