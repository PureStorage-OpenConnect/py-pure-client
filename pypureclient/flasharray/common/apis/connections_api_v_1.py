...
class ConnectionsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api21_connections_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_connections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_connections_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api21_connections_delete_with_http_info = connections_delete_with_http_info
    api21_connections_get_with_http_info = connections_get_with_http_info
    api21_connections_post_with_http_info = connections_post_with_http_info
    api22_connections_delete_with_http_info = connections_delete_with_http_info
    api22_connections_get_with_http_info = connections_get_with_http_info
    api22_connections_post_with_http_info = connections_post_with_http_info
    api23_connections_delete_with_http_info = connections_delete_with_http_info
    api23_connections_get_with_http_info = connections_get_with_http_info
    api23_connections_post_with_http_info = connections_post_with_http_info
    api24_connections_delete_with_http_info = connections_delete_with_http_info
    api24_connections_get_with_http_info = connections_get_with_http_info
    api24_connections_post_with_http_info = connections_post_with_http_info
    api25_connections_delete_with_http_info = connections_delete_with_http_info
    api25_connections_get_with_http_info = connections_get_with_http_info
    api25_connections_post_with_http_info = connections_post_with_http_info
    api26_connections_delete_with_http_info = connections_delete_with_http_info
    api26_connections_get_with_http_info = connections_get_with_http_info
    api26_connections_post_with_http_info = connections_post_with_http_info
    api27_connections_delete_with_http_info = connections_delete_with_http_info
    api27_connections_get_with_http_info = connections_get_with_http_info
    api27_connections_post_with_http_info = connections_post_with_http_info
    api28_connections_delete_with_http_info = connections_delete_with_http_info
    api28_connections_get_with_http_info = connections_get_with_http_info
    api28_connections_post_with_http_info = connections_post_with_http_info
