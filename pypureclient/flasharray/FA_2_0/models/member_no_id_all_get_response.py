...
from pypureclient.flasharray.FA_2_0.models.member_no_id_all import MemberNoIdAll
...
class MemberNoIdAllGetResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["more_items_remaining", "total_item_count", "items"]
