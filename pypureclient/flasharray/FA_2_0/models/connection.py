...
from pypureclient.flasharray.FA_2_0.models.fixed_reference_no_id import FixedReferenceNoId
...
class Connection(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            "host": FixedReferenceNoId.from_dict(obj["host"]) if obj.get("host") is not None else None,
            "host_group": FixedReferenceNoId.from_dict(obj["host_group"]) if obj.get("host_group") is not None else None,
            "lun": obj.get("lun"),
