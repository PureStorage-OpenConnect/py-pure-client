...
class Volume(object):
    ...
    def __init__(self, **kwargs):
        ...
        Keyword args:
            ...
            created (int): The volume creation time. Measured in milliseconds since epoch (January 1, 1970).
            ...
            provisioned (int): The virtual size of the volume. Measured in bytes.
            ...
            time_remaining (int): The amount of time left. Measured in milliseconds, until the destroyed volume is permanently eradicated. Before the `time_remaining` period has elapsed, the destroyed volume can be recovered by setting `destroyed=false`.
