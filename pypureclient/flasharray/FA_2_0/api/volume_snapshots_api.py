...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_0.models.volume_snapshot_get_response import VolumeSnapshotGetResponse
from pypureclient.flasharray.FA_2_0.models.volume_snapshot_patch import VolumeSnapshotPatch
...
class VolumeSnapshotsApi:
    ...
    def api20_volume_snapshots_delete_with_http_info(
        ...
        _param = self._api20_volume_snapshots_delete_serialize(
    ...
    def _api20_volume_snapshots_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.0/volume-snapshots',
    ...
    def api20_volume_snapshots_get_with_http_info(
        ...
        _param = self._api20_volume_snapshots_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            destroyed = destroyed,
            filter = filter,
    ...
    def _api20_volume_snapshots_get_serialize(
        self,
        authorization,
        x_request_id,
        destroyed,
    ...
    def api20_volume_snapshots_patch_with_http_info(
        ...
        _param = self._api20_volume_snapshots_patch_serialize(
    ...
    def _api20_volume_snapshots_patch_serialize(
        self,
        volume_snapshot,
        authorization,
        x_request_id,
    ...
    def api20_volume_snapshots_post_with_http_info(
        ...
        _param = self._api20_volume_snapshots_post_serialize(
            volume_snapshot = volume_snapshot,
            authorization = authorization,
            x_request_id = x_request_id,
            on = on,
    ...
    def _api20_volume_snapshots_post_serialize(
        self,
        volume_snapshot,
        authorization,
        x_request_id,
    ...
    def api20_volume_snapshots_transfer_get_with_http_info(
        ...
        _param = self._api20_volume_snapshots_transfer_get_serialize(
            names = names,
            authorization = authorization,
            x_request_id = x_request_id,
            destroyed = destroyed,
    ...
    def _api20_volume_snapshots_transfer_get_serialize(
        self,
        names,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/volume-snapshots/transfer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
