...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_0.models.host_group_get_response import HostGroupGetResponse
from pypureclient.flasharray.FA_2_0.models.host_group_patch import HostGroupPatch
from pypureclient.flasharray.FA_2_0.models.host_group_response import HostGroupResponse
...
class HostGroupsApi:
    ...
    def api20_host_groups_delete_with_http_info(
        ...
        _param = self._api20_host_groups_delete_serialize(
    ...
    def _api20_host_groups_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.0/host-groups',
    ...
    def api20_host_groups_get_with_http_info(
        ...
        _param = self._api20_host_groups_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api20_host_groups_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
    ...
    def api20_host_groups_hosts_get_with_http_info(
        ...
        _param = self._api20_host_groups_hosts_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
    ...
    def _api20_host_groups_hosts_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/host-groups/hosts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api20_host_groups_patch_with_http_info(
        ...
        _param = self._api20_host_groups_patch_serialize(
    ...
    def _api20_host_groups_patch_serialize(
        self,
        host_group,
        authorization,
        x_request_id,
    ...
    def api20_host_groups_performance_by_array_get_with_http_info(
        ...
        _param = self._api20_host_groups_performance_by_array_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api20_host_groups_performance_by_array_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/host-groups/performance/by-array',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api20_host_groups_performance_get_with_http_info(
        ...
        _param = self._api20_host_groups_performance_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api20_host_groups_performance_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/host-groups/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api20_host_groups_post_with_http_info(
        ...
        _param = self._api20_host_groups_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api20_host_groups_post_serialize(
        self,
        authorization,
        x_request_id,
        names,
