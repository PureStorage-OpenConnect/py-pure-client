...
class HostsApi:
    ...
    def api20_hosts_delete_with_http_info(
        ...
        _param = self._api20_hosts_delete_serialize(
    ...
    def _api20_hosts_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
    ...
    def api20_hosts_get_with_http_info(
        ...
        _param = self._api20_hosts_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api20_hosts_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
    ...
    def api20_hosts_host_groups_get_with_http_info(
        ...
        _param = self._api20_hosts_host_groups_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
    ...
    def _api20_hosts_host_groups_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/hosts/host-groups',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api20_hosts_patch_with_http_info(
        ...
        _param = self._api20_hosts_patch_serialize(
            host = host,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api20_hosts_patch_serialize(
        self,
        host,
        authorization,
        x_request_id,
    ...
    def api20_hosts_performance_by_array_get_with_http_info(
        ...
        _param = self._api20_hosts_performance_by_array_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api20_hosts_performance_by_array_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/hosts/performance/by-array',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api20_hosts_performance_get_with_http_info(
        ...
        _param = self._api20_hosts_performance_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api20_hosts_performance_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/hosts/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api20_hosts_post_with_http_info(
        ...
        _param = self._api20_hosts_post_serialize(
            host = host,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api20_hosts_post_serialize(
        self,
        host,
        authorization,
        x_request_id,
