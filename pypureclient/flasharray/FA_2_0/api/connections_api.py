...
class ConnectionsApi(object):
    ...
    def api20_connections_delete(self, **kwargs):
        ...
        >>> thread = api.api20_connections_delete(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api20_connections_delete_with_http_info(**kwargs)
        else:
            (data) = self.api20_connections_delete_with_http_info(**kwargs)
            return data

    def api20_connections_delete_with_http_info(self, **kwargs):
        """Break a connection between a volume and its host or host group
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api20_connections_delete" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def api20_connections_get(self, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_connections_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api20_connections_get_with_http_info(**kwargs)
        else:
            (data) = self.api20_connections_get_with_http_info(**kwargs)
            return data

    def api20_connections_get_with_http_info(self, **kwargs):
        """List volume connections
        ...
        all_params = ['filter', 'host_group_names', 'host_names', 'limit', 'offset', 'protocol_endpoint_names', 'sort', 'total_item_count', 'volume_names']
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_connections_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def api20_connections_post(self, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_connections_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api20_connections_post_with_http_info(**kwargs)
        else:
            (data) = self.api20_connections_post_with_http_info(**kwargs)
            return data

    def api20_connections_post_with_http_info(self, **kwargs):
        """Create a connection between a volume and host or host group
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_connections_post" % key
                )
            params[key] = val
        del params['kwargs']
