...
class ProtectionGroupPerformance(BaseModel):
    ...
    bytes_per_sec: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The total number of bytes of replication data transmitted and received per second.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "bytes_per_sec", "time"]
