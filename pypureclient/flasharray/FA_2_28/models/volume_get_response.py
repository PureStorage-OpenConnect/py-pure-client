...
class VolumeGetResponse(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            total (list[Volume]): The aggregate value of all items after filtering. If applicable, the average value is displayed instead. The values are displayed for each field, if meaningful.
        """
