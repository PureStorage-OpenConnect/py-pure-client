...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_28.models.drive_get_response import DriveGetResponse
from pypureclient.flasharray.FA_2_28.models.drive_response import DriveResponse
...
class DrivesApi:
    ...
    def api228_drives_get_with_http_info(
        ...
        _param = self._api228_drives_get_serialize(
    ...
    def _api228_drives_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api228_drives_patch_with_http_info(
        ...
        _param = self._api228_drives_patch_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            admit = admit,
        )
    ...
    def _api228_drives_patch_serialize(
        self,
        authorization,
        x_request_id,
        admit,
