...
class PodReplicaLinksApi:
    ...
    def api228_pod_replica_links_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_pod_replica_links_delete_with_http_info(authorization, x_request_id, ids, local_pod_ids, local_pod_names, remote_pod_ids, remote_pod_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api228_pod_replica_links_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_pod_replica_links_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_pod_replica_links_get_with_http_info(authorization, x_request_id, filter, ids, limit, local_pod_ids, local_pod_names, offset, remote_ids, remote_names, remote_pod_ids, remote_pod_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_pod_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_pod_replica_links_lag_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_pod_replica_links_lag_get_with_http_info(authorization, x_request_id, end_time, filter, ids, limit, local_pod_ids, local_pod_names, offset, remote_ids, remote_names, remote_pod_ids, remote_pod_names, resolution, sort, start_time, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_pod_replica_links_lag_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_pod_replica_links_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_pod_replica_links_patch_with_http_info(pod_replica_link, authorization, x_request_id, ids, local_pod_ids, local_pod_names, remote_ids, remote_names, remote_pod_ids, remote_pod_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_pod_replica_links_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_pod_replica_links_performance_replication_get_with_http_info(
        ...
        **kwargs
        ...
        """api228_pod_replica_links_performance_replication_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api228_pod_replica_links_performance_replication_get_with_http_info(authorization, x_request_id, end_time, filter, ids, limit, local_pod_ids, local_pod_names, offset, remote_ids, remote_names, remote_pod_ids, remote_pod_names, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_pod_replica_links_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_pod_replica_links_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_pod_replica_links_post_with_http_info(authorization, x_request_id, local_pod_ids, local_pod_names, remote_ids, remote_names, remote_pod_ids, remote_pod_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_pod_replica_links_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
