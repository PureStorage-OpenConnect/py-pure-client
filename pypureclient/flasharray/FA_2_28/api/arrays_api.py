...
from pypureclient.flasharray.FA_2_28.models.array_factory_reset_token_get_response import ArrayFactoryResetTokenGetResponse
from pypureclient.flasharray.FA_2_28.models.array_factory_reset_token_response import ArrayFactoryResetTokenResponse
from pypureclient.flasharray.FA_2_28.models.array_get_response import ArrayGetResponse
from pypureclient.flasharray.FA_2_28.models.array_performance_by_link_get_response import ArrayPerformanceByLinkGetResponse
from pypureclient.flasharray.FA_2_28.models.array_performance_get_response import ArrayPerformanceGetResponse
from pypureclient.flasharray.FA_2_28.models.array_response import ArrayResponse
from pypureclient.flasharray.FA_2_28.models.array_space_get_response import ArraySpaceGetResponse
from pypureclient.flasharray.FA_2_28.models.arrays import Arrays
from pypureclient.flasharray.FA_2_28.models.cloud_provider_tag import CloudProviderTag
from pypureclient.flasharray.FA_2_28.models.cloud_provider_tag_get_response import CloudProviderTagGetResponse
from pypureclient.flasharray.FA_2_28.models.cloud_provider_tag_response import CloudProviderTagResponse
from pypureclient.flasharray.FA_2_28.models.eula import Eula
from pypureclient.flasharray.FA_2_28.models.eula_get_response import EulaGetResponse
from pypureclient.flasharray.FA_2_28.models.eula_response import EulaResponse
...
class ArraysApi:
    ...
    def api228_arrays_cloud_provider_tags_batch_put_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_cloud_provider_tags_batch_put_with_http_info(tag, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api228_arrays_cloud_provider_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_cloud_provider_tags_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_cloud_provider_tags_delete_with_http_info(authorization, x_request_id, keys, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_cloud_provider_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_cloud_provider_tags_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_cloud_provider_tags_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_cloud_provider_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_delete_with_http_info(authorization, x_request_id, eradicate_all_data, factory_reset_token, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_eula_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_eula_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_eula_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_eula_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_eula_patch_with_http_info(eula, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_eula_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_factory_reset_token_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_factory_reset_token_delete_with_http_info(authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_factory_reset_token_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_factory_reset_token_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_factory_reset_token_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_factory_reset_token_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_factory_reset_token_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_factory_reset_token_post_with_http_info(authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_factory_reset_token_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_ntp_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_ntp_test_get_with_http_info(authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_ntp_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_patch_with_http_info(array, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_performance_by_link_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_performance_by_link_get_with_http_info(authorization, x_request_id, end_time, filter, limit, offset, resolution, sort, start_time, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_performance_by_link_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_performance_get_with_http_info(authorization, x_request_id, end_time, filter, limit, offset, protocol, protocol_group, resolution, sort, start_time, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_arrays_space_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_arrays_space_get_with_http_info(authorization, x_request_id, end_time, filter, limit, offset, resolution, sort, start_time, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_arrays_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
