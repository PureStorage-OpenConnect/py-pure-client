...
from pypureclient.flasharray.FA_2_28.models.syslog_server_get_response import SyslogServerGetResponse
from pypureclient.flasharray.FA_2_28.models.syslog_server_response import SyslogServerResponse
from pypureclient.flasharray.FA_2_28.models.syslog_server_settings import SyslogServerSettings
from pypureclient.flasharray.FA_2_28.models.syslog_server_settings_get_response import SyslogServerSettingsGetResponse
from pypureclient.flasharray.FA_2_28.models.syslog_server_settings_response import SyslogServerSettingsResponse
...
class SyslogApi:
    ...
    def api228_syslog_servers_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_syslog_servers_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api228_syslog_servers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_syslog_servers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_syslog_servers_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_syslog_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_syslog_servers_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_syslog_servers_patch_with_http_info(syslog_server, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_syslog_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_syslog_servers_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_syslog_servers_post_with_http_info(syslog_server, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_syslog_servers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_syslog_servers_settings_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_syslog_servers_settings_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_syslog_servers_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_syslog_servers_settings_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_syslog_servers_settings_patch_with_http_info(syslog_server_settings, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_syslog_servers_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_syslog_servers_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_syslog_servers_test_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_syslog_servers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
