...
from pypureclient.flasharray.FA_2_28.models.admin_api_token_get_response import AdminApiTokenGetResponse
from pypureclient.flasharray.FA_2_28.models.admin_api_token_response import AdminApiTokenResponse
from pypureclient.flasharray.FA_2_28.models.admin_cache_get_response import AdminCacheGetResponse
from pypureclient.flasharray.FA_2_28.models.admin_cache_response import AdminCacheResponse
from pypureclient.flasharray.FA_2_28.models.admin_get_response import AdminGetResponse
from pypureclient.flasharray.FA_2_28.models.admin_patch import AdminPatch
from pypureclient.flasharray.FA_2_28.models.admin_post import AdminPost
from pypureclient.flasharray.FA_2_28.models.admin_response import AdminResponse
from pypureclient.flasharray.FA_2_28.models.admin_settings import AdminSettings
from pypureclient.flasharray.FA_2_28.models.admin_settings_get_response import AdminSettingsGetResponse
from pypureclient.flasharray.FA_2_28.models.admin_settings_response import AdminSettingsResponse
...
class AdministratorsApi:
    ...
    def api228_admins_api_tokens_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_admins_api_tokens_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api228_admins_api_tokens_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_admins_api_tokens_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_admins_api_tokens_get_with_http_info(authorization, x_request_id, continuation_token, expose_api_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_admins_api_tokens_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_admins_api_tokens_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_admins_api_tokens_post_with_http_info(authorization, x_request_id, names, timeout, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_admins_api_tokens_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_admins_cache_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_admins_cache_delete_with_http_info(remove_all_entries, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_admins_cache_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_admins_cache_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_admins_cache_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_admins_cache_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_admins_cache_put_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_admins_cache_put_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_admins_cache_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_admins_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_admins_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_admins_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_admins_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_admins_get_with_http_info(authorization, x_request_id, continuation_token, expose_api_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_admins_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_admins_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_admins_patch_with_http_info(admin, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_admins_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_admins_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_admins_post_with_http_info(admin, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_admins_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_admins_settings_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_admins_settings_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_admins_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api228_admins_settings_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api228_admins_settings_patch_with_http_info(admin_settings, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_admins_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
