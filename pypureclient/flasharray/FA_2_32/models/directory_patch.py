...
class DirectoryPatch(BaseModel):
    ...
    __properties = ["name", "directory_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryPatch:
        """Create an instance of DirectoryPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryPatch:
        """Create an instance of DirectoryPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryPatch.parse_obj(obj)

        _obj = DirectoryPatch.construct(_fields_set=None, **{
            "name": obj.get("name"),
