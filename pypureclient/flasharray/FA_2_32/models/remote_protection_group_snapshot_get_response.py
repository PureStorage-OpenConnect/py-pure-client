...
class RemoteProtectionGroupSnapshotGetResponse(BaseModel):
    ...
    items: Optional[List[RemoteProtectionGroupSnapshot]] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
