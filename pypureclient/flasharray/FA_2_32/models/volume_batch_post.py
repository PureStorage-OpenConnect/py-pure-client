...
class VolumeBatchPost(BaseModel):
    ...
    tags: Optional[List[Tag]] = Field(default=None, description="The list of tags of this volume to be upserted.")
    __properties: ClassVar[List[str]] = ["destroyed", "provisioned", "qos", "priority_adjustment", "source", "subtype", "add_to_protection_groups", "name", "tags"]
