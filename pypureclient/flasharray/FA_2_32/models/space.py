...
class Space(BaseModel):
    ...
    __properties = ["data_reduction", "shared", "snapshots", "system", "thin_provisioning", "total_physical", "total_provisioned", "total_reduction", "total_used", "unique", "used_provisioned", "virtual"]
