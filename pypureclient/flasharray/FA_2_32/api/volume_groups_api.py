...
from pypureclient.flasharray.FA_2_32.models.volume_group_get_response import VolumeGroupGetResponse
from pypureclient.flasharray.FA_2_32.models.volume_group_patch import VolumeGroupPatch
from pypureclient.flasharray.FA_2_32.models.volume_group_post import VolumeGroupPost
from pypureclient.flasharray.FA_2_32.models.volume_group_response import VolumeGroupResponse
...
class VolumeGroupsApi:
    ...
    def api232_volume_groups_delete_with_http_info(
        ...
        _param = self._api232_volume_groups_delete_serialize(
    ...
    def _api232_volume_groups_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.32/volume-groups',
    ...
    def api232_volume_groups_get_with_http_info(
        ...
        _param = self._api232_volume_groups_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api232_volume_groups_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api232_volume_groups_patch_with_http_info(
        ...
        _param = self._api232_volume_groups_patch_serialize(
    ...
    def _api232_volume_groups_patch_serialize(
        self,
        volume_group,
        authorization,
        x_request_id,
    ...
    def api232_volume_groups_performance_get_with_http_info(
        ...
        _param = self._api232_volume_groups_performance_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            destroyed = destroyed,
            filter = filter,
    ...
    def _api232_volume_groups_performance_get_serialize(
        self,
        authorization,
        x_request_id,
        destroyed,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.32/volume-groups/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api232_volume_groups_post_with_http_info(
        ...
        _param = self._api232_volume_groups_post_serialize(
            volume_group = volume_group,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api232_volume_groups_post_serialize(
        self,
        volume_group,
        authorization,
        x_request_id,
    ...
    def api232_volume_groups_space_get_with_http_info(
        ...
        _param = self._api232_volume_groups_space_get_serialize(
            names = names,
            authorization = authorization,
            x_request_id = x_request_id,
            destroyed = destroyed,
    ...
    def _api232_volume_groups_space_get_serialize(
        self,
        names,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.32/volume-groups/space',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api232_volume_groups_volumes_get_with_http_info(
        ...
        _param = self._api232_volume_groups_volumes_get_serialize(
    ...
    def _api232_volume_groups_volumes_get_serialize(
        self,
        group_names,
        member_names,
        authorization,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.32/volume-groups/volumes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
