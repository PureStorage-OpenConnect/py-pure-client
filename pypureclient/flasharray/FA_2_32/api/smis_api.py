...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_32.models.smis import Smis
from pypureclient.flasharray.FA_2_32.models.smis_get_response import SmisGetResponse
from pypureclient.flasharray.FA_2_32.models.smis_response import SmisResponse
...
class SMISApi:
    ...
    def api232_smi_s_get_with_http_info(
        ...
        _param = self._api232_smi_s_get_serialize(
    ...
    def _api232_smi_s_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
    ...
    def api232_smi_s_patch_with_http_info(
        ...
        _param = self._api232_smi_s_patch_serialize(
            smi_s = smi_s,
            authorization = authorization,
            x_request_id = x_request_id,
        )
    ...
    def _api232_smi_s_patch_serialize(
        self,
        smi_s,
        authorization,
        x_request_id,
