...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_32.models.network_interface_get_response import NetworkInterfaceGetResponse
from pypureclient.flasharray.FA_2_32.models.network_interface_neighbor_get_response import NetworkInterfaceNeighborGetResponse
from pypureclient.flasharray.FA_2_32.models.network_interface_patch import NetworkInterfacePatch
from pypureclient.flasharray.FA_2_32.models.network_interface_performance_get_response import NetworkInterfacePerformanceGetResponse
from pypureclient.flasharray.FA_2_32.models.network_interface_post import NetworkInterfacePost
from pypureclient.flasharray.FA_2_32.models.network_interface_response import NetworkInterfaceResponse
from pypureclient.flasharray.FA_2_32.models.network_interfaces_port_details_get_response import NetworkInterfacesPortDetailsGetResponse
...
class NetworkInterfacesApi:
    ...
    def api232_network_interfaces_delete_with_http_info(
        ...
        _param = self._api232_network_interfaces_delete_serialize(
    ...
    def _api232_network_interfaces_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.32/network-interfaces',
    ...
    def api232_network_interfaces_get_with_http_info(
        ...
        _param = self._api232_network_interfaces_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api232_network_interfaces_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api232_network_interfaces_neighbors_get_with_http_info(
        ...
        _param = self._api232_network_interfaces_neighbors_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api232_network_interfaces_neighbors_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.32/network-interfaces/neighbors',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api232_network_interfaces_patch_with_http_info(
        ...
        _param = self._api232_network_interfaces_patch_serialize(
            network = network,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api232_network_interfaces_patch_serialize(
        self,
        network,
        authorization,
        x_request_id,
    ...
    def api232_network_interfaces_performance_get_with_http_info(
        ...
        _param = self._api232_network_interfaces_performance_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            end_time = end_time,
    ...
    def _api232_network_interfaces_performance_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.32/network-interfaces/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api232_network_interfaces_port_details_get_with_http_info(
        ...
        _param = self._api232_network_interfaces_port_details_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api232_network_interfaces_port_details_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.32/network-interfaces/port-details',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api232_network_interfaces_post_with_http_info(
        ...
        _param = self._api232_network_interfaces_post_serialize(
            network = network,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api232_network_interfaces_post_serialize(
        self,
        network,
        authorization,
        x_request_id,
