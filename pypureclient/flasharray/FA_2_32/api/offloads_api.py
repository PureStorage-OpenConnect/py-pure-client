...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_32.models.offload_get_response import OffloadGetResponse
from pypureclient.flasharray.FA_2_32.models.offload_post import OffloadPost
from pypureclient.flasharray.FA_2_32.models.offload_response import OffloadResponse
...
class OffloadsApi:
    ...
    def api232_offloads_delete_with_http_info(
        ...
        _param = self._api232_offloads_delete_serialize(
    ...
    def _api232_offloads_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.32/offloads',
    ...
    def api232_offloads_get_with_http_info(
        ...
        _param = self._api232_offloads_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api232_offloads_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
    ...
    def api232_offloads_post_with_http_info(
        ...
        _param = self._api232_offloads_post_serialize(
            offload = offload,
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api232_offloads_post_serialize(
        self,
        offload,
        authorization,
        x_request_id,
