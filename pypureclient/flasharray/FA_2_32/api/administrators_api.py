...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_32.models.admin_api_token_get_response import AdminApiTokenGetResponse
from pypureclient.flasharray.FA_2_32.models.admin_api_token_response import AdminApiTokenResponse
from pypureclient.flasharray.FA_2_32.models.admin_cache_get_response import AdminCacheGetResponse
from pypureclient.flasharray.FA_2_32.models.admin_cache_response import AdminCacheResponse
from pypureclient.flasharray.FA_2_32.models.admin_get_response import AdminGetResponse
from pypureclient.flasharray.FA_2_32.models.admin_patch import AdminPatch
from pypureclient.flasharray.FA_2_32.models.admin_post import AdminPost
from pypureclient.flasharray.FA_2_32.models.admin_response import AdminResponse
from pypureclient.flasharray.FA_2_32.models.admin_settings import AdminSettings
from pypureclient.flasharray.FA_2_32.models.admin_settings_get_response import AdminSettingsGetResponse
from pypureclient.flasharray.FA_2_32.models.admin_settings_response import AdminSettingsResponse
...
class AdministratorsApi:
    ...
    def api232_admins_api_tokens_delete_with_http_info(
        ...
        _param = self._api232_admins_api_tokens_delete_serialize(
    ...
    def _api232_admins_api_tokens_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.32/admins/api-tokens',
    ...
    def api232_admins_api_tokens_get_with_http_info(
        ...
        _param = self._api232_admins_api_tokens_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api232_admins_api_tokens_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api232_admins_api_tokens_post_with_http_info(
        ...
        _param = self._api232_admins_api_tokens_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
            timeout = timeout,
    ...
    def _api232_admins_api_tokens_post_serialize(
        self,
        authorization,
        x_request_id,
        names,
    ...
    def api232_admins_cache_delete_with_http_info(
        ...
        _param = self._api232_admins_cache_delete_serialize(
    ...
    def _api232_admins_cache_delete_serialize(
        self,
        remove_all_entries,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.32/admins/cache',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api232_admins_cache_get_with_http_info(
        ...
        _param = self._api232_admins_cache_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api232_admins_cache_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api232_admins_cache_put_with_http_info(
        ...
        _param = self._api232_admins_cache_put_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api232_admins_cache_put_serialize(
        self,
        authorization,
        x_request_id,
        names,
    ...
    def api232_admins_delete_with_http_info(
        ...
        _param = self._api232_admins_delete_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api232_admins_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
    ...
    def api232_admins_get_with_http_info(
        ...
        _param = self._api232_admins_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            expose_api_token = expose_api_token,
    ...
    def _api232_admins_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api232_admins_patch_with_http_info(
        ...
        _param = self._api232_admins_patch_serialize(
            admin = admin,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api232_admins_patch_serialize(
        self,
        admin,
        authorization,
        x_request_id,
    ...
    def api232_admins_post_with_http_info(
        ...
        _param = self._api232_admins_post_serialize(
            admin = admin,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api232_admins_post_serialize(
        self,
        admin,
        authorization,
        x_request_id,
    ...
    def api232_admins_settings_get_with_http_info(
        ...
        _param = self._api232_admins_settings_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api232_admins_settings_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.32/admins/settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api232_admins_settings_patch_with_http_info(
        ...
        _param = self._api232_admins_settings_patch_serialize(
    ...
    def _api232_admins_settings_patch_serialize(
        self,
        admin_settings,
        authorization,
        x_request_id,
