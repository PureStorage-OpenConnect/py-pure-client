...
class SNMPManagersApi(object):
    ...
    def api232_snmp_managers_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api232_snmp_managers_get`, must be a value greater than or equal to `1`")
    ...
    def api232_snmp_managers_test_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api232_snmp_managers_test_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
