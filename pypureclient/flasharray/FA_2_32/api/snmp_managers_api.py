...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_32.models.snmp_manager_get_response import SnmpManagerGetResponse
from pypureclient.flasharray.FA_2_32.models.snmp_manager_patch import SnmpManagerPatch
from pypureclient.flasharray.FA_2_32.models.snmp_manager_post import SnmpManagerPost
from pypureclient.flasharray.FA_2_32.models.snmp_manager_response import SnmpManagerResponse
from pypureclient.flasharray.FA_2_32.models.test_result_with_resource_get_response import TestResultWithResourceGetResponse
...
class SNMPManagersApi:
    ...
    def api232_snmp_managers_delete_with_http_info(
        ...
        _param = self._api232_snmp_managers_delete_serialize(
    ...
    def _api232_snmp_managers_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.32/snmp-managers',
    ...
    def api232_snmp_managers_get_with_http_info(
        ...
        _param = self._api232_snmp_managers_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api232_snmp_managers_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api232_snmp_managers_patch_with_http_info(
        ...
        _param = self._api232_snmp_managers_patch_serialize(
    ...
    def _api232_snmp_managers_patch_serialize(
        self,
        snmp_manager,
        authorization,
        x_request_id,
    ...
    def api232_snmp_managers_post_with_http_info(
        ...
        _param = self._api232_snmp_managers_post_serialize(
            snmp_manager = snmp_manager,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api232_snmp_managers_post_serialize(
        self,
        snmp_manager,
        authorization,
        x_request_id,
    ...
    def api232_snmp_managers_test_get_with_http_info(
        ...
        _param = self._api232_snmp_managers_test_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api232_snmp_managers_test_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.32/snmp-managers/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
