...
from pypureclient.flasharray.FA_2_32.models.test_result_with_resource_post_response import TestResultWithResourcePostResponse
from pypureclient.flasharray.FA_2_32.models.volume_snapshot_get_response import VolumeSnapshotGetResponse
from pypureclient.flasharray.FA_2_32.models.volume_snapshot_patch import VolumeSnapshotPatch
from pypureclient.flasharray.FA_2_32.models.volume_snapshot_post import VolumeSnapshotPost
from pypureclient.flasharray.FA_2_32.models.volume_snapshot_response import VolumeSnapshotResponse
from pypureclient.flasharray.FA_2_32.models.volume_snapshot_transfer_get_response import VolumeSnapshotTransferGetResponse
...
class VolumeSnapshotsApi:
    ...
    def api232_volume_snapshots_delete_with_http_info(
        ...
        _param = self._api232_volume_snapshots_delete_serialize(
    ...
    def _api232_volume_snapshots_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.32/volume-snapshots',
    ...
    def api232_volume_snapshots_get_with_http_info(
        ...
        _param = self._api232_volume_snapshots_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api232_volume_snapshots_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api232_volume_snapshots_patch_with_http_info(
        ...
        _param = self._api232_volume_snapshots_patch_serialize(
    ...
    def _api232_volume_snapshots_patch_serialize(
        self,
        volume_snapshot,
        authorization,
        x_request_id,
    ...
    def api232_volume_snapshots_post_with_http_info(
        ...
        _param = self._api232_volume_snapshots_post_serialize(
            volume_snapshot = volume_snapshot,
            authorization = authorization,
            x_request_id = x_request_id,
            on = on,
    ...
    def _api232_volume_snapshots_post_serialize(
        self,
        volume_snapshot,
        authorization,
        x_request_id,
    ...
    def api232_volume_snapshots_tags_batch_put_with_http_info(
        ...
        _param = self._api232_volume_snapshots_tags_batch_put_serialize(
            tag = tag,
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api232_volume_snapshots_tags_batch_put_serialize(
        self,
        tag,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/2.32/volume-snapshots/tags/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api232_volume_snapshots_tags_delete_with_http_info(
        ...
        _param = self._api232_volume_snapshots_tags_delete_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            keys = keys,
    ...
    def _api232_volume_snapshots_tags_delete_serialize(
        self,
        authorization,
        x_request_id,
        keys,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.32/volume-snapshots/tags',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api232_volume_snapshots_tags_get_with_http_info(
        ...
        _param = self._api232_volume_snapshots_tags_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api232_volume_snapshots_tags_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api232_volume_snapshots_test_post_with_http_info(
        ...
        _param = self._api232_volume_snapshots_test_post_serialize(
            volume_snapshot = volume_snapshot,
            authorization = authorization,
            x_request_id = x_request_id,
            on = on,
    ...
    def _api232_volume_snapshots_test_post_serialize(
        self,
        volume_snapshot,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2.32/volume-snapshots/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api232_volume_snapshots_transfer_get_with_http_info(
        ...
        _param = self._api232_volume_snapshots_transfer_get_serialize(
            names = names,
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
    ...
    def _api232_volume_snapshots_transfer_get_serialize(
        self,
        names,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.32/volume-snapshots/transfer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
