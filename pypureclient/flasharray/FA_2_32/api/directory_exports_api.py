...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_32.models.directory_export_get_response import DirectoryExportGetResponse
from pypureclient.flasharray.FA_2_32.models.directory_export_patch import DirectoryExportPatch
from pypureclient.flasharray.FA_2_32.models.directory_export_post import DirectoryExportPost
from pypureclient.flasharray.FA_2_32.models.directory_export_response import DirectoryExportResponse
...
class DirectoryExportsApi:
    ...
    def api232_directory_exports_delete_with_http_info(
        ...
        _param = self._api232_directory_exports_delete_serialize(
    ...
    def _api232_directory_exports_delete_serialize(
        self,
        authorization,
        x_request_id,
        directory_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.32/directory-exports',
    ...
    def api232_directory_exports_get_with_http_info(
        ...
        _param = self._api232_directory_exports_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api232_directory_exports_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api232_directory_exports_patch_with_http_info(
        ...
        _param = self._api232_directory_exports_patch_serialize(
            export = export,
            authorization = authorization,
            x_request_id = x_request_id,
            directory_ids = directory_ids,
    ...
    def _api232_directory_exports_patch_serialize(
        self,
        export,
        authorization,
        x_request_id,
    ...
    def api232_directory_exports_post_with_http_info(
        ...
        _param = self._api232_directory_exports_post_serialize(
            exports = exports,
            authorization = authorization,
            x_request_id = x_request_id,
            directory_ids = directory_ids,
    ...
    def _api232_directory_exports_post_serialize(
        self,
        exports,
        authorization,
        x_request_id,
