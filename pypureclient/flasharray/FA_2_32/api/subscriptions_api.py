...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_32.models.subscription_get_response import SubscriptionGetResponse
...
class SubscriptionsApi:
    ...
    def api232_subscriptions_get_with_http_info(
        ...
        _param = self._api232_subscriptions_get_serialize(
    ...
    def _api232_subscriptions_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.32/subscriptions',
