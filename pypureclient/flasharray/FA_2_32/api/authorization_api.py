...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_32.models.api_version_response import ApiVersionResponse
from pypureclient.flasharray.FA_2_32.models.oauth_token_response import OauthTokenResponse
from pypureclient.flasharray.FA_2_32.models.username_response import UsernameResponse
...
class AuthorizationApi:
    ...
    def api232_login_post_with_http_info(
        ...
        _param = self._api232_login_post_serialize(
    ...
    def _api232_login_post_serialize(
        self,
        x_request_id,
        api_token,
    ) -> RequestSerialized:
    ...
    def api232_logout_post_with_http_info(
        ...
        _param = self._api232_logout_post_serialize(
            x_request_id = x_request_id,
    ...
    def _api232_logout_post_serialize(
        self,
        x_request_id,
        x_auth_token,
    ) -> RequestSerialized:
