...
from pypureclient.flasharray.FA_2_50.models.smis import Smis
from pypureclient.flasharray.FA_2_50.models.smis_get_response import SmisGetResponse
from pypureclient.flasharray.FA_2_50.models.smis_response import SmisResponse
from typing import Optional
...
class SMISApi:
    ...
    def api250_smi_s_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api250_smi_s_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api250_smi_s_patch_with_http_info(
        self,
        smi_s: Smis,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_smi_s_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
