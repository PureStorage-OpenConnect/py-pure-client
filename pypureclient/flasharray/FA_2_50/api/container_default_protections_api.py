...
from pypureclient.flasharray.FA_2_50.models.container_default_protection import ContainerDefaultProtection
from pypureclient.flasharray.FA_2_50.models.container_default_protection_get_response import ContainerDefaultProtectionGetResponse
from pypureclient.flasharray.FA_2_50.models.container_default_protection_response import ContainerDefaultProtectionResponse
from typing import Optional
...
class ContainerDefaultProtectionsApi:
    ...
    def api250_container_default_protections_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api250_container_default_protections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.50/container-default-protections', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api250_container_default_protections_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_container_default_protections_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.50/container-default-protections', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
