...
from pypureclient.flasharray.FA_2_50.models.subscription_asset_get_response import SubscriptionAssetGetResponse
from typing import Optional
...
class SubscriptionAssetsApi:
    ...
    def api250_subscription_assets_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api250_subscription_assets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.50/subscription-assets', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
