...
from pypureclient.flasharray.common.models.remote_arrays_response_v_49 import RemoteArraysResponse
...
class RemoteArraysApi:
    ...
    def api250_remote_arrays_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api250_remote_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
