...
from pypureclient.flasharray.FA_2_50.models.offload_get_response import OffloadGetResponse
from pypureclient.flasharray.FA_2_50.models.offload_patch import OffloadPatch
from pypureclient.flasharray.FA_2_50.models.offload_post import OffloadPost
from pypureclient.flasharray.FA_2_50.models.offload_response import OffloadResponse
from typing import Optional
...
class OffloadsApi:
    ...
    def api250_offloads_delete_with_http_info(
        self,
    ...
    def api250_offloads_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
    ...
    def api250_offloads_patch_with_http_info(
        self,
    ...
    def api250_offloads_post_with_http_info(
        self,
        offload: OffloadPost,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
