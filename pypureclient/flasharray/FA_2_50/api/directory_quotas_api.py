...
from pypureclient.flasharray.common.models.directory_quotas_get_response_v_50 import DirectoryQuotasGetResponse
...
class DirectoryQuotasApi:
    ...
    def api250_directory_quotas_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        :rtype: tuple(DirectoryQuotasGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api250_directory_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "DirectoryQuotasGetResponse",
            '207': "DirectoryQuotasGetResponse",
        }

        return self.api_client.call_api(
            '/api/2.50/directory-quotas', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
