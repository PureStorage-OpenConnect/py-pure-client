...
from pypureclient.flasharray.FA_2_50.models.array_connection_get_response import ArrayConnectionGetResponse
from pypureclient.flasharray.FA_2_50.models.array_connection_key_get_response import ArrayConnectionKeyGetResponse
from pypureclient.flasharray.FA_2_50.models.array_connection_patch import ArrayConnectionPatch
from pypureclient.flasharray.FA_2_50.models.array_connection_path_get_response import ArrayConnectionPathGetResponse
from pypureclient.flasharray.FA_2_50.models.array_connection_post import ArrayConnectionPost
from pypureclient.flasharray.FA_2_50.models.array_connection_response import ArrayConnectionResponse
from typing import Optional
...
class ArrayConnectionsApi:
    ...
    def api250_array_connections_connection_key_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.50/array-connections/connection-key', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api250_array_connections_delete_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.50/array-connections', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api250_array_connections_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.50/array-connections', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api250_array_connections_patch_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.50/array-connections', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api250_array_connections_path_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.50/array-connections/path', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api250_array_connections_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.50/array-connections', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
