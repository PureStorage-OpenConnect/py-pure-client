...
from pypureclient.flasharray.FA_2_50.models.policy_nfs_policy_mapping import PolicyNfsPolicyMapping
...
class PolicySmb(BaseModel):
    ...
    __properties = ["context", "id", "name", "destroyed", "enabled", "pod", "policy_type", "time_remaining", "access_based_enumeration_enabled", "continuous_availability_enabled", "policy_mapping"]
