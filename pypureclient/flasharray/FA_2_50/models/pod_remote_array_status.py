...
class PodRemoteArrayStatus(BaseModel):
    """
    ...
    member: Optional[ReferenceWithType] = Field(default=None, description="Specifies the reference to the member associated with the pod's array status.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PodRemoteArrayStatus:
        """Create an instance of PodRemoteArrayStatus from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PodRemoteArrayStatus:
        """Create an instance of PodRemoteArrayStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PodRemoteArrayStatus.parse_obj(obj)

        _obj = PodRemoteArrayStatus.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
