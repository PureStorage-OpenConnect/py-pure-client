...
class HostGroup(BaseModel):
    ...
    __properties = ["name", "context", "connection_count", "destroyed", "host_count", "is_local", "qos", "space", "time_remaining"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HostGroup:
        """Create an instance of HostGroup from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> HostGroup:
        """Create an instance of HostGroup from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HostGroup.parse_obj(obj)

        _obj = HostGroup.construct(_fields_set=None, **{
            "name": obj.get("name"),
