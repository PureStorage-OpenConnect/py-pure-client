...
class RemoteRealm(BaseModel):
    ...
    arrays: Optional[conlist(ReferenceWithType, min_items=1)] = None
    __properties = ["context", "id", "name", "arrays"]
    ...
    def from_dict(cls, obj: dict) -> RemoteRealm:
        ...
        _obj = RemoteRealm.construct(_fields_set=None, **{
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "arrays": [ReferenceWithType.from_dict(_item) for _item in obj.get("arrays")] if obj.get("arrays") is not None else None
        })
        return _obj
