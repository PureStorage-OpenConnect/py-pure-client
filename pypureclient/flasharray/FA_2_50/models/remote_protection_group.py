...
class RemoteProtectionGroup(BaseModel):
    """
    ...
    remote: Optional[FixedReference] = Field(default=None, description="The offload target that the remote protection group is on.")
    source: Optional[FixedReference] = Field(default=None, description="The array where the remote protection group is replicated from.")
    target_retention: Optional[RetentionPolicy] = Field(default=None, description="The retention policy for the remote protection group.")
    time_remaining: Optional[StrictInt] = Field(default=None, description="Milliseconds remaining until eradication, if remote protection group has been destroyed.")
    __properties = ["id", "name", "context", "destroyed", "is_local", "remote", "source", "target_retention", "time_remaining"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoteProtectionGroup:
        """Create an instance of RemoteProtectionGroup from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RemoteProtectionGroup:
        """Create an instance of RemoteProtectionGroup from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoteProtectionGroup.parse_obj(obj)

        _obj = RemoteProtectionGroup.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
