...
from pypureclient.flasharray.FA_2_50.models.stretched_tag_realm import StretchedTagRealm


class RemoteRealmTagGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(StretchedTagRealm)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoteRealmTagGetResponse:
        """Create an instance of RemoteRealmTagGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RemoteRealmTagGetResponse:
        """Create an instance of RemoteRealmTagGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoteRealmTagGetResponse.parse_obj(obj)

        _obj = RemoteRealmTagGetResponse.construct(_fields_set=None, **{
            ...
            "items": [StretchedTagRealm.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
