...
class VolumeDiff(BaseModel):
    ...
    length: Optional[StrictInt] = Field(default=None, description="Length of the chunk that is different, in bytes.")
    offset: Optional[StrictInt] = Field(default=None, description="Absolute offset of the chunk that is different, in bytes.")
    __properties = ["context", "length", "offset"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VolumeDiff:
        """Create an instance of VolumeDiff from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VolumeDiff:
        """Create an instance of VolumeDiff from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VolumeDiff.parse_obj(obj)

        _obj = VolumeDiff.construct(_fields_set=None, **{
