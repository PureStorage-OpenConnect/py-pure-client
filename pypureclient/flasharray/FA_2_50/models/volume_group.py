...
from pypureclient.flasharray.FA_2_50.models.space import Space
from pypureclient.flasharray.FA_2_50.models.workload_configuration_fixed_reference_workload import WorkloadConfigurationFixedReferenceWorkload
...
class VolumeGroup(BaseModel):
    ...
    __properties = ["context", "id", "name", "workload", "destroyed", "pod", "priority_adjustment", "qos", "space", "time_remaining", "volume_count"]
