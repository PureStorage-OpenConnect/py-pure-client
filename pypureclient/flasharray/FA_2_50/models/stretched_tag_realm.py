...
from pypureclient.flasharray.FA_2_50.models.stretched_tag_remote_array_status import StretchedTagRemoteArrayStatus


class StretchedTagRealm(BaseModel):
    """
    StretchedTagRealm
    """
    ...
    arrays: Optional[conlist(StretchedTagRemoteArrayStatus, min_items=1)] = None
    members: Optional[conlist(FixedReferenceWithType, min_items=1)] = Field(default=None, description="A list of arrays or realms over which the tag is stretched.")
    __properties = ["context", "copyable", "key", "namespace", "resource", "value", "arrays", "members"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StretchedTagRealm:
        """Create an instance of StretchedTagRealm from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> StretchedTagRealm:
        """Create an instance of StretchedTagRealm from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StretchedTagRealm.parse_obj(obj)

        _obj = StretchedTagRealm.construct(_fields_set=None, **{
            ...
            "value": obj.get("value"),
            "arrays": [StretchedTagRemoteArrayStatus.from_dict(_item) for _item in obj.get("arrays")] if obj.get("arrays") is not None else None,
            "members": [FixedReferenceWithType.from_dict(_item) for _item in obj.get("members")] if obj.get("members") is not None else None
        })
        return _obj
