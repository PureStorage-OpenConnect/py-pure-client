...
from pypureclient.flasharray.FA_2_50.models.network_interface_eth import NetworkInterfaceEth
from pypureclient.flasharray.FA_2_50.models.network_interface_fc import NetworkInterfaceFc
...
class NetworkInterface(BaseModel):
    ...
    __properties = ["context", "name", "server", "attached_servers", "enabled", "eth", "fc", "interface_type", "services", "speed"]
