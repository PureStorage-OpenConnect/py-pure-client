...
class VolumeGetResponse(BaseModel):
    ...
    items: Optional[List[Volume]] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name. If `total_only=true`, the `items` list is empty.")
