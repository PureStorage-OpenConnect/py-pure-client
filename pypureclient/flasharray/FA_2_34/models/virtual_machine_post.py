...
class VirtualMachinePost(BaseModel):
    """
    VirtualMachinePost
    """
    ...
    source: Optional[Reference] = Field(default=None, description="The recovery context for the virtual machine or virtual machine snapshot being modified.")
    vm_id: Optional[StrictStr] = Field(default=None, description="The ID of the virtual machine to create or modify, as assigned by the external system.")
    vm_type: Optional[StrictStr] = Field(default=None, description="The type of virtual machine. The only valid value is `vvol`.")
    __properties = ["id", "source", "vm_id", "vm_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VirtualMachinePost:
        """Create an instance of VirtualMachinePost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VirtualMachinePost:
        """Create an instance of VirtualMachinePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VirtualMachinePost.parse_obj(obj)

        _obj = VirtualMachinePost.construct(_fields_set=None, **{
            "id": obj.get("id"),
