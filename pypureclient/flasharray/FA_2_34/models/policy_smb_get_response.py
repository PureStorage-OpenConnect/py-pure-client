...
class PolicySmbGetResponse(BaseModel):
    ...
    items: Optional[List[PolicySmb]] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
