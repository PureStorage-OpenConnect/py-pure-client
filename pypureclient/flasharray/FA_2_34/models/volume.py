...
class Volume(BaseModel):
    ...
    __properties = ["id", "name", "connection_count", "created", "destroyed", "host_encryption_key_status", "priority_adjustment", "provisioned", "qos", "serial", "space", "time_remaining", "pod", "priority", "promotion_status", "protocol_endpoint", "requested_promotion_state", "source", "subtype", "volume_group"]
