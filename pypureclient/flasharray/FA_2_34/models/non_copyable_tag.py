...
class NonCopyableTag(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NonCopyableTag:
        """Create an instance of NonCopyableTag from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NonCopyableTag:
        """Create an instance of NonCopyableTag from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NonCopyableTag.parse_obj(obj)

        _obj = NonCopyableTag.construct(_fields_set=None, **{
            "key": obj.get("key"),
