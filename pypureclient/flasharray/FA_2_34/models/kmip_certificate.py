...
class KmipCertificate(BaseModel):
    """
    KmipCertificate
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> KmipCertificate:
        """Create an instance of KmipCertificate from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> KmipCertificate:
        """Create an instance of KmipCertificate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return KmipCertificate.parse_obj(obj)

        _obj = KmipCertificate.construct(_fields_set=None, **{
            "name": obj.get("name")
        })
        return _obj
