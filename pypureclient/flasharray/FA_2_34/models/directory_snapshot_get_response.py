...
class DirectorySnapshotGetResponse(BaseModel):
    ...
    items: Optional[List[DirectorySnapshot]] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    total: Optional[List[DirectorySnapshot]] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. If applicable, the values are displayed for each field.")
