...
class VolumeSnapshotPatch(BaseModel):
    """
    VolumeSnapshotPatch
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VolumeSnapshotPatch:
        """Create an instance of VolumeSnapshotPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VolumeSnapshotPatch:
        """Create an instance of VolumeSnapshotPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VolumeSnapshotPatch.parse_obj(obj)

        _obj = VolumeSnapshotPatch.construct(_fields_set=None, **{
