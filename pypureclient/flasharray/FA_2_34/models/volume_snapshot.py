...
from pypureclient.flasharray.FA_2_34.models.snapshot_space import SnapshotSpace
...
class VolumeSnapshot(BaseModel):
    ...
    volume_group: Optional[FixedReference] = Field(default=None, description="The volume group to which the volume that is the source of the volume snapshot belongs.")
    __properties: ClassVar[List[str]] = ["id", "name", "created", "destroyed", "pod", "provisioned", "source", "suffix", "time_remaining", "serial", "space", "volume_group"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "space": SnapshotSpace.from_dict(obj["space"]) if obj.get("space") is not None else None,
            "volume_group": FixedReference.from_dict(obj["volume_group"]) if obj.get("volume_group") is not None else None
        })
        return _obj
