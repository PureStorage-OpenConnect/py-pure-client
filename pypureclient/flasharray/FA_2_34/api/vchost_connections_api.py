...
from pypureclient.flasharray.FA_2_34.models.vchost_connection_get_response import VchostConnectionGetResponse
from pypureclient.flasharray.FA_2_34.models.vchost_connection_response import VchostConnectionResponse
...
class VchostConnectionsApi:
    ...
    def api234_vchost_connections_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api234_vchost_connections_delete_with_http_info(authorization, x_request_id, all_vchosts, protocol_endpoint_ids, protocol_endpoint_names, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api234_vchost_connections_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api234_vchost_connections_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api234_vchost_connections_get_with_http_info(authorization, x_request_id, all_vchosts, continuation_token, filter, limit, offset, protocol_endpoint_ids, protocol_endpoint_names, sort, total_item_count, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api234_vchost_connections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api234_vchost_connections_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api234_vchost_connections_post_with_http_info(authorization, x_request_id, all_vchosts, allow_stretched_multi_vchost, protocol_endpoint_ids, protocol_endpoint_names, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api234_vchost_connections_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
