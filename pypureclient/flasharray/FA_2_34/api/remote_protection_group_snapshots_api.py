...
from pypureclient.flasharray.FA_2_34.models.remote_protection_group_snapshot_get_response import RemoteProtectionGroupSnapshotGetResponse
from pypureclient.flasharray.FA_2_34.models.remote_protection_group_snapshot_post import RemoteProtectionGroupSnapshotPost
from pypureclient.flasharray.FA_2_34.models.remote_protection_group_snapshot_response import RemoteProtectionGroupSnapshotResponse
from pypureclient.flasharray.FA_2_34.models.remote_protection_group_snapshot_transfer_get_response import RemoteProtectionGroupSnapshotTransferGetResponse
...
class RemoteProtectionGroupSnapshotsApi:
    ...
    def api234_remote_protection_group_snapshots_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api234_remote_protection_group_snapshots_delete_with_http_info(authorization, x_request_id, ids, names, on, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api234_remote_protection_group_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api234_remote_protection_group_snapshots_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api234_remote_protection_group_snapshots_get_with_http_info(authorization, x_request_id, destroyed, filter, ids, limit, names, offset, on, sort, source_ids, source_names, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api234_remote_protection_group_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api234_remote_protection_group_snapshots_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api234_remote_protection_group_snapshots_patch_with_http_info(remote_protection_group_snapshot, authorization, x_request_id, ids, names, on, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api234_remote_protection_group_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api234_remote_protection_group_snapshots_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api234_remote_protection_group_snapshots_post_with_http_info(authorization, x_request_id, allow_throttle, apply_retention, convert_source_to_baseline, for_replication, ids, names, on, replicate, replicate_now, source_ids, source_names, remote_protection_group_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api234_remote_protection_group_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api234_remote_protection_group_snapshots_test_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api234_remote_protection_group_snapshots_test_post_with_http_info(authorization, x_request_id, allow_throttle, apply_retention, convert_source_to_baseline, for_replication, ids, names, on, replicate, replicate_now, source_ids, source_names, remote_protection_group_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api234_remote_protection_group_snapshots_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api234_remote_protection_group_snapshots_transfer_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api234_remote_protection_group_snapshots_transfer_get_with_http_info(authorization, x_request_id, destroyed, filter, ids, limit, names, offset, on, sort, source_ids, source_names, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api234_remote_protection_group_snapshots_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
