...
class VirtualMachinesApi(object):
    ...
    def api234_virtual_machine_snapshots_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api234_virtual_machine_snapshots_get`, must be a value greater than or equal to `1`")
    ...
    def api234_virtual_machines_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api234_virtual_machines_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
