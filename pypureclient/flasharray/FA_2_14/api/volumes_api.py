...
from pypureclient.flasharray.FA_2_14.models.resource_performance_by_array_get_response import ResourcePerformanceByArrayGetResponse
...
from pypureclient.flasharray.FA_2_14.models.volume_get_response import VolumeGetResponse
from pypureclient.flasharray.FA_2_14.models.volume_patch import VolumePatch
from pypureclient.flasharray.FA_2_14.models.volume_post import VolumePost
from pypureclient.flasharray.FA_2_14.models.volume_response import VolumeResponse
from pypureclient.flasharray.FA_2_14.models.volume_space_get_response import VolumeSpaceGetResponse
from pypureclient.flasharray.FA_2_14.models.volumes_diff_get_response import VolumesDiffGetResponse
...
class VolumesApi:
    ...
    def api214_volumes_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_delete_with_http_info(authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_volumes_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_diff_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_diff_get_with_http_info(block_size, segment_length, authorization, x_request_id, base_id, base_name, filter, ids, limit, names, next_allocated_block_hint, offset, segment_offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_diff_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, ids, limit, names, offset, sort, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_patch_with_http_info(volume, authorization, x_request_id, ids, names, truncate, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_performance_by_array_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_performance_by_array_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_performance_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_post_with_http_info(volume, authorization, x_request_id, names, overwrite, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_protection_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_protection_groups_delete_with_http_info(authorization, x_request_id, group_names, member_ids, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_protection_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_protection_groups_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_names, limit, member_destroyed, member_ids, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_protection_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_protection_groups_post_with_http_info(authorization, x_request_id, group_names, member_ids, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_space_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_space_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_tags_batch_put_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_tags_batch_put_with_http_info(tag, authorization, x_request_id, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_tags_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_tags_delete_with_http_info(authorization, x_request_id, keys, namespaces, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_tags_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_tags_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, namespaces, offset, resource_destroyed, resource_ids, resource_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_volumes_volume_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_volumes_volume_groups_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_ids, group_names, limit, member_ids, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_volumes_volume_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
