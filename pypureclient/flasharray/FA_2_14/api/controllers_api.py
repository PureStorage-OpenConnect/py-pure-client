...
from pypureclient.flasharray.FA_2_14.models.controller_get_response import ControllerGetResponse
...
class ControllersApi:
    ...
    def api214_controllers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_controllers_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_controllers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
