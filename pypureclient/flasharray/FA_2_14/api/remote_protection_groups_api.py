...
from pypureclient.flasharray.FA_2_14.models.remote_protection_group_get_response import RemoteProtectionGroupGetResponse
from pypureclient.flasharray.FA_2_14.models.remote_protection_group_response import RemoteProtectionGroupResponse
...
class RemoteProtectionGroupsApi:
    ...
    def api214_remote_protection_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_remote_protection_groups_delete_with_http_info(authorization, x_request_id, ids, names, on, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_remote_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_remote_protection_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_remote_protection_groups_get_with_http_info(authorization, x_request_id, destroyed, filter, ids, limit, names, offset, on, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_remote_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api214_remote_protection_groups_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api214_remote_protection_groups_patch_with_http_info(remote_protection_group, authorization, x_request_id, ids, names, on, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_remote_protection_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
