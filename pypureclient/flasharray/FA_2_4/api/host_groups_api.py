...
from pypureclient.flasharray.FA_2_4.models.host_group_get_response import HostGroupGetResponse
from pypureclient.flasharray.FA_2_4.models.host_group_patch import HostGroupPatch
from pypureclient.flasharray.FA_2_4.models.host_group_response import HostGroupResponse
from pypureclient.flasharray.FA_2_4.models.member_no_id_all_get_response import MemberNoIdAllGetResponse
from pypureclient.flasharray.FA_2_4.models.member_no_id_all_response import MemberNoIdAllResponse
from pypureclient.flasharray.FA_2_4.models.resource_performance_no_id_by_array_get_response import ResourcePerformanceNoIdByArrayGetResponse
from pypureclient.flasharray.FA_2_4.models.resource_performance_no_id_get_response import ResourcePerformanceNoIdGetResponse
from pypureclient.flasharray.FA_2_4.models.resource_space_no_id_get_response import ResourceSpaceNoIdGetResponse
from pypureclient.flasharray.FA_2_4.api_client import ApiClient as _TransportApiClient
from pypureclient.flasharray.FA_2_4.api_response import ApiResponse
from pypureclient.flasharray.FA_2_4.exceptions import (  # noqa: F401
    ApiTypeError,
    ApiValueError
)
...
class HostGroupsApi:
    ...
    def api24_host_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_host_groups_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api24_host_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_host_groups_get_with_http_info(
        ...
        **kwargs
        ...
        Returns a list of host groups.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api24_host_groups_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_host_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_host_groups_hosts_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_host_groups_hosts_delete_with_http_info(authorization, x_request_id, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_host_groups_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_host_groups_hosts_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_host_groups_hosts_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_names, limit, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_host_groups_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_host_groups_hosts_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_host_groups_hosts_post_with_http_info(authorization, x_request_id, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_host_groups_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_host_groups_patch_with_http_info(
        ...
        **kwargs
        ...
        Manages a host group. The `names` query parameter is required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api24_host_groups_patch_with_http_info(host_group, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_host_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_host_groups_performance_by_array_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_host_groups_performance_by_array_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_host_groups_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_host_groups_performance_get_with_http_info(
        ...
        **kwargs
        ...
        Displays real-time and historical performance data, real-time latency data, and average I/O sizes across all volumes, displayed both by host group and as a total across all host groups.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api24_host_groups_performance_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_host_groups_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_host_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_host_groups_post_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_host_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_host_groups_protection_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_host_groups_protection_groups_delete_with_http_info(authorization, x_request_id, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_host_groups_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_host_groups_protection_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_host_groups_protection_groups_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_names, limit, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_host_groups_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_host_groups_protection_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_host_groups_protection_groups_post_with_http_info(authorization, x_request_id, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_host_groups_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_host_groups_space_get_with_http_info(
        ...
        **kwargs
        ...
        Returns provisioned size and physical storage consumption data for each host group.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api24_host_groups_space_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_host_groups_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
