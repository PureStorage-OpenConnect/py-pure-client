...
from pypureclient.flasharray.FA_2_4.models.port_get_response import PortGetResponse
from pypureclient.flasharray.FA_2_4.models.port_initiators_get_response import PortInitiatorsGetResponse
...
class PortsApi:
    ...
    def api24_ports_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_ports_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api24_ports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_ports_initiators_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_ports_initiators_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_ports_initiators_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
