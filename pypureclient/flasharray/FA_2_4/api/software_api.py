...
from pypureclient.flasharray.FA_2_4.models.software_get_response import SoftwareGetResponse
from pypureclient.flasharray.FA_2_4.models.software_installation_patch import SoftwareInstallationPatch
from pypureclient.flasharray.FA_2_4.models.software_installation_post import SoftwareInstallationPost
from pypureclient.flasharray.FA_2_4.models.software_installation_steps_get_response import SoftwareInstallationStepsGetResponse
from pypureclient.flasharray.FA_2_4.models.software_installations_get_response import SoftwareInstallationsGetResponse
from pypureclient.flasharray.FA_2_4.models.software_installations_response import SoftwareInstallationsResponse
...
class SoftwareApi:
    ...
    def api24_software_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_software_get_with_http_info(authorization, x_request_id, filter, ids, limit, names, offset, sort, total_item_count, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api24_software_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_software_installation_steps_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_software_installation_steps_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, software_installation_ids, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_software_installation_steps_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_software_installations_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_software_installations_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, software_ids, software_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_software_installations_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_software_installations_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_software_installations_patch_with_http_info(command, current_step_id, authorization, x_request_id, software_installations, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_software_installations_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_software_installations_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_software_installations_post_with_http_info(software_ids, software_installations, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_software_installations_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
