...
from pypureclient.flasharray.FA_2_4.models.remote_pods_response import RemotePodsResponse
...
class RemotePodsApi:
    ...
    def api24_remote_pods_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_remote_pods_get_with_http_info(authorization, x_request_id, filter, ids, limit, names, offset, on, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api24_remote_pods_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
