...
class ReferenceNoId(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceNoId:
        """Create an instance of ReferenceNoId from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceNoId:
        """Create an instance of ReferenceNoId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReferenceNoId.parse_obj(obj)

        _obj = ReferenceNoId.construct(_fields_set=None, **{
            "name": obj.get("name")
        })
        return _obj
