...
class Volume(BaseModel):
    ...
    __properties = ["id", "name", "connection_count", "created", "destroyed", "host_encryption_key_status", "provisioned", "qos", "serial", "space", "time_remaining", "pod", "promotion_status", "requested_promotion_state", "source", "subtype", "volume_group"]
