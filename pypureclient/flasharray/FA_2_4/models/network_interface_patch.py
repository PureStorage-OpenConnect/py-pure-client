...
from pypureclient.flasharray.FA_2_4.models.networkinterfacepatch_eth import NetworkinterfacepatchEth
...
class NetworkInterfacePatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["enabled", "override_npiv_check", "eth"]
