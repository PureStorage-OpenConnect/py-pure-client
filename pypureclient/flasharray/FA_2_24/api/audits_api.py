...
class AuditsApi:
    ...
    def api224_audits_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api224_audits_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
