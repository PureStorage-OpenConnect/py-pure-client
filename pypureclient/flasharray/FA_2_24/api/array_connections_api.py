...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_24.models.array_connection_get_response import ArrayConnectionGetResponse
from pypureclient.flasharray.FA_2_24.models.array_connection_key_get_response import ArrayConnectionKeyGetResponse
from pypureclient.flasharray.FA_2_24.models.array_connection_path_get_response import ArrayConnectionPathGetResponse
from pypureclient.flasharray.FA_2_24.models.array_connection_post import ArrayConnectionPost
from pypureclient.flasharray.FA_2_24.models.array_connection_response import ArrayConnectionResponse
from pypureclient.flasharray.FA_2_24.models.throttle import Throttle
...
class ArrayConnectionsApi:
    ...
    def api224_array_connections_connection_key_get_with_http_info(
        ...
        _param = self._api224_array_connections_connection_key_get_serialize(
    ...
    def _api224_array_connections_connection_key_get_serialize(
        self,
        authorization,
        x_request_id,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.24/array-connections/connection-key',
    ...
    def api224_array_connections_delete_with_http_info(
        ...
        _param = self._api224_array_connections_delete_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api224_array_connections_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.24/array-connections',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api224_array_connections_get_with_http_info(
        ...
        _param = self._api224_array_connections_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api224_array_connections_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api224_array_connections_patch_with_http_info(
        ...
        _param = self._api224_array_connections_patch_serialize(
    ...
    def _api224_array_connections_patch_serialize(
        self,
        array_connection,
        authorization,
        x_request_id,
    ...
    def api224_array_connections_path_get_with_http_info(
        ...
        _param = self._api224_array_connections_path_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api224_array_connections_path_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.24/array-connections/path',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api224_array_connections_post_with_http_info(
        ...
        _param = self._api224_array_connections_post_serialize(
            array_connection = array_connection,
            authorization = authorization,
            x_request_id = x_request_id,
        )
    ...
    def _api224_array_connections_post_serialize(
        self,
        array_connection,
        authorization,
        x_request_id,
