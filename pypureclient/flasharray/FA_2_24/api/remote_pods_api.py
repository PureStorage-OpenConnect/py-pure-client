...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_24.models.remote_pods_response import RemotePodsResponse
...
class RemotePodsApi:
    ...
    def api224_remote_pods_get_with_http_info(
        ...
        _param = self._api224_remote_pods_get_serialize(
    ...
    def _api224_remote_pods_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.24/remote-pods',
