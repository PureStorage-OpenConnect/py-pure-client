...
from pypureclient.flasharray.FA_2_24.models.active_directory_get_response import ActiveDirectoryGetResponse
from pypureclient.flasharray.FA_2_24.models.active_directory_patch import ActiveDirectoryPatch
from pypureclient.flasharray.FA_2_24.models.active_directory_post import ActiveDirectoryPost
from pypureclient.flasharray.FA_2_24.models.active_directory_response import ActiveDirectoryResponse
...
class ActiveDirectoryApi:
    ...
    def api224_active_directory_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api224_active_directory_delete_with_http_info(names, authorization, x_request_id, local_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api224_active_directory_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api224_active_directory_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api224_active_directory_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_active_directory_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api224_active_directory_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api224_active_directory_patch_with_http_info(names, active_directory, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_active_directory_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api224_active_directory_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api224_active_directory_post_with_http_info(names, active_directory, authorization, x_request_id, join_existing_account, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_active_directory_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
