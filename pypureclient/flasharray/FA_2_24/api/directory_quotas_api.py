...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_24.models.directory_quotas_get_response import DirectoryQuotasGetResponse
...
class DirectoryQuotasApi:
    ...
    def api224_directory_quotas_get_with_http_info(
        ...
        _param = self._api224_directory_quotas_get_serialize(
    ...
    def _api224_directory_quotas_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.24/directory-quotas',
