...
from pypureclient.flasharray.FA_2_24.models.offload import Offload
...
class OffloadGetResponse(BaseModel):
    ...
    total: Optional[List[Offload]] = Field(default=None, description="The aggregate value of all items after filtering. If applicable, the average value is displayed instead. If applicable, the values are displayed for each field.")
