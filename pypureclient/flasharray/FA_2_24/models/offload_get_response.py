...
class OffloadGetResponse(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            items (list[Offload])
            total (list[Offload]): The aggregate value of all items after filtering. If applicable, the average value is displayed instead. If applicable, the values are displayed for each field.
        """
