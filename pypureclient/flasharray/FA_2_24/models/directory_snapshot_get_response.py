...
class DirectorySnapshotGetResponse(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            items (list[DirectorySnapshot]): Displays a list of all items after filtering. The values are displayed for each name, if applicable.
            total (list[DirectorySnapshot]): The aggregate value of all items after filtering. If applicable, the average value is displayed instead. The values are displayed for each field, if applicable.
        """
