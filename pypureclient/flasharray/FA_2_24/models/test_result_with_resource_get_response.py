...
class TestResultWithResourceGetResponse(BaseModel):
    ...
    items: Optional[List[TestResultWithResource]] = None
    __properties: ClassVar[List[str]] = ["total_item_count", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [TestResultWithResource.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
