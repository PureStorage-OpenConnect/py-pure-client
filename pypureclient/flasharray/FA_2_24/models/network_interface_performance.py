...
from pypureclient.flasharray.FA_2_24.models.network_interface_performance_eth import NetworkInterfacePerformanceEth
from pypureclient.flasharray.FA_2_24.models.network_interface_performance_fc import NetworkInterfacePerformanceFc
...
class NetworkInterfacePerformance(BaseModel):
    ...
    __properties = ["name", "eth", "fc", "interface_type", "time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkInterfacePerformance:
        """Create an instance of NetworkInterfacePerformance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkInterfacePerformance:
        """Create an instance of NetworkInterfacePerformance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkInterfacePerformance.parse_obj(obj)

        _obj = NetworkInterfacePerformance.construct(_fields_set=None, **{
            "name": obj.get("name"),
            "eth": NetworkInterfacePerformanceEth.from_dict(obj.get("eth")) if obj.get("eth") is not None else None,
            "fc": NetworkInterfacePerformanceFc.from_dict(obj.get("fc")) if obj.get("fc") is not None else None,
