...
from pypureclient.flasharray.common.models.app_get_response_v_2 import AppGetResponse
from pypureclient.flasharray.common.models.app_node_get_response_v_49 import AppNodeGetResponse
from pypureclient.flasharray.common.models.app_response_v_2 import AppResponse
from pypureclient.flasharray.common.models.app_v_2 import App
...
class AppsApi:
    ...
    def api251_apps_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        :rtype: tuple(AppGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api251_apps_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api251_apps_nodes_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(AppNodeGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_apps_nodes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the query parameters
        _query_params = []
        if _params.get('app_names') is not None:  # noqa: E501
            _query_params.append(('app_names', _params['app_names']))
            _collection_formats['app_names'] = 'csv'
        ...
        _response_types_map = {
            '200': "AppNodeGetResponse",
        }

        return self.api_client.call_api(
            '/api/2.51/apps/nodes', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api251_apps_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_apps_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
