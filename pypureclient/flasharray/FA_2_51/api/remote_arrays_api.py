...
from pypureclient.flasharray.common.models.remote_arrays_response_v_51 import RemoteArraysResponse
...
class RemoteArraysApi:
    ...
    def api251_remote_arrays_get_with_http_info(
        self,
