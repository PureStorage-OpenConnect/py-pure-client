...
from pypureclient.flasharray.common.models.alert_event_get_response_v_50 import AlertEventGetResponse
from pypureclient.flasharray.common.models.alert_get_response_v_51 import AlertGetResponse
from pypureclient.flasharray.common.models.alert_response_v_51 import AlertResponse
from pypureclient.flasharray.common.models.alert_rules_catalog_get_response_v_50 import AlertRulesCatalogGetResponse
from pypureclient.flasharray.common.models.alert_rules_get_response_v_50 import AlertRulesGetResponse
from pypureclient.flasharray.common.models.alert_rules_response_v_50 import AlertRulesResponse
from pypureclient.flasharray.common.models.alert_rules_v_50 import AlertRules
from pypureclient.flasharray.common.models.alert_v_51 import Alert
...
class AlertsApi:
    ...
    def api251_alerts_events_get_with_http_info(
        self,
    ...
    def api251_alerts_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
    ...
    def api251_alerts_patch_with_http_info(
        self,
        alert: Alert,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
    ...
    def api251_alerts_rules_catalog_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.51/alerts/rules/catalog', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api251_alerts_rules_delete_with_http_info(
        self,
    ...
    def api251_alerts_rules_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
    ...
    def api251_alerts_rules_patch_with_http_info(
        self,
        code: Annotated[StrictInt, Field(..., description="The alert code that the rule applies to. Available alert codes for customization can be found in the alert rules catalog.")],
        parameter: Annotated[StrictStr, Field(..., description="The parameter of the custom alert rule to modify. Values include `info` and `warning`. Available parameter values can be found in the alert rules catalog.")],
    ...
    def api251_alerts_rules_post_with_http_info(
        self,
        code: Annotated[StrictInt, Field(..., description="The alert code that the rule applies to. Available alert codes for customization can be found in the alert rules catalog.")],
        parameter: Annotated[StrictStr, Field(..., description="The parameter of the custom alert rule to modify. Values include `info` and `warning`. Available parameter values can be found in the alert rules catalog.")],
        alert_rule: AlertRules,
