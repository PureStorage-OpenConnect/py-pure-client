...
from pypureclient.flasharray.common.models.hardware_get_response_v_51 import HardwareGetResponse
from pypureclient.flasharray.common.models.hardware_patch_v_2 import HardwarePatch
from pypureclient.flasharray.common.models.hardware_response_v_51 import HardwareResponse
...
class HardwareApi:
    ...
    def api251_hardware_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api251_hardware_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api251_hardware_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_hardware_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
