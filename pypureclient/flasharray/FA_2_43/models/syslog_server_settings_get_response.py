...
class SyslogServerSettingsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SyslogServerSettings)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyslogServerSettingsGetResponse:
        """Create an instance of SyslogServerSettingsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SyslogServerSettingsGetResponse:
        """Create an instance of SyslogServerSettingsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyslogServerSettingsGetResponse.parse_obj(obj)

        _obj = SyslogServerSettingsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SyslogServerSettings.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
