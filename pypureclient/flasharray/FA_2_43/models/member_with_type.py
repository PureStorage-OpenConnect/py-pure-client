...
class MemberWithType(BaseModel):
    """
    MemberWithType
    """
    group: Optional[ReferenceWithType] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MemberWithType:
        """Create an instance of MemberWithType from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> MemberWithType:
        """Create an instance of MemberWithType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MemberWithType.parse_obj(obj)

        _obj = MemberWithType.construct(_fields_set=None, **{
