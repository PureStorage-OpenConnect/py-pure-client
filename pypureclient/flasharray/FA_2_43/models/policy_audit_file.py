...
class PolicyAuditFile(BaseModel):
    ...
    log_targets: Optional[conlist(ReferenceNoIdWithType)] = Field(default=None, description="A list of targets to which audit logs will be sent.")
    __properties = ["id", "name", "context", "destroyed", "enabled", "pod", "policy_type", "time_remaining", "log_targets"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyAuditFile:
        """Create an instance of PolicyAuditFile from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyAuditFile:
        """Create an instance of PolicyAuditFile from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyAuditFile.parse_obj(obj)

        _obj = PolicyAuditFile.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "log_targets": [ReferenceNoIdWithType.from_dict(_item) for _item in obj.get("log_targets")] if obj.get("log_targets") is not None else None
        })
        return _obj
