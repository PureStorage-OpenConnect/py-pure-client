...
from pypureclient.flasharray.FA_2_43.models.log_target_file import LogTargetFile


class LogTargetFileGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(LogTargetFile)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogTargetFileGetResponse:
        """Create an instance of LogTargetFileGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LogTargetFileGetResponse:
        """Create an instance of LogTargetFileGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogTargetFileGetResponse.parse_obj(obj)

        _obj = LogTargetFileGetResponse.construct(_fields_set=None, **{
            ...
            "items": [LogTargetFile.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
