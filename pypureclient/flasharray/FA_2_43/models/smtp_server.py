...
class SmtpServer(BaseModel):
    ...
    body_prefix: Optional[constr(strict=True, max_length=256)] = Field(default=None, description="Optional string added to the beginning of the email body when sending alert email messages. HTML tags are not allowed.")
    ...
    subject_prefix: Optional[constr(strict=True, max_length=64)] = Field(default=None, description="Optional string added to the beginning of the subject when sending alert email messages. HTML tags are not allowed.")
    user_name: Optional[StrictStr] = Field(default=None, description="User name for the relay host, if needed.")
    __properties = ["name", "body_prefix", "encryption_mode", "password", "relay_host", "sender_domain", "sender_username", "subject_prefix", "user_name"]
