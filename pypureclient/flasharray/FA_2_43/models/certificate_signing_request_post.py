...
from pypureclient.flasharray.FA_2_43.models.reference_no_id import ReferenceNoId
...
class CertificateSigningRequestPost(BaseModel):
    ...
    subject_alternative_names: Optional[conlist(StrictStr)] = Field(default=None, description="The alternative names that are secured by this certificate. Alternative names include IP addresses, DNS names, or URIs.")
