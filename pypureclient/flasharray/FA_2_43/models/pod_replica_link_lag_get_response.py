...
from pypureclient.flasharray.FA_2_43.models.pod_replica_link_lag import PodReplicaLinkLag


class PodReplicaLinkLagGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PodReplicaLinkLag)] = Field(default=None, description="A list of pod replica link lag objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PodReplicaLinkLagGetResponse:
        """Create an instance of PodReplicaLinkLagGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PodReplicaLinkLagGetResponse:
        """Create an instance of PodReplicaLinkLagGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PodReplicaLinkLagGetResponse.parse_obj(obj)

        _obj = PodReplicaLinkLagGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PodReplicaLinkLag.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
