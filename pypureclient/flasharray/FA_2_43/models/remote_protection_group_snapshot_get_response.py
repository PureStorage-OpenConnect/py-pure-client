...
from pypureclient.flasharray.FA_2_43.models.remote_protection_group_snapshot import RemoteProtectionGroupSnapshot


class RemoteProtectionGroupSnapshotGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(RemoteProtectionGroupSnapshot)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoteProtectionGroupSnapshotGetResponse:
        """Create an instance of RemoteProtectionGroupSnapshotGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RemoteProtectionGroupSnapshotGetResponse:
        """Create an instance of RemoteProtectionGroupSnapshotGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoteProtectionGroupSnapshotGetResponse.parse_obj(obj)

        _obj = RemoteProtectionGroupSnapshotGetResponse.construct(_fields_set=None, **{
            ...
            "items": [RemoteProtectionGroupSnapshot.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
