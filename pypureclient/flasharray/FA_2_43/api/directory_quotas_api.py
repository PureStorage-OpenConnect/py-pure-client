...
from pypureclient.flasharray.common.models.directory_quotas_get_response_v_42 import DirectoryQuotasGetResponse
...
class DirectoryQuotasApi:
    ...
    def api243_directory_quotas_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api243_directory_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
