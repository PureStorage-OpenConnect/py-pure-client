...
from pypureclient.flasharray.FA_2_43.models.subnet_get_response import SubnetGetResponse
from pypureclient.flasharray.FA_2_43.models.subnet_patch import SubnetPatch
from pypureclient.flasharray.FA_2_43.models.subnet_post import SubnetPost
from pypureclient.flasharray.FA_2_43.models.subnet_response import SubnetResponse
from typing import Optional
...
class SubnetsApi:
    ...
    def api243_subnets_delete_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api243_subnets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api243_subnets_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api243_subnets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api243_subnets_patch_with_http_info(
        self,
        subnet: SubnetPatch,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api243_subnets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api243_subnets_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api243_subnets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
