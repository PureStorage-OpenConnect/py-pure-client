...
from pypureclient.flasharray.FA_2_43.models.maintenance_window_post import MaintenanceWindowPost
from pypureclient.flasharray.FA_2_43.models.maintenance_windows_get_response import MaintenanceWindowsGetResponse
from pypureclient.flasharray.FA_2_43.models.maintenance_windows_response import MaintenanceWindowsResponse
from typing import Optional
...
class MaintenanceWindowsApi:
    ...
    def api243_maintenance_windows_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api243_maintenance_windows_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.43/maintenance-windows', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api243_maintenance_windows_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api243_maintenance_windows_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.43/maintenance-windows', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api243_maintenance_windows_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api243_maintenance_windows_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.43/maintenance-windows', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
