...
from pypureclient.flasharray.FA_2_43.models.remote_pods_response import RemotePodsResponse
from typing import Optional
...
class RemotePodsApi:
    ...
    def api243_remote_pods_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api243_remote_pods_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
