...
class Arrays(BaseModel):
    ...
    capacity: Optional[StrictInt] = Field(default=None, description="Usable capacity in bytes. If the user does not have sufficient access, this field will return `null`.")
    ...
    idle_timeout: Optional[StrictInt] = Field(default=None, description="Idle timeout in milliseconds. Valid values are `0` and any multiple of 60000 in the range of 300000 and 10800000. Any other values will be rounded down to the nearest multiple of 60000.")
    ...
    os: Optional[StrictStr] = Field(default=None, description="Valid values are `Purity`, `Purity//FA`, and `Purity//FB`.")
    ...
    scsi_timeout: Optional[StrictInt] = Field(default=None, description="The SCSI timeout. This value defaults to 60s if it is not specified. If the user does not have sufficient access, this field will return `null`.")
    space: Optional[Space] = None
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "name", "banner", "capacity", "console_lock_enabled", "idle_timeout", "ntp_servers", "os", "parity", "scsi_timeout", "space", "version"]
