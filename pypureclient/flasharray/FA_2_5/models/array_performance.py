...
class ArrayPerformance(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayPerformance:
        """Create an instance of ArrayPerformance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayPerformance:
        """Create an instance of ArrayPerformance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayPerformance.parse_obj(obj)
