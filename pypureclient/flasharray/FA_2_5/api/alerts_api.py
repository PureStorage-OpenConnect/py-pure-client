...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_5.models.alert import Alert
from pypureclient.flasharray.FA_2_5.models.alert_event_get_response import AlertEventGetResponse
from pypureclient.flasharray.FA_2_5.models.alert_get_response import AlertGetResponse
from pypureclient.flasharray.FA_2_5.models.alert_response import AlertResponse
...
class AlertsApi:
    ...
    def api25_alerts_events_get_with_http_info(
        ...
        _param = self._api25_alerts_events_get_serialize(
    ...
    def _api25_alerts_events_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.5/alerts/events',
    ...
    def api25_alerts_get_with_http_info(
        ...
        _param = self._api25_alerts_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api25_alerts_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api25_alerts_patch_with_http_info(
        ...
        _param = self._api25_alerts_patch_serialize(
            alert = alert,
            authorization = authorization,
            x_request_id = x_request_id,
            ids = ids,
    ...
    def _api25_alerts_patch_serialize(
        self,
        alert,
        authorization,
        x_request_id,
