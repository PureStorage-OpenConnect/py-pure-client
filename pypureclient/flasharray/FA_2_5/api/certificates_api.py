...
class CertificatesApi:
    ...
    def api25_certificates_certificate_signing_requests_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_certificates_certificate_signing_requests_post_with_http_info(certificate, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api25_certificates_certificate_signing_requests_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_certificates_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_certificates_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_certificates_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_certificates_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_certificates_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_certificates_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_certificates_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_certificates_patch_with_http_info(certificate, authorization, x_request_id, generate_new_key, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_certificates_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_certificates_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_certificates_post_with_http_info(certificate, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_certificates_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
