...
class SubnetsApi:
    ...
    def api25_subnets_delete_with_http_info(
        ...
        _param = self._api25_subnets_delete_serialize(
    ...
    def _api25_subnets_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
    ...
    def api25_subnets_get_with_http_info(
        ...
        _param = self._api25_subnets_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api25_subnets_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api25_subnets_patch_with_http_info(
        ...
        _param = self._api25_subnets_patch_serialize(
            subnet = subnet,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api25_subnets_patch_serialize(
        self,
        subnet,
        authorization,
        x_request_id,
    ...
    def api25_subnets_post_with_http_info(
        ...
        _param = self._api25_subnets_post_serialize(
            names = names,
            subnet = subnet,
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api25_subnets_post_serialize(
        self,
        names,
        subnet,
        authorization,
