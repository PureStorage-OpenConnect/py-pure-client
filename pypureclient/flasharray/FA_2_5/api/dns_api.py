...
from pypureclient.flasharray.FA_2_5.models.dns_get_response import DnsGetResponse
from pypureclient.flasharray.FA_2_5.models.dns_patch import DnsPatch
from pypureclient.flasharray.FA_2_5.models.dns_response import DnsResponse
...
class DNSApi:
    ...
    def api25_dns_get_with_http_info(
        ...
        **kwargs
        ...
        Displays the current DNS parameters of the array, including domain suffix and name servers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api25_dns_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api25_dns_patch_with_http_info(
        ...
        **kwargs
        ...
        Modifies the DNS parameters of an array, including the domain suffix and the list of DNS name server IP addresses.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api25_dns_patch_with_http_info(dns, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_dns_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
