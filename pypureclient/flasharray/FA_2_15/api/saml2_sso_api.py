...
class SAML2SSOApi:
    ...
    def api215_sso_saml2_idps_test_get_with_http_info(
        ...
        _param = self._api215_sso_saml2_idps_test_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api215_sso_saml2_idps_test_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/sso/saml2/idps/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api215_sso_saml2_idps_test_patch_with_http_info(
        ...
        _param = self._api215_sso_saml2_idps_test_patch_serialize(
            idp = idp,
            authorization = authorization,
            x_request_id = x_request_id,
            ids = ids,
    ...
    def _api215_sso_saml2_idps_test_patch_serialize(
        self,
        idp,
        authorization,
        x_request_id,
