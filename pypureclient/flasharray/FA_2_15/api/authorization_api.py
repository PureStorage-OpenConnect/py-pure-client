...
class AuthorizationApi:
    ...
    def api215_login_post_with_http_info(
        ...
        _param = self._api215_login_post_serialize(
    ...
    def _api215_login_post_serialize(
        self,
        x_request_id,
        api_token,
    ) -> RequestSerialized:
    ...
    def api215_logout_post_with_http_info(
        ...
        _param = self._api215_logout_post_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_logout_post_serialize(
        self,
        x_request_id,
        x_auth_token,
    ) -> RequestSerialized:
