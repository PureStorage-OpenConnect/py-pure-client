...
class NetworkInterfacesApi:
    ...
    def api215_network_interfaces_performance_get_with_http_info(
        ...
        _param = self._api215_network_interfaces_performance_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            end_time = end_time,
    ...
    def _api215_network_interfaces_performance_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/network-interfaces/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
