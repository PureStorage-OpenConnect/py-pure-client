...
from pypureclient.flasharray.FA_2_15.models.priority_adjustment import PriorityAdjustment
from pypureclient.flasharray.FA_2_15.models.qos import Qos
from pypureclient.flasharray.FA_2_15.models.space import Space
...
class VolumeGroup(BaseModel):
    ...
    __properties = ["id", "name", "destroyed", "priority_adjustment", "qos", "space", "time_remaining", "volume_count"]
