...
class ProtectionGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "destroyed", "host_count", "host_group_count", "is_local", "pod", "replication_schedule", "snapshot_schedule", "source", "source_retention", "space", "target_retention", "target_count", "time_remaining", "volume_count", "eradication_config", "retention_lock"]
