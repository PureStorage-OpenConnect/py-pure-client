...
from pypureclient.flasharray.FA_2_15.models.fixed_reference import FixedReference
from pypureclient.flasharray.FA_2_15.models.pod_array_status import PodArrayStatus
from pypureclient.flasharray.FA_2_15.models.pod_eradication_config import PodEradicationConfig
...
class Pod(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "arrays", "destroyed", "failover_preferences", "footprint", "mediator", "mediator_version", "source", "space", "time_remaining", "requested_promotion_state", "promotion_status", "link_source_count", "link_target_count", "array_count", "eradication_config"]
