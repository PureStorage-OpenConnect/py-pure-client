...
from pypureclient.flasharray.FA_2_15.models.directory import Directory
...
class DirectoryGetResponse(BaseModel):
    ...
    items: Optional[conlist(Directory)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    total: Optional[conlist(Directory)] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field, if meaningful.")
