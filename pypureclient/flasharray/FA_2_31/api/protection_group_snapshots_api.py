...
from pypureclient.flasharray.FA_2_31.models.protection_group_snapshot_get_response import ProtectionGroupSnapshotGetResponse
from pypureclient.flasharray.FA_2_31.models.protection_group_snapshot_patch import ProtectionGroupSnapshotPatch
from pypureclient.flasharray.FA_2_31.models.protection_group_snapshot_post import ProtectionGroupSnapshotPost
from pypureclient.flasharray.FA_2_31.models.protection_group_snapshot_replica_response import ProtectionGroupSnapshotReplicaResponse
from pypureclient.flasharray.FA_2_31.models.protection_group_snapshot_response import ProtectionGroupSnapshotResponse
from pypureclient.flasharray.FA_2_31.models.protection_group_snapshot_transfer_get_response import ProtectionGroupSnapshotTransferGetResponse
...
class ProtectionGroupSnapshotsApi:
    ...
    def api231_protection_group_snapshots_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_protection_group_snapshots_delete_with_http_info(authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api231_protection_group_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_protection_group_snapshots_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_protection_group_snapshots_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, ids, limit, names, offset, sort, source_ids, source_names, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_protection_group_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_protection_group_snapshots_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_protection_group_snapshots_patch_with_http_info(protection_group_snapshot, authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_protection_group_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_protection_group_snapshots_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_protection_group_snapshots_post_with_http_info(authorization, x_request_id, allow_throttle, apply_retention, for_replication, replicate, replicate_now, source_ids, source_names, protection_group_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_protection_group_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_protection_group_snapshots_replica_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_protection_group_snapshots_replica_post_with_http_info(authorization, x_request_id, convert_source_to_baseline, ids, names, on, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_protection_group_snapshots_replica_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_protection_group_snapshots_test_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_protection_group_snapshots_test_post_with_http_info(authorization, x_request_id, allow_throttle, apply_retention, for_replication, replicate, replicate_now, source_ids, source_names, protection_group_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_protection_group_snapshots_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_protection_group_snapshots_transfer_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_protection_group_snapshots_transfer_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, ids, limit, names, offset, sort, source_ids, source_names, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_protection_group_snapshots_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
