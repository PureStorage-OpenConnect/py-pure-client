...
from pypureclient.flasharray.FA_2_31.models.subnet_get_response import SubnetGetResponse
from pypureclient.flasharray.FA_2_31.models.subnet_patch import SubnetPatch
from pypureclient.flasharray.FA_2_31.models.subnet_post import SubnetPost
from pypureclient.flasharray.FA_2_31.models.subnet_response import SubnetResponse
...
class SubnetsApi:
    ...
    def api231_subnets_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_subnets_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api231_subnets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_subnets_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_subnets_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_subnets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_subnets_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_subnets_patch_with_http_info(subnet, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_subnets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_subnets_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_subnets_post_with_http_info(names, subnet, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_subnets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
