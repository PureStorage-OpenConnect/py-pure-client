...
from pypureclient.flasharray.FA_2_31.models.member_response import MemberResponse
from pypureclient.flasharray.FA_2_31.models.pod_get_response import PodGetResponse
from pypureclient.flasharray.FA_2_31.models.pod_patch import PodPatch
from pypureclient.flasharray.FA_2_31.models.pod_performance_by_array_get_response import PodPerformanceByArrayGetResponse
from pypureclient.flasharray.FA_2_31.models.pod_performance_get_response import PodPerformanceGetResponse
from pypureclient.flasharray.FA_2_31.models.pod_performance_replication_by_array_get_response import PodPerformanceReplicationByArrayGetResponse
from pypureclient.flasharray.FA_2_31.models.pod_performance_replication_get_response import PodPerformanceReplicationGetResponse
from pypureclient.flasharray.FA_2_31.models.pod_post import PodPost
from pypureclient.flasharray.FA_2_31.models.pod_response import PodResponse
from pypureclient.flasharray.FA_2_31.models.resource_pod_space_get_response import ResourcePodSpaceGetResponse
...
class PodsApi:
    ...
    def api231_pods_arrays_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_pods_arrays_delete_with_http_info(authorization, x_request_id, group_ids, group_names, member_ids, member_names, with_unknown, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api231_pods_arrays_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_pods_arrays_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_pods_arrays_get_with_http_info(authorization, x_request_id, filter, group_ids, group_names, limit, member_ids, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_pods_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_pods_arrays_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_pods_arrays_post_with_http_info(authorization, x_request_id, group_ids, group_names, member_ids, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_pods_arrays_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_pods_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_pods_delete_with_http_info(authorization, x_request_id, eradicate_contents, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_pods_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_pods_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_pods_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, ids, limit, names, offset, sort, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_pods_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_pods_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_pods_patch_with_http_info(pod, authorization, x_request_id, abort_quiesce, destroy_contents, ids, names, promote_from, quiesce, skip_quiesce, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_pods_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_pods_performance_by_array_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_pods_performance_by_array_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, protocol, protocol_group, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_pods_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_pods_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_pods_performance_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, protocol, protocol_group, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_pods_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_pods_performance_replication_by_array_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_pods_performance_replication_by_array_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_pods_performance_replication_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_pods_performance_replication_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_pods_performance_replication_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_pods_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_pods_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_pods_post_with_http_info(pod, authorization, x_request_id, allow_throttle, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_pods_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_pods_space_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_pods_space_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_pods_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_pods_test_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_pods_test_post_with_http_info(pod, authorization, x_request_id, allow_throttle, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_pods_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
