...
class AuthorizationApi:
    ...
    def api231_login_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_login_post_with_http_info(api_token, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api231_login_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_logout_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_logout_post_with_http_info(x_auth_token, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_logout_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
