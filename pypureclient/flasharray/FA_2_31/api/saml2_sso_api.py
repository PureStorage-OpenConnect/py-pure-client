...
from pypureclient.flasharray.FA_2_31.models.saml2_sso_get_response import Saml2SsoGetResponse
from pypureclient.flasharray.FA_2_31.models.saml2_sso_patch import Saml2SsoPatch
from pypureclient.flasharray.FA_2_31.models.saml2_sso_post import Saml2SsoPost
from pypureclient.flasharray.FA_2_31.models.saml2_sso_response import Saml2SsoResponse
from pypureclient.flasharray.FA_2_31.models.test_result_with_resource_patch_response import TestResultWithResourcePatchResponse
...
class SAML2SSOApi:
    ...
    def api231_sso_saml2_idps_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_sso_saml2_idps_delete_with_http_info(authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api231_sso_saml2_idps_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_sso_saml2_idps_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_sso_saml2_idps_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_sso_saml2_idps_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_sso_saml2_idps_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_sso_saml2_idps_patch_with_http_info(idp, authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_sso_saml2_idps_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_sso_saml2_idps_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_sso_saml2_idps_post_with_http_info(names, idp, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_sso_saml2_idps_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_sso_saml2_idps_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_sso_saml2_idps_test_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_sso_saml2_idps_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api231_sso_saml2_idps_test_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api231_sso_saml2_idps_test_patch_with_http_info(idp, authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api231_sso_saml2_idps_test_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
