...
class RemotePod(BaseModel):
    ...
    arrays: Optional[Annotated[List[Resource], Field(min_length=1)]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "arrays"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "arrays": [Resource.from_dict(_item) for _item in obj["arrays"]] if obj.get("arrays") is not None else None
        })
        return _obj
