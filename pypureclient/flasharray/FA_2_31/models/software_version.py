...
class SoftwareVersion(BaseModel):
    ...
    upgrade_hops: Optional[List[StrictStr]] = Field(default=None, description="The list of software versions the upgrade will go through.")
    version: Optional[StrictStr] = Field(default=None, description="The version of the software.")
    __properties: ClassVar[List[str]] = ["details", "name", "release_family", "upgrade_hops", "version"]
