...
class DirectoryServiceRole(BaseModel):
    ...
    group: Optional[StrictStr] = Field(default=None, description="A group name that contains users with the authority level of the specified role.")
    ...
    role: Optional[ReferenceNoId] = Field(default=None, description="A reference to the role to be assigned. Can be any role that exists on the system.")
    __properties = ["name", "group", "group_base", "role"]
