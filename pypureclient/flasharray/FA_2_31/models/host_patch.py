...
class HostPatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "add_iqns", "add_nqns", "add_wwns", "chap", "host_group", "iqns", "nqns", "personality", "preferred_arrays", "remove_iqns", "remove_nqns", "remove_wwns", "wwns", "vlan"]
