...
class PolicyRuleSmbClientGetResponse(BaseModel):
    ...
    items: Optional[List[PolicyRuleSmbClient]] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name, if meaningful.")
