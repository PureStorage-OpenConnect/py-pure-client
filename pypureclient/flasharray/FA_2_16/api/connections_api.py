...
from pypureclient.flasharray.FA_2_16.models.connection_get_response import ConnectionGetResponse
from pypureclient.flasharray.FA_2_16.models.connection_post import ConnectionPost
from pypureclient.flasharray.FA_2_16.models.connection_response import ConnectionResponse
...
class ConnectionsApi:
    ...
    def api216_connections_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_connections_delete_with_http_info(authorization, x_request_id, host_group_names, host_names, volume_ids, volume_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api216_connections_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api216_connections_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_connections_get_with_http_info(authorization, x_request_id, continuation_token, filter, host_group_names, host_names, limit, offset, protocol_endpoint_ids, protocol_endpoint_names, sort, total_item_count, volume_ids, volume_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_connections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api216_connections_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_connections_post_with_http_info(authorization, x_request_id, host_group_names, host_names, volume_ids, volume_names, connection, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_connections_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
