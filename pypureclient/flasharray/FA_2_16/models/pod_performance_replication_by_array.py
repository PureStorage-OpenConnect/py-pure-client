...
from pypureclient.flasharray.FA_2_16.models.replication_performance_with_total import ReplicationPerformanceWithTotal
from pypureclient.flasharray.FA_2_16.models.resource import Resource
...
class PodPerformanceReplicationByArray(BaseModel):
    ...
    __properties = ["continuous_bytes_per_sec", "periodic_bytes_per_sec", "pod", "resync_bytes_per_sec", "sync_bytes_per_sec", "time", "total_bytes_per_sec", "array"]
