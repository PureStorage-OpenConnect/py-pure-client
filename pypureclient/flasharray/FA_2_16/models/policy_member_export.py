...
from pypureclient.flasharray.FA_2_16.models.fixed_reference_with_type import FixedReferenceWithType
...
class PolicyMemberExport(BaseModel):
    ...
    __properties = ["destroyed", "enabled", "member", "policy", "export_name"]
