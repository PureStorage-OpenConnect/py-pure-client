...
class PolicyPost(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyPost:
        """Create an instance of PolicyPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyPost:
        """Create an instance of PolicyPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyPost.parse_obj(obj)

        _obj = PolicyPost.construct(_fields_set=None, **{
