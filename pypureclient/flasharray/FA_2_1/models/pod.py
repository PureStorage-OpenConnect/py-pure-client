...
from pypureclient.flasharray.FA_2_1.models.pod_array_status import PodArrayStatus
...
class Pod(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "arrays", "destroyed", "failover_preferences", "footprint", "mediator", "mediator_version", "source", "space", "time_remaining"]
