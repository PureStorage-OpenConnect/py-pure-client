...
class ProtectionGroupSnapshotGetResponse(object):
    ...
    def __init__(self, **kwargs):
        ...
        Keyword args:
            ...
            items (list[ProtectionGroupSnapshot]): Returns a list of all items after filtering. The values are displayed for each name where meaningful.
            total (list[ProtectionGroupSnapshot]): The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field where meaningful.
        """
        for arg in kwargs:
