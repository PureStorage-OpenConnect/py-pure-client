...
class VolumeGroupPerformance(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VolumeGroupPerformance:
        """Create an instance of VolumeGroupPerformance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VolumeGroupPerformance:
        """Create an instance of VolumeGroupPerformance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VolumeGroupPerformance.parse_obj(obj)

        _obj = VolumeGroupPerformance.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
