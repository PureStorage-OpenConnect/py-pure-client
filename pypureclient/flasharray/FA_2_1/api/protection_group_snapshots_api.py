...
class ProtectionGroupSnapshotsApi(object):
    ...
    def api21_protection_group_snapshots_delete(self, **kwargs):
        ...
        >>> thread = api.api21_protection_group_snapshots_delete(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api21_protection_group_snapshots_delete_with_http_info(**kwargs)
        else:
            (data) = self.api21_protection_group_snapshots_delete_with_http_info(**kwargs)
            return data

    def api21_protection_group_snapshots_delete_with_http_info(self, **kwargs):
        """Eradicate a protection group snapshot
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api21_protection_group_snapshots_delete" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def api21_protection_group_snapshots_get(self, **kwargs):
        """List protection group snapshots

        Returns a list of protection group snapshots, including those pending eradication.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_protection_group_snapshots_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api21_protection_group_snapshots_get_with_http_info(**kwargs)
        else:
            (data) = self.api21_protection_group_snapshots_get_with_http_info(**kwargs)
            return data

    def api21_protection_group_snapshots_get_with_http_info(self, **kwargs):
        """List protection group snapshots
        ...
        all_params = ['continuation_token', 'destroyed', 'filter', 'limit', 'names', 'offset', 'sort', 'source_names', 'total_item_count', 'total_only']
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_protection_group_snapshots_get" % key
                )
            params[key] = val
        del params['kwargs']

        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api21_protection_group_snapshots_get`, must be a value greater than or equal to `1`")
    ...
    def api21_protection_group_snapshots_patch(self, protection_group_snapshot, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_protection_group_snapshots_patch(protection_group_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api21_protection_group_snapshots_patch_with_http_info(protection_group_snapshot, **kwargs)
        else:
            (data) = self.api21_protection_group_snapshots_patch_with_http_info(protection_group_snapshot, **kwargs)
            return data

    def api21_protection_group_snapshots_patch_with_http_info(self, protection_group_snapshot, **kwargs):
        """Manage a protection group snapshot
        ...
        all_params = ['protection_group_snapshot', 'names']
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_protection_group_snapshots_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'protection_group_snapshot' is set
        if ('protection_group_snapshot' not in params or
                params['protection_group_snapshot'] is None):
            raise ValueError("Missing the required parameter `protection_group_snapshot` when calling `api21_protection_group_snapshots_patch`")
    ...
    def api21_protection_group_snapshots_post(self, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_protection_group_snapshots_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api21_protection_group_snapshots_post_with_http_info(**kwargs)
        else:
            (data) = self.api21_protection_group_snapshots_post_with_http_info(**kwargs)
            return data

    def api21_protection_group_snapshots_post_with_http_info(self, **kwargs):
        """Generate a protection group snapshot
        ...
        all_params = ['apply_retention', 'source_names', 'protection_group_snapshot']
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_protection_group_snapshots_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def api21_protection_group_snapshots_transfer_get(self, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_protection_group_snapshots_transfer_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api21_protection_group_snapshots_transfer_get_with_http_info(**kwargs)
        else:
            (data) = self.api21_protection_group_snapshots_transfer_get_with_http_info(**kwargs)
            return data

    def api21_protection_group_snapshots_transfer_get_with_http_info(self, **kwargs):
        """List protection group snapshots with transfer statistics
        ...
        all_params = ['destroyed', 'filter', 'limit', 'names', 'offset', 'sort', 'source_names', 'total_item_count', 'total_only']
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_protection_group_snapshots_transfer_get" % key
                )
            params[key] = val
        del params['kwargs']

        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api21_protection_group_snapshots_transfer_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
