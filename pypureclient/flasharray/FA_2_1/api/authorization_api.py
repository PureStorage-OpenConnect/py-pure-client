...
class AuthorizationApi:
    ...
    def api21_login_post_with_http_info(
        ...
        _param = self._api21_login_post_serialize(
    ...
    def _api21_login_post_serialize(
        self,
        x_request_id,
        api_token,
    ) -> RequestSerialized:
    ...
    def api21_logout_post_with_http_info(
        ...
        _param = self._api21_logout_post_serialize(
            x_request_id = x_request_id,
    ...
    def _api21_logout_post_serialize(
        self,
        x_request_id,
        x_auth_token,
    ) -> RequestSerialized:
