...
class OffloadsApi(object):
    ...
    def api21_offloads_delete(self, **kwargs):
        ...
        if kwargs.get('async_req'):
            return self.api21_offloads_delete_with_http_info(**kwargs)
        else:
            (data) = self.api21_offloads_delete_with_http_info(**kwargs)
            return data

    def api21_offloads_delete_with_http_info(self, **kwargs):
        """Disconnect from an offload target
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api21_offloads_delete" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def api21_offloads_get(self, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api21_offloads_get_with_http_info(**kwargs)
        else:
            (data) = self.api21_offloads_get_with_http_info(**kwargs)
            return data

    def api21_offloads_get_with_http_info(self, **kwargs):
        """List offload targets
        ...
        all_params = ['filter', 'limit', 'names', 'offset', 'protocol', 'sort', 'total_item_count', 'total_only']
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_offloads_get" % key
                )
            params[key] = val
        del params['kwargs']

        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api21_offloads_get`, must be a value greater than or equal to `1`")
    ...
    def api21_offloads_post(self, offload, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_offloads_post(offload, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api21_offloads_post_with_http_info(offload, **kwargs)
        else:
            (data) = self.api21_offloads_post_with_http_info(offload, **kwargs)
            return data

    def api21_offloads_post_with_http_info(self, offload, **kwargs):
        """Connect to an offload target
        ...
        all_params = ['offload', 'initialize', 'names']
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_offloads_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'offload' is set
        if ('offload' not in params or
                params['offload'] is None):
            raise ValueError("Missing the required parameter `offload` when calling `api21_offloads_post`")
