...
from pypureclient.flasharray.FA_2_25.models.directory import Directory
...
class DirectoryGetResponse(BaseModel):
    ...
    total: Optional[List[Directory]] = Field(default=None, description="The aggregate value of all items after filtering. If applicable, the average value is displayed instead. The values are displayed for each field, if applicable.")
