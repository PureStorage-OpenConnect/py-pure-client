...
class SnapshotSpace(BaseModel):
    ...
    snapshots_effective: Optional[conint(strict=True, ge=0)] = Field(default=None, description="Deprecated. The effective space contributed by data unique to one or more snapshots, measured in bytes. Please use the `snapshots` field in the future, as it contains the same information for Evergreen//One arrays.")
    __properties = ["data_reduction", "shared", "snapshots", "system", "thin_provisioning", "total_physical", "total_provisioned", "total_reduction", "unique", "used_provisioned", "virtual", "snapshots_effective"]
