...
class HostGroupGetResponse(BaseModel):
    ...
    items: Optional[List[HostGroup]] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name, if applicable.")
