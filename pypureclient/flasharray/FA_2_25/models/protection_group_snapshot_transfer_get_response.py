...
from pypureclient.flasharray.FA_2_25.models.protection_group_snapshot_transfer import ProtectionGroupSnapshotTransfer
...
class ProtectionGroupSnapshotTransferGetResponse(BaseModel):
    ...
    items: Optional[conlist(ProtectionGroupSnapshotTransfer)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful.")
    total: Optional[conlist(ProtectionGroupSnapshotTransfer)] = Field(default=None, description="The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field where meaningful.")
