...
class ActiveDirectoryApi(object):
    ...
    def api225_active_directory_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api225_active_directory_patch_with_http_info(active_directory, names, async_req=True)
        >>> result = thread.get()
    ...
    def api225_active_directory_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api225_active_directory_post_with_http_info(active_directory, names, async_req=True)
        >>> result = thread.get()
