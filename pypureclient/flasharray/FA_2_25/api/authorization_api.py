...
class AuthorizationApi:
    ...
    def api225_login_post_with_http_info(
        ...
        _param = self._api225_login_post_serialize(
    ...
    def _api225_login_post_serialize(
        self,
        x_request_id,
        api_token,
    ) -> RequestSerialized:
    ...
    def api225_logout_post_with_http_info(
        ...
        _param = self._api225_logout_post_serialize(
            x_request_id = x_request_id,
    ...
    def _api225_logout_post_serialize(
        self,
        x_request_id,
        x_auth_token,
    ) -> RequestSerialized:
