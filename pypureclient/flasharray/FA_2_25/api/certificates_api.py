...
from pypureclient.flasharray.FA_2_25.models.certificate_get_response import CertificateGetResponse
from pypureclient.flasharray.FA_2_25.models.certificate_post import CertificatePost
from pypureclient.flasharray.FA_2_25.models.certificate_response import CertificateResponse
from pypureclient.flasharray.FA_2_25.models.certificate_signing_request_post import CertificateSigningRequestPost
from pypureclient.flasharray.FA_2_25.models.certificate_signing_request_response import CertificateSigningRequestResponse
...
class CertificatesApi:
    ...
    def api225_certificates_certificate_signing_requests_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api225_certificates_certificate_signing_requests_post_with_http_info(certificate, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api225_certificates_certificate_signing_requests_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api225_certificates_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api225_certificates_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_certificates_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api225_certificates_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api225_certificates_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_certificates_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api225_certificates_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api225_certificates_patch_with_http_info(certificate, authorization, x_request_id, generate_new_key, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_certificates_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api225_certificates_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api225_certificates_post_with_http_info(certificate, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_certificates_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
