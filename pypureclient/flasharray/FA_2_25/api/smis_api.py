...
class SMISApi:
    ...
    def api225_smi_s_get_with_http_info(
        ...
        _param = self._api225_smi_s_get_serialize(
    ...
    def _api225_smi_s_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
    ...
    def api225_smi_s_patch_with_http_info(
        ...
        _param = self._api225_smi_s_patch_serialize(
            smi_s = smi_s,
            authorization = authorization,
            x_request_id = x_request_id,
        )
    ...
    def _api225_smi_s_patch_serialize(
        self,
        smi_s,
        authorization,
        x_request_id,
