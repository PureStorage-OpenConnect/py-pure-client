...
from pypureclient.flasharray.FA_2_7.models.dns_get_response import DnsGetResponse
from pypureclient.flasharray.FA_2_7.models.dns_patch import DnsPatch
from pypureclient.flasharray.FA_2_7.models.dns_response import DnsResponse
...
class DNSApi:
    ...
    def api27_dns_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_dns_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api27_dns_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_dns_patch_with_http_info(dns, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
