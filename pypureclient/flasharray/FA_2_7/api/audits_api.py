...
from pypureclient.flasharray.FA_2_7.models.audit_get_response import AuditGetResponse
...
class AuditsApi:
    ...
    def api27_audits_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_audits_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api27_audits_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
