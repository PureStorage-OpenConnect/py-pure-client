...
from pypureclient.flasharray.FA_2_7.models.member_get_response import MemberGetResponse
from pypureclient.flasharray.FA_2_7.models.resource_performance_get_response import ResourcePerformanceGetResponse
from pypureclient.flasharray.FA_2_7.models.resource_space_get_response import ResourceSpaceGetResponse
from pypureclient.flasharray.FA_2_7.models.volume_group import VolumeGroup
from pypureclient.flasharray.FA_2_7.models.volume_group_get_response import VolumeGroupGetResponse
from pypureclient.flasharray.FA_2_7.models.volume_group_post import VolumeGroupPost
from pypureclient.flasharray.FA_2_7.models.volume_group_response import VolumeGroupResponse
...
class VolumeGroupsApi:
    ...
    def api27_volume_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        Deletes a volume group that has been destroyed and is pending eradication. Eradicated volume groups cannot be recovered. Volume groups are destroyed through the PATCH method. The `ids` or `names` parameter is required, but cannot be set together.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api27_volume_groups_delete_with_http_info(authorization, x_request_id, eradicate_contents, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api27_volume_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_volume_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_volume_groups_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, ids, limit, names, offset, sort, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_volume_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_volume_groups_patch_with_http_info(
        ...
        **kwargs
        ...
        Modifies a volume group. You can rename, destroy, recover, or set QoS limits for a volume group. To rename a volume group, set `name` to the new name. To destroy a volume group, set `destroyed=true`. To recover a volume group that has been destroyed and is pending eradication, set `destroyed=false`. Sets the bandwidth and IOPs limits of a volume group through the respective `bandwidth_limit` and `iops_limit` parameter. The `ids` or `names` parameter is required, but cannot be set together.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api27_volume_groups_patch_with_http_info(volume_group, authorization, x_request_id, destroy_contents, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_volume_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_volume_groups_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_volume_groups_performance_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_volume_groups_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_volume_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_volume_groups_post_with_http_info(volume_group, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_volume_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_volume_groups_space_get_with_http_info(
        ...
        **kwargs
        ...
        Returns the provisioned size and physical storage consumption data for each volume group.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api27_volume_groups_space_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_volume_groups_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_volume_groups_volumes_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_volume_groups_volumes_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_ids, group_names, limit, member_ids, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_volume_groups_volumes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
