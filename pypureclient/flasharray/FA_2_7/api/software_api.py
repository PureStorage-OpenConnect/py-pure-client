...
class SoftwareApi:
    ...
    def api27_software_bundle_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_software_bundle_get_with_http_info(x_request_id, filter, ids, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api27_software_bundle_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_software_bundle_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_software_bundle_post_with_http_info(source, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_software_bundle_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_software_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_software_get_with_http_info(authorization, x_request_id, filter, ids, limit, names, offset, sort, total_item_count, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_software_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_software_installation_steps_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_software_installation_steps_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, software_installation_ids, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_software_installation_steps_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_software_installations_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_software_installations_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, software_ids, software_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_software_installations_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_software_installations_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_software_installations_patch_with_http_info(command, current_step_id, authorization, x_request_id, software_installations, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_software_installations_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_software_installations_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_software_installations_post_with_http_info(software_ids, software_installations, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_software_installations_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
