...
from pypureclient.flasharray.FA_2_7.models.software_upgrade_plan import SoftwareUpgradePlan
...
class Software(BaseModel):
    ...
    upgrade_hops: Optional[List[StrictStr]] = Field(default=None, description="By which plan the upgrade will be conducted. The first element is the current version, the last element is the destination version, and the elements in between are intermediate versions.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "details", "payload_id", "progress", "status", "upgrade_hops", "version", "upgrade_plan"]
