...
from pypureclient.flasharray.FA_2_7.models.array_encryption import ArrayEncryption
from pypureclient.flasharray.FA_2_7.models.eradication_config import EradicationConfig
...
class Arrays(BaseModel):
    ...
    idle_timeout: Optional[StrictInt] = Field(default=None, description="The idle timeout in milliseconds. Valid values include `0` and any multiple of `60000` in the range of `300000` and `10800000`. Any other values will be rounded down to the nearest multiple of `60000`.")
