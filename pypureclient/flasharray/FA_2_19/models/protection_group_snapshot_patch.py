...
from pypureclient.flasharray.FA_2_19.models.fixed_reference import FixedReference
from pypureclient.flasharray.FA_2_19.models.protection_group_eradication_config import ProtectionGroupEradicationConfig
from pypureclient.flasharray.FA_2_19.models.space import Space
...
class ProtectionGroupSnapshotPatch(BaseModel):
    ...
    __properties = ["name", "created", "destroyed", "eradication_config", "pod", "source", "space", "suffix", "time_remaining"]
