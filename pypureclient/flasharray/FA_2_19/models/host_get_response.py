...
from pypureclient.flasharray.FA_2_19.models.host import Host
...
class HostGetResponse(BaseModel):
    ...
    items: Optional[conlist(Host)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful.")
