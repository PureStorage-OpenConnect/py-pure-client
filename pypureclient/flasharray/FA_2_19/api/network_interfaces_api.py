...
class NetworkInterfacesApi(object):
    ...
    def api219_network_interfaces_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api219_network_interfaces_get`, must be a value greater than or equal to `1`")
    ...
    def api219_network_interfaces_performance_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api219_network_interfaces_performance_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api219_network_interfaces_port_details_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api219_network_interfaces_port_details_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
