...
class VolumeSpaceCommon(BaseModel):
    ...
    __properties = ["data_reduction", "shared", "snapshots", "system", "thin_provisioning", "total_physical", "total_provisioned", "total_reduction", "unique", "virtual", "snapshots_effective", "total_effective", "unique_effective"]
