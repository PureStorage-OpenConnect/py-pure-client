...
class VolumeSpaceCommon(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data_reduction", "shared", "snapshots", "system", "thin_provisioning", "total_physical", "total_provisioned", "total_reduction", "unique", "virtual", "snapshots_effective", "unique_effective", "total_effective"]
