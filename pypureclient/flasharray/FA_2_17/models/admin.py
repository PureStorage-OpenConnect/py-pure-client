...
from pypureclient.flasharray.FA_2_17.models.admin_role import AdminRole
...
class Admin(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "api_token", "is_local", "locked", "lockout_remaining", "password", "public_key", "role"]
