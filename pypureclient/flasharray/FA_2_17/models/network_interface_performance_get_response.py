...
class NetworkInterfacePerformanceGetResponse(BaseModel):
    ...
    items: Optional[List[NetworkInterfacePerformance]] = Field(default=None, description="A list of performance objects.")
    total: Optional[List[NetworkInterfacePerformance]] = Field(default=None, description="The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field where meaningful.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [NetworkInterfacePerformance.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": [NetworkInterfacePerformance.from_dict(_item) for _item in obj["total"]] if obj.get("total") is not None else None
        })
        return _obj
