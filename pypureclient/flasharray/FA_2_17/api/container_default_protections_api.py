...
class ContainerDefaultProtectionsApi:
    ...
    def api217_container_default_protections_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_container_default_protections_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_container_default_protections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_container_default_protections_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_container_default_protections_patch_with_http_info(container_default_protection, authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_container_default_protections_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
