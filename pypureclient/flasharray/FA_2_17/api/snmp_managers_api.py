...
class SNMPManagersApi:
    ...
    def api217_snmp_managers_delete_with_http_info(
        ...
        _param = self._api217_snmp_managers_delete_serialize(
    ...
    def _api217_snmp_managers_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.17/snmp-managers',
    ...
    def api217_snmp_managers_get_with_http_info(
        ...
        _param = self._api217_snmp_managers_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api217_snmp_managers_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api217_snmp_managers_patch_with_http_info(
        ...
        _param = self._api217_snmp_managers_patch_serialize(
    ...
    def _api217_snmp_managers_patch_serialize(
        self,
        snmp_manager,
        authorization,
        x_request_id,
    ...
    def api217_snmp_managers_post_with_http_info(
        ...
        _param = self._api217_snmp_managers_post_serialize(
            snmp_manager = snmp_manager,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api217_snmp_managers_post_serialize(
        self,
        snmp_manager,
        authorization,
        x_request_id,
    ...
    def api217_snmp_managers_test_get_with_http_info(
        ...
        _param = self._api217_snmp_managers_test_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api217_snmp_managers_test_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.17/snmp-managers/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
