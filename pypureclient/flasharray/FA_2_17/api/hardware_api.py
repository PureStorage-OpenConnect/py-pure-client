...
class HardwareApi:
    ...
    def api217_hardware_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_hardware_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_hardware_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_hardware_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_hardware_patch_with_http_info(hardware, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_hardware_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
