...
from pypureclient.flasharray.FA_2_17.models.app import App
from pypureclient.flasharray.FA_2_17.models.app_get_response import AppGetResponse
from pypureclient.flasharray.FA_2_17.models.app_node_get_response import AppNodeGetResponse
from pypureclient.flasharray.FA_2_17.models.app_response import AppResponse
...
class AppsApi:
    ...
    def api217_apps_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_apps_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_apps_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_apps_nodes_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_apps_nodes_get_with_http_info(authorization, x_request_id, app_names, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_apps_nodes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_apps_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_apps_patch_with_http_info(names, app, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_apps_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
