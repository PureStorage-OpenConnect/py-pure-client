...
class FileSystemsApi:
    ...
    def api217_file_systems_delete_with_http_info(
        ...
        _param = self._api217_file_systems_delete_serialize(
    ...
    def _api217_file_systems_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.17/file-systems',
    ...
    def api217_file_systems_get_with_http_info(
        ...
        _param = self._api217_file_systems_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api217_file_systems_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api217_file_systems_patch_with_http_info(
        ...
        _param = self._api217_file_systems_patch_serialize(
    ...
    def _api217_file_systems_patch_serialize(
        self,
        file_system,
        authorization,
        x_request_id,
    ...
    def api217_file_systems_post_with_http_info(
        ...
        _param = self._api217_file_systems_post_serialize(
            names = names,
            authorization = authorization,
            x_request_id = x_request_id,
        )
    ...
    def _api217_file_systems_post_serialize(
        self,
        names,
        authorization,
        x_request_id,
