...
from pypureclient.flasharray.FA_2_17.models.protection_groups_volumes_get_response import ProtectionGroupsVolumesGetResponse
from pypureclient.flasharray.FA_2_17.models.protection_groups_volumes_response import ProtectionGroupsVolumesResponse
from pypureclient.flasharray.FA_2_17.models.resource_performance_by_array_get_response import ResourcePerformanceByArrayGetResponse
from pypureclient.flasharray.FA_2_17.models.resource_performance_get_response import ResourcePerformanceGetResponse
from pypureclient.flasharray.FA_2_17.models.tag import Tag
from pypureclient.flasharray.FA_2_17.models.tag_get_response import TagGetResponse
from pypureclient.flasharray.FA_2_17.models.tag_response import TagResponse
from pypureclient.flasharray.FA_2_17.models.volume_get_response import VolumeGetResponse
from pypureclient.flasharray.FA_2_17.models.volume_patch import VolumePatch
from pypureclient.flasharray.FA_2_17.models.volume_post import VolumePost
from pypureclient.flasharray.FA_2_17.models.volume_response import VolumeResponse
from pypureclient.flasharray.FA_2_17.models.volume_space_get_response import VolumeSpaceGetResponse
from pypureclient.flasharray.FA_2_17.models.volumes_diff_get_response import VolumesDiffGetResponse
...
class VolumesApi:
    ...
    def api217_volumes_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_delete_with_http_info(authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_volumes_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_diff_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_diff_get_with_http_info(block_size, segment_length, authorization, x_request_id, base_id, base_name, filter, ids, limit, names, next_allocated_block_hint, offset, segment_offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_diff_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, ids, limit, names, offset, sort, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_patch_with_http_info(volume, authorization, x_request_id, ids, names, truncate, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_performance_by_array_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_performance_by_array_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_performance_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_post_with_http_info(
        ...
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        add_to_protection_group_names: Annotated[Optional[conlist(StrictStr)], Field(description="The volume will be added to the specified protection groups on creation. Enter multiple names in comma-separated format.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique name specified. Enter multiple names in comma-separated format. For example, `name01,name02`.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_post_with_http_info(volume, authorization, x_request_id, add_to_protection_group_names, names, overwrite, with_default_protection, async_req=True)
        >>> result = thread.get()
        ...
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        :param add_to_protection_group_names: The volume will be added to the specified protection groups on creation. Enter multiple names in comma-separated format.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_protection_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_protection_groups_delete_with_http_info(authorization, x_request_id, group_names, member_ids, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_protection_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_protection_groups_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_names, limit, member_destroyed, member_ids, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_protection_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_protection_groups_post_with_http_info(authorization, x_request_id, group_names, member_ids, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_space_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_space_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_tags_batch_put_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_tags_batch_put_with_http_info(tag, authorization, x_request_id, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_tags_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_tags_delete_with_http_info(authorization, x_request_id, keys, namespaces, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_tags_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_tags_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, namespaces, offset, resource_destroyed, resource_ids, resource_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_volumes_volume_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_volumes_volume_groups_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_ids, group_names, limit, member_ids, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_volumes_volume_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
