...
class ActiveDirectoryApi:
    ...
    def api217_active_directory_delete_with_http_info(
        ...
        _param = self._api217_active_directory_delete_serialize(
            names = names,
    ...
    def _api217_active_directory_delete_serialize(
        self,
        names,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.17/active-directory',
    ...
    def api217_active_directory_get_with_http_info(
        ...
        _param = self._api217_active_directory_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api217_active_directory_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api217_active_directory_patch_with_http_info(
        ...
        _param = self._api217_active_directory_patch_serialize(
            names = names,
    ...
    def _api217_active_directory_patch_serialize(
        self,
        names,
        active_directory,
        authorization,
    ...
    def api217_active_directory_post_with_http_info(
        ...
        _param = self._api217_active_directory_post_serialize(
            names = names,
            active_directory = active_directory,
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api217_active_directory_post_serialize(
        self,
        names,
        active_directory,
        authorization,
