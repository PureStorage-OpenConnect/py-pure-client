...
class DNSApi:
    ...
    def api217_dns_delete_with_http_info(
        ...
        _param = self._api217_dns_delete_serialize(
    ...
    def _api217_dns_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
    ...
    def api217_dns_get_with_http_info(
        ...
        _param = self._api217_dns_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def api217_dns_patch_with_http_info(
        ...
        _param = self._api217_dns_patch_serialize(
            dns = dns,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api217_dns_patch_serialize(
        self,
        dns,
        authorization,
        x_request_id,
    ...
    def api217_dns_post_with_http_info(
        ...
        _param = self._api217_dns_post_serialize(
            dns = dns,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api217_dns_post_serialize(
        self,
        dns,
        authorization,
        x_request_id,
