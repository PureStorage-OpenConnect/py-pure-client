...
class DirectoryPerformanceGetResponse(BaseModel):
    ...
    items: Optional[List[DirectoryPerformance]] = Field(default=None, description="Performance data. If `total_only=true`, the `items` list will be empty.")
    total: Optional[List[DirectoryPerformance]] = Field(default=None, description="The aggregate value of all items after filtering. When it makes sense, the average value is displayed instead. The values are displayed for each field if meaningful.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [DirectoryPerformance.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": [DirectoryPerformance.from_dict(_item) for _item in obj["total"]] if obj.get("total") is not None else None
        })
        return _obj
