...
class HostGetResponse(BaseModel):
    ...
    items: Optional[List[Host]] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful.")
