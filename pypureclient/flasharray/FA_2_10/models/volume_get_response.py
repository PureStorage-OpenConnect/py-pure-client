...
class VolumeGetResponse(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            items (list[Volume]): Displays a list of all items after filtering. The values are displayed for each name, if meaningful. If `total_only=true`, the `items` list is empty.
            total (list[Volume]): The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field, if meaningful.
        """
