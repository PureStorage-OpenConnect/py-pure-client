...
from pypureclient.flasharray.FA_2_10.models.priority_adjustment import PriorityAdjustment
from pypureclient.flasharray.FA_2_10.models.qos import Qos
from pypureclient.flasharray.FA_2_10.models.space import Space
...
class VolumeGroupPost(BaseModel):
    ...
    destroyed: Optional[StrictBool] = Field(default=None, description="Destroy or recover a volume group. To destroy a volume group, patch to `true`. To recover a destroyed volume group, patch to `false`. If not specified, defaults to `false`.")
