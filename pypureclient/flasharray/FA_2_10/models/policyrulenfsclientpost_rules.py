...
class PolicyrulenfsclientpostRules(BaseModel):
    ...
    """ # noqa: E501
    access: Optional[StrictStr] = Field(default=None, description="Specifies access control for the export. Valid values are `root-squash` and `no-root-squash`. If not specified, the default value is `root-squash`.")
    ...
    __properties: ClassVar[List[str]] = ["access", "client", "permission"]
