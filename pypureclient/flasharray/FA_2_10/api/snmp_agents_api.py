...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_10.models.snmp_agent_get_response import SnmpAgentGetResponse
from pypureclient.flasharray.FA_2_10.models.snmp_agent_mib_get_response import SnmpAgentMibGetResponse
from pypureclient.flasharray.FA_2_10.models.snmp_agent_patch import SnmpAgentPatch
from pypureclient.flasharray.FA_2_10.models.snmp_agent_response import SnmpAgentResponse
...
class SNMPAgentsApi:
    ...
    def api210_snmp_agents_get_with_http_info(
        ...
        _param = self._api210_snmp_agents_get_serialize(
    ...
    def _api210_snmp_agents_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.10/snmp-agents',
    ...
    def api210_snmp_agents_mib_get_with_http_info(
        ...
        _param = self._api210_snmp_agents_mib_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api210_snmp_agents_mib_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.10/snmp-agents/mib',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api210_snmp_agents_patch_with_http_info(
        ...
        _param = self._api210_snmp_agents_patch_serialize(
    ...
    def _api210_snmp_agents_patch_serialize(
        self,
        snmp_agent,
        authorization,
        x_request_id,
