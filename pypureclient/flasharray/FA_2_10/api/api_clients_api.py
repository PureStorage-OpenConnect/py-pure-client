...
from pypureclient.flasharray.FA_2_10.models.api_client_get_response import ApiClientGetResponse
from pypureclient.flasharray.FA_2_10.models.api_client_patch import ApiClientPatch
from pypureclient.flasharray.FA_2_10.models.api_client_post import ApiClientPost
from pypureclient.flasharray.FA_2_10.models.api_client_response import ApiClientResponse
...
class APIClientsApi:
    ...
    def api210_api_clients_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api210_api_clients_delete_with_http_info(authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api210_api_clients_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api210_api_clients_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api210_api_clients_get_with_http_info(authorization, x_request_id, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_api_clients_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api210_api_clients_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api210_api_clients_patch_with_http_info(api_clients, authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_api_clients_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api210_api_clients_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api210_api_clients_post_with_http_info(api_clients, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_api_clients_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
