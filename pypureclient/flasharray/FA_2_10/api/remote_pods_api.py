...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_10.models.remote_pods_response import RemotePodsResponse
...
class RemotePodsApi:
    ...
    def api210_remote_pods_get_with_http_info(
        ...
        _param = self._api210_remote_pods_get_serialize(
    ...
    def _api210_remote_pods_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.10/remote-pods',
