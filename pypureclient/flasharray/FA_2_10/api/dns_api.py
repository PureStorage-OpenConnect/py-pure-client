...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_10.models.dns_get_response import DnsGetResponse
from pypureclient.flasharray.FA_2_10.models.dns_patch import DnsPatch
from pypureclient.flasharray.FA_2_10.models.dns_response import DnsResponse
...
class DNSApi:
    ...
    def api210_dns_get_with_http_info(
        ...
        _param = self._api210_dns_get_serialize(
    ...
    def api210_dns_patch_with_http_info(
        ...
        _param = self._api210_dns_patch_serialize(
            dns = dns,
            authorization = authorization,
            x_request_id = x_request_id,
        )
    ...
    def _api210_dns_patch_serialize(
        self,
        dns,
        authorization,
        x_request_id,
