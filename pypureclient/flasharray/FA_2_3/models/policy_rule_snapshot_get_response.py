...
from pypureclient.flasharray.FA_2_3.models.policy_rule_snapshot import PolicyRuleSnapshot
...
class PolicyRuleSnapshotGetResponse(BaseModel):
    ...
    items: Optional[conlist(PolicyRuleSnapshot)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful.")
