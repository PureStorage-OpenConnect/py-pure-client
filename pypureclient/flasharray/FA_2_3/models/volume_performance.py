...
class VolumePerformance(BaseModel):
    """
    VolumePerformance
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VolumePerformance:
        """Create an instance of VolumePerformance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VolumePerformance:
        """Create an instance of VolumePerformance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VolumePerformance.parse_obj(obj)

        _obj = VolumePerformance.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
