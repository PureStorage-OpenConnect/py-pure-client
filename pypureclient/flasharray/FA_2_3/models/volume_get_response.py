...
class VolumeGetResponse(BaseModel):
    ...
    items: Optional[List[Volume]] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name if meaningful. If `total_only=true`, the `items` list will be empty.")
    total: Optional[List[Volume]] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field if meaningful.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "total": [Volume.from_dict(_item) for _item in obj["total"]] if obj.get("total") is not None else None
        })
        return _obj
