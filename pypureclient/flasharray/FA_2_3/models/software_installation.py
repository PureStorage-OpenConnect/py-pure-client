...
class SoftwareInstallation(BaseModel):
    ...
    override_checks: Optional[List[OverrideCheck]] = Field(default=None, description="A list of upgrade checks whose failure will be overridden during the upgrade. If any optional `args` are provided, they are validated later when the corresponding check script runs.")
