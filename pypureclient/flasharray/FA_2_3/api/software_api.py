...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_3.models.software_get_response import SoftwareGetResponse
from pypureclient.flasharray.FA_2_3.models.software_installation_patch import SoftwareInstallationPatch
from pypureclient.flasharray.FA_2_3.models.software_installation_post import SoftwareInstallationPost
from pypureclient.flasharray.FA_2_3.models.software_installation_steps_get_response import SoftwareInstallationStepsGetResponse
from pypureclient.flasharray.FA_2_3.models.software_installations_get_response import SoftwareInstallationsGetResponse
from pypureclient.flasharray.FA_2_3.models.software_installations_response import SoftwareInstallationsResponse
...
class SoftwareApi:
    ...
    def api23_software_get_with_http_info(
        ...
        _param = self._api23_software_get_serialize(
    ...
    def _api23_software_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.3/software',
    ...
    def api23_software_installation_steps_get_with_http_info(
        ...
        _param = self._api23_software_installation_steps_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            ids = ids,
    ...
    def _api23_software_installation_steps_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.3/software-installation-steps',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api23_software_installations_get_with_http_info(
        ...
        _param = self._api23_software_installations_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            ids = ids,
    ...
    def _api23_software_installations_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.3/software-installations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api23_software_installations_patch_with_http_info(
        ...
        _param = self._api23_software_installations_patch_serialize(
            command = command,
    ...
    def _api23_software_installations_patch_serialize(
        self,
        command,
        current_step_id,
        authorization,
    ...
    def api23_software_installations_post_with_http_info(
        ...
        _param = self._api23_software_installations_post_serialize(
            software_ids = software_ids,
            software_installations = software_installations,
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api23_software_installations_post_serialize(
        self,
        software_ids,
        software_installations,
        authorization,
