...
from pypureclient.flasharray.FA_2_3.models.alert_event_get_response import AlertEventGetResponse
from pypureclient.flasharray.FA_2_3.models.alert_get_response import AlertGetResponse
from pypureclient.flasharray.FA_2_3.models.alert_response import AlertResponse
...
class AlertsApi:
    ...
    def api23_alerts_events_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_alerts_events_get_with_http_info(authorization, x_request_id, continuation_token, filter, flagged, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api23_alerts_events_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_alerts_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_alerts_get_with_http_info(authorization, x_request_id, continuation_token, filter, flagged, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_alerts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_alerts_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_alerts_patch_with_http_info(alert, authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_alerts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
