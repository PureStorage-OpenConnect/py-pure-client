...
class ProtectionGroupSnapshotsApi:
    ...
    def api23_protection_group_snapshots_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_protection_group_snapshots_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api23_protection_group_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_protection_group_snapshots_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_protection_group_snapshots_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, limit, names, offset, sort, source_names, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_protection_group_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_protection_group_snapshots_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_protection_group_snapshots_patch_with_http_info(protection_group_snapshot, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_protection_group_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_protection_group_snapshots_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_protection_group_snapshots_post_with_http_info(authorization, x_request_id, apply_retention, source_names, protection_group_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_protection_group_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_protection_group_snapshots_transfer_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_protection_group_snapshots_transfer_get_with_http_info(authorization, x_request_id, destroyed, filter, limit, names, offset, sort, source_names, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_protection_group_snapshots_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
