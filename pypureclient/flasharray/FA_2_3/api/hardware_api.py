...
class HardwareApi:
    ...
    def api23_hardware_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_hardware_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api23_hardware_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_hardware_patch_with_http_info(hardware, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
