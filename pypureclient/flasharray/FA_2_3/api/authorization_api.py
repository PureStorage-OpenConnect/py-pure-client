...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_3.models.api_version_response import ApiVersionResponse
from pypureclient.flasharray.FA_2_3.models.oauth_token_response import OauthTokenResponse
from pypureclient.flasharray.FA_2_3.models.username_response import UsernameResponse
...
class AuthorizationApi:
    ...
    def api23_login_post_with_http_info(
        ...
        _param = self._api23_login_post_serialize(
    ...
    def _api23_login_post_serialize(
        self,
        x_request_id,
        api_token,
    ) -> RequestSerialized:
    ...
    def api23_logout_post_with_http_info(
        ...
        _param = self._api23_logout_post_serialize(
            x_request_id = x_request_id,
    ...
    def _api23_logout_post_serialize(
        self,
        x_request_id,
        x_auth_token,
    ) -> RequestSerialized:
