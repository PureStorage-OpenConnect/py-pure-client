...
from pypureclient.flasharray.FA_2_3.models.audit_get_response import AuditGetResponse
...
class AuditsApi:
    ...
    def api23_audits_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_audits_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
