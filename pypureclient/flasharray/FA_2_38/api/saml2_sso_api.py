...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_38.models.saml2_sso_get_response import Saml2SsoGetResponse
from pypureclient.flasharray.FA_2_38.models.saml2_sso_patch import Saml2SsoPatch
from pypureclient.flasharray.FA_2_38.models.saml2_sso_post import Saml2SsoPost
from pypureclient.flasharray.FA_2_38.models.saml2_sso_response import Saml2SsoResponse
from pypureclient.flasharray.FA_2_38.models.test_result_with_resource_patch_response import TestResultWithResourcePatchResponse
from pypureclient.flasharray.FA_2_38.models.test_result_with_resource_response import TestResultWithResourceResponse
...
class SAML2SSOApi:
    ...
    def api238_sso_saml2_idps_delete_with_http_info(
        ...
        _param = self._api238_sso_saml2_idps_delete_serialize(
    ...
    def _api238_sso_saml2_idps_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.38/sso/saml2/idps',
    ...
    def api238_sso_saml2_idps_get_with_http_info(
        ...
        _param = self._api238_sso_saml2_idps_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api238_sso_saml2_idps_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api238_sso_saml2_idps_patch_with_http_info(
        ...
        _param = self._api238_sso_saml2_idps_patch_serialize(
            idp = idp,
            authorization = authorization,
            x_request_id = x_request_id,
            ids = ids,
    ...
    def _api238_sso_saml2_idps_patch_serialize(
        self,
        idp,
        authorization,
        x_request_id,
    ...
    def api238_sso_saml2_idps_post_with_http_info(
        ...
        _param = self._api238_sso_saml2_idps_post_serialize(
            names = names,
            idp = idp,
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api238_sso_saml2_idps_post_serialize(
        self,
        names,
        idp,
        authorization,
    ...
    def api238_sso_saml2_idps_test_get_with_http_info(
        ...
        _param = self._api238_sso_saml2_idps_test_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api238_sso_saml2_idps_test_get_serialize(
        self,
        authorization,
        x_request_id,
        allow_errors,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.38/sso/saml2/idps/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api238_sso_saml2_idps_test_patch_with_http_info(
        ...
        _param = self._api238_sso_saml2_idps_test_patch_serialize(
            idp = idp,
            authorization = authorization,
            x_request_id = x_request_id,
            context_names = context_names,
    ...
    def _api238_sso_saml2_idps_test_patch_serialize(
        self,
        idp,
        authorization,
        x_request_id,
