...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_38.models.certificate_certificate_group_get_response import CertificateCertificateGroupGetResponse
from pypureclient.flasharray.FA_2_38.models.certificate_certificate_group_response import CertificateCertificateGroupResponse
from pypureclient.flasharray.FA_2_38.models.certificate_get_response import CertificateGetResponse
from pypureclient.flasharray.FA_2_38.models.certificate_post import CertificatePost
from pypureclient.flasharray.FA_2_38.models.certificate_response import CertificateResponse
from pypureclient.flasharray.FA_2_38.models.certificate_signing_request_post import CertificateSigningRequestPost
from pypureclient.flasharray.FA_2_38.models.certificate_signing_request_response import CertificateSigningRequestResponse
...
class CertificatesApi:
    ...
    def api238_certificates_certificate_groups_delete_with_http_info(
        ...
        _param = self._api238_certificates_certificate_groups_delete_serialize(
    ...
    def _api238_certificates_certificate_groups_delete_serialize(
        self,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.38/certificates/certificate-groups',
    ...
    def api238_certificates_certificate_groups_get_with_http_info(
        ...
        _param = self._api238_certificates_certificate_groups_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api238_certificates_certificate_groups_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api238_certificates_certificate_groups_post_with_http_info(
        ...
        _param = self._api238_certificates_certificate_groups_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            certificate_group_ids = certificate_group_ids,
            certificate_group_names = certificate_group_names,
    ...
    def _api238_certificates_certificate_groups_post_serialize(
        self,
        authorization,
        x_request_id,
        certificate_group_ids,
    ...
    def api238_certificates_certificate_signing_requests_post_with_http_info(
        ...
        _param = self._api238_certificates_certificate_signing_requests_post_serialize(
    ...
    def _api238_certificates_certificate_signing_requests_post_serialize(
        self,
        certificate,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2.38/certificates/certificate-signing-requests',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api238_certificates_delete_with_http_info(
        ...
        _param = self._api238_certificates_delete_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api238_certificates_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.38/certificates',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api238_certificates_get_with_http_info(
        ...
        _param = self._api238_certificates_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api238_certificates_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api238_certificates_patch_with_http_info(
        ...
        _param = self._api238_certificates_patch_serialize(
            certificate = certificate,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api238_certificates_patch_serialize(
        self,
        certificate,
        authorization,
        x_request_id,
    ...
    def api238_certificates_post_with_http_info(
        ...
        _param = self._api238_certificates_post_serialize(
            certificate = certificate,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api238_certificates_post_serialize(
        self,
        certificate,
        authorization,
        x_request_id,
