...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_38.models.support_diagnostics_details_get_response import SupportDiagnosticsDetailsGetResponse
from pypureclient.flasharray.FA_2_38.models.support_diagnostics_get_response import SupportDiagnosticsGetResponse
from pypureclient.flasharray.FA_2_38.models.support_diagnostics_response import SupportDiagnosticsResponse
from pypureclient.flasharray.FA_2_38.models.support_get_response import SupportGetResponse
from pypureclient.flasharray.FA_2_38.models.support_patch import SupportPatch
from pypureclient.flasharray.FA_2_38.models.support_response import SupportResponse
from pypureclient.flasharray.FA_2_38.models.test_result_get_response import TestResultGetResponse
...
class SupportApi:
    ...
    def api238_support_diagnostics_details_get_with_http_info(
    ...
    ) -> ApiResponse[SupportDiagnosticsDetailsGetResponse]:
        ...
        _param = self._api238_support_diagnostics_details_get_serialize(
    ...
    def _api238_support_diagnostics_details_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.38/support-diagnostics/details',
    ...
    def api238_support_diagnostics_settings_get_with_http_info(
        ...
        total_item_count: Annotated[Optional[StrictBool], Field(description="If set to `true`, the `total_item_count` matching the specified query parameters is calculated and returned in the response. If set to `false`, the `total_item_count` is `null` in the response. This may speed up queries where the `total_item_count` is large. If not specified, defaults to `false`.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[SupportDiagnosticsGetResponse]:
        ...
        _param = self._api238_support_diagnostics_settings_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api238_support_diagnostics_settings_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.38/support-diagnostics/settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api238_support_diagnostics_settings_patch_with_http_info(
        ...
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[SupportDiagnosticsResponse]:
        ...
        _param = self._api238_support_diagnostics_settings_patch_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            purity_default = purity_default,
        )
    ...
    def _api238_support_diagnostics_settings_patch_serialize(
        self,
        authorization,
        x_request_id,
        purity_default,
        ...
        # process the path parameters
        # process the query parameters
        if purity_default is not None:
            
            _query_params.append(('purity_default', purity_default))
    ...
    def api238_support_get_with_http_info(
        ...
        _param = self._api238_support_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api238_support_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.38/support',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api238_support_patch_with_http_info(
        ...
        _param = self._api238_support_patch_serialize(
            support = support,
            authorization = authorization,
            x_request_id = x_request_id,
        )
    ...
    def _api238_support_patch_serialize(
        self,
        support,
        authorization,
        x_request_id,
    ...
    def api238_support_test_get_with_http_info(
        ...
        _param = self._api238_support_test_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api238_support_test_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.38/support/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
