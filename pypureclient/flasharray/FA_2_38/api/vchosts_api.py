...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_38.models.vchost_certificate_get_response import VchostCertificateGetResponse
from pypureclient.flasharray.FA_2_38.models.vchost_certificate_patch import VchostCertificatePatch
from pypureclient.flasharray.FA_2_38.models.vchost_certificate_post import VchostCertificatePost
from pypureclient.flasharray.FA_2_38.models.vchost_certificate_response import VchostCertificateResponse
from pypureclient.flasharray.FA_2_38.models.vchost_endpoint_get_response import VchostEndpointGetResponse
from pypureclient.flasharray.FA_2_38.models.vchost_endpoint_patch import VchostEndpointPatch
from pypureclient.flasharray.FA_2_38.models.vchost_endpoint_post import VchostEndpointPost
from pypureclient.flasharray.FA_2_38.models.vchost_endpoint_response import VchostEndpointResponse
from pypureclient.flasharray.FA_2_38.models.vchost_get_response import VchostGetResponse
from pypureclient.flasharray.FA_2_38.models.vchost_patch import VchostPatch
from pypureclient.flasharray.FA_2_38.models.vchost_post import VchostPost
from pypureclient.flasharray.FA_2_38.models.vchost_response import VchostResponse
...
class VchostsApi:
    ...
    def api238_vchosts_certificates_delete_with_http_info(
        ...
        _param = self._api238_vchosts_certificates_delete_serialize(
    ...
    def _api238_vchosts_certificates_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.38/vchosts/certificates',
    ...
    def api238_vchosts_certificates_get_with_http_info(
        ...
        _param = self._api238_vchosts_certificates_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api238_vchosts_certificates_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api238_vchosts_certificates_patch_with_http_info(
        ...
        _param = self._api238_vchosts_certificates_patch_serialize(
    ...
    def _api238_vchosts_certificates_patch_serialize(
        self,
        certificate,
        authorization,
        x_request_id,
    ...
    def api238_vchosts_certificates_post_with_http_info(
        ...
        _param = self._api238_vchosts_certificates_post_serialize(
            certificate = certificate,
            authorization = authorization,
            x_request_id = x_request_id,
            vchost_names = vchost_names,
    ...
    def _api238_vchosts_certificates_post_serialize(
        self,
        certificate,
        authorization,
        x_request_id,
    ...
    def api238_vchosts_delete_with_http_info(
        ...
        _param = self._api238_vchosts_delete_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
            ids = ids,
    ...
    def _api238_vchosts_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.38/vchosts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api238_vchosts_endpoints_delete_with_http_info(
        ...
        _param = self._api238_vchosts_endpoints_delete_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            ids = ids,
            vchost_names = vchost_names,
    ...
    def _api238_vchosts_endpoints_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.38/vchosts/endpoints',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api238_vchosts_endpoints_get_with_http_info(
        ...
        _param = self._api238_vchosts_endpoints_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api238_vchosts_endpoints_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api238_vchosts_endpoints_patch_with_http_info(
        ...
        _param = self._api238_vchosts_endpoints_patch_serialize(
            endpoint = endpoint,
            authorization = authorization,
            x_request_id = x_request_id,
            ids = ids,
    ...
    def _api238_vchosts_endpoints_patch_serialize(
        self,
        endpoint,
        authorization,
        x_request_id,
    ...
    def api238_vchosts_endpoints_post_with_http_info(
        ...
        _param = self._api238_vchosts_endpoints_post_serialize(
            endpoint = endpoint,
            authorization = authorization,
            x_request_id = x_request_id,
            vchost_names = vchost_names,
    ...
    def _api238_vchosts_endpoints_post_serialize(
        self,
        endpoint,
        authorization,
        x_request_id,
    ...
    def api238_vchosts_get_with_http_info(
        ...
        _param = self._api238_vchosts_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api238_vchosts_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api238_vchosts_patch_with_http_info(
        ...
        _param = self._api238_vchosts_patch_serialize(
            vchost = vchost,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api238_vchosts_patch_serialize(
        self,
        vchost,
        authorization,
        x_request_id,
    ...
    def api238_vchosts_post_with_http_info(
        ...
        _param = self._api238_vchosts_post_serialize(
            vchost = vchost,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api238_vchosts_post_serialize(
        self,
        vchost,
        authorization,
        x_request_id,
