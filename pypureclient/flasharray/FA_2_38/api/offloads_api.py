...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_38.models.offload_get_response import OffloadGetResponse
from pypureclient.flasharray.FA_2_38.models.offload_post import OffloadPost
from pypureclient.flasharray.FA_2_38.models.offload_response import OffloadResponse
...
class OffloadsApi:
    ...
    def api238_offloads_delete_with_http_info(
        ...
        _param = self._api238_offloads_delete_serialize(
    ...
    def _api238_offloads_delete_serialize(
        self,
        authorization,
        x_request_id,
        context_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.38/offloads',
    ...
    def api238_offloads_get_with_http_info(
        ...
        _param = self._api238_offloads_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api238_offloads_get_serialize(
        self,
        authorization,
        x_request_id,
        allow_errors,
    ...
    def api238_offloads_post_with_http_info(
        ...
        _param = self._api238_offloads_post_serialize(
            offload = offload,
            authorization = authorization,
            x_request_id = x_request_id,
            context_names = context_names,
    ...
    def _api238_offloads_post_serialize(
        self,
        offload,
        authorization,
        x_request_id,
