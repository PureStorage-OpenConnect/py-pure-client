...
from pypureclient.flasharray.FA_2_38.models.api_client_get_response import ApiClientGetResponse
from pypureclient.flasharray.FA_2_38.models.api_client_patch import ApiClientPatch
from pypureclient.flasharray.FA_2_38.models.api_client_post import ApiClientPost
from pypureclient.flasharray.FA_2_38.models.api_client_response import ApiClientResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api238_api_clients_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_api_clients_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_api_clients_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_api_clients_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
