...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_38.models.syslog_server import SyslogServer
from pypureclient.flasharray.FA_2_38.models.syslog_server_get_response import SyslogServerGetResponse
from pypureclient.flasharray.FA_2_38.models.syslog_server_response import SyslogServerResponse
from pypureclient.flasharray.FA_2_38.models.syslog_server_settings import SyslogServerSettings
from pypureclient.flasharray.FA_2_38.models.syslog_server_settings_get_response import SyslogServerSettingsGetResponse
from pypureclient.flasharray.FA_2_38.models.syslog_server_settings_response import SyslogServerSettingsResponse
...
class SyslogApi:
    ...
    def api238_syslog_servers_delete_with_http_info(
        ...
        _param = self._api238_syslog_servers_delete_serialize(
    ...
    def _api238_syslog_servers_delete_serialize(
        self,
        authorization,
        x_request_id,
        context_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.38/syslog-servers',
    ...
    def api238_syslog_servers_get_with_http_info(
        ...
        _param = self._api238_syslog_servers_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api238_syslog_servers_get_serialize(
        self,
        authorization,
        x_request_id,
        allow_errors,
    ...
    def api238_syslog_servers_patch_with_http_info(
        ...
        _param = self._api238_syslog_servers_patch_serialize(
    ...
    def _api238_syslog_servers_patch_serialize(
        self,
        syslog_server,
        authorization,
        x_request_id,
    ...
    def api238_syslog_servers_post_with_http_info(
        ...
        _param = self._api238_syslog_servers_post_serialize(
            syslog_server = syslog_server,
            authorization = authorization,
            x_request_id = x_request_id,
            context_names = context_names,
    ...
    def _api238_syslog_servers_post_serialize(
        self,
        syslog_server,
        authorization,
        x_request_id,
    ...
    def api238_syslog_servers_settings_get_with_http_info(
        ...
        _param = self._api238_syslog_servers_settings_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            allow_errors = allow_errors,
            context_names = context_names,
    ...
    def _api238_syslog_servers_settings_get_serialize(
        self,
        authorization,
        x_request_id,
        allow_errors,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.38/syslog-servers/settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api238_syslog_servers_settings_patch_with_http_info(
        ...
        _param = self._api238_syslog_servers_settings_patch_serialize(
    ...
    def _api238_syslog_servers_settings_patch_serialize(
        self,
    ...
    def api238_syslog_servers_test_get_with_http_info(
        ...
        _param = self._api238_syslog_servers_test_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            allow_errors = allow_errors,
            context_names = context_names,
    ...
    def _api238_syslog_servers_test_get_serialize(
        self,
        authorization,
        x_request_id,
        allow_errors,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.38/syslog-servers/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
