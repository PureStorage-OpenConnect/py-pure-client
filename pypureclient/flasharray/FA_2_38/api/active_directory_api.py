...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_38.models.active_directory_get_response import ActiveDirectoryGetResponse
from pypureclient.flasharray.FA_2_38.models.active_directory_patch import ActiveDirectoryPatch
from pypureclient.flasharray.FA_2_38.models.active_directory_post import ActiveDirectoryPost
from pypureclient.flasharray.FA_2_38.models.active_directory_response import ActiveDirectoryResponse
...
class ActiveDirectoryApi:
    ...
    def api238_active_directory_delete_with_http_info(
        ...
        _param = self._api238_active_directory_delete_serialize(
            names = names,
    ...
    def _api238_active_directory_delete_serialize(
        self,
        names,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.38/active-directory',
    ...
    def api238_active_directory_get_with_http_info(
        ...
        _param = self._api238_active_directory_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api238_active_directory_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api238_active_directory_patch_with_http_info(
        ...
        _param = self._api238_active_directory_patch_serialize(
            names = names,
    ...
    def _api238_active_directory_patch_serialize(
        self,
        names,
        active_directory,
        authorization,
    ...
    def api238_active_directory_post_with_http_info(
        ...
        _param = self._api238_active_directory_post_serialize(
            names = names,
            active_directory = active_directory,
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api238_active_directory_post_serialize(
        self,
        names,
        active_directory,
        authorization,
