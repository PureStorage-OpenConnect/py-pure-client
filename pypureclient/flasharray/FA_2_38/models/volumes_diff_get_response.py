...
from pypureclient.flasharray.FA_2_38.models.volume_diff import VolumeDiff
...
class VolumesDiffGetResponse(BaseModel):
    ...
    items: Optional[List[VolumeDiff]] = Field(default=None, description="A list of different chunks between specified volumes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [VolumeDiff.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
