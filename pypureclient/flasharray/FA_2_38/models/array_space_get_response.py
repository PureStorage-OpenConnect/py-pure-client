...
from pypureclient.flasharray.FA_2_38.models.array_space import ArraySpace
...
class ArraySpaceGetResponse(BaseModel):
    ...
    items: Optional[List[ArraySpace]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [ArraySpace.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
