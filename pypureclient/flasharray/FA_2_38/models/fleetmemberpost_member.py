...
class FleetmemberpostMember(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FleetmemberpostMember:
        """Create an instance of FleetmemberpostMember from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FleetmemberpostMember:
        """Create an instance of FleetmemberpostMember from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FleetmemberpostMember.parse_obj(obj)

        _obj = FleetmemberpostMember.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
