...
from pypureclient.flasharray.FA_2_38.models.replica_link_lag import ReplicaLinkLag
...
class PodReplicaLinkLag(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "context", "direction", "lag", "local_pod", "recovery_point", "remotes", "remote_pod", "status", "time"]
