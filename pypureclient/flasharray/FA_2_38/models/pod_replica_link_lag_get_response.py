...
class PodReplicaLinkLagGetResponse(BaseModel):
    ...
    items: Optional[List[PodReplicaLinkLag]] = Field(default=None, description="A list of pod replica link lag objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [PodReplicaLinkLag.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
