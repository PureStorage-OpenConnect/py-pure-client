...
class PolicyPasswordGetResponse(BaseModel):
    ...
    items: Optional[List[PolicyPassword]] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
