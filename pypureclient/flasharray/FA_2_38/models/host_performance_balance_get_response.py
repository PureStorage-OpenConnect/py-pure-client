...
from pypureclient.flasharray.FA_2_38.models.host_performance_balance import HostPerformanceBalance
...
class HostPerformanceBalanceGetResponse(BaseModel):
    ...
    items: Optional[List[HostPerformanceBalance]] = Field(default=None, description="A list of entries indicating count and percentage of I/O operations across various data paths between the host and the array.")
    __properties: ClassVar[List[str]] = ["more_items_remaining", "total_item_count", "continuation_token", "errors", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [HostPerformanceBalance.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
