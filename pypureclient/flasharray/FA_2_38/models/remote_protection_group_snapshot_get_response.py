...
class RemoteProtectionGroupSnapshotGetResponse(BaseModel):
    ...
    items: Optional[List[RemoteProtectionGroupSnapshot]] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    __properties: ClassVar[List[str]] = ["more_items_remaining", "total_item_count", "continuation_token", "items", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [RemoteProtectionGroupSnapshot.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
