...
from pypureclient.flasharray.FA_2_38.models.connection import Connection
...
class ConnectionGetResponse(BaseModel):
    ...
    items: Optional[List[Connection]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [Connection.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
