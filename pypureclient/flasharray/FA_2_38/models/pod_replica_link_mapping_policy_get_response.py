...
class PodReplicaLinkMappingPolicyGetResponse(BaseModel):
    ...
    items: Optional[List[MappingPolicy]] = Field(default=None, description="A list of policy mappings.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [MappingPolicy.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
