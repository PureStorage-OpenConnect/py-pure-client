...
from pypureclient.flasharray.FA_2_38.models.policy_nfs import PolicyNfs
...
class PolicyNfsGetResponse(BaseModel):
    ...
    items: Optional[List[PolicyNfs]] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [PolicyNfs.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
