...
from pypureclient.flasharray.FA_2_38.models.remote_protection_group import RemoteProtectionGroup


class RemoteProtectionGroupGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(RemoteProtectionGroup)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name where meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoteProtectionGroupGetResponse:
        """Create an instance of RemoteProtectionGroupGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RemoteProtectionGroupGetResponse:
        """Create an instance of RemoteProtectionGroupGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoteProtectionGroupGetResponse.parse_obj(obj)

        _obj = RemoteProtectionGroupGetResponse.construct(_fields_set=None, **{
            ...
            "items": [RemoteProtectionGroup.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
