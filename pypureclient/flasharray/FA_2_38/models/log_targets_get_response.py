...
from pypureclient.flasharray.FA_2_38.models.log_target import LogTarget
...
class LogTargetsGetResponse(BaseModel):
    ...
    items: Optional[List[LogTarget]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [LogTarget.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
