...
from pypureclient.flasharray.FA_2_48.models.dns import Dns
...
class DnsGetResponse(BaseModel):
    ...
    items: Optional[conlist(Dns)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DnsGetResponse:
        """Create an instance of DnsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DnsGetResponse:
        """Create an instance of DnsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DnsGetResponse.parse_obj(obj)

        _obj = DnsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Dns.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
