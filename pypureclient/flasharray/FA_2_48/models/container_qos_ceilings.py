...
class ContainerQosCeilings(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContainerQosCeilings:
        """Create an instance of ContainerQosCeilings from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ContainerQosCeilings:
        """Create an instance of ContainerQosCeilings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContainerQosCeilings.parse_obj(obj)

        _obj = ContainerQosCeilings.construct(_fields_set=None, **{
