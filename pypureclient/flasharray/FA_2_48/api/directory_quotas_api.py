...
from pypureclient.flasharray.FA_2_48.models.directory_quotas_get_response import DirectoryQuotasGetResponse
from typing import Optional
...
class DirectoryQuotasApi:
    ...
    def api248_directory_quotas_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api248_directory_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
