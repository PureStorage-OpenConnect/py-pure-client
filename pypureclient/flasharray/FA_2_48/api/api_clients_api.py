...
from pypureclient.flasharray.common.models.api_client_get_response_v_36 import ApiClientGetResponse
from pypureclient.flasharray.common.models.api_client_patch_v_1 import ApiClientPatch
from pypureclient.flasharray.common.models.api_client_post_v_36 import ApiClientPost
from pypureclient.flasharray.common.models.api_client_response_v_36 import ApiClientResponse
...
class APIClientsApi:
    ...
    def api248_api_clients_delete_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api248_api_clients_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api248_api_clients_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api248_api_clients_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api248_api_clients_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api248_api_clients_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api248_api_clients_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api248_api_clients_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
