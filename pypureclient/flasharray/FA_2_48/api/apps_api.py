...
from pypureclient.flasharray.FA_2_48.models.app import App
from pypureclient.flasharray.FA_2_48.models.app_get_response import AppGetResponse
from pypureclient.flasharray.FA_2_48.models.app_node_get_response import AppNodeGetResponse
from pypureclient.flasharray.FA_2_48.models.app_response import AppResponse
from typing import Optional
...
class AppsApi:
    ...
    def api248_apps_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api248_apps_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api248_apps_nodes_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api248_apps_nodes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api248_apps_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api248_apps_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
