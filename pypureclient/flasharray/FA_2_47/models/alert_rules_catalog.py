...
class AlertRulesCatalog(BaseModel):
    ...
    __properties = ["context", "allowed_values", "code", "default_value", "parameter", "subject"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertRulesCatalog:
        """Create an instance of AlertRulesCatalog from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AlertRulesCatalog:
        """Create an instance of AlertRulesCatalog from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlertRulesCatalog.parse_obj(obj)

        _obj = AlertRulesCatalog.construct(_fields_set=None, **{
