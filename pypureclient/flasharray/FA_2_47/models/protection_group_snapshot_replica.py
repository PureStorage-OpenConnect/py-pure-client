...
class ProtectionGroupSnapshotReplica(BaseModel):
    ...
    __properties = ["id", "name", "context", "created", "destroyed", "eradication_config", "pod", "source", "space", "suffix", "time_remaining"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProtectionGroupSnapshotReplica:
        """Create an instance of ProtectionGroupSnapshotReplica from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ProtectionGroupSnapshotReplica:
        """Create an instance of ProtectionGroupSnapshotReplica from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProtectionGroupSnapshotReplica.parse_obj(obj)

        _obj = ProtectionGroupSnapshotReplica.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
