...
class MemberNoIdMember(BaseModel):
    """
    MemberNoIdMember
    """
    ...
    group: Optional[Reference] = Field(default=None, description="The resource in which the host, volume, or other item in the environment is a member.")
    member: Optional[ReferenceNoId] = Field(default=None, description="The member of the resource.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MemberNoIdMember:
        """Create an instance of MemberNoIdMember from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> MemberNoIdMember:
        """Create an instance of MemberNoIdMember from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MemberNoIdMember.parse_obj(obj)

        _obj = MemberNoIdMember.construct(_fields_set=None, **{
            ...
            "member": ReferenceNoId.from_dict(obj.get("member")) if obj.get("member") is not None else None
        })
        return _obj
