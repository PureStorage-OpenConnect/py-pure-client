...
from pypureclient.flasharray.FA_2_47.models.chap import Chap
from pypureclient.flasharray.FA_2_47.models.non_copyable_tag import NonCopyableTag
...
class HostPost(BaseModel):
    ...
    __properties = ["chap", "iqns", "nqns", "personality", "preferred_arrays", "tags", "vlan", "wwns"]
