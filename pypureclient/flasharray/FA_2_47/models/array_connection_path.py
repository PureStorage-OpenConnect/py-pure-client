...
class ArrayConnectionPath(BaseModel):
    ...
    __properties = ["name", "encryption", "encryption_mode", "id", "local_address", "local_port", "remote", "remote_address", "remote_port", "replication_transport", "status", "status_details", "type"]
