...
from pypureclient.flasharray.FA_2_47.models.host_port_connectivity import HostPortConnectivity
...
class Host(BaseModel):
    ...
    time_remaining: Optional[StrictInt] = Field(default=None, description="The amount of time left until the destroyed host is permanently eradicated, measured in milliseconds.")
    ...
    __properties = ["name", "context", "chap", "connection_count", "destroyed", "host_group", "iqns", "is_local", "nqns", "personality", "port_connectivity", "preferred_arrays", "space", "time_remaining", "vlan", "wwns"]
