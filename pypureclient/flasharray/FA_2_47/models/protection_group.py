...
from pypureclient.flasharray.FA_2_47.models.fixed_reference import FixedReference
from pypureclient.flasharray.FA_2_47.models.fixed_reference_with_type import FixedReferenceWithType
from pypureclient.flasharray.FA_2_47.models.protection_group_eradication_config import ProtectionGroupEradicationConfig
from pypureclient.flasharray.FA_2_47.models.replication_schedule import ReplicationSchedule
from pypureclient.flasharray.FA_2_47.models.retention_policy import RetentionPolicy
from pypureclient.flasharray.FA_2_47.models.snapshot_schedule import SnapshotSchedule
...
class ProtectionGroup(BaseModel):
    ...
    __properties = ["name", "id", "context", "workload", "destroyed", "eradication_config", "host_count", "host_group_count", "is_local", "pod", "replication_schedule", "retention_lock", "snapshot_schedule", "source", "source_retention", "space", "target_count", "target_retention", "time_remaining", "volume_count"]
    ...
    def from_dict(cls, obj: dict) -> ProtectionGroup:
        ...
        _obj = ProtectionGroup.construct(_fields_set=None, **{
            ...
            "eradication_config": ProtectionGroupEradicationConfig.from_dict(obj.get("eradication_config")) if obj.get("eradication_config") is not None else None,
