...
from pypureclient.flasharray.FA_2_47.models.priority_adjustment import PriorityAdjustment
from pypureclient.flasharray.FA_2_47.models.qos import Qos
from pypureclient.flasharray.FA_2_47.models.reference import Reference
from pypureclient.flasharray.FA_2_47.models.space import Space
from pypureclient.flasharray.FA_2_47.models.workload_configuration_fixed_reference_workload import WorkloadConfigurationFixedReferenceWorkload
...
class VolumeGroup(BaseModel):
    ...
    workload: Optional[WorkloadConfigurationFixedReferenceWorkload] = None
    ...
    __properties = ["id", "name", "context", "workload", "destroyed", "pod", "priority_adjustment", "qos", "space", "time_remaining", "volume_count"]
    ...
    def from_dict(cls, obj: dict) -> VolumeGroup:
        ...
        _obj = VolumeGroup.construct(_fields_set=None, **{
            ...
            "workload": WorkloadConfigurationFixedReferenceWorkload.from_dict(obj.get("workload")) if obj.get("workload") is not None else None,
