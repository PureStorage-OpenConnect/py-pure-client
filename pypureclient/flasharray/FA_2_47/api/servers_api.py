...
from pypureclient.flasharray.FA_2_47.models.server_get_response import ServerGetResponse
from pypureclient.flasharray.FA_2_47.models.server_patch import ServerPatch
from pypureclient.flasharray.FA_2_47.models.server_post import ServerPost
from pypureclient.flasharray.FA_2_47.models.server_response import ServerResponse
from typing import Optional
...
class ServersApi:
    ...
    def api247_servers_delete_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api247_servers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api247_servers_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api247_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api247_servers_patch_with_http_info(
        self,
        server: ServerPatch,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api247_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api247_servers_post_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api247_servers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
