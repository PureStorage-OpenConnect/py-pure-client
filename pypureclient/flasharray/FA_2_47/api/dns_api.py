...
from pypureclient.flasharray.FA_2_47.models.dns_get_response import DnsGetResponse
from pypureclient.flasharray.FA_2_47.models.dns_patch import DnsPatch
from pypureclient.flasharray.FA_2_47.models.dns_post import DnsPost
from pypureclient.flasharray.FA_2_47.models.dns_response import DnsResponse
from typing import Optional
...
class DNSApi:
    ...
    def api247_dns_delete_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api247_dns_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api247_dns_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
    ...
    def api247_dns_patch_with_http_info(
        self,
        dns: DnsPatch,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api247_dns_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api247_dns_post_with_http_info(
        self,
        dns: DnsPost,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api247_dns_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
