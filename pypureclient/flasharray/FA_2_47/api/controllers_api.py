...
from pypureclient.flasharray.common.models.controller_get_response_v_30 import ControllerGetResponse
...
class ControllersApi:
    ...
    def api247_controllers_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api247_controllers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
