...
from pypureclient.flasharray.FA_2_47.models.session_get_response import SessionGetResponse
from typing import Optional
...
class SessionsApi:
    ...
    def api247_sessions_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api247_sessions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
