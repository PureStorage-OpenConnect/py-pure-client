...
from pypureclient.flasharray.common.models.audit_get_response_v_47 import AuditGetResponse
...
class AuditsApi:
    ...
    def api247_audits_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api247_audits_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
