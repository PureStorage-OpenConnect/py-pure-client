...
from pypureclient.flasharray.FA_2_11.models.host_get_response import HostGetResponse
from pypureclient.flasharray.FA_2_11.models.host_patch import HostPatch
from pypureclient.flasharray.FA_2_11.models.host_performance_balance_get_response import HostPerformanceBalanceGetResponse
from pypureclient.flasharray.FA_2_11.models.host_post import HostPost
from pypureclient.flasharray.FA_2_11.models.host_response import HostResponse
from pypureclient.flasharray.FA_2_11.models.member_no_id_all_get_response import MemberNoIdAllGetResponse
from pypureclient.flasharray.FA_2_11.models.member_no_id_all_response import MemberNoIdAllResponse
from pypureclient.flasharray.FA_2_11.models.resource_performance_no_id_by_array_get_response import ResourcePerformanceNoIdByArrayGetResponse
from pypureclient.flasharray.FA_2_11.models.resource_performance_no_id_get_response import ResourcePerformanceNoIdGetResponse
from pypureclient.flasharray.FA_2_11.models.resource_space_no_id_get_response import ResourceSpaceNoIdGetResponse
...
class HostsApi:
    ...
    def api211_hosts_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_hosts_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api211_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api211_hosts_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_hosts_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api211_hosts_host_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_hosts_host_groups_delete_with_http_info(authorization, x_request_id, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_hosts_host_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api211_hosts_host_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_hosts_host_groups_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_names, limit, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_hosts_host_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api211_hosts_host_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_hosts_host_groups_post_with_http_info(authorization, x_request_id, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_hosts_host_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api211_hosts_patch_with_http_info(
        ...
        **kwargs
        ...
        """Manage a host  # noqa: E501

        Manages an existing host, including its storage network addresses, CHAP, host personality, and preferred arrays, or associate a host to a host group. The `names` query parameter is required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api211_hosts_patch_with_http_info(host, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_hosts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api211_hosts_performance_balance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_hosts_performance_balance_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_hosts_performance_balance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_hosts_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api211_hosts_performance_get_with_http_info(
        ...
        **kwargs
        ...
        Displays real-time and historical performance data, real-time latency data, and average I/O sizes across all volumes, displayed both by host and as a total across all hosts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api211_hosts_performance_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_hosts_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api211_hosts_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_hosts_post_with_http_info(host, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api211_hosts_protection_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_hosts_protection_groups_delete_with_http_info(authorization, x_request_id, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_hosts_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api211_hosts_protection_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_hosts_protection_groups_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_names, limit, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_hosts_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api211_hosts_protection_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_hosts_protection_groups_post_with_http_info(authorization, x_request_id, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_hosts_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api211_hosts_space_get_with_http_info(
        ...
        **kwargs
        ...
        Returns provisioned size and physical storage consumption data for each host.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api211_hosts_space_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_hosts_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
