...
class RemoteVolumeSnapshotsApi:
    ...
    def api211_remote_volume_snapshots_delete_with_http_info(
        ...
        _param = self._api211_remote_volume_snapshots_delete_serialize(
    ...
    def _api211_remote_volume_snapshots_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/remote-volume-snapshots',
    ...
    def api211_remote_volume_snapshots_get_with_http_info(
        ...
        _param = self._api211_remote_volume_snapshots_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            destroyed = destroyed,
            filter = filter,
    ...
    def _api211_remote_volume_snapshots_get_serialize(
        self,
        authorization,
        x_request_id,
        destroyed,
    ...
    def api211_remote_volume_snapshots_patch_with_http_info(
        ...
        _param = self._api211_remote_volume_snapshots_patch_serialize(
    ...
    def _api211_remote_volume_snapshots_patch_serialize(
        self,
    ...
    def api211_remote_volume_snapshots_post_with_http_info(
        ...
        _param = self._api211_remote_volume_snapshots_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            source_ids = source_ids,
            source_names = source_names,
    ...
    def _api211_remote_volume_snapshots_post_serialize(
        self,
        authorization,
        x_request_id,
        source_ids,
    ...
    def api211_remote_volume_snapshots_transfer_get_with_http_info(
        ...
        _param = self._api211_remote_volume_snapshots_transfer_get_serialize(
            names = names,
            authorization = authorization,
            x_request_id = x_request_id,
            destroyed = destroyed,
    ...
    def _api211_remote_volume_snapshots_transfer_get_serialize(
        self,
        names,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.11/remote-volume-snapshots/transfer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
