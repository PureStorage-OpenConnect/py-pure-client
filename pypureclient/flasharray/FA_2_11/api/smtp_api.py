...
from pypureclient.flasharray.FA_2_11.models.smtp_server_get_response import SmtpServerGetResponse
from pypureclient.flasharray.FA_2_11.models.smtp_server_response import SmtpServerResponse
...
class SMTPApi:
    ...
    def api211_smtp_servers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_smtp_servers_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api211_smtp_servers_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_smtp_servers_patch_with_http_info(smtp, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
