...
from pypureclient.flasharray.FA_2_11.models.virtual_machine_post import VirtualMachinePost
from pypureclient.flasharray.FA_2_11.models.virtual_machine_response import VirtualMachineResponse
...
class VirtualMachinesApi:
    ...
    def api211_virtual_machines_patch_with_http_info(
        ...
        **kwargs
        ...
        """Modify a virtual machine  # noqa: E501

        Modifies a virtual machine, recovering it from the destroyed state. If recovering the virtual machine causes a conflict with an existing virtual machine, the operation fails.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api211_virtual_machines_patch_with_http_info(virtual_machine, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api211_virtual_machines_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_virtual_machines_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
