...
class ReplicaLinkPerformanceReplication(BaseModel):
    ...
    """ # noqa: E501
    bytes_per_sec_from_remote: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The number of bytes received per second from a remote array.")
    bytes_per_sec_to_remote: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The number of bytes transmitted per second to a remote array.")
    bytes_per_sec_total: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Total bytes transmitted and received per second.")
    ...
    __properties: ClassVar[List[str]] = ["bytes_per_sec_from_remote", "bytes_per_sec_to_remote", "bytes_per_sec_total", "direction", "local_pod", "remotes", "remote_pod", "time"]
