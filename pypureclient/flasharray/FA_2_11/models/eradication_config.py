...
class EradicationConfig(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            manual_eradication (str): Manual eradication status applied on the array level. If status is `all-disabled`, you cannot eradicate objects, files, and directories. Values include `all-disabled` and `all-enabled`.
        """
