...
from pypureclient.flasharray.FA_2_11.models.port import Port
from pypureclient.flasharray.FA_2_11.models.port_common import PortCommon
...
class HostPerformanceBalance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "op_count", "fraction_relative_to_max", "initiator", "target", "time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "target": Port.from_dict(obj["target"]) if obj.get("target") is not None else None,
            "time": obj.get("time")
        })
        return _obj
