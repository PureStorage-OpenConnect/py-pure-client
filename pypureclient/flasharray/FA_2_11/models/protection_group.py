...
from pypureclient.flasharray.FA_2_11.models.replication_schedule import ReplicationSchedule
from pypureclient.flasharray.FA_2_11.models.retention_policy import RetentionPolicy
from pypureclient.flasharray.FA_2_11.models.snapshot_schedule import SnapshotSchedule
from pypureclient.flasharray.FA_2_11.models.space import Space
...
class ProtectionGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "destroyed", "host_count", "host_group_count", "is_local", "pod", "replication_schedule", "snapshot_schedule", "source", "source_retention", "space", "target_retention", "target_count", "time_remaining", "volume_count"]
