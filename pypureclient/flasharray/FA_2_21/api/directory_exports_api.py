...
from pypureclient.flasharray.FA_2_21.models.directory_export_get_response import DirectoryExportGetResponse
from pypureclient.flasharray.FA_2_21.models.directory_export_post import DirectoryExportPost
from pypureclient.flasharray.FA_2_21.models.directory_export_response import DirectoryExportResponse
...
class DirectoryExportsApi:
    ...
    def api221_directory_exports_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api221_directory_exports_delete_with_http_info(authorization, x_request_id, export_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api221_directory_exports_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api221_directory_exports_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api221_directory_exports_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, directory_ids, directory_names, export_names, filter, limit, offset, policy_ids, policy_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directory_exports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api221_directory_exports_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api221_directory_exports_post_with_http_info(exports, authorization, x_request_id, directory_ids, directory_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_directory_exports_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
