...
class PodPerformance(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            usec_per_other_op (int): The average time it takes the pod to process an I/O other request, measured in microseconds. The average time does not include SAN time, queue time, or QoS rate limit time.
        """
