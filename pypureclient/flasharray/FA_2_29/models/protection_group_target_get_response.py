...
class ProtectionGroupTargetGetResponse(BaseModel):
    ...
    items: Optional[List[TargetProtectionGroup]] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
