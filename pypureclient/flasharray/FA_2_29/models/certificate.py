...
class Certificate(BaseModel):
    ...
    __properties = ["name", "certificate", "common_name", "country", "email", "intermediate_certificate", "issued_by", "issued_to", "key_size", "locality", "organization", "organizational_unit", "state", "status", "valid_from", "valid_to"]
