...
class MemberResponse(BaseModel):
    ...
    MemberResponse
    """ # noqa: E501
    items: Optional[List[Member]] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful. If `total_only=true`, the `items` list will be empty.")
