...
class ProtectionGroupSnapshotsApi(object):
    ...
    def api229_protection_group_snapshots_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api229_protection_group_snapshots_get`, must be a value greater than or equal to `1`")
    ...
    def api229_protection_group_snapshots_transfer_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api229_protection_group_snapshots_transfer_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
