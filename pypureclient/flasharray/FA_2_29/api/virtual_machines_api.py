...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_29.models.virtual_machine_get_response import VirtualMachineGetResponse
from pypureclient.flasharray.FA_2_29.models.virtual_machine_post import VirtualMachinePost
from pypureclient.flasharray.FA_2_29.models.virtual_machine_response import VirtualMachineResponse
...
class VirtualMachinesApi:
    ...
    def api229_virtual_machine_snapshots_get_with_http_info(
        ...
        _param = self._api229_virtual_machine_snapshots_get_serialize(
    ...
    def _api229_virtual_machine_snapshots_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.29/virtual-machine-snapshots',
    ...
    def api229_virtual_machines_get_with_http_info(
        ...
        _param = self._api229_virtual_machines_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            destroyed = destroyed,
    ...
    def _api229_virtual_machines_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.29/virtual-machines',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api229_virtual_machines_patch_with_http_info(
        ...
        _param = self._api229_virtual_machines_patch_serialize(
    ...
    def _api229_virtual_machines_patch_serialize(
        self,
        virtual_machine,
        authorization,
        x_request_id,
    ...
    def api229_virtual_machines_post_with_http_info(
        ...
        _param = self._api229_virtual_machines_post_serialize(
            virtual_machine = virtual_machine,
            authorization = authorization,
            x_request_id = x_request_id,
            overwrite = overwrite,
    ...
    def _api229_virtual_machines_post_serialize(
        self,
        virtual_machine,
        authorization,
        x_request_id,
