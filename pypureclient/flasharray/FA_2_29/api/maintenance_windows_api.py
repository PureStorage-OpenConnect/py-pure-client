...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_29.models.maintenance_window_post import MaintenanceWindowPost
from pypureclient.flasharray.FA_2_29.models.maintenance_windows_get_response import MaintenanceWindowsGetResponse
from pypureclient.flasharray.FA_2_29.models.maintenance_windows_response import MaintenanceWindowsResponse
...
class MaintenanceWindowsApi:
    ...
    def api229_maintenance_windows_delete_with_http_info(
        ...
        _param = self._api229_maintenance_windows_delete_serialize(
    ...
    def _api229_maintenance_windows_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.29/maintenance-windows',
    ...
    def api229_maintenance_windows_get_with_http_info(
        ...
        _param = self._api229_maintenance_windows_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api229_maintenance_windows_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api229_maintenance_windows_post_with_http_info(
        ...
        _param = self._api229_maintenance_windows_post_serialize(
    ...
    def _api229_maintenance_windows_post_serialize(
        self,
        maintenance_window,
        authorization,
        x_request_id,
