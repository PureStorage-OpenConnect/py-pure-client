...
from pypureclient.flasharray.FA_2_29.models.smis_get_response import SmisGetResponse
from pypureclient.flasharray.FA_2_29.models.smis_response import SmisResponse
from typing import Optional
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api229_smi_s_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api229_smi_s_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
