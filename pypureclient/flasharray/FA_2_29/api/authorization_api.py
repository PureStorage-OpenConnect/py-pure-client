...
class AuthorizationApi:
    ...
    def api229_login_post_with_http_info(
        ...
        _param = self._api229_login_post_serialize(
    ...
    def _api229_login_post_serialize(
        self,
        x_request_id,
        api_token,
    ) -> RequestSerialized:
    ...
    def api229_logout_post_with_http_info(
        ...
        _param = self._api229_logout_post_serialize(
            x_request_id = x_request_id,
    ...
    def _api229_logout_post_serialize(
        self,
        x_request_id,
        x_auth_token,
    ) -> RequestSerialized:
