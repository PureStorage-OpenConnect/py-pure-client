...
from pypureclient.flasharray.FA_2_29.models.remote_volume_snapshot_get_response import RemoteVolumeSnapshotGetResponse
from pypureclient.flasharray.FA_2_29.models.remote_volume_snapshot_post import RemoteVolumeSnapshotPost
from pypureclient.flasharray.FA_2_29.models.remote_volume_snapshot_response import RemoteVolumeSnapshotResponse
from pypureclient.flasharray.FA_2_29.models.remote_volume_snapshot_transfer_get_response import RemoteVolumeSnapshotTransferGetResponse
...
class RemoteVolumeSnapshotsApi:
    ...
    def api229_remote_volume_snapshots_delete_with_http_info(
        ...
        _param = self._api229_remote_volume_snapshots_delete_serialize(
    ...
    def _api229_remote_volume_snapshots_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.29/remote-volume-snapshots',
    ...
    def api229_remote_volume_snapshots_get_with_http_info(
        ...
        _param = self._api229_remote_volume_snapshots_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            destroyed = destroyed,
            filter = filter,
    ...
    def _api229_remote_volume_snapshots_get_serialize(
        self,
        authorization,
        x_request_id,
        destroyed,
    ...
    def api229_remote_volume_snapshots_patch_with_http_info(
        ...
        _param = self._api229_remote_volume_snapshots_patch_serialize(
    ...
    def _api229_remote_volume_snapshots_patch_serialize(
        self,
    ...
    def api229_remote_volume_snapshots_post_with_http_info(
        ...
        _param = self._api229_remote_volume_snapshots_post_serialize(
            remote_volume_snapshot = remote_volume_snapshot,
            authorization = authorization,
            x_request_id = x_request_id,
            source_ids = source_ids,
    ...
    def _api229_remote_volume_snapshots_post_serialize(
        self,
        remote_volume_snapshot,
        authorization,
        x_request_id,
    ...
    def api229_remote_volume_snapshots_transfer_get_with_http_info(
        ...
        _param = self._api229_remote_volume_snapshots_transfer_get_serialize(
            names = names,
            authorization = authorization,
            x_request_id = x_request_id,
            destroyed = destroyed,
    ...
    def _api229_remote_volume_snapshots_transfer_get_serialize(
        self,
        names,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.29/remote-volume-snapshots/transfer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
