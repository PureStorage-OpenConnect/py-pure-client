...
class PolicyAuditFilePatch(BaseModel):
    ...
    log_targets: Optional[List[ReferenceNoIdWithType]] = Field(default=None, description="A list of targets to which audit logs will be sent. This list, if sent, overrides existing target list.")
    __properties: ClassVar[List[str]] = ["name", "enabled", "log_targets"]
