...
from pypureclient.flasharray.FA_2_37.models.policy_audit_file import PolicyAuditFile
...
class PolicyAuditFileGetResponse(BaseModel):
    ...
    items: Optional[conlist(PolicyAuditFile)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
