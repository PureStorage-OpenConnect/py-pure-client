...
class PolicyAuditFileGetResponse(BaseModel):
    ...
    items: Optional[List[PolicyAuditFile]] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
