...
from pypureclient.flasharray.FA_2_37.models.target_protection_group import TargetProtectionGroup
...
class ProtectionGroupTargetGetResponse(BaseModel):
    ...
    items: Optional[conlist(TargetProtectionGroup)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
