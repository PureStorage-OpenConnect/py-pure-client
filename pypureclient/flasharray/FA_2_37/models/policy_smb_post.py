...
from pypureclient.flasharray.FA_2_37.models.policynfspost_policy_mapping import PolicynfspostPolicyMapping
...
class PolicySmbPost(BaseModel):
    ...
    __properties = ["enabled", "access_based_enumeration_enabled", "policy_mapping"]
