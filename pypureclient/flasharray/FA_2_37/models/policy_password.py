...
class PolicyPassword(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "enforce_dictionary_check", "enforce_username_check", "lockout_duration", "max_login_attempts", "min_character_groups", "min_characters_per_group", "min_password_age", "min_password_length", "password_history", "policy_type"]
