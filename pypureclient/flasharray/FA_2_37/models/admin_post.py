...
from pypureclient.flasharray.FA_2_37.models.admin_role import AdminRole
...
class AdminPost(BaseModel):
    ...
    AdminPost
    """
    management_access_policies: Optional[conlist(ReferenceWithType)] = Field(default=None, description="List of management access policies to associate with the administrator. Policies can be specified by the `name` or `ID` parameter, but they cannot be set together.")
    password: Optional[StrictStr] = Field(default=None, description="Password associated with the account.")
    role: Optional[AdminRole] = None
    __properties = ["management_access_policies", "password", "role"]
