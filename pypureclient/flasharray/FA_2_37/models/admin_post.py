...
class AdminPost(BaseModel):
    ...
    management_access_policies: Optional[List[ReferenceWithType]] = Field(default=None, description="List of management access policies to associate with the administrator. Policies can be specified by the `name` or `ID` parameter, but they cannot be set together.")
    __properties: ClassVar[List[str]] = ["password", "role", "management_access_policies"]
