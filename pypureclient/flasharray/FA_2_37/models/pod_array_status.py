...
class PodArrayStatus(BaseModel):
    ...
    member: Optional[ReferenceWithType] = Field(default=None, description="A reference to the member associated with the pod's array status.")
    __properties: ClassVar[List[str]] = ["id", "name", "frozen_at", "mediator_status", "pre_elected", "progress", "status", "member"]
