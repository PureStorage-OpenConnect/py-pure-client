...
class LogTargetFile(BaseModel):
    ...
    keep_for: Optional[Annotated[int, Field(strict=True, ge=86400000)]] = Field(default=None, description="Specifies the period that audit logs are retained before they are deleted, in milliseconds. If not specified, defaults to `null` which means size based retention does not apply. Use 0 to reset the value to `null`. At least one of the `keep_for` or `keep_size` parameters are required, and they can be set together.")
    keep_size: Optional[Annotated[int, Field(strict=True, ge=1000000)]] = Field(default=None, description="Specifies the maximum size of audit logs to be retained. Measured in bytes. When exceeded, older logs will be deleted. If not specified, defaults to `null` which means size based retention does not apply. Use 0 to reset the value to `null`.")
    __properties: ClassVar[List[str]] = ["name", "target_type", "directory", "keep_for", "keep_size"]
