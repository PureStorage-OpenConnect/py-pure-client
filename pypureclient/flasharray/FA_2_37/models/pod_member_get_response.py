...
class PodMemberGetResponse(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            items (list[PodMember]): Returns a list of all items after filtering. The values are displayed for each name, where meaningful. If `total_only=true`, the `items` list will be empty.
        """
