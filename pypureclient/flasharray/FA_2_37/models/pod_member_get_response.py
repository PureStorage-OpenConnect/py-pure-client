...
class PodMemberGetResponse(BaseModel):
    ...
    items: Optional[List[PodMember]] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name, where meaningful. If `total_only=true`, the `items` list will be empty.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [PodMember.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
