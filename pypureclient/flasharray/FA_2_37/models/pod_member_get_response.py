...
from pypureclient.flasharray.FA_2_37.models.pod_member import PodMember
...
class PodMemberGetResponse(BaseModel):
    ...
    items: Optional[conlist(PodMember)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name, where meaningful. If `total_only=true`, the `items` list will be empty.")
