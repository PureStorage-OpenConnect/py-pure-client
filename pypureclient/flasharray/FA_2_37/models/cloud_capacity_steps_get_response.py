...
from pypureclient.flasharray.FA_2_37.models.cloud_capacity_step import CloudCapacityStep


class CloudCapacityStepsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(CloudCapacityStep)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloudCapacityStepsGetResponse:
        """Create an instance of CloudCapacityStepsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CloudCapacityStepsGetResponse:
        """Create an instance of CloudCapacityStepsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CloudCapacityStepsGetResponse.parse_obj(obj)

        _obj = CloudCapacityStepsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [CloudCapacityStep.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
