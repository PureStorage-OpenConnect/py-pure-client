...
from pypureclient.flasharray.FA_2_37.models.host import Host
...
class HostGetResponse(BaseModel):
    ...
    items: Optional[conlist(Host)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
