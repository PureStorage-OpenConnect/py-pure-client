...
from pypureclient.flasharray.FA_2_37.models.container_eradication_config import ContainerEradicationConfig
from pypureclient.flasharray.FA_2_37.models.fixed_reference import FixedReference
from pypureclient.flasharray.FA_2_37.models.pod_array_status import PodArrayStatus
from pypureclient.flasharray.FA_2_37.models.pod_space import PodSpace
...
class Pod(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "arrays", "destroyed", "failover_preferences", "footprint", "mediator", "mediator_version", "source", "time_remaining", "requested_promotion_state", "promotion_status", "link_source_count", "link_target_count", "array_count", "eradication_config", "quota_limit", "space", "members"]
