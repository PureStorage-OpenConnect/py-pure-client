...
class Pod(BaseModel):
    ...
    __properties = ["id", "name", "array_count", "arrays", "destroyed", "eradication_config", "failover_preferences", "footprint", "link_source_count", "link_target_count", "mediator", "mediator_version", "members", "promotion_status", "quota_limit", "requested_promotion_state", "source", "space", "time_remaining"]
