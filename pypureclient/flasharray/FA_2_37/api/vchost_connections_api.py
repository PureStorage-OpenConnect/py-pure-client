...
class VchostConnectionsApi:
    ...
    def api237_vchost_connections_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_vchost_connections_delete_with_http_info(authorization, x_request_id, all_vchosts, protocol_endpoint_ids, protocol_endpoint_names, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
    ...
    def api237_vchost_connections_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_vchost_connections_get_with_http_info(authorization, x_request_id, all_vchosts, continuation_token, filter, limit, offset, protocol_endpoint_ids, protocol_endpoint_names, sort, total_item_count, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
    ...
    def api237_vchost_connections_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_vchost_connections_post_with_http_info(authorization, x_request_id, all_vchosts, allow_stretched_multi_vchost, protocol_endpoint_ids, protocol_endpoint_names, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
