...
from pypureclient.flasharray.FA_2_37.models.fleet_get_response import FleetGetResponse
from pypureclient.flasharray.FA_2_37.models.fleet_key_get_response import FleetKeyGetResponse
from pypureclient.flasharray.FA_2_37.models.fleet_key_response import FleetKeyResponse
from pypureclient.flasharray.FA_2_37.models.fleet_member_get_response import FleetMemberGetResponse
from pypureclient.flasharray.FA_2_37.models.fleet_member_post import FleetMemberPost
from pypureclient.flasharray.FA_2_37.models.fleet_member_response import FleetMemberResponse
from pypureclient.flasharray.FA_2_37.models.fleet_response import FleetResponse
...
class FleetsApi:
    ...
    def api237_fleets_fleet_key_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_fleets_fleet_key_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api237_fleets_fleet_key_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_fleets_fleet_key_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_fleets_fleet_key_post_with_http_info(authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_fleets_fleet_key_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_fleets_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_fleets_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_fleets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_fleets_members_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_fleets_members_delete_with_http_info(authorization, x_request_id, member_ids, member_names, unreachable, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_fleets_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_fleets_members_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_fleets_members_get_with_http_info(authorization, x_request_id, continuation_token, filter, fleet_ids, fleet_names, limit, member_ids, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_fleets_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_fleets_members_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_fleets_members_post_with_http_info(authorization, x_request_id, fleet_ids, fleet_names, members, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_fleets_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_fleets_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_fleets_post_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_fleets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
