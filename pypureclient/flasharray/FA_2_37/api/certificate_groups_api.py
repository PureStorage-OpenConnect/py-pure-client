...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_37.models.certificate_group_certificate_get_response import CertificateGroupCertificateGetResponse
from pypureclient.flasharray.FA_2_37.models.certificate_group_certificate_response import CertificateGroupCertificateResponse
from pypureclient.flasharray.FA_2_37.models.certificate_group_get_response import CertificateGroupGetResponse
from pypureclient.flasharray.FA_2_37.models.certificate_group_response import CertificateGroupResponse
...
class CertificateGroupsApi:
    ...
    def api237_certificate_groups_certificates_delete_with_http_info(
        ...
        _param = self._api237_certificate_groups_certificates_delete_serialize(
    ...
    def _api237_certificate_groups_certificates_delete_serialize(
        self,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.37/certificate-groups/certificates',
    ...
    def api237_certificate_groups_certificates_get_with_http_info(
        ...
        _param = self._api237_certificate_groups_certificates_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api237_certificate_groups_certificates_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api237_certificate_groups_certificates_post_with_http_info(
        ...
        _param = self._api237_certificate_groups_certificates_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            certificate_group_ids = certificate_group_ids,
            certificate_group_names = certificate_group_names,
    ...
    def _api237_certificate_groups_certificates_post_serialize(
        self,
        authorization,
        x_request_id,
        certificate_group_ids,
    ...
    def api237_certificate_groups_delete_with_http_info(
        ...
        _param = self._api237_certificate_groups_delete_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            ids = ids,
            names = names,
    ...
    def _api237_certificate_groups_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.37/certificate-groups',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api237_certificate_groups_get_with_http_info(
        ...
        _param = self._api237_certificate_groups_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api237_certificate_groups_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api237_certificate_groups_post_with_http_info(
        ...
        _param = self._api237_certificate_groups_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api237_certificate_groups_post_serialize(
        self,
        authorization,
        x_request_id,
        names,
