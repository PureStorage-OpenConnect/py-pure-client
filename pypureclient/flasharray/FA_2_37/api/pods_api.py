...
from pypureclient.flasharray.FA_2_37.models.member_get_response import MemberGetResponse
from pypureclient.flasharray.FA_2_37.models.member_response import MemberResponse
from pypureclient.flasharray.FA_2_37.models.pod_get_response import PodGetResponse
from pypureclient.flasharray.FA_2_37.models.pod_member_get_response import PodMemberGetResponse
from pypureclient.flasharray.FA_2_37.models.pod_member_response import PodMemberResponse
from pypureclient.flasharray.FA_2_37.models.pod_patch import PodPatch
from pypureclient.flasharray.FA_2_37.models.pod_performance_by_array_get_response import PodPerformanceByArrayGetResponse
from pypureclient.flasharray.FA_2_37.models.pod_performance_replication_by_array_get_response import PodPerformanceReplicationByArrayGetResponse
from pypureclient.flasharray.FA_2_37.models.pod_performance_replication_get_response import PodPerformanceReplicationGetResponse
from pypureclient.flasharray.FA_2_37.models.pod_post import PodPost
from pypureclient.flasharray.FA_2_37.models.pod_response import PodResponse
from pypureclient.flasharray.FA_2_37.models.resource_pod_space_get_response import ResourcePodSpaceGetResponse
from pypureclient.flasharray.FA_2_37.models.test_result_with_resource_with_id_post_response import TestResultWithResourceWithIdPostResponse
...
class PodsApi:
    ...
    def api237_pods_arrays_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_arrays_delete_with_http_info(authorization, x_request_id, group_ids, group_names, member_ids, member_names, with_unknown, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api237_pods_arrays_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_arrays_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_arrays_post_with_http_info(authorization, x_request_id, group_ids, group_names, member_ids, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_arrays_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_delete_with_http_info(authorization, x_request_id, eradicate_contents, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, ids, limit, names, offset, sort, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_members_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_members_delete_with_http_info(authorization, x_request_id, member_ids, member_names, pod_ids, pod_names, with_unknown, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_members_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_members_get_with_http_info(authorization, x_request_id, filter, limit, member_ids, member_names, offset, pod_ids, pod_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_members_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_members_post_with_http_info(authorization, x_request_id, member_ids, member_names, pod_ids, pod_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_patch_with_http_info(pod, authorization, x_request_id, abort_quiesce, destroy_contents, from_member_ids, from_member_names, ids, move_with_host_group_names, move_with_host_names, names, promote_from, quiesce, skip_quiesce, to_member_ids, to_member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_performance_by_array_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_performance_by_array_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, protocol, protocol_group, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_performance_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, protocol, protocol_group, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_performance_replication_by_array_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_performance_replication_by_array_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_performance_replication_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_performance_replication_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_performance_replication_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_post_with_http_info(pod, authorization, x_request_id, allow_throttle, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_space_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_space_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api237_pods_test_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api237_pods_test_post_with_http_info(pod, authorization, x_request_id, allow_throttle, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_pods_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
