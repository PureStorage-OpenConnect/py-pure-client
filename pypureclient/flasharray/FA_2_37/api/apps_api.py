...
class AppsApi:
    ...
    def api237_apps_get_with_http_info(
        ...
        _param = self._api237_apps_get_serialize(
    ...
    def _api237_apps_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api237_apps_nodes_get_with_http_info(
        ...
        _param = self._api237_apps_nodes_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            app_names = app_names,
    ...
    def _api237_apps_nodes_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.37/apps/nodes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api237_apps_patch_with_http_info(
        ...
        _param = self._api237_apps_patch_serialize(
            names = names,
            app = app,
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api237_apps_patch_serialize(
        self,
        names,
        app,
        authorization,
