...
class DrivesApi:
    ...
    def api237_drives_get_with_http_info(
        ...
        _param = self._api237_drives_get_serialize(
    ...
    def _api237_drives_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api237_drives_patch_with_http_info(
        ...
        _param = self._api237_drives_patch_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            admit = admit,
        )
    ...
    def _api237_drives_patch_serialize(
        self,
        authorization,
        x_request_id,
        admit,
