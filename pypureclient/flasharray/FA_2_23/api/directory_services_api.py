...
class DirectoryServicesApi:
    ...
    def api223_directory_services_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api223_directory_services_local_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_groups_delete_with_http_info(authorization, x_request_id, gids, names, sids, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_local_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_groups_get_with_http_info(authorization, x_request_id, continuation_token, filter, gids, ids, limit, names, offset, sids, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_local_groups_members_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_groups_members_delete_with_http_info(authorization, x_request_id, group_gids, group_names, group_sids, member_ids, member_names, member_sids, member_types, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_groups_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_local_groups_members_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_groups_members_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_gids, group_names, group_sids, limit, member_ids, member_names, member_sids, member_types, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_groups_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_local_groups_members_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_groups_members_post_with_http_info(local_membership, authorization, x_request_id, group_gids, group_names, group_sids, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_groups_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_local_groups_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_groups_patch_with_http_info(local_group, authorization, x_request_id, gids, names, sids, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_local_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_groups_post_with_http_info(names, authorization, x_request_id, local_group, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_local_users_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_users_delete_with_http_info(authorization, x_request_id, names, sids, uids, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_users_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_local_users_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_users_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sids, sort, total_item_count, uids, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_users_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_local_users_members_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_users_members_delete_with_http_info(authorization, x_request_id, group_gids, group_names, group_sids, member_ids, member_names, member_sids, member_types, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_users_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_local_users_members_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_users_members_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_gids, group_names, group_sids, limit, member_ids, member_names, member_sids, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_users_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_local_users_members_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_users_members_post_with_http_info(local_membership, authorization, x_request_id, member_ids, member_names, member_sids, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_users_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_local_users_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_users_patch_with_http_info(local_user, authorization, x_request_id, keep_open_sessions, names, sids, uids, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_users_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_local_users_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_local_users_post_with_http_info(names, authorization, x_request_id, local_user, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_directory_services_local_users_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_directory_services_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_patch_with_http_info(names, directory_service, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
    ...
    def api223_directory_services_roles_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_roles_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, offset, role_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api223_directory_services_roles_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_roles_patch_with_http_info(role_names, directory_service_roles, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
    ...
    def api223_directory_services_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_directory_services_test_get_with_http_info(names, authorization, x_request_id, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
