...
class KMIPApi:
    ...
    def api223_kmip_delete_with_http_info(
        ...
        _param = self._api223_kmip_delete_serialize(
    ...
    def _api223_kmip_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
    ...
    def api223_kmip_get_with_http_info(
        ...
        _param = self._api223_kmip_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api223_kmip_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api223_kmip_patch_with_http_info(
        ...
        _param = self._api223_kmip_patch_serialize(
            kmip = kmip,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api223_kmip_patch_serialize(
        self,
        kmip,
        authorization,
        x_request_id,
    ...
    def api223_kmip_post_with_http_info(
        ...
        _param = self._api223_kmip_post_serialize(
            kmip = kmip,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api223_kmip_post_serialize(
        self,
        kmip,
        authorization,
        x_request_id,
    ...
    def api223_kmip_test_get_with_http_info(
        ...
        _param = self._api223_kmip_test_get_serialize(
            names = names,
            authorization = authorization,
            x_request_id = x_request_id,
        )
    ...
    def _api223_kmip_test_get_serialize(
        self,
        names,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.23/kmip/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
