...
from pypureclient.flasharray.FA_2_23.models.host_get_response import HostGetResponse
from pypureclient.flasharray.FA_2_23.models.host_patch import HostPatch
from pypureclient.flasharray.FA_2_23.models.host_performance_balance_get_response import HostPerformanceBalanceGetResponse
from pypureclient.flasharray.FA_2_23.models.host_post import HostPost
from pypureclient.flasharray.FA_2_23.models.host_response import HostResponse
...
class HostsApi:
    ...
    def api223_hosts_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api223_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hosts_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hosts_host_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_host_groups_delete_with_http_info(authorization, x_request_id, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hosts_host_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hosts_host_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_host_groups_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_names, limit, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hosts_host_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hosts_host_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_host_groups_post_with_http_info(authorization, x_request_id, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hosts_host_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hosts_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_patch_with_http_info(host, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hosts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hosts_performance_balance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_performance_balance_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hosts_performance_balance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hosts_performance_by_array_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_performance_by_array_get_with_http_info(authorization, x_request_id, end_time, filter, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hosts_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hosts_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_performance_get_with_http_info(authorization, x_request_id, end_time, filter, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hosts_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hosts_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_post_with_http_info(host, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hosts_protection_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_protection_groups_delete_with_http_info(authorization, x_request_id, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hosts_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hosts_protection_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_protection_groups_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_names, limit, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hosts_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hosts_protection_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_protection_groups_post_with_http_info(authorization, x_request_id, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hosts_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hosts_space_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_hosts_space_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hosts_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
