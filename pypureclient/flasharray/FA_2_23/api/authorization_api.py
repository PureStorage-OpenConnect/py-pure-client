...
from pypureclient.flasharray.FA_2_23.models.api_version_response import ApiVersionResponse
from pypureclient.flasharray.FA_2_23.models.oauth_token_response import OauthTokenResponse
from pypureclient.flasharray.FA_2_23.models.username_response import UsernameResponse
...
class AuthorizationApi:
    ...
    def api223_login_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_login_post_with_http_info(api_token, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api223_login_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_logout_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api223_logout_post_with_http_info(x_auth_token, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_logout_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
