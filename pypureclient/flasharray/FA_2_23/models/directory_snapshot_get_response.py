...
from pypureclient.flasharray.FA_2_23.models.directory_snapshot import DirectorySnapshot
...
class DirectorySnapshotGetResponse(BaseModel):
    ...
    items: Optional[List[DirectorySnapshot]] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if applicable.")
    total: Optional[List[DirectorySnapshot]] = Field(default=None, description="The aggregate value of all items after filtering. If applicable, the average value is displayed instead. The values are displayed for each field, if applicable.")
