...
from pypureclient.flasharray.FA_2_23.models.policy_rule_smb_client import PolicyRuleSmbClient
...
class PolicyRuleSmbClientGetResponse(BaseModel):
    ...
    items: Optional[conlist(PolicyRuleSmbClient)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name, if meaningful.")
