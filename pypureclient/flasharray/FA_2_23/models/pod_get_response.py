...
class PodGetResponse(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            items (list[Pod])
            total (list[Pod]): The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field, if applicable.
        """
