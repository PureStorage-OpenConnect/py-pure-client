...
from pypureclient.flasharray.FA_2_23.models.array_encryption import ArrayEncryption
from pypureclient.flasharray.FA_2_23.models.eradication_config import EradicationConfig
...
class Arrays(BaseModel):
    ...
    capacity: Optional[StrictInt] = Field(default=None, description="The usable capacity measured in bytes. If the user does not have sufficient access, this field will return `null`.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "banner", "capacity", "console_lock_enabled", "encryption", "eradication_config", "idle_timeout", "ntp_servers", "os", "parity", "scsi_timeout", "space", "version"]
