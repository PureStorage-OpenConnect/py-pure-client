...
class VolumeGroupGetResponse(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            items (list[VolumeGroup])
            total (list[VolumeGroup]): The aggregate value of all items after filtering. If applicable, the average value is displayed instead. If applicalbe, the values are displayed for each field.
        """
