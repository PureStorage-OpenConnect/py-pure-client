...
from pypureclient.flasharray.FA_2_23.models.volume_group import VolumeGroup
...
class VolumeGroupGetResponse(BaseModel):
    ...
    total: Optional[conlist(VolumeGroup)] = Field(default=None, description="The aggregate value of all items after filtering. If applicable, the average value is displayed instead. If applicalbe, the values are displayed for each field.")
