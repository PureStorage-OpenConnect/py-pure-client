...
class CertificateGroupsApi(object):
    ...
    def api236_certificate_groups_certificates_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api236_certificate_groups_certificates_get`, must be a value greater than or equal to `1`")
    ...
    def api236_certificate_groups_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api236_certificate_groups_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
