...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_36.models.mapping_policy_patch import MappingPolicyPatch
from pypureclient.flasharray.FA_2_36.models.pod_replica_link_get_response import PodReplicaLinkGetResponse
from pypureclient.flasharray.FA_2_36.models.pod_replica_link_lag_get_response import PodReplicaLinkLagGetResponse
from pypureclient.flasharray.FA_2_36.models.pod_replica_link_mapping_policy_get_response import PodReplicaLinkMappingPolicyGetResponse
from pypureclient.flasharray.FA_2_36.models.pod_replica_link_mapping_policy_response import PodReplicaLinkMappingPolicyResponse
from pypureclient.flasharray.FA_2_36.models.pod_replica_link_patch import PodReplicaLinkPatch
from pypureclient.flasharray.FA_2_36.models.pod_replica_link_performance_replication_get_response import PodReplicaLinkPerformanceReplicationGetResponse
from pypureclient.flasharray.FA_2_36.models.pod_replica_link_response import PodReplicaLinkResponse
...
class PodReplicaLinksApi:
    ...
    def api236_pod_replica_links_delete_with_http_info(
        ...
        _param = self._api236_pod_replica_links_delete_serialize(
    ...
    def _api236_pod_replica_links_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.36/pod-replica-links',
    ...
    def api236_pod_replica_links_get_with_http_info(
        ...
        _param = self._api236_pod_replica_links_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            ids = ids,
    ...
    def _api236_pod_replica_links_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
    ...
    def api236_pod_replica_links_lag_get_with_http_info(
        ...
        _param = self._api236_pod_replica_links_lag_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            ids = ids,
    ...
    def _api236_pod_replica_links_lag_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.36/pod-replica-links/lag',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api236_pod_replica_links_mappings_policies_get_with_http_info(
        ...
        _param = self._api236_pod_replica_links_mappings_policies_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api236_pod_replica_links_mappings_policies_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.36/pod-replica-links/mappings/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api236_pod_replica_links_mappings_policies_patch_with_http_info(
        ...
        _param = self._api236_pod_replica_links_mappings_policies_patch_serialize(
            mapping = mapping,
            authorization = authorization,
            x_request_id = x_request_id,
            ids = ids,
    ...
    def _api236_pod_replica_links_mappings_policies_patch_serialize(
        self,
        mapping,
        authorization,
        x_request_id,
    ...
    def api236_pod_replica_links_patch_with_http_info(
        ...
        _param = self._api236_pod_replica_links_patch_serialize(
    ...
    def _api236_pod_replica_links_patch_serialize(
        self,
        pod_replica_link,
        authorization,
        x_request_id,
    ...
    def api236_pod_replica_links_performance_replication_get_with_http_info(
        ...
        _param = self._api236_pod_replica_links_performance_replication_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            end_time = end_time,
    ...
    def _api236_pod_replica_links_performance_replication_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.36/pod-replica-links/performance/replication',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api236_pod_replica_links_post_with_http_info(
        ...
        _param = self._api236_pod_replica_links_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            local_pod_ids = local_pod_ids,
            local_pod_names = local_pod_names,
    ...
    def _api236_pod_replica_links_post_serialize(
        self,
        authorization,
        x_request_id,
        local_pod_ids,
