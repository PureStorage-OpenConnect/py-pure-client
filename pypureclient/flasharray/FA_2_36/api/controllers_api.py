...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_36.models.controller_get_response import ControllerGetResponse
...
class ControllersApi:
    ...
    def api236_controllers_get_with_http_info(
        ...
        _param = self._api236_controllers_get_serialize(
    ...
    def _api236_controllers_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.36/controllers',
