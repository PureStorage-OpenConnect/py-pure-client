...
from pypureclient.flasharray.FA_2_36.models.smtp_server_get_response import SmtpServerGetResponse
from pypureclient.flasharray.FA_2_36.models.smtp_server_response import SmtpServerResponse
...
class SMTPApi:
    ...
    def api236_smtp_servers_get_with_http_info(
        ...
        _param = self._api236_smtp_servers_get_serialize(
    ...
    def _api236_smtp_servers_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.36/smtp-servers',
    ...
    def api236_smtp_servers_patch_with_http_info(
        ...
        _param = self._api236_smtp_servers_patch_serialize(
            smtp = smtp,
            authorization = authorization,
            x_request_id = x_request_id,
        )
    ...
    def _api236_smtp_servers_patch_serialize(
        self,
        smtp,
        authorization,
        x_request_id,
