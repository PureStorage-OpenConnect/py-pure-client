...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_36.models.audit_get_response import AuditGetResponse
...
class AuditsApi:
    ...
    def api236_audits_get_with_http_info(
        ...
        _param = self._api236_audits_get_serialize(
    ...
    def _api236_audits_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
