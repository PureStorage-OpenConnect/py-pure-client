...
class RealmPatch(BaseModel):
    ...
    quota_limit: Optional[Annotated[int, Field(le=4503599627370496, strict=True, ge=1048576)]] = Field(default=None, description="The logical quota limit of the realm, measured in bytes.")
    qos: Optional[ContainerQos] = Field(default=None, description="Sets QoS limits.")
    __properties: ClassVar[List[str]] = ["name", "destroyed", "quota_limit", "qos"]
