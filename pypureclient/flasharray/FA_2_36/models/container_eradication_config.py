...
class ContainerEradicationConfig(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContainerEradicationConfig:
        """Create an instance of ContainerEradicationConfig from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ContainerEradicationConfig:
        """Create an instance of ContainerEradicationConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContainerEradicationConfig.parse_obj(obj)

        _obj = ContainerEradicationConfig.construct(_fields_set=None, **{
