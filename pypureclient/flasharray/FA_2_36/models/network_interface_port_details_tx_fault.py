...
class NetworkInterfacePortDetailsTxFault(BaseModel):
    """
    ...
    flag: Optional[StrictBool] = Field(default=None, description="A value of `true` indicates transmitter/laser fault.")
    __properties = ["channel", "flag"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkInterfacePortDetailsTxFault:
        """Create an instance of NetworkInterfacePortDetailsTxFault from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkInterfacePortDetailsTxFault:
        """Create an instance of NetworkInterfacePortDetailsTxFault from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkInterfacePortDetailsTxFault.parse_obj(obj)

        _obj = NetworkInterfacePortDetailsTxFault.construct(_fields_set=None, **{
