...
class PolicyPassword(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "policy_type", "enabled", "lockout_duration", "max_login_attempts", "min_password_length", "password_history", "min_password_age", "min_character_groups", "min_characters_per_group", "enforce_username_check", "enforce_dictionary_check"]
