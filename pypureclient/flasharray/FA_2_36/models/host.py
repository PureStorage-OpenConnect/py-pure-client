...
class Host(BaseModel):
    ...
    __properties = ["name", "chap", "connection_count", "destroyed", "host_group", "iqns", "is_local", "nqns", "personality", "port_connectivity", "preferred_arrays", "space", "time_remaining", "vlan", "wwns"]
