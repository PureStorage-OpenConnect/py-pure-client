...
from pypureclient.flasharray.FA_2_36.models.resource_pod_space import ResourcePodSpace
...
class ResourcePodSpaceGetResponse(BaseModel):
    ...
    total: Optional[List[ResourcePodSpace]] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. If applicable, the values are displayed for each field.")
