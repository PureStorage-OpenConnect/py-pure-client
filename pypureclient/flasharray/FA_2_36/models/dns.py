...
class Dns(BaseModel):
    ...
    nameservers: Optional[List[StrictStr]] = Field(default=None, description="The list of DNS server IP addresses.")
    ...
    __properties: ClassVar[List[str]] = ["name", "domain", "nameservers", "services", "source"]
