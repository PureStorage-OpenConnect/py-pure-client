...
from pypureclient.flasharray.FA_2_36.models.fixed_reference_with_type import FixedReferenceWithType
...
class PolicyRuleSmbClient(BaseModel):
    ...
    __properties = ["anonymous_access_allowed", "client", "destroyed", "name", "policy", "smb_encryption_required", "time_remaining"]
