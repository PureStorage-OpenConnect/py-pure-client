...
class ApiClientPost(BaseModel):
    ...
    access_policies: Optional[List[ReferenceWithType]] = Field(default=None, description="The access policies allowed for ID Tokens issued by this API client. The bearer of an access token will be authorized to perform actions within the intersection of these policies and those of the array user specified as the JWT `sub` (subject) claim.")
    ...
    __properties: ClassVar[List[str]] = ["max_role", "access_policies", "issuer", "public_key", "access_token_ttl_in_ms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "access_policies": [ReferenceWithType.from_dict(_item) for _item in obj["access_policies"]] if obj.get("access_policies") is not None else None,
