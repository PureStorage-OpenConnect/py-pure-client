...
class DirectoryServiceRolePost(BaseModel):
    ...
    management_access_policies: Optional[conlist(ReferenceWithType)] = Field(default=None, description="List of management access policies to associate with the group.")
    role: Optional[ReferenceNoId] = Field(default=None, description="This field has been deprecated. Predecessor to management access policies. Can be set to the premade policy of the same name. Cannot be set with management_access_policies.")
