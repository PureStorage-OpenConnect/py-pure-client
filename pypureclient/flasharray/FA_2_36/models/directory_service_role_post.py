...
class DirectoryServiceRolePost(BaseModel):
    ...
    management_access_policies: Optional[List[ReferenceWithType]] = Field(default=None, description="List of management access policies to associate with the group.")
    ...
    __properties: ClassVar[List[str]] = ["role", "management_access_policies", "group", "group_base"]
