...
class ResourceNoId(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceNoId:
        """Create an instance of ResourceNoId from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourceNoId:
        """Create an instance of ResourceNoId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceNoId.parse_obj(obj)

        _obj = ResourceNoId.construct(_fields_set=None, **{
            "name": obj.get("name")
        })
        return _obj
