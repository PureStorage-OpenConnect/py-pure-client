...
class DNSApi:
    ...
    def api29_dns_get_with_http_info(
        ...
        _param = self._api29_dns_get_serialize(
    ...
    def api29_dns_patch_with_http_info(
        ...
        _param = self._api29_dns_patch_serialize(
            dns = dns,
            authorization = authorization,
            x_request_id = x_request_id,
        )
    ...
    def _api29_dns_patch_serialize(
        self,
        dns,
        authorization,
        x_request_id,
