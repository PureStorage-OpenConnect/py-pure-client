...
class DirectorySnapshotsApi:
    ...
    def api29_directory_snapshots_delete_with_http_info(
        ...
        _param = self._api29_directory_snapshots_delete_serialize(
    ...
    def _api29_directory_snapshots_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.9/directory-snapshots',
    ...
    def api29_directory_snapshots_get_with_http_info(
        ...
        _param = self._api29_directory_snapshots_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api29_directory_snapshots_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api29_directory_snapshots_patch_with_http_info(
        ...
        _param = self._api29_directory_snapshots_patch_serialize(
    ...
    def _api29_directory_snapshots_patch_serialize(
        self,
        directory_snapshot,
        authorization,
        x_request_id,
    ...
    def api29_directory_snapshots_post_with_http_info(
        ...
        _param = self._api29_directory_snapshots_post_serialize(
            directory_snapshot = directory_snapshot,
            authorization = authorization,
            x_request_id = x_request_id,
            source_ids = source_ids,
    ...
    def _api29_directory_snapshots_post_serialize(
        self,
        directory_snapshot,
        authorization,
        x_request_id,
