...
from pypureclient.flasharray.FA_2_44.models.directory_group_quotas_get_response import DirectoryGroupQuotasGetResponse
from pypureclient.flasharray.FA_2_44.models.directory_user_quotas_get_response import DirectoryUserQuotasGetResponse
from typing import Optional
...
class UserGroupQuotasApi:
    ...
    def api244_directory_group_quotas_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.44/directory-group-quotas', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api244_directory_user_quotas_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.44/directory-user-quotas', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
