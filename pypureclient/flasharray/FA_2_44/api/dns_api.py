...
from pypureclient.flasharray.FA_2_44.models.dns_get_response import DnsGetResponse
from pypureclient.flasharray.FA_2_44.models.dns_patch import DnsPatch
from pypureclient.flasharray.FA_2_44.models.dns_post import DnsPost
from pypureclient.flasharray.FA_2_44.models.dns_response import DnsResponse
from typing import Optional
...
class DNSApi:
    ...
    def api244_dns_delete_with_http_info(
        self,
    ...
    def api244_dns_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
    ...
    def api244_dns_patch_with_http_info(
        self,
        dns: DnsPatch,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
    ...
    def api244_dns_post_with_http_info(
        self,
        dns: DnsPost,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
