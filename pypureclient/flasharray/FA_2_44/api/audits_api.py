...
from pypureclient.flasharray.FA_2_44.models.audit_get_response import AuditGetResponse
from typing import Optional
...
class AuditsApi:
    ...
    def api244_audits_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api244_audits_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
