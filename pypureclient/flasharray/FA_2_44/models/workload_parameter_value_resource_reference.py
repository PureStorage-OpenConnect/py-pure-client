...
class WorkloadParameterValueResourceReference(BaseModel):
    ...
    resource_type: Optional[StrictStr] = Field(default=None, description="The type of the resource to reference. Resource type is optional, and will be automatically determined by the server if not set.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkloadParameterValueResourceReference:
        """Create an instance of WorkloadParameterValueResourceReference from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> WorkloadParameterValueResourceReference:
        """Create an instance of WorkloadParameterValueResourceReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkloadParameterValueResourceReference.parse_obj(obj)

        _obj = WorkloadParameterValueResourceReference.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
