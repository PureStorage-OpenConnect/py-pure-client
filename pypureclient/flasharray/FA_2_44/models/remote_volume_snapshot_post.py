...
class RemoteVolumeSnapshotPost(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoteVolumeSnapshotPost:
        """Create an instance of RemoteVolumeSnapshotPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RemoteVolumeSnapshotPost:
        """Create an instance of RemoteVolumeSnapshotPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoteVolumeSnapshotPost.parse_obj(obj)

        _obj = RemoteVolumeSnapshotPost.construct(_fields_set=None, **{
