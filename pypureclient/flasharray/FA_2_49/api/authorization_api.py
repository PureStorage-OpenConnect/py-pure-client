...
class AuthorizationApi:
    ...
    def api249_login_post_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api249_login_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api249_logout_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_logout_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
