...
from pypureclient.flasharray.FA_2_49.models.kmip_get_response import KmipGetResponse
from pypureclient.flasharray.FA_2_49.models.kmip_patch import KmipPatch
from pypureclient.flasharray.FA_2_49.models.kmip_post import KmipPost
from pypureclient.flasharray.FA_2_49.models.kmip_response import KmipResponse
from pypureclient.flasharray.FA_2_49.models.kmip_test_result_get_response import KmipTestResultGetResponse
from typing import Optional
...
class KMIPApi:
    ...
    def api249_kmip_delete_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api249_kmip_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api249_kmip_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_kmip_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api249_kmip_patch_with_http_info(
        self,
        kmip: KmipPatch,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_kmip_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api249_kmip_post_with_http_info(
        self,
        kmip: KmipPost,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_kmip_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api249_kmip_test_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_kmip_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
