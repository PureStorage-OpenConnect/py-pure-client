...
from pypureclient.flasharray.FA_2_49.models.snmp_manager_get_response import SnmpManagerGetResponse
from pypureclient.flasharray.FA_2_49.models.snmp_manager_patch import SnmpManagerPatch
from pypureclient.flasharray.FA_2_49.models.snmp_manager_post import SnmpManagerPost
from pypureclient.flasharray.FA_2_49.models.snmp_manager_response import SnmpManagerResponse
...
class SNMPManagersApi:
    ...
    def api249_snmp_managers_delete_with_http_info(
        self,
    ...
    def api249_snmp_managers_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
    ...
    def api249_snmp_managers_patch_with_http_info(
        self,
    ...
    def api249_snmp_managers_post_with_http_info(
        self,
    ...
    def api249_snmp_managers_test_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.49/snmp-managers/test', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
