...
from pypureclient.flasharray.common.models.offload_get_response_v_49 import OffloadGetResponse
from pypureclient.flasharray.common.models.offload_post_v_25 import OffloadPost
from pypureclient.flasharray.common.models.offload_response_v_49 import OffloadResponse
...
class OffloadsApi:
    ...
    def api249_offloads_delete_with_http_info(
        self,
    ...
    def api249_offloads_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
    ...
    def api249_offloads_post_with_http_info(
        self,
        offload: OffloadPost,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
