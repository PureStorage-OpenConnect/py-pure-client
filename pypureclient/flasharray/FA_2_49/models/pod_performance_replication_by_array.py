...
from pypureclient.flasharray.FA_2_49.models.replication_performance_with_total import ReplicationPerformanceWithTotal
...
class PodPerformanceReplicationByArray(BaseModel):
    ...
    __properties = ["context", "continuous_bytes_per_sec", "periodic_bytes_per_sec", "pod", "resync_bytes_per_sec", "sync_bytes_per_sec", "time", "total_bytes_per_sec", "array"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PodPerformanceReplicationByArray:
        """Create an instance of PodPerformanceReplicationByArray from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PodPerformanceReplicationByArray:
        """Create an instance of PodPerformanceReplicationByArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PodPerformanceReplicationByArray.parse_obj(obj)

        _obj = PodPerformanceReplicationByArray.construct(_fields_set=None, **{
