...
from pypureclient.flasharray.FA_2_49.models.snapshot_space import SnapshotSpace
...
class VolumeSnapshot(BaseModel):
    ...
    __properties = ["id", "name", "created", "destroyed", "pod", "provisioned", "source", "suffix", "time_remaining", "context", "serial", "space", "volume_group"]
