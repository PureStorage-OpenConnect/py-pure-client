...
from pypureclient.flasharray.FA_2_49.models.array_encryption import ArrayEncryption
from pypureclient.flasharray.FA_2_49.models.eradication_config import EradicationConfig
...
class Arrays(BaseModel):
    ...
    __properties = ["id", "name", "context", "_as_of", "banner", "capacity", "console_lock_enabled", "encryption", "eradication_config", "idle_timeout", "ntp_servers", "ntp_symmetric_key", "os", "parity", "scsi_timeout", "space", "time_zone", "version"]
