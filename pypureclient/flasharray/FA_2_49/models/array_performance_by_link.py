...
class ArrayPerformanceByLink(BaseModel):
    ...
    local_queue_usec_per_op: Optional[conint(strict=True, ge=0)] = Field(default=None, description="Deprecated. The number displayed here may not be accurate and in later versions of the product this field will always display `null`. Instead, use `queue_usec_per_mirrored_write_op`, `queue_usec_per_read_op`, and `queue_usec_per_write_op` fields to measure IO queuing.")
    ...
    queue_depth: Optional[conint(strict=True, ge=0)] = Field(default=None, description="Deprecated. The number displayed here may not be accurate and in later versions of the product this field will always display `null`. Instead, use `queue_usec_per_mirrored_write_op`, `queue_usec_per_read_op`, and `queue_usec_per_write_op` fields to measure IO queuing.")
    ...
    def to_dict(self, include_readonly: bool=True) -> Dict[str, Any]:
        ...
        if _include_in_dict('link', include_readonly, excluded_fields, none_fields):
            _items = []
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayPerformanceByLink:
        """Create an instance of ArrayPerformanceByLink from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayPerformanceByLink:
        """Create an instance of ArrayPerformanceByLink from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayPerformanceByLink.parse_obj(obj)

        _obj = ArrayPerformanceByLink.construct(_fields_set=None, **{
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "local_queue_usec_per_op": obj.get("local_queue_usec_per_op"),
            "others_per_sec": obj.get("others_per_sec"),
            "queue_depth": obj.get("queue_depth"),
            "usec_per_other_op": obj.get("usec_per_other_op"),
            "link": [Resource.from_dict(_item) for _item in obj.get("link")] if obj.get("link") is not None else None
        })
        return _obj
