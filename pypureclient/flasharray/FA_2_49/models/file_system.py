...
from pypureclient.flasharray.FA_2_49.models.container_eradication_config import ContainerEradicationConfig
...
class FileSystem(BaseModel):
    ...
    __properties = ["id", "name", "context", "created", "destroyed", "eradication_config", "pod", "time_remaining"]
