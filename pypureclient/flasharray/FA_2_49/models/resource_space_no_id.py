...
class ResourceSpaceNoId(BaseModel):
    """
    ResourceSpaceNoId
    """
    ...
    __properties = ["name", "context", "space", "time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceSpaceNoId:
        """Create an instance of ResourceSpaceNoId from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourceSpaceNoId:
        """Create an instance of ResourceSpaceNoId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceSpaceNoId.parse_obj(obj)

        _obj = ResourceSpaceNoId.construct(_fields_set=None, **{
            "name": obj.get("name"),
