...
from pypureclient.flasharray.FA_2_49.models.protection_group_eradication_config import ProtectionGroupEradicationConfig
from pypureclient.flasharray.FA_2_49.models.replication_schedule import ReplicationSchedule
from pypureclient.flasharray.FA_2_49.models.retention_policy import RetentionPolicy
from pypureclient.flasharray.FA_2_49.models.snapshot_schedule import SnapshotSchedule
from pypureclient.flasharray.FA_2_49.models.space import Space
from pypureclient.flasharray.FA_2_49.models.workload_configuration_fixed_reference_workload import WorkloadConfigurationFixedReferenceWorkload
...
class ProtectionGroup(BaseModel):
    ...
    __properties = ["context", "id", "name", "workload", "destroyed", "eradication_config", "host_count", "host_group_count", "is_local", "pod", "replication_schedule", "retention_lock", "snapshot_schedule", "source", "source_retention", "space", "target_count", "target_retention", "time_remaining", "volume_count"]
