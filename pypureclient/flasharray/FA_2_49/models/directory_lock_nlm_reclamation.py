...
class DirectoryLockNlmReclamation(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryLockNlmReclamation:
        """Create an instance of DirectoryLockNlmReclamation from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryLockNlmReclamation:
        """Create an instance of DirectoryLockNlmReclamation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryLockNlmReclamation.parse_obj(obj)

        _obj = DirectoryLockNlmReclamation.construct(_fields_set=None, **{
