...
from pypureclient.flasharray.FA_2_49.models.port_common import PortCommon
from pypureclient.flasharray.FA_2_49.models.port_initiator_encryption import PortInitiatorEncryption
from pypureclient.flasharray.FA_2_49.models.port_initiator_target import PortInitiatorTarget
...
class PortInitiator(BaseModel):
    ...
    encryption: Optional[PortInitiatorEncryption] = None
    initiator: Optional[PortCommon] = None
    target: Optional[PortInitiatorTarget] = None
    __properties = ["context", "encryption", "initiator", "target"]
    ...
    def from_dict(cls, obj: dict) -> PortInitiator:
        ...
        _obj = PortInitiator.construct(_fields_set=None, **{
            ...
            "encryption": PortInitiatorEncryption.from_dict(obj.get("encryption")) if obj.get("encryption") is not None else None,
