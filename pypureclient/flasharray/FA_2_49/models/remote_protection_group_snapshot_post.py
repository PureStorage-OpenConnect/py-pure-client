...
class RemoteProtectionGroupSnapshotPost(BaseModel):
    ...
    __properties = ["id", "name", "context", "created", "destroyed", "is_local", "remote", "source", "suffix", "time_remaining", "tags"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoteProtectionGroupSnapshotPost:
        """Create an instance of RemoteProtectionGroupSnapshotPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RemoteProtectionGroupSnapshotPost:
        """Create an instance of RemoteProtectionGroupSnapshotPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoteProtectionGroupSnapshotPost.parse_obj(obj)

        _obj = RemoteProtectionGroupSnapshotPost.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
