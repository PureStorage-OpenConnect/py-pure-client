...
from pypureclient.flasharray.FA_2_46.models.port_common import PortCommon
from pypureclient.flasharray.FA_2_46.models.port_initiator_target import PortInitiatorTarget
...
class PortInitiator(BaseModel):
    ...
    __properties = ["context", "initiator", "target"]
