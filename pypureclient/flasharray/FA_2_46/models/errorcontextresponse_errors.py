...
class ErrorcontextresponseErrors(BaseModel):
    ...
    def to_dict(self, include_readonly: bool=True) -> Dict[str, Any]:
        ...
        # override the default output from pydantic by calling `to_dict()` of location_context
        if _include_in_dict('location_context', include_readonly, excluded_fields, none_fields):
            _dict['location_context'] = self.location_context.to_dict(include_readonly=include_readonly)
        return _dict
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ErrorcontextresponseErrors:
        """Create an instance of ErrorcontextresponseErrors from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ErrorcontextresponseErrors:
        """Create an instance of ErrorcontextresponseErrors from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ErrorcontextresponseErrors.parse_obj(obj)
