...
class PresetWorkloadConstraintsInteger(BaseModel):
    ...
    __properties = ["allowed_values", "default", "maximum", "minimum"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PresetWorkloadConstraintsInteger:
        """Create an instance of PresetWorkloadConstraintsInteger from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PresetWorkloadConstraintsInteger:
        """Create an instance of PresetWorkloadConstraintsInteger from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PresetWorkloadConstraintsInteger.parse_obj(obj)

        _obj = PresetWorkloadConstraintsInteger.construct(_fields_set=None, **{
