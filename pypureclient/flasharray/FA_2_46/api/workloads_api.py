...
from pypureclient.flasharray.FA_2_46.models.workload_get_response import WorkloadGetResponse
from pypureclient.flasharray.FA_2_46.models.workload_patch import WorkloadPatch
from pypureclient.flasharray.FA_2_46.models.workload_placement_recommendation import WorkloadPlacementRecommendation
from pypureclient.flasharray.FA_2_46.models.workload_placement_recommendation_get_response import WorkloadPlacementRecommendationGetResponse
from pypureclient.flasharray.FA_2_46.models.workload_placement_recommendation_response import WorkloadPlacementRecommendationResponse
from pypureclient.flasharray.FA_2_46.models.workload_post import WorkloadPost
from pypureclient.flasharray.FA_2_46.models.workload_response import WorkloadResponse
from typing import Optional
...
class WorkloadsApi:
    ...
    def api246_workloads_delete_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api246_workloads_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api246_workloads_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api246_workloads_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api246_workloads_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api246_workloads_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api246_workloads_placement_recommendations_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api246_workloads_placement_recommendations_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.46/workloads/placement-recommendations', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api246_workloads_placement_recommendations_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api246_workloads_placement_recommendations_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.46/workloads/placement-recommendations', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api246_workloads_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api246_workloads_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api246_workloads_tags_batch_put_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api246_workloads_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.46/workloads/tags/batch', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api246_workloads_tags_delete_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api246_workloads_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.46/workloads/tags', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api246_workloads_tags_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api246_workloads_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
