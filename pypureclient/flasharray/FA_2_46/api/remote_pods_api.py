...
from pypureclient.flasharray.FA_2_46.models.remote_pods_response import RemotePodsResponse
from typing import Optional
...
class RemotePodsApi:
    ...
    def api246_remote_pods_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api246_remote_pods_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
