...
class AdminSettingsGetResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["items", "more_items_remaining", "total_item_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            "items": [AdminSettings.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
