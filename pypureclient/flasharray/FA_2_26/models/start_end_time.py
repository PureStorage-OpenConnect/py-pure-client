...
class StartEndTime(BaseModel):
    ...
    __properties = ["end_time", "start_time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StartEndTime:
        """Create an instance of StartEndTime from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> StartEndTime:
        """Create an instance of StartEndTime from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StartEndTime.parse_obj(obj)

        _obj = StartEndTime.construct(_fields_set=None, **{
