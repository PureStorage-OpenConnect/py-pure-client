...
from pypureclient.flasharray.FA_2_26.models.throttle import Throttle
...
class ArrayConnection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "management_address", "replication_addresses", "status", "type", "replication_transport", "version", "throttle"]
