...
from pypureclient.flasharray.FA_2_26.models.support_get_response import SupportGetResponse
from pypureclient.flasharray.FA_2_26.models.support_patch import SupportPatch
from pypureclient.flasharray.FA_2_26.models.support_response import SupportResponse
...
class SupportApi:
    ...
    def api226_support_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api226_support_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_support_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api226_support_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api226_support_patch_with_http_info(support, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_support_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api226_support_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api226_support_test_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, test_type, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_support_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
