...
from pypureclient.flasharray.FA_2_26.models.network_interface_get_response import NetworkInterfaceGetResponse
from pypureclient.flasharray.FA_2_26.models.network_interface_neighbor_get_response import NetworkInterfaceNeighborGetResponse
from pypureclient.flasharray.FA_2_26.models.network_interface_patch import NetworkInterfacePatch
from pypureclient.flasharray.FA_2_26.models.network_interface_performance_get_response import NetworkInterfacePerformanceGetResponse
from pypureclient.flasharray.FA_2_26.models.network_interface_post import NetworkInterfacePost
from pypureclient.flasharray.FA_2_26.models.network_interface_response import NetworkInterfaceResponse
from pypureclient.flasharray.FA_2_26.models.network_interfaces_port_details_get_response import NetworkInterfacesPortDetailsGetResponse
...
class NetworkInterfacesApi:
    ...
    def api226_network_interfaces_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api226_network_interfaces_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_network_interfaces_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api226_network_interfaces_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api226_network_interfaces_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_network_interfaces_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api226_network_interfaces_neighbors_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api226_network_interfaces_neighbors_get_with_http_info(authorization, x_request_id, filter, limit, local_port_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_network_interfaces_neighbors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api226_network_interfaces_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api226_network_interfaces_patch_with_http_info(network, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_network_interfaces_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api226_network_interfaces_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api226_network_interfaces_performance_get_with_http_info(authorization, x_request_id, end_time, filter, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_network_interfaces_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api226_network_interfaces_port_details_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api226_network_interfaces_port_details_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_network_interfaces_port_details_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api226_network_interfaces_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api226_network_interfaces_post_with_http_info(network, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_network_interfaces_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
