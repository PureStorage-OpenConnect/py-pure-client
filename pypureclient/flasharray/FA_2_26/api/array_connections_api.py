...
class ArrayConnectionsApi(object):
    ...
    def api226_array_connections_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api226_array_connections_get`, must be a value greater than or equal to `1`")
    ...
    def api226_array_connections_path_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api226_array_connections_path_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
