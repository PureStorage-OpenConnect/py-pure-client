...
class NetworkInterfacePortDetailsRxLos(BaseModel):
    """
    ...
    flag: Optional[StrictBool] = Field(default=None, description="A value of `true` indicates Rx Loss-of-Signal.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkInterfacePortDetailsRxLos:
        """Create an instance of NetworkInterfacePortDetailsRxLos from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkInterfacePortDetailsRxLos:
        """Create an instance of NetworkInterfacePortDetailsRxLos from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkInterfacePortDetailsRxLos.parse_obj(obj)

        _obj = NetworkInterfacePortDetailsRxLos.construct(_fields_set=None, **{
