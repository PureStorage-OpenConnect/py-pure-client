...
class VolumeGroupSpace(object):
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `VolumeGroupSpace`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(VolumeGroupSpace, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VolumeGroupSpace):
            return False
