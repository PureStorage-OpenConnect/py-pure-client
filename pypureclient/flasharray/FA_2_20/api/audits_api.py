...
from pypureclient.flasharray.FA_2_20.models.audit_get_response import AuditGetResponse
...
class AuditsApi:
    ...
    def api220_audits_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api220_audits_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
