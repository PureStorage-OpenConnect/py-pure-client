...
from pypureclient.flasharray.FA_2_20.models.syslog_server_get_response import SyslogServerGetResponse
from pypureclient.flasharray.FA_2_20.models.syslog_server_response import SyslogServerResponse
from pypureclient.flasharray.FA_2_20.models.syslog_server_settings import SyslogServerSettings
from pypureclient.flasharray.FA_2_20.models.syslog_server_settings_get_response import SyslogServerSettingsGetResponse
from pypureclient.flasharray.FA_2_20.models.syslog_server_settings_response import SyslogServerSettingsResponse
...
class SyslogApi:
    ...
    def api220_syslog_servers_delete_with_http_info(
        ...
        _param = self._api220_syslog_servers_delete_serialize(
    ...
    def _api220_syslog_servers_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.20/syslog-servers',
    ...
    def api220_syslog_servers_get_with_http_info(
        ...
        _param = self._api220_syslog_servers_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api220_syslog_servers_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api220_syslog_servers_patch_with_http_info(
        ...
        _param = self._api220_syslog_servers_patch_serialize(
    ...
    def _api220_syslog_servers_patch_serialize(
        self,
        syslog_server,
        authorization,
        x_request_id,
    ...
    def api220_syslog_servers_post_with_http_info(
        ...
        _param = self._api220_syslog_servers_post_serialize(
            syslog_server = syslog_server,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api220_syslog_servers_post_serialize(
        self,
        syslog_server,
        authorization,
        x_request_id,
    ...
    def api220_syslog_servers_settings_get_with_http_info(
        ...
        _param = self._api220_syslog_servers_settings_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api220_syslog_servers_settings_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.20/syslog-servers/settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api220_syslog_servers_settings_patch_with_http_info(
        ...
        _param = self._api220_syslog_servers_settings_patch_serialize(
    ...
    def _api220_syslog_servers_settings_patch_serialize(
        self,
    ...
    def api220_syslog_servers_test_get_with_http_info(
        ...
        _param = self._api220_syslog_servers_test_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api220_syslog_servers_test_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.20/syslog-servers/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
