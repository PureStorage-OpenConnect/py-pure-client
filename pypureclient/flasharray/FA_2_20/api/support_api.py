...
class SupportApi:
    ...
    def api220_support_get_with_http_info(
        ...
        _param = self._api220_support_get_serialize(
    ...
    def _api220_support_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.20/support',
    ...
    def api220_support_patch_with_http_info(
        ...
        _param = self._api220_support_patch_serialize(
            support = support,
            authorization = authorization,
            x_request_id = x_request_id,
        )
    ...
    def _api220_support_patch_serialize(
        self,
        support,
        authorization,
        x_request_id,
    ...
    def api220_support_test_get_with_http_info(
        ...
        _param = self._api220_support_test_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api220_support_test_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.20/support/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
