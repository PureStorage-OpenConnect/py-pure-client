...
from pypureclient.flasharray.FA_2_20.models.smtp_server_get_response import SmtpServerGetResponse
from pypureclient.flasharray.FA_2_20.models.smtp_server_response import SmtpServerResponse
...
class SMTPApi:
    ...
    def api220_smtp_servers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api220_smtp_servers_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api220_smtp_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api220_smtp_servers_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api220_smtp_servers_patch_with_http_info(smtp, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_smtp_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
