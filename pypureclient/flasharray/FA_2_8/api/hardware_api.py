...
from pypureclient.flasharray.FA_2_8.models.hardware_get_response import HardwareGetResponse
from pypureclient.flasharray.FA_2_8.models.hardware_patch import HardwarePatch
from pypureclient.flasharray.FA_2_8.models.hardware_response import HardwareResponse
...
class HardwareApi:
    ...
    def api28_hardware_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_hardware_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api28_hardware_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_hardware_patch_with_http_info(hardware, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
