...
from pypureclient.flasharray.FA_2_8.models.maintenance_window_post import MaintenanceWindowPost
from pypureclient.flasharray.FA_2_8.models.maintenance_windows_get_response import MaintenanceWindowsGetResponse
from pypureclient.flasharray.FA_2_8.models.maintenance_windows_response import MaintenanceWindowsResponse
...
class MaintenanceWindowsApi:
    ...
    def api28_maintenance_windows_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_maintenance_windows_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api28_maintenance_windows_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_maintenance_windows_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_maintenance_windows_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_maintenance_windows_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_maintenance_windows_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_maintenance_windows_post_with_http_info(maintenance_window, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_maintenance_windows_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
