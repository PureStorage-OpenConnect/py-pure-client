...
class AlertsApi:
    ...
    def api28_alerts_events_get_with_http_info(
        ...
        _param = self._api28_alerts_events_get_serialize(
    ...
    def _api28_alerts_events_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.8/alerts/events',
    ...
    def api28_alerts_get_with_http_info(
        ...
        _param = self._api28_alerts_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api28_alerts_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api28_alerts_patch_with_http_info(
        ...
        _param = self._api28_alerts_patch_serialize(
            alert = alert,
            authorization = authorization,
            x_request_id = x_request_id,
            ids = ids,
    ...
    def _api28_alerts_patch_serialize(
        self,
        alert,
        authorization,
        x_request_id,
