...
from pypureclient.flasharray.FA_2_8.models.volume_group_get_response import VolumeGroupGetResponse
from pypureclient.flasharray.FA_2_8.models.volume_group_post import VolumeGroupPost
from pypureclient.flasharray.FA_2_8.models.volume_group_response import VolumeGroupResponse
...
class VolumeGroupsApi:
    ...
    def api28_volume_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_volume_groups_delete_with_http_info(authorization, x_request_id, eradicate_contents, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api28_volume_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_volume_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_volume_groups_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, ids, limit, names, offset, sort, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_volume_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_volume_groups_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_volume_groups_patch_with_http_info(volume_group, authorization, x_request_id, destroy_contents, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_volume_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_volume_groups_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_volume_groups_performance_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_volume_groups_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_volume_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_volume_groups_post_with_http_info(volume_group, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_volume_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_volume_groups_space_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_volume_groups_space_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_volume_groups_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_volume_groups_volumes_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_volume_groups_volumes_get_with_http_info(authorization, x_request_id, continuation_token, filter, group_ids, group_names, limit, member_ids, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_volume_groups_volumes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
