...
class DirectoryServicesApi(object):
    ...
    def api28_directory_services_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_directory_services_patch_with_http_info(directory_service, names, async_req=True)
        >>> result = thread.get()
    ...
    def api28_directory_services_roles_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_directory_services_roles_patch_with_http_info(directory_service_roles, role_names, async_req=True)
        >>> result = thread.get()
