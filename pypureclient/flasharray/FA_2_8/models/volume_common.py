...
from pypureclient.flasharray.FA_2_8.models.qos import Qos
from pypureclient.flasharray.FA_2_8.models.space import Space
...
class VolumeCommon(BaseModel):
    ...
    __properties = ["id", "name", "connection_count", "created", "destroyed", "host_encryption_key_status", "provisioned", "qos", "serial", "space", "time_remaining"]
