...
from pypureclient.flasharray.FA_2_40.models.fleet_get_response import FleetGetResponse
from pypureclient.flasharray.FA_2_40.models.fleet_key_get_response import FleetKeyGetResponse
from pypureclient.flasharray.FA_2_40.models.fleet_key_response import FleetKeyResponse
from pypureclient.flasharray.FA_2_40.models.fleet_member_get_response import FleetMemberGetResponse
from pypureclient.flasharray.FA_2_40.models.fleet_member_post import FleetMemberPost
from pypureclient.flasharray.FA_2_40.models.fleet_member_response import FleetMemberResponse
from pypureclient.flasharray.FA_2_40.models.fleet_patch import FleetPatch
from pypureclient.flasharray.FA_2_40.models.fleet_response import FleetResponse
...
class FleetsApi:
    ...
    def api240_fleets_delete_with_http_info(
        ...
        **kwargs
        ...
        Deletes a fleet, permanently. A fleet can only be deleted if the current array is the only array in the fleet.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_fleets_delete_with_http_info(authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api240_fleets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_fleets_fleet_key_get_with_http_info(
        ...
        **kwargs
        ...
        Displays the time remaining on the fleet key. Note, fleet key itself is not displayed, since that is only available at time of fleet key creation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_fleets_fleet_key_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_fleets_fleet_key_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_fleets_fleet_key_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_fleets_fleet_key_post_with_http_info(authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_fleets_fleet_key_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_fleets_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_fleets_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_fleets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_fleets_members_delete_with_http_info(
        ...
        **kwargs
        ...
        Deletes the specified array(s) from the fleet. Note that this will only succeed if the array(s) to be removed are not making use of any fleet resources.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_fleets_members_delete_with_http_info(authorization, x_request_id, member_ids, member_names, unreachable, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_fleets_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_fleets_members_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_fleets_members_get_with_http_info(authorization, x_request_id, continuation_token, filter, fleet_ids, fleet_names, limit, member_ids, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_fleets_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_fleets_members_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_fleets_members_post_with_http_info(authorization, x_request_id, fleet_ids, fleet_names, members, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_fleets_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_fleets_patch_with_http_info(
        ...
        **kwargs
        ...
        Modifies a fleet, changing its name by passing the old name in `name` query parameter, and the new name in the `name` parameter in the request body.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_fleets_patch_with_http_info(fleet, authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_fleets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_fleets_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_fleets_post_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_fleets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
