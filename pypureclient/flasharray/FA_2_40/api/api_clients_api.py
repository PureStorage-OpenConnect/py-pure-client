...
from pypureclient.flasharray.FA_2_40.models.api_client_get_response import ApiClientGetResponse
from pypureclient.flasharray.FA_2_40.models.api_client_patch import ApiClientPatch
from pypureclient.flasharray.FA_2_40.models.api_client_post import ApiClientPost
from pypureclient.flasharray.FA_2_40.models.api_client_response import ApiClientResponse
...
class APIClientsApi:
    ...
    def api240_api_clients_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_api_clients_delete_with_http_info(authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api240_api_clients_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_api_clients_get_with_http_info(
        ...
        **kwargs
        ...
        Displays a list of API clients.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_api_clients_get_with_http_info(authorization, x_request_id, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_api_clients_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_api_clients_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_api_clients_patch_with_http_info(api_clients, authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_api_clients_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_api_clients_post_with_http_info(
        ...
        **kwargs
        ...
        Creates an API client. Newly created API clients are disabled by default. Enable an API client through the `PATCH` method. The `names`, `issuer`, and `public_key` parameters are required. The `access_policies` or `max_role` parameter is required, but they cannot be set together.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_api_clients_post_with_http_info(api_clients, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_api_clients_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
