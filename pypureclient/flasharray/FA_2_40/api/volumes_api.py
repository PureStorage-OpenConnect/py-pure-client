...
from pypureclient.flasharray.FA_2_40.models.member_get_response import MemberGetResponse
from pypureclient.flasharray.FA_2_40.models.protection_groups_volumes_get_response import ProtectionGroupsVolumesGetResponse
from pypureclient.flasharray.FA_2_40.models.protection_groups_volumes_response import ProtectionGroupsVolumesResponse
from pypureclient.flasharray.FA_2_40.models.resource_performance_by_array_get_response import ResourcePerformanceByArrayGetResponse
from pypureclient.flasharray.FA_2_40.models.resource_performance_get_response import ResourcePerformanceGetResponse
...
from pypureclient.flasharray.FA_2_40.models.volume_batch_post import VolumeBatchPost
from pypureclient.flasharray.FA_2_40.models.volume_get_response import VolumeGetResponse
from pypureclient.flasharray.FA_2_40.models.volume_patch import VolumePatch
from pypureclient.flasharray.FA_2_40.models.volume_post import VolumePost
from pypureclient.flasharray.FA_2_40.models.volume_response import VolumeResponse
from pypureclient.flasharray.FA_2_40.models.volume_space_get_response import VolumeSpaceGetResponse
from pypureclient.flasharray.FA_2_40.models.volumes_batch_response import VolumesBatchResponse
from pypureclient.flasharray.FA_2_40.models.volumes_diff_get_response import VolumesDiffGetResponse
...
class VolumesApi:
    ...
    def api240_volumes_batch_post_with_http_info(
        ...
        **kwargs
        ...
        Creates or copies a list of virtual storage volumes. Volumes of different sizes, vgroups, and tag upsertions can be copied this way.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_volumes_batch_post_with_http_info(volume, authorization, x_request_id, allow_throttle, context_names, overwrite, with_default_protection, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api240_volumes_batch_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_batch_test_post_with_http_info(
        ...
        **kwargs
        ...
        """Create an attempt to copy volumes and upsert tags  # noqa: E501

        Creates an attempt to copy virtual storage volumes of different sizes in different vgroups and also upserts tags, without actually creating them, to test if they can be successfully created. Only available for creating volumes via a copy, not direct volume creation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_volumes_batch_test_post_with_http_info(volume, authorization, x_request_id, allow_throttle, context_names, overwrite, with_default_protection, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_batch_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_volumes_delete_with_http_info(authorization, x_request_id, context_names, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_diff_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_volumes_diff_get_with_http_info(block_size, segment_length, authorization, x_request_id, allow_errors, base_id, base_name, context_names, continuation_token, filter, ids, limit, names, next_allocated_block_hint, offset, segment_offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_diff_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_volumes_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, destroyed, filter, ids, limit, names, offset, sort, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_volumes_patch_with_http_info(volume, authorization, x_request_id, add_to_protection_group_ids, add_to_protection_group_names, context_names, ids, names, remove_from_protection_group_ids, remove_from_protection_group_names, truncate, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_performance_by_array_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_volumes_performance_by_array_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_performance_get_with_http_info(
        ...
        **kwargs
        ...
        Displays real-time and historical performance data, real-time latency data, and average I/O sizes for each volume and and as a total of all volumes across the entire array.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_volumes_performance_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_post_with_http_info(
        ...
        **kwargs
        ...
        """Create or copy a volume and upsert tags  # noqa: E501
        ...
        >>> thread = api.api240_volumes_post_with_http_info(volume, authorization, x_request_id, add_to_protection_group_ids, add_to_protection_group_names, allow_throttle, context_names, names, overwrite, with_default_protection, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_protection_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_volumes_protection_groups_delete_with_http_info(authorization, x_request_id, context_names, group_ids, group_names, member_ids, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_protection_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_volumes_protection_groups_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, group_ids, group_names, limit, member_destroyed, member_ids, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_protection_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_volumes_protection_groups_post_with_http_info(authorization, x_request_id, context_names, group_ids, group_names, member_ids, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_space_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_volumes_space_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_tags_batch_put_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_volumes_tags_batch_put_with_http_info(tag, authorization, x_request_id, context_names, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_tags_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_volumes_tags_delete_with_http_info(authorization, x_request_id, context_names, keys, namespaces, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_tags_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_volumes_tags_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, limit, namespaces, offset, resource_destroyed, resource_ids, resource_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_test_post_with_http_info(
        ...
        **kwargs
        ...
        Creates a dry run attempt to see if copying a volume would succeed. No virtual volumes are actually copied or created in this process.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_volumes_test_post_with_http_info(volume, authorization, x_request_id, add_to_protection_group_ids, add_to_protection_group_names, allow_throttle, context_names, names, overwrite, with_default_protection, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_volumes_volume_groups_get_with_http_info(
        ...
        **kwargs
        ...
        Displays a list of volumes that are in a volume group.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_volumes_volume_groups_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, group_ids, group_names, limit, member_ids, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_volumes_volume_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
