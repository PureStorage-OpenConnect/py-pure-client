...
from pypureclient.flasharray.FA_2_40.models.smis_get_response import SmisGetResponse
from pypureclient.flasharray.FA_2_40.models.smis_response import SmisResponse
...
class SMISApi:
    ...
    def api240_smi_s_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_smi_s_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api240_smi_s_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_smi_s_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_smi_s_patch_with_http_info(smi_s, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_smi_s_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
