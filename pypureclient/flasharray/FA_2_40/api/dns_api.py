...
from pypureclient.flasharray.FA_2_40.models.dns_get_response import DnsGetResponse
from pypureclient.flasharray.FA_2_40.models.dns_patch import DnsPatch
from pypureclient.flasharray.FA_2_40.models.dns_post import DnsPost
from pypureclient.flasharray.FA_2_40.models.dns_response import DnsResponse
...
class DNSApi:
    ...
    def api240_dns_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_dns_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api240_dns_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_dns_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_dns_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api240_dns_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_dns_patch_with_http_info(dns, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_dns_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_dns_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_dns_post_with_http_info(dns, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_dns_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
