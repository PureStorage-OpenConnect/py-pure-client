...
class RealmsApi:
    ...
    def api240_realms_delete_with_http_info(
        ...
        _param = self._api240_realms_delete_serialize(
    ...
    def _api240_realms_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
    ...
    def api240_realms_get_with_http_info(
        ...
        _param = self._api240_realms_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api240_realms_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api240_realms_patch_with_http_info(
        ...
        _param = self._api240_realms_patch_serialize(
            realm = realm,
            authorization = authorization,
            x_request_id = x_request_id,
            ids = ids,
    ...
    def _api240_realms_patch_serialize(
        self,
        realm,
        authorization,
        x_request_id,
    ...
    def api240_realms_performance_get_with_http_info(
        ...
        _param = self._api240_realms_performance_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api240_realms_performance_get_serialize(
        self,
        authorization,
        x_request_id,
        allow_errors,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.40/realms/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api240_realms_post_with_http_info(
        ...
        _param = self._api240_realms_post_serialize(
            names = names,
            authorization = authorization,
            x_request_id = x_request_id,
            realm = realm,
    ...
    def _api240_realms_post_serialize(
        self,
        names,
        authorization,
        x_request_id,
    ...
    def api240_realms_space_get_with_http_info(
        ...
        _param = self._api240_realms_space_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            destroyed = destroyed,
            filter = filter,
    ...
    def _api240_realms_space_get_serialize(
        self,
        authorization,
        x_request_id,
        destroyed,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.40/realms/space',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
