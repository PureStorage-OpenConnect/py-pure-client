...
from pypureclient.flasharray.FA_2_40.models.container_performance_get_response import ContainerPerformanceGetResponse
from pypureclient.flasharray.FA_2_40.models.realm_get_response import RealmGetResponse
from pypureclient.flasharray.FA_2_40.models.realm_patch import RealmPatch
from pypureclient.flasharray.FA_2_40.models.realm_post import RealmPost
from pypureclient.flasharray.FA_2_40.models.realm_response import RealmResponse
from pypureclient.flasharray.FA_2_40.models.realm_space_get_response import RealmSpaceGetResponse
...
class RealmsApi:
    ...
    def api240_realms_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_realms_delete_with_http_info(authorization, x_request_id, eradicate_contents, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api240_realms_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_realms_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_realms_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, ids, limit, names, offset, sort, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_realms_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_realms_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_realms_patch_with_http_info(realm, authorization, x_request_id, destroy_contents, ids, ignore_usage, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_realms_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_realms_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_realms_performance_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_realms_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_realms_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_realms_post_with_http_info(names, authorization, x_request_id, realm, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_realms_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_realms_space_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_realms_space_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_realms_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
