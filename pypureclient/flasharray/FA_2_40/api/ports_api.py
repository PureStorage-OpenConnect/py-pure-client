...
class PortsApi:
    ...
    def api240_ports_get_with_http_info(
        ...
        _param = self._api240_ports_get_serialize(
    ...
    def _api240_ports_get_serialize(
        self,
        authorization,
        x_request_id,
        allow_errors,
    ...
    def api240_ports_initiators_get_with_http_info(
        ...
        _param = self._api240_ports_initiators_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            allow_errors = allow_errors,
            context_names = context_names,
    ...
    def _api240_ports_initiators_get_serialize(
        self,
        authorization,
        x_request_id,
        allow_errors,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.40/ports/initiators',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
