...
class PortsApi:
    ...
    def api240_ports_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_ports_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api240_ports_initiators_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api240_ports_initiators_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
