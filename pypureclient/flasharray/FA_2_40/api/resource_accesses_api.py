...
from pypureclient.flasharray.FA_2_40.models.resource_access import ResourceAccess
from pypureclient.flasharray.FA_2_40.models.resource_accesses_get_response import ResourceAccessesGetResponse
from pypureclient.flasharray.FA_2_40.models.resource_accesses_response import ResourceAccessesResponse
from pypureclient.flasharray.FA_2_40.models.resource_accesses_status_get_response import ResourceAccessesStatusGetResponse
...
class ResourceAccessesApi:
    ...
    def api240_resource_accesses_batch_post_with_http_info(
        ...
        **kwargs
        ...
        """Create a resource access configuration  # noqa: E501

        Creates resource access objects.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_resource_accesses_batch_post_with_http_info(items, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api240_resource_accesses_batch_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_resource_accesses_delete_with_http_info(
        ...
        **kwargs
        ...
        """Delete a resource access configuration  # noqa: E501

        Deletes a resource access object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_resource_accesses_delete_with_http_info(authorization, x_request_id, ids, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_resource_accesses_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_resource_accesses_get_with_http_info(
        ...
        **kwargs
        ...
        """List resource access configurations  # noqa: E501

        Displays a list of configured resource accesses.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_resource_accesses_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_resource_accesses_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api240_resource_accesses_status_get_with_http_info(
        ...
        **kwargs
        ...
        """List status of resource accesses as specified by resource access configuration  # noqa: E501

        Displays a list of effective resource accesses.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api240_resource_accesses_status_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_resource_accesses_status_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
