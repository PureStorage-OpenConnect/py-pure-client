...
from pypureclient.flasharray.FA_2_40.models.remote_protection_group_snapshot_get_response import RemoteProtectionGroupSnapshotGetResponse
from pypureclient.flasharray.FA_2_40.models.remote_protection_group_snapshot_post import RemoteProtectionGroupSnapshotPost
...
class RemoteProtectionGroupSnapshotsApi:
    ...
    def api240_remote_protection_group_snapshots_delete_with_http_info(
        ...
        _param = self._api240_remote_protection_group_snapshots_delete_serialize(
    ...
    def _api240_remote_protection_group_snapshots_delete_serialize(
        self,
        authorization,
        x_request_id,
        context_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.40/remote-protection-group-snapshots',
    ...
    def api240_remote_protection_group_snapshots_get_with_http_info(
        ...
        _param = self._api240_remote_protection_group_snapshots_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api240_remote_protection_group_snapshots_get_serialize(
        self,
        authorization,
        x_request_id,
        allow_errors,
    ...
    def api240_remote_protection_group_snapshots_patch_with_http_info(
        ...
        _param = self._api240_remote_protection_group_snapshots_patch_serialize(
    ...
    def _api240_remote_protection_group_snapshots_patch_serialize(
        self,
    ...
    def api240_remote_protection_group_snapshots_post_with_http_info(
        ...
        _param = self._api240_remote_protection_group_snapshots_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api240_remote_protection_group_snapshots_post_serialize(
        self,
        authorization,
        x_request_id,
        apply_retention,
    ...
    def api240_remote_protection_group_snapshots_test_post_with_http_info(
        ...
        _param = self._api240_remote_protection_group_snapshots_test_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            context_names = context_names,
            apply_retention = apply_retention,
    ...
    def _api240_remote_protection_group_snapshots_test_post_serialize(
        self,
        authorization,
        x_request_id,
        context_names,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2.40/remote-protection-group-snapshots/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api240_remote_protection_group_snapshots_transfer_get_with_http_info(
        ...
        _param = self._api240_remote_protection_group_snapshots_transfer_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            allow_errors = allow_errors,
            context_names = context_names,
    ...
    def _api240_remote_protection_group_snapshots_transfer_get_serialize(
        self,
        authorization,
        x_request_id,
        allow_errors,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.40/remote-protection-group-snapshots/transfer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
