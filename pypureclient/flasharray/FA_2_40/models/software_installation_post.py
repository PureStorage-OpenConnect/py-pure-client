...
class SoftwareInstallationPost(BaseModel):
    ...
    def to_dict(self, include_readonly: bool=True) -> Dict[str, Any]:
        ...
        if _include_in_dict('upgrade_parameters', include_readonly, excluded_fields, none_fields):
            _items = []
            for _item in self.upgrade_parameters:
                if _item:
                    _items.append(_item.to_dict(include_readonly=include_readonly))
    ...
    def from_dict(cls, obj: dict) -> SoftwareInstallationPost:
        ...
        _obj = SoftwareInstallationPost.construct(_fields_set=None, **{
            ...
            "upgrade_parameters": [UpgradeParameters.from_dict(_item) for _item in obj.get("upgrade_parameters")] if obj.get("upgrade_parameters") is not None else None
        })
        return _obj
