...
class VolumeGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "context", "workload", "destroyed", "qos", "priority_adjustment", "time_remaining", "volume_count", "pod", "space"]
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded, if `include_readonly` is `False`.
        ...
        if self.workload and (include_readonly or "workload" not in excluded_fields):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "workload": WorkloadConfigurationFixedReferenceWorkload.from_dict(obj["workload"]) if obj.get("workload") is not None else None,
