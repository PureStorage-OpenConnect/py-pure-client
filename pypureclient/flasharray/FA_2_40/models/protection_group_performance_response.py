...
from pypureclient.flasharray.FA_2_40.models.protection_group_performance import ProtectionGroupPerformance
from typing import Optional, Set
from typing_extensions import Self

class ProtectionGroupPerformanceResponse(BaseModel):
    """
    ...
    items: Optional[List[ProtectionGroupPerformance]] = Field(default=None, description="A list of protection group performance objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [ProtectionGroupPerformance.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
