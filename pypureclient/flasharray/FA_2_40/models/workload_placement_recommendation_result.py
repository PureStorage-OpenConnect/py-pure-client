...
class WorkloadPlacementRecommendationResult(BaseModel):
    ...
    placements: Optional[List[WorkloadPlacementRecommendationPlacement]] = Field(default=None, description="The placements of the preset.")
    __properties: ClassVar[List[str]] = ["score", "placements"]
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded, if `include_readonly` is `False`.
        ...
        if self.placements and (include_readonly or "placements" not in excluded_fields):
            _items = []
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            "score": obj.get("score"),
            "placements": [WorkloadPlacementRecommendationPlacement.from_dict(_item) for _item in obj["placements"]] if obj.get("placements") is not None else None
        })
        return _obj
