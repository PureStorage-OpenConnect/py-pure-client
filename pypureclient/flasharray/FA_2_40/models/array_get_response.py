...
from pypureclient.flasharray.FA_2_40.models.arrays import Arrays
...
class ArrayGetResponse(BaseModel):
    ...
    items: Optional[List[Arrays]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [Arrays.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
