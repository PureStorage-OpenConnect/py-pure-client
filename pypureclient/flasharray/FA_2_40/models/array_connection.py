...
class ArrayConnection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "context", "management_address", "replication_addresses", "status", "type", "replication_transport", "version", "throttle", "encryption", "encryption_mode", "os", "remote"]
