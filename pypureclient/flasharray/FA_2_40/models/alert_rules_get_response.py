...
from pypureclient.flasharray.FA_2_40.models.alert_rules import AlertRules
...
class AlertRulesGetResponse(BaseModel):
    ...
    items: Optional[List[AlertRules]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [AlertRules.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
