...
from pypureclient.flasharray.FA_2_40.models.protection_group_performance_array import ProtectionGroupPerformanceArray
from typing import Optional, Set
from typing_extensions import Self

class ProtectionGroupPerformanceArrayResponse(BaseModel):
    """
    ...
    items: Optional[List[ProtectionGroupPerformanceArray]] = Field(default=None, description="Lists performance data, broken down by array.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [ProtectionGroupPerformanceArray.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
