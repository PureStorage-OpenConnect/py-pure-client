...
class ResourceAccess(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "resource", "scope"]
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded, if `include_readonly` is `False`.
        ...
        if self.scope and (include_readonly or "scope" not in excluded_fields):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            "id": obj.get("id"),
            "resource": ReferenceWithType.from_dict(obj["resource"]) if obj.get("resource") is not None else None,
            "scope": ReferenceWithType.from_dict(obj["scope"]) if obj.get("scope") is not None else None
        })
        return _obj
