...
class PodGetResponse(BaseModel):
    ...
    total: Optional[List[Pod]] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field, if meaningful.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [Pod.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "errors": [ErrorcontextresponseErrors.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
            "total": [Pod.from_dict(_item) for _item in obj["total"]] if obj.get("total") is not None else None
        })
        return _obj
