...
class FleetPatch(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FleetPatch:
        """Create an instance of FleetPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FleetPatch:
        """Create an instance of FleetPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FleetPatch.parse_obj(obj)

        _obj = FleetPatch.construct(_fields_set=None, **{
            "name": obj.get("name")
        })
        return _obj
