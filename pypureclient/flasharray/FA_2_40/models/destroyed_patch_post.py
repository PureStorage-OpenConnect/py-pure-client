...
class DestroyedPatchPost(BaseModel):
    """
    DestroyedPatchPost
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DestroyedPatchPost:
        """Create an instance of DestroyedPatchPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DestroyedPatchPost:
        """Create an instance of DestroyedPatchPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DestroyedPatchPost.parse_obj(obj)

        _obj = DestroyedPatchPost.construct(_fields_set=None, **{
