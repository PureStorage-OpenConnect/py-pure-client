...
from pypureclient.flasharray.FA_2_40.models.cloud_config_model import CloudConfigModel
...
class CloudConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "model"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "model": CloudConfigModel.from_dict(obj["model"]) if obj.get("model") is not None else None
        })
        return _obj
