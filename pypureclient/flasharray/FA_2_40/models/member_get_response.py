...
from pypureclient.flasharray.FA_2_40.models.member import Member
...
class MemberGetResponse(BaseModel):
    ...
    items: Optional[List[Member]] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name where meaningful. If `total_only=true`, the `items` list will be empty.")
