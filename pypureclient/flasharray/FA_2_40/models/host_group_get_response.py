...
from pypureclient.flasharray.FA_2_40.models.host_group import HostGroup
from typing import Optional, Set
from typing_extensions import Self

class HostGroupGetResponse(BaseModel):
    """
    ...
    items: Optional[List[HostGroup]] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [HostGroup.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
