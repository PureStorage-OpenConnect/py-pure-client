...
from pypureclient.flasharray.FA_2_40.models.workload_parameter_value import WorkloadParameterValue
...
class WorkloadParameter(BaseModel):
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.value and (include_readonly or "value" not in excluded_fields):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            "name": obj.get("name"),
            "value": WorkloadParameterValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
