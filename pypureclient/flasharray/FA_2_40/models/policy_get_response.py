...
class PolicyGetResponse(BaseModel):
    ...
    items: Optional[conlist(Policy)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyGetResponse:
        """Create an instance of PolicyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyGetResponse:
        """Create an instance of PolicyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyGetResponse.parse_obj(obj)

        _obj = PolicyGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Policy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
