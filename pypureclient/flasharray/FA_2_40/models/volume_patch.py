...
from pypureclient.flasharray.FA_2_40.models.reference_with_fixed_type import ReferenceWithFixedType
...
class VolumePatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["destroyed", "name", "pod", "provisioned", "qos", "priority_adjustment", "volume_group", "requested_promotion_state", "protocol_endpoint", "workload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "workload": ReferenceWithFixedType.from_dict(obj["workload"]) if obj.get("workload") is not None else None
        })
        return _obj
