...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_33.models.hardware_get_response import HardwareGetResponse
from pypureclient.flasharray.FA_2_33.models.hardware_patch import HardwarePatch
from pypureclient.flasharray.FA_2_33.models.hardware_response import HardwareResponse
...
class HardwareApi:
    ...
    def api233_hardware_get_with_http_info(
        ...
        _param = self._api233_hardware_get_serialize(
    ...
    def _api233_hardware_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.33/hardware',
    ...
    def api233_hardware_patch_with_http_info(
        ...
        _param = self._api233_hardware_patch_serialize(
            hardware = hardware,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api233_hardware_patch_serialize(
        self,
        hardware,
        authorization,
        x_request_id,
