...
from pypureclient.flasharray.FA_2_33.models.offload_get_response import OffloadGetResponse
from pypureclient.flasharray.FA_2_33.models.offload_post import OffloadPost
from pypureclient.flasharray.FA_2_33.models.offload_response import OffloadResponse
...
class OffloadsApi:
    ...
    def api233_offloads_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api233_offloads_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api233_offloads_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api233_offloads_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api233_offloads_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, protocol, sort, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_offloads_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api233_offloads_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api233_offloads_post_with_http_info(offload, authorization, x_request_id, initialize, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_offloads_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
