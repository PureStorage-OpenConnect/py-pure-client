...
from pypureclient.flasharray.FA_2_33.models.remote_volume_snapshot_get_response import RemoteVolumeSnapshotGetResponse
from pypureclient.flasharray.FA_2_33.models.remote_volume_snapshot_post import RemoteVolumeSnapshotPost
from pypureclient.flasharray.FA_2_33.models.remote_volume_snapshot_response import RemoteVolumeSnapshotResponse
from pypureclient.flasharray.FA_2_33.models.remote_volume_snapshot_transfer_get_response import RemoteVolumeSnapshotTransferGetResponse
...
class RemoteVolumeSnapshotsApi:
    ...
    def api233_remote_volume_snapshots_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api233_remote_volume_snapshots_delete_with_http_info(authorization, x_request_id, names, on, replication_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api233_remote_volume_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api233_remote_volume_snapshots_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api233_remote_volume_snapshots_get_with_http_info(authorization, x_request_id, destroyed, filter, ids, limit, names, offset, on, sort, source_ids, source_names, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_remote_volume_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api233_remote_volume_snapshots_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api233_remote_volume_snapshots_patch_with_http_info(remote_volume_snapshot, authorization, x_request_id, names, on, replication_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_remote_volume_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api233_remote_volume_snapshots_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api233_remote_volume_snapshots_post_with_http_info(remote_volume_snapshot, authorization, x_request_id, on, source_ids, source_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_remote_volume_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api233_remote_volume_snapshots_transfer_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api233_remote_volume_snapshots_transfer_get_with_http_info(authorization, x_request_id, destroyed, filter, ids, limit, names, offset, on, sort, source_ids, source_names, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_remote_volume_snapshots_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
