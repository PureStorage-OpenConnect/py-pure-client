...
from pypureclient.flasharray.FA_2_33.models.fixed_reference import FixedReference
from pypureclient.flasharray.FA_2_33.models.protection_group_eradication_config import ProtectionGroupEradicationConfig
from pypureclient.flasharray.FA_2_33.models.space import Space
...
class ProtectionGroupSnapshotPatch(BaseModel):
    ...
    __properties = ["name", "id", "created", "destroyed", "eradication_config", "pod", "source", "space", "suffix", "time_remaining"]
