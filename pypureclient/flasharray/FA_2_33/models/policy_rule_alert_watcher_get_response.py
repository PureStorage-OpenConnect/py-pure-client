...
class PolicyRuleAlertWatcherGetResponse(BaseModel):
    ...
    items: Optional[List[PolicyRuleAlertWatcher]] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name, if meaningful.")
