...
from pypureclient.flasharray.FA_2_33.models.policy_nfs_policy_mapping import PolicyNfsPolicyMapping
...
class PolicySmb(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "destroyed", "enabled", "pod", "policy_type", "time_remaining", "access_based_enumeration_enabled", "policy_mapping"]
