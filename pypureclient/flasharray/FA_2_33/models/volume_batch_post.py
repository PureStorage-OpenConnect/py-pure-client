...
class VolumeBatchPost(BaseModel):
    ...
    add_to_protection_groups: Optional[List[Reference]] = Field(default=None, description="Specifies a list of protection groups that will protect the volume.")
    name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the volume.")
    tags: Optional[List[Tag]] = Field(default=None, description="Specifies the list of tags to be upserted on this volume.")
    __properties: ClassVar[List[str]] = ["destroyed", "provisioned", "qos", "priority_adjustment", "source", "subtype", "protocol_endpoint", "add_to_protection_groups", "name", "tags"]
