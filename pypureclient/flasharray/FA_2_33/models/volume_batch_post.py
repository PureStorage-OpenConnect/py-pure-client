...
from pypureclient.flasharray.FA_2_33.models.priority_adjustment import PriorityAdjustment
from pypureclient.flasharray.FA_2_33.models.protocol_endpoint import ProtocolEndpoint
from pypureclient.flasharray.FA_2_33.models.qos import Qos
...
class VolumeBatchPost(BaseModel):
    ...
    add_to_protection_groups: Optional[conlist(Reference)] = Field(default=None, description="Specifies a list of protection groups that will protect the volume.")
    name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the volume.")
    tags: Optional[conlist(Tag)] = Field(default=None, description="Specifies the list of tags to be upserted on this volume.")
    __properties = ["destroyed", "priority_adjustment", "protocol_endpoint", "provisioned", "qos", "source", "subtype", "add_to_protection_groups", "name", "tags"]
