...
class ResourcePodSpaceGetResponse(BaseModel):
    ...
    items: Optional[List[ResourcePodSpace]] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name. If `total_only=true`, the `items` list will be empty.")
