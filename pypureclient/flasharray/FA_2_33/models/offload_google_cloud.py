...
class OffloadGoogleCloud(BaseModel):
    ...
    profile: Optional[StrictStr] = Field(default=None, description="The offload target profile that will be selected for this target. This option allows more granular configuration for the target on top of the `protocol` parameter. Values include `gcp`.")
    ...
    __properties = ["access_key_id", "bucket", "profile", "secret_access_key"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OffloadGoogleCloud:
        """Create an instance of OffloadGoogleCloud from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> OffloadGoogleCloud:
        """Create an instance of OffloadGoogleCloud from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OffloadGoogleCloud.parse_obj(obj)

        _obj = OffloadGoogleCloud.construct(_fields_set=None, **{
