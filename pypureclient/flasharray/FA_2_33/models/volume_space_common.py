...
class VolumeSpaceCommon(BaseModel):
    ...
    snapshots_effective: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="This field has been deprecated. The effective space contributed by data unique to one or more snapshots, measured in bytes. Please use the `snapshots` field in the future, as it contains the same information for Evergreen//One arrays.")
    unique_effective: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="This field has been deprecated. The effective space contributed by unique customer data. Unique data does not include shared space, snapshots, and internal array metadata, measured in bytes. Please use the `unique` field in the future, as it contains the same information for Evergreen//One arrays.")
    total_effective: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="This field has been deprecated. The total effective space contributed by customer data, measured in bytes. Please use the `total_physical` field in the future, as it contains the same information for Evergreen//One arrays.")
    __properties: ClassVar[List[str]] = ["data_reduction", "shared", "snapshots", "system", "thin_provisioning", "total_physical", "total_provisioned", "total_reduction", "unique", "virtual", "used_provisioned", "total_used", "snapshots_effective", "unique_effective", "total_effective"]
