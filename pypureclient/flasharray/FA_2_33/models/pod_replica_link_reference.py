...
class PodReplicaLinkReference(BaseModel):
    ...
    remotes: Optional[List[FixedReference]] = Field(default=None, description="Reference to remote arrays.")
    remote_pod: Optional[FixedReference] = Field(default=None, description="Reference to a remote pod.")
    __properties: ClassVar[List[str]] = ["id", "local_pod", "remotes", "remote_pod"]
