...
from pypureclient.flasharray.FA_2_2.models.smis_get_response import SmisGetResponse
from pypureclient.flasharray.FA_2_2.models.smis_response import SmisResponse
...
class SMISApi:
    ...
    def api22_smi_s_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_smi_s_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api22_smi_s_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_smi_s_patch_with_http_info(smi_s, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
