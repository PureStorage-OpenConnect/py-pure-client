...
from pypureclient.flasharray.FA_2_2.models.directory_service import DirectoryService
from pypureclient.flasharray.FA_2_2.models.directory_service_get_response import DirectoryServiceGetResponse
from pypureclient.flasharray.FA_2_2.models.directory_service_response import DirectoryServiceResponse
from pypureclient.flasharray.FA_2_2.models.directory_service_role import DirectoryServiceRole
from pypureclient.flasharray.FA_2_2.models.directory_service_role_get_response import DirectoryServiceRoleGetResponse
from pypureclient.flasharray.FA_2_2.models.directory_service_role_response import DirectoryServiceRoleResponse
from pypureclient.flasharray.FA_2_2.models.test_result_with_resource_response import TestResultWithResourceResponse
...
class DirectoryServicesApi:
    ...
    def api22_directory_services_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_directory_services_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api22_directory_services_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_directory_services_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_directory_services_patch_with_http_info(names, directory_service, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_directory_services_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_directory_services_roles_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_directory_services_roles_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, offset, role_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_directory_services_roles_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_directory_services_roles_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_directory_services_roles_patch_with_http_info(role_names, directory_service_roles, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_directory_services_roles_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_directory_services_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_directory_services_test_get_with_http_info(names, authorization, x_request_id, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_directory_services_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
