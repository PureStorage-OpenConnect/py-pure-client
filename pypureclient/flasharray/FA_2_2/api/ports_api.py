...
from pypureclient.flasharray.FA_2_2.models.port_get_response import PortGetResponse
from pypureclient.flasharray.FA_2_2.models.port_initiators_get_response import PortInitiatorsGetResponse
...
class PortsApi:
    ...
    def api22_ports_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_ports_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api22_ports_initiators_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_ports_initiators_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
