...
class PortsApi:
    ...
    def api22_ports_get_with_http_info(
        ...
        _param = self._api22_ports_get_serialize(
    ...
    def _api22_ports_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
    ...
    def api22_ports_initiators_get_with_http_info(
        ...
        _param = self._api22_ports_initiators_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api22_ports_initiators_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.2/ports/initiators',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
