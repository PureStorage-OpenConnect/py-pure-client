...
from pypureclient.flasharray.FA_2_2.models.volume_snapshot_get_response import VolumeSnapshotGetResponse
from pypureclient.flasharray.FA_2_2.models.volume_snapshot_patch import VolumeSnapshotPatch
from pypureclient.flasharray.FA_2_2.models.volume_snapshot_post import VolumeSnapshotPost
from pypureclient.flasharray.FA_2_2.models.volume_snapshot_response import VolumeSnapshotResponse
from pypureclient.flasharray.FA_2_2.models.volume_snapshot_transfer_get_response import VolumeSnapshotTransferGetResponse
...
class VolumeSnapshotsApi:
    ...
    def api22_volume_snapshots_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_volume_snapshots_delete_with_http_info(authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api22_volume_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_volume_snapshots_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_volume_snapshots_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, ids, limit, names, offset, sort, source_ids, source_names, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_volume_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_volume_snapshots_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_volume_snapshots_patch_with_http_info(volume_snapshot, authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_volume_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_volume_snapshots_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_volume_snapshots_post_with_http_info(volume_snapshot, authorization, x_request_id, on, source_ids, source_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_volume_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_volume_snapshots_tags_batch_put_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_volume_snapshots_tags_batch_put_with_http_info(tag, authorization, x_request_id, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_volume_snapshots_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_volume_snapshots_tags_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_volume_snapshots_tags_delete_with_http_info(authorization, x_request_id, keys, namespaces, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_volume_snapshots_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_volume_snapshots_tags_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_volume_snapshots_tags_get_with_http_info(authorization, x_request_id, filter, limit, offset, resource_destroyed, resource_ids, resource_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_volume_snapshots_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_volume_snapshots_transfer_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_volume_snapshots_transfer_get_with_http_info(authorization, x_request_id, destroyed, filter, ids, limit, names, offset, sort, source_ids, source_names, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_volume_snapshots_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
