...
from pypureclient.flasharray.FA_2_2.models.pod_performance_replication import PodPerformanceReplication
...
class PodPerformanceReplicationGetResponse(BaseModel):
    ...
    total: Optional[List[PodPerformanceReplication]] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field if meaningful.")
