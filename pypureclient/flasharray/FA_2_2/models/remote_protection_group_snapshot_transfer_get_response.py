...
class RemoteProtectionGroupSnapshotTransferGetResponse(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            items (list[RemoteProtectionGroupSnapshotTransfer])
            total (list[RemoteProtectionGroupSnapshotTransfer]): The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field where meaningful.
        """
