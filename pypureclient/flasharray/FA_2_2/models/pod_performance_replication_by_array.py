...
from pypureclient.flasharray.FA_2_2.models.fixed_reference import FixedReference
from pypureclient.flasharray.FA_2_2.models.replication_performance_with_total import ReplicationPerformanceWithTotal
from pypureclient.flasharray.FA_2_2.models.resource import Resource
...
class PodPerformanceReplicationByArray(BaseModel):
    ...
    __properties = ["continuous_bytes_per_sec", "pod", "resync_bytes_per_sec", "sync_bytes_per_sec", "time", "total_bytes_per_sec", "array"]
