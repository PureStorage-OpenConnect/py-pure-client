...
class VolumeGroupGetResponse(BaseModel):
    ...
    total: Optional[List[VolumeGroup]] = Field(default=None, description="The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field where meaningful.")
