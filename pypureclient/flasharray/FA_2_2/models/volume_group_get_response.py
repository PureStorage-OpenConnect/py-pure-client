...
from pypureclient.flasharray.FA_2_2.models.volume_group import VolumeGroup
...
class VolumeGroupGetResponse(BaseModel):
    ...
    total: Optional[conlist(VolumeGroup)] = Field(default=None, description="The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field where meaningful.")
