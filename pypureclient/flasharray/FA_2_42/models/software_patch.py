...
class SoftwarePatch(BaseModel):
    ...
    alert_code: Optional[StrictInt] = Field(default=None, description="Alert code for the Software Patch. This code is used to uniquely identify the Software Patch.")
    ...
    ha_reduction_required: Optional[StrictBool] = Field(default=None, description="If set to `true`, indicates reduction in high availability is required for Software Patch installation. If set to `false`, indicates such a reduction is not required.")
    ...
    __properties = ["id", "name", "alert_code", "description", "details", "ha_reduction_required", "progress", "status"]
    ...
    def from_dict(cls, obj: dict) -> SoftwarePatch:
        ...
        _obj = SoftwarePatch.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "alert_code": obj.get("alert_code"),
            "description": obj.get("description"),
            "details": obj.get("details"),
            "ha_reduction_required": obj.get("ha_reduction_required"),
