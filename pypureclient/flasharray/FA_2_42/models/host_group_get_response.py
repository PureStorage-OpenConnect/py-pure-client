...
from pypureclient.flasharray.FA_2_42.models.host_group import HostGroup
...
class HostGroupGetResponse(BaseModel):
    ...
    items: Optional[conlist(HostGroup)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HostGroupGetResponse:
        """Create an instance of HostGroupGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> HostGroupGetResponse:
        """Create an instance of HostGroupGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HostGroupGetResponse.parse_obj(obj)

        _obj = HostGroupGetResponse.construct(_fields_set=None, **{
            ...
            "items": [HostGroup.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
