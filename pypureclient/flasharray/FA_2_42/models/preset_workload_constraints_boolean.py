...
class PresetWorkloadConstraintsBoolean(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PresetWorkloadConstraintsBoolean:
        """Create an instance of PresetWorkloadConstraintsBoolean from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PresetWorkloadConstraintsBoolean:
        """Create an instance of PresetWorkloadConstraintsBoolean from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PresetWorkloadConstraintsBoolean.parse_obj(obj)

        _obj = PresetWorkloadConstraintsBoolean.construct(_fields_set=None, **{
