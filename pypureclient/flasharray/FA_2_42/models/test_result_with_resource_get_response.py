...
from pypureclient.flasharray.FA_2_42.models.test_result_with_resource import TestResultWithResource


class TestResultWithResourceGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultWithResourceGetResponse:
        """Create an instance of TestResultWithResourceGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TestResultWithResourceGetResponse:
