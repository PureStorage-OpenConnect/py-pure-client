...
class SnapshotSpace(BaseModel):
    ...
    __properties = ["data_reduction", "footprint", "shared", "snapshots", "system", "thin_provisioning", "total_physical", "total_provisioned", "total_reduction", "total_used", "unique", "used_provisioned", "virtual", "snapshots_effective"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnapshotSpace:
        """Create an instance of SnapshotSpace from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SnapshotSpace:
        """Create an instance of SnapshotSpace from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnapshotSpace.parse_obj(obj)

        _obj = SnapshotSpace.construct(_fields_set=None, **{
