...
class PolicyRuleSmbClient(BaseModel):
    ...
    time_remaining: Optional[StrictInt] = Field(default=None, description="The amount of time left, in milliseconds, until the destroyed SMB policy rule is permanently eradicated.")
    __properties = ["context", "anonymous_access_allowed", "client", "destroyed", "name", "policy", "smb_encryption_required", "time_remaining"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleSmbClient:
        """Create an instance of PolicyRuleSmbClient from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleSmbClient:
        """Create an instance of PolicyRuleSmbClient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleSmbClient.parse_obj(obj)

        _obj = PolicyRuleSmbClient.construct(_fields_set=None, **{
