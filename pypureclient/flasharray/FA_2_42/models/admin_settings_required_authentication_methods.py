...
class AdminSettingsRequiredAuthenticationMethods(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdminSettingsRequiredAuthenticationMethods:
        """Create an instance of AdminSettingsRequiredAuthenticationMethods from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AdminSettingsRequiredAuthenticationMethods:
        """Create an instance of AdminSettingsRequiredAuthenticationMethods from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdminSettingsRequiredAuthenticationMethods.parse_obj(obj)

        _obj = AdminSettingsRequiredAuthenticationMethods.construct(_fields_set=None, **{
            "ssh": obj.get("ssh"),
