...
class KMIPApi(object):
    ...
    def api242_kmip_delete_with_http_info(
        ...
        >>> thread = api.api242_kmip_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_kmip_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_kmip_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_kmip_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_kmip_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_kmip_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_kmip_patch_with_http_info(kmip, async_req=True)
        >>> result = thread.get()
        ...
        if kmip is None:
            raise TypeError("Missing the required parameter `kmip` when calling `api242_kmip_patch`")
    ...
    def api242_kmip_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_kmip_post_with_http_info(kmip, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'kmip' is set
        if kmip is None:
            raise TypeError("Missing the required parameter `kmip` when calling `api242_kmip_post`")
    ...
    def api242_kmip_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_kmip_test_get_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api242_kmip_test_get`")
