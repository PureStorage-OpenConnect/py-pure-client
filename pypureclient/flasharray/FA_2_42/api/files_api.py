...
class FilesApi(object):
    ...
    def api242_files_post_with_http_info(
        ...
        >>> thread = api.api242_files_post_with_http_info(source_file, async_req=True)
        >>> result = thread.get()
        ...
        if source_file is None:
            raise TypeError("Missing the required parameter `source_file` when calling `api242_files_post`")
