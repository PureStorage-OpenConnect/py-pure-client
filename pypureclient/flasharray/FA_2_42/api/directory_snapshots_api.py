...
class DirectorySnapshotsApi(object):
    ...
    def api242_directory_snapshots_delete_with_http_info(
        self,
        ...
        >>> thread = api.api242_directory_snapshots_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.42/directory-snapshots', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api242_directory_snapshots_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_directory_snapshots_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_directory_snapshots_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_directory_snapshots_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.42/directory-snapshots', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api242_directory_snapshots_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_directory_snapshots_patch_with_http_info(directory_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        if directory_snapshot is None:
            raise TypeError("Missing the required parameter `directory_snapshot` when calling `api242_directory_snapshots_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.42/directory-snapshots', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api242_directory_snapshots_post_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_directory_snapshots_post_with_http_info(directory_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'directory_snapshot' is set
        if directory_snapshot is None:
            raise TypeError("Missing the required parameter `directory_snapshot` when calling `api242_directory_snapshots_post`")
        ...
        return self.api_client.call_api(
            '/api/2.42/directory-snapshots', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
