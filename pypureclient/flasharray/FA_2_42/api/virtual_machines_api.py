...
class VirtualMachinesApi(object):
    ...
    def api242_virtual_machine_snapshots_get_with_http_info(
        self,
        ...
        >>> thread = api.api242_virtual_machine_snapshots_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_virtual_machine_snapshots_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_virtual_machine_snapshots_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.42/virtual-machine-snapshots', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api242_virtual_machine_volume_snapshots_get_with_http_info(
        self,
        vm_ids=None,  # type: List[str]
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_virtual_machine_volume_snapshots_get_with_http_info(vm_ids, async_req=True)
        >>> result = thread.get()
        ...
        if vm_ids is None:
            raise TypeError("Missing the required parameter `vm_ids` when calling `api242_virtual_machine_volume_snapshots_get`")

        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_virtual_machine_volume_snapshots_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_virtual_machine_volume_snapshots_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.42/virtual-machine-volume-snapshots', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api242_virtual_machines_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        continuation_token=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_virtual_machines_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_virtual_machines_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_virtual_machines_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_virtual_machines_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_virtual_machines_patch_with_http_info(virtual_machine, async_req=True)
        >>> result = thread.get()
        ...
        if virtual_machine is None:
            raise TypeError("Missing the required parameter `virtual_machine` when calling `api242_virtual_machines_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.42/virtual-machines', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api242_virtual_machines_post_with_http_info(
        self,
        virtual_machine=None,  # type: models.VirtualMachinePost
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_virtual_machines_post_with_http_info(virtual_machine, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'virtual_machine' is set
        if virtual_machine is None:
            raise TypeError("Missing the required parameter `virtual_machine` when calling `api242_virtual_machines_post`")
        ...
        return self.api_client.call_api(
            '/api/2.42/virtual-machines', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
