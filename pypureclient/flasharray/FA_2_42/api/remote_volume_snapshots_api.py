...
class RemoteVolumeSnapshotsApi(object):
    ...
    def api242_remote_volume_snapshots_delete_with_http_info(
        ...
        >>> thread = api.api242_remote_volume_snapshots_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_remote_volume_snapshots_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_remote_volume_snapshots_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_remote_volume_snapshots_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_remote_volume_snapshots_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_remote_volume_snapshots_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_remote_volume_snapshots_patch_with_http_info(remote_volume_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        if remote_volume_snapshot is None:
            raise TypeError("Missing the required parameter `remote_volume_snapshot` when calling `api242_remote_volume_snapshots_patch`")
    ...
    def api242_remote_volume_snapshots_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_remote_volume_snapshots_post_with_http_info(remote_volume_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'remote_volume_snapshot' is set
        if remote_volume_snapshot is None:
            raise TypeError("Missing the required parameter `remote_volume_snapshot` when calling `api242_remote_volume_snapshots_post`")
    ...
    def api242_remote_volume_snapshots_transfer_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_remote_volume_snapshots_transfer_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_remote_volume_snapshots_transfer_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_remote_volume_snapshots_transfer_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
