...
class PresetsApi(object):
    ...
    def api242_presets_workload_delete_with_http_info(
        ...
        >>> thread = api.api242_presets_workload_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_presets_workload_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_presets_workload_get_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_presets_workload_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_presets_workload_patch_with_http_info(preset, async_req=True)
        >>> result = thread.get()
        ...
        if preset is None:
            raise TypeError("Missing the required parameter `preset` when calling `api242_presets_workload_patch`")
    ...
    def api242_presets_workload_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_presets_workload_post_with_http_info(preset, names, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'preset' is set
        if preset is None:
            raise TypeError("Missing the required parameter `preset` when calling `api242_presets_workload_post`")
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api242_presets_workload_post`")
    ...
    def api242_presets_workload_put_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_presets_workload_put_with_http_info(preset, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'preset' is set
        if preset is None:
            raise TypeError("Missing the required parameter `preset` when calling `api242_presets_workload_put`")
