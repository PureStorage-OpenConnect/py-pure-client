...
class FileSystemsApi(object):
    ...
    def api242_file_systems_delete_with_http_info(
        self,
        ...
        >>> thread = api.api242_file_systems_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_file_systems_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_file_systems_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_file_systems_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_file_systems_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_file_systems_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_file_systems_patch_with_http_info(file_system, async_req=True)
        >>> result = thread.get()
        ...
        if file_system is None:
            raise TypeError("Missing the required parameter `file_system` when calling `api242_file_systems_patch`")
    ...
    def api242_file_systems_post_with_http_info(
        self,
        names=None,  # type: List[str]
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_file_systems_post_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api242_file_systems_post`")
