...
from pypureclient.flasharray.FA_2_42.models.alert import Alert
from pypureclient.flasharray.FA_2_42.models.alert_event_get_response import AlertEventGetResponse
from pypureclient.flasharray.FA_2_42.models.alert_get_response import AlertGetResponse
from pypureclient.flasharray.FA_2_42.models.alert_response import AlertResponse
from pypureclient.flasharray.FA_2_42.models.alert_rules import AlertRules
from pypureclient.flasharray.FA_2_42.models.alert_rules_catalog_get_response import AlertRulesCatalogGetResponse
from pypureclient.flasharray.FA_2_42.models.alert_rules_get_response import AlertRulesGetResponse
from pypureclient.flasharray.FA_2_42.models.alert_rules_response import AlertRulesResponse
...
class AlertsApi:
    ...
    def api242_alerts_events_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_alerts_events_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, flagged, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api242_alerts_events_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_alerts_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_alerts_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, flagged, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_alerts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_alerts_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_alerts_patch_with_http_info(alert, authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_alerts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_alerts_rules_catalog_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_alerts_rules_catalog_get_with_http_info(authorization, x_request_id, allow_errors, code, context_names, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_alerts_rules_catalog_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_alerts_rules_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_alerts_rules_delete_with_http_info(code, parameter, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_alerts_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_alerts_rules_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_alerts_rules_get_with_http_info(authorization, x_request_id, allow_errors, code, context_names, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_alerts_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_alerts_rules_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_alerts_rules_patch_with_http_info(code, parameter, alert_rule, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_alerts_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_alerts_rules_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_alerts_rules_post_with_http_info(code, parameter, alert_rule, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_alerts_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
