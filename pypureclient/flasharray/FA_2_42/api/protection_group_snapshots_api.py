...
class ProtectionGroupSnapshotsApi(object):
    ...
    def api242_protection_group_snapshots_delete_with_http_info(
        ...
        >>> thread = api.api242_protection_group_snapshots_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_protection_group_snapshots_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_protection_group_snapshots_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_protection_group_snapshots_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_protection_group_snapshots_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_protection_group_snapshots_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_protection_group_snapshots_patch_with_http_info(protection_group_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        if protection_group_snapshot is None:
            raise TypeError("Missing the required parameter `protection_group_snapshot` when calling `api242_protection_group_snapshots_patch`")
    ...
    def api242_protection_group_snapshots_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_protection_group_snapshots_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_protection_group_snapshots_replica_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_protection_group_snapshots_replica_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_protection_group_snapshots_test_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_protection_group_snapshots_test_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_protection_group_snapshots_transfer_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_protection_group_snapshots_transfer_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_protection_group_snapshots_transfer_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_protection_group_snapshots_transfer_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
