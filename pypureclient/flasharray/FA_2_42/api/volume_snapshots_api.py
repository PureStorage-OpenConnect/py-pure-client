...
class VolumeSnapshotsApi(object):
    ...
    def api242_volume_snapshots_delete_with_http_info(
        ...
        >>> thread = api.api242_volume_snapshots_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_volume_snapshots_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_volume_snapshots_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_volume_snapshots_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_volume_snapshots_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_volume_snapshots_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_volume_snapshots_patch_with_http_info(volume_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        if volume_snapshot is None:
            raise TypeError("Missing the required parameter `volume_snapshot` when calling `api242_volume_snapshots_patch`")
    ...
    def api242_volume_snapshots_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_volume_snapshots_post_with_http_info(volume_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'volume_snapshot' is set
        if volume_snapshot is None:
            raise TypeError("Missing the required parameter `volume_snapshot` when calling `api242_volume_snapshots_post`")
    ...
    def api242_volume_snapshots_tags_batch_put_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_volume_snapshots_tags_batch_put_with_http_info(tag, async_req=True)
        >>> result = thread.get()
        ...
        if tag is None:
            raise TypeError("Missing the required parameter `tag` when calling `api242_volume_snapshots_tags_batch_put`")
    ...
    def api242_volume_snapshots_tags_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_volume_snapshots_tags_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_volume_snapshots_tags_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_volume_snapshots_tags_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_volume_snapshots_tags_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_volume_snapshots_tags_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_volume_snapshots_test_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_volume_snapshots_test_post_with_http_info(volume_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'volume_snapshot' is set
        if volume_snapshot is None:
            raise TypeError("Missing the required parameter `volume_snapshot` when calling `api242_volume_snapshots_test_post`")
    ...
    def api242_volume_snapshots_transfer_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_volume_snapshots_transfer_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_volume_snapshots_transfer_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_volume_snapshots_transfer_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
