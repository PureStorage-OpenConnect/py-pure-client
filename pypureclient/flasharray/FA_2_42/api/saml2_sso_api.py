...
class SAML2SSOApi(object):
    ...
    def api242_sso_saml2_idps_delete_with_http_info(
        ...
        >>> thread = api.api242_sso_saml2_idps_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_sso_saml2_idps_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_sso_saml2_idps_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_sso_saml2_idps_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_sso_saml2_idps_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_sso_saml2_idps_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_sso_saml2_idps_patch_with_http_info(idp, async_req=True)
        >>> result = thread.get()
        ...
        if idp is None:
            raise TypeError("Missing the required parameter `idp` when calling `api242_sso_saml2_idps_patch`")
    ...
    def api242_sso_saml2_idps_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_sso_saml2_idps_post_with_http_info(idp, names, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'idp' is set
        if idp is None:
            raise TypeError("Missing the required parameter `idp` when calling `api242_sso_saml2_idps_post`")
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api242_sso_saml2_idps_post`")
    ...
    def api242_sso_saml2_idps_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_sso_saml2_idps_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_sso_saml2_idps_test_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_sso_saml2_idps_test_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_sso_saml2_idps_test_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_sso_saml2_idps_test_patch_with_http_info(idp, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'idp' is set
        if idp is None:
            raise TypeError("Missing the required parameter `idp` when calling `api242_sso_saml2_idps_test_patch`")
