...
class AdministratorsApi(object):
    ...
    def api242_admins_api_tokens_delete_with_http_info(
        ...
        >>> thread = api.api242_admins_api_tokens_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_admins_api_tokens_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_api_tokens_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_admins_api_tokens_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_admins_api_tokens_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_admins_api_tokens_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_api_tokens_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_admins_cache_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_cache_delete_with_http_info(remove_all_entries, async_req=True)
        >>> result = thread.get()
        ...
        if remove_all_entries is None:
            raise TypeError("Missing the required parameter `remove_all_entries` when calling `api242_admins_cache_delete`")
    ...
    def api242_admins_cache_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_cache_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_admins_cache_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_admins_cache_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_admins_cache_put_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_cache_put_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_admins_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_admins_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_admins_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_admins_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_admins_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_patch_with_http_info(admin, async_req=True)
        >>> result = thread.get()
        ...
        if admin is None:
            raise TypeError("Missing the required parameter `admin` when calling `api242_admins_patch`")
    ...
    def api242_admins_policies_management_access_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_policies_management_access_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_admins_policies_management_access_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_policies_management_access_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_admins_policies_management_access_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_admins_policies_management_access_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_admins_policies_management_access_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_policies_management_access_post_with_http_info(policies, async_req=True)
        >>> result = thread.get()
        ...
        if policies is None:
            raise TypeError("Missing the required parameter `policies` when calling `api242_admins_policies_management_access_post`")
    ...
    def api242_admins_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_post_with_http_info(admin, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'admin' is set
        if admin is None:
            raise TypeError("Missing the required parameter `admin` when calling `api242_admins_post`")
    ...
    def api242_admins_settings_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_settings_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_admins_settings_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_admins_settings_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_admins_settings_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_admins_settings_patch_with_http_info(admin_settings, async_req=True)
        >>> result = thread.get()
        ...
        if admin_settings is None:
            raise TypeError("Missing the required parameter `admin_settings` when calling `api242_admins_settings_patch`")
