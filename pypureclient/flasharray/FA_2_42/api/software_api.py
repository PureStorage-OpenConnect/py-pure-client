...
from pypureclient.flasharray.FA_2_42.models.software_bundle_get_response import SoftwareBundleGetResponse
from pypureclient.flasharray.FA_2_42.models.software_bundle_post import SoftwareBundlePost
from pypureclient.flasharray.FA_2_42.models.software_bundle_response import SoftwareBundleResponse
from pypureclient.flasharray.FA_2_42.models.software_checks_get_response import SoftwareChecksGetResponse
from pypureclient.flasharray.FA_2_42.models.software_checks_response import SoftwareChecksResponse
from pypureclient.flasharray.FA_2_42.models.software_get_response import SoftwareGetResponse
from pypureclient.flasharray.FA_2_42.models.software_installation_patch import SoftwareInstallationPatch
from pypureclient.flasharray.FA_2_42.models.software_installation_post import SoftwareInstallationPost
from pypureclient.flasharray.FA_2_42.models.software_installation_steps_get_response import SoftwareInstallationStepsGetResponse
from pypureclient.flasharray.FA_2_42.models.software_installations_get_response import SoftwareInstallationsGetResponse
from pypureclient.flasharray.FA_2_42.models.software_installations_response import SoftwareInstallationsResponse
from pypureclient.flasharray.FA_2_42.models.software_patches_get_response import SoftwarePatchesGetResponse
from pypureclient.flasharray.FA_2_42.models.software_patches_response import SoftwarePatchesResponse
from pypureclient.flasharray.FA_2_42.models.software_post import SoftwarePost
from pypureclient.flasharray.FA_2_42.models.software_response import SoftwareResponse
from pypureclient.flasharray.FA_2_42.models.software_versions_get_response import SoftwareVersionsGetResponse
...
class SoftwareApi:
    ...
    def api242_software_bundle_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_bundle_get_with_http_info(x_request_id, filter, ids, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api242_software_bundle_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_bundle_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_bundle_post_with_http_info(source, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_bundle_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_check_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_check_delete_with_http_info(authorization, x_request_id, software_names, software_versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_check_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_check_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_check_get_with_http_info(authorization, x_request_id, filter, ids, limit, names, offset, software_names, software_versions, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_check_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_check_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_check_post_with_http_info(authorization, x_request_id, software_names, software_versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_check_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_delete_with_http_info(authorization, x_request_id, names, software_versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_get_with_http_info(authorization, x_request_id, filter, ids, limit, names, offset, sort, total_item_count, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_installation_steps_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_installation_steps_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, software_installation_ids, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_installation_steps_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_installations_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_installations_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, software_ids, software_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_installations_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_installations_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_installations_patch_with_http_info(command, current_step_id, authorization, x_request_id, software_installations, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_installations_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_installations_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_installations_post_with_http_info(software_ids, software_installations, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_installations_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_patches_catalog_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_patches_catalog_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_patches_catalog_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_patches_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_patches_get_with_http_info(authorization, x_request_id, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_patches_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_patches_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_patches_post_with_http_info(name, authorization, x_request_id, allow_ha_reduction, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_patches_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_post_with_http_info(software, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_software_versions_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api242_software_versions_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_software_versions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
