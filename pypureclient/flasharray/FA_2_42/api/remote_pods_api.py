...
from pypureclient.flasharray.FA_2_42.models.remote_pods_response import RemotePodsResponse
...
class RemotePodsApi:
    ...
    def api242_remote_pods_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        Displays a list of pods that that are on connected arrays but not stretched to this array.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api242_remote_pods_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, ids, limit, names, offset, on, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api242_remote_pods_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
