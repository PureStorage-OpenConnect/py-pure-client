...
class DirectoryExportsApi(object):
    ...
    def api242_directory_exports_delete_with_http_info(
        ...
        >>> thread = api.api242_directory_exports_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_directory_exports_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_directory_exports_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_directory_exports_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_directory_exports_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_directory_exports_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_directory_exports_patch_with_http_info(export, async_req=True)
        >>> result = thread.get()
        ...
        if export is None:
            raise TypeError("Missing the required parameter `export` when calling `api242_directory_exports_patch`")
    ...
    def api242_directory_exports_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_directory_exports_post_with_http_info(exports, async_req=True)
        >>> result = thread.get()
        ...
        if exports is None:
            raise TypeError("Missing the required parameter `exports` when calling `api242_directory_exports_post`")
