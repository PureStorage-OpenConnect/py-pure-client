...
class ContainerDefaultProtectionsApi(object):
    ...
    def api242_container_default_protections_get_with_http_info(
        ...
        >>> thread = api.api242_container_default_protections_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_container_default_protections_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_container_default_protections_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_container_default_protections_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_container_default_protections_patch_with_http_info(container_default_protection, async_req=True)
        >>> result = thread.get()
        ...
        if container_default_protection is None:
            raise TypeError("Missing the required parameter `container_default_protection` when calling `api242_container_default_protections_patch`")
