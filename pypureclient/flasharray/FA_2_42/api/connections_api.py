...
from pypureclient.flasharray.FA_2_42.models.connection_get_response import ConnectionGetResponse
from pypureclient.flasharray.FA_2_42.models.connection_post import ConnectionPost
from pypureclient.flasharray.FA_2_42.models.connection_response import ConnectionResponse
...
class ConnectionsApi:
    ...
    def api242_connections_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api242_connections_delete_with_http_info(authorization, x_request_id, context_names, host_group_names, host_names, volume_ids, volume_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api242_connections_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_connections_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api242_connections_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, host_group_names, host_names, limit, offset, protocol_endpoint_ids, protocol_endpoint_names, sort, total_item_count, volume_ids, volume_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_connections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api242_connections_post_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api242_connections_post_with_http_info(authorization, x_request_id, context_names, host_group_names, host_names, volume_ids, volume_names, connection, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api242_connections_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
