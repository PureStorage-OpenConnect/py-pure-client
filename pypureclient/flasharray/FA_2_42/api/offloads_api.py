...
class OffloadsApi(object):
    ...
    def api242_offloads_delete_with_http_info(
        ...
        >>> thread = api.api242_offloads_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_offloads_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_offloads_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_offloads_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_offloads_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_offloads_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_offloads_post_with_http_info(offload, async_req=True)
        >>> result = thread.get()
        ...
        if offload is None:
            raise TypeError("Missing the required parameter `offload` when calling `api242_offloads_post`")
