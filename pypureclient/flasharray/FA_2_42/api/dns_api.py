...
class DNSApi(object):
    ...
    def api242_dns_delete_with_http_info(
        ...
        >>> thread = api.api242_dns_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api242_dns_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_dns_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_dns_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_dns_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api242_dns_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_dns_patch_with_http_info(dns, async_req=True)
        >>> result = thread.get()
        ...
        if dns is None:
            raise TypeError("Missing the required parameter `dns` when calling `api242_dns_patch`")
    ...
    def api242_dns_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_dns_post_with_http_info(dns, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'dns' is set
        if dns is None:
            raise TypeError("Missing the required parameter `dns` when calling `api242_dns_post`")
