...
class ArrayConnectionsApi(object):
    ...
    def api242_array_connections_connection_key_get_with_http_info(
        self,
        ...
        >>> thread = api.api242_array_connections_connection_key_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.42/array-connections/connection-key', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api242_array_connections_delete_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_array_connections_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.42/array-connections', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api242_array_connections_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_array_connections_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_array_connections_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_array_connections_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.42/array-connections', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api242_array_connections_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_array_connections_patch_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.42/array-connections', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api242_array_connections_path_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        continuation_token=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_array_connections_path_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api242_array_connections_path_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api242_array_connections_path_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.42/array-connections/path', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api242_array_connections_post_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api242_array_connections_post_with_http_info(array_connection, async_req=True)
        >>> result = thread.get()
        ...
        if array_connection is None:
            raise TypeError("Missing the required parameter `array_connection` when calling `api242_array_connections_post`")
        ...
        return self.api_client.call_api(
            '/api/2.42/array-connections', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
