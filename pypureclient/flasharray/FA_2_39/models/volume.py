...
from pypureclient.flasharray.FA_2_39.models.protocol_endpoint import ProtocolEndpoint
...
from pypureclient.flasharray.FA_2_39.models.volume_space_common import VolumeSpaceCommon
...
class Volume(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "connection_count", "created", "destroyed", "host_encryption_key_status", "provisioned", "qos", "priority_adjustment", "serial", "space", "time_remaining", "context", "pod", "source", "subtype", "volume_group", "requested_promotion_state", "promotion_status", "priority", "protocol_endpoint"]
