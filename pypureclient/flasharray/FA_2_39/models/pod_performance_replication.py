...
from pypureclient.flasharray.FA_2_39.models.replication_performance_with_total import ReplicationPerformanceWithTotal
...
class PodPerformanceReplication(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["context", "continuous_bytes_per_sec", "resync_bytes_per_sec", "sync_bytes_per_sec", "periodic_bytes_per_sec", "total_bytes_per_sec", "pod", "time"]
