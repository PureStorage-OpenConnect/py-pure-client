...
class PodEradicationConfig(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PodEradicationConfig:
        """Create an instance of PodEradicationConfig from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PodEradicationConfig:
        """Create an instance of PodEradicationConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PodEradicationConfig.parse_obj(obj)

        _obj = PodEradicationConfig.construct(_fields_set=None, **{
