...
class TagBatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["copyable", "key", "namespace", "value", "resource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "value": obj.get("value"),
            "resource": Reference.from_dict(obj["resource"]) if obj.get("resource") is not None else None
        })
        return _obj
