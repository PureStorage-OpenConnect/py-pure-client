...
from pypureclient.flasharray.FA_2_39.models.resource_space_no_id import ResourceSpaceNoId
from typing import Optional, Set
from typing_extensions import Self

class ResourceSpaceNoIdGetResponse(BaseModel):
    """
    ...
    items: Optional[List[ResourceSpaceNoId]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [ResourceSpaceNoId.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
