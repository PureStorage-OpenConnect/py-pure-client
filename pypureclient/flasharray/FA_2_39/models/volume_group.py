...
from pypureclient.flasharray.FA_2_39.models.priority_adjustment import PriorityAdjustment
from pypureclient.flasharray.FA_2_39.models.qos import Qos
from pypureclient.flasharray.FA_2_39.models.reference import Reference
from pypureclient.flasharray.FA_2_39.models.space import Space
...
class VolumeGroup(BaseModel):
    ...
    __properties = ["id", "name", "context", "destroyed", "pod", "priority_adjustment", "qos", "space", "time_remaining", "volume_count"]
