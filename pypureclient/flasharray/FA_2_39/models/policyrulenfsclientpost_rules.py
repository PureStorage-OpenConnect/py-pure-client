...
class PolicyrulenfsclientpostRules(BaseModel):
    ...
    nfs_version: Optional[List[StrictStr]] = Field(default=None, description="NFS protocol version allowed for the export. Valid values are `nfsv3` and `nfsv4`. If not specified, defaults to `nfsv3`.")
    ...
    __properties: ClassVar[List[str]] = ["access", "anongid", "anonuid", "client", "nfs_version", "permission", "security"]
