...
from pypureclient.flasharray.FA_2_39.models.protection_group_eradication_config import ProtectionGroupEradicationConfig
from pypureclient.flasharray.FA_2_39.models.replication_schedule import ReplicationSchedule
from pypureclient.flasharray.FA_2_39.models.retention_policy import RetentionPolicy
from pypureclient.flasharray.FA_2_39.models.snapshot_schedule import SnapshotSchedule
...
class ProtectionGroup(BaseModel):
    ...
    __properties = ["name", "id", "context", "destroyed", "eradication_config", "host_count", "host_group_count", "is_local", "pod", "replication_schedule", "retention_lock", "snapshot_schedule", "source", "source_retention", "space", "target_count", "target_retention", "time_remaining", "volume_count"]
