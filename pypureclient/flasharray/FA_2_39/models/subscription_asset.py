...
from pypureclient.flasharray.FA_2_39.models.subscription_asset_subscription import SubscriptionAssetSubscription
...
class SubscriptionAsset(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "subscription"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "subscription": SubscriptionAssetSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        })
        return _obj
