...
class VolumeBatchPost(BaseModel):
    ...
    add_to_protection_groups: Optional[List[Reference]] = Field(default=None, description="Specifies a list of protection group that will compose the initial protection for the volume.")
