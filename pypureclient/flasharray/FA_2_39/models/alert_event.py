...
class AlertEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "context", "actual", "alert", "created", "code", "component_name", "component_type", "expected", "issue", "knowledge_base_url", "severity", "state", "summary", "time"]
