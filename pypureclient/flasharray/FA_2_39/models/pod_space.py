...
class PodSpace(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data_reduction", "shared", "snapshots", "system", "thin_provisioning", "total_physical", "total_provisioned", "total_reduction", "unique", "virtual", "used_provisioned", "total_used", "footprint", "replication", "shared_effective", "replication_effective"]
