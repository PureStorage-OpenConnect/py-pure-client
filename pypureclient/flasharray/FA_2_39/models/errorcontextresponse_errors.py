...
class ErrorcontextresponseErrors(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["context", "message", "location_context"]
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.location_context and (include_readonly or "location_context" not in excluded_fields):
            _dict['location_context'] = self.location_context.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "location_context": FixedReferenceWithType.from_dict(obj["location_context"]) if obj.get("location_context") is not None else None
        })
        return _obj
