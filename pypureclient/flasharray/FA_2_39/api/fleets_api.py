...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_39.models.fleet_get_response import FleetGetResponse
from pypureclient.flasharray.FA_2_39.models.fleet_key_get_response import FleetKeyGetResponse
from pypureclient.flasharray.FA_2_39.models.fleet_key_response import FleetKeyResponse
from pypureclient.flasharray.FA_2_39.models.fleet_member_get_response import FleetMemberGetResponse
from pypureclient.flasharray.FA_2_39.models.fleet_member_post import FleetMemberPost
from pypureclient.flasharray.FA_2_39.models.fleet_member_response import FleetMemberResponse
from pypureclient.flasharray.FA_2_39.models.fleet_patch import FleetPatch
from pypureclient.flasharray.FA_2_39.models.fleet_response import FleetResponse
...
class FleetsApi:
    ...
    def api239_fleets_delete_with_http_info(
        ...
        _param = self._api239_fleets_delete_serialize(
    ...
    def _api239_fleets_delete_serialize(
        self,
        authorization,
        x_request_id,
        ids,
    ...
    def api239_fleets_fleet_key_get_with_http_info(
        ...
        _param = self._api239_fleets_fleet_key_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api239_fleets_fleet_key_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.39/fleets/fleet-key',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api239_fleets_fleet_key_post_with_http_info(
        ...
        _param = self._api239_fleets_fleet_key_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
        )
    ...
    def _api239_fleets_fleet_key_post_serialize(
        self,
        authorization,
        x_request_id,
    ) -> RequestSerialized:
    ...
    def api239_fleets_get_with_http_info(
        ...
        _param = self._api239_fleets_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api239_fleets_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api239_fleets_members_delete_with_http_info(
        ...
        _param = self._api239_fleets_members_delete_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api239_fleets_members_delete_serialize(
        self,
        authorization,
        x_request_id,
        member_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.39/fleets/members',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api239_fleets_members_get_with_http_info(
        ...
        _param = self._api239_fleets_members_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api239_fleets_members_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api239_fleets_members_post_with_http_info(
        ...
        _param = self._api239_fleets_members_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            fleet_ids = fleet_ids,
            fleet_names = fleet_names,
    ...
    def _api239_fleets_members_post_serialize(
        self,
        authorization,
        x_request_id,
        fleet_ids,
    ...
    def api239_fleets_patch_with_http_info(
        ...
        _param = self._api239_fleets_patch_serialize(
            fleet = fleet,
            authorization = authorization,
            x_request_id = x_request_id,
            ids = ids,
    ...
    def _api239_fleets_patch_serialize(
        self,
        fleet,
        authorization,
        x_request_id,
    ...
    def api239_fleets_post_with_http_info(
        ...
        _param = self._api239_fleets_post_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api239_fleets_post_serialize(
        self,
        authorization,
        x_request_id,
        names,
