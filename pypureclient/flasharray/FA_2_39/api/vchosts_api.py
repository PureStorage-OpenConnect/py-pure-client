...
from pypureclient.flasharray.FA_2_39.models.vchost_certificate_get_response import VchostCertificateGetResponse
from pypureclient.flasharray.FA_2_39.models.vchost_certificate_patch import VchostCertificatePatch
from pypureclient.flasharray.FA_2_39.models.vchost_certificate_post import VchostCertificatePost
from pypureclient.flasharray.FA_2_39.models.vchost_certificate_response import VchostCertificateResponse
from pypureclient.flasharray.FA_2_39.models.vchost_endpoint_get_response import VchostEndpointGetResponse
from pypureclient.flasharray.FA_2_39.models.vchost_endpoint_patch import VchostEndpointPatch
from pypureclient.flasharray.FA_2_39.models.vchost_endpoint_post import VchostEndpointPost
from pypureclient.flasharray.FA_2_39.models.vchost_endpoint_response import VchostEndpointResponse
from pypureclient.flasharray.FA_2_39.models.vchost_get_response import VchostGetResponse
from pypureclient.flasharray.FA_2_39.models.vchost_patch import VchostPatch
from pypureclient.flasharray.FA_2_39.models.vchost_post import VchostPost
from pypureclient.flasharray.FA_2_39.models.vchost_response import VchostResponse
...
class VchostsApi:
    ...
    def api239_vchosts_certificates_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_vchosts_certificates_delete_with_http_info(authorization, x_request_id, certificate_names, ids, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api239_vchosts_certificates_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_vchosts_certificates_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_vchosts_certificates_get_with_http_info(authorization, x_request_id, certificate_names, continuation_token, filter, ids, limit, offset, sort, total_item_count, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_vchosts_certificates_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_vchosts_certificates_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_vchosts_certificates_patch_with_http_info(certificate, authorization, x_request_id, certificate_names, ids, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_vchosts_certificates_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_vchosts_certificates_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_vchosts_certificates_post_with_http_info(certificate, authorization, x_request_id, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_vchosts_certificates_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_vchosts_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_vchosts_delete_with_http_info(authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_vchosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_vchosts_endpoints_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_vchosts_endpoints_delete_with_http_info(authorization, x_request_id, endpoints, ids, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_vchosts_endpoints_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_vchosts_endpoints_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_vchosts_endpoints_get_with_http_info(authorization, x_request_id, continuation_token, endpoints, filter, ids, limit, offset, sort, total_item_count, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_vchosts_endpoints_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_vchosts_endpoints_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_vchosts_endpoints_patch_with_http_info(endpoint, authorization, x_request_id, endpoints, ids, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_vchosts_endpoints_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_vchosts_endpoints_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_vchosts_endpoints_post_with_http_info(endpoint, authorization, x_request_id, vchost_ids, vchost_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_vchosts_endpoints_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_vchosts_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_vchosts_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_vchosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_vchosts_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_vchosts_patch_with_http_info(vchost, authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_vchosts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_vchosts_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_vchosts_post_with_http_info(vchost, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_vchosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
