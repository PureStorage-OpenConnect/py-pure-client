...
from pypureclient.flasharray.FA_2_39.models.file_post import FilePost
...
class FilesApi:
    ...
    def api239_files_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_files_post_with_http_info(source_file, authorization, x_request_id, directory_ids, directory_names, overwrite, paths, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api239_files_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
