...
from pypureclient.flasharray.FA_2_39.models.remote_arrays_response import RemoteArraysResponse
...
class RemoteArraysApi:
    ...
    def api239_remote_arrays_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_remote_arrays_get_with_http_info(authorization, x_request_id, continuation_token, current_fleet_only, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api239_remote_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
