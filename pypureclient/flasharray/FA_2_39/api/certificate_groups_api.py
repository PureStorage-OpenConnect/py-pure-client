...
from pypureclient.flasharray.FA_2_39.models.certificate_group_certificate_get_response import CertificateGroupCertificateGetResponse
from pypureclient.flasharray.FA_2_39.models.certificate_group_certificate_response import CertificateGroupCertificateResponse
from pypureclient.flasharray.FA_2_39.models.certificate_group_get_response import CertificateGroupGetResponse
from pypureclient.flasharray.FA_2_39.models.certificate_group_response import CertificateGroupResponse
...
class CertificateGroupsApi:
    ...
    def api239_certificate_groups_certificates_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_certificate_groups_certificates_delete_with_http_info(authorization, x_request_id, certificate_group_ids, certificate_group_names, certificate_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api239_certificate_groups_certificates_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_certificate_groups_certificates_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_certificate_groups_certificates_get_with_http_info(authorization, x_request_id, certificate_group_ids, certificate_group_names, certificate_names, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_certificate_groups_certificates_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_certificate_groups_certificates_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_certificate_groups_certificates_post_with_http_info(authorization, x_request_id, certificate_group_ids, certificate_group_names, certificate_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_certificate_groups_certificates_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_certificate_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_certificate_groups_delete_with_http_info(authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_certificate_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_certificate_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_certificate_groups_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_certificate_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_certificate_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_certificate_groups_post_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_certificate_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
