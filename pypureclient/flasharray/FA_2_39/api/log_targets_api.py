...
from pypureclient.flasharray.FA_2_39.models.log_target_file import LogTargetFile
from pypureclient.flasharray.FA_2_39.models.log_target_file_get_response import LogTargetFileGetResponse
from pypureclient.flasharray.FA_2_39.models.log_target_file_response import LogTargetFileResponse
from pypureclient.flasharray.FA_2_39.models.log_targets_get_response import LogTargetsGetResponse
...
class LogTargetsApi:
    ...
    def api239_log_targets_file_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_log_targets_file_delete_with_http_info(authorization, x_request_id, context_names, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api239_log_targets_file_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_log_targets_file_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_log_targets_file_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_log_targets_file_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_log_targets_file_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_log_targets_file_patch_with_http_info(log_target_file, authorization, x_request_id, context_names, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_log_targets_file_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_log_targets_file_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_log_targets_file_post_with_http_info(log_target_file, authorization, x_request_id, context_names, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_log_targets_file_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_log_targets_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_log_targets_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_log_targets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_log_targets_syslog_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_log_targets_syslog_delete_with_http_info(authorization, x_request_id, context_names, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_log_targets_syslog_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_log_targets_syslog_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_log_targets_syslog_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_log_targets_syslog_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_log_targets_syslog_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_log_targets_syslog_patch_with_http_info(syslog_server, authorization, x_request_id, context_names, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_log_targets_syslog_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_log_targets_syslog_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_log_targets_syslog_post_with_http_info(syslog_server, authorization, x_request_id, context_names, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_log_targets_syslog_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_log_targets_syslog_settings_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_log_targets_syslog_settings_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_log_targets_syslog_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_log_targets_syslog_settings_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_log_targets_syslog_settings_patch_with_http_info(syslog_server_settings, authorization, x_request_id, context_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_log_targets_syslog_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_log_targets_syslog_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_log_targets_syslog_test_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_log_targets_syslog_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
