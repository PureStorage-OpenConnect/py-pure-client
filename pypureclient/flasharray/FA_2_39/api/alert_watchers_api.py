...
from pypureclient.flasharray.FA_2_39.models.alert_watcher_get_response import AlertWatcherGetResponse
from pypureclient.flasharray.FA_2_39.models.alert_watcher_patch import AlertWatcherPatch
from pypureclient.flasharray.FA_2_39.models.alert_watcher_post import AlertWatcherPost
from pypureclient.flasharray.FA_2_39.models.alert_watcher_response import AlertWatcherResponse
...
class AlertWatchersApi:
    ...
    def api239_alert_watchers_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_alert_watchers_delete_with_http_info(names, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api239_alert_watchers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_alert_watchers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_alert_watchers_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_alert_watchers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_alert_watchers_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_alert_watchers_patch_with_http_info(names, alert_watcher, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_alert_watchers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_alert_watchers_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_alert_watchers_post_with_http_info(names, authorization, x_request_id, alert_watcher, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_alert_watchers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_alert_watchers_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_alert_watchers_test_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_alert_watchers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
