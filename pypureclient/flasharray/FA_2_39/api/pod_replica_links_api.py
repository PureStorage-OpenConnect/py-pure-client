...
from pypureclient.flasharray.FA_2_39.models.mapping_policy_patch import MappingPolicyPatch
from pypureclient.flasharray.FA_2_39.models.pod_replica_link_get_response import PodReplicaLinkGetResponse
from pypureclient.flasharray.FA_2_39.models.pod_replica_link_lag_get_response import PodReplicaLinkLagGetResponse
from pypureclient.flasharray.FA_2_39.models.pod_replica_link_mapping_policy_get_response import PodReplicaLinkMappingPolicyGetResponse
from pypureclient.flasharray.FA_2_39.models.pod_replica_link_mapping_policy_response import PodReplicaLinkMappingPolicyResponse
from pypureclient.flasharray.FA_2_39.models.pod_replica_link_patch import PodReplicaLinkPatch
from pypureclient.flasharray.FA_2_39.models.pod_replica_link_performance_replication_get_response import PodReplicaLinkPerformanceReplicationGetResponse
from pypureclient.flasharray.FA_2_39.models.pod_replica_link_response import PodReplicaLinkResponse
...
class PodReplicaLinksApi:
    ...
    def api239_pod_replica_links_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_pod_replica_links_delete_with_http_info(authorization, x_request_id, context_names, ids, local_pod_ids, local_pod_names, remote_pod_ids, remote_pod_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api239_pod_replica_links_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_pod_replica_links_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_pod_replica_links_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, ids, limit, local_pod_ids, local_pod_names, offset, remote_ids, remote_names, remote_pod_ids, remote_pod_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_pod_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_pod_replica_links_lag_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_pod_replica_links_mappings_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_pod_replica_links_mappings_policies_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_pod_replica_links_mappings_policies_patch_with_http_info(mapping, authorization, x_request_id, context_names, ids, local_pod_ids, local_pod_names, pod_replica_link_ids, remote_ids, remote_names, remote_pod_ids, remote_pod_names, remote_policy_ids, remote_policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_pod_replica_links_mappings_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_pod_replica_links_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_pod_replica_links_patch_with_http_info(pod_replica_link, authorization, x_request_id, context_names, ids, local_pod_ids, local_pod_names, remote_ids, remote_names, remote_pod_ids, remote_pod_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_pod_replica_links_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_pod_replica_links_performance_replication_get_with_http_info(
        ...
        **kwargs
        ...
        """api239_pod_replica_links_performance_replication_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api239_pod_replica_links_performance_replication_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, end_time, filter, ids, limit, local_pod_ids, local_pod_names, offset, remote_ids, remote_names, remote_pod_ids, remote_pod_names, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_pod_replica_links_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_pod_replica_links_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_pod_replica_links_post_with_http_info(authorization, x_request_id, context_names, local_pod_ids, local_pod_names, remote_ids, remote_names, remote_pod_ids, remote_pod_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_pod_replica_links_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
