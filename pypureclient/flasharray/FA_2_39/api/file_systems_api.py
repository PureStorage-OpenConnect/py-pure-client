...
from pypureclient.flasharray.FA_2_39.models.file_system_get_response import FileSystemGetResponse
from pypureclient.flasharray.FA_2_39.models.file_system_patch import FileSystemPatch
from pypureclient.flasharray.FA_2_39.models.file_system_response import FileSystemResponse
...
class FileSystemsApi:
    ...
    def api239_file_systems_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_file_systems_delete_with_http_info(authorization, x_request_id, context_names, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api239_file_systems_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_file_systems_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_file_systems_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, destroyed, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_file_systems_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_file_systems_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_file_systems_patch_with_http_info(file_system, authorization, x_request_id, context_names, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_file_systems_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_file_systems_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_file_systems_post_with_http_info(names, authorization, x_request_id, context_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_file_systems_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
