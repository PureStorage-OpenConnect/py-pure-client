...
from pypureclient.flasharray.FA_2_39.models.host_group_get_response import HostGroupGetResponse
from pypureclient.flasharray.FA_2_39.models.host_group_patch import HostGroupPatch
from pypureclient.flasharray.FA_2_39.models.host_group_post import HostGroupPost
from pypureclient.flasharray.FA_2_39.models.host_group_response import HostGroupResponse
from pypureclient.flasharray.FA_2_39.models.member_no_id_all_get_response import MemberNoIdAllGetResponse
from pypureclient.flasharray.FA_2_39.models.member_no_id_all_response import MemberNoIdAllResponse
from pypureclient.flasharray.FA_2_39.models.member_no_id_member_get_response import MemberNoIdMemberGetResponse
from pypureclient.flasharray.FA_2_39.models.member_no_id_member_response import MemberNoIdMemberResponse
from pypureclient.flasharray.FA_2_39.models.non_copyable_tag import NonCopyableTag
from pypureclient.flasharray.FA_2_39.models.resource_performance_no_id_by_array_get_response import ResourcePerformanceNoIdByArrayGetResponse
from pypureclient.flasharray.FA_2_39.models.resource_performance_no_id_get_response import ResourcePerformanceNoIdGetResponse
from pypureclient.flasharray.FA_2_39.models.resource_space_no_id_get_response import ResourceSpaceNoIdGetResponse
from pypureclient.flasharray.FA_2_39.models.tag_get_response import TagGetResponse
from pypureclient.flasharray.FA_2_39.models.tag_response import TagResponse
...
class HostGroupsApi:
    ...
    def api239_host_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_host_groups_delete_with_http_info(authorization, x_request_id, context_names, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api239_host_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_host_groups_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, destroyed, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_hosts_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_host_groups_hosts_delete_with_http_info(authorization, x_request_id, context_names, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_hosts_get_with_http_info(
        ...
        **kwargs
        ...
        Displays a list of host groups that are associated with hosts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api239_host_groups_hosts_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, group_names, limit, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_hosts_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_host_groups_hosts_post_with_http_info(authorization, x_request_id, context_names, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_host_groups_patch_with_http_info(host_group, authorization, x_request_id, context_names, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_performance_by_array_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_host_groups_performance_by_array_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, end_time, filter, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_host_groups_performance_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, end_time, filter, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_post_with_http_info(
        ...
        **kwargs
        ...
        """Create a host group and upsert tags.  # noqa: E501

        Creates a host group. The `names` query parameter is required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api239_host_groups_post_with_http_info(authorization, x_request_id, context_names, names, host_group, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_protection_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_host_groups_protection_groups_delete_with_http_info(authorization, x_request_id, context_names, group_ids, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_protection_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_host_groups_protection_groups_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, group_ids, group_names, limit, member_names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_protection_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_host_groups_protection_groups_post_with_http_info(authorization, x_request_id, context_names, group_ids, group_names, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_space_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_host_groups_space_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_tags_batch_put_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api239_host_groups_tags_batch_put_with_http_info(tag, authorization, x_request_id, context_names, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_tags_delete_with_http_info(
        ...
        **kwargs
        ...
        Deletes specified tags on host group objects.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api239_host_groups_tags_delete_with_http_info(authorization, x_request_id, context_names, keys, namespaces, resource_ids, resource_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api239_host_groups_tags_get_with_http_info(
        ...
        **kwargs
        ...
        Displays the list of tags on host group objects.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api239_host_groups_tags_get_with_http_info(authorization, x_request_id, allow_errors, context_names, continuation_token, filter, limit, namespaces, offset, resource_destroyed, resource_ids, resource_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api239_host_groups_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
