...
class ProtectionGroupGetResponse(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            total (list[ProtectionGroup]): The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field where applicable.
        """
