...
class RemoteProtectionGroupSnapshotGetResponse(BaseModel):
    ...
    items: Optional[List[RemoteProtectionGroupSnapshot]] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful.")
