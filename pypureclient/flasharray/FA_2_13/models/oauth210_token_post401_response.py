...
class Oauth210TokenPost401Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Oauth210TokenPost401Response:
        """Create an instance of Oauth210TokenPost401Response from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> Oauth210TokenPost401Response:
        """Create an instance of Oauth210TokenPost401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Oauth210TokenPost401Response.parse_obj(obj)

        _obj = Oauth210TokenPost401Response.construct(_fields_set=None, **{
            "error": obj.get("error"),
