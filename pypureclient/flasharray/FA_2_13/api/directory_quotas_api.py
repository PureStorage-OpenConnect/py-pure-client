...
from pypureclient.flasharray.FA_2_13.models.directory_quotas_get_response import DirectoryQuotasGetResponse
...
class DirectoryQuotasApi:
    ...
    def api213_directory_quotas_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_directory_quotas_get_with_http_info(authorization, x_request_id, continuation_token, directory_ids, directory_names, filter, limit, offset, policy_ids, policy_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api213_directory_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
