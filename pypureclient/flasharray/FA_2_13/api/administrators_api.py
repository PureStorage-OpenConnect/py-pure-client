...
class AdministratorsApi:
    ...
    def api213_admins_cache_put_with_http_info(
        ...
        _param = self._api213_admins_cache_put_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api213_admins_cache_put_serialize(
        self,
        authorization,
        x_request_id,
        names,
    ...
    def api213_admins_delete_with_http_info(
        ...
        _param = self._api213_admins_delete_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api213_admins_delete_serialize(
        self,
        authorization,
        x_request_id,
        names,
    ...
    def api213_admins_post_with_http_info(
        ...
        _param = self._api213_admins_post_serialize(
            admin = admin,
            authorization = authorization,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api213_admins_post_serialize(
        self,
        admin,
        authorization,
        x_request_id,
