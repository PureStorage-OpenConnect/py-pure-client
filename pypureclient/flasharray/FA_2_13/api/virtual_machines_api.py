...
class VirtualMachinesApi:
    ...
    def api213_virtual_machines_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_virtual_machines_patch_with_http_info(virtual_machine, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
    ...
    def api213_virtual_machines_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_virtual_machines_post_with_http_info(virtual_machine, authorization, x_request_id, overwrite, async_req=True)
        >>> result = thread.get()
