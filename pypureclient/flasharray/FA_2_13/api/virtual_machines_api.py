...
class VirtualMachinesApi:
    ...
    def api213_virtual_machines_patch_with_http_info(
        ...
        _param = self._api213_virtual_machines_patch_serialize(
    ...
    def _api213_virtual_machines_patch_serialize(
        self,
        virtual_machine,
        authorization,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/2.13/virtual-machines',
    ...
    def api213_virtual_machines_post_with_http_info(
        ...
        _param = self._api213_virtual_machines_post_serialize(
            virtual_machine = virtual_machine,
            authorization = authorization,
            x_request_id = x_request_id,
            overwrite = overwrite,
    ...
    def _api213_virtual_machines_post_serialize(
        self,
        virtual_machine,
        authorization,
        x_request_id,
