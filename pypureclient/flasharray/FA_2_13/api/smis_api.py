...
class SMISApi:
    ...
    def api213_smi_s_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_smi_s_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api213_smi_s_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_smi_s_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_smi_s_patch_with_http_info(smi_s, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_smi_s_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
