...
from pypureclient.flasharray._common.models.mapping_policy_patch_v_2_51 import MappingPolicyPatch
from pypureclient.flasharray._common.models.pod_replica_link_get_response_v_2_51 import PodReplicaLinkGetResponse
from pypureclient.flasharray._common.models.pod_replica_link_lag_get_response_v_2_51 import PodReplicaLinkLagGetResponse
from pypureclient.flasharray._common.models.pod_replica_link_mapping_policy_get_response_v_2_51 import PodReplicaLinkMappingPolicyGetResponse
from pypureclient.flasharray._common.models.pod_replica_link_mapping_policy_response_v_2_51 import PodReplicaLinkMappingPolicyResponse
from pypureclient.flasharray._common.models.pod_replica_link_patch_v_2_51 import PodReplicaLinkPatch
from pypureclient.flasharray._common.models.pod_replica_link_performance_replication_get_response_v_2_51 import PodReplicaLinkPerformanceReplicationGetResponse
from pypureclient.flasharray._common.models.pod_replica_link_response_v_2_51 import PodReplicaLinkResponse
...
class PodReplicaLinksApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api251_pod_replica_links_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_pod_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_pod_replica_links_lag_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_pod_replica_links_mappings_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_pod_replica_links_mappings_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_pod_replica_links_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def pod_replica_links_performance_replication_get_with_http_info(
        ...
        **kwargs
        ...
        """api251_pod_replica_links_performance_replication_get
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_pod_replica_links_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_pod_replica_links_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
