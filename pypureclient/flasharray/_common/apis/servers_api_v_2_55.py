...
from pypureclient.flasharray._common.models.server_get_response_v_2_55 import ServerGetResponse
from pypureclient.flasharray._common.models.server_patch_v_2_49 import ServerPatch
from pypureclient.flasharray._common.models.server_post_v_2_49 import ServerPost
from pypureclient.flasharray._common.models.server_response_v_2_55 import ServerResponse
...
class ServersApi:
    ...
    def servers_delete_with_http_info(
        ...
        cascade_delete: Annotated[Optional[conlist(StrictStr)], Field(description="The resource types to delete when deleting the object. It will fail if the resources are referenced by other objects. Valid values include `directory-services`.")] = None,
        ...
        **kwargs
        ...
        :param cascade_delete: The resource types to delete when deleting the object. It will fail if the resources are referenced by other objects. Valid values include `directory-services`.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api255_servers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _query_params = []
        if _params.get('cascade_delete') is not None:  # noqa: E501
            _query_params.append(('cascade_delete', _params['cascade_delete']))
            _collection_formats['cascade_delete'] = 'csv'
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/servers', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def servers_get_with_http_info(
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ServerGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ServerGetResponse",
            '207': "ServerGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/servers', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def servers_patch_with_http_info(
        self,
        server: ServerPatch,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ServerResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/servers', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def servers_policies_tls_delete_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        ...
        **kwargs
        ...
        """Delete membership between TLS policies and attached object

        The operation that deletes a `membership` between a `server` and a `TLS policy`. For this request, either `policy_ids` or `policy_names` must be provided, and either `member_ids` or `member_names` must be provided; however, the ID and name parameters for each respective category cannot be set together.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_servers_policies_tls_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/servers/policies/tls', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def servers_policies_tls_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        """List TLS policies attached to servers

        The operation that displays a list of `TLS policies` that are attached to `servers`.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_servers_policies_tls_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/servers/policies/tls', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def servers_policies_tls_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        """Create a membership between a server and a TLS policy

        The operation that creates a `membership` between a `server` and a `TLS policy`. For this request, either the `member_ids` or `member_names` parameter is required, but they cannot be set together.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_servers_policies_tls_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/servers/policies/tls', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def servers_post_with_http_info(
        ...
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        create_local_directory_service: Annotated[Optional[StrictStr], Field(description="The name of the local directory service object to be created and associated to the server. This parameter cannot be used together with `local_directory_service` property in the request entity.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique name specified. Enter multiple names in comma-separated format. The name is expected to be fully qualified, meaning if the object is contained in some context, the corresponding name would provide complete information about the containment hierarchy. For example, `name01,pod01::name01`.")] = None,
        server: Optional[ServerPost] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        """Create server
        ...
        :param context_names: Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.
        :type context_names: List[str]
        :param create_local_directory_service: The name of the local directory service object to be created and associated to the server. This parameter cannot be used together with `local_directory_service` property in the request entity.
        :type create_local_directory_service: str
        :param names: Performs the operation on the unique name specified. Enter multiple names in comma-separated format. The name is expected to be fully qualified, meaning if the object is contained in some context, the corresponding name would provide complete information about the containment hierarchy. For example, `name01,pod01::name01`.
        :type names: List[str]
        :param server:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_servers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('create_local_directory_service') is not None:  # noqa: E501
            _query_params.append(('create_local_directory_service', _params['create_local_directory_service']))
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/servers', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api255_servers_delete_with_http_info = servers_delete_with_http_info
    api255_servers_get_with_http_info = servers_get_with_http_info
    api255_servers_patch_with_http_info = servers_patch_with_http_info
    api255_servers_policies_tls_delete_with_http_info = servers_policies_tls_delete_with_http_info
    api255_servers_policies_tls_get_with_http_info = servers_policies_tls_get_with_http_info
    api255_servers_policies_tls_post_with_http_info = servers_policies_tls_post_with_http_info
    api255_servers_post_with_http_info = servers_post_with_http_info
    api256_servers_delete_with_http_info = servers_delete_with_http_info
    api256_servers_get_with_http_info = servers_get_with_http_info
    api256_servers_patch_with_http_info = servers_patch_with_http_info
    api256_servers_policies_tls_delete_with_http_info = servers_policies_tls_delete_with_http_info
