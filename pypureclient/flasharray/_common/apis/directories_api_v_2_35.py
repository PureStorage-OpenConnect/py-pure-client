...
from pypureclient.flasharray._common.models.directory_get_response_v_2_34 import DirectoryGetResponse
from pypureclient.flasharray._common.models.directory_lock_nlm_reclamation_response_v_2_21 import DirectoryLockNlmReclamationResponse
...
from pypureclient.flasharray._common.models.directory_policy_export_post_v_2_32 import DirectoryPolicyExportPost
...
from pypureclient.flasharray._common.models.directory_response_v_2_34 import DirectoryResponse
from pypureclient.flasharray._common.models.policy_member_export_get_response_v_2_32 import PolicyMemberExportGetResponse
from pypureclient.flasharray._common.models.policy_member_export_response_v_2_32 import PolicyMemberExportResponse
...
from pypureclient.flasharray._common.models.resource_directory_space_get_response_v_2_34 import ResourceDirectorySpaceGetResponse
...
class DirectoriesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api235_directories_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_locks_nlm_reclamations_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_audit_file_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_audit_file_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_audit_file_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_autodir_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_autodir_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_autodir_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_nfs_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_nfs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_nfs_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_quota_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_quota_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_quota_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_smb_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_smb_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_smb_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_snapshot_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_snapshot_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_policies_snapshot_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api235_directories_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api235_directories_delete_with_http_info = directories_delete_with_http_info
    api235_directories_get_with_http_info = directories_get_with_http_info
    api235_directories_locks_nlm_reclamations_post_with_http_info = directories_locks_nlm_reclamations_post_with_http_info
    api235_directories_patch_with_http_info = directories_patch_with_http_info
    api235_directories_performance_get_with_http_info = directories_performance_get_with_http_info
    api235_directories_policies_audit_file_delete_with_http_info = directories_policies_audit_file_delete_with_http_info
    api235_directories_policies_audit_file_get_with_http_info = directories_policies_audit_file_get_with_http_info
    api235_directories_policies_audit_file_post_with_http_info = directories_policies_audit_file_post_with_http_info
    api235_directories_policies_autodir_delete_with_http_info = directories_policies_autodir_delete_with_http_info
    api235_directories_policies_autodir_get_with_http_info = directories_policies_autodir_get_with_http_info
    api235_directories_policies_autodir_post_with_http_info = directories_policies_autodir_post_with_http_info
    api235_directories_policies_get_with_http_info = directories_policies_get_with_http_info
    api235_directories_policies_nfs_delete_with_http_info = directories_policies_nfs_delete_with_http_info
    api235_directories_policies_nfs_get_with_http_info = directories_policies_nfs_get_with_http_info
    api235_directories_policies_nfs_post_with_http_info = directories_policies_nfs_post_with_http_info
    api235_directories_policies_quota_delete_with_http_info = directories_policies_quota_delete_with_http_info
    api235_directories_policies_quota_get_with_http_info = directories_policies_quota_get_with_http_info
    api235_directories_policies_quota_post_with_http_info = directories_policies_quota_post_with_http_info
    api235_directories_policies_smb_delete_with_http_info = directories_policies_smb_delete_with_http_info
    api235_directories_policies_smb_get_with_http_info = directories_policies_smb_get_with_http_info
    api235_directories_policies_smb_post_with_http_info = directories_policies_smb_post_with_http_info
    api235_directories_policies_snapshot_delete_with_http_info = directories_policies_snapshot_delete_with_http_info
    api235_directories_policies_snapshot_get_with_http_info = directories_policies_snapshot_get_with_http_info
    api235_directories_policies_snapshot_post_with_http_info = directories_policies_snapshot_post_with_http_info
    api235_directories_post_with_http_info = directories_post_with_http_info
    api235_directories_space_get_with_http_info = directories_space_get_with_http_info
    api236_directories_delete_with_http_info = directories_delete_with_http_info
    api236_directories_get_with_http_info = directories_get_with_http_info
    api236_directories_locks_nlm_reclamations_post_with_http_info = directories_locks_nlm_reclamations_post_with_http_info
    api236_directories_patch_with_http_info = directories_patch_with_http_info
    api236_directories_performance_get_with_http_info = directories_performance_get_with_http_info
    api236_directories_policies_audit_file_delete_with_http_info = directories_policies_audit_file_delete_with_http_info
    api236_directories_policies_audit_file_get_with_http_info = directories_policies_audit_file_get_with_http_info
    api236_directories_policies_audit_file_post_with_http_info = directories_policies_audit_file_post_with_http_info
    api236_directories_policies_autodir_delete_with_http_info = directories_policies_autodir_delete_with_http_info
    api236_directories_policies_autodir_get_with_http_info = directories_policies_autodir_get_with_http_info
    api236_directories_policies_autodir_post_with_http_info = directories_policies_autodir_post_with_http_info
    api236_directories_policies_get_with_http_info = directories_policies_get_with_http_info
    api236_directories_policies_nfs_delete_with_http_info = directories_policies_nfs_delete_with_http_info
    api236_directories_policies_nfs_get_with_http_info = directories_policies_nfs_get_with_http_info
    api236_directories_policies_nfs_post_with_http_info = directories_policies_nfs_post_with_http_info
    api236_directories_policies_quota_delete_with_http_info = directories_policies_quota_delete_with_http_info
    api236_directories_policies_quota_get_with_http_info = directories_policies_quota_get_with_http_info
    api236_directories_policies_quota_post_with_http_info = directories_policies_quota_post_with_http_info
    api236_directories_policies_smb_delete_with_http_info = directories_policies_smb_delete_with_http_info
    api236_directories_policies_smb_get_with_http_info = directories_policies_smb_get_with_http_info
    api236_directories_policies_smb_post_with_http_info = directories_policies_smb_post_with_http_info
    api236_directories_policies_snapshot_delete_with_http_info = directories_policies_snapshot_delete_with_http_info
    api236_directories_policies_snapshot_get_with_http_info = directories_policies_snapshot_get_with_http_info
    api236_directories_policies_snapshot_post_with_http_info = directories_policies_snapshot_post_with_http_info
    api236_directories_post_with_http_info = directories_post_with_http_info
    api236_directories_space_get_with_http_info = directories_space_get_with_http_info
    api237_directories_delete_with_http_info = directories_delete_with_http_info
    api237_directories_get_with_http_info = directories_get_with_http_info
    api237_directories_locks_nlm_reclamations_post_with_http_info = directories_locks_nlm_reclamations_post_with_http_info
    api237_directories_patch_with_http_info = directories_patch_with_http_info
    api237_directories_performance_get_with_http_info = directories_performance_get_with_http_info
    api237_directories_policies_audit_file_delete_with_http_info = directories_policies_audit_file_delete_with_http_info
    api237_directories_policies_audit_file_get_with_http_info = directories_policies_audit_file_get_with_http_info
    api237_directories_policies_audit_file_post_with_http_info = directories_policies_audit_file_post_with_http_info
    api237_directories_policies_autodir_delete_with_http_info = directories_policies_autodir_delete_with_http_info
    api237_directories_policies_autodir_get_with_http_info = directories_policies_autodir_get_with_http_info
    api237_directories_policies_autodir_post_with_http_info = directories_policies_autodir_post_with_http_info
    api237_directories_policies_get_with_http_info = directories_policies_get_with_http_info
    api237_directories_policies_nfs_delete_with_http_info = directories_policies_nfs_delete_with_http_info
    api237_directories_policies_nfs_get_with_http_info = directories_policies_nfs_get_with_http_info
    api237_directories_policies_nfs_post_with_http_info = directories_policies_nfs_post_with_http_info
    api237_directories_policies_quota_delete_with_http_info = directories_policies_quota_delete_with_http_info
    api237_directories_policies_quota_get_with_http_info = directories_policies_quota_get_with_http_info
    api237_directories_policies_quota_post_with_http_info = directories_policies_quota_post_with_http_info
    api237_directories_policies_smb_delete_with_http_info = directories_policies_smb_delete_with_http_info
    api237_directories_policies_smb_get_with_http_info = directories_policies_smb_get_with_http_info
    api237_directories_policies_smb_post_with_http_info = directories_policies_smb_post_with_http_info
    api237_directories_policies_snapshot_delete_with_http_info = directories_policies_snapshot_delete_with_http_info
    api237_directories_policies_snapshot_get_with_http_info = directories_policies_snapshot_get_with_http_info
    api237_directories_policies_snapshot_post_with_http_info = directories_policies_snapshot_post_with_http_info
    api237_directories_post_with_http_info = directories_post_with_http_info
    api237_directories_space_get_with_http_info = directories_space_get_with_http_info
