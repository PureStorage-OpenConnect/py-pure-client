...
class RealmsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api236_realms_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_realms_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_realms_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_realms_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_realms_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_realms_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api236_realms_delete_with_http_info = realms_delete_with_http_info
    api236_realms_get_with_http_info = realms_get_with_http_info
    api236_realms_patch_with_http_info = realms_patch_with_http_info
    api236_realms_performance_get_with_http_info = realms_performance_get_with_http_info
    api236_realms_post_with_http_info = realms_post_with_http_info
    api236_realms_space_get_with_http_info = realms_space_get_with_http_info
    api237_realms_delete_with_http_info = realms_delete_with_http_info
    api237_realms_get_with_http_info = realms_get_with_http_info
    api237_realms_patch_with_http_info = realms_patch_with_http_info
    api237_realms_performance_get_with_http_info = realms_performance_get_with_http_info
    api237_realms_post_with_http_info = realms_post_with_http_info
    api237_realms_space_get_with_http_info = realms_space_get_with_http_info
