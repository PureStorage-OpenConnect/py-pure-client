...
class SMISApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api236_smi_s_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_smi_s_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api255_smi_s_get_with_http_info = smi_s_get_with_http_info
    api255_smi_s_patch_with_http_info = smi_s_patch_with_http_info
    api256_smi_s_get_with_http_info = smi_s_get_with_http_info
