...
from pypureclient.flasharray._common.models.protection_group_snapshot_get_response_v_2_38 import ProtectionGroupSnapshotGetResponse
from pypureclient.flasharray._common.models.protection_group_snapshot_patch_v_2_38 import ProtectionGroupSnapshotPatch
from pypureclient.flasharray._common.models.protection_group_snapshot_post_v_2_44 import ProtectionGroupSnapshotPost
from pypureclient.flasharray._common.models.protection_group_snapshot_replica_response_v_2_38 import ProtectionGroupSnapshotReplicaResponse
from pypureclient.flasharray._common.models.protection_group_snapshot_response_v_2_38 import ProtectionGroupSnapshotResponse
from pypureclient.flasharray._common.models.protection_group_snapshot_transfer_get_response_v_2_38 import ProtectionGroupSnapshotTransferGetResponse
...
class ProtectionGroupSnapshotsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api244_protection_group_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api244_protection_group_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api244_protection_group_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api244_protection_group_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api244_protection_group_snapshots_replica_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api244_protection_group_snapshots_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api244_protection_group_snapshots_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api244_protection_group_snapshots_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api244_protection_group_snapshots_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api244_protection_group_snapshots_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api244_protection_group_snapshots_delete_with_http_info = protection_group_snapshots_delete_with_http_info
    api244_protection_group_snapshots_get_with_http_info = protection_group_snapshots_get_with_http_info
    api244_protection_group_snapshots_patch_with_http_info = protection_group_snapshots_patch_with_http_info
    api244_protection_group_snapshots_post_with_http_info = protection_group_snapshots_post_with_http_info
    api244_protection_group_snapshots_replica_post_with_http_info = protection_group_snapshots_replica_post_with_http_info
    api244_protection_group_snapshots_tags_batch_put_with_http_info = protection_group_snapshots_tags_batch_put_with_http_info
    api244_protection_group_snapshots_tags_delete_with_http_info = protection_group_snapshots_tags_delete_with_http_info
    api244_protection_group_snapshots_tags_get_with_http_info = protection_group_snapshots_tags_get_with_http_info
    api244_protection_group_snapshots_test_post_with_http_info = protection_group_snapshots_test_post_with_http_info
    api244_protection_group_snapshots_transfer_get_with_http_info = protection_group_snapshots_transfer_get_with_http_info
    api245_protection_group_snapshots_delete_with_http_info = protection_group_snapshots_delete_with_http_info
    api245_protection_group_snapshots_get_with_http_info = protection_group_snapshots_get_with_http_info
    api245_protection_group_snapshots_patch_with_http_info = protection_group_snapshots_patch_with_http_info
    api245_protection_group_snapshots_post_with_http_info = protection_group_snapshots_post_with_http_info
    api245_protection_group_snapshots_replica_post_with_http_info = protection_group_snapshots_replica_post_with_http_info
    api245_protection_group_snapshots_tags_batch_put_with_http_info = protection_group_snapshots_tags_batch_put_with_http_info
    api245_protection_group_snapshots_tags_delete_with_http_info = protection_group_snapshots_tags_delete_with_http_info
    api245_protection_group_snapshots_tags_get_with_http_info = protection_group_snapshots_tags_get_with_http_info
    api245_protection_group_snapshots_test_post_with_http_info = protection_group_snapshots_test_post_with_http_info
    api245_protection_group_snapshots_transfer_get_with_http_info = protection_group_snapshots_transfer_get_with_http_info
    api246_protection_group_snapshots_delete_with_http_info = protection_group_snapshots_delete_with_http_info
    api246_protection_group_snapshots_get_with_http_info = protection_group_snapshots_get_with_http_info
    api246_protection_group_snapshots_patch_with_http_info = protection_group_snapshots_patch_with_http_info
    api246_protection_group_snapshots_post_with_http_info = protection_group_snapshots_post_with_http_info
    api246_protection_group_snapshots_replica_post_with_http_info = protection_group_snapshots_replica_post_with_http_info
    api246_protection_group_snapshots_tags_batch_put_with_http_info = protection_group_snapshots_tags_batch_put_with_http_info
    api246_protection_group_snapshots_tags_delete_with_http_info = protection_group_snapshots_tags_delete_with_http_info
    api246_protection_group_snapshots_tags_get_with_http_info = protection_group_snapshots_tags_get_with_http_info
    api246_protection_group_snapshots_test_post_with_http_info = protection_group_snapshots_test_post_with_http_info
    api246_protection_group_snapshots_transfer_get_with_http_info = protection_group_snapshots_transfer_get_with_http_info
    api247_protection_group_snapshots_delete_with_http_info = protection_group_snapshots_delete_with_http_info
    api247_protection_group_snapshots_get_with_http_info = protection_group_snapshots_get_with_http_info
    api247_protection_group_snapshots_patch_with_http_info = protection_group_snapshots_patch_with_http_info
    api247_protection_group_snapshots_post_with_http_info = protection_group_snapshots_post_with_http_info
    api247_protection_group_snapshots_replica_post_with_http_info = protection_group_snapshots_replica_post_with_http_info
    api247_protection_group_snapshots_tags_batch_put_with_http_info = protection_group_snapshots_tags_batch_put_with_http_info
    api247_protection_group_snapshots_tags_delete_with_http_info = protection_group_snapshots_tags_delete_with_http_info
    api247_protection_group_snapshots_tags_get_with_http_info = protection_group_snapshots_tags_get_with_http_info
    api247_protection_group_snapshots_test_post_with_http_info = protection_group_snapshots_test_post_with_http_info
    api247_protection_group_snapshots_transfer_get_with_http_info = protection_group_snapshots_transfer_get_with_http_info
    api248_protection_group_snapshots_delete_with_http_info = protection_group_snapshots_delete_with_http_info
    api248_protection_group_snapshots_get_with_http_info = protection_group_snapshots_get_with_http_info
    api248_protection_group_snapshots_patch_with_http_info = protection_group_snapshots_patch_with_http_info
    api248_protection_group_snapshots_post_with_http_info = protection_group_snapshots_post_with_http_info
    api248_protection_group_snapshots_replica_post_with_http_info = protection_group_snapshots_replica_post_with_http_info
    api248_protection_group_snapshots_tags_batch_put_with_http_info = protection_group_snapshots_tags_batch_put_with_http_info
    api248_protection_group_snapshots_tags_delete_with_http_info = protection_group_snapshots_tags_delete_with_http_info
    api248_protection_group_snapshots_tags_get_with_http_info = protection_group_snapshots_tags_get_with_http_info
    api248_protection_group_snapshots_test_post_with_http_info = protection_group_snapshots_test_post_with_http_info
    api248_protection_group_snapshots_transfer_get_with_http_info = protection_group_snapshots_transfer_get_with_http_info
