...
from pypureclient.flasharray._common.models.alert_event_get_response_v_2_51 import AlertEventGetResponse
from pypureclient.flasharray._common.models.alert_get_response_v_2_51 import AlertGetResponse
from pypureclient.flasharray._common.models.alert_response_v_2_51 import AlertResponse
from pypureclient.flasharray._common.models.alert_rules_catalog_get_response_v_2_51 import AlertRulesCatalogGetResponse
from pypureclient.flasharray._common.models.alert_rules_get_response_v_2_51 import AlertRulesGetResponse
from pypureclient.flasharray._common.models.alert_rules_response_v_2_51 import AlertRulesResponse
from pypureclient.flasharray._common.models.alert_rules_v_2_51 import AlertRules
from pypureclient.flasharray._common.models.alert_v_2_51 import Alert
...
class AlertsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api251_alerts_events_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_alerts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_alerts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_alerts_rules_catalog_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "AlertRulesCatalogGetResponse",
        }
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_alerts_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_alerts_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_alerts_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_alerts_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api251_alerts_events_get_with_http_info = alerts_events_get_with_http_info
    api251_alerts_get_with_http_info = alerts_get_with_http_info
    api251_alerts_patch_with_http_info = alerts_patch_with_http_info
    api251_alerts_rules_catalog_get_with_http_info = alerts_rules_catalog_get_with_http_info
    api251_alerts_rules_delete_with_http_info = alerts_rules_delete_with_http_info
