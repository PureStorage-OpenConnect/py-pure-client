...
from pypureclient.flasharray._common.models.realm_get_response_v_2_36 import RealmGetResponse
from pypureclient.flasharray._common.models.realm_patch_v_2_36 import RealmPatch
from pypureclient.flasharray._common.models.realm_post_v_2_36 import RealmPost
from pypureclient.flasharray._common.models.realm_response_v_2_36 import RealmResponse
from pypureclient.flasharray._common.models.realm_space_get_response_v_2_36 import RealmSpaceGetResponse
...
class RealmsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api238_realms_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_realms_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_realms_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_realms_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_realms_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_realms_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api238_realms_delete_with_http_info = realms_delete_with_http_info
    api238_realms_get_with_http_info = realms_get_with_http_info
    api238_realms_patch_with_http_info = realms_patch_with_http_info
    api238_realms_performance_get_with_http_info = realms_performance_get_with_http_info
    api238_realms_post_with_http_info = realms_post_with_http_info
    api238_realms_space_get_with_http_info = realms_space_get_with_http_info
    api239_realms_delete_with_http_info = realms_delete_with_http_info
    api239_realms_get_with_http_info = realms_get_with_http_info
    api239_realms_patch_with_http_info = realms_patch_with_http_info
    api239_realms_performance_get_with_http_info = realms_performance_get_with_http_info
    api239_realms_post_with_http_info = realms_post_with_http_info
    api239_realms_space_get_with_http_info = realms_space_get_with_http_info
    api240_realms_delete_with_http_info = realms_delete_with_http_info
    api240_realms_get_with_http_info = realms_get_with_http_info
    api240_realms_patch_with_http_info = realms_patch_with_http_info
    api240_realms_performance_get_with_http_info = realms_performance_get_with_http_info
    api240_realms_post_with_http_info = realms_post_with_http_info
    api240_realms_space_get_with_http_info = realms_space_get_with_http_info
