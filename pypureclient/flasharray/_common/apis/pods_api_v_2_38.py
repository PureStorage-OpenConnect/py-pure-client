...
class PodsApi:
    ...
    # Method Aliases
    api238_pods_arrays_delete_with_http_info = pods_arrays_delete_with_http_info
    api238_pods_arrays_get_with_http_info = pods_arrays_get_with_http_info
    api238_pods_arrays_post_with_http_info = pods_arrays_post_with_http_info
    api238_pods_delete_with_http_info = pods_delete_with_http_info
    api238_pods_get_with_http_info = pods_get_with_http_info
    api238_pods_members_delete_with_http_info = pods_members_delete_with_http_info
    api238_pods_members_get_with_http_info = pods_members_get_with_http_info
    api238_pods_members_post_with_http_info = pods_members_post_with_http_info
    api238_pods_patch_with_http_info = pods_patch_with_http_info
    api238_pods_performance_by_array_get_with_http_info = pods_performance_by_array_get_with_http_info
    api238_pods_performance_get_with_http_info = pods_performance_get_with_http_info
    api238_pods_performance_replication_by_array_get_with_http_info = pods_performance_replication_by_array_get_with_http_info
    api238_pods_performance_replication_get_with_http_info = pods_performance_replication_get_with_http_info
    api238_pods_post_with_http_info = pods_post_with_http_info
    api238_pods_space_get_with_http_info = pods_space_get_with_http_info
    api238_pods_test_post_with_http_info = pods_test_post_with_http_info
