...
from pypureclient.flasharray._common.models.directory_quotas_get_response_v_2_49 import DirectoryQuotasGetResponse
...
class DirectoryQuotasApi:
    ...
    def directory_quotas_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api249_directory_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/directory-quotas', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    api253_directory_quotas_get_with_http_info = directory_quotas_get_with_http_info
