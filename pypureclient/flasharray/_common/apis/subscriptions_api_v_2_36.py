...
from pypureclient.flasharray._common.models.subscription_get_response_v_2_26 import SubscriptionGetResponse
...
class SubscriptionsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api236_subscriptions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api253_subscriptions_get_with_http_info = subscriptions_get_with_http_info
    api254_subscriptions_get_with_http_info = subscriptions_get_with_http_info
