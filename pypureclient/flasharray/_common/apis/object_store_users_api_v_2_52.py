...
from pypureclient.flasharray._common.models.object_store_user_get_response_v_2_52 import ObjectStoreUserGetResponse
from pypureclient.flasharray._common.models.object_store_user_response_v_2_52 import ObjectStoreUserResponse
from pypureclient.flasharray._common.models.policy_member_object_store_access_get_response_v_2_52 import PolicyMemberObjectStoreAccessGetResponse
from pypureclient.flasharray._common.models.policy_member_object_store_access_response_v_2_52 import PolicyMemberObjectStoreAccessResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_object_store_users_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_object_store_users_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_object_store_users_policies_object_store_access_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_object_store_users_policies_object_store_access_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_object_store_users_policies_object_store_access_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_object_store_users_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
