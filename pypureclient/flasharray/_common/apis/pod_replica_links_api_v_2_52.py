...
from pypureclient.flasharray._common.models.mapping_policy_patch_v_2_32 import MappingPolicyPatch
from pypureclient.flasharray._common.models.pod_replica_link_get_response_v_2_52 import PodReplicaLinkGetResponse
from pypureclient.flasharray._common.models.pod_replica_link_lag_get_response_v_2_52 import PodReplicaLinkLagGetResponse
from pypureclient.flasharray._common.models.pod_replica_link_mapping_policy_get_response_v_2_52 import PodReplicaLinkMappingPolicyGetResponse
from pypureclient.flasharray._common.models.pod_replica_link_mapping_policy_response_v_2_52 import PodReplicaLinkMappingPolicyResponse
from pypureclient.flasharray._common.models.pod_replica_link_patch_v_2_2 import PodReplicaLinkPatch
from pypureclient.flasharray._common.models.pod_replica_link_performance_replication_array_get_response_v_2_52 import PodReplicaLinkPerformanceReplicationArrayGetResponse
from pypureclient.flasharray._common.models.pod_replica_link_performance_replication_get_response_v_2_52 import PodReplicaLinkPerformanceReplicationGetResponse
from pypureclient.flasharray._common.models.pod_replica_link_response_v_2_52 import PodReplicaLinkResponse
...
class PodReplicaLinksApi:
    ...
    def pod_replica_links_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_pod_replica_links_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/pod-replica-links', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def pod_replica_links_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        remote_ids: Annotated[Optional[conlist(StrictStr)], Field(description="The comma-separated list of remote array or realm IDs. If, after filtering, there is not at least one resource that matches each of the elements, an error is returned. The remote_ids and remote_names parameters cannot be set together.")] = None,
        remote_names: Annotated[Optional[conlist(StrictStr)], Field(description="The comma-separated list of remote array or realm names. If, after filtering, there is not at least one resource that matches each of the elements, an error is returned. The remote_names and remote_ids parameters cannot be set together.")] = None,
        remote_pod_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of remote pod IDs. If, after filtering, there is not at least one resource that matches each of the elements, then an error is returned. This cannot be provided together with the `remote_pod_names` query parameter.")] = None,
        remote_pod_names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of remote pod names. If, after filtering, there is not at least one resource that matches each of the elements, then an error is returned. This cannot be provided together with the `remote_pod_ids` query parameter.")] = None,
        ...
        **kwargs
        ...
        :type offset: int
        :param remote_ids: The comma-separated list of remote array or realm IDs. If, after filtering, there is not at least one resource that matches each of the elements, an error is returned. The remote_ids and remote_names parameters cannot be set together.
        :type remote_ids: List[str]
        :param remote_names: The comma-separated list of remote array or realm names. If, after filtering, there is not at least one resource that matches each of the elements, an error is returned. The remote_names and remote_ids parameters cannot be set together.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_pod_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "PodReplicaLinkGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/pod-replica-links', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def pod_replica_links_lag_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_pod_replica_links_lag_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "PodReplicaLinkLagGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/pod-replica-links/lag', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def pod_replica_links_mappings_policies_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_pod_replica_links_mappings_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "PodReplicaLinkMappingPolicyGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/pod-replica-links/mappings/policies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def pod_replica_links_mappings_policies_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_pod_replica_links_mappings_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/pod-replica-links/mappings/policies', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def pod_replica_links_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_pod_replica_links_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/pod-replica-links', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def pod_replica_links_performance_replication_by_array_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        """List replica link performance data with array details

        The monitoring interface that provides the total number of `bytes` of `replication` data transmitted and received `per second`. This data is organized by `array` and further categorized by the specific `replica link`, `source array`, and `target array` to provide granular visibility into network throughput.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PodReplicaLinkPerformanceReplicationArrayGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_pod_replica_links_performance_replication_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "PodReplicaLinkPerformanceReplicationArrayGetResponse",
            '207': "PodReplicaLinkPerformanceReplicationArrayGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/pod-replica-links/performance/replication/by-array', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def pod_replica_links_performance_replication_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        """List replica link performance data

        The monitoring interface or metric that provides the total number of `bytes` of `replication` data transmitted and received `per second`.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_pod_replica_links_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "PodReplicaLinkPerformanceReplicationGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/pod-replica-links/performance/replication', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def pod_replica_links_post_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_pod_replica_links_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/pod-replica-links', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api252_pod_replica_links_delete_with_http_info = pod_replica_links_delete_with_http_info
    api252_pod_replica_links_get_with_http_info = pod_replica_links_get_with_http_info
    api252_pod_replica_links_lag_get_with_http_info = pod_replica_links_lag_get_with_http_info
    api252_pod_replica_links_mappings_policies_get_with_http_info = pod_replica_links_mappings_policies_get_with_http_info
    api252_pod_replica_links_mappings_policies_patch_with_http_info = pod_replica_links_mappings_policies_patch_with_http_info
    api252_pod_replica_links_patch_with_http_info = pod_replica_links_patch_with_http_info
    api252_pod_replica_links_performance_replication_by_array_get_with_http_info = pod_replica_links_performance_replication_by_array_get_with_http_info
    api252_pod_replica_links_performance_replication_get_with_http_info = pod_replica_links_performance_replication_get_with_http_info
    api252_pod_replica_links_post_with_http_info = pod_replica_links_post_with_http_info
    api253_pod_replica_links_delete_with_http_info = pod_replica_links_delete_with_http_info
    api253_pod_replica_links_get_with_http_info = pod_replica_links_get_with_http_info
    api253_pod_replica_links_lag_get_with_http_info = pod_replica_links_lag_get_with_http_info
    api253_pod_replica_links_mappings_policies_get_with_http_info = pod_replica_links_mappings_policies_get_with_http_info
    api253_pod_replica_links_mappings_policies_patch_with_http_info = pod_replica_links_mappings_policies_patch_with_http_info
    api253_pod_replica_links_patch_with_http_info = pod_replica_links_patch_with_http_info
    api253_pod_replica_links_performance_replication_by_array_get_with_http_info = pod_replica_links_performance_replication_by_array_get_with_http_info
    api253_pod_replica_links_performance_replication_get_with_http_info = pod_replica_links_performance_replication_get_with_http_info
    api253_pod_replica_links_post_with_http_info = pod_replica_links_post_with_http_info
    api254_pod_replica_links_delete_with_http_info = pod_replica_links_delete_with_http_info
    api254_pod_replica_links_get_with_http_info = pod_replica_links_get_with_http_info
    api254_pod_replica_links_lag_get_with_http_info = pod_replica_links_lag_get_with_http_info
    api254_pod_replica_links_mappings_policies_get_with_http_info = pod_replica_links_mappings_policies_get_with_http_info
    api254_pod_replica_links_mappings_policies_patch_with_http_info = pod_replica_links_mappings_policies_patch_with_http_info
    api254_pod_replica_links_patch_with_http_info = pod_replica_links_patch_with_http_info
    api254_pod_replica_links_performance_replication_by_array_get_with_http_info = pod_replica_links_performance_replication_by_array_get_with_http_info
    api254_pod_replica_links_performance_replication_get_with_http_info = pod_replica_links_performance_replication_get_with_http_info
    api254_pod_replica_links_post_with_http_info = pod_replica_links_post_with_http_info
    api255_pod_replica_links_delete_with_http_info = pod_replica_links_delete_with_http_info
    api255_pod_replica_links_get_with_http_info = pod_replica_links_get_with_http_info
    api255_pod_replica_links_lag_get_with_http_info = pod_replica_links_lag_get_with_http_info
    api255_pod_replica_links_mappings_policies_get_with_http_info = pod_replica_links_mappings_policies_get_with_http_info
    api255_pod_replica_links_mappings_policies_patch_with_http_info = pod_replica_links_mappings_policies_patch_with_http_info
    api255_pod_replica_links_patch_with_http_info = pod_replica_links_patch_with_http_info
    api255_pod_replica_links_performance_replication_by_array_get_with_http_info = pod_replica_links_performance_replication_by_array_get_with_http_info
    api255_pod_replica_links_performance_replication_get_with_http_info = pod_replica_links_performance_replication_get_with_http_info
    api255_pod_replica_links_post_with_http_info = pod_replica_links_post_with_http_info
    api256_pod_replica_links_delete_with_http_info = pod_replica_links_delete_with_http_info
    api256_pod_replica_links_get_with_http_info = pod_replica_links_get_with_http_info
    api256_pod_replica_links_lag_get_with_http_info = pod_replica_links_lag_get_with_http_info
    api256_pod_replica_links_mappings_policies_get_with_http_info = pod_replica_links_mappings_policies_get_with_http_info
    api256_pod_replica_links_mappings_policies_patch_with_http_info = pod_replica_links_mappings_policies_patch_with_http_info
    api256_pod_replica_links_patch_with_http_info = pod_replica_links_patch_with_http_info
    api256_pod_replica_links_performance_replication_by_array_get_with_http_info = pod_replica_links_performance_replication_by_array_get_with_http_info
    api256_pod_replica_links_performance_replication_get_with_http_info = pod_replica_links_performance_replication_get_with_http_info
    api256_pod_replica_links_post_with_http_info = pod_replica_links_post_with_http_info
