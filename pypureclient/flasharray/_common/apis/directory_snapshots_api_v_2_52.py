...
from pypureclient.flasharray._common.models.directory_snapshot_get_response_v_2_52 import DirectorySnapshotGetResponse
from pypureclient.flasharray._common.models.directory_snapshot_patch_v_2_52 import DirectorySnapshotPatch
from pypureclient.flasharray._common.models.directory_snapshot_post_v_2_52 import DirectorySnapshotPost
from pypureclient.flasharray._common.models.directory_snapshot_response_v_2_52 import DirectorySnapshotResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_directory_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_directory_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "DirectorySnapshotGetResponse",
        }
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_directory_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_directory_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
