...
from pypureclient.flasharray._common.models.directory_service_get_response_v_2_32 import DirectoryServiceGetResponse
from pypureclient.flasharray._common.models.directory_service_response_v_2_32 import DirectoryServiceResponse
from pypureclient.flasharray._common.models.directory_service_role_get_response_v_2_36 import DirectoryServiceRoleGetResponse
from pypureclient.flasharray._common.models.directory_service_role_post_v_2_36 import DirectoryServiceRolePost
from pypureclient.flasharray._common.models.directory_service_role_response_v_2_36 import DirectoryServiceRoleResponse
from pypureclient.flasharray._common.models.directory_service_role_v_2_36 import DirectoryServiceRole
from pypureclient.flasharray._common.models.directory_service_v_2_32 import DirectoryService
...
from pypureclient.flasharray._common.models.policy_member_clean_get_response_v_2_36 import PolicyMemberCleanGetResponse
from pypureclient.flasharray._common.models.policy_member_clean_response_v_2_36 import PolicyMemberCleanResponse
...
class DirectoryServicesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api236_directory_services_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_groups_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_groups_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_groups_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_users_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_users_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_users_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_users_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_users_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_users_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_local_users_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_roles_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_roles_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_roles_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_roles_policies_management_access_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_roles_policies_management_access_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_roles_policies_management_access_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_roles_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_directory_services_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api236_directory_services_get_with_http_info = directory_services_get_with_http_info
    api236_directory_services_local_groups_delete_with_http_info = directory_services_local_groups_delete_with_http_info
    api236_directory_services_local_groups_get_with_http_info = directory_services_local_groups_get_with_http_info
    api236_directory_services_local_groups_members_delete_with_http_info = directory_services_local_groups_members_delete_with_http_info
    api236_directory_services_local_groups_members_get_with_http_info = directory_services_local_groups_members_get_with_http_info
    api236_directory_services_local_groups_members_post_with_http_info = directory_services_local_groups_members_post_with_http_info
    api236_directory_services_local_groups_patch_with_http_info = directory_services_local_groups_patch_with_http_info
    api236_directory_services_local_groups_post_with_http_info = directory_services_local_groups_post_with_http_info
    api236_directory_services_local_users_delete_with_http_info = directory_services_local_users_delete_with_http_info
    api236_directory_services_local_users_get_with_http_info = directory_services_local_users_get_with_http_info
    api236_directory_services_local_users_members_delete_with_http_info = directory_services_local_users_members_delete_with_http_info
    api236_directory_services_local_users_members_get_with_http_info = directory_services_local_users_members_get_with_http_info
    api236_directory_services_local_users_members_post_with_http_info = directory_services_local_users_members_post_with_http_info
    api236_directory_services_local_users_patch_with_http_info = directory_services_local_users_patch_with_http_info
    api236_directory_services_local_users_post_with_http_info = directory_services_local_users_post_with_http_info
    api236_directory_services_patch_with_http_info = directory_services_patch_with_http_info
    api236_directory_services_roles_delete_with_http_info = directory_services_roles_delete_with_http_info
    api236_directory_services_roles_get_with_http_info = directory_services_roles_get_with_http_info
    api236_directory_services_roles_patch_with_http_info = directory_services_roles_patch_with_http_info
    api236_directory_services_roles_policies_management_access_delete_with_http_info = directory_services_roles_policies_management_access_delete_with_http_info
    api236_directory_services_roles_policies_management_access_get_with_http_info = directory_services_roles_policies_management_access_get_with_http_info
    api236_directory_services_roles_policies_management_access_post_with_http_info = directory_services_roles_policies_management_access_post_with_http_info
    api236_directory_services_roles_post_with_http_info = directory_services_roles_post_with_http_info
    api236_directory_services_test_get_with_http_info = directory_services_test_get_with_http_info
    api237_directory_services_get_with_http_info = directory_services_get_with_http_info
    api237_directory_services_local_groups_delete_with_http_info = directory_services_local_groups_delete_with_http_info
    api237_directory_services_local_groups_get_with_http_info = directory_services_local_groups_get_with_http_info
    api237_directory_services_local_groups_members_delete_with_http_info = directory_services_local_groups_members_delete_with_http_info
    api237_directory_services_local_groups_members_get_with_http_info = directory_services_local_groups_members_get_with_http_info
    api237_directory_services_local_groups_members_post_with_http_info = directory_services_local_groups_members_post_with_http_info
    api237_directory_services_local_groups_patch_with_http_info = directory_services_local_groups_patch_with_http_info
    api237_directory_services_local_groups_post_with_http_info = directory_services_local_groups_post_with_http_info
    api237_directory_services_local_users_delete_with_http_info = directory_services_local_users_delete_with_http_info
    api237_directory_services_local_users_get_with_http_info = directory_services_local_users_get_with_http_info
    api237_directory_services_local_users_members_delete_with_http_info = directory_services_local_users_members_delete_with_http_info
    api237_directory_services_local_users_members_get_with_http_info = directory_services_local_users_members_get_with_http_info
    api237_directory_services_local_users_members_post_with_http_info = directory_services_local_users_members_post_with_http_info
    api237_directory_services_local_users_patch_with_http_info = directory_services_local_users_patch_with_http_info
    api237_directory_services_local_users_post_with_http_info = directory_services_local_users_post_with_http_info
    api237_directory_services_patch_with_http_info = directory_services_patch_with_http_info
    api237_directory_services_roles_delete_with_http_info = directory_services_roles_delete_with_http_info
    api237_directory_services_roles_get_with_http_info = directory_services_roles_get_with_http_info
    api237_directory_services_roles_patch_with_http_info = directory_services_roles_patch_with_http_info
    api237_directory_services_roles_policies_management_access_delete_with_http_info = directory_services_roles_policies_management_access_delete_with_http_info
    api237_directory_services_roles_policies_management_access_get_with_http_info = directory_services_roles_policies_management_access_get_with_http_info
    api237_directory_services_roles_policies_management_access_post_with_http_info = directory_services_roles_policies_management_access_post_with_http_info
    api237_directory_services_roles_post_with_http_info = directory_services_roles_post_with_http_info
    api237_directory_services_test_get_with_http_info = directory_services_test_get_with_http_info
