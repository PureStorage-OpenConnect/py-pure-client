...
from pypureclient.flasharray._common.models.protection_group_get_response_v_2_34 import ProtectionGroupGetResponse
from pypureclient.flasharray._common.models.protection_group_performance_array_response_v_2_26 import ProtectionGroupPerformanceArrayResponse
from pypureclient.flasharray._common.models.protection_group_performance_response_v_2_26 import ProtectionGroupPerformanceResponse
from pypureclient.flasharray._common.models.protection_group_response_v_2_34 import ProtectionGroupResponse
from pypureclient.flasharray._common.models.protection_group_target_get_response_v_2_37 import ProtectionGroupTargetGetResponse
from pypureclient.flasharray._common.models.protection_group_target_response_v_2_37 import ProtectionGroupTargetResponse
...
from pypureclient.flasharray._common.models.resource_space_get_response_v_2_34 import ResourceSpaceGetResponse
...
class ProtectionGroupsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api237_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_host_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_host_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_host_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_performance_replication_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_targets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_targets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_targets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_targets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_volumes_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_volumes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api237_protection_groups_volumes_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api237_protection_groups_delete_with_http_info = protection_groups_delete_with_http_info
    api237_protection_groups_get_with_http_info = protection_groups_get_with_http_info
    api237_protection_groups_host_groups_delete_with_http_info = protection_groups_host_groups_delete_with_http_info
    api237_protection_groups_host_groups_get_with_http_info = protection_groups_host_groups_get_with_http_info
    api237_protection_groups_host_groups_post_with_http_info = protection_groups_host_groups_post_with_http_info
    api237_protection_groups_hosts_delete_with_http_info = protection_groups_hosts_delete_with_http_info
    api237_protection_groups_hosts_get_with_http_info = protection_groups_hosts_get_with_http_info
    api237_protection_groups_hosts_post_with_http_info = protection_groups_hosts_post_with_http_info
    api237_protection_groups_patch_with_http_info = protection_groups_patch_with_http_info
    api237_protection_groups_performance_replication_by_array_get_with_http_info = protection_groups_performance_replication_by_array_get_with_http_info
    api237_protection_groups_performance_replication_get_with_http_info = protection_groups_performance_replication_get_with_http_info
    api237_protection_groups_post_with_http_info = protection_groups_post_with_http_info
    api237_protection_groups_space_get_with_http_info = protection_groups_space_get_with_http_info
    api237_protection_groups_targets_delete_with_http_info = protection_groups_targets_delete_with_http_info
    api237_protection_groups_targets_get_with_http_info = protection_groups_targets_get_with_http_info
    api237_protection_groups_targets_patch_with_http_info = protection_groups_targets_patch_with_http_info
    api237_protection_groups_targets_post_with_http_info = protection_groups_targets_post_with_http_info
    api237_protection_groups_volumes_delete_with_http_info = protection_groups_volumes_delete_with_http_info
    api237_protection_groups_volumes_get_with_http_info = protection_groups_volumes_get_with_http_info
    api237_protection_groups_volumes_post_with_http_info = protection_groups_volumes_post_with_http_info
