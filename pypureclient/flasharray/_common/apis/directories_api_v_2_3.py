...
from pypureclient.flasharray._common.models.directory_get_response_v_2_3 import DirectoryGetResponse
...
from pypureclient.flasharray._common.models.directory_response_v_2_3 import DirectoryResponse
...
class DirectoriesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api23_directories_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_policies_nfs_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_policies_nfs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_policies_nfs_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_policies_smb_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_policies_smb_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_policies_smb_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_policies_snapshot_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_policies_snapshot_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_policies_snapshot_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_directories_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api23_directories_delete_with_http_info = directories_delete_with_http_info
    api23_directories_get_with_http_info = directories_get_with_http_info
    api23_directories_patch_with_http_info = directories_patch_with_http_info
    api23_directories_performance_get_with_http_info = directories_performance_get_with_http_info
    api23_directories_policies_get_with_http_info = directories_policies_get_with_http_info
    api23_directories_policies_nfs_delete_with_http_info = directories_policies_nfs_delete_with_http_info
    api23_directories_policies_nfs_get_with_http_info = directories_policies_nfs_get_with_http_info
    api23_directories_policies_nfs_post_with_http_info = directories_policies_nfs_post_with_http_info
    api23_directories_policies_smb_delete_with_http_info = directories_policies_smb_delete_with_http_info
    api23_directories_policies_smb_get_with_http_info = directories_policies_smb_get_with_http_info
    api23_directories_policies_smb_post_with_http_info = directories_policies_smb_post_with_http_info
    api23_directories_policies_snapshot_delete_with_http_info = directories_policies_snapshot_delete_with_http_info
    api23_directories_policies_snapshot_get_with_http_info = directories_policies_snapshot_get_with_http_info
    api23_directories_policies_snapshot_post_with_http_info = directories_policies_snapshot_post_with_http_info
    api23_directories_post_with_http_info = directories_post_with_http_info
    api23_directories_space_get_with_http_info = directories_space_get_with_http_info
    api24_directories_delete_with_http_info = directories_delete_with_http_info
    api24_directories_get_with_http_info = directories_get_with_http_info
    api24_directories_patch_with_http_info = directories_patch_with_http_info
    api24_directories_performance_get_with_http_info = directories_performance_get_with_http_info
    api24_directories_policies_get_with_http_info = directories_policies_get_with_http_info
    api24_directories_policies_nfs_delete_with_http_info = directories_policies_nfs_delete_with_http_info
    api24_directories_policies_nfs_get_with_http_info = directories_policies_nfs_get_with_http_info
    api24_directories_policies_nfs_post_with_http_info = directories_policies_nfs_post_with_http_info
    api24_directories_policies_smb_delete_with_http_info = directories_policies_smb_delete_with_http_info
    api24_directories_policies_smb_get_with_http_info = directories_policies_smb_get_with_http_info
    api24_directories_policies_smb_post_with_http_info = directories_policies_smb_post_with_http_info
    api24_directories_policies_snapshot_delete_with_http_info = directories_policies_snapshot_delete_with_http_info
    api24_directories_policies_snapshot_get_with_http_info = directories_policies_snapshot_get_with_http_info
    api24_directories_policies_snapshot_post_with_http_info = directories_policies_snapshot_post_with_http_info
    api24_directories_post_with_http_info = directories_post_with_http_info
    api24_directories_space_get_with_http_info = directories_space_get_with_http_info
    api25_directories_delete_with_http_info = directories_delete_with_http_info
    api25_directories_get_with_http_info = directories_get_with_http_info
    api25_directories_patch_with_http_info = directories_patch_with_http_info
    api25_directories_performance_get_with_http_info = directories_performance_get_with_http_info
    api25_directories_policies_get_with_http_info = directories_policies_get_with_http_info
    api25_directories_policies_nfs_delete_with_http_info = directories_policies_nfs_delete_with_http_info
    api25_directories_policies_nfs_get_with_http_info = directories_policies_nfs_get_with_http_info
    api25_directories_policies_nfs_post_with_http_info = directories_policies_nfs_post_with_http_info
    api25_directories_policies_smb_delete_with_http_info = directories_policies_smb_delete_with_http_info
    api25_directories_policies_smb_get_with_http_info = directories_policies_smb_get_with_http_info
    api25_directories_policies_smb_post_with_http_info = directories_policies_smb_post_with_http_info
    api25_directories_policies_snapshot_delete_with_http_info = directories_policies_snapshot_delete_with_http_info
    api25_directories_policies_snapshot_get_with_http_info = directories_policies_snapshot_get_with_http_info
    api25_directories_policies_snapshot_post_with_http_info = directories_policies_snapshot_post_with_http_info
    api25_directories_post_with_http_info = directories_post_with_http_info
    api25_directories_space_get_with_http_info = directories_space_get_with_http_info
    api26_directories_delete_with_http_info = directories_delete_with_http_info
    api26_directories_get_with_http_info = directories_get_with_http_info
    api26_directories_patch_with_http_info = directories_patch_with_http_info
    api26_directories_performance_get_with_http_info = directories_performance_get_with_http_info
    api26_directories_policies_get_with_http_info = directories_policies_get_with_http_info
    api26_directories_policies_nfs_delete_with_http_info = directories_policies_nfs_delete_with_http_info
    api26_directories_policies_nfs_get_with_http_info = directories_policies_nfs_get_with_http_info
    api26_directories_policies_nfs_post_with_http_info = directories_policies_nfs_post_with_http_info
    api26_directories_policies_smb_delete_with_http_info = directories_policies_smb_delete_with_http_info
    api26_directories_policies_smb_get_with_http_info = directories_policies_smb_get_with_http_info
    api26_directories_policies_smb_post_with_http_info = directories_policies_smb_post_with_http_info
    api26_directories_policies_snapshot_delete_with_http_info = directories_policies_snapshot_delete_with_http_info
    api26_directories_policies_snapshot_get_with_http_info = directories_policies_snapshot_get_with_http_info
    api26_directories_policies_snapshot_post_with_http_info = directories_policies_snapshot_post_with_http_info
    api26_directories_post_with_http_info = directories_post_with_http_info
    api26_directories_space_get_with_http_info = directories_space_get_with_http_info
