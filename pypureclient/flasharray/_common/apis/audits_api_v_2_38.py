...
from pypureclient.flasharray._common.models.audit_get_response_v_2_38 import AuditGetResponse
...
class AuditsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api238_audits_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api238_audits_get_with_http_info = audits_get_with_http_info
    api239_audits_get_with_http_info = audits_get_with_http_info
    api240_audits_get_with_http_info = audits_get_with_http_info
    api241_audits_get_with_http_info = audits_get_with_http_info
    api242_audits_get_with_http_info = audits_get_with_http_info
    api243_audits_get_with_http_info = audits_get_with_http_info
    api244_audits_get_with_http_info = audits_get_with_http_info
    api245_audits_get_with_http_info = audits_get_with_http_info
    api246_audits_get_with_http_info = audits_get_with_http_info
    api247_audits_get_with_http_info = audits_get_with_http_info
    api248_audits_get_with_http_info = audits_get_with_http_info
