...
from pypureclient.flasharray._common.models.subnet_get_response_v_2_2 import SubnetGetResponse
from pypureclient.flasharray._common.models.subnet_patch_v_2_2 import SubnetPatch
from pypureclient.flasharray._common.models.subnet_post_v_2_2 import SubnetPost
from pypureclient.flasharray._common.models.subnet_response_v_2_2 import SubnetResponse
...
class SubnetsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api236_subnets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_subnets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_subnets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_subnets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api252_subnets_delete_with_http_info = subnets_delete_with_http_info
