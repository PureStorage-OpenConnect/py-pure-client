...
from pypureclient.flasharray._common.models.active_directory_get_response_v_2_55 import ActiveDirectoryGetResponse
...
from pypureclient.flasharray._common.models.active_directory_response_v_2_55 import ActiveDirectoryResponse
...
class ActiveDirectoryApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api255_active_directory_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_active_directory_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "ActiveDirectoryGetResponse",
        }
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_active_directory_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_active_directory_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_active_directory_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api255_active_directory_delete_with_http_info = active_directory_delete_with_http_info
    api255_active_directory_get_with_http_info = active_directory_get_with_http_info
    api255_active_directory_patch_with_http_info = active_directory_patch_with_http_info
    api255_active_directory_post_with_http_info = active_directory_post_with_http_info
    api255_active_directory_test_get_with_http_info = active_directory_test_get_with_http_info
    api256_active_directory_delete_with_http_info = active_directory_delete_with_http_info
    api256_active_directory_get_with_http_info = active_directory_get_with_http_info
    api256_active_directory_patch_with_http_info = active_directory_patch_with_http_info
    api256_active_directory_post_with_http_info = active_directory_post_with_http_info
    api256_active_directory_test_get_with_http_info = active_directory_test_get_with_http_info
