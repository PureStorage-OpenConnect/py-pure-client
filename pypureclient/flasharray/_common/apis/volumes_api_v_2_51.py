...
from pypureclient.flasharray._common.models.member_get_response_v_2_51 import MemberGetResponse
from pypureclient.flasharray._common.models.protection_groups_volumes_get_response_v_2_51 import ProtectionGroupsVolumesGetResponse
from pypureclient.flasharray._common.models.protection_groups_volumes_response_v_2_51 import ProtectionGroupsVolumesResponse
from pypureclient.flasharray._common.models.resource_performance_by_array_get_response_v_2_51 import ResourcePerformanceByArrayGetResponse
from pypureclient.flasharray._common.models.resource_performance_get_response_v_2_51 import ResourcePerformanceGetResponse
from pypureclient.flasharray._common.models.tag_batch_v_2_51 import TagBatch
...
from pypureclient.flasharray._common.models.test_result_with_resource_with_id_post_response_v_2_51 import TestResultWithResourceWithIdPostResponse
from pypureclient.flasharray._common.models.volume_batch_post_v_2_51 import VolumeBatchPost
from pypureclient.flasharray._common.models.volume_get_response_v_2_51 import VolumeGetResponse
from pypureclient.flasharray._common.models.volume_patch_v_2_51 import VolumePatch
from pypureclient.flasharray._common.models.volume_post_v_2_51 import VolumePost
from pypureclient.flasharray._common.models.volume_qos_get_response_v_2_51 import VolumeQosGetResponse
from pypureclient.flasharray._common.models.volume_response_v_2_51 import VolumeResponse
from pypureclient.flasharray._common.models.volume_space_get_response_v_2_51 import VolumeSpaceGetResponse
from pypureclient.flasharray._common.models.volumes_batch_response_v_2_51 import VolumesBatchResponse
from pypureclient.flasharray._common.models.volumes_diff_get_response_v_2_51 import VolumesDiffGetResponse
...
class VolumesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api251_volumes_batch_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_batch_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_diff_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "ResourcePerformanceByArrayGetResponse",
        }
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "ResourcePerformanceGetResponse",
        }
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def volumes_qos_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        """List volume QoS config

        Displays real-time and historical QoS configuration data for each volume.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(VolumeQosGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_qos_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "VolumeQosGetResponse",
            '207': "VolumeQosGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/volumes/qos', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volumes_volume_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api251_volumes_batch_post_with_http_info = volumes_batch_post_with_http_info
    api251_volumes_batch_test_post_with_http_info = volumes_batch_test_post_with_http_info
    api251_volumes_delete_with_http_info = volumes_delete_with_http_info
    api251_volumes_diff_get_with_http_info = volumes_diff_get_with_http_info
    api251_volumes_get_with_http_info = volumes_get_with_http_info
    api251_volumes_patch_with_http_info = volumes_patch_with_http_info
    api251_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api251_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api251_volumes_post_with_http_info = volumes_post_with_http_info
    api251_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api251_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api251_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api251_volumes_qos_get_with_http_info = volumes_qos_get_with_http_info
    api251_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api251_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api251_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api251_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api251_volumes_test_post_with_http_info = volumes_test_post_with_http_info
    api251_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
