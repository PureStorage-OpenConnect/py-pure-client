...
class RemoteVolumeSnapshotsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api236_remote_volume_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_remote_volume_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_remote_volume_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_remote_volume_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_remote_volume_snapshots_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api236_remote_volume_snapshots_delete_with_http_info = remote_volume_snapshots_delete_with_http_info
    api236_remote_volume_snapshots_get_with_http_info = remote_volume_snapshots_get_with_http_info
    api236_remote_volume_snapshots_patch_with_http_info = remote_volume_snapshots_patch_with_http_info
    api236_remote_volume_snapshots_post_with_http_info = remote_volume_snapshots_post_with_http_info
    api236_remote_volume_snapshots_transfer_get_with_http_info = remote_volume_snapshots_transfer_get_with_http_info
    api237_remote_volume_snapshots_delete_with_http_info = remote_volume_snapshots_delete_with_http_info
    api237_remote_volume_snapshots_get_with_http_info = remote_volume_snapshots_get_with_http_info
    api237_remote_volume_snapshots_patch_with_http_info = remote_volume_snapshots_patch_with_http_info
    api237_remote_volume_snapshots_post_with_http_info = remote_volume_snapshots_post_with_http_info
    api237_remote_volume_snapshots_transfer_get_with_http_info = remote_volume_snapshots_transfer_get_with_http_info
