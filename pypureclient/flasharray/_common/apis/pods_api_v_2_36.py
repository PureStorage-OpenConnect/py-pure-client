...
from pypureclient.flasharray._common.models.container_performance_get_response_v_2_36 import ContainerPerformanceGetResponse
from pypureclient.flasharray._common.models.member_get_response_v_2_1 import MemberGetResponse
from pypureclient.flasharray._common.models.member_response_v_2_1 import MemberResponse
from pypureclient.flasharray._common.models.pod_get_response_v_2_36 import PodGetResponse
from pypureclient.flasharray._common.models.pod_member_get_response_v_2_36 import PodMemberGetResponse
from pypureclient.flasharray._common.models.pod_member_response_v_2_36 import PodMemberResponse
from pypureclient.flasharray._common.models.pod_patch_v_2_23 import PodPatch
from pypureclient.flasharray._common.models.pod_performance_by_array_get_response_v_2_13 import PodPerformanceByArrayGetResponse
from pypureclient.flasharray._common.models.pod_performance_replication_by_array_get_response_v_2_4 import PodPerformanceReplicationByArrayGetResponse
from pypureclient.flasharray._common.models.pod_performance_replication_get_response_v_2_4 import PodPerformanceReplicationGetResponse
from pypureclient.flasharray._common.models.pod_post_v_2_23 import PodPost
from pypureclient.flasharray._common.models.pod_response_v_2_36 import PodResponse
from pypureclient.flasharray._common.models.resource_pod_space_get_response_v_2_34 import ResourcePodSpaceGetResponse
from pypureclient.flasharray._common.models.test_result_with_resource_with_id_post_response_v_2_26 import TestResultWithResourceWithIdPostResponse
...
class PodsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api236_pods_arrays_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_arrays_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_performance_replication_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_pods_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api236_pods_arrays_delete_with_http_info = pods_arrays_delete_with_http_info
    api236_pods_arrays_get_with_http_info = pods_arrays_get_with_http_info
    api236_pods_arrays_post_with_http_info = pods_arrays_post_with_http_info
    api236_pods_delete_with_http_info = pods_delete_with_http_info
    api236_pods_get_with_http_info = pods_get_with_http_info
    api236_pods_members_delete_with_http_info = pods_members_delete_with_http_info
    api236_pods_members_get_with_http_info = pods_members_get_with_http_info
    api236_pods_members_post_with_http_info = pods_members_post_with_http_info
    api236_pods_patch_with_http_info = pods_patch_with_http_info
    api236_pods_performance_by_array_get_with_http_info = pods_performance_by_array_get_with_http_info
    api236_pods_performance_get_with_http_info = pods_performance_get_with_http_info
    api236_pods_performance_replication_by_array_get_with_http_info = pods_performance_replication_by_array_get_with_http_info
    api236_pods_performance_replication_get_with_http_info = pods_performance_replication_get_with_http_info
    api236_pods_post_with_http_info = pods_post_with_http_info
    api236_pods_space_get_with_http_info = pods_space_get_with_http_info
    api236_pods_test_post_with_http_info = pods_test_post_with_http_info
    api237_pods_arrays_delete_with_http_info = pods_arrays_delete_with_http_info
    api237_pods_arrays_get_with_http_info = pods_arrays_get_with_http_info
    api237_pods_arrays_post_with_http_info = pods_arrays_post_with_http_info
    api237_pods_delete_with_http_info = pods_delete_with_http_info
    api237_pods_get_with_http_info = pods_get_with_http_info
    api237_pods_members_delete_with_http_info = pods_members_delete_with_http_info
    api237_pods_members_get_with_http_info = pods_members_get_with_http_info
    api237_pods_members_post_with_http_info = pods_members_post_with_http_info
    api237_pods_patch_with_http_info = pods_patch_with_http_info
    api237_pods_performance_by_array_get_with_http_info = pods_performance_by_array_get_with_http_info
    api237_pods_performance_get_with_http_info = pods_performance_get_with_http_info
    api237_pods_performance_replication_by_array_get_with_http_info = pods_performance_replication_by_array_get_with_http_info
    api237_pods_performance_replication_get_with_http_info = pods_performance_replication_get_with_http_info
    api237_pods_post_with_http_info = pods_post_with_http_info
    api237_pods_space_get_with_http_info = pods_space_get_with_http_info
    api237_pods_test_post_with_http_info = pods_test_post_with_http_info
