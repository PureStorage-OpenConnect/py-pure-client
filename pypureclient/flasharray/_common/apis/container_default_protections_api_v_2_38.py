...
from pypureclient.flasharray._common.models.container_default_protection_get_response_v_2_38 import ContainerDefaultProtectionGetResponse
from pypureclient.flasharray._common.models.container_default_protection_response_v_2_38 import ContainerDefaultProtectionResponse
from pypureclient.flasharray._common.models.container_default_protection_v_2_38 import ContainerDefaultProtection
...
class ContainerDefaultProtectionsApi:
    ...
    def container_default_protections_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        :rtype: tuple(ContainerDefaultProtectionGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api238_container_default_protections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/container-default-protections', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def container_default_protections_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ContainerDefaultProtectionResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api238_container_default_protections_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['container_default_protection'] is not None:
            _body_params = _params['container_default_protection']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/container-default-protections', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api238_container_default_protections_get_with_http_info = container_default_protections_get_with_http_info
    api238_container_default_protections_patch_with_http_info = container_default_protections_patch_with_http_info
    api239_container_default_protections_get_with_http_info = container_default_protections_get_with_http_info
    api239_container_default_protections_patch_with_http_info = container_default_protections_patch_with_http_info
    api240_container_default_protections_get_with_http_info = container_default_protections_get_with_http_info
    api240_container_default_protections_patch_with_http_info = container_default_protections_patch_with_http_info
    api241_container_default_protections_get_with_http_info = container_default_protections_get_with_http_info
    api241_container_default_protections_patch_with_http_info = container_default_protections_patch_with_http_info
    api242_container_default_protections_get_with_http_info = container_default_protections_get_with_http_info
    api242_container_default_protections_patch_with_http_info = container_default_protections_patch_with_http_info
    api243_container_default_protections_get_with_http_info = container_default_protections_get_with_http_info
    api243_container_default_protections_patch_with_http_info = container_default_protections_patch_with_http_info
    api244_container_default_protections_get_with_http_info = container_default_protections_get_with_http_info
    api244_container_default_protections_patch_with_http_info = container_default_protections_patch_with_http_info
    api245_container_default_protections_get_with_http_info = container_default_protections_get_with_http_info
    api245_container_default_protections_patch_with_http_info = container_default_protections_patch_with_http_info
    api246_container_default_protections_get_with_http_info = container_default_protections_get_with_http_info
    api246_container_default_protections_patch_with_http_info = container_default_protections_patch_with_http_info
    api247_container_default_protections_get_with_http_info = container_default_protections_get_with_http_info
    api247_container_default_protections_patch_with_http_info = container_default_protections_patch_with_http_info
    api248_container_default_protections_get_with_http_info = container_default_protections_get_with_http_info
    api248_container_default_protections_patch_with_http_info = container_default_protections_patch_with_http_info
