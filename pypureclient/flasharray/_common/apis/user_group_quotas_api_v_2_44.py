...
from pypureclient.flasharray._common.models.directory_group_quotas_get_response_v_2_44 import DirectoryGroupQuotasGetResponse
from pypureclient.flasharray._common.models.directory_user_quotas_get_response_v_2_44 import DirectoryUserQuotasGetResponse
...
class UserGroupQuotasApi:
    ...
    def directory_group_quotas_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api244_directory_group_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/directory-group-quotas', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def directory_user_quotas_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api244_directory_user_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/directory-user-quotas', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api244_directory_group_quotas_get_with_http_info = directory_group_quotas_get_with_http_info
    api244_directory_user_quotas_get_with_http_info = directory_user_quotas_get_with_http_info
    api245_directory_group_quotas_get_with_http_info = directory_group_quotas_get_with_http_info
    api245_directory_user_quotas_get_with_http_info = directory_user_quotas_get_with_http_info
    api246_directory_group_quotas_get_with_http_info = directory_group_quotas_get_with_http_info
    api246_directory_user_quotas_get_with_http_info = directory_user_quotas_get_with_http_info
    api247_directory_group_quotas_get_with_http_info = directory_group_quotas_get_with_http_info
    api247_directory_user_quotas_get_with_http_info = directory_user_quotas_get_with_http_info
    api248_directory_group_quotas_get_with_http_info = directory_group_quotas_get_with_http_info
    api248_directory_user_quotas_get_with_http_info = directory_user_quotas_get_with_http_info
