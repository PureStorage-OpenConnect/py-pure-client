...
from pypureclient.flasharray._common.models.resource_performance_no_id_by_array_get_response_v_2_1 import ResourcePerformanceNoIdByArrayGetResponse
from pypureclient.flasharray._common.models.resource_performance_no_id_get_response_v_2_1 import ResourcePerformanceNoIdGetResponse
...
class HostsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api21_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_hosts_host_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_hosts_host_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_hosts_host_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_hosts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_hosts_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_hosts_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_hosts_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_hosts_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_hosts_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_hosts_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api21_hosts_delete_with_http_info = hosts_delete_with_http_info
    api21_hosts_get_with_http_info = hosts_get_with_http_info
    api21_hosts_host_groups_delete_with_http_info = hosts_host_groups_delete_with_http_info
    api21_hosts_host_groups_get_with_http_info = hosts_host_groups_get_with_http_info
    api21_hosts_host_groups_post_with_http_info = hosts_host_groups_post_with_http_info
    api21_hosts_patch_with_http_info = hosts_patch_with_http_info
    api21_hosts_performance_by_array_get_with_http_info = hosts_performance_by_array_get_with_http_info
    api21_hosts_performance_get_with_http_info = hosts_performance_get_with_http_info
    api21_hosts_post_with_http_info = hosts_post_with_http_info
    api21_hosts_protection_groups_delete_with_http_info = hosts_protection_groups_delete_with_http_info
    api21_hosts_protection_groups_get_with_http_info = hosts_protection_groups_get_with_http_info
    api21_hosts_protection_groups_post_with_http_info = hosts_protection_groups_post_with_http_info
    api21_hosts_space_get_with_http_info = hosts_space_get_with_http_info
    api22_hosts_delete_with_http_info = hosts_delete_with_http_info
    api22_hosts_get_with_http_info = hosts_get_with_http_info
    api22_hosts_host_groups_delete_with_http_info = hosts_host_groups_delete_with_http_info
    api22_hosts_host_groups_get_with_http_info = hosts_host_groups_get_with_http_info
    api22_hosts_host_groups_post_with_http_info = hosts_host_groups_post_with_http_info
    api22_hosts_patch_with_http_info = hosts_patch_with_http_info
    api22_hosts_performance_by_array_get_with_http_info = hosts_performance_by_array_get_with_http_info
    api22_hosts_performance_get_with_http_info = hosts_performance_get_with_http_info
    api22_hosts_post_with_http_info = hosts_post_with_http_info
    api22_hosts_protection_groups_delete_with_http_info = hosts_protection_groups_delete_with_http_info
    api22_hosts_protection_groups_get_with_http_info = hosts_protection_groups_get_with_http_info
    api22_hosts_protection_groups_post_with_http_info = hosts_protection_groups_post_with_http_info
    api22_hosts_space_get_with_http_info = hosts_space_get_with_http_info
    api23_hosts_delete_with_http_info = hosts_delete_with_http_info
    api23_hosts_get_with_http_info = hosts_get_with_http_info
    api23_hosts_host_groups_delete_with_http_info = hosts_host_groups_delete_with_http_info
    api23_hosts_host_groups_get_with_http_info = hosts_host_groups_get_with_http_info
    api23_hosts_host_groups_post_with_http_info = hosts_host_groups_post_with_http_info
    api23_hosts_patch_with_http_info = hosts_patch_with_http_info
    api23_hosts_performance_by_array_get_with_http_info = hosts_performance_by_array_get_with_http_info
    api23_hosts_performance_get_with_http_info = hosts_performance_get_with_http_info
    api23_hosts_post_with_http_info = hosts_post_with_http_info
    api23_hosts_protection_groups_delete_with_http_info = hosts_protection_groups_delete_with_http_info
    api23_hosts_protection_groups_get_with_http_info = hosts_protection_groups_get_with_http_info
    api23_hosts_protection_groups_post_with_http_info = hosts_protection_groups_post_with_http_info
    api23_hosts_space_get_with_http_info = hosts_space_get_with_http_info
