...
from pypureclient.flasharray._common.models.host_get_response_v_2_36 import HostGetResponse
...
from pypureclient.flasharray._common.models.host_post_v_2_16 import HostPost
from pypureclient.flasharray._common.models.host_response_v_2_36 import HostResponse
...
from pypureclient.flasharray._common.models.member_no_id_member_get_response_v_2_26 import MemberNoIdMemberGetResponse
from pypureclient.flasharray._common.models.member_no_id_member_response_v_2_26 import MemberNoIdMemberResponse
...
from pypureclient.flasharray._common.models.resource_space_no_id_get_response_v_2_34 import ResourceSpaceNoIdGetResponse
...
class HostsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api236_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_host_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_host_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_host_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_performance_balance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api236_hosts_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api236_hosts_delete_with_http_info = hosts_delete_with_http_info
    api236_hosts_get_with_http_info = hosts_get_with_http_info
    api236_hosts_host_groups_delete_with_http_info = hosts_host_groups_delete_with_http_info
    api236_hosts_host_groups_get_with_http_info = hosts_host_groups_get_with_http_info
    api236_hosts_host_groups_post_with_http_info = hosts_host_groups_post_with_http_info
    api236_hosts_patch_with_http_info = hosts_patch_with_http_info
    api236_hosts_performance_balance_get_with_http_info = hosts_performance_balance_get_with_http_info
    api236_hosts_performance_by_array_get_with_http_info = hosts_performance_by_array_get_with_http_info
    api236_hosts_performance_get_with_http_info = hosts_performance_get_with_http_info
    api236_hosts_post_with_http_info = hosts_post_with_http_info
    api236_hosts_protection_groups_delete_with_http_info = hosts_protection_groups_delete_with_http_info
    api236_hosts_protection_groups_get_with_http_info = hosts_protection_groups_get_with_http_info
    api236_hosts_protection_groups_post_with_http_info = hosts_protection_groups_post_with_http_info
    api236_hosts_space_get_with_http_info = hosts_space_get_with_http_info
    api236_hosts_tags_batch_put_with_http_info = hosts_tags_batch_put_with_http_info
    api236_hosts_tags_delete_with_http_info = hosts_tags_delete_with_http_info
    api236_hosts_tags_get_with_http_info = hosts_tags_get_with_http_info
    api237_hosts_delete_with_http_info = hosts_delete_with_http_info
    api237_hosts_get_with_http_info = hosts_get_with_http_info
    api237_hosts_host_groups_delete_with_http_info = hosts_host_groups_delete_with_http_info
    api237_hosts_host_groups_get_with_http_info = hosts_host_groups_get_with_http_info
    api237_hosts_host_groups_post_with_http_info = hosts_host_groups_post_with_http_info
    api237_hosts_patch_with_http_info = hosts_patch_with_http_info
    api237_hosts_performance_balance_get_with_http_info = hosts_performance_balance_get_with_http_info
    api237_hosts_performance_by_array_get_with_http_info = hosts_performance_by_array_get_with_http_info
    api237_hosts_performance_get_with_http_info = hosts_performance_get_with_http_info
    api237_hosts_post_with_http_info = hosts_post_with_http_info
    api237_hosts_protection_groups_delete_with_http_info = hosts_protection_groups_delete_with_http_info
    api237_hosts_protection_groups_get_with_http_info = hosts_protection_groups_get_with_http_info
    api237_hosts_protection_groups_post_with_http_info = hosts_protection_groups_post_with_http_info
    api237_hosts_space_get_with_http_info = hosts_space_get_with_http_info
    api237_hosts_tags_batch_put_with_http_info = hosts_tags_batch_put_with_http_info
    api237_hosts_tags_delete_with_http_info = hosts_tags_delete_with_http_info
    api237_hosts_tags_get_with_http_info = hosts_tags_get_with_http_info
