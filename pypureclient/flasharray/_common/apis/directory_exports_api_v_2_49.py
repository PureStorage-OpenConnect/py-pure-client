...
from pypureclient.flasharray._common.models.directory_export_get_response_v_2_49 import DirectoryExportGetResponse
...
from pypureclient.flasharray._common.models.directory_export_response_v_2_49 import DirectoryExportResponse
...
class DirectoryExportsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api249_directory_exports_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_directory_exports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_directory_exports_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_directory_exports_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api249_directory_exports_delete_with_http_info = directory_exports_delete_with_http_info
    api249_directory_exports_get_with_http_info = directory_exports_get_with_http_info
    api249_directory_exports_patch_with_http_info = directory_exports_patch_with_http_info
    api249_directory_exports_post_with_http_info = directory_exports_post_with_http_info
    api250_directory_exports_delete_with_http_info = directory_exports_delete_with_http_info
    api250_directory_exports_get_with_http_info = directory_exports_get_with_http_info
    api250_directory_exports_patch_with_http_info = directory_exports_patch_with_http_info
    api250_directory_exports_post_with_http_info = directory_exports_post_with_http_info
