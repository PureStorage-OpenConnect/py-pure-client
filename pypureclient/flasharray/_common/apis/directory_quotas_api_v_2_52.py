...
from pypureclient.flasharray._common.models.directory_quotas_get_response_v_2_52 import DirectoryQuotasGetResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_directory_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
