...
from pypureclient.flasharray._common.models.pod_get_response_v_2_3 import PodGetResponse
from pypureclient.flasharray._common.models.pod_patch_v_2_2 import PodPatch
...
from pypureclient.flasharray._common.models.pod_post_v_2_1 import PodPost
from pypureclient.flasharray._common.models.pod_response_v_2_3 import PodResponse
...
from pypureclient.flasharray._common.models.resource_pod_space_get_response_v_2_2 import ResourcePodSpaceGetResponse
...
class PodsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api24_pods_arrays_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_pods_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_pods_arrays_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_pods_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_pods_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_pods_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_pods_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_pods_performance_replication_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_pods_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_pods_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_pods_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api24_pods_arrays_delete_with_http_info = pods_arrays_delete_with_http_info
    api24_pods_arrays_get_with_http_info = pods_arrays_get_with_http_info
    api24_pods_arrays_post_with_http_info = pods_arrays_post_with_http_info
    api24_pods_delete_with_http_info = pods_delete_with_http_info
    api24_pods_get_with_http_info = pods_get_with_http_info
    api24_pods_patch_with_http_info = pods_patch_with_http_info
    api24_pods_performance_by_array_get_with_http_info = pods_performance_by_array_get_with_http_info
    api24_pods_performance_get_with_http_info = pods_performance_get_with_http_info
    api24_pods_performance_replication_by_array_get_with_http_info = pods_performance_replication_by_array_get_with_http_info
    api24_pods_performance_replication_get_with_http_info = pods_performance_replication_get_with_http_info
    api24_pods_post_with_http_info = pods_post_with_http_info
    api24_pods_space_get_with_http_info = pods_space_get_with_http_info
