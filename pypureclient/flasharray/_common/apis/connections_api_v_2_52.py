...
from pypureclient.flasharray._common.models.connection_get_response_v_2_52 import ConnectionGetResponse
from pypureclient.flasharray._common.models.connection_post_v_2_52 import ConnectionPost
from pypureclient.flasharray._common.models.connection_response_v_2_52 import ConnectionResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_connections_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_connections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_connections_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
