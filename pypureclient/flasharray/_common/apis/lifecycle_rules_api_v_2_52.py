...
from pypureclient.flasharray._common.models.lifecycle_rule_get_response_v_2_52 import LifecycleRuleGetResponse
from pypureclient.flasharray._common.models.lifecycle_rule_patch_base_v_2_52 import LifecycleRulePatchBase
from pypureclient.flasharray._common.models.lifecycle_rule_post_base_v_2_52 import LifecycleRulePostBase
from pypureclient.flasharray._common.models.lifecycle_rule_response_v_2_52 import LifecycleRuleResponse
...
class LifecycleRulesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_lifecycle_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_lifecycle_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def lifecycle_rules_patch_with_http_info(
        ...
        **kwargs
        ...
        :type lifecycle: LifecycleRulePatchBase
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        :param bucket_ids: A comma-separated list of bucket IDs. If after filtering, there is not at least one resource that matches each of the elements of `bucket_ids`, then an error is returned. This cannot be provided together with the `bucket_names` query parameter. This can be provided with the `ids` query parameter but not with `names`.
        :type bucket_ids: List[str]
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_lifecycle_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def lifecycle_rules_post_with_http_info(
        ...
        **kwargs
        ...
        Creates a lifecycle rule. `bucket` and `keep_previous_version_for` are required. If `rule_id` is not specified, it will be automatically generated in the format \"faRuleIdX\".

        :param rule: (required)
        :type rule: LifecycleRulePostBase
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        :param confirm_date: If set to `true`, then confirm the date of `keep_current_version_until` is correct.
        :type confirm_date: bool
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_lifecycle_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api252_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api252_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api252_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api252_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
