...
from pypureclient.flasharray._common.models.software_bundle_get_response_v_2_5 import SoftwareBundleGetResponse
from pypureclient.flasharray._common.models.software_bundle_post_v_2_5 import SoftwareBundlePost
from pypureclient.flasharray._common.models.software_bundle_response_v_2_5 import SoftwareBundleResponse
from pypureclient.flasharray._common.models.software_checks_get_response_v_2_9 import SoftwareChecksGetResponse
from pypureclient.flasharray._common.models.software_checks_response_v_2_9 import SoftwareChecksResponse
from pypureclient.flasharray._common.models.software_get_response_v_2_9 import SoftwareGetResponse
from pypureclient.flasharray._common.models.software_installation_patch_v_2_4 import SoftwareInstallationPatch
from pypureclient.flasharray._common.models.software_installation_post_v_2_9 import SoftwareInstallationPost
from pypureclient.flasharray._common.models.software_installation_steps_get_response_v_2_2 import SoftwareInstallationStepsGetResponse
from pypureclient.flasharray._common.models.software_installations_get_response_v_2_9 import SoftwareInstallationsGetResponse
from pypureclient.flasharray._common.models.software_installations_response_v_2_9 import SoftwareInstallationsResponse
from pypureclient.flasharray._common.models.software_post_v_2_9 import SoftwarePost
from pypureclient.flasharray._common.models.software_response_v_2_9 import SoftwareResponse
from pypureclient.flasharray._common.models.software_versions_get_response_v_2_9 import SoftwareVersionsGetResponse
...
class SoftwareApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api29_software_bundle_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_software_bundle_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_software_check_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_software_check_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_software_check_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_software_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_software_installation_steps_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_software_installations_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_software_installations_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_software_installations_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_software_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_software_versions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api210_software_bundle_get_with_http_info = software_bundle_get_with_http_info
    api210_software_bundle_post_with_http_info = software_bundle_post_with_http_info
    api210_software_check_delete_with_http_info = software_check_delete_with_http_info
    api210_software_check_get_with_http_info = software_check_get_with_http_info
    api210_software_check_post_with_http_info = software_check_post_with_http_info
    api210_software_get_with_http_info = software_get_with_http_info
    api210_software_installation_steps_get_with_http_info = software_installation_steps_get_with_http_info
    api210_software_installations_get_with_http_info = software_installations_get_with_http_info
    api210_software_installations_patch_with_http_info = software_installations_patch_with_http_info
    api210_software_installations_post_with_http_info = software_installations_post_with_http_info
    api210_software_post_with_http_info = software_post_with_http_info
    api210_software_versions_get_with_http_info = software_versions_get_with_http_info
    api29_software_bundle_get_with_http_info = software_bundle_get_with_http_info
    api29_software_bundle_post_with_http_info = software_bundle_post_with_http_info
    api29_software_check_delete_with_http_info = software_check_delete_with_http_info
    api29_software_check_get_with_http_info = software_check_get_with_http_info
    api29_software_check_post_with_http_info = software_check_post_with_http_info
    api29_software_get_with_http_info = software_get_with_http_info
    api29_software_installation_steps_get_with_http_info = software_installation_steps_get_with_http_info
    api29_software_installations_get_with_http_info = software_installations_get_with_http_info
    api29_software_installations_patch_with_http_info = software_installations_patch_with_http_info
    api29_software_installations_post_with_http_info = software_installations_post_with_http_info
    api29_software_post_with_http_info = software_post_with_http_info
    api29_software_versions_get_with_http_info = software_versions_get_with_http_info
