...
from pypureclient.flasharray._common.models.dns_get_response_v_2_52 import DnsGetResponse
from pypureclient.flasharray._common.models.dns_patch_v_2_52 import DnsPatch
from pypureclient.flasharray._common.models.dns_post_v_2_52 import DnsPost
from pypureclient.flasharray._common.models.dns_response_v_2_52 import DnsResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_dns_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_dns_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_dns_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
