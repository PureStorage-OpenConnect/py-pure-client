...
from pypureclient.flasharray._common.models.api_version_response_v_2_50 import ApiVersionResponse
from pypureclient.flasharray._common.models.login_post_v_2_52 import LoginPost
...
from pypureclient.flasharray._common.models.oauth_token_response_v_2_52 import OauthTokenResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_login_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_logout_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
