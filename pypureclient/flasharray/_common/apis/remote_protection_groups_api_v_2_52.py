...
from pypureclient.flasharray._common.models.remote_protection_group_get_response_v_2_52 import RemoteProtectionGroupGetResponse
from pypureclient.flasharray._common.models.remote_protection_group_response_v_2_52 import RemoteProtectionGroupResponse
from pypureclient.flasharray._common.models.remote_protection_group_v_2_52 import RemoteProtectionGroup
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_remote_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_remote_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_remote_protection_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
