...
from pypureclient.flasharray._common.models.remote_realm_tag_get_response_v_2_51 import RemoteRealmTagGetResponse
from pypureclient.flasharray._common.models.remote_realms_response_v_2_51 import RemoteRealmsResponse

class RemoteRealmsApi:
    ...
    def remote_realms_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        :rtype: tuple(RemoteRealmsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api251_remote_realms_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "RemoteRealmsResponse",
            '207': "RemoteRealmsResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/remote-realms', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def remote_realms_tags_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(RemoteRealmTagGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_remote_realms_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "RemoteRealmTagGetResponse",
            '207': "RemoteRealmTagGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/remote-realms/tags', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
