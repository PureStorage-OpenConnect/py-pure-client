...
from pypureclient.flasharray._common.models.resource_performance_by_array_get_response_v_2_1 import ResourcePerformanceByArrayGetResponse
...
from pypureclient.flasharray._common.models.volume_get_response_v_2_2 import VolumeGetResponse
...
from pypureclient.flasharray._common.models.volume_response_v_2_2 import VolumeResponse
...
class VolumesApi:
    ...
    # Method Aliases
    api23_volumes_delete_with_http_info = volumes_delete_with_http_info
    api23_volumes_get_with_http_info = volumes_get_with_http_info
    api23_volumes_patch_with_http_info = volumes_patch_with_http_info
    api23_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api23_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api23_volumes_post_with_http_info = volumes_post_with_http_info
    api23_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api23_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api23_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api23_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api23_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api23_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api23_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api23_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api24_volumes_delete_with_http_info = volumes_delete_with_http_info
    api24_volumes_get_with_http_info = volumes_get_with_http_info
    api24_volumes_patch_with_http_info = volumes_patch_with_http_info
    api24_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api24_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api24_volumes_post_with_http_info = volumes_post_with_http_info
    api24_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api24_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api24_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api24_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api24_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api24_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api24_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api24_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api25_volumes_delete_with_http_info = volumes_delete_with_http_info
    api25_volumes_get_with_http_info = volumes_get_with_http_info
    api25_volumes_patch_with_http_info = volumes_patch_with_http_info
    api25_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api25_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api25_volumes_post_with_http_info = volumes_post_with_http_info
    api25_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api25_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api25_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api25_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api25_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api25_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api25_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api25_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api26_volumes_delete_with_http_info = volumes_delete_with_http_info
    api26_volumes_get_with_http_info = volumes_get_with_http_info
    api26_volumes_patch_with_http_info = volumes_patch_with_http_info
    api26_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api26_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api26_volumes_post_with_http_info = volumes_post_with_http_info
    api26_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api26_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api26_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api26_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api26_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api26_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api26_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api26_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api27_volumes_delete_with_http_info = volumes_delete_with_http_info
    api27_volumes_get_with_http_info = volumes_get_with_http_info
    api27_volumes_patch_with_http_info = volumes_patch_with_http_info
    api27_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api27_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api27_volumes_post_with_http_info = volumes_post_with_http_info
    api27_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api27_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api27_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api27_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api27_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api27_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api27_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api27_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api28_volumes_delete_with_http_info = volumes_delete_with_http_info
    api28_volumes_get_with_http_info = volumes_get_with_http_info
    api28_volumes_patch_with_http_info = volumes_patch_with_http_info
    api28_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api28_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api28_volumes_post_with_http_info = volumes_post_with_http_info
    api28_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api28_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api28_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api28_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api28_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api28_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api28_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api28_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
