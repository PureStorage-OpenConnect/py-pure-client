...
from pypureclient.flasharray._common.models.volume_get_response_v_2_9 import VolumeGetResponse
from pypureclient.flasharray._common.models.volume_patch_v_2_2 import VolumePatch
from pypureclient.flasharray._common.models.volume_post_v_2_0 import VolumePost
from pypureclient.flasharray._common.models.volume_response_v_2_9 import VolumeResponse
from pypureclient.flasharray._common.models.volume_space_get_response_v_2_9 import VolumeSpaceGetResponse
...
class VolumesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api29_volumes_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_diff_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_volumes_volume_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api210_volumes_delete_with_http_info = volumes_delete_with_http_info
    api210_volumes_diff_get_with_http_info = volumes_diff_get_with_http_info
    api210_volumes_get_with_http_info = volumes_get_with_http_info
    api210_volumes_patch_with_http_info = volumes_patch_with_http_info
    api210_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api210_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api210_volumes_post_with_http_info = volumes_post_with_http_info
    api210_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api210_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api210_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api210_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api210_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api210_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api210_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api210_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api211_volumes_delete_with_http_info = volumes_delete_with_http_info
    api211_volumes_diff_get_with_http_info = volumes_diff_get_with_http_info
    api211_volumes_get_with_http_info = volumes_get_with_http_info
    api211_volumes_patch_with_http_info = volumes_patch_with_http_info
    api211_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api211_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api211_volumes_post_with_http_info = volumes_post_with_http_info
    api211_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api211_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api211_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api211_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api211_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api211_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api211_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api211_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api213_volumes_delete_with_http_info = volumes_delete_with_http_info
    api213_volumes_diff_get_with_http_info = volumes_diff_get_with_http_info
    api213_volumes_get_with_http_info = volumes_get_with_http_info
    api213_volumes_patch_with_http_info = volumes_patch_with_http_info
    api213_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api213_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api213_volumes_post_with_http_info = volumes_post_with_http_info
    api213_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api213_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api213_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api213_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api213_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api213_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api213_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api213_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api214_volumes_delete_with_http_info = volumes_delete_with_http_info
    api214_volumes_diff_get_with_http_info = volumes_diff_get_with_http_info
    api214_volumes_get_with_http_info = volumes_get_with_http_info
    api214_volumes_patch_with_http_info = volumes_patch_with_http_info
    api214_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api214_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api214_volumes_post_with_http_info = volumes_post_with_http_info
    api214_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api214_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api214_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api214_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api214_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api214_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api214_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api214_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api215_volumes_delete_with_http_info = volumes_delete_with_http_info
    api215_volumes_diff_get_with_http_info = volumes_diff_get_with_http_info
    api215_volumes_get_with_http_info = volumes_get_with_http_info
    api215_volumes_patch_with_http_info = volumes_patch_with_http_info
    api215_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api215_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api215_volumes_post_with_http_info = volumes_post_with_http_info
    api215_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api215_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api215_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api215_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api215_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api215_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api215_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api215_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
    api29_volumes_delete_with_http_info = volumes_delete_with_http_info
    api29_volumes_diff_get_with_http_info = volumes_diff_get_with_http_info
    api29_volumes_get_with_http_info = volumes_get_with_http_info
    api29_volumes_patch_with_http_info = volumes_patch_with_http_info
    api29_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api29_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api29_volumes_post_with_http_info = volumes_post_with_http_info
    api29_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api29_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api29_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api29_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api29_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api29_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api29_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api29_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
