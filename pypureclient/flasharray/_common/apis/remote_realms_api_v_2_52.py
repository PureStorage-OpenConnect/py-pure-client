...
from pypureclient.flasharray._common.models.remote_realm_tag_get_response_v_2_52 import RemoteRealmTagGetResponse
from pypureclient.flasharray._common.models.remote_realms_response_v_2_52 import RemoteRealmsResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_remote_realms_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_remote_realms_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
