...
from pypureclient.flasharray._common.models.network_interface_get_response_v_2_52 import NetworkInterfaceGetResponse
from pypureclient.flasharray._common.models.network_interface_neighbor_get_response_v_2_52 import NetworkInterfaceNeighborGetResponse
from pypureclient.flasharray._common.models.network_interface_patch_v_2_52 import NetworkInterfacePatch
from pypureclient.flasharray._common.models.network_interface_performance_get_response_v_2_52 import NetworkInterfacePerformanceGetResponse
from pypureclient.flasharray._common.models.network_interface_post_v_2_52 import NetworkInterfacePost
from pypureclient.flasharray._common.models.network_interface_response_v_2_52 import NetworkInterfaceResponse
from pypureclient.flasharray._common.models.network_interfaces_port_details_get_response_v_2_52 import NetworkInterfacesPortDetailsGetResponse
...
class NetworkInterfacesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_network_interfaces_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_network_interfaces_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_network_interfaces_neighbors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_network_interfaces_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_network_interfaces_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_network_interfaces_port_details_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_network_interfaces_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api252_network_interfaces_delete_with_http_info = network_interfaces_delete_with_http_info
    api252_network_interfaces_get_with_http_info = network_interfaces_get_with_http_info
    api252_network_interfaces_neighbors_get_with_http_info = network_interfaces_neighbors_get_with_http_info
    api252_network_interfaces_patch_with_http_info = network_interfaces_patch_with_http_info
    api252_network_interfaces_performance_get_with_http_info = network_interfaces_performance_get_with_http_info
    api252_network_interfaces_port_details_get_with_http_info = network_interfaces_port_details_get_with_http_info
    api252_network_interfaces_post_with_http_info = network_interfaces_post_with_http_info
