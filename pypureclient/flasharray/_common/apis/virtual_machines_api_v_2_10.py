...
from pypureclient.flasharray._common.models.virtual_machine_post_v_2_10 import VirtualMachinePost
from pypureclient.flasharray._common.models.virtual_machine_response_v_2_10 import VirtualMachineResponse
...
class VirtualMachinesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api210_virtual_machines_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_virtual_machines_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api210_virtual_machines_patch_with_http_info = virtual_machines_patch_with_http_info
    api210_virtual_machines_post_with_http_info = virtual_machines_post_with_http_info
    api211_virtual_machines_patch_with_http_info = virtual_machines_patch_with_http_info
    api211_virtual_machines_post_with_http_info = virtual_machines_post_with_http_info
    api213_virtual_machines_patch_with_http_info = virtual_machines_patch_with_http_info
    api213_virtual_machines_post_with_http_info = virtual_machines_post_with_http_info
