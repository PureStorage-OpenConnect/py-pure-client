...
from pypureclient.flasharray._common.models.container_default_protection_get_response_v_2_52 import ContainerDefaultProtectionGetResponse
from pypureclient.flasharray._common.models.container_default_protection_response_v_2_52 import ContainerDefaultProtectionResponse
from pypureclient.flasharray._common.models.container_default_protection_v_2_52 import ContainerDefaultProtection
...
class ContainerDefaultProtectionsApi:
    ...
    def container_default_protections_get_with_http_info(
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_container_default_protections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "ContainerDefaultProtectionGetResponse",
        }
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_container_default_protections_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api252_container_default_protections_get_with_http_info = container_default_protections_get_with_http_info
    api252_container_default_protections_patch_with_http_info = container_default_protections_patch_with_http_info
