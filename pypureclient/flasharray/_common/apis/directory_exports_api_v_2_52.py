...
from pypureclient.flasharray._common.models.directory_export_get_response_v_2_52 import DirectoryExportGetResponse
from pypureclient.flasharray._common.models.directory_export_patch_v_2_52 import DirectoryExportPatch
from pypureclient.flasharray._common.models.directory_export_post_v_2_52 import DirectoryExportPost
from pypureclient.flasharray._common.models.directory_export_response_v_2_52 import DirectoryExportResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_directory_exports_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_directory_exports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_directory_exports_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_directory_exports_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
