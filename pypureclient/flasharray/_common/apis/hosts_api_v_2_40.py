...
class HostsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api240_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_host_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_host_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_host_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_performance_balance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def hosts_tags_batch_put_with_http_info(
        self,
        tag: Annotated[conlist(NonCopyableTag, max_items=30, min_items=1, unique_items=True), Field(..., description="A list of tags to be created or, if one already exists, updated.")],
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api240_hosts_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api240_hosts_delete_with_http_info = hosts_delete_with_http_info
    api240_hosts_get_with_http_info = hosts_get_with_http_info
    api240_hosts_host_groups_delete_with_http_info = hosts_host_groups_delete_with_http_info
    api240_hosts_host_groups_get_with_http_info = hosts_host_groups_get_with_http_info
    api240_hosts_host_groups_post_with_http_info = hosts_host_groups_post_with_http_info
    api240_hosts_patch_with_http_info = hosts_patch_with_http_info
    api240_hosts_performance_balance_get_with_http_info = hosts_performance_balance_get_with_http_info
    api240_hosts_performance_by_array_get_with_http_info = hosts_performance_by_array_get_with_http_info
    api240_hosts_performance_get_with_http_info = hosts_performance_get_with_http_info
    api240_hosts_post_with_http_info = hosts_post_with_http_info
    api240_hosts_protection_groups_delete_with_http_info = hosts_protection_groups_delete_with_http_info
    api240_hosts_protection_groups_get_with_http_info = hosts_protection_groups_get_with_http_info
    api240_hosts_protection_groups_post_with_http_info = hosts_protection_groups_post_with_http_info
    api240_hosts_space_get_with_http_info = hosts_space_get_with_http_info
    api240_hosts_tags_batch_put_with_http_info = hosts_tags_batch_put_with_http_info
    api240_hosts_tags_delete_with_http_info = hosts_tags_delete_with_http_info
    api240_hosts_tags_get_with_http_info = hosts_tags_get_with_http_info
    api241_hosts_delete_with_http_info = hosts_delete_with_http_info
    api241_hosts_get_with_http_info = hosts_get_with_http_info
    api241_hosts_host_groups_delete_with_http_info = hosts_host_groups_delete_with_http_info
    api241_hosts_host_groups_get_with_http_info = hosts_host_groups_get_with_http_info
    api241_hosts_host_groups_post_with_http_info = hosts_host_groups_post_with_http_info
    api241_hosts_patch_with_http_info = hosts_patch_with_http_info
    api241_hosts_performance_balance_get_with_http_info = hosts_performance_balance_get_with_http_info
    api241_hosts_performance_by_array_get_with_http_info = hosts_performance_by_array_get_with_http_info
    api241_hosts_performance_get_with_http_info = hosts_performance_get_with_http_info
    api241_hosts_post_with_http_info = hosts_post_with_http_info
    api241_hosts_protection_groups_delete_with_http_info = hosts_protection_groups_delete_with_http_info
    api241_hosts_protection_groups_get_with_http_info = hosts_protection_groups_get_with_http_info
    api241_hosts_protection_groups_post_with_http_info = hosts_protection_groups_post_with_http_info
    api241_hosts_space_get_with_http_info = hosts_space_get_with_http_info
    api241_hosts_tags_batch_put_with_http_info = hosts_tags_batch_put_with_http_info
    api241_hosts_tags_delete_with_http_info = hosts_tags_delete_with_http_info
    api241_hosts_tags_get_with_http_info = hosts_tags_get_with_http_info
    api242_hosts_delete_with_http_info = hosts_delete_with_http_info
    api242_hosts_get_with_http_info = hosts_get_with_http_info
    api242_hosts_host_groups_delete_with_http_info = hosts_host_groups_delete_with_http_info
    api242_hosts_host_groups_get_with_http_info = hosts_host_groups_get_with_http_info
    api242_hosts_host_groups_post_with_http_info = hosts_host_groups_post_with_http_info
    api242_hosts_patch_with_http_info = hosts_patch_with_http_info
    api242_hosts_performance_balance_get_with_http_info = hosts_performance_balance_get_with_http_info
    api242_hosts_performance_by_array_get_with_http_info = hosts_performance_by_array_get_with_http_info
    api242_hosts_performance_get_with_http_info = hosts_performance_get_with_http_info
    api242_hosts_post_with_http_info = hosts_post_with_http_info
    api242_hosts_protection_groups_delete_with_http_info = hosts_protection_groups_delete_with_http_info
    api242_hosts_protection_groups_get_with_http_info = hosts_protection_groups_get_with_http_info
    api242_hosts_protection_groups_post_with_http_info = hosts_protection_groups_post_with_http_info
    api242_hosts_space_get_with_http_info = hosts_space_get_with_http_info
    api242_hosts_tags_batch_put_with_http_info = hosts_tags_batch_put_with_http_info
    api242_hosts_tags_delete_with_http_info = hosts_tags_delete_with_http_info
    api242_hosts_tags_get_with_http_info = hosts_tags_get_with_http_info
