...
from pypureclient.flasharray._common.models.remote_arrays_response_v_2_52 import RemoteArraysResponse

class RemoteArraysApi:
    ...
    def remote_arrays_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        :param current_fleet_only: If current_fleet_only is specified, then results will only show arrays from the same fleet to which the current array is a member of.
        ...
        :rtype: tuple(RemoteArraysResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_remote_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('current_fleet_only') is not None:  # noqa: E501
            _query_params.append(('current_fleet_only', _params['current_fleet_only']))
        ...
        _response_types_map = {
            '200': "RemoteArraysResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/remote-arrays', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
