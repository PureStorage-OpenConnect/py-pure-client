...
from pypureclient.flasharray._common.models.host_group_get_response_v_2_0 import HostGroupGetResponse
from pypureclient.flasharray._common.models.host_group_patch_v_2_0 import HostGroupPatch
from pypureclient.flasharray._common.models.host_group_response_v_2_0 import HostGroupResponse
from pypureclient.flasharray._common.models.member_no_id_all_get_response_v_2_0 import MemberNoIdAllGetResponse
from pypureclient.flasharray._common.models.resource_performance_no_id_by_array_get_response_v_2_0 import ResourcePerformanceNoIdByArrayGetResponse
from pypureclient.flasharray._common.models.resource_performance_no_id_get_response_v_2_0 import ResourcePerformanceNoIdGetResponse
...
class HostGroupsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api20_host_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_host_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_host_groups_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_host_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_host_groups_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_host_groups_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_host_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api20_host_groups_delete_with_http_info = host_groups_delete_with_http_info
    api20_host_groups_get_with_http_info = host_groups_get_with_http_info
    api20_host_groups_hosts_get_with_http_info = host_groups_hosts_get_with_http_info
    api20_host_groups_patch_with_http_info = host_groups_patch_with_http_info
    api20_host_groups_performance_by_array_get_with_http_info = host_groups_performance_by_array_get_with_http_info
    api20_host_groups_performance_get_with_http_info = host_groups_performance_get_with_http_info
    api20_host_groups_post_with_http_info = host_groups_post_with_http_info
