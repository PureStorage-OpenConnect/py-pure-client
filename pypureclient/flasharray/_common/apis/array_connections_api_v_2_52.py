...
from pypureclient.flasharray._common.models.array_connection_get_response_v_2_52 import ArrayConnectionGetResponse
from pypureclient.flasharray._common.models.array_connection_key_get_response_v_2_52 import ArrayConnectionKeyGetResponse
from pypureclient.flasharray._common.models.array_connection_patch_v_2_52 import ArrayConnectionPatch
from pypureclient.flasharray._common.models.array_connection_path_get_response_v_2_52 import ArrayConnectionPathGetResponse
from pypureclient.flasharray._common.models.array_connection_post_v_2_52 import ArrayConnectionPost
from pypureclient.flasharray._common.models.array_connection_response_v_2_52 import ArrayConnectionResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_array_connections_connection_key_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_array_connections_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_array_connections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_array_connections_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_array_connections_path_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_array_connections_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
