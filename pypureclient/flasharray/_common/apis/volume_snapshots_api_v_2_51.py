...
from pypureclient.flasharray._common.models.test_result_with_resource_post_response_v_2_51 import TestResultWithResourcePostResponse
from pypureclient.flasharray._common.models.volume_snapshot_batch_post_v_2_51 import VolumeSnapshotBatchPost
from pypureclient.flasharray._common.models.volume_snapshot_batch_response_v_2_51 import VolumeSnapshotBatchResponse
from pypureclient.flasharray._common.models.volume_snapshot_get_response_v_2_51 import VolumeSnapshotGetResponse
from pypureclient.flasharray._common.models.volume_snapshot_patch_v_2_51 import VolumeSnapshotPatch
from pypureclient.flasharray._common.models.volume_snapshot_post_v_2_51 import VolumeSnapshotPost
from pypureclient.flasharray._common.models.volume_snapshot_response_v_2_51 import VolumeSnapshotResponse
from pypureclient.flasharray._common.models.volume_snapshot_transfer_get_response_v_2_51 import VolumeSnapshotTransferGetResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api251_volume_snapshots_batch_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volume_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volume_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volume_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volume_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volume_snapshots_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volume_snapshots_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volume_snapshots_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volume_snapshots_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_volume_snapshots_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
