...
from pypureclient.flasharray._common.models.policy_nfs_get_response_v_2_32 import PolicyNfsGetResponse
...
from pypureclient.flasharray._common.models.policy_nfs_response_v_2_32 import PolicyNfsResponse
...
from pypureclient.flasharray._common.models.policy_rule_alert_watcher_get_response_v_2_33 import PolicyRuleAlertWatcherGetResponse
...
from pypureclient.flasharray._common.models.policy_rule_alert_watcher_response_v_2_33 import PolicyRuleAlertWatcherResponse
from pypureclient.flasharray._common.models.policy_rule_nfs_client_get_response_v_2_29 import PolicyRuleNfsClientGetResponse
from pypureclient.flasharray._common.models.policy_rule_nfs_client_post_v_2_29 import PolicyRuleNfsClientPost
from pypureclient.flasharray._common.models.policy_rule_nfs_client_response_v_2_29 import PolicyRuleNfsClientResponse
...
from pypureclient.flasharray._common.models.policy_smb_get_response_v_2_32 import PolicySmbGetResponse
...
from pypureclient.flasharray._common.models.policy_smb_response_v_2_32 import PolicySmbResponse
...
class PoliciesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api233_policies_alert_watcher_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_alert_watcher_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_alert_watcher_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_alert_watcher_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_alert_watcher_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_alert_watcher_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_alert_watcher_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_alert_watcher_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_alert_watcher_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_alert_watcher_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_alert_watcher_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_alert_watcher_rules_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_autodir_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_autodir_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_autodir_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_autodir_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_autodir_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_autodir_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_autodir_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_nfs_client_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_nfs_client_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_nfs_client_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_nfs_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_nfs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_nfs_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_nfs_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_nfs_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_nfs_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_nfs_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_quota_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_quota_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_quota_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_quota_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_quota_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_quota_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_quota_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_quota_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_quota_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_quota_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_quota_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_smb_client_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_smb_client_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_smb_client_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_smb_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_smb_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_smb_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_smb_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_smb_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_smb_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_smb_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_snapshot_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_snapshot_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_snapshot_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_snapshot_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_snapshot_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_snapshot_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_snapshot_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_snapshot_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_snapshot_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api233_policies_snapshot_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api233_policies_alert_watcher_delete_with_http_info = policies_alert_watcher_delete_with_http_info
    api233_policies_alert_watcher_get_with_http_info = policies_alert_watcher_get_with_http_info
    api233_policies_alert_watcher_members_delete_with_http_info = policies_alert_watcher_members_delete_with_http_info
    api233_policies_alert_watcher_members_get_with_http_info = policies_alert_watcher_members_get_with_http_info
    api233_policies_alert_watcher_members_post_with_http_info = policies_alert_watcher_members_post_with_http_info
    api233_policies_alert_watcher_patch_with_http_info = policies_alert_watcher_patch_with_http_info
    api233_policies_alert_watcher_post_with_http_info = policies_alert_watcher_post_with_http_info
    api233_policies_alert_watcher_rules_delete_with_http_info = policies_alert_watcher_rules_delete_with_http_info
    api233_policies_alert_watcher_rules_get_with_http_info = policies_alert_watcher_rules_get_with_http_info
    api233_policies_alert_watcher_rules_patch_with_http_info = policies_alert_watcher_rules_patch_with_http_info
    api233_policies_alert_watcher_rules_post_with_http_info = policies_alert_watcher_rules_post_with_http_info
    api233_policies_alert_watcher_rules_test_get_with_http_info = policies_alert_watcher_rules_test_get_with_http_info
    api233_policies_autodir_delete_with_http_info = policies_autodir_delete_with_http_info
    api233_policies_autodir_get_with_http_info = policies_autodir_get_with_http_info
    api233_policies_autodir_members_delete_with_http_info = policies_autodir_members_delete_with_http_info
    api233_policies_autodir_members_get_with_http_info = policies_autodir_members_get_with_http_info
    api233_policies_autodir_members_post_with_http_info = policies_autodir_members_post_with_http_info
    api233_policies_autodir_patch_with_http_info = policies_autodir_patch_with_http_info
    api233_policies_autodir_post_with_http_info = policies_autodir_post_with_http_info
    api233_policies_get_with_http_info = policies_get_with_http_info
    api233_policies_members_get_with_http_info = policies_members_get_with_http_info
    api233_policies_nfs_client_rules_delete_with_http_info = policies_nfs_client_rules_delete_with_http_info
    api233_policies_nfs_client_rules_get_with_http_info = policies_nfs_client_rules_get_with_http_info
    api233_policies_nfs_client_rules_post_with_http_info = policies_nfs_client_rules_post_with_http_info
    api233_policies_nfs_delete_with_http_info = policies_nfs_delete_with_http_info
    api233_policies_nfs_get_with_http_info = policies_nfs_get_with_http_info
    api233_policies_nfs_members_delete_with_http_info = policies_nfs_members_delete_with_http_info
    api233_policies_nfs_members_get_with_http_info = policies_nfs_members_get_with_http_info
    api233_policies_nfs_members_post_with_http_info = policies_nfs_members_post_with_http_info
    api233_policies_nfs_patch_with_http_info = policies_nfs_patch_with_http_info
    api233_policies_nfs_post_with_http_info = policies_nfs_post_with_http_info
    api233_policies_quota_delete_with_http_info = policies_quota_delete_with_http_info
    api233_policies_quota_get_with_http_info = policies_quota_get_with_http_info
    api233_policies_quota_members_delete_with_http_info = policies_quota_members_delete_with_http_info
    api233_policies_quota_members_get_with_http_info = policies_quota_members_get_with_http_info
    api233_policies_quota_members_post_with_http_info = policies_quota_members_post_with_http_info
    api233_policies_quota_patch_with_http_info = policies_quota_patch_with_http_info
    api233_policies_quota_post_with_http_info = policies_quota_post_with_http_info
    api233_policies_quota_rules_delete_with_http_info = policies_quota_rules_delete_with_http_info
    api233_policies_quota_rules_get_with_http_info = policies_quota_rules_get_with_http_info
    api233_policies_quota_rules_patch_with_http_info = policies_quota_rules_patch_with_http_info
    api233_policies_quota_rules_post_with_http_info = policies_quota_rules_post_with_http_info
    api233_policies_smb_client_rules_delete_with_http_info = policies_smb_client_rules_delete_with_http_info
    api233_policies_smb_client_rules_get_with_http_info = policies_smb_client_rules_get_with_http_info
    api233_policies_smb_client_rules_post_with_http_info = policies_smb_client_rules_post_with_http_info
    api233_policies_smb_delete_with_http_info = policies_smb_delete_with_http_info
    api233_policies_smb_get_with_http_info = policies_smb_get_with_http_info
    api233_policies_smb_members_delete_with_http_info = policies_smb_members_delete_with_http_info
    api233_policies_smb_members_get_with_http_info = policies_smb_members_get_with_http_info
    api233_policies_smb_members_post_with_http_info = policies_smb_members_post_with_http_info
    api233_policies_smb_patch_with_http_info = policies_smb_patch_with_http_info
    api233_policies_smb_post_with_http_info = policies_smb_post_with_http_info
    api233_policies_snapshot_delete_with_http_info = policies_snapshot_delete_with_http_info
    api233_policies_snapshot_get_with_http_info = policies_snapshot_get_with_http_info
    api233_policies_snapshot_members_delete_with_http_info = policies_snapshot_members_delete_with_http_info
    api233_policies_snapshot_members_get_with_http_info = policies_snapshot_members_get_with_http_info
    api233_policies_snapshot_members_post_with_http_info = policies_snapshot_members_post_with_http_info
    api233_policies_snapshot_patch_with_http_info = policies_snapshot_patch_with_http_info
    api233_policies_snapshot_post_with_http_info = policies_snapshot_post_with_http_info
    api233_policies_snapshot_rules_delete_with_http_info = policies_snapshot_rules_delete_with_http_info
    api233_policies_snapshot_rules_get_with_http_info = policies_snapshot_rules_get_with_http_info
    api233_policies_snapshot_rules_post_with_http_info = policies_snapshot_rules_post_with_http_info
