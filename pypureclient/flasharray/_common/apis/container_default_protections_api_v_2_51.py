...
from pypureclient.flasharray._common.models.container_default_protection_get_response_v_2_51 import ContainerDefaultProtectionGetResponse
from pypureclient.flasharray._common.models.container_default_protection_response_v_2_51 import ContainerDefaultProtectionResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api251_container_default_protections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_container_default_protections_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
