...
class RemoteVolumeSnapshotsApi:
    ...
    # Method Aliases
    api21_remote_volume_snapshots_get_with_http_info = remote_volume_snapshots_get_with_http_info
    api21_remote_volume_snapshots_transfer_get_with_http_info = remote_volume_snapshots_transfer_get_with_http_info
    api22_remote_volume_snapshots_get_with_http_info = remote_volume_snapshots_get_with_http_info
    api22_remote_volume_snapshots_transfer_get_with_http_info = remote_volume_snapshots_transfer_get_with_http_info
    api23_remote_volume_snapshots_get_with_http_info = remote_volume_snapshots_get_with_http_info
    api23_remote_volume_snapshots_transfer_get_with_http_info = remote_volume_snapshots_transfer_get_with_http_info
