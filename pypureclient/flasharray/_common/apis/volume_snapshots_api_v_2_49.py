...
from pypureclient.flasharray._common.models.test_result_with_resource_post_response_v_2_49 import TestResultWithResourcePostResponse
from pypureclient.flasharray._common.models.volume_snapshot_get_response_v_2_49 import VolumeSnapshotGetResponse
from pypureclient.flasharray._common.models.volume_snapshot_patch_v_2_0 import VolumeSnapshotPatch
from pypureclient.flasharray._common.models.volume_snapshot_post_v_2_49 import VolumeSnapshotPost
from pypureclient.flasharray._common.models.volume_snapshot_response_v_2_49 import VolumeSnapshotResponse
from pypureclient.flasharray._common.models.volume_snapshot_transfer_get_response_v_2_49 import VolumeSnapshotTransferGetResponse
...
class VolumeSnapshotsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api249_volume_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_volume_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_volume_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_volume_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_volume_snapshots_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_volume_snapshots_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_volume_snapshots_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_volume_snapshots_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_volume_snapshots_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api249_volume_snapshots_delete_with_http_info = volume_snapshots_delete_with_http_info
    api249_volume_snapshots_get_with_http_info = volume_snapshots_get_with_http_info
    api249_volume_snapshots_patch_with_http_info = volume_snapshots_patch_with_http_info
    api249_volume_snapshots_post_with_http_info = volume_snapshots_post_with_http_info
    api249_volume_snapshots_tags_batch_put_with_http_info = volume_snapshots_tags_batch_put_with_http_info
    api249_volume_snapshots_tags_delete_with_http_info = volume_snapshots_tags_delete_with_http_info
    api249_volume_snapshots_tags_get_with_http_info = volume_snapshots_tags_get_with_http_info
    api249_volume_snapshots_test_post_with_http_info = volume_snapshots_test_post_with_http_info
    api249_volume_snapshots_transfer_get_with_http_info = volume_snapshots_transfer_get_with_http_info
