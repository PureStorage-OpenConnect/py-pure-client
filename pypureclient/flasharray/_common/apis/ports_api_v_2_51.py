...
from pypureclient.flasharray._common.models.port_get_response_v_2_51 import PortGetResponse
from pypureclient.flasharray._common.models.port_initiators_get_response_v_2_51 import PortInitiatorsGetResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api251_ports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_ports_initiators_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
