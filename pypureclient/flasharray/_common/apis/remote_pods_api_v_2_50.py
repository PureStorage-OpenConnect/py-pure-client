...
from pypureclient.flasharray._common.models.remote_pod_tag_get_response_v_2_50 import RemotePodTagGetResponse
from pypureclient.flasharray._common.models.remote_pods_response_v_2_50 import RemotePodsResponse
...
class RemotePodsApi:
    ...
    def remote_pods_get_with_http_info(
        self,
        ...
        on_ids: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the specified target IDs. Enter multiple target IDs in comma-separated format. The on and on_ids parameters cannot be set together.")] = None,
        ...
        **kwargs
        ...
        :type on: List[str]
        :param on_ids: Performs the operation on the specified target IDs. Enter multiple target IDs in comma-separated format. The on and on_ids parameters cannot be set together.
        :type on_ids: List[str]
        ...
        :rtype: tuple(RemotePodsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api250_remote_pods_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('on_ids') is not None:  # noqa: E501
            _query_params.append(('on_ids', _params['on_ids']))
            _collection_formats['on_ids'] = 'csv'
        ...
        _response_types_map = {
            '200': "RemotePodsResponse",
            '207': "RemotePodsResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/remote-pods', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def remote_pods_tags_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(RemotePodTagGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_remote_pods_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "RemotePodTagGetResponse",
            '207': "RemotePodTagGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/remote-pods/tags', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    api253_remote_pods_get_with_http_info = remote_pods_get_with_http_info
    api253_remote_pods_tags_get_with_http_info = remote_pods_tags_get_with_http_info
    api254_remote_pods_get_with_http_info = remote_pods_get_with_http_info
    api254_remote_pods_tags_get_with_http_info = remote_pods_tags_get_with_http_info
    api255_remote_pods_get_with_http_info = remote_pods_get_with_http_info
    api255_remote_pods_tags_get_with_http_info = remote_pods_tags_get_with_http_info
    api256_remote_pods_get_with_http_info = remote_pods_get_with_http_info
