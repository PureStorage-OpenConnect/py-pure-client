...
from pypureclient.flasharray._common.models.remote_pod_tag_get_response_v_2_49 import RemotePodTagGetResponse
from pypureclient.flasharray._common.models.remote_pods_response_v_2_49 import RemotePodsResponse
...
class RemotePodsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api249_remote_pods_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_remote_pods_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api249_remote_pods_get_with_http_info = remote_pods_get_with_http_info
    api249_remote_pods_tags_get_with_http_info = remote_pods_tags_get_with_http_info
