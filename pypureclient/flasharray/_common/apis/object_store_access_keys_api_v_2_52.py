...
from pypureclient.flasharray._common.models.object_store_access_key_get_response_v_2_52 import ObjectStoreAccessKeyGetResponse
from pypureclient.flasharray._common.models.object_store_access_key_post_base_v_2_52 import ObjectStoreAccessKeyPostBase
from pypureclient.flasharray._common.models.object_store_access_key_response_v_2_52 import ObjectStoreAccessKeyResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_object_store_access_keys_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_object_store_access_keys_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_object_store_access_keys_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_object_store_access_keys_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
