...
from pypureclient.flasharray._common.models.destroyed_patch_post_v_2_52 import DestroyedPatchPost
from pypureclient.flasharray._common.models.remote_protection_group_snapshot_get_response_v_2_52 import RemoteProtectionGroupSnapshotGetResponse
from pypureclient.flasharray._common.models.remote_protection_group_snapshot_post_v_2_52 import RemoteProtectionGroupSnapshotPost
from pypureclient.flasharray._common.models.remote_protection_group_snapshot_response_v_2_52 import RemoteProtectionGroupSnapshotResponse
from pypureclient.flasharray._common.models.remote_protection_group_snapshot_transfer_get_response_v_2_52 import RemoteProtectionGroupSnapshotTransferGetResponse
...
class RemoteProtectionGroupSnapshotsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api252_remote_protection_group_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_remote_protection_group_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "RemoteProtectionGroupSnapshotGetResponse",
        }
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_remote_protection_group_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_remote_protection_group_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_remote_protection_group_snapshots_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api252_remote_protection_group_snapshots_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "RemoteProtectionGroupSnapshotTransferGetResponse",
        }
    ...
    # Method Aliases
    api252_remote_protection_group_snapshots_delete_with_http_info = remote_protection_group_snapshots_delete_with_http_info
    api252_remote_protection_group_snapshots_get_with_http_info = remote_protection_group_snapshots_get_with_http_info
    api252_remote_protection_group_snapshots_patch_with_http_info = remote_protection_group_snapshots_patch_with_http_info
    api252_remote_protection_group_snapshots_post_with_http_info = remote_protection_group_snapshots_post_with_http_info
    api252_remote_protection_group_snapshots_test_post_with_http_info = remote_protection_group_snapshots_test_post_with_http_info
    api252_remote_protection_group_snapshots_transfer_get_with_http_info = remote_protection_group_snapshots_transfer_get_with_http_info
