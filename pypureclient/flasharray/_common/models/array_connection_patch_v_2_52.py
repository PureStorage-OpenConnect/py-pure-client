...
from pypureclient.flasharray._common.models.throttle_v_2_52 import Throttle
...
class ArrayConnectionPatch(BaseModel):
    ...
    connection_key: Optional[StrictStr] = Field(default=None, description="The connection key of the target array. It is required when `encryption` is changed, or when `type` is changed from `async-replication` to `sync-replication`.")
