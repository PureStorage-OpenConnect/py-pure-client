...
class WorkloadConfigurationReference(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkloadConfigurationReference:
        """Create an instance of WorkloadConfigurationReference from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> WorkloadConfigurationReference:
        """Create an instance of WorkloadConfigurationReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkloadConfigurationReference.parse_obj(obj)

        _obj = WorkloadConfigurationReference.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
