...
from pypureclient.flasharray._common.models.kmip_v_2_2 import Kmip


class KmipGetResponse(BaseModel):
    """
    KmipGetResponse
    """
    ...
    items: Optional[conlist(Kmip)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> KmipGetResponse:
        """Create an instance of KmipGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> KmipGetResponse:
        """Create an instance of KmipGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return KmipGetResponse.parse_obj(obj)

        _obj = KmipGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Kmip.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
