...
from pypureclient.flasharray._common.models.local_directory_service_v_2_55 import LocalDirectoryService
...
class LocalDirectoryServiceGetResponse(BaseModel):
    ...
    __properties = ["errors", "continuation_token", "more_items_remaining", "total_item_count", "items"]
