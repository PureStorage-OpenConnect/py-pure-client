...
class Vchost(BaseModel):
    ...
    vcuuid: Optional[StrictStr] = Field(default=None, description="The vCenter Server uuid of the vchost.")
    __properties = ["id", "name", "vcuuid"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Vchost:
        """Create an instance of Vchost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> Vchost:
        """Create an instance of Vchost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Vchost.parse_obj(obj)

        _obj = Vchost.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "vcuuid": obj.get("vcuuid")
        })
        return _obj
