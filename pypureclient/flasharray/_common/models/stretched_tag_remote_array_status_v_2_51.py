...
class StretchedTagRemoteArrayStatus(BaseModel):
    """
    ...
    member: Optional[FixedReferenceWithType] = Field(default=None, description="A reference to the member associated with the tag's array status.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StretchedTagRemoteArrayStatus:
        """Create an instance of StretchedTagRemoteArrayStatus from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> StretchedTagRemoteArrayStatus:
        """Create an instance of StretchedTagRemoteArrayStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StretchedTagRemoteArrayStatus.parse_obj(obj)

        _obj = StretchedTagRemoteArrayStatus.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
