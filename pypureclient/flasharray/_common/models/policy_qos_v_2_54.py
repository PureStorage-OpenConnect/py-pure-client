...
class PolicyQos(BaseModel):
    ...
    __properties = ["id", "name", "context", "policy_type", "destroyed", "enabled", "pod", "time_remaining", "max_total_bytes_per_sec", "max_total_ops_per_sec"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyQos:
        """Create an instance of PolicyQos from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyQos:
        """Create an instance of PolicyQos from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyQos.parse_obj(obj)

        _obj = PolicyQos.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
