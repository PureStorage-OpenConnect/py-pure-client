...
from pypureclient.flasharray._common.models.policy_rule_nfs_client_v_2_26 import PolicyRuleNfsClient
...
class PolicyRuleNfsClientGetResponse(BaseModel):
    ...
    items: Optional[conlist(PolicyRuleNfsClient)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
