...
class PolicyRuleObjectStoreAccess(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleObjectStoreAccess:
        """Create an instance of PolicyRuleObjectStoreAccess from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleObjectStoreAccess:
        """Create an instance of PolicyRuleObjectStoreAccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleObjectStoreAccess.parse_obj(obj)
