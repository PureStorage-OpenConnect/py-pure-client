...
class DirectoriesPerformanceByArray(BaseModel):
    """
    ...
    usec_per_mirrored_write_op: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The average time it takes the array to process a mirrored I/O write request, measured in microseconds.")
    ...
    __properties = ["id", "name", "context", "mirrored_others_per_sec", "others_per_sec", "usec_per_mirrored_other_op", "usec_per_other_op", "bytes_per_mirrored_write", "bytes_per_op", "bytes_per_read", "bytes_per_write", "mirrored_write_bytes_per_sec", "mirrored_writes_per_sec", "read_bytes_per_sec", "reads_per_sec", "time", "usec_per_mirrored_write_op", "usec_per_read_op", "usec_per_write_op", "write_bytes_per_sec", "writes_per_sec", "array"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoriesPerformanceByArray:
        """Create an instance of DirectoriesPerformanceByArray from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoriesPerformanceByArray:
        """Create an instance of DirectoriesPerformanceByArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoriesPerformanceByArray.parse_obj(obj)

        _obj = DirectoriesPerformanceByArray.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
