...
from pypureclient.flasharray._common.models.resource_space_v_2_34 import ResourceSpace
...
class ResourceSpaceGetResponse(BaseModel):
    ...
    items: Optional[conlist(ResourceSpace)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name. If `total_only=true`, the `items` list will be empty.")
