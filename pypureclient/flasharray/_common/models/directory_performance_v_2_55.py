...
class DirectoryPerformance(BaseModel):
    ...
    __properties = ["id", "name", "context", "mirrored_others_per_sec", "others_per_sec", "usec_per_mirrored_other_op", "usec_per_other_op", "bytes_per_mirrored_write", "bytes_per_op", "bytes_per_read", "bytes_per_write", "mirrored_write_bytes_per_sec", "mirrored_writes_per_sec", "read_bytes_per_sec", "reads_per_sec", "time", "usec_per_mirrored_write_op", "usec_per_read_op", "usec_per_write_op", "write_bytes_per_sec", "writes_per_sec"]
