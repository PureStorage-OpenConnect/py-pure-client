...
class PodMember(BaseModel):
    ...
    __properties = ["context", "member", "pod"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PodMember:
        """Create an instance of PodMember from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PodMember:
        """Create an instance of PodMember from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PodMember.parse_obj(obj)

        _obj = PodMember.construct(_fields_set=None, **{
            ...
            "pod": ReferenceWithType.from_dict(obj.get("pod")) if obj.get("pod") is not None else None
        })
        return _obj
