...
class ResourceDirectorySpace(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceDirectorySpace:
        """Create an instance of ResourceDirectorySpace from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourceDirectorySpace:
        """Create an instance of ResourceDirectorySpace from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceDirectorySpace.parse_obj(obj)

        _obj = ResourceDirectorySpace.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
