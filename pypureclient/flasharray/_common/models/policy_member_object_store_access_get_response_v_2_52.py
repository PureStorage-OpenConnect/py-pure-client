...
from pypureclient.flasharray._common.models.policy_member_base_v_2_52 import PolicyMemberBase


class PolicyMemberObjectStoreAccessGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyMemberBase)] = Field(default=None, description="A list of members for policies.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyMemberObjectStoreAccessGetResponse:
        """Create an instance of PolicyMemberObjectStoreAccessGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyMemberObjectStoreAccessGetResponse:
        """Create an instance of PolicyMemberObjectStoreAccessGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyMemberObjectStoreAccessGetResponse.parse_obj(obj)

        _obj = PolicyMemberObjectStoreAccessGetResponse.construct(_fields_set=None, **{
