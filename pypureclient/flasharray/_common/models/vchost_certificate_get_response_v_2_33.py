...
from pypureclient.flasharray._common.models.vchost_certificate_v_2_33 import VchostCertificate


class VchostCertificateGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(VchostCertificate)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VchostCertificateGetResponse:
        """Create an instance of VchostCertificateGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VchostCertificateGetResponse:
        """Create an instance of VchostCertificateGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VchostCertificateGetResponse.parse_obj(obj)

        _obj = VchostCertificateGetResponse.construct(_fields_set=None, **{
            ...
            "items": [VchostCertificate.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
