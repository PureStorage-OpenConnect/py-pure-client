...
class ResourceSpace(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceSpace:
        """Create an instance of ResourceSpace from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourceSpace:
        """Create an instance of ResourceSpace from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceSpace.parse_obj(obj)

        _obj = ResourceSpace.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
