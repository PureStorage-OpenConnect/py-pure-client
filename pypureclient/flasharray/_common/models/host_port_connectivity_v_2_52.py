...
class HostPortConnectivity(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HostPortConnectivity:
        """Create an instance of HostPortConnectivity from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> HostPortConnectivity:
        """Create an instance of HostPortConnectivity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HostPortConnectivity.parse_obj(obj)

        _obj = HostPortConnectivity.construct(_fields_set=None, **{
