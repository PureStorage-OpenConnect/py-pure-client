...
from pypureclient.flasharray._common.models.saml2_sso_v_2_51 import Saml2Sso


class Saml2SsoGetResponse(BaseModel):
    """
    Saml2SsoGetResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Saml2SsoGetResponse:
        """Create an instance of Saml2SsoGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> Saml2SsoGetResponse:
        """Create an instance of Saml2SsoGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Saml2SsoGetResponse.parse_obj(obj)

        _obj = Saml2SsoGetResponse.construct(_fields_set=None, **{
