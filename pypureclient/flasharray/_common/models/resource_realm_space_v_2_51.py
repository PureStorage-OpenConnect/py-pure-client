...
from pypureclient.flasharray._common.models.space_no_deprecated_physical_or_effective_v_2_51 import SpaceNoDeprecatedPhysicalOrEffective


class ResourceRealmSpace(BaseModel):
    """
    ResourceRealmSpace
    """
    ...
    space: Optional[SpaceNoDeprecatedPhysicalOrEffective] = Field(default=None, description="Displays size and space consumption information.")
    ...
    __properties = ["id", "name", "space", "time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceRealmSpace:
        """Create an instance of ResourceRealmSpace from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourceRealmSpace:
        """Create an instance of ResourceRealmSpace from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceRealmSpace.parse_obj(obj)

        _obj = ResourceRealmSpace.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
