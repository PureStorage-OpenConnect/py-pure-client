...
from pypureclient.flasharray._common.models.policy_rule_quota_v_2_21 import PolicyRuleQuota
...
class PolicyRuleQuotaGetResponse(BaseModel):
    ...
    items: Optional[conlist(PolicyRuleQuota)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name, if meaningful.")
