...
from pypureclient.flasharray._common.models.software_patch_v_2_29 import SoftwarePatch


class SoftwarePatchesGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SoftwarePatchesGetResponse:
        """Create an instance of SoftwarePatchesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SoftwarePatchesGetResponse:
        """Create an instance of SoftwarePatchesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SoftwarePatchesGetResponse.parse_obj(obj)

        _obj = SoftwarePatchesGetResponse.construct(_fields_set=None, **{
