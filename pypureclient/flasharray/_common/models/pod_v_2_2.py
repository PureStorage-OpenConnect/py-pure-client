...
class Pod(BaseModel):
    ...
    __properties = ["id", "name", "arrays", "destroyed", "failover_preferences", "footprint", "link_source_count", "link_target_count", "mediator", "mediator_version", "promotion_status", "requested_promotion_state", "source", "space", "time_remaining"]
