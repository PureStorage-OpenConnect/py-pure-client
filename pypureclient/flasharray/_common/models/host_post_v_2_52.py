...
class HostPost(BaseModel):
    ...
    __properties = ["chap", "iqns", "nqns", "nvme_stretch", "personality", "preferred_arrays", "qos", "tags", "vlan", "wwns"]
    ...
    def from_dict(cls, obj: dict) -> HostPost:
        ...
        _obj = HostPost.construct(_fields_set=None, **{
            ...
            "iqns": obj.get("iqns"),
            "nqns": obj.get("nqns"),
            "nvme_stretch": obj.get("nvme_stretch"),
