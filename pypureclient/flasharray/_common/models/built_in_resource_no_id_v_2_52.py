...
class BuiltInResourceNoId(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BuiltInResourceNoId:
        """Create an instance of BuiltInResourceNoId from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> BuiltInResourceNoId:
        """Create an instance of BuiltInResourceNoId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BuiltInResourceNoId.parse_obj(obj)

        _obj = BuiltInResourceNoId.construct(_fields_set=None, **{
            "name": obj.get("name")
        })
        return _obj
