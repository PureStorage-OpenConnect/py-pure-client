...
class TotalItemCountResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TotalItemCountResponse:
        """Create an instance of TotalItemCountResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TotalItemCountResponse:
        """Create an instance of TotalItemCountResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TotalItemCountResponse.parse_obj(obj)

        _obj = TotalItemCountResponse.construct(_fields_set=None, **{
