...
class Tgroup(BaseModel):
    ...
    parent_topology_group: Optional[FixedReferenceWithType] = Field(default=None, description="The `topology group` in which this `group` is a member.")
    ...
    def from_dict(cls, obj: dict) -> Tgroup:
        ...
        _obj = Tgroup.construct(_fields_set=None, **{
            ...
            "parent_topology_group": FixedReferenceWithType.from_dict(obj.get("parent_topology_group")) if obj.get("parent_topology_group") is not None else None
        })
        return _obj
