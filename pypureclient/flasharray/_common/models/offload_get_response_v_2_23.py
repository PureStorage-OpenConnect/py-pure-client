...
from pypureclient.flasharray._common.models.offload_v_2_23 import Offload
...
class OffloadGetResponse(BaseModel):
    ...
    total: Optional[conlist(Offload)] = Field(default=None, description="The aggregate value of all items after filtering. If applicable, the average value is displayed instead. If applicable, the values are displayed for each field.")
