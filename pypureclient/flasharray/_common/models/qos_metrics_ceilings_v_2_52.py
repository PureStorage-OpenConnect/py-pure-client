...
class QosMetricsCeilings(BaseModel):
    """
    QosMetricsCeilings
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QosMetricsCeilings:
        """Create an instance of QosMetricsCeilings from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> QosMetricsCeilings:
        """Create an instance of QosMetricsCeilings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QosMetricsCeilings.parse_obj(obj)

        _obj = QosMetricsCeilings.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
