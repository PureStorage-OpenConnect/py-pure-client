...
from pypureclient.flasharray._common.models.maintenance_window_v_2_51 import MaintenanceWindow


class MaintenanceWindowsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(MaintenanceWindow)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MaintenanceWindowsGetResponse:
        """Create an instance of MaintenanceWindowsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> MaintenanceWindowsGetResponse:
        """Create an instance of MaintenanceWindowsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MaintenanceWindowsGetResponse.parse_obj(obj)

        _obj = MaintenanceWindowsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [MaintenanceWindow.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
