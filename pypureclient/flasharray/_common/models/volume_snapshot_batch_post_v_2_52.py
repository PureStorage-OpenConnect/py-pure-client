...
class VolumeSnapshotBatchPost(BaseModel):
    """
    ...
    source_id: Optional[StrictStr] = Field(default=None, description="Specifies the Id of the source volume.")
    source_name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the source volume.")
    __properties = ["destroyed", "suffix", "tags", "source_id", "source_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VolumeSnapshotBatchPost:
        """Create an instance of VolumeSnapshotBatchPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VolumeSnapshotBatchPost:
        """Create an instance of VolumeSnapshotBatchPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VolumeSnapshotBatchPost.parse_obj(obj)

        _obj = VolumeSnapshotBatchPost.construct(_fields_set=None, **{
