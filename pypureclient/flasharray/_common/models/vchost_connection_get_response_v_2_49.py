...
from pypureclient.flasharray._common.models.vchost_connection_v_2_49 import VchostConnection


class VchostConnectionGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VchostConnectionGetResponse:
        """Create an instance of VchostConnectionGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VchostConnectionGetResponse:
        """Create an instance of VchostConnectionGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VchostConnectionGetResponse.parse_obj(obj)

        _obj = VchostConnectionGetResponse.construct(_fields_set=None, **{
