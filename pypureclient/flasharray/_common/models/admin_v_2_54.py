...
class Admin(BaseModel):
    ...
    __properties = ["name", "context", "admin_type", "api_token", "authorization_model", "is_local", "locked", "lockout_remaining", "management_access_policies", "password", "public_key", "role"]
