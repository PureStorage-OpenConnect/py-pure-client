...
class ResourceObjectStoreAccountSpace(BaseModel):
    """
    ...
    __properties = ["id", "name", "context", "space", "time", "object_count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceObjectStoreAccountSpace:
        """Create an instance of ResourceObjectStoreAccountSpace from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourceObjectStoreAccountSpace:
        """Create an instance of ResourceObjectStoreAccountSpace from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceObjectStoreAccountSpace.parse_obj(obj)

        _obj = ResourceObjectStoreAccountSpace.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
