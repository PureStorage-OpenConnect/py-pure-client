...
from pypureclient.flasharray._common.models.workload_placement_recommendation_target_capacity_used_projections_v_2_47 import WorkloadPlacementRecommendationTargetCapacityUsedProjections
from pypureclient.flasharray._common.models.workload_placement_recommendation_target_load_projections_v_2_47 import WorkloadPlacementRecommendationTargetLoadProjections
from pypureclient.flasharray._common.models.workload_placement_recommendation_warning_v_2_40 import WorkloadPlacementRecommendationWarning
...
class WorkloadPlacementRecommendationGenericTarget(BaseModel):
    ...
    periodic_replication_configurations: Optional[conlist(StrictStr)] = Field(default=None, description="The preset periodic replication configurations supported by the array.")
    placement_configurations: Optional[conlist(StrictStr)] = Field(default=None, description="The preset placement configurations supported by the array.")
