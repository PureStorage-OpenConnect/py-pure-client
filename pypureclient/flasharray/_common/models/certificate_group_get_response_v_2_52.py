...
from pypureclient.flasharray._common.models.certificate_group_v_2_52 import CertificateGroup


class CertificateGroupGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(CertificateGroup)] = Field(default=None, description="A list of certificate group objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificateGroupGetResponse:
        """Create an instance of CertificateGroupGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CertificateGroupGetResponse:
        """Create an instance of CertificateGroupGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CertificateGroupGetResponse.parse_obj(obj)

        _obj = CertificateGroupGetResponse.construct(_fields_set=None, **{
            ...
            "items": [CertificateGroup.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
