...
from pypureclient.flasharray._common.models.policy_quota_v_2_51 import PolicyQuota


class PolicyQuotaGetResponse(BaseModel):
    """
    PolicyQuotaGetResponse
    """
    ...
    items: Optional[conlist(PolicyQuota)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyQuotaGetResponse:
        """Create an instance of PolicyQuotaGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyQuotaGetResponse:
        """Create an instance of PolicyQuotaGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyQuotaGetResponse.parse_obj(obj)

        _obj = PolicyQuotaGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyQuota.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
