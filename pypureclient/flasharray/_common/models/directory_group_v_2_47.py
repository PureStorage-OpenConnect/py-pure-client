...
from pypureclient.flasharray._common.models.user_group_quota_limited_by_v_2_44 import UserGroupQuotaLimitedBy
from pypureclient.flasharray._common.models.user_group_space_v_2_44 import UserGroupSpace
...
class DirectoryGroup(BaseModel):
    ...
    file_system: Optional[FixedReference] = Field(default=None, description="The file system that the managed directory occupies.")
    group: Optional[UserGroup] = Field(default=None, description="A group which has content in the managed directory.")
    limited_by: Optional[UserGroupQuotaLimitedBy] = Field(default=None, description="The user-group-quota or quota policy that is limiting usage for this group in this managed directory. This policy defines the total amount of space allowed for this group or this managed directory. The returned value contains two parts&#58; the name of the policy and the managed directory to which the policy is attached.")
    path: Optional[StrictStr] = Field(default=None, description="Absolute path of the managed directory in the file system.")
    space: Optional[UserGroupSpace] = Field(default=None, description="The logical space owned by the group.")
    __properties = ["id", "name", "context", "directory_name", "file_system", "group", "limited_by", "path", "space"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryGroup:
        """Create an instance of DirectoryGroup from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryGroup:
        """Create an instance of DirectoryGroup from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryGroup.parse_obj(obj)

        _obj = DirectoryGroup.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
