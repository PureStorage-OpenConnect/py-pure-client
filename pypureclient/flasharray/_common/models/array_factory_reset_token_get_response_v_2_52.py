...
from pypureclient.flasharray._common.models.array_factory_reset_token_v_2_52 import ArrayFactoryResetToken


class ArrayFactoryResetTokenGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ArrayFactoryResetToken)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayFactoryResetTokenGetResponse:
        """Create an instance of ArrayFactoryResetTokenGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayFactoryResetTokenGetResponse:
        """Create an instance of ArrayFactoryResetTokenGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayFactoryResetTokenGetResponse.parse_obj(obj)

        _obj = ArrayFactoryResetTokenGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ArrayFactoryResetToken.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
