...
from pypureclient.flasharray._common.models.software_v_2_51 import Software


class SoftwareGetResponse(BaseModel):
    """
    SoftwareGetResponse
    """
    ...
    items: Optional[conlist(Software)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SoftwareGetResponse:
        """Create an instance of SoftwareGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SoftwareGetResponse:
        """Create an instance of SoftwareGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SoftwareGetResponse.parse_obj(obj)

        _obj = SoftwareGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Software.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
