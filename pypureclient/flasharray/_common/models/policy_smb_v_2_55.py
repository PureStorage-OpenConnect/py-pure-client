...
class PolicySmb(BaseModel):
    ...
    __properties = ["context", "id", "name", "policy_type", "realms", "destroyed", "enabled", "pod", "time_remaining", "access_based_enumeration_enabled", "continuous_availability_enabled", "policy_mapping", "workload"]
