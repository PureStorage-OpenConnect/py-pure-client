...
class PodReplicaLinkReference(BaseModel):
    """
    ...
    remotes: Optional[conlist(FixedReferenceWithType)] = Field(default=None, description="Reference to remote arrays.")
    __properties = ["id", "local_pod", "remote_pod", "remotes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PodReplicaLinkReference:
        """Create an instance of PodReplicaLinkReference from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PodReplicaLinkReference:
        """Create an instance of PodReplicaLinkReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PodReplicaLinkReference.parse_obj(obj)

        _obj = PodReplicaLinkReference.construct(_fields_set=None, **{
            "id": obj.get("id"),
