...
from pypureclient.flasharray._common.models.software_installation_step_v_2_52 import SoftwareInstallationStep


class SoftwareInstallationStepsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SoftwareInstallationStep)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SoftwareInstallationStepsGetResponse:
        """Create an instance of SoftwareInstallationStepsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SoftwareInstallationStepsGetResponse:
        """Create an instance of SoftwareInstallationStepsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SoftwareInstallationStepsGetResponse.parse_obj(obj)

        _obj = SoftwareInstallationStepsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SoftwareInstallationStep.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
