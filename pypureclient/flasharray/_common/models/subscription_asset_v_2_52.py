...
from pypureclient.flasharray._common.models.subscription_asset_subscription_v_2_52 import SubscriptionAssetSubscription
...
class SubscriptionAsset(BaseModel):
    ...
    subscription: Optional[SubscriptionAssetSubscription] = None
    __properties = ["id", "name", "subscription"]
    ...
    def from_dict(cls, obj: dict) -> SubscriptionAsset:
        ...
        _obj = SubscriptionAsset.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "subscription": SubscriptionAssetSubscription.from_dict(obj.get("subscription")) if obj.get("subscription") is not None else None
        })
        return _obj
