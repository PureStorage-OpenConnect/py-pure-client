...
from pypureclient.flasharray._common.models.replica_link_lag_v_2_52 import ReplicaLinkLag
...
class PodReplicaLinkLag(BaseModel):
    ...
    local_pod_members: Optional[conlist(FixedReferenceWithType)] = Field(default=None, description="A list of arrays or realms that are members of the local pod.")
    ...
    remotes: Optional[conlist(FixedReferenceWithType)] = Field(default=None, description="Reference to a remote array.")
    ...
    __properties = ["id", "context", "direction", "lag", "local_pod", "local_pod_members", "recovery_point", "remote_pod", "remotes", "status", "time"]
    ...
    def to_dict(self, include_readonly: bool=True) -> Dict[str, Any]:
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in local_pod_members (list)
        if _include_in_dict('local_pod_members', include_readonly, excluded_fields, none_fields):
            _items = []
            for _item in self.local_pod_members:
                if _item:
                    _items.append(_item.to_dict(include_readonly=include_readonly))
            _dict['local_pod_members'] = _items
    ...
    def from_dict(cls, obj: dict) -> PodReplicaLinkLag:
        ...
        _obj = PodReplicaLinkLag.construct(_fields_set=None, **{
            ...
            "local_pod_members": [FixedReferenceWithType.from_dict(_item) for _item in obj.get("local_pod_members")] if obj.get("local_pod_members") is not None else None,
