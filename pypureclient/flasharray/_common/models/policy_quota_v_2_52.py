...
class PolicyQuota(BaseModel):
    ...
    __properties = ["id", "name", "context", "policy_type", "destroyed", "enabled", "pod", "time_remaining", "workload"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyQuota:
        """Create an instance of PolicyQuota from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyQuota:
        """Create an instance of PolicyQuota from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyQuota.parse_obj(obj)

        _obj = PolicyQuota.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
