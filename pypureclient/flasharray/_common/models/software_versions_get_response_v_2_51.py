...
from pypureclient.flasharray._common.models.software_version_v_2_51 import SoftwareVersion


class SoftwareVersionsGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SoftwareVersionsGetResponse:
        """Create an instance of SoftwareVersionsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SoftwareVersionsGetResponse:
        """Create an instance of SoftwareVersionsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SoftwareVersionsGetResponse.parse_obj(obj)

        _obj = SoftwareVersionsGetResponse.construct(_fields_set=None, **{
