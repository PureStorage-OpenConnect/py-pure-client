...
class DirectoryServiceRole(BaseModel):
    ...
    management_access_policies: Optional[conlist(FixedReferenceWithType)] = Field(default=None, description="List of management access policies associated with the group.")
    ...
    __properties = ["name", "context", "group", "group_base", "management_access_policies", "role"]
