...
from pypureclient.flasharray._common.models.remote_protection_group_snapshot_v_2_26 import RemoteProtectionGroupSnapshot
...
class RemoteProtectionGroupSnapshotGetResponse(BaseModel):
    ...
    items: Optional[conlist(RemoteProtectionGroupSnapshot)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
