...
from pypureclient.flasharray._common.models.policy_smb_v_2_13 import PolicySmb
...
class PolicySmbGetResponse(BaseModel):
    ...
    items: Optional[conlist(PolicySmb)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
