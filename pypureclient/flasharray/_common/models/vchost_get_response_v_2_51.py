...
from pypureclient.flasharray._common.models.vchost_v_2_51 import Vchost


class VchostGetResponse(BaseModel):
    """
    VchostGetResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VchostGetResponse:
        """Create an instance of VchostGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VchostGetResponse:
        """Create an instance of VchostGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VchostGetResponse.parse_obj(obj)

        _obj = VchostGetResponse.construct(_fields_set=None, **{
