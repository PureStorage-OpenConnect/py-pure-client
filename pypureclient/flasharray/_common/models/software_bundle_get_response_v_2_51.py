...
from pypureclient.flasharray._common.models.software_bundle_v_2_51 import SoftwareBundle


class SoftwareBundleGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SoftwareBundle)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SoftwareBundleGetResponse:
        """Create an instance of SoftwareBundleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SoftwareBundleGetResponse:
        """Create an instance of SoftwareBundleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SoftwareBundleGetResponse.parse_obj(obj)

        _obj = SoftwareBundleGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SoftwareBundle.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
