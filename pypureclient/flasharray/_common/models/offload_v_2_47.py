...
from pypureclient.flasharray._common.models.offload_azure_v_2_25 import OffloadAzure
from pypureclient.flasharray._common.models.offload_google_cloud_v_2_25 import OffloadGoogleCloud
from pypureclient.flasharray._common.models.offload_nfs_v_2_25 import OffloadNfs
from pypureclient.flasharray._common.models.offload_s3_v_2_25 import OffloadS3
...
class Offload(BaseModel):
    ...
    __properties = ["azure", "google-cloud", "nfs", "s3", "name", "context", "protocol", "space", "status", "target_id"]
