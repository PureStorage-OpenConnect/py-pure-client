...
from pypureclient.flasharray._common.models.policy_rule_smb_client_v_2_3 import PolicyRuleSmbClient
...
class PolicyRuleSmbClientGetResponse(BaseModel):
    ...
    items: Optional[conlist(PolicyRuleSmbClient)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful.")
