...
class Directory(BaseModel):
    ...
    space: Optional[Space] = Field(default=None, description="Displays size and space consumption details.")
    ...
    __properties = ["id", "name", "context", "realms", "created", "destroyed", "directory_name", "file_system", "limited_by", "path", "space", "time_remaining", "workload"]
