...
class PolicyNfs(BaseModel):
    ...
    __properties = ["context", "id", "name", "policy_type", "realms", "destroyed", "enabled", "pod", "time_remaining", "nfs_version", "policy_mapping", "security", "user_mapping_enabled", "workload"]
