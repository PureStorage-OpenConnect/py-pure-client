...
from pypureclient.flasharray._common.models.cache_space_v_2_51 import CacheSpace
...
class Cache(BaseModel):
    ...
    cache_type: Optional[StrictStr] = Field(default=None, description="The cache type.")
    space: Optional[CacheSpace] = None
    status: Optional[StrictStr] = Field(default=None, description="The cache status.")
    __properties = ["id", "name", "cache_type", "space", "status"]
    ...
    def from_dict(cls, obj: dict) -> Cache:
        ...
        _obj = Cache.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "cache_type": obj.get("cache_type"),
            "space": CacheSpace.from_dict(obj.get("space")) if obj.get("space") is not None else None,
