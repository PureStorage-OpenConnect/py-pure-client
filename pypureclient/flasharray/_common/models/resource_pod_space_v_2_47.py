...
class ResourcePodSpace(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourcePodSpace:
        """Create an instance of ResourcePodSpace from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourcePodSpace:
        """Create an instance of ResourcePodSpace from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourcePodSpace.parse_obj(obj)

        _obj = ResourcePodSpace.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
