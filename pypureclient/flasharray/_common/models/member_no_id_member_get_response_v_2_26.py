...
from pypureclient.flasharray._common.models.member_no_id_member_v_2_26 import MemberNoIdMember
...
class MemberNoIdMemberGetResponse(BaseModel):
    ...
    items: Optional[conlist(MemberNoIdMember)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name, if meaningful.")
