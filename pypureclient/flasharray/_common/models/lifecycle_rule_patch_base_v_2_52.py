...
class LifecycleRulePatchBase(BaseModel):
    """
    ...
    __properties = ["abort_incomplete_multipart_uploads_after", "keep_current_version_for", "keep_current_version_until", "keep_previous_version_for", "prefix", "enabled"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LifecycleRulePatchBase:
        """Create an instance of LifecycleRulePatchBase from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LifecycleRulePatchBase:
        """Create an instance of LifecycleRulePatchBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LifecycleRulePatchBase.parse_obj(obj)

        _obj = LifecycleRulePatchBase.construct(_fields_set=None, **{
