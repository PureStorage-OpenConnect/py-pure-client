...
from pypureclient.flasharray._common.models.pod_replica_link_performance_replication_v_2_2 import PodReplicaLinkPerformanceReplication
...
class PodReplicaLinkPerformanceReplicationGetResponse(BaseModel):
    ...
    total: Optional[conlist(PodReplicaLinkPerformanceReplication)] = Field(default=None, description="The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field where meaningful.")
