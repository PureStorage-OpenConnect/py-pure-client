...
class NetworkinterfacepostEth(BaseModel):
    ...
    __properties = ["address", "preferred_arrays", "remediation_mode", "subinterfaces", "subnet", "subtype"]
