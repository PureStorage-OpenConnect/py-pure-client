...
from pypureclient.flasharray._common.models.resource_access_status_v_2_40 import ResourceAccessStatus


class ResourceAccessesStatusGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceAccessesStatusGetResponse:
        """Create an instance of ResourceAccessesStatusGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourceAccessesStatusGetResponse:
        """Create an instance of ResourceAccessesStatusGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceAccessesStatusGetResponse.parse_obj(obj)

        _obj = ResourceAccessesStatusGetResponse.construct(_fields_set=None, **{
