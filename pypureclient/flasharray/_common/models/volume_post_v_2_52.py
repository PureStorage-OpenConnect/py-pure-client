...
from pypureclient.flasharray._common.models.protocol_endpoint_v_2_52 import ProtocolEndpoint
from pypureclient.flasharray._common.models.qos_v_2_52 import Qos
...
from pypureclient.flasharray._common.models.workload_configuration_reference_post_v_2_52 import WorkloadConfigurationReferencePost
...
class VolumePost(BaseModel):
    ...
    workload: Optional[WorkloadConfigurationReferencePost] = None
    ...
    def from_dict(cls, obj: dict) -> VolumePost:
        ...
        _obj = VolumePost.construct(_fields_set=None, **{
            ...
            "workload": WorkloadConfigurationReferencePost.from_dict(obj.get("workload")) if obj.get("workload") is not None else None
        })
        return _obj
