...
from pypureclient.flasharray._common.models.override_check_v_2_2 import OverrideCheck
...
class SoftwareInstallation(BaseModel):
    ...
    override_checks: Optional[conlist(OverrideCheck)] = Field(default=None, description="A list of upgrade checks whose failure will be overridden during the upgrade. If any optional `args` are provided, they are validated later when the corresponding check script runs.")
