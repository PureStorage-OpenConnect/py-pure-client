...
from pypureclient.flasharray._common.models.network_interface_eth_v_2_55 import NetworkInterfaceEth
...
class NetworkInterface(BaseModel):
    ...
    __properties = ["context", "realms", "name", "server", "attached_servers", "enabled", "eth", "fc", "interface_type", "services", "speed"]
