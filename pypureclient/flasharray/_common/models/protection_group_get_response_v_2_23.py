...
from pypureclient.flasharray._common.models.protection_group_v_2_23 import ProtectionGroup
...
class ProtectionGroupGetResponse(BaseModel):
    ...
    total: Optional[conlist(ProtectionGroup)] = Field(default=None, description="The aggregate value of all items after filtering. If applicable, the average value is displayed instead. The values are displayed for each field, where applicable.")
