...
class TestResultWithResourceWithId(BaseModel):
    """
    ...
    __properties = ["component_address", "component_name", "description", "destination", "enabled", "result_details", "success", "test_type", "context", "resource"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultWithResourceWithId:
        """Create an instance of TestResultWithResourceWithId from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TestResultWithResourceWithId:
        """Create an instance of TestResultWithResourceWithId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultWithResourceWithId.parse_obj(obj)

        _obj = TestResultWithResourceWithId.construct(_fields_set=None, **{
