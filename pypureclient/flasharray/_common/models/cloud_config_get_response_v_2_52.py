...
from pypureclient.flasharray._common.models.cloud_config_v_2_52 import CloudConfig


class CloudConfigGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(CloudConfig)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloudConfigGetResponse:
        """Create an instance of CloudConfigGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CloudConfigGetResponse:
        """Create an instance of CloudConfigGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CloudConfigGetResponse.parse_obj(obj)

        _obj = CloudConfigGetResponse.construct(_fields_set=None, **{
            ...
            "items": [CloudConfig.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
