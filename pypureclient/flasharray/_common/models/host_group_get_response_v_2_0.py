...
from pypureclient.flasharray._common.models.host_group_v_2_0 import HostGroup
...
class HostGroupGetResponse(BaseModel):
    ...
    items: Optional[conlist(HostGroup)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful.")
