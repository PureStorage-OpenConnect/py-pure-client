...
class ResourceFixedNonUniqueName(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceFixedNonUniqueName:
        """Create an instance of ResourceFixedNonUniqueName from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourceFixedNonUniqueName:
        """Create an instance of ResourceFixedNonUniqueName from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceFixedNonUniqueName.parse_obj(obj)

        _obj = ResourceFixedNonUniqueName.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
