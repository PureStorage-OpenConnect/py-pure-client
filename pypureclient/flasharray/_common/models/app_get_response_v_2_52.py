...
from pypureclient.flasharray._common.models.app_v_2_52 import App
...
class AppGetResponse(BaseModel):
    ...
    items: Optional[conlist(App)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AppGetResponse:
        """Create an instance of AppGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AppGetResponse:
        """Create an instance of AppGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AppGetResponse.parse_obj(obj)

        _obj = AppGetResponse.construct(_fields_set=None, **{
            ...
            "items": [App.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
