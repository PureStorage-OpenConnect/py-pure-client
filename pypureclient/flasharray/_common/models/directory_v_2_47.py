...
from pypureclient.flasharray._common.models.limited_by_v_2_7 import LimitedBy
...
class Directory(BaseModel):
    ...
    __properties = ["id", "name", "context", "created", "destroyed", "directory_name", "file_system", "limited_by", "path", "space", "time_remaining"]
