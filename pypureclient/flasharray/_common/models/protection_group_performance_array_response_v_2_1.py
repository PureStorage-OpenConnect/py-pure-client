...
from pypureclient.flasharray._common.models.protection_group_performance_array_v_2_1 import ProtectionGroupPerformanceArray
...
class ProtectionGroupPerformanceArrayResponse(BaseModel):
    ...
    items: Optional[conlist(ProtectionGroupPerformanceArray)] = Field(default=None, description="List performance data, broken down by array.")
