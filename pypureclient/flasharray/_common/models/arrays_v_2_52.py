...
class Arrays(BaseModel):
    ...
    network_access_policy: Optional[ReferenceWithType] = Field(default=None, description="The network access policy for the array.")
    ...
    __properties = ["id", "name", "context", "_as_of", "banner", "capacity", "console_lock_enabled", "encryption", "eradication_config", "idle_timeout", "network_access_policy", "ntp_servers", "ntp_symmetric_key", "os", "parity", "scsi_timeout", "space", "time_zone", "version"]
    ...
    def from_dict(cls, obj: dict) -> Arrays:
        ...
        _obj = Arrays.construct(_fields_set=None, **{
            ...
            "network_access_policy": ReferenceWithType.from_dict(obj.get("network_access_policy")) if obj.get("network_access_policy") is not None else None,
