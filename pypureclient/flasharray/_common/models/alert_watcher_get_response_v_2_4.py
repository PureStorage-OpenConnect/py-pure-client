...
from pypureclient.flasharray._common.models.alert_watcher_v_2_4 import AlertWatcher


class AlertWatcherGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(AlertWatcher)] = Field(default=None, description="A list of alert watcher objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertWatcherGetResponse:
        """Create an instance of AlertWatcherGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AlertWatcherGetResponse:
        """Create an instance of AlertWatcherGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlertWatcherGetResponse.parse_obj(obj)

        _obj = AlertWatcherGetResponse.construct(_fields_set=None, **{
            ...
            "items": [AlertWatcher.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
