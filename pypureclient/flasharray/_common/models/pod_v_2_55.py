...
from pypureclient.flasharray._common.models.pod_array_status_v_2_54 import PodArrayStatus
from pypureclient.flasharray._common.models.pod_space_v_2_50 import PodSpace
...
class Pod(BaseModel):
    ...
    mediator: Optional[StrictStr] = Field(default=None, description="The URL of the mediator for the pod. By default, the Pure1 Cloud Mediator (`purestorage`) serves as the mediator. For a pod in a stretched realm, the realm mediator takes precedence over the mediator of the pod.")
