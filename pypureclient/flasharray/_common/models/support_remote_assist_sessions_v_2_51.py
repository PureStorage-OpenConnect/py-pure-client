...
from pypureclient.flasharray._common.models.support_remote_assist_sessions_paths_v_2_51 import SupportRemoteAssistSessionsPaths
...
class SupportRemoteAssistSessions(BaseModel):
    ...
    paths: Optional[conlist(SupportRemoteAssistSessionsPaths)] = None
    ...
    __properties = ["access_level", "active", "duration", "expires", "opened", "paths", "status"]
    ...
    def to_dict(self, include_readonly: bool=True) -> Dict[str, Any]:
        ...
        if _include_in_dict('paths', include_readonly, excluded_fields, none_fields):
            _items = []
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupportRemoteAssistSessions:
        """Create an instance of SupportRemoteAssistSessions from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SupportRemoteAssistSessions:
        """Create an instance of SupportRemoteAssistSessions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupportRemoteAssistSessions.parse_obj(obj)

        _obj = SupportRemoteAssistSessions.construct(_fields_set=None, **{
            "access_level": obj.get("access_level"),
            "active": obj.get("active"),
            "duration": obj.get("duration"),
            "expires": obj.get("expires"),
            "opened": obj.get("opened"),
            "paths": [SupportRemoteAssistSessionsPaths.from_dict(_item) for _item in obj.get("paths")] if obj.get("paths") is not None else None,
