...
class PolicySmb(BaseModel):
    ...
    __properties = ["id", "name", "context", "destroyed", "enabled", "pod", "policy_type", "time_remaining", "access_based_enumeration_enabled", "continuous_availability_enabled", "policy_mapping"]
