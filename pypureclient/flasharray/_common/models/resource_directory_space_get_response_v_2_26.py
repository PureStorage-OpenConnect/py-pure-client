...
from pypureclient.flasharray._common.models.resource_directory_space_v_2_26 import ResourceDirectorySpace
...
class ResourceDirectorySpaceGetResponse(BaseModel):
    ...
    items: Optional[conlist(ResourceDirectorySpace)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name. If `total_only=true`, the `items` list will be empty.")
