...
class PolicyRuleObjectStoreAccessNested(BaseModel):
    """
    PolicyRuleObjectStoreAccessNested
    """
    ...
    __properties = ["name", "actions", "effect", "policy", "resources"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleObjectStoreAccessNested:
        """Create an instance of PolicyRuleObjectStoreAccessNested from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleObjectStoreAccessNested:
        """Create an instance of PolicyRuleObjectStoreAccessNested from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleObjectStoreAccessNested.parse_obj(obj)

        _obj = PolicyRuleObjectStoreAccessNested.construct(_fields_set=None, **{
            "name": obj.get("name"),
