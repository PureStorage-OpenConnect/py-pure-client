...
class LimitedBy(BaseModel):
    """
    LimitedBy
    """
    member: Optional[FixedReferenceWithType] = Field(default=None, description="Reference to the resource to which the effective quota policy is attached.")
    policy: Optional[FixedReferenceWithType] = Field(default=None, description="Reference to the effective quota policy.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LimitedBy:
        """Create an instance of LimitedBy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LimitedBy:
        """Create an instance of LimitedBy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LimitedBy.parse_obj(obj)

        _obj = LimitedBy.construct(_fields_set=None, **{
