...
from pypureclient.flasharray._common.models.support_diagnostics_settings_v_2_36 import SupportDiagnosticsSettings


class SupportDiagnosticsGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupportDiagnosticsGetResponse:
        """Create an instance of SupportDiagnosticsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SupportDiagnosticsGetResponse:
        """Create an instance of SupportDiagnosticsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupportDiagnosticsGetResponse.parse_obj(obj)

        _obj = SupportDiagnosticsGetResponse.construct(_fields_set=None, **{
