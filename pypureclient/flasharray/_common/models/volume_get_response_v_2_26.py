...
from pypureclient.flasharray._common.models.volume_v_2_26 import Volume
...
class VolumeGetResponse(BaseModel):
    ...
    total: Optional[conlist(Volume)] = Field(default=None, description="The aggregate value of all items after filtering. If applicable, the average value is displayed instead. The values are displayed for each field, if meaningful.")
