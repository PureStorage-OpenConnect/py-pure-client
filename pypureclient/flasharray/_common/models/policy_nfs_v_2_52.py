...
from pypureclient.flasharray._common.models.policy_nfs_policy_mapping_v_2_52 import PolicyNfsPolicyMapping
...
class PolicyNfs(BaseModel):
    ...
    __properties = ["context", "id", "name", "policy_type", "destroyed", "enabled", "pod", "time_remaining", "nfs_version", "policy_mapping", "security", "user_mapping_enabled", "workload"]
    ...
    def to_dict(self, include_readonly: bool=True) -> Dict[str, Any]:
        ...
        if _include_in_dict('policy_mapping', include_readonly, excluded_fields, none_fields):
            _dict['policy_mapping'] = self.policy_mapping.to_dict(include_readonly=include_readonly)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyNfs:
        """Create an instance of PolicyNfs from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyNfs:
        """Create an instance of PolicyNfs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyNfs.parse_obj(obj)

        _obj = PolicyNfs.construct(_fields_set=None, **{
            ...
            "policy_mapping": PolicyNfsPolicyMapping.from_dict(obj.get("policy_mapping")) if obj.get("policy_mapping") is not None else None,
