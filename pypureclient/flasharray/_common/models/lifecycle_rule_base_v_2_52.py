...
class LifecycleRuleBase(BaseModel):
    ...
    __properties = ["context", "abort_incomplete_multipart_uploads_after", "keep_current_version_for", "keep_current_version_until", "keep_previous_version_for", "prefix", "bucket", "cleanup_expired_object_delete_marker", "enabled", "rule_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LifecycleRuleBase:
        """Create an instance of LifecycleRuleBase from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LifecycleRuleBase:
        """Create an instance of LifecycleRuleBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LifecycleRuleBase.parse_obj(obj)

        _obj = LifecycleRuleBase.construct(_fields_set=None, **{
