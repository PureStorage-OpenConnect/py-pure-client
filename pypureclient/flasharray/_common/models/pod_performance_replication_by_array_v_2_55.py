...
class PodPerformanceReplicationByArray(BaseModel):
    ...
    __properties = ["context", "continuous_bytes_per_sec", "periodic_bytes_per_sec", "resync_bytes_per_sec", "sync_bytes_per_sec", "time", "total_bytes_per_sec", "pod", "array", "member"]
