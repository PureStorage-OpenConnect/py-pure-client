...
class VolumeQosGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VolumeQosGetResponse:
        """Create an instance of VolumeQosGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VolumeQosGetResponse:
        """Create an instance of VolumeQosGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VolumeQosGetResponse.parse_obj(obj)

        _obj = VolumeQosGetResponse.construct(_fields_set=None, **{
