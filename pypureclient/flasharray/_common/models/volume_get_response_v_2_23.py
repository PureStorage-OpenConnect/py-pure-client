...
from pypureclient.flasharray._common.models.volume_v_2_23 import Volume
...
class VolumeGetResponse(BaseModel):
    ...
    items: Optional[conlist(Volume)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if applicable. If `total_only=true`, the `items` list is empty.")
