...
from pypureclient.flasharray._common.models.app_node_v_2_51 import AppNode


class AppNodeGetResponse(BaseModel):
    """
    AppNodeGetResponse
    """
    ...
    items: Optional[conlist(AppNode)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AppNodeGetResponse:
        """Create an instance of AppNodeGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AppNodeGetResponse:
        """Create an instance of AppNodeGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AppNodeGetResponse.parse_obj(obj)

        _obj = AppNodeGetResponse.construct(_fields_set=None, **{
            ...
            "items": [AppNode.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
