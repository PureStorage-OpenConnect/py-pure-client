...
from pypureclient.flasharray._common.models.cloud_config_supported_v_2_40 import CloudConfigSupported


class CloudConfigSupportedConfigsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(CloudConfigSupported)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloudConfigSupportedConfigsGetResponse:
        """Create an instance of CloudConfigSupportedConfigsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CloudConfigSupportedConfigsGetResponse:
        """Create an instance of CloudConfigSupportedConfigsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CloudConfigSupportedConfigsGetResponse.parse_obj(obj)

        _obj = CloudConfigSupportedConfigsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [CloudConfigSupported.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
