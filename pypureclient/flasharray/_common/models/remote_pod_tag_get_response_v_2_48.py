...
from pypureclient.flasharray._common.models.stretched_tag_v_2_48 import StretchedTag
...
class RemotePodTagGetResponse(BaseModel):
    ...
    items: Optional[conlist(StretchedTag)] = None
    ...
    def from_dict(cls, obj: dict) -> RemotePodTagGetResponse:
        ...
        _obj = RemotePodTagGetResponse.construct(_fields_set=None, **{
            ...
            "items": [StretchedTag.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
