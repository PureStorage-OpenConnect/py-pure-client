...
from pypureclient.flasharray._common.models.realm_connection_v_2_52 import RealmConnection


class RealmConnectionsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(RealmConnection)] = Field(default=None, description="A list of realm connection objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RealmConnectionsGetResponse:
        """Create an instance of RealmConnectionsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RealmConnectionsGetResponse:
        """Create an instance of RealmConnectionsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RealmConnectionsGetResponse.parse_obj(obj)

        _obj = RealmConnectionsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [RealmConnection.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
