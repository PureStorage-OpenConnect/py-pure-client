...
from pypureclient.flasharray._common.models.network_interfaces_port_details_v_2_52 import NetworkInterfacesPortDetails


class NetworkInterfacesPortDetailsGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkInterfacesPortDetailsGetResponse:
        """Create an instance of NetworkInterfacesPortDetailsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkInterfacesPortDetailsGetResponse:
        """Create an instance of NetworkInterfacesPortDetailsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkInterfacesPortDetailsGetResponse.parse_obj(obj)

        _obj = NetworkInterfacesPortDetailsGetResponse.construct(_fields_set=None, **{
