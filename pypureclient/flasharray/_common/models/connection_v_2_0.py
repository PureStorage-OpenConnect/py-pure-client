...
class Connection(BaseModel):
    ...
    Connection
    """
    host: Optional[FixedReferenceNoId] = Field(default=None, description="The host computer that sends and receives I/O requests to and from volumes on the FlashArray array.")
    host_group: Optional[FixedReferenceNoId] = Field(default=None, description="A virtual collection of hosts with common connectivity to volumes.")
    ...
    def from_dict(cls, obj: dict) -> Connection:
        ...
        _obj = Connection.construct(_fields_set=None, **{
            "host": FixedReferenceNoId.from_dict(obj.get("host")) if obj.get("host") is not None else None,
            "host_group": FixedReferenceNoId.from_dict(obj.get("host_group")) if obj.get("host_group") is not None else None,
            "lun": obj.get("lun"),
