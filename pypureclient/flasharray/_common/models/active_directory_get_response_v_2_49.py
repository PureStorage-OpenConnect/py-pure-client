...
from pypureclient.flasharray._common.models.active_directory_v_2_49 import ActiveDirectory


class ActiveDirectoryGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActiveDirectoryGetResponse:
        """Create an instance of ActiveDirectoryGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ActiveDirectoryGetResponse:
        """Create an instance of ActiveDirectoryGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActiveDirectoryGetResponse.parse_obj(obj)

        _obj = ActiveDirectoryGetResponse.construct(_fields_set=None, **{
