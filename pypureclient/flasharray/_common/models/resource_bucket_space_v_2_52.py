...
class ResourceBucketSpace(BaseModel):
    """
    ResourceBucketSpace
    """
    ...
    __properties = ["id", "name", "context", "space", "time", "account", "object_count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceBucketSpace:
        """Create an instance of ResourceBucketSpace from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourceBucketSpace:
        """Create an instance of ResourceBucketSpace from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceBucketSpace.parse_obj(obj)

        _obj = ResourceBucketSpace.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
