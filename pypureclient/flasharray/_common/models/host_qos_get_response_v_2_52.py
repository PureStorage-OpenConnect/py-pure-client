...
class HostQosGetResponse(BaseModel):
    """
    HostQosGetResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HostQosGetResponse:
        """Create an instance of HostQosGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> HostQosGetResponse:
        """Create an instance of HostQosGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HostQosGetResponse.parse_obj(obj)

        _obj = HostQosGetResponse.construct(_fields_set=None, **{
