...
class PolicyMemberClean(BaseModel):
    """
    PolicyMemberClean
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyMemberClean:
        """Create an instance of PolicyMemberClean from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyMemberClean:
        """Create an instance of PolicyMemberClean from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyMemberClean.parse_obj(obj)

        _obj = PolicyMemberClean.construct(_fields_set=None, **{
