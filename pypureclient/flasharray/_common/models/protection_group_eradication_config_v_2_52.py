...
class ProtectionGroupEradicationConfig(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProtectionGroupEradicationConfig:
        """Create an instance of ProtectionGroupEradicationConfig from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ProtectionGroupEradicationConfig:
        """Create an instance of ProtectionGroupEradicationConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProtectionGroupEradicationConfig.parse_obj(obj)

        _obj = ProtectionGroupEradicationConfig.construct(_fields_set=None, **{
