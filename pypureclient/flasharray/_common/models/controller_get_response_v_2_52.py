...
from pypureclient.flasharray._common.models.controller_v_2_52 import Controller
...
class ControllerGetResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ControllerGetResponse:
        """Create an instance of ControllerGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ControllerGetResponse:
        """Create an instance of ControllerGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ControllerGetResponse.parse_obj(obj)

        _obj = ControllerGetResponse.construct(_fields_set=None, **{
