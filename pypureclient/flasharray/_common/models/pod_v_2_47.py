...
from pypureclient.flasharray._common.models.container_eradication_config_v_2_36 import ContainerEradicationConfig
...
from pypureclient.flasharray._common.models.pod_array_status_v_2_36 import PodArrayStatus
from pypureclient.flasharray._common.models.pod_space_v_2_34 import PodSpace
...
class Pod(BaseModel):
    ...
    quota_limit: Optional[conint(strict=True, le=4503599627370496, ge=1048576)] = Field(default=None, description="The logical quota limit of the pod, measured in bytes.")
