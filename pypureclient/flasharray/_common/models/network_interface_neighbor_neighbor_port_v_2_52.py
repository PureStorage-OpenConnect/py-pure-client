...
from pypureclient.flasharray._common.models.network_interface_neighbor_neighbor_port_id_v_2_52 import NetworkInterfaceNeighborNeighborPortId
...
class NetworkInterfaceNeighborNeighborPort(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkInterfaceNeighborNeighborPort:
        """Create an instance of NetworkInterfaceNeighborNeighborPort from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkInterfaceNeighborNeighborPort:
        """Create an instance of NetworkInterfaceNeighborNeighborPort from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkInterfaceNeighborNeighborPort.parse_obj(obj)

        _obj = NetworkInterfaceNeighborNeighborPort.construct(_fields_set=None, **{
            "description": obj.get("description"),
            "id": NetworkInterfaceNeighborNeighborPortId.from_dict(obj.get("id")) if obj.get("id") is not None else None
        })
        return _obj
