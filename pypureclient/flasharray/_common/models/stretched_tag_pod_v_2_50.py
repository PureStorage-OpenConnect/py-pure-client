...
class StretchedTagPod(BaseModel):
    """
    StretchedTagPod
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StretchedTagPod:
        """Create an instance of StretchedTagPod from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> StretchedTagPod:
        """Create an instance of StretchedTagPod from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StretchedTagPod.parse_obj(obj)

        _obj = StretchedTagPod.construct(_fields_set=None, **{
