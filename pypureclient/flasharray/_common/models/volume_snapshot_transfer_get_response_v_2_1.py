...
from pypureclient.flasharray._common.models.volume_snapshot_transfer_v_2_1 import VolumeSnapshotTransfer
...
class VolumeSnapshotTransferGetResponse(BaseModel):
    ...
    items: Optional[conlist(VolumeSnapshotTransfer)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful. If `total_only=true`, the `items` list will be empty.")
