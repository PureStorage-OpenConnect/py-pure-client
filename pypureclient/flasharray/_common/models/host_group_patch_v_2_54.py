...
from pypureclient.flasharray._common.models.container_qos_ceilings_patch_v_2_54 import ContainerQosCeilingsPatch
...
class HostGroupPatch(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HostGroupPatch:
        """Create an instance of HostGroupPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> HostGroupPatch:
        """Create an instance of HostGroupPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HostGroupPatch.parse_obj(obj)
