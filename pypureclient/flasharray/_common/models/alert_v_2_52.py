...
class Alert(BaseModel):
    ...
    __properties = ["id", "name", "context", "action", "actual", "category", "closed", "code", "component_name", "component_type", "created", "description", "duration", "expected", "flagged", "issue", "knowledge_base_url", "notified", "severity", "state", "summary", "updated"]
