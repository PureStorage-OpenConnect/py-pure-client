...
class ResourcePerformanceByArray(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourcePerformanceByArray:
        """Create an instance of ResourcePerformanceByArray from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourcePerformanceByArray:
        """Create an instance of ResourcePerformanceByArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourcePerformanceByArray.parse_obj(obj)

        _obj = ResourcePerformanceByArray.construct(_fields_set=None, **{
