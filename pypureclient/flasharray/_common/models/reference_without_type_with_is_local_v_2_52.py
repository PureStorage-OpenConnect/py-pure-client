...
class ReferenceWithoutTypeWithIsLocal(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceWithoutTypeWithIsLocal:
        """Create an instance of ReferenceWithoutTypeWithIsLocal from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceWithoutTypeWithIsLocal:
        """Create an instance of ReferenceWithoutTypeWithIsLocal from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReferenceWithoutTypeWithIsLocal.parse_obj(obj)

        _obj = ReferenceWithoutTypeWithIsLocal.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
