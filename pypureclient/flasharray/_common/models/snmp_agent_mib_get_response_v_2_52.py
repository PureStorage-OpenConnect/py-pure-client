...
from pypureclient.flasharray._common.models.snmp_agent_mib_v_2_4 import SnmpAgentMib


class SnmpAgentMibGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SnmpAgentMib)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnmpAgentMibGetResponse:
        """Create an instance of SnmpAgentMibGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SnmpAgentMibGetResponse:
        """Create an instance of SnmpAgentMibGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnmpAgentMibGetResponse.parse_obj(obj)

        _obj = SnmpAgentMibGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SnmpAgentMib.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
