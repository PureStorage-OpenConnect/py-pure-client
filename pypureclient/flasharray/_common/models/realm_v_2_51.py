...
try:
    from pydantic.v1 import BaseModel, Field, StrictBool, StrictInt, StrictStr, conint
...
from pypureclient.flasharray._common.models.container_qos_v_2_51 import ContainerQos
...
class Realm(BaseModel):
    ...
    __properties = ["id", "name", "context", "created", "destroyed", "eradication_config", "qos", "quota_limit", "space", "time_remaining"]
