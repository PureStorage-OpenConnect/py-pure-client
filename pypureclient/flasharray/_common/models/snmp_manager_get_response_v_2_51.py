...
from pypureclient.flasharray._common.models.snmp_manager_v_2_51 import SnmpManager


class SnmpManagerGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SnmpManager)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnmpManagerGetResponse:
        """Create an instance of SnmpManagerGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SnmpManagerGetResponse:
        """Create an instance of SnmpManagerGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnmpManagerGetResponse.parse_obj(obj)

        _obj = SnmpManagerGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SnmpManager.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
