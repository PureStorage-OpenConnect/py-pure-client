...
from pypureclient.flasharray._common.models.kmip_test_result_v_2_52 import KmipTestResult


class KmipTestResultGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(KmipTestResult)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> KmipTestResultGetResponse:
        """Create an instance of KmipTestResultGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> KmipTestResultGetResponse:
        """Create an instance of KmipTestResultGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return KmipTestResultGetResponse.parse_obj(obj)

        _obj = KmipTestResultGetResponse.construct(_fields_set=None, **{
            ...
            "items": [KmipTestResult.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
