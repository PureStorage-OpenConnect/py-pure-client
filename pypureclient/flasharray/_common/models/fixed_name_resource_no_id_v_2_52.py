...
class FixedNameResourceNoId(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixedNameResourceNoId:
        """Create an instance of FixedNameResourceNoId from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FixedNameResourceNoId:
        """Create an instance of FixedNameResourceNoId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FixedNameResourceNoId.parse_obj(obj)

        _obj = FixedNameResourceNoId.construct(_fields_set=None, **{
            "name": obj.get("name")
        })
        return _obj
