...
class CloudProviderTagGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(CloudProviderTag)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloudProviderTagGetResponse:
        """Create an instance of CloudProviderTagGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CloudProviderTagGetResponse:
        """Create an instance of CloudProviderTagGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CloudProviderTagGetResponse.parse_obj(obj)

        _obj = CloudProviderTagGetResponse.construct(_fields_set=None, **{
            ...
            "items": [CloudProviderTag.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
