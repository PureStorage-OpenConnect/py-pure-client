...
from pypureclient.flasharray._common.models.resource_directory_space_v_2_23 import ResourceDirectorySpace
...
class ResourceDirectorySpaceGetResponse(BaseModel):
    ...
    total: Optional[conlist(ResourceDirectorySpace)] = Field(default=None, description="The aggregate value of all items after filtering. If applicable, the average value is displayed instead. If applicable, the values are displayed for each field.")
