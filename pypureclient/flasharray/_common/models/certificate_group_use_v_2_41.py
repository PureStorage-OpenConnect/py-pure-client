...
class CertificateGroupUse(BaseModel):
    ...
    use: Optional[FixedReferenceWithType] = Field(default=None, description="A reference to an object using this certificate group.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificateGroupUse:
        """Create an instance of CertificateGroupUse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CertificateGroupUse:
        """Create an instance of CertificateGroupUse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CertificateGroupUse.parse_obj(obj)

        _obj = CertificateGroupUse.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "use": FixedReferenceWithType.from_dict(obj.get("use")) if obj.get("use") is not None else None
        })
        return _obj
