...
from pypureclient.flasharray._common.models.workload_configuration_reference_v_2_55 import WorkloadConfigurationReference
...
class FileSystem(BaseModel):
    ...
    pod: Optional[Reference] = Field(default=None, description="The reference to the pod this file systems belongs to, or `null` if it is not in a pod.")
    ...
    __properties = ["id", "name", "context", "realms", "created", "destroyed", "eradication_config", "pod", "time_remaining", "workload"]
