...
class RealmMember(BaseModel):
    ...
    member: Optional[ReferenceWithFixedType] = None
    realm: Optional[ReferenceWithFixedType] = None
    __properties = ["context", "member", "realm"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RealmMember:
        """Create an instance of RealmMember from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RealmMember:
        """Create an instance of RealmMember from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RealmMember.parse_obj(obj)

        _obj = RealmMember.construct(_fields_set=None, **{
            ...
            "realm": ReferenceWithFixedType.from_dict(obj.get("realm")) if obj.get("realm") is not None else None
        })
        return _obj
