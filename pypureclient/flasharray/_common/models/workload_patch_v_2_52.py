...
class WorkloadPatch(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkloadPatch:
        """Create an instance of WorkloadPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> WorkloadPatch:
        """Create an instance of WorkloadPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkloadPatch.parse_obj(obj)

        _obj = WorkloadPatch.construct(_fields_set=None, **{
