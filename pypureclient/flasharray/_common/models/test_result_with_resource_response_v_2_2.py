...
class TestResultWithResourceResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultWithResourceResponse:
        """Create an instance of TestResultWithResourceResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TestResultWithResourceResponse:
        """Create an instance of TestResultWithResourceResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultWithResourceResponse.parse_obj(obj)

        _obj = TestResultWithResourceResponse.construct(_fields_set=None, **{
