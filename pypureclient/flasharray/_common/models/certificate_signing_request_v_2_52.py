...
class CertificateSigningRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificateSigningRequest:
        """Create an instance of CertificateSigningRequest from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CertificateSigningRequest:
        """Create an instance of CertificateSigningRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CertificateSigningRequest.parse_obj(obj)

        _obj = CertificateSigningRequest.construct(_fields_set=None, **{
            "certificate_signing_request": obj.get("certificate_signing_request")
        })
        return _obj
