...
from pypureclient.flasharray._common.models.member_no_id_all_v_2_0 import MemberNoIdAll
...
class MemberNoIdAllGetResponse(BaseModel):
    ...
    items: Optional[conlist(MemberNoIdAll)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful.")
    __properties = ["more_items_remaining", "total_item_count", "items"]
