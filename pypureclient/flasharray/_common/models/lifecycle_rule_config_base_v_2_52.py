...
class LifecycleRuleConfigBase(BaseModel):
    """
    ...
    __properties = ["abort_incomplete_multipart_uploads_after", "keep_current_version_for", "keep_current_version_until", "keep_previous_version_for", "prefix"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LifecycleRuleConfigBase:
        """Create an instance of LifecycleRuleConfigBase from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LifecycleRuleConfigBase:
        """Create an instance of LifecycleRuleConfigBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LifecycleRuleConfigBase.parse_obj(obj)

        _obj = LifecycleRuleConfigBase.construct(_fields_set=None, **{
