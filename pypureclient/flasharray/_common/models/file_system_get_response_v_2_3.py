...
from pypureclient.flasharray._common.models.file_system_v_2_3 import FileSystem
...
class FileSystemGetResponse(BaseModel):
    ...
    items: Optional[conlist(FileSystem)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name if meaningful.")
