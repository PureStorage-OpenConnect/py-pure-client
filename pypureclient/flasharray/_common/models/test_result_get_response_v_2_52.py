...
from pypureclient.flasharray._common.models.test_result_v_2_52 import TestResult


class TestResultGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(TestResult)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultGetResponse:
        """Create an instance of TestResultGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TestResultGetResponse:
        """Create an instance of TestResultGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultGetResponse.parse_obj(obj)

        _obj = TestResultGetResponse.construct(_fields_set=None, **{
            ...
            "items": [TestResult.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
