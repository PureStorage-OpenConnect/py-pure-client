...
class SubscriptionAssetSubscription(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionAssetSubscription:
        """Create an instance of SubscriptionAssetSubscription from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionAssetSubscription:
        """Create an instance of SubscriptionAssetSubscription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionAssetSubscription.parse_obj(obj)

        _obj = SubscriptionAssetSubscription.construct(_fields_set=None, **{
            "id": obj.get("id")
        })
        return _obj
