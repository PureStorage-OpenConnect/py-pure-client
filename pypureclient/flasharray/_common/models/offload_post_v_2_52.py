...
from pypureclient.flasharray._common.models.offload_azure_v_2_52 import OffloadAzure
from pypureclient.flasharray._common.models.offload_google_cloud_v_2_52 import OffloadGoogleCloud
from pypureclient.flasharray._common.models.offload_nfs_v_2_52 import OffloadNfs
from pypureclient.flasharray._common.models.offload_s3_v_2_52 import OffloadS3
...
class OffloadPost(BaseModel):
    ...
    __properties = ["azure", "google-cloud", "nfs", "s3"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OffloadPost:
        """Create an instance of OffloadPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> OffloadPost:
        """Create an instance of OffloadPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OffloadPost.parse_obj(obj)

        _obj = OffloadPost.construct(_fields_set=None, **{
