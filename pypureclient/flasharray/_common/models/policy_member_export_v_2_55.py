...
class PolicyMemberExport(BaseModel):
    """
    PolicyMemberExport
    """
    ...
    member: Optional[FixedReferenceWithType] = Field(default=None, description="The reference to the resource targeted by the policy.")
    policy: Optional[FixedReferenceWithType] = Field(default=None, description="The reference to the policy.")
    ...
    __properties = ["context", "realms", "member", "policy", "destroyed", "enabled", "time_remaining", "export_name", "status", "server"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyMemberExport:
        """Create an instance of PolicyMemberExport from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyMemberExport:
        """Create an instance of PolicyMemberExport from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyMemberExport.parse_obj(obj)

        _obj = PolicyMemberExport.construct(_fields_set=None, **{
