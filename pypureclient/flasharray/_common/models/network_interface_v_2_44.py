...
from pypureclient.flasharray._common.models.network_interface_eth_v_2_4 import NetworkInterfaceEth
from pypureclient.flasharray._common.models.network_interface_fc_v_2_4 import NetworkInterfaceFc
...
class NetworkInterface(BaseModel):
    ...
    attached_servers: Optional[conlist(FixedReferenceWithType, max_items=1)] = Field(default=None, description="List of servers associated with the specified network interface for data ingress.")
    ...
    __properties = ["name", "attached_servers", "enabled", "eth", "fc", "interface_type", "services", "speed"]
    ...
    def to_dict(self, include_readonly: bool=True) -> Dict[str, Any]:
        ...
        if _include_in_dict('fc', include_readonly, excluded_fields, none_fields):
            _dict['fc'] = self.fc.to_dict(include_readonly=include_readonly)
        return _dict
    ...
    def from_dict(cls, obj: dict) -> NetworkInterface:
        ...
        _obj = NetworkInterface.construct(_fields_set=None, **{
            "name": obj.get("name"),
            "attached_servers": [FixedReferenceWithType.from_dict(_item) for _item in obj.get("attached_servers")] if obj.get("attached_servers") is not None else None,
            "enabled": obj.get("enabled"),
            "eth": NetworkInterfaceEth.from_dict(obj.get("eth")) if obj.get("eth") is not None else None,
            "fc": NetworkInterfaceFc.from_dict(obj.get("fc")) if obj.get("fc") is not None else None,
