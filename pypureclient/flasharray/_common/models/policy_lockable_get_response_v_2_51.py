...
from pypureclient.flasharray._common.models.policy_lockable_v_2_51 import PolicyLockable


class PolicyLockableGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyLockableGetResponse:
        """Create an instance of PolicyLockableGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyLockableGetResponse:
        """Create an instance of PolicyLockableGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyLockableGetResponse.parse_obj(obj)

        _obj = PolicyLockableGetResponse.construct(_fields_set=None, **{
