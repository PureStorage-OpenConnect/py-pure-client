...
from pypureclient.flasharray._common.models.remote_pod_v_2_1 import RemotePod
...
class RemotePodsResponse(BaseModel):
    ...
    items: Optional[conlist(RemotePod)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful.")
