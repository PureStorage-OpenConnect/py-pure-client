...
from pypureclient.flasharray._common.models.policy_v_2_3 import Policy
...
class PolicyGetResponse(BaseModel):
    ...
    items: Optional[conlist(Policy)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name if meaningful.")
