...
from pypureclient.flasharray._common.models.chap_v_2_51 import Chap
from pypureclient.flasharray._common.models.container_qos_ceilings_v_2_51 import ContainerQosCeilings
from pypureclient.flasharray._common.models.fixed_reference_with_type_v_2_51 import FixedReferenceWithType
from pypureclient.flasharray._common.models.host_port_connectivity_v_2_51 import HostPortConnectivity
...
class Host(BaseModel):
    ...
    qos: Optional[ContainerQosCeilings] = Field(default=None, description="Displays QoS limit information.")
    ...
    __properties = ["name", "context", "chap", "connection_count", "destroyed", "host_group", "iqns", "is_local", "nqns", "personality", "port_connectivity", "preferred_arrays", "qos", "space", "time_remaining", "vlan", "wwns"]
