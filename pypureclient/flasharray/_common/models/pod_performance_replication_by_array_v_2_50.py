...
from pypureclient.flasharray._common.models.replication_performance_with_total_v_2_2 import ReplicationPerformanceWithTotal
...
class PodPerformanceReplicationByArray(BaseModel):
    ...
    member: Optional[FixedReferenceWithType] = Field(default=None, description="The member that shares this pod.")
    __properties = ["context", "continuous_bytes_per_sec", "periodic_bytes_per_sec", "pod", "resync_bytes_per_sec", "sync_bytes_per_sec", "time", "total_bytes_per_sec", "array", "member"]
