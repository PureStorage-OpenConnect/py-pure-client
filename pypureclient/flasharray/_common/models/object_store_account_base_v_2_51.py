...
class ObjectStoreAccountBase(BaseModel):
    """
    ...
    created: Optional[StrictInt] = Field(default=None, description="The object store account creation time in milliseconds since the UNIX epoch.")
    object_count: Optional[StrictInt] = Field(default=None, description="The count of objects within the account.")
    __properties = ["context", "created", "object_count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreAccountBase:
        """Create an instance of ObjectStoreAccountBase from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreAccountBase:
        """Create an instance of ObjectStoreAccountBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreAccountBase.parse_obj(obj)

        _obj = ObjectStoreAccountBase.construct(_fields_set=None, **{
