...
class PolicynfspostPolicyMapping(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicynfspostPolicyMapping:
        """Create an instance of PolicynfspostPolicyMapping from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicynfspostPolicyMapping:
        """Create an instance of PolicynfspostPolicyMapping from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicynfspostPolicyMapping.parse_obj(obj)

        _obj = PolicynfspostPolicyMapping.construct(_fields_set=None, **{
