...
class RemoteArrayFleet(BaseModel):
    """
    RemoteArrayFleet
    """
    ...
    is_local: Optional[StrictBool] = Field(default=None, description="If set to `true`, the current array is a member of the fleet.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoteArrayFleet:
        """Create an instance of RemoteArrayFleet from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RemoteArrayFleet:
        """Create an instance of RemoteArrayFleet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoteArrayFleet.parse_obj(obj)

        _obj = RemoteArrayFleet.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
