...
class PolicyMemberBase(BaseModel):
    """
    PolicyMemberBase
    """
    ...
    __properties = ["context", "member", "policy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyMemberBase:
        """Create an instance of PolicyMemberBase from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyMemberBase:
        """Create an instance of PolicyMemberBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyMemberBase.parse_obj(obj)

        _obj = PolicyMemberBase.construct(_fields_set=None, **{
