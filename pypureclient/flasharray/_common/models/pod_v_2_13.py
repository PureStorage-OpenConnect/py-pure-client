...
from pypureclient.flasharray._common.models.pod_array_status_v_2_1 import PodArrayStatus
from pypureclient.flasharray._common.models.pod_eradication_config_v_2_13 import PodEradicationConfig
...
class Pod(BaseModel):
    ...
    array_count: Optional[StrictInt] = Field(default=None, description="Number of arrays to which this pod connects.")
    ...
    link_source_count: Optional[StrictInt] = Field(default=None, description="Number of source pods that link to the pod.")
    link_target_count: Optional[StrictInt] = Field(default=None, description="Number of target pods that link to the pod.")
    ...
    space: Optional[Dict[str, Any]] = Field(default=None, description="Displays provisioned size and physical storage consumption information for the sum of all volumes connected to the specified host.")
    ...
    __properties = ["id", "name", "array_count", "arrays", "destroyed", "eradication_config", "failover_preferences", "footprint", "link_source_count", "link_target_count", "mediator", "mediator_version", "promotion_status", "requested_promotion_state", "source", "space", "time_remaining"]
