...
class SupportDiagnosticsSettings(BaseModel):
    ...
    __properties = ["last_updated", "version"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupportDiagnosticsSettings:
        """Create an instance of SupportDiagnosticsSettings from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SupportDiagnosticsSettings:
        """Create an instance of SupportDiagnosticsSettings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupportDiagnosticsSettings.parse_obj(obj)

        _obj = SupportDiagnosticsSettings.construct(_fields_set=None, **{
