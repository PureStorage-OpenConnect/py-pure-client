...
from pypureclient.flasharray._common.models.target_protection_group_v_2_1 import TargetProtectionGroup
...
class ProtectionGroupTargetGetResponse(BaseModel):
    ...
    items: Optional[conlist(TargetProtectionGroup)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful.")
