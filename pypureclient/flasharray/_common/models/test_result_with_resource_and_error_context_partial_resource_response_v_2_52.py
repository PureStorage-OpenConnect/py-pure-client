...
class TestResultWithResourceAndErrorContextPartialResourceResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultWithResourceAndErrorContextPartialResourceResponse:
        """Create an instance of TestResultWithResourceAndErrorContextPartialResourceResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TestResultWithResourceAndErrorContextPartialResourceResponse:
        """Create an instance of TestResultWithResourceAndErrorContextPartialResourceResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultWithResourceAndErrorContextPartialResourceResponse.parse_obj(obj)

        _obj = TestResultWithResourceAndErrorContextPartialResourceResponse.construct(_fields_set=None, **{
