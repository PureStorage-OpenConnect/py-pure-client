...
class AlertRules(BaseModel):
    ...
    __properties = ["context", "code", "parameter", "value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertRules:
        """Create an instance of AlertRules from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AlertRules:
        """Create an instance of AlertRules from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlertRules.parse_obj(obj)

        _obj = AlertRules.construct(_fields_set=None, **{
