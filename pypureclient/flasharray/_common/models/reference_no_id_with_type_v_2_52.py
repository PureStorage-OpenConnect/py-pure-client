...
class ReferenceNoIdWithType(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceNoIdWithType:
        """Create an instance of ReferenceNoIdWithType from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceNoIdWithType:
        """Create an instance of ReferenceNoIdWithType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReferenceNoIdWithType.parse_obj(obj)

        _obj = ReferenceNoIdWithType.construct(_fields_set=None, **{
            "name": obj.get("name"),
