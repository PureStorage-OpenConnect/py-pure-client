...
from pypureclient.flasharray._common.models.offload_v_2_1 import Offload
...
class OffloadGetResponse(BaseModel):
    ...
    items: Optional[conlist(Offload)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful.")
