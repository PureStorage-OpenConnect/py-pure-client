...
class HardwarePatch(BaseModel):
    ...
    __properties = ["name", "identify_enabled", "index"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HardwarePatch:
        """Create an instance of HardwarePatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> HardwarePatch:
        """Create an instance of HardwarePatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HardwarePatch.parse_obj(obj)

        _obj = HardwarePatch.construct(_fields_set=None, **{
            "name": obj.get("name"),
