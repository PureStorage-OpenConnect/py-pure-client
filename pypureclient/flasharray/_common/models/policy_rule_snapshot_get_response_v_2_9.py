...
from pypureclient.flasharray._common.models.policy_rule_snapshot_v_2_9 import PolicyRuleSnapshot
...
class PolicyRuleSnapshotGetResponse(BaseModel):
    ...
    items: Optional[conlist(PolicyRuleSnapshot)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name if meaningful.")
