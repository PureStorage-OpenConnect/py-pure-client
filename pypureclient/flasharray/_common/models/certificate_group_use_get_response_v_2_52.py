...
from pypureclient.flasharray._common.models.certificate_group_use_v_2_52 import CertificateGroupUse


class CertificateGroupUseGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(CertificateGroupUse)] = Field(default=None, description="A list of certificate group use objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificateGroupUseGetResponse:
        """Create an instance of CertificateGroupUseGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CertificateGroupUseGetResponse:
        """Create an instance of CertificateGroupUseGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CertificateGroupUseGetResponse.parse_obj(obj)

        _obj = CertificateGroupUseGetResponse.construct(_fields_set=None, **{
            ...
            "items": [CertificateGroupUse.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
