...
from pypureclient.flasharray._common.models.qos_metrics_file_ceilings_v_2_54 import QosMetricsFileCeilings


class DirectoryQosGetResponse(BaseModel):
    """
    DirectoryQosGetResponse
    """
    ...
    items: Optional[conlist(QosMetricsFileCeilings)] = Field(default=None, description="The object that contains `QoS` configuration data.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryQosGetResponse:
        """Create an instance of DirectoryQosGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryQosGetResponse:
        """Create an instance of DirectoryQosGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryQosGetResponse.parse_obj(obj)

        _obj = DirectoryQosGetResponse.construct(_fields_set=None, **{
            ...
            "items": [QosMetricsFileCeilings.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
