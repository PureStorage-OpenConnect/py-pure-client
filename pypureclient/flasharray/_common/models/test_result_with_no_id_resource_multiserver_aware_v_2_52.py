...
class TestResultWithNoIdResourceMultiserverAware(BaseModel):
    ...
    __properties = ["component_address", "component_name", "description", "destination", "enabled", "result_details", "success", "test_type", "context", "realms", "server", "resource"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultWithNoIdResourceMultiserverAware:
        """Create an instance of TestResultWithNoIdResourceMultiserverAware from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TestResultWithNoIdResourceMultiserverAware:
        """Create an instance of TestResultWithNoIdResourceMultiserverAware from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultWithNoIdResourceMultiserverAware.parse_obj(obj)

        _obj = TestResultWithNoIdResourceMultiserverAware.construct(_fields_set=None, **{
