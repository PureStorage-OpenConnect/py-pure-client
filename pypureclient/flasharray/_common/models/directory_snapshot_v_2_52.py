...
from pypureclient.flasharray._common.models.directory_snapshot_eradication_config_v_2_52 import DirectorySnapshotEradicationConfig
...
class DirectorySnapshot(BaseModel):
    ...
    eradication_config: Optional[DirectorySnapshotEradicationConfig] = None
    ...
    __properties = ["id", "name", "context", "client_name", "created", "destroyed", "eradication_config", "policy", "source", "space", "suffix", "time_remaining"]
    ...
    def from_dict(cls, obj: dict) -> DirectorySnapshot:
        ...
        _obj = DirectorySnapshot.construct(_fields_set=None, **{
            ...
            "eradication_config": DirectorySnapshotEradicationConfig.from_dict(obj.get("eradication_config")) if obj.get("eradication_config") is not None else None,
