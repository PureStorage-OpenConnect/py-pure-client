...
from pypureclient.flasharray._common.models.volume_v_2_0 import Volume
...
class VolumeGetResponse(BaseModel):
    ...
    total: Optional[conlist(Volume)] = Field(default=None, description="The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field where meaningful.")
