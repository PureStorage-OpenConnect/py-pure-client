...
from pypureclient.flasharray._common.models.networkinterfacepatch_eth_v_2_4 import NetworkinterfacepatchEth
...
class NetworkInterfacePatch(BaseModel):
    ...
    __properties = ["enabled", "eth", "override_npiv_check"]
