...
class ResourcePerformance(BaseModel):
    ...
    cached_read_bytes_per_sec: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The number of cached bytes read, measured in bytes per second.")
    cached_reads_per_sec: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The number of cached read requests, measured in requests per second.")
    ...
    non_cached_read_bytes_per_sec: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The number of non-cached bytes read, measured in bytes per second.")
    non_cached_reads_per_sec: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The number of non-cached read requests, measured in requests per second.")
    ...
    qos_scheduling_usec_per_mirrored_write_op: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The average time that a mirrored write I/O gets delayed due to QoS scheduling, measured in microseconds.")
    qos_scheduling_usec_per_read_op: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The average time that a read I/O gets delayed due to QoS scheduling, measured in microseconds.")
    qos_scheduling_usec_per_write_op: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The average time that a write I/O gets delayed due to QoS scheduling, measured in microseconds.")
    queue_usec_per_mirrored_write_op: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The average time that a mirrored write I/O request spends in the kernel waiting to be served, measured in microseconds.")
    queue_usec_per_read_op: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The average time that a read I/O request spends in the kernel waiting to be served, measured in microseconds.")
    queue_usec_per_write_op: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The average time that a write I/O request spends in the kernel waiting to be served, measured in microseconds.")
    read_bytes_per_sec: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The number of bytes read per second.")
    read_cache_hit_ratio: Optional[Union[confloat(le=1, ge=0, strict=True), conint(le=1, ge=0, strict=True)]] = Field(default=None, description="The ratio of read requests served directly from the cache.")
    ...
    service_usec_per_read_op_cached: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The average time required for the array to service a read request that is satisfied by a cache hit, measured in microseconds.")
    service_usec_per_read_op_non_cached: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The average time required for the array to service a read request that is not satisfied by a cache hit, measured in microseconds.")
    ...
    __properties = ["bytes_per_mirrored_write", "bytes_per_op", "bytes_per_read", "bytes_per_write", "cached_read_bytes_per_sec", "cached_reads_per_sec", "mirrored_write_bytes_per_sec", "mirrored_writes_per_sec", "non_cached_read_bytes_per_sec", "non_cached_reads_per_sec", "qos_rate_limit_usec_per_mirrored_write_op", "qos_rate_limit_usec_per_read_op", "qos_rate_limit_usec_per_write_op", "qos_scheduling_usec_per_mirrored_write_op", "qos_scheduling_usec_per_read_op", "qos_scheduling_usec_per_write_op", "queue_usec_per_mirrored_write_op", "queue_usec_per_read_op", "queue_usec_per_write_op", "read_bytes_per_sec", "read_cache_hit_ratio", "reads_per_sec", "san_usec_per_mirrored_write_op", "san_usec_per_read_op", "san_usec_per_write_op", "service_usec_per_mirrored_write_op", "service_usec_per_read_op", "service_usec_per_read_op_cache_reduction", "service_usec_per_read_op_cached", "service_usec_per_read_op_non_cached", "service_usec_per_write_op", "time", "usec_per_mirrored_write_op", "usec_per_read_op", "usec_per_write_op", "write_bytes_per_sec", "writes_per_sec", "mirrored_others_per_sec", "others_per_sec", "usec_per_mirrored_other_op", "usec_per_other_op", "id", "name", "context"]
    ...
    def from_dict(cls, obj: dict) -> ResourcePerformance:
        ...
        _obj = ResourcePerformance.construct(_fields_set=None, **{
            ...
            "cached_read_bytes_per_sec": obj.get("cached_read_bytes_per_sec"),
            "cached_reads_per_sec": obj.get("cached_reads_per_sec"),
            "mirrored_write_bytes_per_sec": obj.get("mirrored_write_bytes_per_sec"),
            "mirrored_writes_per_sec": obj.get("mirrored_writes_per_sec"),
            "non_cached_read_bytes_per_sec": obj.get("non_cached_read_bytes_per_sec"),
            "non_cached_reads_per_sec": obj.get("non_cached_reads_per_sec"),
            ...
            "qos_scheduling_usec_per_mirrored_write_op": obj.get("qos_scheduling_usec_per_mirrored_write_op"),
            "qos_scheduling_usec_per_read_op": obj.get("qos_scheduling_usec_per_read_op"),
            "qos_scheduling_usec_per_write_op": obj.get("qos_scheduling_usec_per_write_op"),
            ...
            "read_cache_hit_ratio": obj.get("read_cache_hit_ratio"),
            ...
            "service_usec_per_read_op_cached": obj.get("service_usec_per_read_op_cached"),
            "service_usec_per_read_op_non_cached": obj.get("service_usec_per_read_op_non_cached"),
