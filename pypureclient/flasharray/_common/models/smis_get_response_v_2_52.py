...
from pypureclient.flasharray._common.models.smis_v_2_52 import Smis


class SmisGetResponse(BaseModel):
    """
    SmisGetResponse
    """
    ...
    items: Optional[conlist(Smis)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmisGetResponse:
        """Create an instance of SmisGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmisGetResponse:
        """Create an instance of SmisGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmisGetResponse.parse_obj(obj)

        _obj = SmisGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Smis.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
