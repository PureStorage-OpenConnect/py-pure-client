...
class VolumeSnapshotPost(BaseModel):
    """
    VolumeSnapshotPost
    """
    ...
    __properties = ["destroyed", "suffix", "tags"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VolumeSnapshotPost:
        """Create an instance of VolumeSnapshotPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VolumeSnapshotPost:
        """Create an instance of VolumeSnapshotPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VolumeSnapshotPost.parse_obj(obj)

        _obj = VolumeSnapshotPost.construct(_fields_set=None, **{
