...
class ArrayConnectionKey(BaseModel):
    ...
    connection_key: Optional[StrictStr] = Field(default=None, description="The `connection-key` used on another `array` to connect to this `array`.")
    __properties = ["context", "connection_key"]
