...
from pypureclient.flasharray._common.models.test_result_with_no_id_resource_multiserver_aware_v_2_52 import TestResultWithNoIdResourceMultiserverAware


class TestGetResultWithResourceErrorContextMultiserverAwareResponse(BaseModel):
    """
    TestGetResultWithResourceErrorContextMultiserverAwareResponse
    """
    ...
    items: Optional[conlist(TestResultWithNoIdResourceMultiserverAware)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestGetResultWithResourceErrorContextMultiserverAwareResponse:
        """Create an instance of TestGetResultWithResourceErrorContextMultiserverAwareResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TestGetResultWithResourceErrorContextMultiserverAwareResponse:
        """Create an instance of TestGetResultWithResourceErrorContextMultiserverAwareResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestGetResultWithResourceErrorContextMultiserverAwareResponse.parse_obj(obj)

        _obj = TestGetResultWithResourceErrorContextMultiserverAwareResponse.construct(_fields_set=None, **{
            ...
            "items": [TestResultWithNoIdResourceMultiserverAware.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
