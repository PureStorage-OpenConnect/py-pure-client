...
from pypureclient.flasharray._common.models.support_remote_assist_sessions_settings_v_2_52 import SupportRemoteAssistSessionsSettings


class SupportRemoteAssistSessionsSettingsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SupportRemoteAssistSessionsSettings)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupportRemoteAssistSessionsSettingsGetResponse:
        """Create an instance of SupportRemoteAssistSessionsSettingsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SupportRemoteAssistSessionsSettingsGetResponse:
        """Create an instance of SupportRemoteAssistSessionsSettingsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupportRemoteAssistSessionsSettingsGetResponse.parse_obj(obj)

        _obj = SupportRemoteAssistSessionsSettingsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SupportRemoteAssistSessionsSettings.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
