...
class ThrottleDeprecated(BaseModel):
    """
    ThrottleDeprecated
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ThrottleDeprecated:
        """Create an instance of ThrottleDeprecated from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ThrottleDeprecated:
        """Create an instance of ThrottleDeprecated from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ThrottleDeprecated.parse_obj(obj)

        _obj = ThrottleDeprecated.construct(_fields_set=None, **{
