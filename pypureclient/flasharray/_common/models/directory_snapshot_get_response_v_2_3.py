...
from pypureclient.flasharray._common.models.directory_snapshot_v_2_3 import DirectorySnapshot
...
class DirectorySnapshotGetResponse(BaseModel):
    ...
    items: Optional[conlist(DirectorySnapshot)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name if meaningful.")
    total: Optional[conlist(DirectorySnapshot)] = Field(default=None, description="The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field if meaningful.")
