...
from pypureclient.flasharray._common.models.workload_configuration_reference_patch_v_2_55 import WorkloadConfigurationReferencePatch
...
class VolumePatch(BaseModel):
    ...
    __properties = ["destroyed", "name", "pod", "priority_adjustment", "protocol_endpoint", "provisioned", "qos", "requested_promotion_state", "volume_group", "workload"]
