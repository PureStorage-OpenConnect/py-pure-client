...
from pypureclient.flasharray._common.models.workload_placement_recommendation_target_v_2_51 import WorkloadPlacementRecommendationTarget
...
class WorkloadPlacementRecommendationPlacement(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkloadPlacementRecommendationPlacement:
        """Create an instance of WorkloadPlacementRecommendationPlacement from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> WorkloadPlacementRecommendationPlacement:
        """Create an instance of WorkloadPlacementRecommendationPlacement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkloadPlacementRecommendationPlacement.parse_obj(obj)

        _obj = WorkloadPlacementRecommendationPlacement.construct(_fields_set=None, **{
            "name": obj.get("name"),
            "targets": [WorkloadPlacementRecommendationTarget.from_dict(_item) for _item in obj.get("targets")] if obj.get("targets") is not None else None
        })
        return _obj
