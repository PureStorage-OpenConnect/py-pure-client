...
class SoftwarePost(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SoftwarePost:
        """Create an instance of SoftwarePost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SoftwarePost:
        """Create an instance of SoftwarePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SoftwarePost.parse_obj(obj)

        _obj = SoftwarePost.construct(_fields_set=None, **{
            "name": obj.get("name"),
