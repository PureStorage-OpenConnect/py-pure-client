...
"""
    ...
    The version of the OpenAPI document: 2.56
...
from pypureclient.flasharray._common.models.storage_class_member_v_2_56 import StorageClassMember


class StorageClassesMembersGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(StorageClassMember)] = Field(default=None, description="The list of `storage class membership` results.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StorageClassesMembersGetResponse:
        """Create an instance of StorageClassesMembersGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> StorageClassesMembersGetResponse:
        """Create an instance of StorageClassesMembersGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StorageClassesMembersGetResponse.parse_obj(obj)

        _obj = StorageClassesMembersGetResponse.construct(_fields_set=None, **{
            ...
            "items": [StorageClassMember.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
