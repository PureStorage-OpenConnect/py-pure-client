...
class SupportDiagnosticsDetails(BaseModel):
    ...
    test_type: Optional[StrictStr] = Field(default=None, description="The category to which the test belongs to.")
    __properties = ["result_details", "severity", "test_name", "test_type"]
