...
class SupportPatch(BaseModel):
    ...
    phonehome_excludes: Optional[conlist(StrictStr)] = Field(default=None, description="A list of of items to exclude form phonehome. Valid values include `application-insights`.")
    ...
    __properties = ["phonehome_enabled", "phonehome_excludes", "proxy", "remote_assist_active", "remote_assist_duration"]
