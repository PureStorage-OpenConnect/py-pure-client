...
from pypureclient.flasharray._common.models.object_store_account_v_2_52 import ObjectStoreAccount
...
class ObjectStoreAccountGetResponse(BaseModel):
    ...
    total: Optional[conlist(ObjectStoreAccount)] = Field(default=None, description="If `total_only` query param is `true`, then this field will be a total of all records after filtering and no items will be returned. If `total_only` is `false`, then it will be a total of all records on this page.")
    ...
    def from_dict(cls, obj: dict) -> ObjectStoreAccountGetResponse:
        ...
        _obj = ObjectStoreAccountGetResponse.construct(_fields_set=None, **{
            ...
            "total": [ObjectStoreAccount.from_dict(_item) for _item in obj.get("total")] if obj.get("total") is not None else None
        })
        return _obj
