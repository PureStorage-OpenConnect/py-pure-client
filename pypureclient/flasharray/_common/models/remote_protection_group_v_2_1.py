...
from pypureclient.flasharray._common.models.retention_policy_v_2_1 import RetentionPolicy
...
class RemoteProtectionGroup(BaseModel):
    ...
    __properties = ["id", "name", "destroyed", "is_local", "remote", "source", "target_retention", "time_remaining"]
