...
from pypureclient.flasharray._common.models.support_remote_assist_paths_v_2_2 import SupportRemoteAssistPaths
...
class Support(BaseModel):
    ...
    __properties = ["phonehome_enabled", "proxy", "remote_assist_active", "remote_assist_expires", "remote_assist_opened", "remote_assist_paths", "remote_assist_status"]
