...
class ReferenceWithFixedType(BaseModel):
    """
    ...
    resource_type: Optional[StrictStr] = Field(default=None, description="Type of the object (full name of the endpoint). Valid values are `hosts`, `host-groups`, `network-interfaces`, `pods`, `ports`, `pod-replica-links`, `realms`, `subnets`, `volumes`, `volume-snapshots`, `volume-groups`, `directories`, `policies/nfs`, `policies/smb`, and `policies/snapshot`, etc.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceWithFixedType:
        """Create an instance of ReferenceWithFixedType from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceWithFixedType:
        """Create an instance of ReferenceWithFixedType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReferenceWithFixedType.parse_obj(obj)

        _obj = ReferenceWithFixedType.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
