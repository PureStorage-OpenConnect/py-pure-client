...
from pypureclient.flasharray._common.models.policy_rule_network_access_v_2_52 import PolicyRuleNetworkAccess


class PolicyRuleNetworkAccessGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyRuleNetworkAccess)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleNetworkAccessGetResponse:
        """Create an instance of PolicyRuleNetworkAccessGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleNetworkAccessGetResponse:
        """Create an instance of PolicyRuleNetworkAccessGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleNetworkAccessGetResponse.parse_obj(obj)

        _obj = PolicyRuleNetworkAccessGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyRuleNetworkAccess.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
