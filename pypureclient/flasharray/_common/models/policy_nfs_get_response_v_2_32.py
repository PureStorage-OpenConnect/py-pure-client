...
from pypureclient.flasharray._common.models.policy_nfs_v_2_32 import PolicyNfs
...
class PolicyNfsGetResponse(BaseModel):
    ...
    items: Optional[conlist(PolicyNfs)] = Field(default=None, description="Returns a list of all items after filtering. If applicable, the values are displayed for each name.")
