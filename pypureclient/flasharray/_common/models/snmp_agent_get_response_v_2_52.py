...
from pypureclient.flasharray._common.models.snmp_agent_v_2_52 import SnmpAgent


class SnmpAgentGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SnmpAgent)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnmpAgentGetResponse:
        """Create an instance of SnmpAgentGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SnmpAgentGetResponse:
        """Create an instance of SnmpAgentGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnmpAgentGetResponse.parse_obj(obj)

        _obj = SnmpAgentGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SnmpAgent.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
