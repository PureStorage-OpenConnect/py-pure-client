...
class VolumeGroupQosGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(QosMetricsCeilings)] = Field(default=None, description="QoS configuration data.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VolumeGroupQosGetResponse:
        """Create an instance of VolumeGroupQosGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VolumeGroupQosGetResponse:
        """Create an instance of VolumeGroupQosGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VolumeGroupQosGetResponse.parse_obj(obj)

        _obj = VolumeGroupQosGetResponse.construct(_fields_set=None, **{
