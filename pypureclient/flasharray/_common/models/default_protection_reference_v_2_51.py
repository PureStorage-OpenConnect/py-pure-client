...
class DefaultProtectionReference(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="The type of default protection. Currently, the only valid values are `protection_group` and `snapshot_policy`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DefaultProtectionReference:
        """Create an instance of DefaultProtectionReference from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DefaultProtectionReference:
        """Create an instance of DefaultProtectionReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DefaultProtectionReference.parse_obj(obj)

        _obj = DefaultProtectionReference.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type")
        })
