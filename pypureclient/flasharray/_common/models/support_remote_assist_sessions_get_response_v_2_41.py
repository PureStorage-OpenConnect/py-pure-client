...
from pypureclient.flasharray._common.models.support_remote_assist_sessions_v_2_41 import SupportRemoteAssistSessions


class SupportRemoteAssistSessionsGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupportRemoteAssistSessionsGetResponse:
        """Create an instance of SupportRemoteAssistSessionsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SupportRemoteAssistSessionsGetResponse:
        """Create an instance of SupportRemoteAssistSessionsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupportRemoteAssistSessionsGetResponse.parse_obj(obj)

        _obj = SupportRemoteAssistSessionsGetResponse.construct(_fields_set=None, **{
