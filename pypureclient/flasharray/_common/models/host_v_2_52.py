...
from pypureclient.flasharray._common.models.host_port_connectivity_v_2_52 import HostPortConnectivity
...
class Host(BaseModel):
    ...
    __properties = ["name", "context", "chap", "connection_count", "destroyed", "host_group", "iqns", "is_local", "nqns", "nvme_stretch", "personality", "port_connectivity", "preferred_arrays", "qos", "space", "time_remaining", "vlan", "wwns"]
