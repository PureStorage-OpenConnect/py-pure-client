...
class SpaceNoDeprecatedPhysicalOrEffective(BaseModel):
    ...
    footprint: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The maximum amount of physical space the container would take up on any array, ignoring any data shared outside the container. Measured in bytes. On Evergreen//One arrays, this is the maximum amount of effective used space, measured in bytes. The footprint metric is mostly used for capacity planning. This field will be null in non-container contexts.")
    ...
    __properties = ["data_reduction", "footprint", "shared", "snapshots", "system", "thin_provisioning", "total_provisioned", "total_reduction", "total_used", "unique", "used_provisioned", "virtual"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpaceNoDeprecatedPhysicalOrEffective:
        """Create an instance of SpaceNoDeprecatedPhysicalOrEffective from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SpaceNoDeprecatedPhysicalOrEffective:
        """Create an instance of SpaceNoDeprecatedPhysicalOrEffective from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpaceNoDeprecatedPhysicalOrEffective.parse_obj(obj)

        _obj = SpaceNoDeprecatedPhysicalOrEffective.construct(_fields_set=None, **{
