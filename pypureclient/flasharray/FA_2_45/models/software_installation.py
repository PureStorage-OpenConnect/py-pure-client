...
from pypureclient.flasharray.FA_2_45.models.upgrade_parameters import UpgradeParameters
...
class SoftwareInstallation(BaseModel):
    ...
    __properties = ["id", "name", "end_time", "start_time", "current_step_id", "details", "mode", "override_checks", "software", "status", "upgrade_parameters"]
