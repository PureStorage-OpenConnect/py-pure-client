...
from pypureclient.flasharray.FA_2_45.models.protection_group_eradication_config import ProtectionGroupEradicationConfig
from pypureclient.flasharray.FA_2_45.models.space import Space


class ProtectionGroupSnapshotPatch(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProtectionGroupSnapshotPatch:
        """Create an instance of ProtectionGroupSnapshotPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ProtectionGroupSnapshotPatch:
        """Create an instance of ProtectionGroupSnapshotPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProtectionGroupSnapshotPatch.parse_obj(obj)

        _obj = ProtectionGroupSnapshotPatch.construct(_fields_set=None, **{
            "name": obj.get("name"),
            "id": obj.get("id"),
