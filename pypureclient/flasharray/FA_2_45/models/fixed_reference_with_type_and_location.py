...
class FixedReferenceWithTypeAndLocation(BaseModel):
    """
    ...
    resource_type: Optional[StrictStr] = Field(default=None, description="Type of the object (full name of the endpoint).   Valid values are the unique part of the resource's REST endpoint.   For example, a reference to a fleet would have a   `resource_type` of `fleets`.")
    __properties = ["id", "name", "is_local", "resource_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixedReferenceWithTypeAndLocation:
        """Create an instance of FixedReferenceWithTypeAndLocation from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FixedReferenceWithTypeAndLocation:
        """Create an instance of FixedReferenceWithTypeAndLocation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FixedReferenceWithTypeAndLocation.parse_obj(obj)

        _obj = FixedReferenceWithTypeAndLocation.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
