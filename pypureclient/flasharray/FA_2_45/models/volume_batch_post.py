...
from pypureclient.flasharray.FA_2_45.models.priority_adjustment import PriorityAdjustment
from pypureclient.flasharray.FA_2_45.models.protocol_endpoint import ProtocolEndpoint
from pypureclient.flasharray.FA_2_45.models.qos import Qos
from pypureclient.flasharray.FA_2_45.models.reference import Reference
from pypureclient.flasharray.FA_2_45.models.tag import Tag
...
class VolumeBatchPost(BaseModel):
    ...
    add_to_protection_groups: Optional[conlist(Reference)] = Field(default=None, description="Specifies a list of protection groups that will compose the initial protection for the volume.")
    name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the volume.")
    __properties = ["destroyed", "priority_adjustment", "protocol_endpoint", "provisioned", "qos", "source", "subtype", "tags", "add_to_protection_groups", "name"]
    ...
    def to_dict(self, include_readonly: bool=True) -> Dict[str, Any]:
        ...
        if _include_in_dict('add_to_protection_groups', include_readonly, excluded_fields, none_fields):
            _items = []
            for _item in self.add_to_protection_groups:
                if _item:
                    _items.append(_item.to_dict(include_readonly=include_readonly))
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VolumeBatchPost:
        """Create an instance of VolumeBatchPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VolumeBatchPost:
        """Create an instance of VolumeBatchPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VolumeBatchPost.parse_obj(obj)

        _obj = VolumeBatchPost.construct(_fields_set=None, **{
            ...
            "add_to_protection_groups": [Reference.from_dict(_item) for _item in obj.get("add_to_protection_groups")] if obj.get("add_to_protection_groups") is not None else None,
            "name": obj.get("name")
        })
        return _obj
