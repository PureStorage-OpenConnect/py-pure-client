...
class VolumePostBase(BaseModel):
    """
    VolumePostBase
    """
    ...
    __properties = ["destroyed", "priority_adjustment", "protocol_endpoint", "provisioned", "qos", "source", "subtype", "tags"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VolumePostBase:
        """Create an instance of VolumePostBase from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VolumePostBase:
        """Create an instance of VolumePostBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VolumePostBase.parse_obj(obj)

        _obj = VolumePostBase.construct(_fields_set=None, **{
