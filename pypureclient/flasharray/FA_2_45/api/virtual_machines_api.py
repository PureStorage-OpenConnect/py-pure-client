...
from pypureclient.flasharray.FA_2_45.models.virtual_machine_get_response import VirtualMachineGetResponse
from pypureclient.flasharray.FA_2_45.models.virtual_machine_post import VirtualMachinePost
from pypureclient.flasharray.FA_2_45.models.virtual_machine_response import VirtualMachineResponse
from pypureclient.flasharray.FA_2_45.models.virtual_machine_volume_snapshot_response import VirtualMachineVolumeSnapshotResponse
from typing import Optional
...
class VirtualMachinesApi:
    ...
    def api245_virtual_machine_snapshots_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api245_virtual_machine_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.45/virtual-machine-snapshots', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api245_virtual_machine_volume_snapshots_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_virtual_machine_volume_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.45/virtual-machine-volume-snapshots', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api245_virtual_machines_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="A token used to retrieve the next page of data with some consistency guaranteed. The token is a Base64 encoded value. Set `continuation_token` to the system-generated token taken from the `x-next-token` header field of the response. A query has reached its last page when the response does not include a token. Pagination requires the `limit` and `continuation_token` query parameters.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_virtual_machines_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api245_virtual_machines_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_virtual_machines_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.45/virtual-machines', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api245_virtual_machines_post_with_http_info(
        self,
        virtual_machine: VirtualMachinePost,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_virtual_machines_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.45/virtual-machines', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
