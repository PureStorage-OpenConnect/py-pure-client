...
from pypureclient.flasharray.FA_2_45.models.subscription_get_response import SubscriptionGetResponse
from typing import Optional
...
class SubscriptionsApi:
    ...
    def api245_subscriptions_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api245_subscriptions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
