...
from pypureclient.flasharray.FA_2_45.models.offload_get_response import OffloadGetResponse
from pypureclient.flasharray.FA_2_45.models.offload_post import OffloadPost
from pypureclient.flasharray.FA_2_45.models.offload_response import OffloadResponse
from typing import Optional
...
class OffloadsApi:
    ...
    def api245_offloads_delete_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api245_offloads_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api245_offloads_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_offloads_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api245_offloads_post_with_http_info(
        self,
        offload: OffloadPost,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_offloads_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
