...
from pypureclient.flasharray.FA_2_45.models.api_version_response import ApiVersionResponse
from pypureclient.flasharray.FA_2_45.models.oauth_token_response import OauthTokenResponse
from pypureclient.flasharray.FA_2_45.models.username_response import UsernameResponse
from typing import Optional
...
class AuthorizationApi:
    ...
    def api245_login_post_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api245_login_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api245_logout_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_logout_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
