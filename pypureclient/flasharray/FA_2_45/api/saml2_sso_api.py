...
from pypureclient.flasharray.FA_2_45.models.saml2_sso_get_response import Saml2SsoGetResponse
from pypureclient.flasharray.FA_2_45.models.saml2_sso_patch import Saml2SsoPatch
from pypureclient.flasharray.FA_2_45.models.saml2_sso_post import Saml2SsoPost
from pypureclient.flasharray.FA_2_45.models.saml2_sso_response import Saml2SsoResponse
from pypureclient.flasharray.FA_2_45.models.test_result_with_resource_patch_response import TestResultWithResourcePatchResponse
...
class SAML2SSOApi:
    ...
    def api245_sso_saml2_idps_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api245_sso_saml2_idps_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.45/sso/saml2/idps', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api245_sso_saml2_idps_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_sso_saml2_idps_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api245_sso_saml2_idps_patch_with_http_info(
        self,
        idp: Saml2SsoPatch,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_sso_saml2_idps_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api245_sso_saml2_idps_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_sso_saml2_idps_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api245_sso_saml2_idps_test_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_sso_saml2_idps_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.45/sso/saml2/idps/test', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api245_sso_saml2_idps_test_patch_with_http_info(
        self,
        idp: Saml2SsoPost,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_sso_saml2_idps_test_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.45/sso/saml2/idps/test', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
