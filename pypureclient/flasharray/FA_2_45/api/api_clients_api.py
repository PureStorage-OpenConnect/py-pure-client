...
from pypureclient.flasharray.FA_2_45.models.api_client_get_response import ApiClientGetResponse
from pypureclient.flasharray.FA_2_45.models.api_client_patch import ApiClientPatch
from pypureclient.flasharray.FA_2_45.models.api_client_post import ApiClientPost
from pypureclient.flasharray.FA_2_45.models.api_client_response import ApiClientResponse
from typing import Optional
...
class APIClientsApi:
    ...
    def api245_api_clients_delete_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api245_api_clients_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api245_api_clients_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_api_clients_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api245_api_clients_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_api_clients_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api245_api_clients_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api245_api_clients_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
