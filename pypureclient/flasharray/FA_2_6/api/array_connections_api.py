...
from pypureclient.flasharray.FA_2_6.models.array_connection_get_response import ArrayConnectionGetResponse
from pypureclient.flasharray.FA_2_6.models.array_connection_key_get_response import ArrayConnectionKeyGetResponse
from pypureclient.flasharray.FA_2_6.models.array_connection_path_get_response import ArrayConnectionPathGetResponse
from pypureclient.flasharray.FA_2_6.models.array_connection_post import ArrayConnectionPost
from pypureclient.flasharray.FA_2_6.models.array_connection_response import ArrayConnectionResponse
from pypureclient.flasharray.FA_2_6.models.throttle import Throttle
...
class ArrayConnectionsApi:
    ...
    def api26_array_connections_connection_key_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_array_connections_connection_key_get_with_http_info(authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api26_array_connections_connection_key_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_array_connections_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_array_connections_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_array_connections_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_array_connections_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_array_connections_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_array_connections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_array_connections_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_array_connections_patch_with_http_info(array_connection, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_array_connections_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_array_connections_path_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_array_connections_path_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_array_connections_path_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_array_connections_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_array_connections_post_with_http_info(array_connection, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_array_connections_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
