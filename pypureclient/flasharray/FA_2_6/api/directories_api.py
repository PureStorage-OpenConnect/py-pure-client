...
from pypureclient.flasharray.FA_2_6.models.directory_get_response import DirectoryGetResponse
from pypureclient.flasharray.FA_2_6.models.directory_patch import DirectoryPatch
from pypureclient.flasharray.FA_2_6.models.directory_performance_get_response import DirectoryPerformanceGetResponse
from pypureclient.flasharray.FA_2_6.models.directory_policy_export_post import DirectoryPolicyExportPost
from pypureclient.flasharray.FA_2_6.models.directory_policy_post import DirectoryPolicyPost
from pypureclient.flasharray.FA_2_6.models.directory_post import DirectoryPost
from pypureclient.flasharray.FA_2_6.models.directory_response import DirectoryResponse
...
class DirectoriesApi:
    ...
    def api26_directories_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_delete_with_http_info(authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api26_directories_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, file_system_ids, file_system_names, filter, ids, limit, names, offset, sort, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_patch_with_http_info(directory, authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_performance_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, protocol, protocol_group, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_policies_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_policies_nfs_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_policies_nfs_delete_with_http_info(authorization, x_request_id, member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_policies_nfs_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_policies_nfs_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_policies_nfs_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_policies_nfs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_policies_nfs_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_policies_nfs_post_with_http_info(policies, authorization, x_request_id, member_ids, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_policies_nfs_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_policies_smb_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_policies_smb_delete_with_http_info(authorization, x_request_id, member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_policies_smb_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_policies_smb_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_policies_smb_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_policies_smb_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_policies_smb_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_policies_smb_post_with_http_info(policies, authorization, x_request_id, member_ids, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_policies_smb_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_policies_snapshot_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_policies_snapshot_delete_with_http_info(authorization, x_request_id, member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_policies_snapshot_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_policies_snapshot_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_policies_snapshot_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_policies_snapshot_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_policies_snapshot_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_policies_snapshot_post_with_http_info(policies, authorization, x_request_id, member_ids, member_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_policies_snapshot_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_post_with_http_info(directory, authorization, x_request_id, file_system_ids, file_system_names, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_directories_space_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_directories_space_get_with_http_info(authorization, x_request_id, destroyed, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_directories_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
