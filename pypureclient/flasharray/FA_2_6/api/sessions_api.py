...
from pypureclient.flasharray.FA_2_6.models.session_get_response import SessionGetResponse
...
class SessionsApi:
    ...
    def api26_sessions_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_sessions_get_with_http_info(authorization, x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
