...
from pypureclient.flasharray.FA_2_6.models.dns_get_response import DnsGetResponse
...
class DNSApi:
    ...
    def api26_dns_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_dns_get_with_http_info(authorization, x_request_id, filter, limit, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api26_dns_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_dns_patch_with_http_info(dns, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
