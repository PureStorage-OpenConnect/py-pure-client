...
class FileSystemGetResponse(BaseModel):
    ...
    items: Optional[List[FileSystem]] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name if meaningful.")
