...
class NetworkInterfaceFc(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkInterfaceFc:
        """Create an instance of NetworkInterfaceFc from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkInterfaceFc:
        """Create an instance of NetworkInterfaceFc from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkInterfaceFc.parse_obj(obj)

        _obj = NetworkInterfaceFc.construct(_fields_set=None, **{
            "wwn": obj.get("wwn")
        })
        return _obj
