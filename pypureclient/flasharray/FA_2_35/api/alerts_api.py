...
class AlertsApi:
    ...
    def api235_alerts_events_get_with_http_info(
        ...
        _param = self._api235_alerts_events_get_serialize(
    ...
    def _api235_alerts_events_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.35/alerts/events',
    ...
    def api235_alerts_get_with_http_info(
        ...
        _param = self._api235_alerts_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
    ...
    def _api235_alerts_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
    ...
    def api235_alerts_patch_with_http_info(
        ...
        _param = self._api235_alerts_patch_serialize(
            alert = alert,
            authorization = authorization,
            x_request_id = x_request_id,
            ids = ids,
    ...
    def _api235_alerts_patch_serialize(
        self,
        alert,
        authorization,
        x_request_id,
    ...
    def api235_alerts_rules_catalog_get_with_http_info(
        ...
        _param = self._api235_alerts_rules_catalog_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api235_alerts_rules_catalog_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.35/alerts/rules/catalog',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api235_alerts_rules_delete_with_http_info(
        ...
        _param = self._api235_alerts_rules_delete_serialize(
            code = code,
            parameter = parameter,
            authorization = authorization,
            x_request_id = x_request_id,
    ...
    def _api235_alerts_rules_delete_serialize(
        self,
        code,
        parameter,
        authorization,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.35/alerts/rules',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api235_alerts_rules_get_with_http_info(
        ...
        _param = self._api235_alerts_rules_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api235_alerts_rules_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
    ...
    def api235_alerts_rules_patch_with_http_info(
        ...
        _param = self._api235_alerts_rules_patch_serialize(
            code = code,
            parameter = parameter,
    ...
    def _api235_alerts_rules_patch_serialize(
        self,
        code,
        parameter,
        alert_rule,
    ...
    def api235_alerts_rules_post_with_http_info(
        ...
        _param = self._api235_alerts_rules_post_serialize(
            code = code,
            parameter = parameter,
            alert_rule = alert_rule,
            authorization = authorization,
    ...
    def _api235_alerts_rules_post_serialize(
        self,
        code,
        parameter,
        alert_rule,
