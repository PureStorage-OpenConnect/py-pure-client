...
from pypureclient.flasharray.FA_2_35.models.policy_nfs_policy_mapping import PolicyNfsPolicyMapping
...
class PolicyNfs(BaseModel):
    ...
    __properties = ["id", "name", "destroyed", "enabled", "pod", "policy_type", "time_remaining", "nfs_version", "policy_mapping", "security", "user_mapping_enabled"]
