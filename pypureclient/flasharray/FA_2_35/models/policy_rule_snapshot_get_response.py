...
class PolicyRuleSnapshotGetResponse(BaseModel):
    ...
    items: Optional[List[PolicyRuleSnapshot]] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name, if meaningful.")
