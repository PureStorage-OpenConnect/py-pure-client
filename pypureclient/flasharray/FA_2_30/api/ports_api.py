...
class PortsApi:
    ...
    def api230_ports_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api230_ports_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api230_ports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api230_ports_initiators_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api230_ports_initiators_get_with_http_info(authorization, x_request_id, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api230_ports_initiators_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
