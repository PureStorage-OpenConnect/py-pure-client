...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_30.models.port_get_response import PortGetResponse
from pypureclient.flasharray.FA_2_30.models.port_initiators_get_response import PortInitiatorsGetResponse
...
class PortsApi:
    ...
    def api230_ports_get_with_http_info(
        ...
        _param = self._api230_ports_get_serialize(
    ...
    def _api230_ports_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
    ...
    def api230_ports_initiators_get_with_http_info(
        ...
        _param = self._api230_ports_initiators_get_serialize(
            authorization = authorization,
            x_request_id = x_request_id,
            filter = filter,
            limit = limit,
    ...
    def _api230_ports_initiators_get_serialize(
        self,
        authorization,
        x_request_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.30/ports/initiators',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
