...
class AuthorizationApi:
    ...
    def api230_login_post_with_http_info(
        ...
        _param = self._api230_login_post_serialize(
    ...
    def _api230_login_post_serialize(
        self,
        x_request_id,
        api_token,
    ) -> RequestSerialized:
    ...
    def api230_logout_post_with_http_info(
        ...
        _param = self._api230_logout_post_serialize(
            x_request_id = x_request_id,
    ...
    def _api230_logout_post_serialize(
        self,
        x_request_id,
        x_auth_token,
    ) -> RequestSerialized:
