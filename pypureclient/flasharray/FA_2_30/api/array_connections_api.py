...
class ArrayConnectionsApi:
    ...
    def api230_array_connections_connection_key_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api230_array_connections_connection_key_get_with_http_info(authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api230_array_connections_connection_key_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api230_array_connections_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api230_array_connections_delete_with_http_info(authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api230_array_connections_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api230_array_connections_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api230_array_connections_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api230_array_connections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api230_array_connections_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api230_array_connections_patch_with_http_info(array_connection, authorization, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api230_array_connections_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api230_array_connections_path_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api230_array_connections_path_get_with_http_info(authorization, x_request_id, continuation_token, filter, limit, names, offset, sort, total_item_count, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api230_array_connections_path_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api230_array_connections_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api230_array_connections_post_with_http_info(array_connection, authorization, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api230_array_connections_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
