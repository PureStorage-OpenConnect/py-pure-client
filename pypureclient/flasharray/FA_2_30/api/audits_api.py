...
from typing_extensions import Annotated
from pypureclient.flasharray.FA_2_30.models.audit_get_response import AuditGetResponse
...
class AuditsApi:
    ...
    def api230_audits_get_with_http_info(
        ...
        _param = self._api230_audits_get_serialize(
    ...
    def _api230_audits_get_serialize(
        self,
        authorization,
        x_request_id,
        continuation_token,
