...
from pypureclient.flasharray.FA_2_30.models.directory_snapshot_get_response import DirectorySnapshotGetResponse
from pypureclient.flasharray.FA_2_30.models.directory_snapshot_patch import DirectorySnapshotPatch
from pypureclient.flasharray.FA_2_30.models.directory_snapshot_post import DirectorySnapshotPost
from pypureclient.flasharray.FA_2_30.models.directory_snapshot_response import DirectorySnapshotResponse
...
class DirectorySnapshotsApi:
    ...
    def api230_directory_snapshots_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api230_directory_snapshots_delete_with_http_info(authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api230_directory_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api230_directory_snapshots_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api230_directory_snapshots_get_with_http_info(authorization, x_request_id, continuation_token, destroyed, filter, ids, limit, names, offset, sort, source_ids, source_names, total_item_count, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api230_directory_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api230_directory_snapshots_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api230_directory_snapshots_patch_with_http_info(directory_snapshot, authorization, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api230_directory_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api230_directory_snapshots_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api230_directory_snapshots_post_with_http_info(directory_snapshot, authorization, x_request_id, source_ids, source_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api230_directory_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
