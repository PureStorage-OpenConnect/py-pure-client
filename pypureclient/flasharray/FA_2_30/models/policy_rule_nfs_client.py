...
from pypureclient.flasharray.FA_2_30.models.fixed_reference_with_type import FixedReferenceWithType
...
class PolicyRuleNfsClient(BaseModel):
    ...
    nfs_version: Optional[List[StrictStr]] = Field(default=None, description="The NFS protocol version allowed for the export. Valid values are `nfsv3` and `nfsv4`.")
    ...
    __properties: ClassVar[List[str]] = ["access", "client", "name", "policy", "permission", "anongid", "anonuid", "destroyed", "time_remaining", "nfs_version", "security"]
