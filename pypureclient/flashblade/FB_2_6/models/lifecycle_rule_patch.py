...
class LifecycleRulePatch(BaseModel):
    ...
    __properties = ["abort_incomplete_multipart_uploads_after", "keep_current_version_for", "keep_current_version_until", "enabled", "keep_previous_version_for", "prefix"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LifecycleRulePatch:
        """Create an instance of LifecycleRulePatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LifecycleRulePatch:
        """Create an instance of LifecycleRulePatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LifecycleRulePatch.parse_obj(obj)

        _obj = LifecycleRulePatch.construct(_fields_set=None, **{
