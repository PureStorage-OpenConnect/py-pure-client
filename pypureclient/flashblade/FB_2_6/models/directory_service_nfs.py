...
class DirectoryServiceNfs(BaseModel):
    ...
    __properties = ["nis_domains", "nis_servers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryServiceNfs:
        """Create an instance of DirectoryServiceNfs from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryServiceNfs:
        """Create an instance of DirectoryServiceNfs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryServiceNfs.parse_obj(obj)

        _obj = DirectoryServiceNfs.construct(_fields_set=None, **{
