...
class ArrayConnectionsApi:
    ...
    def api26_array_connections_connection_key_post_with_http_info(
        ...
        _param = self._api26_array_connections_connection_key_post_serialize(
        )
    ...
    def _api26_array_connections_connection_key_post_serialize(
        self,
    ) -> RequestSerialized:
    ...
    def api26_array_connections_performance_replication_get_with_http_info(
        ...
        _param = self._api26_array_connections_performance_replication_get_serialize(
            continuation_token = continuation_token,
            end_time = end_time,
            filter = filter,
            ids = ids,
    ...
    def _api26_array_connections_performance_replication_get_serialize(
        self,
        continuation_token,
        end_time,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.6/array-connections/performance/replication',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
