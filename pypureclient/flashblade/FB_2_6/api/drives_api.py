...
from pypureclient.flashblade.FB_2_6.models.drive_get_response import DriveGetResponse
...
class DrivesApi:
    ...
    def api26_drives_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_drives_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, total_only, async_req=True)
        >>> result = thread.get()
