...
from pypureclient.flashblade.FB_2_6.models.hardware_connector import HardwareConnector
from pypureclient.flashblade.FB_2_6.models.hardware_connector_get_response import HardwareConnectorGetResponse
from pypureclient.flashblade.FB_2_6.models.hardware_connector_performance_get_response import HardwareConnectorPerformanceGetResponse
from pypureclient.flashblade.FB_2_6.models.hardware_connector_response import HardwareConnectorResponse
...
class HardwareConnectorsApi:
    ...
    def api26_hardware_connectors_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_hardware_connectors_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api26_hardware_connectors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_hardware_connectors_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_hardware_connectors_patch_with_http_info(hardware_connector, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_hardware_connectors_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_hardware_connectors_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_hardware_connectors_performance_get_with_http_info(end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_hardware_connectors_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
