...
from pypureclient.flashblade.FB_2_6.models.policy import Policy
from pypureclient.flashblade.FB_2_6.models.policy_file_system_snapshot_get_response import PolicyFileSystemSnapshotGetResponse
from pypureclient.flashblade.FB_2_6.models.policy_get_response import PolicyGetResponse
...
from pypureclient.flashblade.FB_2_6.models.policy_patch import PolicyPatch
from pypureclient.flashblade.FB_2_6.models.policy_response import PolicyResponse
...
class PoliciesSnapshotApi:
    ...
    def api26_policies_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_policies_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api26_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_policies_file_system_replica_links_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_policies_file_system_replica_links_delete_with_http_info(local_file_system_ids, local_file_system_names, member_ids, policy_ids, policy_names, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_policies_file_system_replica_links_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_policies_file_system_replica_links_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_policies_file_system_replica_links_get_with_http_info(continuation_token, filter, limit, local_file_system_ids, local_file_system_names, member_ids, offset, policy_ids, policy_names, remote_file_system_ids, remote_file_system_names, remote_ids, remote_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_policies_file_system_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_policies_file_system_replica_links_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_policies_file_system_replica_links_post_with_http_info(local_file_system_ids, local_file_system_names, member_ids, policy_ids, policy_names, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_policies_file_system_replica_links_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_policies_file_system_snapshots_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_policies_file_system_snapshots_delete_with_http_info(member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_policies_file_system_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_policies_file_system_snapshots_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_policies_file_system_snapshots_get_with_http_info(continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_policies_file_system_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_policies_file_systems_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_policies_file_systems_delete_with_http_info(member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_policies_file_systems_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_policies_file_systems_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_policies_file_systems_get_with_http_info(continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_policies_file_systems_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_policies_file_systems_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_policies_file_systems_post_with_http_info(member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_policies_file_systems_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_policies_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api26_policies_members_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_policies_members_get_with_http_info(continuation_token, filter, limit, local_file_system_ids, local_file_system_names, member_ids, member_names, member_types, offset, policy_ids, policy_names, remote_file_system_ids, remote_file_system_names, remote_ids, remote_names, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api26_policies_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_policies_patch_with_http_info(policy, destroy_snapshots, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api26_policies_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_policies_post_with_http_info(names, policy, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
