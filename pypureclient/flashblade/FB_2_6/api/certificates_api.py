...
class CertificatesApi(object):
    ...
    def api26_certificates_certificate_groups_delete_with_http_info(
        ...
        >>> thread = api.api26_certificates_certificate_groups_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api26_certificates_certificate_groups_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api26_certificates_certificate_groups_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api26_certificates_certificate_groups_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api26_certificates_certificate_groups_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api26_certificates_certificate_groups_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api26_certificates_certificate_groups_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api26_certificates_uses_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api26_certificates_uses_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api26_certificates_uses_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api26_certificates_uses_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
