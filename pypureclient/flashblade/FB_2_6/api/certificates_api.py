...
class CertificatesApi(object):
    ...
    def api26_certificates_certificate_groups_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api26_certificates_certificate_groups_get`, must be a value greater than or equal to `0`")
    ...
    def api26_certificates_uses_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api26_certificates_uses_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
