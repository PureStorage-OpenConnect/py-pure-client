...
class RDLApi:
    ...
    def api26_rapid_data_locking_get_with_http_info(
        ...
        _param = self._api26_rapid_data_locking_get_serialize(
        )
    ...
    def _api26_rapid_data_locking_get_serialize(
        self,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.6/rapid-data-locking',
    ...
    def api26_rapid_data_locking_patch_with_http_info(
        ...
        _param = self._api26_rapid_data_locking_patch_serialize(
    ...
    def _api26_rapid_data_locking_patch_serialize(
        self,
        rapid_data_locking,
    ) -> RequestSerialized:
    ...
    def api26_rapid_data_locking_rotate_post_with_http_info(
        ...
        _param = self._api26_rapid_data_locking_rotate_post_serialize(
        )
    ...
    def _api26_rapid_data_locking_rotate_post_serialize(
        self,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2.6/rapid-data-locking/rotate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api26_rapid_data_locking_test_get_with_http_info(
        ...
        _param = self._api26_rapid_data_locking_test_get_serialize(
        )
    ...
    def _api26_rapid_data_locking_test_get_serialize(
        self,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.6/rapid-data-locking/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
