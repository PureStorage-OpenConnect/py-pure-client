...
class DNSApi:
    ...
    def api26_dns_get_with_http_info(
        ...
        _param = self._api26_dns_get_serialize(
    ...
    def api26_dns_patch_with_http_info(
        ...
        _param = self._api26_dns_patch_serialize(
            dns = dns,
            ids = ids,
            names = names,
        )
    ...
    def _api26_dns_patch_serialize(
        self,
        dns,
        ids,
        names,
