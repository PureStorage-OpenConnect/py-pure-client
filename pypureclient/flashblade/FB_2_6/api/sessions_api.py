...
from pypureclient.flashblade.FB_2_6.models.session_get_response import SessionGetResponse
...
class SessionsApi:
    ...
    def api26_sessions_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_sessions_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api26_sessions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
