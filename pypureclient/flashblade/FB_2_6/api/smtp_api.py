...
from pypureclient.flashblade.FB_2_6.models.smtp_server_get_response import SmtpServerGetResponse
from pypureclient.flashblade.FB_2_6.models.smtp_server_response import SmtpServerResponse
...
class SMTPApi:
    ...
    def api26_smtp_servers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api26_smtp_servers_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
