...
class BucketReplicaLinksApi:
    ...
    def api26_bucket_replica_links_delete_with_http_info(
        ...
        _param = self._api26_bucket_replica_links_delete_serialize(
            ids = ids,
    ...
    def _api26_bucket_replica_links_delete_serialize(
        self,
        ids,
        local_bucket_ids,
        local_bucket_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.6/bucket-replica-links',
    ...
    def api26_bucket_replica_links_get_with_http_info(
        ...
        _param = self._api26_bucket_replica_links_get_serialize(
    ...
    def _api26_bucket_replica_links_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api26_bucket_replica_links_patch_with_http_info(
        ...
        _param = self._api26_bucket_replica_links_patch_serialize(
    ...
    def _api26_bucket_replica_links_patch_serialize(
        self,
        bucket_replica_link,
        ids,
        local_bucket_ids,
    ...
    def api26_bucket_replica_links_post_with_http_info(
        ...
        _param = self._api26_bucket_replica_links_post_serialize(
            bucket_replica_link = bucket_replica_link,
            local_bucket_names = local_bucket_names,
            local_bucket_ids = local_bucket_ids,
            remote_bucket_names = remote_bucket_names,
    ...
    def _api26_bucket_replica_links_post_serialize(
        self,
        bucket_replica_link,
        local_bucket_names,
        local_bucket_ids,
