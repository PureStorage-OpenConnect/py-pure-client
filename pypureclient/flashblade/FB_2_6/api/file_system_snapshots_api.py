...
from pypureclient.flashblade.FB_2_6.models.file_system_snapshot_get_response import FileSystemSnapshotGetResponse
...
from pypureclient.flashblade.FB_2_6.models.file_system_snapshot_post import FileSystemSnapshotPost
from pypureclient.flashblade.FB_2_6.models.file_system_snapshot_response import FileSystemSnapshotResponse
...
class FileSystemSnapshotsApi:
    ...
    def api26_file_system_snapshots_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api26_file_system_snapshots_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api26_file_system_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.6/file-system-snapshots', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api26_file_system_snapshots_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api26_file_system_snapshots_get_with_http_info(continuation_token, destroyed, filter, ids, limit, names_or_owner_names, offset, owner_ids, sort, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_file_system_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.6/file-system-snapshots', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api26_file_system_snapshots_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api26_file_system_snapshots_patch_with_http_info(file_system_snapshot, ids, latest_replica, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_file_system_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.6/file-system-snapshots', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api26_file_system_snapshots_policies_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api26_file_system_snapshots_policies_delete_with_http_info(member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_file_system_snapshots_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.6/file-system-snapshots/policies', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api26_file_system_snapshots_policies_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        limit: Annotated[Optional[conint(strict=True, ge=0)], Field(description="Limit the size of the response to the specified number of resources. A `limit` of `0` can be used to get the number of resources without getting all of the resources. It will be returned in the `total_item_count` field. If a client asks for a page size larger than the available number, the request is still valid. In that case the server just returns the available number of items, disregarding the client's page size request.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api26_file_system_snapshots_policies_get_with_http_info(continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_file_system_snapshots_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.6/file-system-snapshots/policies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api26_file_system_snapshots_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api26_file_system_snapshots_post_with_http_info(send, source_ids, source_names, targets, file_system_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_file_system_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.6/file-system-snapshots', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api26_file_system_snapshots_transfer_delete_with_http_info(
        self,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api26_file_system_snapshots_transfer_delete_with_http_info(ids, names, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_file_system_snapshots_transfer_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.6/file-system-snapshots/transfer', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api26_file_system_snapshots_transfer_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api26_file_system_snapshots_transfer_get_with_http_info(continuation_token, filter, ids, limit, names_or_owner_names, offset, sort, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api26_file_system_snapshots_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.6/file-system-snapshots/transfer', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
