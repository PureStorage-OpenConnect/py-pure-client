...
class KeytabsApi:
    ...
    def api26_keytabs_delete_with_http_info(
        ...
        _param = self._api26_keytabs_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api26_keytabs_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
    ...
    def api26_keytabs_download_get_with_http_info(
        ...
        _param = self._api26_keytabs_download_get_serialize(
    ...
    def _api26_keytabs_download_get_serialize(
        self,
        keytab_ids,
        keytab_names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.6/keytabs/download',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api26_keytabs_get_with_http_info(
        ...
        _param = self._api26_keytabs_get_serialize(
    ...
    def _api26_keytabs_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api26_keytabs_post_with_http_info(
        ...
        _param = self._api26_keytabs_post_serialize(
            keytab = keytab,
    ...
    def _api26_keytabs_post_serialize(
        self,
        keytab,
        name_prefixes,
    ) -> RequestSerialized:
    ...
    def api26_keytabs_upload_post_with_http_info(
        ...
        _param = self._api26_keytabs_upload_post_serialize(
    ...
    def _api26_keytabs_upload_post_serialize(
        self,
        keytab_file,
        name_prefixes,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2.6/keytabs/upload',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
