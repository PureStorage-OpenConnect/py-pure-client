...
from pypureclient.flashblade.FB_2_23.models.password_policies_get_response import PasswordPoliciesGetResponse
from pypureclient.flashblade.FB_2_23.models.password_policies_response import PasswordPoliciesResponse
...
class PoliciesPasswordApi:
    ...
    def api223_password_policies_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api223_password_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/password-policies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api223_password_policies_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_password_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/password-policies', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
