...
from pypureclient.flashblade.FB_2_23.models.remote_arrays_response import RemoteArraysResponse
from typing import Optional
...
class RemoteArraysApi:
    ...
    def api223_remote_arrays_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api223_remote_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
