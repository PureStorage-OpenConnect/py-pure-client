...
from pypureclient.flashblade.FB_2_23.models.syslog_server_get_response import SyslogServerGetResponse
from pypureclient.flashblade.FB_2_23.models.syslog_server_patch import SyslogServerPatch
from pypureclient.flashblade.FB_2_23.models.syslog_server_post import SyslogServerPost
from pypureclient.flashblade.FB_2_23.models.syslog_server_response import SyslogServerResponse
from pypureclient.flashblade.FB_2_23.models.syslog_server_settings import SyslogServerSettings
from pypureclient.flashblade.FB_2_23.models.syslog_server_settings_get_response import SyslogServerSettingsGetResponse
from pypureclient.flashblade.FB_2_23.models.syslog_server_settings_response import SyslogServerSettingsResponse
from pypureclient.flashblade.FB_2_23.models.test_result_get_response import TestResultGetResponse
from typing import Optional
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api223_syslog_servers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_syslog_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_syslog_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_syslog_servers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_syslog_servers_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_syslog_servers_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_syslog_servers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
