...
from pypureclient.flashblade.FB_2_23.models.object_store_virtual_host_get_response import ObjectStoreVirtualHostGetResponse
from pypureclient.flashblade.FB_2_23.models.object_store_virtual_host_patch import ObjectStoreVirtualHostPatch
from pypureclient.flashblade.FB_2_23.models.object_store_virtual_host_response import ObjectStoreVirtualHostResponse
from typing import Optional
...
class ObjectStoreVirtualHostsApi:
    ...
    def api223_object_store_virtual_hosts_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api223_object_store_virtual_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/object-store-virtual-hosts', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api223_object_store_virtual_hosts_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_object_store_virtual_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/object-store-virtual-hosts', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api223_object_store_virtual_hosts_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_object_store_virtual_hosts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/object-store-virtual-hosts', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api223_object_store_virtual_hosts_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_object_store_virtual_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/object-store-virtual-hosts', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
