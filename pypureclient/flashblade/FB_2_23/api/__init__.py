...
__class_apis_dict = {
    'APIClientsApi': __LazyApiLoader('pypureclient.flashblade._common.apis.api_clients_api_v_2_17', 'APIClientsApi', '2.23'),
    ...
    'AlertWatchersApi': __LazyApiLoader('pypureclient.flashblade._common.apis.alert_watchers_api_v_2_17', 'AlertWatchersApi', '2.23'),
    'AlertsApi': __LazyApiLoader('pypureclient.flashblade._common.apis.alerts_api_v_2_17', 'AlertsApi', '2.23'),
    ...
    'AuthorizationApi': __LazyApiLoader('pypureclient.flashblade._common.apis.authorization_api_v_2_17', 'AuthorizationApi', '2.23'),
    'BladesApi': __LazyApiLoader('pypureclient.flashblade._common.apis.blades_api_v_2_17', 'BladesApi', '2.23'),
    ...
    'CertificateGroupsApi': __LazyApiLoader('pypureclient.flashblade._common.apis.certificate_groups_api_v_2_17', 'CertificateGroupsApi', '2.23'),
    ...
    'DNSApi': __LazyApiLoader('pypureclient.flashblade._common.apis.dns_api_v_2_17', 'DNSApi', '2.23'),
    ...
    'DrivesApi': __LazyApiLoader('pypureclient.flashblade._common.apis.drives_api_v_2_17', 'DrivesApi', '2.23'),
    ...
    'HardwareApi': __LazyApiLoader('pypureclient.flashblade._common.apis.hardware_api_v_2_17', 'HardwareApi', '2.23'),
    'HardwareConnectorsApi': __LazyApiLoader('pypureclient.flashblade._common.apis.hardware_connectors_api_v_2_17', 'HardwareConnectorsApi', '2.23'),
    'KMIPApi': __LazyApiLoader('pypureclient.flashblade._common.apis.kmip_api_v_2_17', 'KMIPApi', '2.23'),
    'KeytabsApi': __LazyApiLoader('pypureclient.flashblade._common.apis.keytabs_api_v_2_17', 'KeytabsApi', '2.23'),
    ...
    'LogsApi': __LazyApiLoader('pypureclient.flashblade._common.apis.logs_api_v_2_17', 'LogsApi', '2.23'),
    'MaintenanceWindowsApi': __LazyApiLoader('pypureclient.flashblade._common.apis.maintenance_windows_api_v_2_17', 'MaintenanceWindowsApi', '2.23'),
    ...
    'PoliciesNetworkAccessApi': __LazyApiLoader('pypureclient.flashblade._common.apis.policies_network_access_api_v_2_17', 'PoliciesNetworkAccessApi', '2.23'),
    ...
    'PoliciesPasswordApi': __LazyApiLoader('pypureclient.flashblade._common.apis.policies_password_api_v_2_17', 'PoliciesPasswordApi', '2.23'),
    ...
    'PoliciesSSHCertificateAuthorityApi': __LazyApiLoader('pypureclient.flashblade._common.apis.policies_ssh_certificate_authority_api_v_2_17', 'PoliciesSSHCertificateAuthorityApi', '2.23'),
    ...
    'PublicKeysApi': __LazyApiLoader('pypureclient.flashblade._common.apis.public_keys_api_v_2_17', 'PublicKeysApi', '2.23'),
    'QuotasApi': __LazyApiLoader('pypureclient.flashblade._common.apis.quotas_api_v_2_22', 'QuotasApi', '2.23'),
    'RDLApi': __LazyApiLoader('pypureclient.flashblade._common.apis.rdl_api_v_2_17', 'RDLApi', '2.23'),
    ...
    'RolesApi': __LazyApiLoader('pypureclient.flashblade._common.apis.roles_api_v_2_17', 'RolesApi', '2.23'),
    'SAML2SSOApi': __LazyApiLoader('pypureclient.flashblade._common.apis.saml2_sso_api_v_2_17', 'SAML2SSOApi', '2.23'),
    'SMTPApi': __LazyApiLoader('pypureclient.flashblade._common.apis.smtp_api_v_2_17', 'SMTPApi', '2.23'),
    'SNMPAgentsApi': __LazyApiLoader('pypureclient.flashblade._common.apis.snmp_agents_api_v_2_17', 'SNMPAgentsApi', '2.23'),
    'SNMPManagersApi': __LazyApiLoader('pypureclient.flashblade._common.apis.snmp_managers_api_v_2_17', 'SNMPManagersApi', '2.23'),
    'ServersApi': __LazyApiLoader('pypureclient.flashblade._common.apis.servers_api_v_2_22', 'ServersApi', '2.23'),
    'SessionsApi': __LazyApiLoader('pypureclient.flashblade._common.apis.sessions_api_v_2_17', 'SessionsApi', '2.23'),
    'SoftwareApi': __LazyApiLoader('pypureclient.flashblade._common.apis.software_api_v_2_17', 'SoftwareApi', '2.23'),
    'SubnetsApi': __LazyApiLoader('pypureclient.flashblade._common.apis.subnets_api_v_2_17', 'SubnetsApi', '2.23'),
    'SupportApi': __LazyApiLoader('pypureclient.flashblade._common.apis.support_api_v_2_17', 'SupportApi', '2.23'),
    'SupportDiagnosticsApi': __LazyApiLoader('pypureclient.flashblade._common.apis.support_diagnostics_api_v_2_17', 'SupportDiagnosticsApi', '2.23'),
    ...
    'VerificationKeysApi': __LazyApiLoader('pypureclient.flashblade._common.apis.verification_keys_api_v_2_17', 'VerificationKeysApi', '2.23'),
