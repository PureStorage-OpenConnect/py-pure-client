...
from pypureclient.flashblade.FB_2_23.models.hardware_connector import HardwareConnector
from pypureclient.flashblade.FB_2_23.models.hardware_connector_get_response import HardwareConnectorGetResponse
from pypureclient.flashblade.FB_2_23.models.hardware_connector_performance_get_response import HardwareConnectorPerformanceGetResponse
from pypureclient.flashblade.FB_2_23.models.hardware_connector_response import HardwareConnectorResponse
from typing import Optional
...
class HardwareConnectorsApi:
    ...
    def api223_hardware_connectors_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api223_hardware_connectors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api223_hardware_connectors_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hardware_connectors_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/hardware-connectors', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api223_hardware_connectors_performance_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_hardware_connectors_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/hardware-connectors/performance', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
