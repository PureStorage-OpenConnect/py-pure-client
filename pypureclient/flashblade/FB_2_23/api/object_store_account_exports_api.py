...
from pypureclient.flashblade.FB_2_23.models.object_store_account_export_get_response import ObjectStoreAccountExportGetResponse
from pypureclient.flashblade.FB_2_23.models.object_store_account_export_patch import ObjectStoreAccountExportPatch
from pypureclient.flashblade.FB_2_23.models.object_store_account_export_post import ObjectStoreAccountExportPost
from pypureclient.flashblade.FB_2_23.models.object_store_account_export_response import ObjectStoreAccountExportResponse
from typing import Optional
...
class ObjectStoreAccountExportsApi:
    ...
    def api223_object_store_account_exports_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api223_object_store_account_exports_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/object-store-account-exports', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api223_object_store_account_exports_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_object_store_account_exports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/object-store-account-exports', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api223_object_store_account_exports_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_object_store_account_exports_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/object-store-account-exports', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api223_object_store_account_exports_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_object_store_account_exports_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/object-store-account-exports', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
