...
from pypureclient.flashblade.FB_2_23.models.array_connection_get_response import ArrayConnectionGetResponse
from pypureclient.flashblade.FB_2_23.models.array_connection_key_get_response import ArrayConnectionKeyGetResponse
from pypureclient.flashblade.FB_2_23.models.array_connection_key_response import ArrayConnectionKeyResponse
from pypureclient.flashblade.FB_2_23.models.array_connection_path_get_response import ArrayConnectionPathGetResponse
from pypureclient.flashblade.FB_2_23.models.array_connection_post import ArrayConnectionPost
from pypureclient.flashblade.FB_2_23.models.array_connection_response import ArrayConnectionResponse
from pypureclient.flashblade.FB_2_23.models.connection_relationship_performance_replication_get_resp import ConnectionRelationshipPerformanceReplicationGetResp
from typing import Optional
...
class ArrayConnectionsApi:
    ...
    def api223_array_connections_connection_key_post_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_array_connections_connection_key_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/array-connections/connection-key', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api223_array_connections_performance_replication_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="A token used to retrieve the next page of data with some consistency guaranteed. The token is a Base64 encoded value. Set `continuation_token` to the system-generated token taken from the `x-next-token` header field of the response. A query has reached its last page when the response does not include a token. Pagination requires the `limit` and `continuation_token` query parameters.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_array_connections_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.23/array-connections/performance/replication', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
