...
class NamingPattern(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NamingPattern:
        """Create an instance of NamingPattern from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NamingPattern:
        """Create an instance of NamingPattern from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NamingPattern.parse_obj(obj)

        _obj = NamingPattern.construct(_fields_set=None, **{
