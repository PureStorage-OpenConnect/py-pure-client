...
from pypureclient.flashblade.FB_2_23.models.error_context_response_errors import ErrorContextResponseErrors
from pypureclient.flashblade.FB_2_23.models.fixed_reference import FixedReference
from pypureclient.flashblade.FB_2_23.models.policy_member_with_remote import PolicyMemberWithRemote


class PolicyMemberWithRemoteGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyMemberWithRemote)] = Field(default=None, description="A list of members for policies.")
    ...
    __properties = ["continuation_token", "total_item_count", "context", "items", "errors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyMemberWithRemoteGetResponse:
        """Create an instance of PolicyMemberWithRemoteGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyMemberWithRemoteGetResponse:
        """Create an instance of PolicyMemberWithRemoteGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyMemberWithRemoteGetResponse.parse_obj(obj)

        _obj = PolicyMemberWithRemoteGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyMemberWithRemote.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
