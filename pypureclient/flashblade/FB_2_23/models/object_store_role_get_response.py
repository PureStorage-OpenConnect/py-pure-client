...
from pypureclient.flashblade.FB_2_23.models.object_store_role import ObjectStoreRole


class ObjectStoreRoleGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ObjectStoreRole)] = Field(default=None, description="A list of object store roles.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreRoleGetResponse:
        """Create an instance of ObjectStoreRoleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreRoleGetResponse:
        """Create an instance of ObjectStoreRoleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreRoleGetResponse.parse_obj(obj)

        _obj = ObjectStoreRoleGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ObjectStoreRole.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
