...
from pypureclient.flashblade.FB_2_23.models.fixed_reference import FixedReference
from pypureclient.flashblade.FB_2_23.models.preset_workload_directory_configuration import PresetWorkloadDirectoryConfiguration
from pypureclient.flashblade.FB_2_23.models.preset_workload_export_configurations import PresetWorkloadExportConfigurations
from pypureclient.flashblade.FB_2_23.models.preset_workload_parameter import PresetWorkloadParameter
from pypureclient.flashblade.FB_2_23.models.preset_workload_periodic_replication_configuration import PresetWorkloadPeriodicReplicationConfiguration
from pypureclient.flashblade.FB_2_23.models.preset_workload_placement_configuration import PresetWorkloadPlacementConfiguration
from pypureclient.flashblade.FB_2_23.models.preset_workload_qos_configuration import PresetWorkloadQosConfiguration
from pypureclient.flashblade.FB_2_23.models.preset_workload_quota_configuration import PresetWorkloadQuotaConfiguration
from pypureclient.flashblade.FB_2_23.models.preset_workload_snapshot_configuration import PresetWorkloadSnapshotConfiguration
from pypureclient.flashblade.FB_2_23.models.preset_workload_volume_configuration import PresetWorkloadVolumeConfiguration
from pypureclient.flashblade.FB_2_23.models.preset_workload_workload_tag import PresetWorkloadWorkloadTag
...
class PresetWorkload(BaseModel):
    ...
    export_configurations: Optional[PresetWorkloadExportConfigurations] = Field(default=None, description="NFS, SMB, and SMB share policy configuration to be specified in file system and directory exports.")
    ...
    quota_configurations: Optional[conlist(PresetWorkloadQuotaConfiguration, max_items=5)] = Field(default=None, description="The quota configurations that can be applied to storage resources (such as file systems and directories) within the preset.")
    ...
    __properties = ["id", "name", "context", "description", "directory_configurations", "export_configurations", "parameters", "periodic_replication_configurations", "placement_configurations", "platform_features", "qos_configurations", "quota_configurations", "revision", "snapshot_configurations", "volume_configurations", "workload_tags", "workload_type"]
