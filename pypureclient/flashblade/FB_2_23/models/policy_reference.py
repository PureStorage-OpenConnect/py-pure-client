...
class PolicyReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyReference:
        """Create an instance of PolicyReference from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyReference:
        """Create an instance of PolicyReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyReference.parse_obj(obj)

        _obj = PolicyReference.construct(_fields_set=None, **{
