...
from pypureclient.flashblade.FB_2_23.models.preset_workload_export_configuration_nfs_policy import PresetWorkloadExportConfigurationNfsPolicy


class PresetWorkloadExportConfigurationNfs(BaseModel):
    """
    ...
    policy_configuration: Optional[PresetWorkloadExportConfigurationNfsPolicy] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PresetWorkloadExportConfigurationNfs:
        """Create an instance of PresetWorkloadExportConfigurationNfs from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PresetWorkloadExportConfigurationNfs:
        """Create an instance of PresetWorkloadExportConfigurationNfs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PresetWorkloadExportConfigurationNfs.parse_obj(obj)

        _obj = PresetWorkloadExportConfigurationNfs.construct(_fields_set=None, **{
            ...
            "policy_configuration": PresetWorkloadExportConfigurationNfsPolicy.from_dict(obj.get("policy_configuration")) if obj.get("policy_configuration") is not None else None
        })
        return _obj
