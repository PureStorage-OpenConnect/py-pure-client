...
class ArrayConnectionPath(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="The type of path. Valid values include `async-replication` and `fleet-management`.")
    __properties = ["id", "context", "destination", "remote", "source", "status", "status_details", "type"]
