...
class NfsExportPolicyRuleBasePatchRequest(BaseModel):
    """
    ...
    __properties = ["id", "name", "access", "anongid", "anonuid", "atime", "client", "fileid_32bit", "permission", "required_transport_security", "secure", "security"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NfsExportPolicyRuleBasePatchRequest:
        """Create an instance of NfsExportPolicyRuleBasePatchRequest from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NfsExportPolicyRuleBasePatchRequest:
        """Create an instance of NfsExportPolicyRuleBasePatchRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NfsExportPolicyRuleBasePatchRequest.parse_obj(obj)

        _obj = NfsExportPolicyRuleBasePatchRequest.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
