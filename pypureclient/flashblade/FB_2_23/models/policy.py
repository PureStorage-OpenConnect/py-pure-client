...
from pypureclient.flashblade.FB_2_23.models.policy_rule import PolicyRule
...
class Policy(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "context", "retention_lock", "rules", "workload"]
