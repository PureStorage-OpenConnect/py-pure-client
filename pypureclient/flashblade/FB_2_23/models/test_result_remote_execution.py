...
from pypureclient.flashblade.FB_2_23.models.test_result_with_context import TestResultWithContext


class TestResultRemoteExecution(BaseModel):
    """
    TestResultRemoteExecution
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultRemoteExecution:
        """Create an instance of TestResultRemoteExecution from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TestResultRemoteExecution:
        """Create an instance of TestResultRemoteExecution from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultRemoteExecution.parse_obj(obj)

        _obj = TestResultRemoteExecution.construct(_fields_set=None, **{
