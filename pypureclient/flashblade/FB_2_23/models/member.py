...
class Member(BaseModel):
    ...
    Member
    """
    group: Optional[Reference] = Field(default=None, description="A reference to a group object that has the referenced member object as a member.")
    member: Optional[Reference] = Field(default=None, description="A reference to an object that is a member of the referenced group.")
    ...
    def from_dict(cls, obj: dict) -> Member:
        ...
        _obj = Member.construct(_fields_set=None, **{
