...
from pypureclient.flashblade.FB_2_23.models.fixed_reference_without_type import FixedReferenceWithoutType
...
class Tag(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> Tag:
        ...
        _obj = Tag.construct(_fields_set=None, **{
            "context": FixedReference.from_dict(obj.get("context")) if obj.get("context") is not None else None,
            "copyable": obj.get("copyable"),
            "key": obj.get("key"),
            "namespace": obj.get("namespace"),
            "resource": FixedReferenceWithoutType.from_dict(obj.get("resource")) if obj.get("resource") is not None else None,
            "value": obj.get("value")
        })
        return _obj
