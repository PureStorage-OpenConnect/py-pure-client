...
class PasswordPolicy(BaseModel):
    ...
    max_password_age: Optional[conint(strict=True, le=8639913600000, ge=0)] = Field(default=None, description="The maximum age of password before password change is required. Ranges from 1 day to 99999 days with 1 hour precision. 0ms value means password expiration is disabled. Maximum age is always greater than the minimum password age.")
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "enforce_dictionary_check", "enforce_username_check", "lockout_duration", "max_login_attempts", "max_password_age", "min_character_groups", "min_characters_per_group", "min_password_age", "min_password_length", "password_history"]
