...
from pypureclient.flashblade.FB_2_18.models.api_client import ApiClient
from pypureclient.flashblade.FB_2_18.models.api_clients_post import ApiClientsPost
from pypureclient.flashblade.FB_2_18.models.api_clients_response import ApiClientsResponse
from typing import Optional
...
class APIClientsApi:
    ...
    def api218_api_clients_delete_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api218_api_clients_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api218_api_clients_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api218_api_clients_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api218_api_clients_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api218_api_clients_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api218_api_clients_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api218_api_clients_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
