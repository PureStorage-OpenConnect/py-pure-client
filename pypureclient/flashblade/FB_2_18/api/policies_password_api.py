...
from pypureclient.flashblade.FB_2_18.models.password_policies_get_response import PasswordPoliciesGetResponse
from pypureclient.flashblade.FB_2_18.models.password_policies_response import PasswordPoliciesResponse
from pypureclient.flashblade.FB_2_18.models.password_policy import PasswordPolicy
from typing import Optional
...
class PoliciesPasswordApi:
    ...
    def api218_password_policies_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api218_password_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.18/password-policies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api218_password_policies_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api218_password_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.18/password-policies', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
