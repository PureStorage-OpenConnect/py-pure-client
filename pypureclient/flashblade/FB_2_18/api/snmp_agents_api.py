...
from pypureclient.flashblade.FB_2_18.models.snmp_agent import SnmpAgent
from pypureclient.flashblade.FB_2_18.models.snmp_agent_get_response import SnmpAgentGetResponse
from pypureclient.flashblade.FB_2_18.models.snmp_agent_mib_response import SnmpAgentMibResponse
from pypureclient.flashblade.FB_2_18.models.snmp_agent_response import SnmpAgentResponse
from typing import Optional
...
class SNMPAgentsApi:
    ...
    def api218_snmp_agents_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api218_snmp_agents_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api218_snmp_agents_mib_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api218_snmp_agents_mib_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api218_snmp_agents_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api218_snmp_agents_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
