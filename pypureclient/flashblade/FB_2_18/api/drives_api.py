...
from pypureclient.flashblade.FB_2_18.models.drive_get_response import DriveGetResponse
from typing import Optional
...
class DrivesApi:
    ...
    def api218_drives_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api218_drives_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
