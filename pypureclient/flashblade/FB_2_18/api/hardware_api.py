...
from pypureclient.flashblade.FB_2_18.models.hardware_get_response import HardwareGetResponse
from pypureclient.flashblade.FB_2_18.models.hardware_response import HardwareResponse
from typing import Optional
...
class HardwareApi:
    ...
    def api218_hardware_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api218_hardware_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api218_hardware_patch_with_http_info(
        self,
        hardware: Hardware,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api218_hardware_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
