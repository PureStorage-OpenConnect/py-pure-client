...
from pypureclient.flashblade.FB_2_18.models.support_get_response import SupportGetResponse
from pypureclient.flashblade.FB_2_18.models.support_response import SupportResponse
...
class SupportApi:
    ...
    def api218_support_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api218_support_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api218_support_patch_with_http_info(
        self,
        support: Support,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api218_support_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api218_support_test_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api218_support_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
