...
class FixedReferenceNameOnly(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixedReferenceNameOnly:
        """Create an instance of FixedReferenceNameOnly from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FixedReferenceNameOnly:
        """Create an instance of FixedReferenceNameOnly from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FixedReferenceNameOnly.parse_obj(obj)

        _obj = FixedReferenceNameOnly.construct(_fields_set=None, **{
            "name": obj.get("name")
        })
        return _obj
