...
from pypureclient.flashblade.FB_2_18.models.legal_hold_held_entity import LegalHoldHeldEntity


class LegalHoldsHeldEntitiesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(LegalHoldHeldEntity)] = Field(default=None, description="A list of held entities for legal holds.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LegalHoldsHeldEntitiesGetResponse:
        """Create an instance of LegalHoldsHeldEntitiesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LegalHoldsHeldEntitiesGetResponse:
        """Create an instance of LegalHoldsHeldEntitiesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LegalHoldsHeldEntitiesGetResponse.parse_obj(obj)

        _obj = LegalHoldsHeldEntitiesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [LegalHoldHeldEntity.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
