...
class MultiProtocolPost(BaseModel):
    """
    MultiProtocolPost
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MultiProtocolPost:
        """Create an instance of MultiProtocolPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> MultiProtocolPost:
        """Create an instance of MultiProtocolPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MultiProtocolPost.parse_obj(obj)

        _obj = MultiProtocolPost.construct(_fields_set=None, **{
