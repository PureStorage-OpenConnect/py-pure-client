...
from pypureclient.flashblade.FB_2_18.models.relationship_performance_replication import RelationshipPerformanceReplication


class ArrayPerformanceReplicationGetResp(BaseModel):
    """
    ...
    items: Optional[conlist(RelationshipPerformanceReplication)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayPerformanceReplicationGetResp:
        """Create an instance of ArrayPerformanceReplicationGetResp from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayPerformanceReplicationGetResp:
        """Create an instance of ArrayPerformanceReplicationGetResp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayPerformanceReplicationGetResp.parse_obj(obj)

        _obj = ArrayPerformanceReplicationGetResp.construct(_fields_set=None, **{
            ...
            "items": [RelationshipPerformanceReplication.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
