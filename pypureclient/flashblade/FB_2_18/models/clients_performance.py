...
class ClientsPerformance(BaseModel):
    """
    ClientsPerformance
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientsPerformance:
        """Create an instance of ClientsPerformance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ClientsPerformance:
        """Create an instance of ClientsPerformance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientsPerformance.parse_obj(obj)

        _obj = ClientsPerformance.construct(_fields_set=None, **{
            "name": obj.get("name"),
