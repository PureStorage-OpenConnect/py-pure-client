...
from pypureclient.flashblade.FB_2_18.models.policy_member_context import PolicyMemberContext


class WormDataPoliciesMembersGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyMemberContext)] = Field(default=None, description="A list of members for worm data policies.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WormDataPoliciesMembersGetResponse:
        """Create an instance of WormDataPoliciesMembersGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> WormDataPoliciesMembersGetResponse:
        """Create an instance of WormDataPoliciesMembersGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WormDataPoliciesMembersGetResponse.parse_obj(obj)

        _obj = WormDataPoliciesMembersGetResponse.construct(_fields_set=None, **{
