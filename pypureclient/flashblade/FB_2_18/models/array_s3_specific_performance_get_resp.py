...
from pypureclient.flashblade.FB_2_18.models.array_s3_specific_performance import ArrayS3SpecificPerformance
from pypureclient.flashblade.FB_2_18.models.error_context_response_errors import ErrorContextResponseErrors


class ArrayS3SpecificPerformanceGetResp(BaseModel):
    """
    ...
    items: Optional[conlist(ArrayS3SpecificPerformance)] = Field(default=None, description="A list of S3 specific array performance metrics objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayS3SpecificPerformanceGetResp:
        """Create an instance of ArrayS3SpecificPerformanceGetResp from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayS3SpecificPerformanceGetResp:
        """Create an instance of ArrayS3SpecificPerformanceGetResp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayS3SpecificPerformanceGetResp.parse_obj(obj)

        _obj = ArrayS3SpecificPerformanceGetResp.construct(_fields_set=None, **{
            ...
            "items": [ArrayS3SpecificPerformance.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
