...
class ClientsS3SpecificPerformance(BaseModel):
    """
    ...
    __properties = ["name", "others_per_sec", "read_buckets_per_sec", "read_objects_per_sec", "time", "usec_per_other_op", "usec_per_read_bucket_op", "usec_per_read_object_op", "usec_per_write_bucket_op", "usec_per_write_object_op", "write_buckets_per_sec", "write_objects_per_sec"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientsS3SpecificPerformance:
        """Create an instance of ClientsS3SpecificPerformance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ClientsS3SpecificPerformance:
        """Create an instance of ClientsS3SpecificPerformance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientsS3SpecificPerformance.parse_obj(obj)

        _obj = ClientsS3SpecificPerformance.construct(_fields_set=None, **{
            "name": obj.get("name"),
