...
from pypureclient.flashblade.FB_2_18.models.fixed_reference_no_resource_type import FixedReferenceNoResourceType
...
class FileSystemReplicaLink(BaseModel):
    ...
    __properties = ["id", "direction", "lag", "status_details", "context", "link_type", "local_file_system", "policies", "recovery_point", "remote", "remote_file_system", "status"]
