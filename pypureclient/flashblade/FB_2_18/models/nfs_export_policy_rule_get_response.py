...
from pypureclient.flashblade.FB_2_18.models.nfs_export_policy_rule import NfsExportPolicyRule


class NfsExportPolicyRuleGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(NfsExportPolicyRule)] = Field(default=None, description="Displays a list of all items after filtering.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NfsExportPolicyRuleGetResponse:
        """Create an instance of NfsExportPolicyRuleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NfsExportPolicyRuleGetResponse:
        """Create an instance of NfsExportPolicyRuleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NfsExportPolicyRuleGetResponse.parse_obj(obj)

        _obj = NfsExportPolicyRuleGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [NfsExportPolicyRule.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
