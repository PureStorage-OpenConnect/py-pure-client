...
class ReplicationPerformance(BaseModel):
    ...
    __properties = ["received_bytes_per_sec", "transmitted_bytes_per_sec"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReplicationPerformance:
        """Create an instance of ReplicationPerformance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ReplicationPerformance:
        """Create an instance of ReplicationPerformance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReplicationPerformance.parse_obj(obj)

        _obj = ReplicationPerformance.construct(_fields_set=None, **{
