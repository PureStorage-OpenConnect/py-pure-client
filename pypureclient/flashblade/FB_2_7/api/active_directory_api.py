...
class ActiveDirectoryApi(object):
    ...
    def api27_active_directory_delete_with_http_info(
        ...
        >>> thread = api.api27_active_directory_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api27_active_directory_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api27_active_directory_patch_with_http_info(active_directory, async_req=True)
        >>> result = thread.get()
        ...
        if active_directory is None:
            raise TypeError("Missing the required parameter `active_directory` when calling `api27_active_directory_patch`")
    ...
    def api27_active_directory_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api27_active_directory_post_with_http_info(active_directory, async_req=True)
        >>> result = thread.get()
    ...
    def api27_active_directory_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api27_active_directory_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api27_active_directory_test_get`, must be a value greater than or equal to `1`")
        collection_formats = {}
        path_params = {}
