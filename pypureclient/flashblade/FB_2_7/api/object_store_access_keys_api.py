...
class ObjectStoreAccessKeysApi:
    ...
    def api27_object_store_access_keys_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_object_store_access_keys_delete_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api27_object_store_access_keys_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.7/object-store-access-keys', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api27_object_store_access_keys_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_object_store_access_keys_get_with_http_info(continuation_token, filter, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_object_store_access_keys_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.7/object-store-access-keys', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api27_object_store_access_keys_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_object_store_access_keys_patch_with_http_info(names, object_store_access_key, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_object_store_access_keys_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.7/object-store-access-keys', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api27_object_store_access_keys_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_object_store_access_keys_post_with_http_info(object_store_access_key, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_object_store_access_keys_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.7/object-store-access-keys', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
