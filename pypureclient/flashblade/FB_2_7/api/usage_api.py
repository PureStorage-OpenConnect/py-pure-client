...
class UsageApi:
    ...
    def api27_usage_groups_get_with_http_info(
        ...
        _param = self._api27_usage_groups_get_serialize(
    ...
    def _api27_usage_groups_get_serialize(
        self,
        continuation_token,
        file_system_ids,
        file_system_names,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.7/usage/groups',
    ...
    def api27_usage_users_get_with_http_info(
        ...
        _param = self._api27_usage_users_get_serialize(
            continuation_token = continuation_token,
            file_system_ids = file_system_ids,
            file_system_names = file_system_names,
            filter = filter,
    ...
    def _api27_usage_users_get_serialize(
        self,
        continuation_token,
        file_system_ids,
        file_system_names,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.7/usage/users',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
