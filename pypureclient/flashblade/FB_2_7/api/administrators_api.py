...
class AdministratorsApi(object):
    ...
    def api27_admins_cache_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api27_admins_cache_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api27_admins_settings_patch_with_http_info(
        ...
        if admin_setting is None:
            raise TypeError("Missing the required parameter `admin_setting` when calling `api27_admins_settings_patch`")
