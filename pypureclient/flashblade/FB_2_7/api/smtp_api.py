...
class SMTPApi:
    ...
    def api27_smtp_servers_get_with_http_info(
        ...
        _param = self._api27_smtp_servers_get_serialize(
    ...
    def _api27_smtp_servers_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.7/smtp-servers',
    ...
    def api27_smtp_servers_patch_with_http_info(
        ...
        _param = self._api27_smtp_servers_patch_serialize(
            smtp = smtp,
        )
    ...
    def _api27_smtp_servers_patch_serialize(
        self,
        smtp,
    ) -> RequestSerialized:
