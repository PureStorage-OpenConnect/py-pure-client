...
from pypureclient.flashblade.FB_2_7.models.verification_key_get_response import VerificationKeyGetResponse
from pypureclient.flashblade.FB_2_7.models.verification_key_patch import VerificationKeyPatch
from pypureclient.flashblade.FB_2_7.models.verification_key_response import VerificationKeyResponse
...
class VerificationKeysApi:
    ...
    def api27_support_verification_keys_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api27_support_verification_keys_get_with_http_info(continuation_token, filter, limit, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.7/support/verification-keys', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api27_support_verification_keys_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api27_support_verification_keys_patch_with_http_info(key, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.7/support/verification-keys', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
