...
class VerificationKeysApi(object):
    ...
    def api27_support_verification_keys_get_with_http_info(
        ...
        >>> thread = api.api27_support_verification_keys_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api27_support_verification_keys_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api27_support_verification_keys_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api27_support_verification_keys_patch_with_http_info(
        ...
        if key is None:
            raise TypeError("Missing the required parameter `key` when calling `api27_support_verification_keys_patch`")
