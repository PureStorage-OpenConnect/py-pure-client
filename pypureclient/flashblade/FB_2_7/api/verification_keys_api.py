...
class VerificationKeysApi:
    ...
    def api27_support_verification_keys_get_with_http_info(
        ...
        _param = self._api27_support_verification_keys_get_serialize(
    ...
    def _api27_support_verification_keys_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.7/support/verification-keys',
    ...
    def api27_support_verification_keys_patch_with_http_info(
        ...
        _param = self._api27_support_verification_keys_patch_serialize(
            key = key,
        )
    ...
    def _api27_support_verification_keys_patch_serialize(
        self,
        key,
    ) -> RequestSerialized:
