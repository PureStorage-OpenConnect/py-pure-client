...
class FileSystemSnapshotsApi(object):
    ...
    def api27_file_system_snapshots_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api27_file_system_snapshots_get`, must be a value greater than or equal to `0`")
    ...
    def api27_file_system_snapshots_policies_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api27_file_system_snapshots_policies_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api27_file_system_snapshots_transfer_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api27_file_system_snapshots_transfer_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
