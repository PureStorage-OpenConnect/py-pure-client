...
class PoliciesNFSApi(object):
    ...
    def api27_nfs_export_policies_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api27_nfs_export_policies_get`, must be a value greater than or equal to `0`")
    ...
    def api27_nfs_export_policies_rules_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api27_nfs_export_policies_rules_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
