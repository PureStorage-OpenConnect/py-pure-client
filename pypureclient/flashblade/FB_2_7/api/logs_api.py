...
class LogsApi:
    ...
    def api27_logs_async_download_get_with_http_info(
        ...
        _param = self._api27_logs_async_download_get_serialize(
            names = names,
        )
    ...
    def _api27_logs_async_download_get_serialize(
        self,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.7/logs-async/download',
    ...
    def api27_logs_async_get_with_http_info(
        ...
        _param = self._api27_logs_async_get_serialize(
    ...
    def _api27_logs_async_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.7/logs-async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api27_logs_async_patch_with_http_info(
        ...
        _param = self._api27_logs_async_patch_serialize(
    ...
    def _api27_logs_async_patch_serialize(
        self,
        logs_async,
    ) -> RequestSerialized:
    ...
    def api27_logs_get_with_http_info(
        ...
        _param = self._api27_logs_get_serialize(
            end_time = end_time,
