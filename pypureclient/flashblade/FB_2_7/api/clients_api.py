...
class ClientsApi(object):
    ...
    def api27_arrays_clients_performance_get_with_http_info(
        ...
        >>> thread = api.api27_arrays_clients_performance_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api27_arrays_clients_performance_get`, must be a value greater than or equal to `1`")
        collection_formats = {}
        path_params = {}
