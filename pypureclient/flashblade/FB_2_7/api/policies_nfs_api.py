...
from pypureclient.flashblade.FB_2_7.models.nfs_export_policy import NfsExportPolicy
from pypureclient.flashblade.FB_2_7.models.nfs_export_policy_get_response import NfsExportPolicyGetResponse
from pypureclient.flashblade.FB_2_7.models.nfs_export_policy_post import NfsExportPolicyPost
from pypureclient.flashblade.FB_2_7.models.nfs_export_policy_response import NfsExportPolicyResponse
from pypureclient.flashblade.FB_2_7.models.nfs_export_policy_rule import NfsExportPolicyRule
from pypureclient.flashblade.FB_2_7.models.nfs_export_policy_rule_get_response import NfsExportPolicyRuleGetResponse
from pypureclient.flashblade.FB_2_7.models.nfs_export_policy_rule_response import NfsExportPolicyRuleResponse
...
class PoliciesNFSApi:
    ...
    def api27_nfs_export_policies_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api27_nfs_export_policies_delete_with_http_info(ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api27_nfs_export_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.7/nfs-export-policies', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api27_nfs_export_policies_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api27_nfs_export_policies_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_nfs_export_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.7/nfs-export-policies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api27_nfs_export_policies_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api27_nfs_export_policies_patch_with_http_info(policy, ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_nfs_export_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.7/nfs-export-policies', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api27_nfs_export_policies_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api27_nfs_export_policies_post_with_http_info(names, policy, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_nfs_export_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.7/nfs-export-policies', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api27_nfs_export_policies_rules_delete_with_http_info(
        self,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        versions: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of versions. This is an optional query param used for concurrency control. The ordering should match the names or ids query param. This will fail with a 412 Precondition failed if the resource was changed and the current version of the resource doesn't match the value in the query param.")] = None,
        **kwargs
        ...
        >>> thread = api.api27_nfs_export_policies_rules_delete_with_http_info(ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_nfs_export_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.7/nfs-export-policies/rules', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api27_nfs_export_policies_rules_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api27_nfs_export_policies_rules_get_with_http_info(continuation_token, filter, ids, limit, names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_nfs_export_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.7/nfs-export-policies/rules', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api27_nfs_export_policies_rules_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api27_nfs_export_policies_rules_patch_with_http_info(rule, before_rule_id, before_rule_name, ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_nfs_export_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.7/nfs-export-policies/rules', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api27_nfs_export_policies_rules_post_with_http_info(
        self,
        rule: NfsExportPolicyRule,
        before_rule_id: Annotated[Optional[StrictStr], Field(description="The id of the rule to insert or move a rule before. This cannot be provided together with the `before_rule_name` query parameter.")] = None,
        before_rule_name: Annotated[Optional[StrictStr], Field(description="The name of the rule to insert or move a rule before. This cannot be provided together with the `before_rule_id` query parameter.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api27_nfs_export_policies_rules_post_with_http_info(rule, before_rule_id, before_rule_name, policy_ids, policy_names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_nfs_export_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.7/nfs-export-policies/rules', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
