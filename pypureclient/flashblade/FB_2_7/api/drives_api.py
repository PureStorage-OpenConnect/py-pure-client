...
from pypureclient.flashblade.FB_2_7.models.drive_get_response import DriveGetResponse
...
class DrivesApi:
    ...
    def api27_drives_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_drives_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, total_only, async_req=True)
        >>> result = thread.get()
