...
from pypureclient.flashblade.FB_2_7.models.snmp_manager import SnmpManager
from pypureclient.flashblade.FB_2_7.models.snmp_manager_get_response import SnmpManagerGetResponse
from pypureclient.flashblade.FB_2_7.models.snmp_manager_post import SnmpManagerPost
...
class SNMPManagersApi:
    ...
    def api27_snmp_managers_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_snmp_managers_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api27_snmp_managers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_snmp_managers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_snmp_managers_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_snmp_managers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_snmp_managers_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_snmp_managers_patch_with_http_info(snmp_manager, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_snmp_managers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_snmp_managers_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_snmp_managers_post_with_http_info(names, snmp_manager, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_snmp_managers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api27_snmp_managers_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_snmp_managers_test_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_snmp_managers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
