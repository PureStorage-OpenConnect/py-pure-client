...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_7.models.api27_link_aggregation_groups_patch_request import Api27LinkAggregationGroupsPatchRequest
...
class LinkAggregationGroupsApi:
    ...
    def api27_link_aggregation_groups_delete_with_http_info(
        ...
        _param = self._api27_link_aggregation_groups_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api27_link_aggregation_groups_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.7/link-aggregation-groups',
    ...
    def api27_link_aggregation_groups_get_with_http_info(
        ...
        _param = self._api27_link_aggregation_groups_get_serialize(
    ...
    def _api27_link_aggregation_groups_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api27_link_aggregation_groups_patch_with_http_info(
        self,
        link_aggregation_group: Api27LinkAggregationGroupsPatchRequest,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
        ...
        _param = self._api27_link_aggregation_groups_patch_serialize(
    ...
    def _api27_link_aggregation_groups_patch_serialize(
        self,
    ...
    def api27_link_aggregation_groups_post_with_http_info(
        ...
        _param = self._api27_link_aggregation_groups_post_serialize(
            names = names,
            link_aggregation_group = link_aggregation_group,
        )
    ...
    def _api27_link_aggregation_groups_post_serialize(
        self,
        names,
        link_aggregation_group,
    ) -> RequestSerialized:
