...
class KMIPApi:
    ...
    def api27_kmip_delete_with_http_info(
        ...
        _param = self._api27_kmip_delete_serialize(
            names = names,
            ids = ids,
        )
    ...
    def _api27_kmip_delete_serialize(
        self,
        names,
        ids,
    ) -> RequestSerialized:
    ...
    def api27_kmip_get_with_http_info(
        ...
        _param = self._api27_kmip_get_serialize(
            names = names,
            ids = ids,
            filter = filter,
            limit = limit,
    ...
    def api27_kmip_patch_with_http_info(
        ...
        _param = self._api27_kmip_patch_serialize(
    ...
    def _api27_kmip_patch_serialize(
        self,
        kmip_server,
        names,
        ids,
    ...
    def api27_kmip_post_with_http_info(
        ...
        _param = self._api27_kmip_post_serialize(
            kmip_server = kmip_server,
            names = names,
        )
    ...
    def _api27_kmip_post_serialize(
        self,
        kmip_server,
        names,
    ) -> RequestSerialized:
    ...
    def api27_kmip_test_get_with_http_info(
        ...
        _param = self._api27_kmip_test_get_serialize(
            names = names,
            ids = ids,
        )
    ...
    def _api27_kmip_test_get_serialize(
        self,
        names,
        ids,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.7/kmip/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
