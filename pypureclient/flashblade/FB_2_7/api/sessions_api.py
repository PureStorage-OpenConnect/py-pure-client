...
from pypureclient.flashblade.FB_2_7.models.session_get_response import SessionGetResponse
...
class SessionsApi:
    ...
    def api27_sessions_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api27_sessions_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
