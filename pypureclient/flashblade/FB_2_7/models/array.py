...
from pypureclient.flashblade.FB_2_7.models.array_eradication_config import ArrayEradicationConfig
...
class Array(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "_as_of", "banner", "idle_timeout", "ntp_servers", "os", "revision", "time_zone", "version", "smb_mode", "eradication_config", "product_type", "security_update"]
