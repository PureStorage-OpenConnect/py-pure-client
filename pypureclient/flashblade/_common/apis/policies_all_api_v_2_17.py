...
from pypureclient.flashblade._common.models.policy_base_get_response_v_2_17 import PolicyBaseGetResponse
from pypureclient.flashblade._common.models.policy_member_with_remote_get_response_v_2_17 import PolicyMemberWithRemoteGetResponse
...
class PoliciesAllApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_policies_all_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_policies_all_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api217_policies_all_get_with_http_info = policies_all_get_with_http_info
    api217_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api218_policies_all_get_with_http_info = policies_all_get_with_http_info
    api218_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api219_policies_all_get_with_http_info = policies_all_get_with_http_info
    api219_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api220_policies_all_get_with_http_info = policies_all_get_with_http_info
    api220_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api221_policies_all_get_with_http_info = policies_all_get_with_http_info
    api221_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
