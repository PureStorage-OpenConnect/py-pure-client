...
class SNMPAgentsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_snmp_agents_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_snmp_agents_mib_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_snmp_agents_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api218_snmp_agents_get_with_http_info = snmp_agents_get_with_http_info
    api218_snmp_agents_mib_get_with_http_info = snmp_agents_mib_get_with_http_info
    api218_snmp_agents_patch_with_http_info = snmp_agents_patch_with_http_info
