...
from pypureclient.flashblade._common.models.keytab_get_response_v_2_22 import KeytabGetResponse
from pypureclient.flashblade._common.models.keytab_post_v_2_22 import KeytabPost
from pypureclient.flashblade._common.models.keytab_response_v_2_22 import KeytabResponse
...
class KeytabsApi:
    ...
    def keytabs_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_keytabs_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/keytabs', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def keytabs_download_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_keytabs_download_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/keytabs/download', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def keytabs_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_keytabs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/keytabs', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def keytabs_post_with_http_info(
        self,
        keytab: KeytabPost,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_keytabs_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/keytabs', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def keytabs_upload_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_keytabs_upload_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/keytabs/upload', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api227_keytabs_delete_with_http_info = keytabs_delete_with_http_info
    api227_keytabs_download_get_with_http_info = keytabs_download_get_with_http_info
    api227_keytabs_get_with_http_info = keytabs_get_with_http_info
    api227_keytabs_post_with_http_info = keytabs_post_with_http_info
    api227_keytabs_upload_post_with_http_info = keytabs_upload_post_with_http_info
