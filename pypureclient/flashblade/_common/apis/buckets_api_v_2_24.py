...
from pypureclient.flashblade._common.models.bucket_access_policy_get_response_v_2_24 import BucketAccessPolicyGetResponse
from pypureclient.flashblade._common.models.bucket_access_policy_post_v_2_24 import BucketAccessPolicyPost
from pypureclient.flashblade._common.models.bucket_access_policy_response_v_2_24 import BucketAccessPolicyResponse
from pypureclient.flashblade._common.models.bucket_access_policy_rule_get_response_v_2_24 import BucketAccessPolicyRuleGetResponse
from pypureclient.flashblade._common.models.bucket_access_policy_rule_post_v_2_24 import BucketAccessPolicyRulePost
from pypureclient.flashblade._common.models.bucket_access_policy_rule_response_v_2_24 import BucketAccessPolicyRuleResponse
from pypureclient.flashblade._common.models.bucket_audit_filter_action_get_response_v_2_24 import BucketAuditFilterActionGetResponse
from pypureclient.flashblade._common.models.bucket_audit_filter_get_response_v_2_24 import BucketAuditFilterGetResponse
from pypureclient.flashblade._common.models.bucket_audit_filter_post_v_2_24 import BucketAuditFilterPost
from pypureclient.flashblade._common.models.bucket_audit_filter_response_v_2_24 import BucketAuditFilterResponse
from pypureclient.flashblade._common.models.bucket_get_response_v_2_24 import BucketGetResponse
from pypureclient.flashblade._common.models.bucket_patch_v_2_24 import BucketPatch
from pypureclient.flashblade._common.models.bucket_performance_get_response_v_2_24 import BucketPerformanceGetResponse
from pypureclient.flashblade._common.models.bucket_post_v_2_24 import BucketPost
from pypureclient.flashblade._common.models.bucket_response_v_2_24 import BucketResponse
from pypureclient.flashblade._common.models.bucket_s3_specific_performance_get_resp_v_2_24 import BucketS3SpecificPerformanceGetResp
from pypureclient.flashblade._common.models.cross_origin_resource_sharing_policy_get_response_v_2_24 import CrossOriginResourceSharingPolicyGetResponse
from pypureclient.flashblade._common.models.cross_origin_resource_sharing_policy_patch_v_2_24 import CrossOriginResourceSharingPolicyPatch
from pypureclient.flashblade._common.models.cross_origin_resource_sharing_policy_response_v_2_24 import CrossOriginResourceSharingPolicyResponse
from pypureclient.flashblade._common.models.cross_origin_resource_sharing_policy_rule_get_response_v_2_24 import CrossOriginResourceSharingPolicyRuleGetResponse
from pypureclient.flashblade._common.models.cross_origin_resource_sharing_policy_rule_post_v_2_24 import CrossOriginResourceSharingPolicyRulePost
from pypureclient.flashblade._common.models.cross_origin_resource_sharing_policy_rule_response_v_2_24 import CrossOriginResourceSharingPolicyRuleResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api224_bucket_audit_filter_actions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_audit_filters_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_audit_filters_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_audit_filters_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_audit_filters_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_bucket_access_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_bucket_access_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_bucket_access_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_bucket_access_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_bucket_access_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_bucket_access_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_cross_origin_resource_sharing_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_cross_origin_resource_sharing_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_cross_origin_resource_sharing_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_cross_origin_resource_sharing_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_cross_origin_resource_sharing_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_cross_origin_resource_sharing_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_buckets_s3_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
