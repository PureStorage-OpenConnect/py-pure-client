...
from pypureclient.flashblade._common.models.policy_file_system_snapshot_get_response_v_2_22 import PolicyFileSystemSnapshotGetResponse
from pypureclient.flashblade._common.models.policy_get_response_v_2_22 import PolicyGetResponse
...
from pypureclient.flashblade._common.models.policy_member_with_remote_get_response_v_2_22 import PolicyMemberWithRemoteGetResponse
from pypureclient.flashblade._common.models.policy_member_with_remote_response_v_2_22 import PolicyMemberWithRemoteResponse
from pypureclient.flashblade._common.models.policy_post_v_2_22 import PolicyPost
from pypureclient.flashblade._common.models.policy_response_v_2_22 import PolicyResponse
...
class PoliciesSnapshotApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api222_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_policies_file_system_replica_links_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_policies_file_system_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_policies_file_system_replica_links_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_policies_file_system_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_policies_file_system_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_policies_file_systems_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_policies_file_systems_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_policies_file_systems_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api222_policies_delete_with_http_info = policies_delete_with_http_info
    api222_policies_file_system_replica_links_delete_with_http_info = policies_file_system_replica_links_delete_with_http_info
    api222_policies_file_system_replica_links_get_with_http_info = policies_file_system_replica_links_get_with_http_info
    api222_policies_file_system_replica_links_post_with_http_info = policies_file_system_replica_links_post_with_http_info
    api222_policies_file_system_snapshots_delete_with_http_info = policies_file_system_snapshots_delete_with_http_info
    api222_policies_file_system_snapshots_get_with_http_info = policies_file_system_snapshots_get_with_http_info
    api222_policies_file_systems_delete_with_http_info = policies_file_systems_delete_with_http_info
    api222_policies_file_systems_get_with_http_info = policies_file_systems_get_with_http_info
    api222_policies_file_systems_post_with_http_info = policies_file_systems_post_with_http_info
    ...
    api222_policies_patch_with_http_info = policies_patch_with_http_info
    api222_policies_post_with_http_info = policies_post_with_http_info
