...
from pypureclient.flashblade._common.models.hardware_connector_get_response_v_2_15 import HardwareConnectorGetResponse
from pypureclient.flashblade._common.models.hardware_connector_performance_get_response_v_2_3 import HardwareConnectorPerformanceGetResponse
from pypureclient.flashblade._common.models.hardware_connector_response_v_2_15 import HardwareConnectorResponse
from pypureclient.flashblade._common.models.hardware_connector_v_2_15 import HardwareConnector

class HardwareConnectorsApi:
    ...
    def hardware_connectors_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        :rtype: tuple(HardwareConnectorGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_hardware_connectors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "HardwareConnectorGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/hardware-connectors', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def hardware_connectors_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(HardwareConnectorResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_hardware_connectors_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['hardware_connector'] is not None:
            _body_params = _params['hardware_connector']
        ...
        _response_types_map = {
            '200': "HardwareConnectorResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/hardware-connectors', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def hardware_connectors_performance_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(HardwareConnectorPerformanceGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_hardware_connectors_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "HardwareConnectorPerformanceGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/hardware-connectors/performance', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api217_hardware_connectors_get_with_http_info = hardware_connectors_get_with_http_info
    api217_hardware_connectors_patch_with_http_info = hardware_connectors_patch_with_http_info
    api217_hardware_connectors_performance_get_with_http_info = hardware_connectors_performance_get_with_http_info
    api218_hardware_connectors_get_with_http_info = hardware_connectors_get_with_http_info
    api218_hardware_connectors_patch_with_http_info = hardware_connectors_patch_with_http_info
    api218_hardware_connectors_performance_get_with_http_info = hardware_connectors_performance_get_with_http_info
    api219_hardware_connectors_get_with_http_info = hardware_connectors_get_with_http_info
    api219_hardware_connectors_patch_with_http_info = hardware_connectors_patch_with_http_info
    api219_hardware_connectors_performance_get_with_http_info = hardware_connectors_performance_get_with_http_info
    api220_hardware_connectors_get_with_http_info = hardware_connectors_get_with_http_info
    api220_hardware_connectors_patch_with_http_info = hardware_connectors_patch_with_http_info
    api220_hardware_connectors_performance_get_with_http_info = hardware_connectors_performance_get_with_http_info
    api221_hardware_connectors_get_with_http_info = hardware_connectors_get_with_http_info
    api221_hardware_connectors_patch_with_http_info = hardware_connectors_patch_with_http_info
    api221_hardware_connectors_performance_get_with_http_info = hardware_connectors_performance_get_with_http_info
    api222_hardware_connectors_get_with_http_info = hardware_connectors_get_with_http_info
    api222_hardware_connectors_patch_with_http_info = hardware_connectors_patch_with_http_info
    api222_hardware_connectors_performance_get_with_http_info = hardware_connectors_performance_get_with_http_info
    api223_hardware_connectors_get_with_http_info = hardware_connectors_get_with_http_info
    api223_hardware_connectors_patch_with_http_info = hardware_connectors_patch_with_http_info
    api223_hardware_connectors_performance_get_with_http_info = hardware_connectors_performance_get_with_http_info
    api224_hardware_connectors_get_with_http_info = hardware_connectors_get_with_http_info
    api224_hardware_connectors_patch_with_http_info = hardware_connectors_patch_with_http_info
    api224_hardware_connectors_performance_get_with_http_info = hardware_connectors_performance_get_with_http_info
    api225_hardware_connectors_get_with_http_info = hardware_connectors_get_with_http_info
    api225_hardware_connectors_patch_with_http_info = hardware_connectors_patch_with_http_info
    api225_hardware_connectors_performance_get_with_http_info = hardware_connectors_performance_get_with_http_info
    api226_hardware_connectors_get_with_http_info = hardware_connectors_get_with_http_info
    api226_hardware_connectors_patch_with_http_info = hardware_connectors_patch_with_http_info
    api226_hardware_connectors_performance_get_with_http_info = hardware_connectors_performance_get_with_http_info
