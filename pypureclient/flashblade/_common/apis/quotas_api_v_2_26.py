...
from pypureclient.flashblade._common.models.group_quota_get_response_v_2_26 import GroupQuotaGetResponse
from pypureclient.flashblade._common.models.group_quota_patch_v_2_26 import GroupQuotaPatch
from pypureclient.flashblade._common.models.group_quota_post_v_2_26 import GroupQuotaPost
from pypureclient.flashblade._common.models.group_quota_response_v_2_26 import GroupQuotaResponse
from pypureclient.flashblade._common.models.quota_setting_get_response_v_2_26 import QuotaSettingGetResponse
from pypureclient.flashblade._common.models.quota_setting_response_v_2_26 import QuotaSettingResponse
from pypureclient.flashblade._common.models.quota_setting_v_2_26 import QuotaSetting
from pypureclient.flashblade._common.models.user_quota_get_response_v_2_26 import UserQuotaGetResponse
from pypureclient.flashblade._common.models.user_quota_patch_v_2_26 import UserQuotaPatch
from pypureclient.flashblade._common.models.user_quota_post_v_2_26 import UserQuotaPost
from pypureclient.flashblade._common.models.user_quota_response_v_2_26 import UserQuotaResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_quotas_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_quotas_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_quotas_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_quotas_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_quotas_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_quotas_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_quotas_users_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_quotas_users_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_quotas_users_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_quotas_users_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
