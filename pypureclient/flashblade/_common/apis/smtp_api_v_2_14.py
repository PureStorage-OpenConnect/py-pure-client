...
from pypureclient.flashblade._common.models.smtp_server_get_response_v_2_0 import SmtpServerGetResponse
from pypureclient.flashblade._common.models.smtp_server_response_v_2_0 import SmtpServerResponse
from pypureclient.flashblade._common.models.smtp_server_v_2_0 import SmtpServer
...
class SMTPApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_smtp_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_smtp_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api218_smtp_servers_get_with_http_info = smtp_servers_get_with_http_info
    api218_smtp_servers_patch_with_http_info = smtp_servers_patch_with_http_info
