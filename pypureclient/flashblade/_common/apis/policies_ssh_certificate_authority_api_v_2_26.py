...
from pypureclient.flashblade._common.models.policy_member_context_get_response_v_2_26 import PolicyMemberContextGetResponse
from pypureclient.flashblade._common.models.policy_member_context_response_v_2_26 import PolicyMemberContextResponse
from pypureclient.flashblade._common.models.ssh_certificate_authority_policy_get_response_v_2_26 import SshCertificateAuthorityPolicyGetResponse
from pypureclient.flashblade._common.models.ssh_certificate_authority_policy_post_v_2_26 import SshCertificateAuthorityPolicyPost
from pypureclient.flashblade._common.models.ssh_certificate_authority_policy_response_v_2_26 import SshCertificateAuthorityPolicyResponse
from pypureclient.flashblade._common.models.ssh_certificate_authority_policy_v_2_26 import SshCertificateAuthorityPolicy
...
class PoliciesSSHCertificateAuthorityApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_admins_ssh_certificate_authority_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_admins_ssh_certificate_authority_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_admins_ssh_certificate_authority_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_arrays_ssh_certificate_authority_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_arrays_ssh_certificate_authority_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_arrays_ssh_certificate_authority_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_ssh_certificate_authority_policies_admins_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_ssh_certificate_authority_policies_admins_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_ssh_certificate_authority_policies_admins_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_ssh_certificate_authority_policies_arrays_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_ssh_certificate_authority_policies_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_ssh_certificate_authority_policies_arrays_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_ssh_certificate_authority_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_ssh_certificate_authority_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "SshCertificateAuthorityPolicyGetResponse",
        }
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_ssh_certificate_authority_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_ssh_certificate_authority_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_ssh_certificate_authority_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api226_admins_ssh_certificate_authority_policies_delete_with_http_info = admins_ssh_certificate_authority_policies_delete_with_http_info
    api226_admins_ssh_certificate_authority_policies_get_with_http_info = admins_ssh_certificate_authority_policies_get_with_http_info
    api226_admins_ssh_certificate_authority_policies_post_with_http_info = admins_ssh_certificate_authority_policies_post_with_http_info
    api226_arrays_ssh_certificate_authority_policies_delete_with_http_info = arrays_ssh_certificate_authority_policies_delete_with_http_info
    api226_arrays_ssh_certificate_authority_policies_get_with_http_info = arrays_ssh_certificate_authority_policies_get_with_http_info
    api226_arrays_ssh_certificate_authority_policies_post_with_http_info = arrays_ssh_certificate_authority_policies_post_with_http_info
    api226_ssh_certificate_authority_policies_admins_delete_with_http_info = ssh_certificate_authority_policies_admins_delete_with_http_info
    api226_ssh_certificate_authority_policies_admins_get_with_http_info = ssh_certificate_authority_policies_admins_get_with_http_info
    api226_ssh_certificate_authority_policies_admins_post_with_http_info = ssh_certificate_authority_policies_admins_post_with_http_info
    api226_ssh_certificate_authority_policies_arrays_delete_with_http_info = ssh_certificate_authority_policies_arrays_delete_with_http_info
    api226_ssh_certificate_authority_policies_arrays_get_with_http_info = ssh_certificate_authority_policies_arrays_get_with_http_info
    api226_ssh_certificate_authority_policies_arrays_post_with_http_info = ssh_certificate_authority_policies_arrays_post_with_http_info
    api226_ssh_certificate_authority_policies_delete_with_http_info = ssh_certificate_authority_policies_delete_with_http_info
    api226_ssh_certificate_authority_policies_get_with_http_info = ssh_certificate_authority_policies_get_with_http_info
    api226_ssh_certificate_authority_policies_members_get_with_http_info = ssh_certificate_authority_policies_members_get_with_http_info
    api226_ssh_certificate_authority_policies_patch_with_http_info = ssh_certificate_authority_policies_patch_with_http_info
    api226_ssh_certificate_authority_policies_post_with_http_info = ssh_certificate_authority_policies_post_with_http_info
