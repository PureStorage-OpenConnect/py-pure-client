...
from pypureclient.flashblade._common.models.support_diagnostics_details_get_response_v_2_16 import SupportDiagnosticsDetailsGetResponse
from pypureclient.flashblade._common.models.support_diagnostics_get_response_v_2_16 import SupportDiagnosticsGetResponse
...
class SupportDiagnosticsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_support_diagnostics_details_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_support_diagnostics_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_support_diagnostics_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api217_support_diagnostics_details_get_with_http_info = support_diagnostics_details_get_with_http_info
    api217_support_diagnostics_get_with_http_info = support_diagnostics_get_with_http_info
    api217_support_diagnostics_post_with_http_info = support_diagnostics_post_with_http_info
    api218_support_diagnostics_details_get_with_http_info = support_diagnostics_details_get_with_http_info
    api218_support_diagnostics_get_with_http_info = support_diagnostics_get_with_http_info
    api218_support_diagnostics_post_with_http_info = support_diagnostics_post_with_http_info
    api219_support_diagnostics_details_get_with_http_info = support_diagnostics_details_get_with_http_info
    api219_support_diagnostics_get_with_http_info = support_diagnostics_get_with_http_info
    api219_support_diagnostics_post_with_http_info = support_diagnostics_post_with_http_info
    api220_support_diagnostics_details_get_with_http_info = support_diagnostics_details_get_with_http_info
    api220_support_diagnostics_get_with_http_info = support_diagnostics_get_with_http_info
    api220_support_diagnostics_post_with_http_info = support_diagnostics_post_with_http_info
    api221_support_diagnostics_details_get_with_http_info = support_diagnostics_details_get_with_http_info
    api221_support_diagnostics_get_with_http_info = support_diagnostics_get_with_http_info
    api221_support_diagnostics_post_with_http_info = support_diagnostics_post_with_http_info
    api222_support_diagnostics_details_get_with_http_info = support_diagnostics_details_get_with_http_info
    api222_support_diagnostics_get_with_http_info = support_diagnostics_get_with_http_info
    api222_support_diagnostics_post_with_http_info = support_diagnostics_post_with_http_info
    api223_support_diagnostics_details_get_with_http_info = support_diagnostics_details_get_with_http_info
    api223_support_diagnostics_get_with_http_info = support_diagnostics_get_with_http_info
    api223_support_diagnostics_post_with_http_info = support_diagnostics_post_with_http_info
