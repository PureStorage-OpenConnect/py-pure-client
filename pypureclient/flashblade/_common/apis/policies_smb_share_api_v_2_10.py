...
from pypureclient.flashblade._common.models.smb_share_policy_get_response_v_2_10 import SmbSharePolicyGetResponse
from pypureclient.flashblade._common.models.smb_share_policy_post_v_2_10 import SmbSharePolicyPost
from pypureclient.flashblade._common.models.smb_share_policy_response_v_2_10 import SmbSharePolicyResponse
from pypureclient.flashblade._common.models.smb_share_policy_rule_get_response_v_2_10 import SmbSharePolicyRuleGetResponse
from pypureclient.flashblade._common.models.smb_share_policy_rule_post_v_2_10 import SmbSharePolicyRulePost
from pypureclient.flashblade._common.models.smb_share_policy_rule_response_v_2_10 import SmbSharePolicyRuleResponse
from pypureclient.flashblade._common.models.smb_share_policy_rule_v_2_10 import SmbSharePolicyRule
from pypureclient.flashblade._common.models.smb_share_policy_v_2_10 import SmbSharePolicy
...
class PoliciesSMBShareApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api210_smb_share_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_smb_share_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_smb_share_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_smb_share_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_smb_share_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_smb_share_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_smb_share_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_smb_share_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api210_smb_share_policies_delete_with_http_info = smb_share_policies_delete_with_http_info
    api210_smb_share_policies_get_with_http_info = smb_share_policies_get_with_http_info
    api210_smb_share_policies_patch_with_http_info = smb_share_policies_patch_with_http_info
    api210_smb_share_policies_post_with_http_info = smb_share_policies_post_with_http_info
    api210_smb_share_policies_rules_delete_with_http_info = smb_share_policies_rules_delete_with_http_info
    api210_smb_share_policies_rules_get_with_http_info = smb_share_policies_rules_get_with_http_info
    api210_smb_share_policies_rules_patch_with_http_info = smb_share_policies_rules_patch_with_http_info
    api210_smb_share_policies_rules_post_with_http_info = smb_share_policies_rules_post_with_http_info
    api211_smb_share_policies_delete_with_http_info = smb_share_policies_delete_with_http_info
    api211_smb_share_policies_get_with_http_info = smb_share_policies_get_with_http_info
    api211_smb_share_policies_patch_with_http_info = smb_share_policies_patch_with_http_info
    api211_smb_share_policies_post_with_http_info = smb_share_policies_post_with_http_info
    api211_smb_share_policies_rules_delete_with_http_info = smb_share_policies_rules_delete_with_http_info
    api211_smb_share_policies_rules_get_with_http_info = smb_share_policies_rules_get_with_http_info
    api211_smb_share_policies_rules_patch_with_http_info = smb_share_policies_rules_patch_with_http_info
    api211_smb_share_policies_rules_post_with_http_info = smb_share_policies_rules_post_with_http_info
    api212_smb_share_policies_delete_with_http_info = smb_share_policies_delete_with_http_info
    api212_smb_share_policies_get_with_http_info = smb_share_policies_get_with_http_info
    api212_smb_share_policies_patch_with_http_info = smb_share_policies_patch_with_http_info
    api212_smb_share_policies_post_with_http_info = smb_share_policies_post_with_http_info
    api212_smb_share_policies_rules_delete_with_http_info = smb_share_policies_rules_delete_with_http_info
    api212_smb_share_policies_rules_get_with_http_info = smb_share_policies_rules_get_with_http_info
    api212_smb_share_policies_rules_patch_with_http_info = smb_share_policies_rules_patch_with_http_info
    api212_smb_share_policies_rules_post_with_http_info = smb_share_policies_rules_post_with_http_info
    api213_smb_share_policies_delete_with_http_info = smb_share_policies_delete_with_http_info
    api213_smb_share_policies_get_with_http_info = smb_share_policies_get_with_http_info
    api213_smb_share_policies_patch_with_http_info = smb_share_policies_patch_with_http_info
    api213_smb_share_policies_post_with_http_info = smb_share_policies_post_with_http_info
    api213_smb_share_policies_rules_delete_with_http_info = smb_share_policies_rules_delete_with_http_info
    api213_smb_share_policies_rules_get_with_http_info = smb_share_policies_rules_get_with_http_info
    api213_smb_share_policies_rules_patch_with_http_info = smb_share_policies_rules_patch_with_http_info
    api213_smb_share_policies_rules_post_with_http_info = smb_share_policies_rules_post_with_http_info
