...
class LogsApi:
    ...
    # Method Aliases
    api20_logs_get_with_http_info = logs_get_with_http_info
    api21_logs_get_with_http_info = logs_get_with_http_info
    api22_logs_get_with_http_info = logs_get_with_http_info
    api23_logs_get_with_http_info = logs_get_with_http_info
