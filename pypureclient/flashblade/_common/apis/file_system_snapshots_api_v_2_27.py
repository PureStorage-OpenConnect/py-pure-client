...
from pypureclient.flashblade._common.models.file_system_snapshot_get_response_v_2_22 import FileSystemSnapshotGetResponse
...
from pypureclient.flashblade._common.models.file_system_snapshot_response_v_2_22 import FileSystemSnapshotResponse
from pypureclient.flashblade._common.models.file_system_snapshot_v_2_22 import FileSystemSnapshot
...
class FileSystemSnapshotsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_file_system_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_file_system_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_file_system_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_file_system_snapshots_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_file_system_snapshots_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_file_system_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_file_system_snapshots_transfer_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_file_system_snapshots_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api227_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api227_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api227_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api227_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api227_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api227_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api227_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
