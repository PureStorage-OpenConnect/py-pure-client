...
from pypureclient.flashblade._common.models.maintenance_window_post_v_2_16 import MaintenanceWindowPost
from pypureclient.flashblade._common.models.maintenance_windows_get_response_v_2_16 import MaintenanceWindowsGetResponse
from pypureclient.flashblade._common.models.maintenance_windows_response_v_2_16 import MaintenanceWindowsResponse
...
class MaintenanceWindowsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api216_maintenance_windows_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_maintenance_windows_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_maintenance_windows_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api218_maintenance_windows_delete_with_http_info = maintenance_windows_delete_with_http_info
    api218_maintenance_windows_get_with_http_info = maintenance_windows_get_with_http_info
    api218_maintenance_windows_post_with_http_info = maintenance_windows_post_with_http_info
