...
from pypureclient.flashblade._common.models.file_system_group_quota_get_response_v_2_26 import FileSystemGroupQuotaGetResponse
from pypureclient.flashblade._common.models.file_system_user_quota_get_response_v_2_26 import FileSystemUserQuotaGetResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_file_system_group_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_file_system_user_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
