...
from pypureclient.flashblade._common.models.password_policies_get_response_v_2_16 import PasswordPoliciesGetResponse
from pypureclient.flashblade._common.models.password_policies_response_v_2_16 import PasswordPoliciesResponse
from pypureclient.flashblade._common.models.password_policy_v_2_16 import PasswordPolicy
...
class PoliciesPasswordApi:
    ...
    def password_policies_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api216_password_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/password-policies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def password_policies_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_password_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/password-policies', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
