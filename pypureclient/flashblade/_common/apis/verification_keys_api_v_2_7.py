...
from pypureclient.flashblade._common.models.verification_key_get_response_v_2_7 import VerificationKeyGetResponse
from pypureclient.flashblade._common.models.verification_key_patch_v_2_7 import VerificationKeyPatch
from pypureclient.flashblade._common.models.verification_key_response_v_2_7 import VerificationKeyResponse

class VerificationKeysApi:
    ...
    def support_verification_keys_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        :rtype: tuple(VerificationKeyGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api27_support_verification_keys_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "VerificationKeyGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/support/verification-keys', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def support_verification_keys_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(VerificationKeyResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api27_support_verification_keys_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "VerificationKeyResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/support/verification-keys', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api210_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api210_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api211_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api211_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api212_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api212_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api213_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api213_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api27_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api27_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api28_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api28_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api29_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api29_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
