...
from pypureclient.flashblade._common.models.lifecycle_rule_get_response_v_2_26 import LifecycleRuleGetResponse
from pypureclient.flashblade._common.models.lifecycle_rule_patch_v_2_26 import LifecycleRulePatch
from pypureclient.flashblade._common.models.lifecycle_rule_post_v_2_26 import LifecycleRulePost
from pypureclient.flashblade._common.models.lifecycle_rule_response_v_2_26 import LifecycleRuleResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_lifecycle_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_lifecycle_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_lifecycle_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_lifecycle_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
