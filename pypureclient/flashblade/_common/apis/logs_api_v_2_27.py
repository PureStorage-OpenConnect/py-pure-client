...
from pypureclient.flashblade._common.models.logs_async_get_response_v_2_22 import LogsAsyncGetResponse
from pypureclient.flashblade._common.models.logs_async_response_v_2_22 import LogsAsyncResponse
from pypureclient.flashblade._common.models.logs_async_v_2_22 import LogsAsync
...
class LogsApi:
    ...
    def logs_async_download_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_logs_async_download_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/logs-async/download', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def logs_async_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(LogsAsyncGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_logs_async_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "LogsAsyncGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/logs-async', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def logs_async_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(LogsAsyncResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_logs_async_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['logs_async'] is not None:
            _body_params = _params['logs_async']
        ...
        _response_types_map = {
            '200': "LogsAsyncResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/logs-async', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_logs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_logs_async_download_get_with_http_info = logs_async_download_get_with_http_info
    api227_logs_async_get_with_http_info = logs_async_get_with_http_info
    api227_logs_async_patch_with_http_info = logs_async_patch_with_http_info
    api227_logs_get_with_http_info = logs_get_with_http_info
