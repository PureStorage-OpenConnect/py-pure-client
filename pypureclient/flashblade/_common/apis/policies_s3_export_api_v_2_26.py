...
from pypureclient.flashblade._common.models.s3_export_policy_get_response_v_2_26 import S3ExportPolicyGetResponse
from pypureclient.flashblade._common.models.s3_export_policy_patch_v_2_26 import S3ExportPolicyPatch
from pypureclient.flashblade._common.models.s3_export_policy_post_v_2_26 import S3ExportPolicyPost
from pypureclient.flashblade._common.models.s3_export_policy_response_v_2_26 import S3ExportPolicyResponse
from pypureclient.flashblade._common.models.s3_export_policy_rule_get_response_v_2_26 import S3ExportPolicyRuleGetResponse
from pypureclient.flashblade._common.models.s3_export_policy_rule_post_v_2_26 import S3ExportPolicyRulePost
from pypureclient.flashblade._common.models.s3_export_policy_rule_response_v_2_26 import S3ExportPolicyRuleResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_s3_export_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_s3_export_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_s3_export_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_s3_export_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_s3_export_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_s3_export_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_s3_export_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_s3_export_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
