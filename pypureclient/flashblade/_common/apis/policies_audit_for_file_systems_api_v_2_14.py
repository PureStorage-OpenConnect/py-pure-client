...
from pypureclient.flashblade._common.models.audit_file_systems_policies_get_response_v_2_14 import AuditFileSystemsPoliciesGetResponse
...
from pypureclient.flashblade._common.models.audit_file_systems_policies_patch_v_2_14 import AuditFileSystemsPoliciesPatch
from pypureclient.flashblade._common.models.audit_file_systems_policies_post_v_2_14 import AuditFileSystemsPoliciesPost
from pypureclient.flashblade._common.models.audit_file_systems_policies_response_v_2_14 import AuditFileSystemsPoliciesResponse
...
class PoliciesAuditForFileSystemsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_audit_file_systems_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_audit_file_systems_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_audit_file_systems_policies_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_audit_file_systems_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_audit_file_systems_policies_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_audit_file_systems_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_audit_file_systems_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api214_audit_file_systems_policies_delete_with_http_info = audit_file_systems_policies_delete_with_http_info
    api214_audit_file_systems_policies_get_with_http_info = audit_file_systems_policies_get_with_http_info
    api214_audit_file_systems_policies_members_delete_with_http_info = audit_file_systems_policies_members_delete_with_http_info
    api214_audit_file_systems_policies_members_get_with_http_info = audit_file_systems_policies_members_get_with_http_info
    api214_audit_file_systems_policies_members_post_with_http_info = audit_file_systems_policies_members_post_with_http_info
    api214_audit_file_systems_policies_patch_with_http_info = audit_file_systems_policies_patch_with_http_info
    api214_audit_file_systems_policies_post_with_http_info = audit_file_systems_policies_post_with_http_info
    api215_audit_file_systems_policies_delete_with_http_info = audit_file_systems_policies_delete_with_http_info
    api215_audit_file_systems_policies_get_with_http_info = audit_file_systems_policies_get_with_http_info
    api215_audit_file_systems_policies_members_delete_with_http_info = audit_file_systems_policies_members_delete_with_http_info
    api215_audit_file_systems_policies_members_get_with_http_info = audit_file_systems_policies_members_get_with_http_info
    api215_audit_file_systems_policies_members_post_with_http_info = audit_file_systems_policies_members_post_with_http_info
    api215_audit_file_systems_policies_patch_with_http_info = audit_file_systems_policies_patch_with_http_info
    api215_audit_file_systems_policies_post_with_http_info = audit_file_systems_policies_post_with_http_info
    api216_audit_file_systems_policies_delete_with_http_info = audit_file_systems_policies_delete_with_http_info
    api216_audit_file_systems_policies_get_with_http_info = audit_file_systems_policies_get_with_http_info
    api216_audit_file_systems_policies_members_delete_with_http_info = audit_file_systems_policies_members_delete_with_http_info
    api216_audit_file_systems_policies_members_get_with_http_info = audit_file_systems_policies_members_get_with_http_info
    api216_audit_file_systems_policies_members_post_with_http_info = audit_file_systems_policies_members_post_with_http_info
    api216_audit_file_systems_policies_patch_with_http_info = audit_file_systems_policies_patch_with_http_info
    api216_audit_file_systems_policies_post_with_http_info = audit_file_systems_policies_post_with_http_info
