...
from pypureclient.flashblade._common.models.certificate_certificate_group_get_resp_v_2_0 import CertificateCertificateGroupGetResp
from pypureclient.flashblade._common.models.certificate_certificate_group_response_v_2_0 import CertificateCertificateGroupResponse
from pypureclient.flashblade._common.models.certificate_get_response_v_2_0 import CertificateGetResponse
from pypureclient.flashblade._common.models.certificate_patch_v_2_0 import CertificatePatch
from pypureclient.flashblade._common.models.certificate_post_v_2_15 import CertificatePost
from pypureclient.flashblade._common.models.certificate_response_v_2_0 import CertificateResponse
from pypureclient.flashblade._common.models.certificate_use_get_response_v_2_0 import CertificateUseGetResponse
...
class CertificatesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_certificates_certificate_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_certificates_certificate_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_certificates_certificate_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_certificates_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_certificates_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_certificates_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_certificates_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def certificates_uses_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_certificates_uses_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/certificates/uses', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api217_certificates_certificate_groups_delete_with_http_info = certificates_certificate_groups_delete_with_http_info
    api217_certificates_certificate_groups_get_with_http_info = certificates_certificate_groups_get_with_http_info
    api217_certificates_certificate_groups_post_with_http_info = certificates_certificate_groups_post_with_http_info
    ...
    api217_certificates_uses_get_with_http_info = certificates_uses_get_with_http_info
    api218_certificates_certificate_groups_delete_with_http_info = certificates_certificate_groups_delete_with_http_info
    api218_certificates_certificate_groups_get_with_http_info = certificates_certificate_groups_get_with_http_info
    api218_certificates_certificate_groups_post_with_http_info = certificates_certificate_groups_post_with_http_info
    api218_certificates_delete_with_http_info = certificates_delete_with_http_info
    api218_certificates_get_with_http_info = certificates_get_with_http_info
    api218_certificates_patch_with_http_info = certificates_patch_with_http_info
    api218_certificates_post_with_http_info = certificates_post_with_http_info
    api218_certificates_uses_get_with_http_info = certificates_uses_get_with_http_info
    api219_certificates_certificate_groups_delete_with_http_info = certificates_certificate_groups_delete_with_http_info
    api219_certificates_certificate_groups_get_with_http_info = certificates_certificate_groups_get_with_http_info
    api219_certificates_certificate_groups_post_with_http_info = certificates_certificate_groups_post_with_http_info
    ...
    api219_certificates_uses_get_with_http_info = certificates_uses_get_with_http_info
