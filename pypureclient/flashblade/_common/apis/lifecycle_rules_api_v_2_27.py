...
from pypureclient.flashblade._common.models.lifecycle_rule_post_v_2_26 import LifecycleRulePost
...
class LifecycleRulesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_lifecycle_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_lifecycle_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_lifecycle_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_lifecycle_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api227_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api227_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api227_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
