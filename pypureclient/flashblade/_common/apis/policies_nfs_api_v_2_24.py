...
from pypureclient.flashblade._common.models.nfs_export_policy_get_response_v_2_24 import NfsExportPolicyGetResponse
from pypureclient.flashblade._common.models.nfs_export_policy_patch_v_2_24 import NfsExportPolicyPatch
from pypureclient.flashblade._common.models.nfs_export_policy_post_v_2_24 import NfsExportPolicyPost
from pypureclient.flashblade._common.models.nfs_export_policy_response_v_2_24 import NfsExportPolicyResponse
from pypureclient.flashblade._common.models.nfs_export_policy_rule_get_response_v_2_24 import NfsExportPolicyRuleGetResponse
from pypureclient.flashblade._common.models.nfs_export_policy_rule_patch_v_2_24 import NfsExportPolicyRulePatch
from pypureclient.flashblade._common.models.nfs_export_policy_rule_response_v_2_24 import NfsExportPolicyRuleResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api224_nfs_export_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_nfs_export_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_nfs_export_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_nfs_export_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_nfs_export_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_nfs_export_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_nfs_export_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_nfs_export_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
