...
from pypureclient.flashblade._common.models.object_store_account_export_get_response_v_2_26 import ObjectStoreAccountExportGetResponse
from pypureclient.flashblade._common.models.object_store_account_export_patch_v_2_26 import ObjectStoreAccountExportPatch
from pypureclient.flashblade._common.models.object_store_account_export_post_v_2_26 import ObjectStoreAccountExportPost
from pypureclient.flashblade._common.models.object_store_account_export_response_v_2_26 import ObjectStoreAccountExportResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_object_store_account_exports_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_object_store_account_exports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_object_store_account_exports_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_object_store_account_exports_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
