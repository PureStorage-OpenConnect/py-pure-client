...
from pypureclient.flashblade._common.models.smb_client_policy_get_response_v_2_26 import SmbClientPolicyGetResponse
from pypureclient.flashblade._common.models.smb_client_policy_patch_v_2_26 import SmbClientPolicyPatch
from pypureclient.flashblade._common.models.smb_client_policy_post_v_2_26 import SmbClientPolicyPost
from pypureclient.flashblade._common.models.smb_client_policy_response_v_2_26 import SmbClientPolicyResponse
from pypureclient.flashblade._common.models.smb_client_policy_rule_get_response_v_2_26 import SmbClientPolicyRuleGetResponse
from pypureclient.flashblade._common.models.smb_client_policy_rule_post_v_2_26 import SmbClientPolicyRulePost
from pypureclient.flashblade._common.models.smb_client_policy_rule_response_v_2_26 import SmbClientPolicyRuleResponse
from pypureclient.flashblade._common.models.smb_client_policy_rule_v_2_26 import SmbClientPolicyRule
...
class PoliciesSMBClientApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_smb_client_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_smb_client_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "SmbClientPolicyGetResponse",
        }
    ...
    def smb_client_policies_patch_with_http_info(
        ...
        **kwargs
        ...
        :type policy: SmbClientPolicyPatch
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        :param context_names: Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.
        :type context_names: List[str]
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_smb_client_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_smb_client_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_smb_client_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_smb_client_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "SmbClientPolicyRuleGetResponse",
        }
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_smb_client_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_smb_client_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api226_smb_client_policies_delete_with_http_info = smb_client_policies_delete_with_http_info
    api226_smb_client_policies_get_with_http_info = smb_client_policies_get_with_http_info
    api226_smb_client_policies_patch_with_http_info = smb_client_policies_patch_with_http_info
    api226_smb_client_policies_post_with_http_info = smb_client_policies_post_with_http_info
    api226_smb_client_policies_rules_delete_with_http_info = smb_client_policies_rules_delete_with_http_info
    api226_smb_client_policies_rules_get_with_http_info = smb_client_policies_rules_get_with_http_info
    api226_smb_client_policies_rules_patch_with_http_info = smb_client_policies_rules_patch_with_http_info
    api226_smb_client_policies_rules_post_with_http_info = smb_client_policies_rules_post_with_http_info
