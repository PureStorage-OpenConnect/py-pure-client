...
from pypureclient.flashblade._common.models.audit_get_response_v_2_0 import AuditGetResponse
...
class AuditsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api20_audits_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api20_audits_get_with_http_info = audits_get_with_http_info
    api21_audits_get_with_http_info = audits_get_with_http_info
    api210_audits_get_with_http_info = audits_get_with_http_info
    api211_audits_get_with_http_info = audits_get_with_http_info
    api212_audits_get_with_http_info = audits_get_with_http_info
