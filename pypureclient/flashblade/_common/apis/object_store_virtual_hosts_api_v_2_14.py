...
class ObjectStoreVirtualHostsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_object_store_virtual_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_object_store_virtual_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_object_store_virtual_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api214_object_store_virtual_hosts_delete_with_http_info = object_store_virtual_hosts_delete_with_http_info
    api214_object_store_virtual_hosts_get_with_http_info = object_store_virtual_hosts_get_with_http_info
    api214_object_store_virtual_hosts_post_with_http_info = object_store_virtual_hosts_post_with_http_info
    api215_object_store_virtual_hosts_delete_with_http_info = object_store_virtual_hosts_delete_with_http_info
    api215_object_store_virtual_hosts_get_with_http_info = object_store_virtual_hosts_get_with_http_info
    api215_object_store_virtual_hosts_post_with_http_info = object_store_virtual_hosts_post_with_http_info
    api216_object_store_virtual_hosts_delete_with_http_info = object_store_virtual_hosts_delete_with_http_info
    api216_object_store_virtual_hosts_get_with_http_info = object_store_virtual_hosts_get_with_http_info
    api216_object_store_virtual_hosts_post_with_http_info = object_store_virtual_hosts_post_with_http_info
