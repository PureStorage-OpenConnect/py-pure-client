...
from pypureclient.flashblade._common.models.object_store_remote_credential_get_resp_v_2_26 import ObjectStoreRemoteCredentialGetResp
from pypureclient.flashblade._common.models.object_store_remote_credentials_post_v_2_26 import ObjectStoreRemoteCredentialsPost
from pypureclient.flashblade._common.models.object_store_remote_credentials_resp_v_2_26 import ObjectStoreRemoteCredentialsResp
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_object_store_remote_credentials_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_object_store_remote_credentials_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_object_store_remote_credentials_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_object_store_remote_credentials_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
