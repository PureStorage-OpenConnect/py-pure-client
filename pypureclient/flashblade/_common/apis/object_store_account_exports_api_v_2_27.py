...
from pypureclient.flashblade._common.models.object_store_account_export_get_response_v_2_24 import ObjectStoreAccountExportGetResponse
from pypureclient.flashblade._common.models.object_store_account_export_patch_v_2_22 import ObjectStoreAccountExportPatch
from pypureclient.flashblade._common.models.object_store_account_export_post_v_2_22 import ObjectStoreAccountExportPost
from pypureclient.flashblade._common.models.object_store_account_export_response_v_2_24 import ObjectStoreAccountExportResponse

class ObjectStoreAccountExportsApi:
    ...
    def object_store_account_exports_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_object_store_account_exports_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/object-store-account-exports', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def object_store_account_exports_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ObjectStoreAccountExportGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_object_store_account_exports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ObjectStoreAccountExportGetResponse",
            '207': "ObjectStoreAccountExportGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/object-store-account-exports', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def object_store_account_exports_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        :param object_store_account_export: (required)
        :type object_store_account_export: ObjectStoreAccountExportPatch
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        :param context_names: Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.
        :type context_names: List[str]
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ObjectStoreAccountExportResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'object_store_account_export',
            'x_request_id',
            'context_names',
            'ids',
            'names'
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_object_store_account_exports_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['object_store_account_export'] is not None:
            _body_params = _params['object_store_account_export']
        ...
        _response_types_map = {
            '200': "ObjectStoreAccountExportResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/object-store-account-exports', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def object_store_account_exports_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        :param object_store_account_export: (required)
        :type object_store_account_export: ObjectStoreAccountExportPost
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        :param context_names: Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.
        :type context_names: List[str]
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_object_store_account_exports_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/object-store-account-exports', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api227_object_store_account_exports_delete_with_http_info = object_store_account_exports_delete_with_http_info
    api227_object_store_account_exports_get_with_http_info = object_store_account_exports_get_with_http_info
    api227_object_store_account_exports_patch_with_http_info = object_store_account_exports_patch_with_http_info
    api227_object_store_account_exports_post_with_http_info = object_store_account_exports_post_with_http_info
