...
from pypureclient.flashblade._common.models.audit_object_store_policies_get_response_v_2_20 import AuditObjectStorePoliciesGetResponse
from pypureclient.flashblade._common.models.audit_object_store_policies_members_get_response_v_2_20 import AuditObjectStorePoliciesMembersGetResponse
from pypureclient.flashblade._common.models.audit_object_store_policies_members_response_v_2_20 import AuditObjectStorePoliciesMembersResponse
from pypureclient.flashblade._common.models.audit_object_store_policies_patch_v_2_20 import AuditObjectStorePoliciesPatch
from pypureclient.flashblade._common.models.audit_object_store_policies_post_v_2_20 import AuditObjectStorePoliciesPost
from pypureclient.flashblade._common.models.audit_object_store_policies_response_v_2_20 import AuditObjectStorePoliciesResponse

class PoliciesAuditForObjectStoreApi:
    ...
    def audit_object_store_policies_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api220_audit_object_store_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/audit-object-store-policies', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def audit_object_store_policies_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(AuditObjectStorePoliciesGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_audit_object_store_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "AuditObjectStorePoliciesGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/audit-object-store-policies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def audit_object_store_policies_members_delete_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_audit_object_store_policies_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/audit-object-store-policies/members', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def audit_object_store_policies_members_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique contexts specified. If specified, each context name must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`. Enter multiple names in comma-separated format. For example, `name01,name02`.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(AuditObjectStorePoliciesMembersGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_audit_object_store_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "AuditObjectStorePoliciesMembersGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/audit-object-store-policies/members', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def audit_object_store_policies_members_post_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        member_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of member IDs. If after filtering, there is not at least one resource that matches each of the elements of `member_ids`, then an error is returned. This cannot be provided together with the `member_names` query parameter.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(AuditObjectStorePoliciesMembersResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_audit_object_store_policies_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "AuditObjectStorePoliciesMembersResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/audit-object-store-policies/members', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def audit_object_store_policies_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        :type policy: AuditObjectStorePoliciesPatch
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        :param context_names: Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.
        :type context_names: List[str]
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(AuditObjectStorePoliciesResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_audit_object_store_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "AuditObjectStorePoliciesResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/audit-object-store-policies', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def audit_object_store_policies_post_with_http_info(
        self,
        names: Annotated[conlist(StrictStr), Field(..., description="A comma-separated list of resource names.")],
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        policy: Optional[AuditObjectStorePoliciesPost] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        :type context_names: List[str]
        :param policy:
        :type policy: AuditObjectStorePoliciesPost
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the ApiResponse.data will
                                 be set to none and raw_data will store the
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_audit_object_store_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/audit-object-store-policies', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api220_audit_object_store_policies_delete_with_http_info = audit_object_store_policies_delete_with_http_info
    api220_audit_object_store_policies_get_with_http_info = audit_object_store_policies_get_with_http_info
    api220_audit_object_store_policies_members_delete_with_http_info = audit_object_store_policies_members_delete_with_http_info
    api220_audit_object_store_policies_members_get_with_http_info = audit_object_store_policies_members_get_with_http_info
    api220_audit_object_store_policies_members_post_with_http_info = audit_object_store_policies_members_post_with_http_info
    api220_audit_object_store_policies_patch_with_http_info = audit_object_store_policies_patch_with_http_info
    api220_audit_object_store_policies_post_with_http_info = audit_object_store_policies_post_with_http_info
    api221_audit_object_store_policies_delete_with_http_info = audit_object_store_policies_delete_with_http_info
    api221_audit_object_store_policies_get_with_http_info = audit_object_store_policies_get_with_http_info
    api221_audit_object_store_policies_members_delete_with_http_info = audit_object_store_policies_members_delete_with_http_info
    api221_audit_object_store_policies_members_get_with_http_info = audit_object_store_policies_members_get_with_http_info
    api221_audit_object_store_policies_members_post_with_http_info = audit_object_store_policies_members_post_with_http_info
    api221_audit_object_store_policies_patch_with_http_info = audit_object_store_policies_patch_with_http_info
    api221_audit_object_store_policies_post_with_http_info = audit_object_store_policies_post_with_http_info
