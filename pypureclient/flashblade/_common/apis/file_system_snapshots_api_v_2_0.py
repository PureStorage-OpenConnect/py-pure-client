...
from pypureclient.flashblade._common.models.file_system_snapshot_get_response_v_2_0 import FileSystemSnapshotGetResponse
from pypureclient.flashblade._common.models.file_system_snapshot_get_transfer_response_v_2_0 import FileSystemSnapshotGetTransferResponse
from pypureclient.flashblade._common.models.file_system_snapshot_post_v_2_0 import FileSystemSnapshotPost
from pypureclient.flashblade._common.models.file_system_snapshot_response_v_2_0 import FileSystemSnapshotResponse
from pypureclient.flashblade._common.models.file_system_snapshot_v_2_0 import FileSystemSnapshot
from pypureclient.flashblade._common.models.policy_file_system_snapshot_get_response_v_2_0 import PolicyFileSystemSnapshotGetResponse
...
class FileSystemSnapshotsApi:
    ...
    def file_system_snapshots_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api20_file_system_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/file-system-snapshots', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def file_system_snapshots_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_file_system_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/file-system-snapshots', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def file_system_snapshots_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_file_system_snapshots_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/file-system-snapshots', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def file_system_snapshots_policies_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_file_system_snapshots_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/file-system-snapshots/policies', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def file_system_snapshots_policies_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        limit: Annotated[Optional[conint(strict=True, ge=0)], Field(description="Limit the size of the response to the specified number of resources. A `limit` of `0` can be used to get the number of resources without getting all of the resources. It will be returned in the `total_item_count` field. If a client asks for a page size larger than the available number, the request is still valid. In that case the server just returns the available number of items, disregarding the client's page size request.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_file_system_snapshots_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/file-system-snapshots/policies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def file_system_snapshots_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_file_system_snapshots_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/file-system-snapshots', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def file_system_snapshots_transfer_delete_with_http_info(
        self,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_file_system_snapshots_transfer_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/file-system-snapshots/transfer', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def file_system_snapshots_transfer_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_file_system_snapshots_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/file-system-snapshots/transfer', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api20_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api20_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api20_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api20_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api20_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api20_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api20_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api20_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
    api21_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api21_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api21_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api21_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api21_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api21_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api21_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api21_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
    api210_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api210_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api210_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api210_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api210_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api210_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api210_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api210_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
    api211_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api211_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api211_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api211_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api211_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api211_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api211_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api211_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
    api212_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api212_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api212_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api212_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api212_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api212_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api212_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api212_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
    api213_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api213_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api213_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api213_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api213_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api213_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api213_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api213_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
    api22_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api22_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api22_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api22_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api22_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api22_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api22_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api22_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
    api23_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api23_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api23_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api23_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api23_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api23_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api23_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api23_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
    api24_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api24_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api24_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api24_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api24_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api24_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api24_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api24_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
    api25_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api25_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api25_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api25_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api25_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api25_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api25_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api25_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
    api26_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api26_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api26_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api26_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api26_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api26_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api26_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api26_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
    api27_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api27_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api27_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api27_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api27_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api27_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api27_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api27_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
    api28_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api28_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api28_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api28_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api28_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api28_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api28_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api28_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
    api29_file_system_snapshots_delete_with_http_info = file_system_snapshots_delete_with_http_info
    api29_file_system_snapshots_get_with_http_info = file_system_snapshots_get_with_http_info
    api29_file_system_snapshots_patch_with_http_info = file_system_snapshots_patch_with_http_info
    api29_file_system_snapshots_policies_delete_with_http_info = file_system_snapshots_policies_delete_with_http_info
    api29_file_system_snapshots_policies_get_with_http_info = file_system_snapshots_policies_get_with_http_info
    api29_file_system_snapshots_post_with_http_info = file_system_snapshots_post_with_http_info
    api29_file_system_snapshots_transfer_delete_with_http_info = file_system_snapshots_transfer_delete_with_http_info
    api29_file_system_snapshots_transfer_get_with_http_info = file_system_snapshots_transfer_get_with_http_info
