...
from pypureclient.flashblade._common.models.file_system_export_get_response_v_2_23 import FileSystemExportGetResponse
from pypureclient.flashblade._common.models.file_system_export_patch_v_2_23 import FileSystemExportPatch
from pypureclient.flashblade._common.models.file_system_export_post_v_2_22 import FileSystemExportPost
from pypureclient.flashblade._common.models.file_system_export_response_v_2_23 import FileSystemExportResponse

class FileSystemExportsApi:
    ...
    def file_system_exports_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api223_file_system_exports_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/file-system-exports', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def file_system_exports_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(FileSystemExportGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_file_system_exports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "FileSystemExportGetResponse",
            '207': "FileSystemExportGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/file-system-exports', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def file_system_exports_patch_with_http_info(
        self,
        file_system_export: FileSystemExportPatch,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique names specified. Enter multiple names in comma-separated format. For example, `name01,name02`. If there is not at least one resource that matches each of the elements of `names`, then an error is returned, except when creating new resources.")] = None,
        **kwargs
        ...
        :type file_system_export: FileSystemExportPatch
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        :param context_names: Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.
        :type context_names: List[str]
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(FileSystemExportResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_file_system_exports_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['file_system_export'] is not None:
            _body_params = _params['file_system_export']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/file-system-exports', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def file_system_exports_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_file_system_exports_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/file-system-exports', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api223_file_system_exports_delete_with_http_info = file_system_exports_delete_with_http_info
    api223_file_system_exports_get_with_http_info = file_system_exports_get_with_http_info
    api223_file_system_exports_patch_with_http_info = file_system_exports_patch_with_http_info
    api223_file_system_exports_post_with_http_info = file_system_exports_post_with_http_info
    api224_file_system_exports_delete_with_http_info = file_system_exports_delete_with_http_info
    api224_file_system_exports_get_with_http_info = file_system_exports_get_with_http_info
    api224_file_system_exports_patch_with_http_info = file_system_exports_patch_with_http_info
    api224_file_system_exports_post_with_http_info = file_system_exports_post_with_http_info
    api225_file_system_exports_delete_with_http_info = file_system_exports_delete_with_http_info
