...
from pypureclient.flashblade._common.models.blade_get_response_v_2_0 import BladeGetResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_blades_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
