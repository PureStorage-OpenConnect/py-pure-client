...
from pypureclient.flashblade._common.models.admin_get_response_v_2_0 import AdminGetResponse
from pypureclient.flashblade._common.models.admin_patch_v_2_0 import AdminPatch
from pypureclient.flashblade._common.models.admin_response_v_2_0 import AdminResponse
...
class AdministratorsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api20_admins_api_tokens_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_admins_api_tokens_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_admins_api_tokens_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_admins_cache_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_admins_cache_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_admins_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_admins_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api20_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api20_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api20_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api20_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api20_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api20_admins_get_with_http_info = admins_get_with_http_info
    api20_admins_patch_with_http_info = admins_patch_with_http_info
    api21_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api21_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api21_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api21_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api21_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api21_admins_get_with_http_info = admins_get_with_http_info
    api21_admins_patch_with_http_info = admins_patch_with_http_info
