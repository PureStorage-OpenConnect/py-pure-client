...
from pypureclient.flashblade._common.models.drive_get_response_v_2_9 import DriveGetResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_drives_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
