...
from pypureclient.flashblade._common.models.qos_policies_get_response_v_2_19 import QosPoliciesGetResponse
from pypureclient.flashblade._common.models.qos_policies_response_v_2_19 import QosPoliciesResponse
from pypureclient.flashblade._common.models.qos_policy_v_2_19 import QosPolicy
...
class PoliciesQoSApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api219_qos_policies_buckets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_qos_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_qos_policies_file_systems_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_qos_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_qos_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_qos_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_qos_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api219_qos_policies_buckets_get_with_http_info = qos_policies_buckets_get_with_http_info
    api219_qos_policies_delete_with_http_info = qos_policies_delete_with_http_info
    api219_qos_policies_file_systems_get_with_http_info = qos_policies_file_systems_get_with_http_info
    api219_qos_policies_get_with_http_info = qos_policies_get_with_http_info
    api219_qos_policies_members_get_with_http_info = qos_policies_members_get_with_http_info
    api219_qos_policies_patch_with_http_info = qos_policies_patch_with_http_info
    api219_qos_policies_post_with_http_info = qos_policies_post_with_http_info
