...
from pypureclient.flashblade._common.models.remote_realms_response_v_2_25 import RemoteRealmsResponse
...
class RemoteRealmsApi:
    ...
    def remote_realms_get_with_http_info(
        ...
        on_ids: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the target IDs specified. Enter multiple target IDs in comma-separated format. The `on` and `on_ids` parameters cannot be specified together.")] = None,
        ...
        **kwargs
        ...
        :type on: List[str]
        :param on_ids: Performs the operation on the target IDs specified. Enter multiple target IDs in comma-separated format. The `on` and `on_ids` parameters cannot be specified together.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api225_remote_realms_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
