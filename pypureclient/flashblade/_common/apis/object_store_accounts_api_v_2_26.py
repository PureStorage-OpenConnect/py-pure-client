...
from pypureclient.flashblade._common.models.object_store_account_get_response_v_2_26 import ObjectStoreAccountGetResponse
from pypureclient.flashblade._common.models.object_store_account_patch_v_2_26 import ObjectStoreAccountPatch
from pypureclient.flashblade._common.models.object_store_account_post_v_2_26 import ObjectStoreAccountPost
from pypureclient.flashblade._common.models.object_store_account_response_v_2_26 import ObjectStoreAccountResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_object_store_accounts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_object_store_accounts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_object_store_accounts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_object_store_accounts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
