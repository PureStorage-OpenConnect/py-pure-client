...
from pypureclient.flashblade._common.models.support_get_response_v_2_18 import SupportGetResponse
from pypureclient.flashblade._common.models.support_response_v_2_18 import SupportResponse
from pypureclient.flashblade._common.models.support_system_manifest_response_v_2_26 import SupportSystemManifestResponse
from pypureclient.flashblade._common.models.support_v_2_18 import Support
...
class SupportApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_support_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_support_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def support_system_manifest_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SupportSystemManifestResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_support_system_manifest_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "SupportSystemManifestResponse",
            '207': "SupportSystemManifestResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/support/system-manifest', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_support_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
