...
from pypureclient.flashblade._common.models.public_key_get_response_v_2_22 import PublicKeyGetResponse
from pypureclient.flashblade._common.models.public_key_post_v_2_14 import PublicKeyPost
from pypureclient.flashblade._common.models.public_key_response_v_2_22 import PublicKeyResponse
from pypureclient.flashblade._common.models.public_key_use_get_response_v_2_22 import PublicKeyUseGetResponse
...
class PublicKeysApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_public_keys_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_public_keys_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_public_keys_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_public_keys_uses_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_public_keys_delete_with_http_info = public_keys_delete_with_http_info
