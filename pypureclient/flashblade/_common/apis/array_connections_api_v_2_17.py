...
from pypureclient.flashblade._common.models.array_connection_get_response_v_2_17 import ArrayConnectionGetResponse
...
from pypureclient.flashblade._common.models.array_connection_path_get_response_v_2_17 import ArrayConnectionPathGetResponse
from pypureclient.flashblade._common.models.array_connection_post_v_2_17 import ArrayConnectionPost
from pypureclient.flashblade._common.models.array_connection_response_v_2_17 import ArrayConnectionResponse
from pypureclient.flashblade._common.models.array_connection_v_2_17 import ArrayConnection
from pypureclient.flashblade._common.models.connection_relationship_performance_replication_get_resp_v_2_2 import ConnectionRelationshipPerformanceReplicationGetResp
...
class ArrayConnectionsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_array_connections_connection_key_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_array_connections_connection_key_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def array_connections_delete_with_http_info(
        ...
        **kwargs
        ...
        :param ids: A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.
        :type ids: List[str]
        :param remote_ids: A comma-separated list of remote array IDs. Deprecated, best practice is to reference connections with `ids`. If after filtering, there is not at least one resource that matches each of the elements, then an error is returned. This cannot be provided together with the `remote_names` query parameter.
        :type remote_ids: List[str]
        :param remote_names: A comma-separated list of remote array names. Deprecated, best practice is to reference connections with `ids`. If there is not at least one resource that matches each of the elements, then an error is returned. This cannot be provided together with `remote_ids` query parameter.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_array_connections_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_array_connections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_array_connections_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_array_connections_path_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_array_connections_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_array_connections_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api217_array_connections_connection_key_post_with_http_info = array_connections_connection_key_post_with_http_info
    ...
    api217_array_connections_performance_replication_get_with_http_info = array_connections_performance_replication_get_with_http_info
    api217_array_connections_post_with_http_info = array_connections_post_with_http_info
    api218_array_connections_connection_key_get_with_http_info = array_connections_connection_key_get_with_http_info
    api218_array_connections_connection_key_post_with_http_info = array_connections_connection_key_post_with_http_info
    api218_array_connections_delete_with_http_info = array_connections_delete_with_http_info
    api218_array_connections_get_with_http_info = array_connections_get_with_http_info
    api218_array_connections_patch_with_http_info = array_connections_patch_with_http_info
    api218_array_connections_path_get_with_http_info = array_connections_path_get_with_http_info
    api218_array_connections_performance_replication_get_with_http_info = array_connections_performance_replication_get_with_http_info
    api218_array_connections_post_with_http_info = array_connections_post_with_http_info
    api219_array_connections_connection_key_get_with_http_info = array_connections_connection_key_get_with_http_info
    api219_array_connections_connection_key_post_with_http_info = array_connections_connection_key_post_with_http_info
    ...
    api219_array_connections_performance_replication_get_with_http_info = array_connections_performance_replication_get_with_http_info
    ...
    api220_array_connections_connection_key_post_with_http_info = array_connections_connection_key_post_with_http_info
    ...
    api220_array_connections_performance_replication_get_with_http_info = array_connections_performance_replication_get_with_http_info
    ...
    api221_array_connections_connection_key_post_with_http_info = array_connections_connection_key_post_with_http_info
    ...
    api221_array_connections_performance_replication_get_with_http_info = array_connections_performance_replication_get_with_http_info
