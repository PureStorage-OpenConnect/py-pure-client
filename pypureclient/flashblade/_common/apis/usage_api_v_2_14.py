...
from pypureclient.flashblade._common.models.group_quota_get_response_v_2_0 import GroupQuotaGetResponse
from pypureclient.flashblade._common.models.user_quota_get_response_v_2_0 import UserQuotaGetResponse
...
class UsageApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_usage_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_usage_users_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api214_usage_groups_get_with_http_info = usage_groups_get_with_http_info
    api214_usage_users_get_with_http_info = usage_users_get_with_http_info
    api215_usage_groups_get_with_http_info = usage_groups_get_with_http_info
    api215_usage_users_get_with_http_info = usage_users_get_with_http_info
    api216_usage_groups_get_with_http_info = usage_groups_get_with_http_info
    api216_usage_users_get_with_http_info = usage_users_get_with_http_info
