...
from pypureclient.flashblade._common.models.link_aggregation_group_get_response_v_2_22 import LinkAggregationGroupGetResponse
from pypureclient.flashblade._common.models.link_aggregation_group_patch_v_2_22 import LinkAggregationGroupPatch
from pypureclient.flashblade._common.models.link_aggregation_group_response_v_2_22 import LinkAggregationGroupResponse
from pypureclient.flashblade._common.models.link_aggregation_group_v_2_22 import LinkAggregationGroup
...
class LinkAggregationGroupsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_link_aggregation_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_link_aggregation_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_link_aggregation_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_link_aggregation_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_link_aggregation_groups_delete_with_http_info = link_aggregation_groups_delete_with_http_info
