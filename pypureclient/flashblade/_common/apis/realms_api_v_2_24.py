...
from pypureclient.flashblade._common.models.realm_defaults_get_response_v_2_22 import RealmDefaultsGetResponse
from pypureclient.flashblade._common.models.realm_defaults_response_v_2_22 import RealmDefaultsResponse
from pypureclient.flashblade._common.models.realm_defaults_v_2_22 import RealmDefaults
from pypureclient.flashblade._common.models.realm_get_response_v_2_24 import RealmGetResponse
from pypureclient.flashblade._common.models.realm_patch_v_2_22 import RealmPatch
from pypureclient.flashblade._common.models.realm_response_v_2_22 import RealmResponse
from pypureclient.flashblade._common.models.realm_space_get_response_v_2_19 import RealmSpaceGetResponse
from pypureclient.flashblade._common.models.realm_space_storage_class_get_response_v_2_19 import RealmSpaceStorageClassGetResponse
...
class RealmsApi:
    ...
    def realms_defaults_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        :rtype: tuple(RealmDefaultsGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api224_realms_defaults_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "RealmDefaultsGetResponse",
            '207': "RealmDefaultsGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/realms/defaults', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def realms_defaults_patch_with_http_info(
        self,
        default_realm_configuration: RealmDefaults,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        :param default_realm_configuration: (required)
        :type default_realm_configuration: RealmDefaults
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(RealmDefaultsResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'default_realm_configuration',
            'x_request_id',
            'context_names',
            'realm_ids',
            'realm_names'
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_realms_defaults_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['default_realm_configuration'] is not None:
            _body_params = _params['default_realm_configuration']
        ...
        _response_types_map = {
            '200': "RealmDefaultsResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/realms/defaults', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_realms_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_realms_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_realms_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_realms_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_realms_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def realms_space_storage_classes_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="A token used to retrieve the next page of data with some consistency guaranteed. The token is a Base64 encoded value. Set `continuation_token` to the system-generated token taken from the `x-next-token` header field of the response. A query has reached its last page when the response does not include a token. Pagination requires the `limit` and `continuation_token` query parameters.")] = None,
        end_time: Annotated[Optional[conint(strict=True, ge=0)], Field(description="When the time window ends (in milliseconds since epoch).")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_realms_space_storage_classes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/realms/space/storage-classes', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api224_realms_defaults_get_with_http_info = realms_defaults_get_with_http_info
    api224_realms_defaults_patch_with_http_info = realms_defaults_patch_with_http_info
    api224_realms_delete_with_http_info = realms_delete_with_http_info
    api224_realms_get_with_http_info = realms_get_with_http_info
    api224_realms_patch_with_http_info = realms_patch_with_http_info
    api224_realms_post_with_http_info = realms_post_with_http_info
    api224_realms_space_get_with_http_info = realms_space_get_with_http_info
    api224_realms_space_storage_classes_get_with_http_info = realms_space_storage_classes_get_with_http_info
    api225_realms_defaults_get_with_http_info = realms_defaults_get_with_http_info
    api225_realms_defaults_patch_with_http_info = realms_defaults_patch_with_http_info
    api225_realms_delete_with_http_info = realms_delete_with_http_info
    api225_realms_get_with_http_info = realms_get_with_http_info
    api225_realms_patch_with_http_info = realms_patch_with_http_info
