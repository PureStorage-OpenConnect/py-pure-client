...
from pypureclient.flashblade._common.models.fleet_get_response_v_2_22 import FleetGetResponse
from pypureclient.flashblade._common.models.fleet_key_get_response_v_2_18 import FleetKeyGetResponse
from pypureclient.flashblade._common.models.fleet_key_response_v_2_18 import FleetKeyResponse
from pypureclient.flashblade._common.models.fleet_member_batch_post_v_2_27 import FleetMemberBatchPost
from pypureclient.flashblade._common.models.fleet_member_batch_response_v_2_27 import FleetMemberBatchResponse
from pypureclient.flashblade._common.models.fleet_member_get_response_v_2_22 import FleetMemberGetResponse
from pypureclient.flashblade._common.models.fleet_member_post_v_2_17 import FleetMemberPost
from pypureclient.flashblade._common.models.fleet_member_response_v_2_22 import FleetMemberResponse
from pypureclient.flashblade._common.models.fleet_patch_v_2_22 import FleetPatch
from pypureclient.flashblade._common.models.fleet_response_v_2_22 import FleetResponse
...
class FleetsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_fleets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_fleets_fleet_key_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_fleets_fleet_key_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_fleets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def fleets_members_batch_post_with_http_info(
        self,
        fleet_member_batch_post: conlist(FleetMemberBatchPost),
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        validate_target_certificates: Annotated[Optional[StrictBool], Field(description="Controls certificate validation behavior for all targets in the batch operation. If set to `true`, the certificate presented by each remote target is validated using the provided `ca_certificate` or `ca_certificate_group`. If set to `false`, certificate validation is skipped and any provided `ca_certificate` or `ca_certificate_group` values are ignored. If not specified, defaults to `true`.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        """Create fleet members in batch

        Creates multiple fleet member relationships in a single request. Adds arrays to an existing fleet. Fleets can include FlashArray and FlashBlade arrays. Arrays can only belong to one fleet at a time.

        :param fleet_member_batch_post: (required)
        :type fleet_member_batch_post: List[FleetMemberBatchPost]
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        ...
        :param validate_target_certificates: Controls certificate validation behavior for all targets in the batch operation. If set to `true`, the certificate presented by each remote target is validated using the provided `ca_certificate` or `ca_certificate_group`. If set to `false`, certificate validation is skipped and any provided `ca_certificate` or `ca_certificate_group` values are ignored. If not specified, defaults to `true`.
        :type validate_target_certificates: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the ApiResponse.data will
                                 be set to none and raw_data will store the
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(FleetMemberBatchResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'fleet_member_batch_post',
            'x_request_id',
            'fleet_ids',
            'fleet_names',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_fleets_members_batch_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('validate_target_certificates') is not None:  # noqa: E501
            _query_params.append(('validate_target_certificates', _params['validate_target_certificates']))
        ...
        # process the body parameter
        _body_params = None
        if _params['fleet_member_batch_post'] is not None:
            _body_params = _params['fleet_member_batch_post']
        ...
        _response_types_map = {
            '200': "FleetMemberBatchResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/fleets/members/batch', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_fleets_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_fleets_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_fleets_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_fleets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_fleets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_fleets_delete_with_http_info = fleets_delete_with_http_info
    api227_fleets_fleet_key_get_with_http_info = fleets_fleet_key_get_with_http_info
    api227_fleets_fleet_key_post_with_http_info = fleets_fleet_key_post_with_http_info
    api227_fleets_get_with_http_info = fleets_get_with_http_info
    api227_fleets_members_batch_post_with_http_info = fleets_members_batch_post_with_http_info
    api227_fleets_members_delete_with_http_info = fleets_members_delete_with_http_info
    api227_fleets_members_get_with_http_info = fleets_members_get_with_http_info
    api227_fleets_members_post_with_http_info = fleets_members_post_with_http_info
    api227_fleets_patch_with_http_info = fleets_patch_with_http_info
    api227_fleets_post_with_http_info = fleets_post_with_http_info
