...
from pypureclient.flashblade._common.models.policy_base_get_response_v_2_2 import PolicyBaseGetResponse
from pypureclient.flashblade._common.models.policy_member_with_remote_get_response_v_2_0 import PolicyMemberWithRemoteGetResponse
...
class PoliciesAllApi:
    ...
    def policies_all_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        :rtype: tuple(PolicyBaseGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api22_policies_all_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/policies-all', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def policies_all_members_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        limit: Annotated[Optional[conint(strict=True, ge=0)], Field(description="Limit the size of the response to the specified number of resources. A `limit` of `0` can be used to get the number of resources without getting all of the resources. It will be returned in the `total_item_count` field. If a client asks for a page size larger than the available number, the request is still valid. In that case the server just returns the available number of items, disregarding the client's page size request.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_policies_all_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/policies-all/members', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api210_policies_all_get_with_http_info = policies_all_get_with_http_info
    api210_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api211_policies_all_get_with_http_info = policies_all_get_with_http_info
    api211_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api212_policies_all_get_with_http_info = policies_all_get_with_http_info
    api212_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api213_policies_all_get_with_http_info = policies_all_get_with_http_info
    api213_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api22_policies_all_get_with_http_info = policies_all_get_with_http_info
    api22_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api23_policies_all_get_with_http_info = policies_all_get_with_http_info
    api23_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api24_policies_all_get_with_http_info = policies_all_get_with_http_info
    api24_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api25_policies_all_get_with_http_info = policies_all_get_with_http_info
    api25_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api26_policies_all_get_with_http_info = policies_all_get_with_http_info
    api26_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api27_policies_all_get_with_http_info = policies_all_get_with_http_info
    api27_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api28_policies_all_get_with_http_info = policies_all_get_with_http_info
    api28_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api29_policies_all_get_with_http_info = policies_all_get_with_http_info
    api29_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
