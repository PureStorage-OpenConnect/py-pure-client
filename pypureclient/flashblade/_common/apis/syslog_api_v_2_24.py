...
from pypureclient.flashblade._common.models.syslog_server_get_response_v_2_24 import SyslogServerGetResponse
from pypureclient.flashblade._common.models.syslog_server_patch_v_2_24 import SyslogServerPatch
from pypureclient.flashblade._common.models.syslog_server_post_v_2_24 import SyslogServerPost
from pypureclient.flashblade._common.models.syslog_server_response_v_2_24 import SyslogServerResponse
from pypureclient.flashblade._common.models.syslog_server_settings_get_response_v_2_24 import SyslogServerSettingsGetResponse
from pypureclient.flashblade._common.models.syslog_server_settings_response_v_2_24 import SyslogServerSettingsResponse
from pypureclient.flashblade._common.models.syslog_server_settings_v_2_24 import SyslogServerSettings
from pypureclient.flashblade._common.models.test_result_get_response_v_2_24 import TestResultGetResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api224_syslog_servers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_syslog_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_syslog_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_syslog_servers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_syslog_servers_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_syslog_servers_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_syslog_servers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
