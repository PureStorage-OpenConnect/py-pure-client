...
from pypureclient.flashblade._common.models.software_bundle_get_response_v_2_24 import SoftwareBundleGetResponse
from pypureclient.flashblade._common.models.software_bundle_post_v_2_24 import SoftwareBundlePost
from pypureclient.flashblade._common.models.software_bundle_response_v_2_24 import SoftwareBundleResponse
from pypureclient.flashblade._common.models.software_checks_get_response_v_2_16 import SoftwareChecksGetResponse
from pypureclient.flashblade._common.models.software_checks_response_v_2_16 import SoftwareChecksResponse
from pypureclient.flashblade._common.models.software_patches_get_response_v_2_24 import SoftwarePatchesGetResponse
from pypureclient.flashblade._common.models.software_patches_response_v_2_24 import SoftwarePatchesResponse
...
class SoftwareApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_software_bundle_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def software_bundle_post_with_http_info(
        ...
        **kwargs
        ...
        Creates and initiates a software bundle download. The upgrade won't start automatically after the download finishes. Only one software is being downloaded at a time. Any previous currently running download will be cancelled. The endpoint is not idempotent.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_software_bundle_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_software_check_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_software_check_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_software_patches_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_software_patches_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
