...
from pypureclient.flashblade._common.models.file_system_group_quota_get_response_v_2_25 import FileSystemGroupQuotaGetResponse
from pypureclient.flashblade._common.models.file_system_user_quota_get_response_v_2_25 import FileSystemUserQuotaGetResponse
...
class UserGroupQuotasApi:
    ...
    def file_system_group_quotas_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        :rtype: tuple(FileSystemGroupQuotaGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_file_system_group_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "FileSystemGroupQuotaGetResponse",
            '207': "FileSystemGroupQuotaGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/file-system-group-quotas', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def file_system_user_quotas_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique contexts specified. If specified, each context name must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`. Enter multiple names in comma-separated format. For example, `name01,name02`.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(FileSystemUserQuotaGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_file_system_user_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "FileSystemUserQuotaGetResponse",
            '207': "FileSystemUserQuotaGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/file-system-user-quotas', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api227_file_system_group_quotas_get_with_http_info = file_system_group_quotas_get_with_http_info
