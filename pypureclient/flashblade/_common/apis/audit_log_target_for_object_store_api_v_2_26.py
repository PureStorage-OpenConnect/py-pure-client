...
from pypureclient.flashblade._common.models.log_targets_object_store_get_response_v_2_26 import LogTargetsObjectStoreGetResponse
from pypureclient.flashblade._common.models.log_targets_object_store_post_v_2_26 import LogTargetsObjectStorePost
from pypureclient.flashblade._common.models.log_targets_object_store_response_v_2_26 import LogTargetsObjectStoreResponse
from pypureclient.flashblade._common.models.log_targets_object_store_v_2_26 import LogTargetsObjectStore
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_log_targets_object_store_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_log_targets_object_store_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_log_targets_object_store_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_log_targets_object_store_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
