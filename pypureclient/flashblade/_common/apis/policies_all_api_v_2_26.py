...
from pypureclient.flashblade._common.models.policy_base_get_response_v_2_26 import PolicyBaseGetResponse
from pypureclient.flashblade._common.models.policy_member_with_remote_get_response_v_2_26 import PolicyMemberWithRemoteGetResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_policies_all_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_policies_all_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
