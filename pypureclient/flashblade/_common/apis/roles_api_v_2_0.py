...
from pypureclient.flashblade._common.models.role_get_response_v_2_0 import RoleGetResponse
...
class RolesApi:
    ...
    def roles_get_with_http_info(
        ...
        **kwargs
        ...
        :rtype: tuple(RoleGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api20_roles_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api20_roles_get_with_http_info = roles_get_with_http_info
    api21_roles_get_with_http_info = roles_get_with_http_info
    api210_roles_get_with_http_info = roles_get_with_http_info
    api211_roles_get_with_http_info = roles_get_with_http_info
    api212_roles_get_with_http_info = roles_get_with_http_info
    api213_roles_get_with_http_info = roles_get_with_http_info
    api22_roles_get_with_http_info = roles_get_with_http_info
    api23_roles_get_with_http_info = roles_get_with_http_info
    api24_roles_get_with_http_info = roles_get_with_http_info
    api25_roles_get_with_http_info = roles_get_with_http_info
    api26_roles_get_with_http_info = roles_get_with_http_info
    api27_roles_get_with_http_info = roles_get_with_http_info
    api28_roles_get_with_http_info = roles_get_with_http_info
    api29_roles_get_with_http_info = roles_get_with_http_info
