...
from pypureclient.flashblade._common.models.file_system_export_get_response_v_2_26 import FileSystemExportGetResponse
from pypureclient.flashblade._common.models.file_system_export_patch_v_2_26 import FileSystemExportPatch
from pypureclient.flashblade._common.models.file_system_export_post_v_2_26 import FileSystemExportPost
from pypureclient.flashblade._common.models.file_system_export_response_v_2_26 import FileSystemExportResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_file_system_exports_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_file_system_exports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_file_system_exports_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_file_system_exports_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
