...
from pypureclient.flashblade._common.models.alert_get_response_v_2_20 import AlertGetResponse
from pypureclient.flashblade._common.models.alert_response_v_2_20 import AlertResponse
from pypureclient.flashblade._common.models.alert_v_2_20 import Alert
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_alerts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_alerts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
