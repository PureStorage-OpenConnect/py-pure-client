...
from pypureclient.flashblade._common.models.object_store_access_key_get_response_v_2_24 import ObjectStoreAccessKeyGetResponse
from pypureclient.flashblade._common.models.object_store_access_key_post_v_2_24 import ObjectStoreAccessKeyPost
from pypureclient.flashblade._common.models.object_store_access_key_response_v_2_24 import ObjectStoreAccessKeyResponse
from pypureclient.flashblade._common.models.object_store_access_key_v_2_24 import ObjectStoreAccessKey
...
class ObjectStoreAccessKeysApi:
    ...
    def object_store_access_keys_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api224_object_store_access_keys_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/object-store-access-keys', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def object_store_access_keys_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_object_store_access_keys_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '207': "ObjectStoreAccessKeyGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/object-store-access-keys', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def object_store_access_keys_patch_with_http_info(
        self,
        names: Annotated[conlist(StrictStr), Field(..., description="A comma-separated list of resource names.")],
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_object_store_access_keys_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/object-store-access-keys', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def object_store_access_keys_post_with_http_info(
        self,
        object_store_access_key: ObjectStoreAccessKeyPost,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names to import. To import a set of credentials, this field must be specified with the `secret_access_key` body parameter. If both of these are not specified, the system will generate a new set of credentials. A matching realm prefix is required when importing credentials for a user in a realm. For example, use `realm1::PSFBSAZRBHOODCBADKNFKCBCPCNHLHMEJOIOHHBACEL` when importing credentials for user `realmName::accountName/userName`.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        :param context_names: Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.
        :type context_names: List[str]
        :param names: A comma-separated list of resource names to import. To import a set of credentials, this field must be specified with the `secret_access_key` body parameter. If both of these are not specified, the system will generate a new set of credentials. A matching realm prefix is required when importing credentials for a user in a realm. For example, use `realm1::PSFBSAZRBHOODCBADKNFKCBCPCNHLHMEJOIOHHBACEL` when importing credentials for user `realmName::accountName/userName`.
        :type names: List[str]
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the ApiResponse.data will
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_object_store_access_keys_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/object-store-access-keys', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api224_object_store_access_keys_delete_with_http_info = object_store_access_keys_delete_with_http_info
    api224_object_store_access_keys_get_with_http_info = object_store_access_keys_get_with_http_info
    api224_object_store_access_keys_patch_with_http_info = object_store_access_keys_patch_with_http_info
    api224_object_store_access_keys_post_with_http_info = object_store_access_keys_post_with_http_info
