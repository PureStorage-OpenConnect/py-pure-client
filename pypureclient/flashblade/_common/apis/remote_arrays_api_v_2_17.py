...
from pypureclient.flashblade._common.models.remote_arrays_response_v_2_17 import RemoteArraysResponse
...
class RemoteArraysApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_remote_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api217_remote_arrays_get_with_http_info = remote_arrays_get_with_http_info
    api218_remote_arrays_get_with_http_info = remote_arrays_get_with_http_info
    api219_remote_arrays_get_with_http_info = remote_arrays_get_with_http_info
    api220_remote_arrays_get_with_http_info = remote_arrays_get_with_http_info
    api221_remote_arrays_get_with_http_info = remote_arrays_get_with_http_info
    api222_remote_arrays_get_with_http_info = remote_arrays_get_with_http_info
    api223_remote_arrays_get_with_http_info = remote_arrays_get_with_http_info
    api224_remote_arrays_get_with_http_info = remote_arrays_get_with_http_info
    api225_remote_arrays_get_with_http_info = remote_arrays_get_with_http_info
