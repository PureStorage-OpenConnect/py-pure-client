...
from pypureclient.flashblade._common.models.resiliency_group_get_response_v_2_23 import ResiliencyGroupGetResponse
from pypureclient.flashblade._common.models.resiliency_group_member_get_response_v_2_23 import ResiliencyGroupMemberGetResponse

class ResiliencyGroupsApi:
    ...
    def resiliency_groups_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        :rtype: tuple(ResiliencyGroupGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api223_resiliency_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ResiliencyGroupGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/resiliency-groups', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def resiliency_groups_members_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="A token used to retrieve the next page of data with some consistency guaranteed. The token is a Base64 encoded value. Set `continuation_token` to the system-generated token taken from the `x-next-token` header field of the response. A query has reached its last page when the response does not include a token. Pagination requires the `limit` and `continuation_token` query parameters.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Narrows down the results to only the response objects that satisfy the filter criteria.")] = None,
        ...
        offset: Annotated[Optional[conint(strict=True, ge=0)], Field(description="The offset of the first resource to return from a collection.")] = None,
        resiliency_group_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resiliency group IDs. If there is not at least one resource that matches each of the elements of `resiliency_group_ids`, then an error is returned. This cannot be provided in conjunction with the `resiliency_group_names` parameter.")] = None,
        resiliency_group_names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resiliency group names. If there is not at least one resource that matches each of the elements of `resiliency_group_names`, then an error is returned. This cannot be provided in conjunction with the `resiliency_group_ids` parameter.")] = None,
        sort: Annotated[Optional[conlist(constr(strict=True))], Field(description="Sort the response by the specified fields (in descending order if '-' is appended to the field name). NOTE: If you provide a sort you will not get a `continuation_token` in the response.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        :param offset: The offset of the first resource to return from a collection.
        :type offset: int
        :param resiliency_group_ids: A comma-separated list of resiliency group IDs. If there is not at least one resource that matches each of the elements of `resiliency_group_ids`, then an error is returned. This cannot be provided in conjunction with the `resiliency_group_names` parameter.
        :type resiliency_group_ids: List[str]
        :param resiliency_group_names: A comma-separated list of resiliency group names. If there is not at least one resource that matches each of the elements of `resiliency_group_names`, then an error is returned. This cannot be provided in conjunction with the `resiliency_group_ids` parameter.
        :type resiliency_group_names: List[str]
        :param sort: Sort the response by the specified fields (in descending order if '-' is appended to the field name). NOTE: If you provide a sort you will not get a `continuation_token` in the response.
        :type sort: List[str]
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ResiliencyGroupMemberGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_resiliency_groups_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('resiliency_group_ids') is not None:  # noqa: E501
            _query_params.append(('resiliency_group_ids', _params['resiliency_group_ids']))
            _collection_formats['resiliency_group_ids'] = 'csv'

        if _params.get('resiliency_group_names') is not None:  # noqa: E501
            _query_params.append(('resiliency_group_names', _params['resiliency_group_names']))
            _collection_formats['resiliency_group_names'] = 'csv'
        ...
        _response_types_map = {
            '200': "ResiliencyGroupMemberGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/resiliency-groups/members', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api223_resiliency_groups_get_with_http_info = resiliency_groups_get_with_http_info
    api223_resiliency_groups_members_get_with_http_info = resiliency_groups_members_get_with_http_info
    api224_resiliency_groups_get_with_http_info = resiliency_groups_get_with_http_info
