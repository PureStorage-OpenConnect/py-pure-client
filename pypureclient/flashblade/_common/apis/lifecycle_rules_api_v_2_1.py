...
from pypureclient.flashblade._common.models.lifecycle_rule_get_response_v_2_1 import LifecycleRuleGetResponse
from pypureclient.flashblade._common.models.lifecycle_rule_patch_v_2_1 import LifecycleRulePatch
from pypureclient.flashblade._common.models.lifecycle_rule_post_v_2_1 import LifecycleRulePost
from pypureclient.flashblade._common.models.lifecycle_rule_response_v_2_1 import LifecycleRuleResponse
...
class LifecycleRulesApi:
    ...
    def lifecycle_rules_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api21_lifecycle_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/lifecycle-rules', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def lifecycle_rules_get_with_http_info(
        self,
        bucket_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of bucket IDs. If after filtering, there is not at least one resource that matches each of the elements of `bucket_ids`, then an error is returned. This cannot be provided together with the `bucket_names` query parameter. This can be provided with the `ids` query parameter but not with `names`.")] = None,
        bucket_names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of bucket names. If there is not at least one resource that matches each of the elements of `bucket_names`, then an error is returned. This cannot be provided together with the `bucket_ids` query parameter. This can be provided with the `ids` query parameter but not with `names`.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_lifecycle_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/lifecycle-rules', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def lifecycle_rules_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_lifecycle_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/lifecycle-rules', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def lifecycle_rules_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_lifecycle_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/lifecycle-rules', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api21_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api21_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api21_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api21_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api210_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api210_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api210_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api210_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api211_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api211_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api211_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api211_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api212_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api212_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api212_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api212_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api213_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api213_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api213_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api213_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api22_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api22_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api22_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api22_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api23_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api23_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api23_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api23_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api24_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api24_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api24_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api24_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api25_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api25_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api25_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api25_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api26_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api26_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api26_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api26_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api27_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api27_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api27_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api27_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api28_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api28_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api28_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api28_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api29_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api29_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api29_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api29_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
