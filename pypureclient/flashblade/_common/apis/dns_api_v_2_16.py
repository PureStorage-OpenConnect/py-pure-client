...
from pypureclient.flashblade._common.models.dns_get_response_v_2_16 import DnsGetResponse
from pypureclient.flashblade._common.models.dns_post_v_2_16 import DnsPost
from pypureclient.flashblade._common.models.dns_response_v_2_16 import DnsResponse
from pypureclient.flashblade._common.models.dns_v_2_16 import Dns
...
class DNSApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api216_dns_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_dns_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_dns_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api218_dns_delete_with_http_info = dns_delete_with_http_info
    api218_dns_get_with_http_info = dns_get_with_http_info
    api218_dns_patch_with_http_info = dns_patch_with_http_info
    api218_dns_post_with_http_info = dns_post_with_http_info
