...
from pypureclient.flashblade._common.models.object_store_virtual_host_get_response_v_2_17 import ObjectStoreVirtualHostGetResponse
from pypureclient.flashblade._common.models.object_store_virtual_host_response_v_2_17 import ObjectStoreVirtualHostResponse
...
class ObjectStoreVirtualHostsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_object_store_virtual_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_object_store_virtual_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_object_store_virtual_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api217_object_store_virtual_hosts_delete_with_http_info = object_store_virtual_hosts_delete_with_http_info
    api217_object_store_virtual_hosts_get_with_http_info = object_store_virtual_hosts_get_with_http_info
    api217_object_store_virtual_hosts_post_with_http_info = object_store_virtual_hosts_post_with_http_info
    api218_object_store_virtual_hosts_delete_with_http_info = object_store_virtual_hosts_delete_with_http_info
    api218_object_store_virtual_hosts_get_with_http_info = object_store_virtual_hosts_get_with_http_info
    api218_object_store_virtual_hosts_post_with_http_info = object_store_virtual_hosts_post_with_http_info
    api219_object_store_virtual_hosts_delete_with_http_info = object_store_virtual_hosts_delete_with_http_info
    api219_object_store_virtual_hosts_get_with_http_info = object_store_virtual_hosts_get_with_http_info
    api219_object_store_virtual_hosts_post_with_http_info = object_store_virtual_hosts_post_with_http_info
