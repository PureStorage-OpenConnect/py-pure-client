...
from pypureclient.flashblade._common.models.clients_performance_get_response_v_2_24 import ClientsPerformanceGetResponse
from pypureclient.flashblade._common.models.clients_s3_specific_performance_get_response_v_2_24 import ClientsS3SpecificPerformanceGetResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api224_arrays_clients_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_arrays_clients_s3_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
