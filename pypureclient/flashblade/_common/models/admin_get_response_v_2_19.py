...
from pypureclient.flashblade._common.models.admin_v_2_19 import Admin
...
class AdminGetResponse(BaseModel):
    ...
    items: Optional[conlist(Admin)] = Field(default=None, description="A list of administrative account objects.")
