...
from pypureclient.flashblade._common.models.network_interface_neighbor_local_port_v_2_20 import NetworkInterfaceNeighborLocalPort
from pypureclient.flashblade._common.models.network_interface_neighbor_neighbor_chassis_v_2_20 import NetworkInterfaceNeighborNeighborChassis
from pypureclient.flashblade._common.models.network_interface_neighbor_neighbor_port_v_2_20 import NetworkInterfaceNeighborNeighborPort
...
class NetworkInterfaceNeighbor(BaseModel):
    ...
    local_port: Optional[NetworkInterfaceNeighborLocalPort] = Field(default=None, description="A reference to the local network interface the neighbor is connected to.")
    ...
    def from_dict(cls, obj: dict) -> NetworkInterfaceNeighbor:
        ...
        _obj = NetworkInterfaceNeighbor.construct(_fields_set=None, **{
            ...
            "local_port": NetworkInterfaceNeighborLocalPort.from_dict(obj.get("local_port")) if obj.get("local_port") is not None else None,
