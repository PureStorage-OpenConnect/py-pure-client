...
from pypureclient.flashblade._common.models.bucket_access_policy_rule_v_2_24 import BucketAccessPolicyRule
from pypureclient.flashblade._common.models.fixed_reference_v_2_24 import FixedReference


class BucketAccessPolicy(BaseModel):
    """
    BucketAccessPolicy
    """
    ...
    rules: Optional[conlist(BucketAccessPolicyRule)] = None
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "context", "bucket", "rules"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BucketAccessPolicy:
        """Create an instance of BucketAccessPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> BucketAccessPolicy:
        """Create an instance of BucketAccessPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BucketAccessPolicy.parse_obj(obj)

        _obj = BucketAccessPolicy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "rules": [BucketAccessPolicyRule.from_dict(_item) for _item in obj.get("rules")] if obj.get("rules") is not None else None
        })
        return _obj
