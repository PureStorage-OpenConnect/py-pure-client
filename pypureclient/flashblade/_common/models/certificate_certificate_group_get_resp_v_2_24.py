...
class CertificateCertificateGroupGetResp(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificateCertificateGroupGetResp:
        """Create an instance of CertificateCertificateGroupGetResp from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CertificateCertificateGroupGetResp:
        """Create an instance of CertificateCertificateGroupGetResp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CertificateCertificateGroupGetResp.parse_obj(obj)

        _obj = CertificateCertificateGroupGetResp.construct(_fields_set=None, **{
