...
from pypureclient.flashblade._common.models.smb_client_policy_rule_in_policy_v_2_11 import SmbClientPolicyRuleInPolicy
...
class SmbClientPolicy(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "version", "context", "access_based_enumeration_enabled", "rules"]
