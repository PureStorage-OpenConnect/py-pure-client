...
from pypureclient.flashblade._common.models.array_space_v_2_24 import ArraySpace
from pypureclient.flashblade._common.models.error_context_response_errors_v_2_24 import ErrorContextResponseErrors


class ArraySpaceGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ArraySpace)] = Field(default=None, description="A list of array space metrics objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArraySpaceGetResponse:
        """Create an instance of ArraySpaceGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArraySpaceGetResponse:
        """Create an instance of ArraySpaceGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArraySpaceGetResponse.parse_obj(obj)

        _obj = ArraySpaceGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ArraySpace.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
