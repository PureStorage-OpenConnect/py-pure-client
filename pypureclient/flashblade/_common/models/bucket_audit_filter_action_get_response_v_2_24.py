...
from pypureclient.flashblade._common.models.bucket_audit_filter_action_with_context_v_2_24 import BucketAuditFilterActionWithContext
from pypureclient.flashblade._common.models.error_context_response_errors_v_2_24 import ErrorContextResponseErrors


class BucketAuditFilterActionGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(BucketAuditFilterActionWithContext)] = None
    __properties = ["errors", "continuation_token", "total_item_count", "items"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BucketAuditFilterActionGetResponse:
        """Create an instance of BucketAuditFilterActionGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> BucketAuditFilterActionGetResponse:
        """Create an instance of BucketAuditFilterActionGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BucketAuditFilterActionGetResponse.parse_obj(obj)

        _obj = BucketAuditFilterActionGetResponse.construct(_fields_set=None, **{
            ...
            "items": [BucketAuditFilterActionWithContext.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
