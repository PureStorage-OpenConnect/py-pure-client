...
class ArrayGetResponse(BaseModel):
    ...
    items: Optional[conlist(Array)] = Field(default=None, description="A list of array objects.")
    ...
    def from_dict(cls, obj: dict) -> ArrayGetResponse:
        ...
        _obj = ArrayGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Array.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
