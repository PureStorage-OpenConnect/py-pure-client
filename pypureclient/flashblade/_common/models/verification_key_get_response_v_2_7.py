...
from pypureclient.flashblade._common.models.verification_key_v_2_7 import VerificationKey


class VerificationKeyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(VerificationKey)] = Field(default=None, description="A list of verification key objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VerificationKeyGetResponse:
        """Create an instance of VerificationKeyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> VerificationKeyGetResponse:
        """Create an instance of VerificationKeyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VerificationKeyGetResponse.parse_obj(obj)

        _obj = VerificationKeyGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [VerificationKey.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
