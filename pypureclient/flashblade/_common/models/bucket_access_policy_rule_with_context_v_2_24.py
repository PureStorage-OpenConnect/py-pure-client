...
from pypureclient.flashblade._common.models.bucket_access_policy_rule_principal_v_2_24 import BucketAccessPolicyRulePrincipal
...
class BucketAccessPolicyRuleWithContext(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BucketAccessPolicyRuleWithContext:
        """Create an instance of BucketAccessPolicyRuleWithContext from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> BucketAccessPolicyRuleWithContext:
        """Create an instance of BucketAccessPolicyRuleWithContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BucketAccessPolicyRuleWithContext.parse_obj(obj)

        _obj = BucketAccessPolicyRuleWithContext.construct(_fields_set=None, **{
            "name": obj.get("name"),
