...
class PresetWorkloadExportConfigurationSmbShareRule(BaseModel):
    """
    ...
    principal: Optional[StrictStr] = Field(default=None, description="The user or group who is the subject of this rule, and optionally their domain. If no domain is provided, it will be derived if possible. For example, `PURESTORAGE\\Administrator`, `samplegroup@PureStorage`, or `sampleuser`. Supports parameterization.")
    ...
    __properties = ["change", "full_control", "principal", "read"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PresetWorkloadExportConfigurationSmbShareRule:
        """Create an instance of PresetWorkloadExportConfigurationSmbShareRule from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PresetWorkloadExportConfigurationSmbShareRule:
        """Create an instance of PresetWorkloadExportConfigurationSmbShareRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PresetWorkloadExportConfigurationSmbShareRule.parse_obj(obj)

        _obj = PresetWorkloadExportConfigurationSmbShareRule.construct(_fields_set=None, **{
