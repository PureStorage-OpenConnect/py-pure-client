...
from pypureclient.flashblade._common.models.smb_client_policy_rule_in_policy_v_2_24 import SmbClientPolicyRuleInPolicy
...
class SmbClientPolicy(BaseModel):
    """
    SmbClientPolicy
    """
    ...
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "version", "context", "access_based_enumeration_enabled", "rules", "workload"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmbClientPolicy:
        """Create an instance of SmbClientPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmbClientPolicy:
        """Create an instance of SmbClientPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmbClientPolicy.parse_obj(obj)

        _obj = SmbClientPolicy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
