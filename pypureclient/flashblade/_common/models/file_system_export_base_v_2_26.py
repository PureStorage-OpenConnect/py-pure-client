...
class FileSystemExportBase(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemExportBase:
        """Create an instance of FileSystemExportBase from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemExportBase:
        """Create an instance of FileSystemExportBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemExportBase.parse_obj(obj)

        _obj = FileSystemExportBase.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
