...
class PolicyPatch(BaseModel):
    ...
    policy_type: Optional[StrictStr] = Field(default=None, description="Type of the policy. Valid values are `object-access` and `snapshot`.")
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "rules", "add_rules", "remove_rules"]
