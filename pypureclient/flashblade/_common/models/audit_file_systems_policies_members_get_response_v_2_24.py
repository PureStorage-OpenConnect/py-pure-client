...
class AuditFileSystemsPoliciesMembersGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyMemberContext)] = Field(default=None, description="A list of members for audit policies.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditFileSystemsPoliciesMembersGetResponse:
        """Create an instance of AuditFileSystemsPoliciesMembersGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditFileSystemsPoliciesMembersGetResponse:
        """Create an instance of AuditFileSystemsPoliciesMembersGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditFileSystemsPoliciesMembersGetResponse.parse_obj(obj)

        _obj = AuditFileSystemsPoliciesMembersGetResponse.construct(_fields_set=None, **{
