...
from pypureclient.flashblade._common.models.audit_file_systems_policy_v_2_20 import AuditFileSystemsPolicy
from pypureclient.flashblade._common.models.error_context_response_errors_v_2_17 import ErrorContextResponseErrors


class AuditFileSystemsPoliciesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(AuditFileSystemsPolicy)] = Field(default=None, description="A list of audit policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditFileSystemsPoliciesGetResponse:
        """Create an instance of AuditFileSystemsPoliciesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditFileSystemsPoliciesGetResponse:
        """Create an instance of AuditFileSystemsPoliciesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditFileSystemsPoliciesGetResponse.parse_obj(obj)

        _obj = AuditFileSystemsPoliciesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [AuditFileSystemsPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
