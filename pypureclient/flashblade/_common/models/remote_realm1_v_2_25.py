...
class RemoteRealm1(BaseModel):
    ...
    arrays: Optional[conlist(ReferenceWritable, min_items=1)] = Field(default=None, description="A list of arrays that contain this realm.")
    __properties = ["id", "name", "arrays"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoteRealm1:
        """Create an instance of RemoteRealm1 from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RemoteRealm1:
        """Create an instance of RemoteRealm1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoteRealm1.parse_obj(obj)

        _obj = RemoteRealm1.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "arrays": [ReferenceWritable.from_dict(_item) for _item in obj.get("arrays")] if obj.get("arrays") is not None else None
        })
        return _obj
