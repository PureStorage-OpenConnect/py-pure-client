...
from pypureclient.flashblade._common.models.workload_preset_v_2_24 import WorkloadPreset
...
class Workload(BaseModel):
    ...
    status_details: Optional[conlist(StrictStr)] = Field(default=None, description="Additional information about the workload status. For example, if the workload status is `creating`, status details might describe what resources are currently being created.")
    ...
    __properties = ["id", "name", "context", "created", "destroyed", "preset", "status", "status_details", "time_remaining"]
    ...
    def from_dict(cls, obj: dict) -> Workload:
        ...
        if not isinstance(obj, dict):
            return Workload.parse_obj(obj)

        _obj = Workload.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "context": FixedReference.from_dict(obj.get("context")) if obj.get("context") is not None else None,
            "created": obj.get("created"),
            "destroyed": obj.get("destroyed"),
            "preset": WorkloadPreset.from_dict(obj.get("preset")) if obj.get("preset") is not None else None,
