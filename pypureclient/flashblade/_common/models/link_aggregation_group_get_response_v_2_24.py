...
from pypureclient.flashblade._common.models.link_aggregation_group_v_2_24 import LinkAggregationGroup


class LinkAggregationGroupGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(LinkAggregationGroup)] = Field(default=None, description="A list of lag objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkAggregationGroupGetResponse:
        """Create an instance of LinkAggregationGroupGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LinkAggregationGroupGetResponse:
        """Create an instance of LinkAggregationGroupGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LinkAggregationGroupGetResponse.parse_obj(obj)

        _obj = LinkAggregationGroupGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [LinkAggregationGroup.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
