...
class SmbClientPolicyRule(BaseModel):
    ...
    __properties = ["id", "name", "client", "encryption", "permission", "policy", "policy_version", "index", "context"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmbClientPolicyRule:
        """Create an instance of SmbClientPolicyRule from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmbClientPolicyRule:
        """Create an instance of SmbClientPolicyRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmbClientPolicyRule.parse_obj(obj)

        _obj = SmbClientPolicyRule.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
