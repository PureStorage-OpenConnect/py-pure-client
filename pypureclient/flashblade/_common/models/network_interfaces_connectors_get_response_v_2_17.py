...
class NetworkInterfacesConnectorsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(HardwareConnector)] = Field(default=None, description="A list of network connector objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkInterfacesConnectorsGetResponse:
        """Create an instance of NetworkInterfacesConnectorsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkInterfacesConnectorsGetResponse:
        """Create an instance of NetworkInterfacesConnectorsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkInterfacesConnectorsGetResponse.parse_obj(obj)

        _obj = NetworkInterfacesConnectorsGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [HardwareConnector.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
