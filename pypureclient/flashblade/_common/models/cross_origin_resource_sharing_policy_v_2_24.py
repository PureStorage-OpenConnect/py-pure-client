...
from pypureclient.flashblade._common.models.cross_origin_resource_sharing_policy_rule_with_context_v_2_24 import CrossOriginResourceSharingPolicyRuleWithContext
...
class CrossOriginResourceSharingPolicy(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CrossOriginResourceSharingPolicy:
        """Create an instance of CrossOriginResourceSharingPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CrossOriginResourceSharingPolicy:
        """Create an instance of CrossOriginResourceSharingPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CrossOriginResourceSharingPolicy.parse_obj(obj)

        _obj = CrossOriginResourceSharingPolicy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
