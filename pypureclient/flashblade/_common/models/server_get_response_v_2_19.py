...
from pypureclient.flashblade._common.models.server_context_v_2_19 import ServerContext
...
class ServerGetResponse(BaseModel):
    ...
    items: Optional[conlist(ServerContext)] = Field(default=None, description="A list of server objects.")
    ...
    def from_dict(cls, obj: dict) -> ServerGetResponse:
        ...
        _obj = ServerGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ServerContext.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
