...
from pypureclient.flashblade._common.models.user_quota_v_2_24 import UserQuota


class UserQuotaGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(UserQuota)] = Field(default=None, description="A list of quota objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserQuotaGetResponse:
        """Create an instance of UserQuotaGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> UserQuotaGetResponse:
        """Create an instance of UserQuotaGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserQuotaGetResponse.parse_obj(obj)

        _obj = UserQuotaGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [UserQuota.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
