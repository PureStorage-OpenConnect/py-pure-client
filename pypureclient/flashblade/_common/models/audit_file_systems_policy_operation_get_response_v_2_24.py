...
from pypureclient.flashblade._common.models.audit_file_systems_policy_operation_v_2_24 import AuditFileSystemsPolicyOperation


class AuditFileSystemsPolicyOperationGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(AuditFileSystemsPolicyOperation)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditFileSystemsPolicyOperationGetResponse:
        """Create an instance of AuditFileSystemsPolicyOperationGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditFileSystemsPolicyOperationGetResponse:
        """Create an instance of AuditFileSystemsPolicyOperationGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditFileSystemsPolicyOperationGetResponse.parse_obj(obj)

        _obj = AuditFileSystemsPolicyOperationGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [AuditFileSystemsPolicyOperation.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
