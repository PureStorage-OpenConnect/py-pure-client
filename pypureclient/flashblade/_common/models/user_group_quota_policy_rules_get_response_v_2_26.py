...
class UserGroupQuotaPolicyRulesGetResponse(BaseModel):
    """
    UserGroupQuotaPolicyRulesGetResponse
    """
    ...
    items: Optional[conlist(UserGroupQuotaPolicyRule)] = Field(default=None, description="Displays a list of all items after filtering.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGroupQuotaPolicyRulesGetResponse:
        """Create an instance of UserGroupQuotaPolicyRulesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> UserGroupQuotaPolicyRulesGetResponse:
        """Create an instance of UserGroupQuotaPolicyRulesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGroupQuotaPolicyRulesGetResponse.parse_obj(obj)

        _obj = UserGroupQuotaPolicyRulesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [UserGroupQuotaPolicyRule.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
