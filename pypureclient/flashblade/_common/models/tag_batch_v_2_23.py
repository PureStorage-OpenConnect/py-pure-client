...
class TagBatch(BaseModel):
    ...
    resource: Optional[ReferenceWithoutType] = Field(default=None, description="A reference to the parent object.")
    value: Optional[StrictStr] = Field(default=None, description="Value of the tag. Supports up to 256 Unicode characters.")
    __properties = ["copyable", "key", "namespace", "resource", "value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TagBatch:
        """Create an instance of TagBatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TagBatch:
        """Create an instance of TagBatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TagBatch.parse_obj(obj)

        _obj = TagBatch.construct(_fields_set=None, **{
            "copyable": obj.get("copyable"),
            "key": obj.get("key"),
            "namespace": obj.get("namespace"),
            "resource": ReferenceWithoutType.from_dict(obj.get("resource")) if obj.get("resource") is not None else None,
            "value": obj.get("value")
        })
        return _obj
