...
from pypureclient.flashblade._common.models.bucket_defaults_v_2_8 import BucketDefaults
from pypureclient.flashblade._common.models.server_for_account_export_v_2_20 import ServerForAccountExport
...
class ObjectStoreAccountPost(BaseModel):
    ...
    """
    account_exports: Optional[conlist(ServerForAccountExport)] = Field(default=None, description="A list of exports to be created for the account. If ommited or set to `null`, the default server for object store will be used. Use `[]` to create an account without any export.")
    ...
    __properties = ["account_exports", "bucket_defaults", "hard_limit_enabled", "quota_limit"]
    ...
    def to_dict(self, include_readonly: bool=True) -> Dict[str, Any]:
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in account_exports (list)
        if _include_in_dict('account_exports', include_readonly, excluded_fields, none_fields):
            _items = []
            for _item in self.account_exports:
                if _item:
                    _items.append(_item.to_dict(include_readonly=include_readonly))
            _dict['account_exports'] = _items
    ...
    def from_dict(cls, obj: dict) -> ObjectStoreAccountPost:
        ...
        _obj = ObjectStoreAccountPost.construct(_fields_set=None, **{
            "account_exports": [ServerForAccountExport.from_dict(_item) for _item in obj.get("account_exports")] if obj.get("account_exports") is not None else None,
