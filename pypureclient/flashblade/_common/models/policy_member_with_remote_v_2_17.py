...
from pypureclient.flashblade._common.models.location_reference_v_2_0 import LocationReference
from pypureclient.flashblade._common.models.member_link_v_2_0 import MemberLink
...
class PolicyMemberWithRemote(BaseModel):
    ...
    __properties = ["member", "policy", "context", "link"]
