...
from pypureclient.flashblade._common.models.group_v_2_26 import Group
...
class GroupQuota(BaseModel):
    ...
    __properties = ["name", "context", "file_system", "file_system_default_quota", "group", "quota", "usage"]
