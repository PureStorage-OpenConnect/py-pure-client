...
class ActiveDirectory(BaseModel):
    ...
    __properties = ["id", "name", "realms", "computer_name", "directory_servers", "domain", "encryption_types", "global_catalog_servers", "join_ou", "kerberos_servers", "server", "service_principal_names"]
