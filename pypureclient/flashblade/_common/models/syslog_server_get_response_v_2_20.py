...
from pypureclient.flashblade._common.models.syslog_server_context_v_2_20 import SyslogServerContext
...
class SyslogServerGetResponse(BaseModel):
    ...
    items: Optional[conlist(SyslogServerContext)] = None
    ...
    def from_dict(cls, obj: dict) -> SyslogServerGetResponse:
        ...
        _obj = SyslogServerGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SyslogServerContext.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
