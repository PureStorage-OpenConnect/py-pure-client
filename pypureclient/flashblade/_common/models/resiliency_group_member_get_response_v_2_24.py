...
from pypureclient.flashblade._common.models.member_v_2_24 import Member


class ResiliencyGroupMemberGetResponse(BaseModel):
    """
    ResiliencyGroupMemberGetResponse
    """
    ...
    items: Optional[conlist(Member)] = Field(default=None, description="A list of resiliency group and member relationships.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResiliencyGroupMemberGetResponse:
        """Create an instance of ResiliencyGroupMemberGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResiliencyGroupMemberGetResponse:
        """Create an instance of ResiliencyGroupMemberGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResiliencyGroupMemberGetResponse.parse_obj(obj)

        _obj = ResiliencyGroupMemberGetResponse.construct(_fields_set=None, **{
