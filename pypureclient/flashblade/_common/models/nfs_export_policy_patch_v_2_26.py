...
from pypureclient.flashblade._common.models.nfs_export_policy_patch_rule_in_policy_v_2_26 import NfsExportPolicyPatchRuleInPolicy


class NfsExportPolicyPatch(BaseModel):
    """
    ...
    rules: Optional[conlist(NfsExportPolicyPatchRuleInPolicy)] = Field(default=None, description="All of the rules that are part of this policy. The order is the evaluation order.")
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "version", "rules"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NfsExportPolicyPatch:
        """Create an instance of NfsExportPolicyPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NfsExportPolicyPatch:
        """Create an instance of NfsExportPolicyPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NfsExportPolicyPatch.parse_obj(obj)

        _obj = NfsExportPolicyPatch.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "rules": [NfsExportPolicyPatchRuleInPolicy.from_dict(_item) for _item in obj.get("rules")] if obj.get("rules") is not None else None
        })
        return _obj
