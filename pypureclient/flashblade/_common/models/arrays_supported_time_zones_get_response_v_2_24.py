...
from pypureclient.flashblade._common.models.time_zone_v_2_0 import TimeZone


class ArraysSupportedTimeZonesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(TimeZone)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArraysSupportedTimeZonesGetResponse:
        """Create an instance of ArraysSupportedTimeZonesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArraysSupportedTimeZonesGetResponse:
        """Create an instance of ArraysSupportedTimeZonesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArraysSupportedTimeZonesGetResponse.parse_obj(obj)

        _obj = ArraysSupportedTimeZonesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [TimeZone.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
