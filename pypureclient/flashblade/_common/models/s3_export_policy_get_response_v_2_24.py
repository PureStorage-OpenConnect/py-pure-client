...
from pypureclient.flashblade._common.models.s3_export_policy_v_2_24 import S3ExportPolicy


class S3ExportPolicyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(S3ExportPolicy)] = Field(default=None, description="A list of S3 export policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> S3ExportPolicyGetResponse:
        """Create an instance of S3ExportPolicyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> S3ExportPolicyGetResponse:
        """Create an instance of S3ExportPolicyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return S3ExportPolicyGetResponse.parse_obj(obj)

        _obj = S3ExportPolicyGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [S3ExportPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
