...
from pypureclient.flashblade._common.models.file_system_replica_link_v_2_24 import FileSystemReplicaLink


class FileSystemReplicaLinkGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(FileSystemReplicaLink)] = Field(default=None, description="A list of file system replica link objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemReplicaLinkGetResponse:
        """Create an instance of FileSystemReplicaLinkGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemReplicaLinkGetResponse:
        """Create an instance of FileSystemReplicaLinkGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemReplicaLinkGetResponse.parse_obj(obj)

        _obj = FileSystemReplicaLinkGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [FileSystemReplicaLink.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
