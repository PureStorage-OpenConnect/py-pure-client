...
from pypureclient.flashblade._common.models.realm_connection_v_2_25 import RealmConnection


class RealmConnectionGetResponse(BaseModel):
    """
    RealmConnectionGetResponse
    """
    ...
    items: Optional[conlist(RealmConnection)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RealmConnectionGetResponse:
        """Create an instance of RealmConnectionGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RealmConnectionGetResponse:
        """Create an instance of RealmConnectionGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RealmConnectionGetResponse.parse_obj(obj)

        _obj = RealmConnectionGetResponse.construct(_fields_set=None, **{
