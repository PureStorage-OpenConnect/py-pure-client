...
from pypureclient.flashblade._common.models.array_http_specific_performance_v_2_24 import ArrayHttpSpecificPerformance
from pypureclient.flashblade._common.models.error_context_response_errors_v_2_24 import ErrorContextResponseErrors


class ArrayHttpSpecificPerformanceGet(BaseModel):
    """
    ...
    items: Optional[conlist(ArrayHttpSpecificPerformance)] = Field(default=None, description="A list of http specific array performance metrics objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayHttpSpecificPerformanceGet:
        """Create an instance of ArrayHttpSpecificPerformanceGet from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayHttpSpecificPerformanceGet:
        """Create an instance of ArrayHttpSpecificPerformanceGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayHttpSpecificPerformanceGet.parse_obj(obj)

        _obj = ArrayHttpSpecificPerformanceGet.construct(_fields_set=None, **{
            ...
            "items": [ArrayHttpSpecificPerformance.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
