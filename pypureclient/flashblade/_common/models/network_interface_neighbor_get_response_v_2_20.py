...
from pypureclient.flashblade._common.models.network_interface_neighbor_v_2_20 import NetworkInterfaceNeighbor


class NetworkInterfaceNeighborGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(NetworkInterfaceNeighbor)] = Field(default=None, description="A list of network LLDP neighbors")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkInterfaceNeighborGetResponse:
        """Create an instance of NetworkInterfaceNeighborGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkInterfaceNeighborGetResponse:
        """Create an instance of NetworkInterfaceNeighborGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkInterfaceNeighborGetResponse.parse_obj(obj)

        _obj = NetworkInterfaceNeighborGetResponse.construct(_fields_set=None, **{
