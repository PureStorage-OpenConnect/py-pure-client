...
from pypureclient.flashblade._common.models.policy_rule_object_access_condition_v_2_26 import PolicyRuleObjectAccessCondition


class PolicyRuleObjectAccessBulkManage(BaseModel):
    """
    ...
    __properties = ["actions", "conditions", "effect", "resources", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleObjectAccessBulkManage:
        """Create an instance of PolicyRuleObjectAccessBulkManage from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleObjectAccessBulkManage:
        """Create an instance of PolicyRuleObjectAccessBulkManage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleObjectAccessBulkManage.parse_obj(obj)

        _obj = PolicyRuleObjectAccessBulkManage.construct(_fields_set=None, **{
