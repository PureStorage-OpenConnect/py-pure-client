...
from pypureclient.flashblade._common.models.cross_origin_resource_sharing_policy_rule_v_2_12 import CrossOriginResourceSharingPolicyRule
...
class CrossOriginResourceSharingPolicy(BaseModel):
    ...
    rules: Optional[conlist(CrossOriginResourceSharingPolicyRule, max_items=100)] = None
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "bucket", "rules"]
    ...
    def from_dict(cls, obj: dict) -> CrossOriginResourceSharingPolicy:
        ...
        _obj = CrossOriginResourceSharingPolicy.construct(_fields_set=None, **{
            ...
            "rules": [CrossOriginResourceSharingPolicyRule.from_dict(_item) for _item in obj.get("rules")] if obj.get("rules") is not None else None
        })
        return _obj
