...
from pypureclient.flashblade._common.models.space_v_2_11 import Space
...
class ObjectStoreAccount(BaseModel):
    ...
    __properties = ["id", "name", "bucket_defaults", "created", "hard_limit_enabled", "object_count", "public_access_config", "quota_limit", "space"]
