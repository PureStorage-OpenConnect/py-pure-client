...
from pypureclient.flashblade._common.models.network_interface_v_2_24 import NetworkInterface
...
class NetworkInterfaceGetResponse(BaseModel):
    ...
    items: Optional[conlist(NetworkInterface)] = Field(default=None, description="A list of network interface objects.")
