...
class ObjectStoreAccessPolicyAction(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreAccessPolicyAction:
        """Create an instance of ObjectStoreAccessPolicyAction from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreAccessPolicyAction:
        """Create an instance of ObjectStoreAccessPolicyAction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreAccessPolicyAction.parse_obj(obj)
