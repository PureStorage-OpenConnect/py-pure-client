...
class LogTargetsObjectStore(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogTargetsObjectStore:
        """Create an instance of LogTargetsObjectStore from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LogTargetsObjectStore:
        """Create an instance of LogTargetsObjectStore from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogTargetsObjectStore.parse_obj(obj)
