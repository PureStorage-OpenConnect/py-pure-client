...
class TargetWithContext(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TargetWithContext:
        """Create an instance of TargetWithContext from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TargetWithContext:
        """Create an instance of TargetWithContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TargetWithContext.parse_obj(obj)

        _obj = TargetWithContext.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
