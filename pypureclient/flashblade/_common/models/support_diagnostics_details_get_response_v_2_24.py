...
from pypureclient.flashblade._common.models.support_diagnostics_details_v_2_24 import SupportDiagnosticsDetails


class SupportDiagnosticsDetailsGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupportDiagnosticsDetailsGetResponse:
        """Create an instance of SupportDiagnosticsDetailsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SupportDiagnosticsDetailsGetResponse:
        """Create an instance of SupportDiagnosticsDetailsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupportDiagnosticsDetailsGetResponse.parse_obj(obj)

        _obj = SupportDiagnosticsDetailsGetResponse.construct(_fields_set=None, **{
