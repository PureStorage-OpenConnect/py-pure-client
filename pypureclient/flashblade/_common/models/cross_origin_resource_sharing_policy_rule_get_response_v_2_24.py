...
class CrossOriginResourceSharingPolicyRuleGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(CrossOriginResourceSharingPolicyRuleWithContext)] = None
    __properties = ["continuation_token", "total_item_count", "errors", "items"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CrossOriginResourceSharingPolicyRuleGetResponse:
        """Create an instance of CrossOriginResourceSharingPolicyRuleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CrossOriginResourceSharingPolicyRuleGetResponse:
        """Create an instance of CrossOriginResourceSharingPolicyRuleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CrossOriginResourceSharingPolicyRuleGetResponse.parse_obj(obj)

        _obj = CrossOriginResourceSharingPolicyRuleGetResponse.construct(_fields_set=None, **{
            ...
            "items": [CrossOriginResourceSharingPolicyRuleWithContext.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
