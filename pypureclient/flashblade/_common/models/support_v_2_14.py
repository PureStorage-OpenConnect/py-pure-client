...
from pypureclient.flashblade._common.models.support_remote_assist_paths_v_2_0 import SupportRemoteAssistPaths
...
class Support(BaseModel):
    ...
    __properties = ["id", "name", "phonehome_enabled", "proxy", "remote_assist_active", "remote_assist_duration", "remote_assist_expires", "remote_assist_opened", "remote_assist_paths", "remote_assist_status"]
