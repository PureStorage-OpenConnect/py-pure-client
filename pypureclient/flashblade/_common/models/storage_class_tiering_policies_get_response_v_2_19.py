...
from pypureclient.flashblade._common.models.storage_class_tiering_policy_v_2_19 import StorageClassTieringPolicy


class StorageClassTieringPoliciesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(StorageClassTieringPolicy)] = Field(default=None, description="A list of storage class tiering policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StorageClassTieringPoliciesGetResponse:
        """Create an instance of StorageClassTieringPoliciesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> StorageClassTieringPoliciesGetResponse:
        """Create an instance of StorageClassTieringPoliciesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StorageClassTieringPoliciesGetResponse.parse_obj(obj)

        _obj = StorageClassTieringPoliciesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [StorageClassTieringPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
