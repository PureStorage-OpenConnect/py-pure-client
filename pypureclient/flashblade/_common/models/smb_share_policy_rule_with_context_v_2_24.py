...
class SmbSharePolicyRuleWithContext(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmbSharePolicyRuleWithContext:
        """Create an instance of SmbSharePolicyRuleWithContext from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmbSharePolicyRuleWithContext:
        """Create an instance of SmbSharePolicyRuleWithContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmbSharePolicyRuleWithContext.parse_obj(obj)

        _obj = SmbSharePolicyRuleWithContext.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
