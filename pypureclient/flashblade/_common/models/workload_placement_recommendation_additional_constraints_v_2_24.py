...
from pypureclient.flashblade._common.models.workload_placement_recommendation_resource_reference_v_2_24 import WorkloadPlacementRecommendationResourceReference
...
class WorkloadPlacementRecommendationAdditionalConstraints(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> WorkloadPlacementRecommendationAdditionalConstraints:
        ...
        _obj = WorkloadPlacementRecommendationAdditionalConstraints.construct(_fields_set=None, **{
            ...
            "targets": [ReferenceWritable.from_dict(_item) for _item in obj.get("targets")] if obj.get("targets") is not None else None
        })
        return _obj
