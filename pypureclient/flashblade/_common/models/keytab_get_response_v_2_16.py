...
from pypureclient.flashblade._common.models.keytab_v_2_16 import Keytab


class KeytabGetResponse(BaseModel):
    """
    KeytabGetResponse
    """
    ...
    items: Optional[conlist(Keytab)] = Field(default=None, description="A list of Kerberos keytab objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> KeytabGetResponse:
        """Create an instance of KeytabGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> KeytabGetResponse:
        """Create an instance of KeytabGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return KeytabGetResponse.parse_obj(obj)

        _obj = KeytabGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [Keytab.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
