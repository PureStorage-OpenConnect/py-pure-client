...
from pypureclient.flashblade._common.models.node_group_use_v_2_18 import NodeGroupUse


class NodeGroupUseGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(NodeGroupUse)] = Field(default=None, description="A list of node group use objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NodeGroupUseGetResponse:
        """Create an instance of NodeGroupUseGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NodeGroupUseGetResponse:
        """Create an instance of NodeGroupUseGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NodeGroupUseGetResponse.parse_obj(obj)

        _obj = NodeGroupUseGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [NodeGroupUse.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
