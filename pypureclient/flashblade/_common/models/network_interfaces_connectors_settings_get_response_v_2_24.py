...
from pypureclient.flashblade._common.models.network_interfaces_connectors_setting_v_2_24 import NetworkInterfacesConnectorsSetting


class NetworkInterfacesConnectorsSettingsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(NetworkInterfacesConnectorsSetting)] = Field(default=None, description="A list of global network settings for network connectors.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkInterfacesConnectorsSettingsGetResponse:
        """Create an instance of NetworkInterfacesConnectorsSettingsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkInterfacesConnectorsSettingsGetResponse:
        """Create an instance of NetworkInterfacesConnectorsSettingsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkInterfacesConnectorsSettingsGetResponse.parse_obj(obj)

        _obj = NetworkInterfacesConnectorsSettingsGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [NetworkInterfacesConnectorsSetting.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
