...
class LogsAsyncGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(LogsAsync)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogsAsyncGetResponse:
        """Create an instance of LogsAsyncGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LogsAsyncGetResponse:
        """Create an instance of LogsAsyncGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogsAsyncGetResponse.parse_obj(obj)

        _obj = LogsAsyncGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [LogsAsync.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
