...
from pypureclient.flashblade._common.models.role_v_2_0 import Role
...
class RoleGetResponse(BaseModel):
    ...
    items: Optional[conlist(Role)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoleGetResponse:
        """Create an instance of RoleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RoleGetResponse:
        """Create an instance of RoleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RoleGetResponse.parse_obj(obj)

        _obj = RoleGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [Role.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
