...
class DataEvictionPolicyPost(BaseModel):
    """
    ...
    keep_size: Optional[StrictInt] = Field(default=None, description="The maximum physical data space (in bytes) of a target file system before least recently read data is evicted.")
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "keep_size"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataEvictionPolicyPost:
        """Create an instance of DataEvictionPolicyPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DataEvictionPolicyPost:
        """Create an instance of DataEvictionPolicyPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataEvictionPolicyPost.parse_obj(obj)

        _obj = DataEvictionPolicyPost.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
