...
class FixedReferenceWithRemote(BaseModel):
    """
    ...
    remote: Optional[FixedReferenceNoResourceType] = Field(default=None, description="The remote field of the corresponding array connection.")
    __properties = ["id", "name", "resource_type", "remote"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixedReferenceWithRemote:
        """Create an instance of FixedReferenceWithRemote from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FixedReferenceWithRemote:
        """Create an instance of FixedReferenceWithRemote from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FixedReferenceWithRemote.parse_obj(obj)

        _obj = FixedReferenceWithRemote.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
