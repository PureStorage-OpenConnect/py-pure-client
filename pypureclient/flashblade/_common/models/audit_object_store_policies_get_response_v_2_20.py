...
from pypureclient.flashblade._common.models.audit_object_store_policy_with_context_v_2_20 import AuditObjectStorePolicyWithContext
...
class AuditObjectStorePoliciesGetResponse(BaseModel):
    ...
    items: Optional[conlist(AuditObjectStorePolicyWithContext)] = Field(default=None, description="A list of audit policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditObjectStorePoliciesGetResponse:
        """Create an instance of AuditObjectStorePoliciesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditObjectStorePoliciesGetResponse:
        """Create an instance of AuditObjectStorePoliciesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditObjectStorePoliciesGetResponse.parse_obj(obj)

        _obj = AuditObjectStorePoliciesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [AuditObjectStorePolicyWithContext.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
