...
from pypureclient.flashblade._common.models.workload_placement_recommendation_target_capacity_used_projections_v_2_24 import WorkloadPlacementRecommendationTargetCapacityUsedProjections
from pypureclient.flashblade._common.models.workload_placement_recommendation_target_load_projections_v_2_24 import WorkloadPlacementRecommendationTargetLoadProjections
from pypureclient.flashblade._common.models.workload_placement_recommendation_warning_v_2_24 import WorkloadPlacementRecommendationWarning


class WorkloadPlacementRecommendationGenericTarget(BaseModel):
    """
    ...
    periodic_replication_configurations: Optional[conlist(StrictStr)] = Field(default=None, description="The preset periodic replication configurations in which this array should be used.")
    placement_configurations: Optional[conlist(StrictStr)] = Field(default=None, description="The preset placement configurations in which this array should be used.")
    ...
    __properties = ["id", "name", "resource_type", "capacity", "capacity_used_projections", "load_projections", "model", "periodic_replication_configurations", "placement_configurations", "warnings"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkloadPlacementRecommendationGenericTarget:
        """Create an instance of WorkloadPlacementRecommendationGenericTarget from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> WorkloadPlacementRecommendationGenericTarget:
        """Create an instance of WorkloadPlacementRecommendationGenericTarget from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkloadPlacementRecommendationGenericTarget.parse_obj(obj)

        _obj = WorkloadPlacementRecommendationGenericTarget.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
