...
from pypureclient.flashblade._common.models.policy_member_context_v_2_22 import PolicyMemberContext


class UserGroupQuotaPoliciesMembersGetResponse(BaseModel):
    """
    UserGroupQuotaPoliciesMembersGetResponse
    """
    ...
    items: Optional[conlist(PolicyMemberContext)] = Field(default=None, description="A list of members for user-group-quota policies.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGroupQuotaPoliciesMembersGetResponse:
        """Create an instance of UserGroupQuotaPoliciesMembersGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> UserGroupQuotaPoliciesMembersGetResponse:
        """Create an instance of UserGroupQuotaPoliciesMembersGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGroupQuotaPoliciesMembersGetResponse.parse_obj(obj)

        _obj = UserGroupQuotaPoliciesMembersGetResponse.construct(_fields_set=None, **{
