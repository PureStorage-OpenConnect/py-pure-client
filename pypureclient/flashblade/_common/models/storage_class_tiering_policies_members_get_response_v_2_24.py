...
from pypureclient.flashblade._common.models.policy_member_v_2_24 import PolicyMember


class StorageClassTieringPoliciesMembersGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyMember)] = Field(default=None, description="A list of members for storage class tiering policies.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StorageClassTieringPoliciesMembersGetResponse:
        """Create an instance of StorageClassTieringPoliciesMembersGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> StorageClassTieringPoliciesMembersGetResponse:
        """Create an instance of StorageClassTieringPoliciesMembersGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StorageClassTieringPoliciesMembersGetResponse.parse_obj(obj)

        _obj = StorageClassTieringPoliciesMembersGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [PolicyMember.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
