...
from pypureclient.flashblade._common.models.file_system_eradication_config_v_2_24 import FileSystemEradicationConfig
...
from pypureclient.flashblade._common.models.location_reference_v_2_24 import LocationReference
from pypureclient.flashblade._common.models.multi_protocol_v_2_24 import MultiProtocol
from pypureclient.flashblade._common.models.nfs_v_2_24 import Nfs
from pypureclient.flashblade._common.models.smb_v_2_24 import Smb
from pypureclient.flashblade._common.models.space_v_2_24 import Space
from pypureclient.flashblade._common.models.storage_class_info_v_2_24 import StorageClassInfo
from pypureclient.flashblade._common.models.workload_configuration_reference_v_2_24 import WorkloadConfigurationReference
...
class FileSystem(BaseModel):
    ...
    node_group: Optional[FixedReference] = Field(default=None, description="The nodes contains the data of the file system.")
    ...
    qos_policy: Optional[FixedReference] = Field(default=None, description="The QoS policy for the File System defines the performance controls that can be applied to the aggregate performance of all the clients accessing the file system. If no policy is configured for a file system, then no performance controls are applied to it.")
    ...
    workload: Optional[WorkloadConfigurationReference] = None
    ...
    __properties = ["id", "name", "context", "realms", "created", "default_group_quota", "default_user_quota", "destroyed", "eradication_config", "fast_remove_directory_enabled", "group_ownership", "hard_limit_enabled", "http", "multi_protocol", "nfs", "node_group", "promotion_status", "provisioned", "qos_policy", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "space", "storage_class", "time_remaining", "workload", "writable"]
    ...
    def to_dict(self, include_readonly: bool=True) -> Dict[str, Any]:
        ...
        if _include_in_dict('storage_class', include_readonly, excluded_fields, none_fields):
            _dict['storage_class'] = self.storage_class.to_dict(include_readonly=include_readonly)
    ...
    def from_dict(cls, obj: dict) -> FileSystem:
        ...
        _obj = FileSystem.construct(_fields_set=None, **{
            ...
            "node_group": FixedReference.from_dict(obj.get("node_group")) if obj.get("node_group") is not None else None,
            "promotion_status": obj.get("promotion_status"),
            "provisioned": obj.get("provisioned"),
            "qos_policy": FixedReference.from_dict(obj.get("qos_policy")) if obj.get("qos_policy") is not None else None,
