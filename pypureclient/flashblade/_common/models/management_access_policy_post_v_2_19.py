...
from pypureclient.flashblade._common.models.management_access_policy_rule_in_policy_v_2_19 import ManagementAccessPolicyRuleInPolicy
...
class ManagementAccessPolicyPost(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "aggregation_strategy", "rules"]
