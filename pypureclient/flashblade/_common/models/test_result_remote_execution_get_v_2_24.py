...
from pypureclient.flashblade._common.models.test_result_with_context_v_2_24 import TestResultWithContext


class TestResultRemoteExecutionGet(BaseModel):
    """
    ...
    items: Optional[conlist(TestResultWithContext)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultRemoteExecutionGet:
        """Create an instance of TestResultRemoteExecutionGet from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TestResultRemoteExecutionGet:
        """Create an instance of TestResultRemoteExecutionGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultRemoteExecutionGet.parse_obj(obj)

        _obj = TestResultRemoteExecutionGet.construct(_fields_set=None, **{
            ...
            "items": [TestResultWithContext.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
