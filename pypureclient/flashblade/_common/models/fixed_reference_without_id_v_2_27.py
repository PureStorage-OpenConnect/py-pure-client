...
class FixedReferenceWithoutId(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixedReferenceWithoutId:
        """Create an instance of FixedReferenceWithoutId from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FixedReferenceWithoutId:
        """Create an instance of FixedReferenceWithoutId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FixedReferenceWithoutId.parse_obj(obj)

        _obj = FixedReferenceWithoutId.construct(_fields_set=None, **{
            "name": obj.get("name"),
