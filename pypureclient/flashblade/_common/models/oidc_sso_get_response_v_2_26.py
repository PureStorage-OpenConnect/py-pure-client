...
from pypureclient.flashblade._common.models.oidc_sso_v_2_26 import OidcSso


class OidcSsoGetResponse(BaseModel):
    """
    OidcSsoGetResponse
    """
    ...
    items: Optional[conlist(OidcSso)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OidcSsoGetResponse:
        """Create an instance of OidcSsoGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> OidcSsoGetResponse:
        """Create an instance of OidcSsoGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OidcSsoGetResponse.parse_obj(obj)

        _obj = OidcSsoGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [OidcSso.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
