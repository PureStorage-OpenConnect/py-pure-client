...
from pypureclient.flashblade._common.models.bucket_v_2_20 import Bucket
...
class BucketGetResponse(BaseModel):
    ...
    items: Optional[conlist(Bucket)] = Field(default=None, description="A list of bucket objects.")
    ...
    def from_dict(cls, obj: dict) -> BucketGetResponse:
        ...
        _obj = BucketGetResponse.construct(_fields_set=None, **{
            ...
            "total": Bucket.from_dict(obj.get("total")) if obj.get("total") is not None else None
        })
        return _obj
