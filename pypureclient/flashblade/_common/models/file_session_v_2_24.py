...
from pypureclient.flashblade._common.models.user_no_id_v_2_24 import UserNoId
...
class FileSession(BaseModel):
    ...
    __properties = ["name", "context", "authentication", "client", "connection_time", "idle_time", "opens", "port", "protocol", "time", "user"]
