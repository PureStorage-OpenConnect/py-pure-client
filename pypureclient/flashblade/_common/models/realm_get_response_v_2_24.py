...
from pypureclient.flashblade._common.models.realm_v_2_24 import Realm
...
class RealmGetResponse(BaseModel):
    ...
    items: Optional[conlist(Realm)] = None
    ...
    total: Optional[Realm] = None
    __properties = ["context", "continuation_token", "total_item_count", "items", "errors", "total"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RealmGetResponse:
        """Create an instance of RealmGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RealmGetResponse:
        """Create an instance of RealmGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RealmGetResponse.parse_obj(obj)

        _obj = RealmGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Realm.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "errors": [ErrorContextResponseErrors.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None,
            "total": Realm.from_dict(obj.get("total")) if obj.get("total") is not None else None
        })
        return _obj
