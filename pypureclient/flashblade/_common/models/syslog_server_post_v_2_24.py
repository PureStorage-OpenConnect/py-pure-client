...
class SyslogServerPost(BaseModel):
    """
    SyslogServerPost
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyslogServerPost:
        """Create an instance of SyslogServerPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SyslogServerPost:
        """Create an instance of SyslogServerPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyslogServerPost.parse_obj(obj)

        _obj = SyslogServerPost.construct(_fields_set=None, **{
            "uri": obj.get("uri"),
