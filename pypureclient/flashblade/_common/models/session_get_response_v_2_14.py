...
from pypureclient.flashblade._common.models.session_v_2_14 import Session
...
class SessionGetResponse(BaseModel):
    ...
    items: Optional[conlist(Session)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SessionGetResponse:
        """Create an instance of SessionGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SessionGetResponse:
        """Create an instance of SessionGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SessionGetResponse.parse_obj(obj)

        _obj = SessionGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [Session.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
