...
class WorkloadPreset(BaseModel):
    ...
    revision: Optional[StrictInt] = Field(default=None, description="The revision of the preset from which the workload was deployed.")
    __properties = ["id", "name", "resource_type", "revision"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkloadPreset:
        """Create an instance of WorkloadPreset from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> WorkloadPreset:
        """Create an instance of WorkloadPreset from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkloadPreset.parse_obj(obj)

        _obj = WorkloadPreset.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
