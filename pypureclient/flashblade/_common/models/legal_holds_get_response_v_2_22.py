...
from pypureclient.flashblade._common.models.legal_hold_v_2_22 import LegalHold


class LegalHoldsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(LegalHold)] = Field(default=None, description="A list of legal hold instances.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LegalHoldsGetResponse:
        """Create an instance of LegalHoldsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LegalHoldsGetResponse:
        """Create an instance of LegalHoldsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LegalHoldsGetResponse.parse_obj(obj)

        _obj = LegalHoldsGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [LegalHold.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
