...
from pypureclient.flashblade._common.models.file_system_open_file_v_2_22 import FileSystemOpenFile


class FileSystemOpenFilesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(FileSystemOpenFile)] = Field(default=None, description="A list of file system open file objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemOpenFilesGetResponse:
        """Create an instance of FileSystemOpenFilesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemOpenFilesGetResponse:
        """Create an instance of FileSystemOpenFilesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemOpenFilesGetResponse.parse_obj(obj)

        _obj = FileSystemOpenFilesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [FileSystemOpenFile.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
