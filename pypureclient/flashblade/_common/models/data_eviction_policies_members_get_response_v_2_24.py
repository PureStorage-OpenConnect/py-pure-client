...
from pypureclient.flashblade._common.models.policy_member_context_v_2_24 import PolicyMemberContext


class DataEvictionPoliciesMembersGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyMemberContext)] = Field(default=None, description="A list of members for data eviction policies.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataEvictionPoliciesMembersGetResponse:
        """Create an instance of DataEvictionPoliciesMembersGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DataEvictionPoliciesMembersGetResponse:
        """Create an instance of DataEvictionPoliciesMembersGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataEvictionPoliciesMembersGetResponse.parse_obj(obj)

        _obj = DataEvictionPoliciesMembersGetResponse.construct(_fields_set=None, **{
