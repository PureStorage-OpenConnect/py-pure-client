...
from pypureclient.flashblade._common.models.object_store_remote_credentials_v_2_20 import ObjectStoreRemoteCredentials


class ObjectStoreRemoteCredentialGetResp(BaseModel):
    """
    ...
    items: Optional[conlist(ObjectStoreRemoteCredentials)] = Field(default=None, description="A list of object store remote credentials.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreRemoteCredentialGetResp:
        """Create an instance of ObjectStoreRemoteCredentialGetResp from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreRemoteCredentialGetResp:
        """Create an instance of ObjectStoreRemoteCredentialGetResp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreRemoteCredentialGetResp.parse_obj(obj)

        _obj = ObjectStoreRemoteCredentialGetResp.construct(_fields_set=None, **{
            ...
            "items": [ObjectStoreRemoteCredentials.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
