...
class LocationReference(BaseModel):
    ...
    location: Optional[Reference] = Field(default=None, description="A reference to the location where the object is defined.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LocationReference:
        """Create an instance of LocationReference from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LocationReference:
        """Create an instance of LocationReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LocationReference.parse_obj(obj)

        _obj = LocationReference.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "resource_type": obj.get("resource_type"),
            "display_name": obj.get("display_name"),
            "is_local": obj.get("is_local"),
            "location": Reference.from_dict(obj.get("location")) if obj.get("location") is not None else None
        })
        return _obj
