...
class PolicyBaseRenameable(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyBaseRenameable:
        """Create an instance of PolicyBaseRenameable from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyBaseRenameable:
        """Create an instance of PolicyBaseRenameable from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyBaseRenameable.parse_obj(obj)

        _obj = PolicyBaseRenameable.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
