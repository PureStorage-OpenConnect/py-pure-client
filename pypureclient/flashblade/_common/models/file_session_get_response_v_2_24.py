...
from pypureclient.flashblade._common.models.file_session_v_2_24 import FileSession


class FileSessionGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(FileSession)] = Field(default=None, description="A list of file sessions.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSessionGetResponse:
        """Create an instance of FileSessionGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSessionGetResponse:
        """Create an instance of FileSessionGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSessionGetResponse.parse_obj(obj)

        _obj = FileSessionGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [FileSession.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
