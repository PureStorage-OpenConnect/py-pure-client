...
from pypureclient.flashblade._common.models.resiliency_group_v_2_23 import ResiliencyGroup


class ResiliencyGroupGetResponse(BaseModel):
    """
    ResiliencyGroupGetResponse
    """
    ...
    items: Optional[conlist(ResiliencyGroup)] = Field(default=None, description="A list of resiliency group objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResiliencyGroupGetResponse:
        """Create an instance of ResiliencyGroupGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResiliencyGroupGetResponse:
        """Create an instance of ResiliencyGroupGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResiliencyGroupGetResponse.parse_obj(obj)

        _obj = ResiliencyGroupGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [ResiliencyGroup.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
