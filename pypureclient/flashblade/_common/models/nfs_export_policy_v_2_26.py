...
from pypureclient.flashblade._common.models.nfs_export_policy_rule_in_policy_v_2_26 import NfsExportPolicyRuleInPolicy
from pypureclient.flashblade._common.models.workload_configuration_fixed_reference_v_2_26 import WorkloadConfigurationFixedReference


class NfsExportPolicy(BaseModel):
    """
    NfsExportPolicy
    """
    ...
    rules: Optional[conlist(NfsExportPolicyRuleInPolicy)] = Field(default=None, description="All of the rules that are part of this policy. The order is the evaluation order.")
    workload: Optional[WorkloadConfigurationFixedReference] = None
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "version", "context", "rules", "workload"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NfsExportPolicy:
        """Create an instance of NfsExportPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NfsExportPolicy:
        """Create an instance of NfsExportPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NfsExportPolicy.parse_obj(obj)

        _obj = NfsExportPolicy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "rules": [NfsExportPolicyRuleInPolicy.from_dict(_item) for _item in obj.get("rules")] if obj.get("rules") is not None else None,
