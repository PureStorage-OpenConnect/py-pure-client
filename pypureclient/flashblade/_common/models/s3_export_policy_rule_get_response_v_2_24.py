...
from pypureclient.flashblade._common.models.s3_export_policy_rule_v_2_24 import S3ExportPolicyRule


class S3ExportPolicyRuleGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(S3ExportPolicyRule)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> S3ExportPolicyRuleGetResponse:
        """Create an instance of S3ExportPolicyRuleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> S3ExportPolicyRuleGetResponse:
        """Create an instance of S3ExportPolicyRuleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return S3ExportPolicyRuleGetResponse.parse_obj(obj)

        _obj = S3ExportPolicyRuleGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [S3ExportPolicyRule.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
