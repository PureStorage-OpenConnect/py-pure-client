...
from pypureclient.flashblade._common.models.reference_writable_v_2_24 import ReferenceWritable


class SshCertificateAuthorityPolicy(BaseModel):
    """
    ...
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "signing_authority", "static_authorized_principals", "context"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SshCertificateAuthorityPolicy:
        """Create an instance of SshCertificateAuthorityPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SshCertificateAuthorityPolicy:
        """Create an instance of SshCertificateAuthorityPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SshCertificateAuthorityPolicy.parse_obj(obj)

        _obj = SshCertificateAuthorityPolicy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
