...
class ReferenceWithoutType(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceWithoutType:
        """Create an instance of ReferenceWithoutType from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceWithoutType:
        """Create an instance of ReferenceWithoutType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReferenceWithoutType.parse_obj(obj)

        _obj = ReferenceWithoutType.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
