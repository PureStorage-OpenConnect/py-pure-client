...
from pypureclient.flashblade._common.models.policy_rule_object_access_condition_v_2_2 import PolicyRuleObjectAccessCondition
...
class PolicyRuleObjectAccess(BaseModel):
    ...
    __properties = ["name", "context", "actions", "conditions", "effect", "policy", "resources"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleObjectAccess:
        """Create an instance of PolicyRuleObjectAccess from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleObjectAccess:
        """Create an instance of PolicyRuleObjectAccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleObjectAccess.parse_obj(obj)
