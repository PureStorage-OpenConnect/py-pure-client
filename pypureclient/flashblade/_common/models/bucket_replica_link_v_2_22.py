...
from pypureclient.flashblade._common.models.fixed_reference_name_only_v_2_0 import FixedReferenceNameOnly
from pypureclient.flashblade._common.models.object_backlog_v_2_2 import ObjectBacklog
...
class BucketReplicaLink(BaseModel):
    ...
    __properties = ["id", "direction", "lag", "status_details", "context", "cascading_enabled", "local_bucket", "object_backlog", "paused", "recovery_point", "remote", "remote_bucket", "remote_credentials", "status"]
