...
class SmbClientPolicyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SmbClientPolicy)] = Field(default=None, description="A list of SMB Client policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmbClientPolicyGetResponse:
        """Create an instance of SmbClientPolicyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmbClientPolicyGetResponse:
        """Create an instance of SmbClientPolicyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmbClientPolicyGetResponse.parse_obj(obj)

        _obj = SmbClientPolicyGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [SmbClientPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
