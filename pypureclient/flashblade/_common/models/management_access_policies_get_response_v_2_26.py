...
class ManagementAccessPoliciesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ManagementAccessPolicy)] = Field(default=None, description="A list of management access policy configuration objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagementAccessPoliciesGetResponse:
        """Create an instance of ManagementAccessPoliciesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ManagementAccessPoliciesGetResponse:
        """Create an instance of ManagementAccessPoliciesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagementAccessPoliciesGetResponse.parse_obj(obj)

        _obj = ManagementAccessPoliciesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [ManagementAccessPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
