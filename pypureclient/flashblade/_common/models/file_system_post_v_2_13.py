...
from pypureclient.flashblade._common.models.smb_post_v_2_12 import SmbPost
...
class FileSystemPost(BaseModel):
    ...
    __properties = ["default_group_quota", "default_user_quota", "fast_remove_directory_enabled", "group_ownership", "hard_limit_enabled", "http", "multi_protocol", "nfs", "provisioned", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "writable"]
