...
from pypureclient.flashblade._common.models.nfs_v_2_16 import Nfs
from pypureclient.flashblade._common.models.reference_v_2_0 import Reference
from pypureclient.flashblade._common.models.smb_post_v_2_16 import SmbPost
...
class FileSystemPost(BaseModel):
    ...
    __properties = ["default_group_quota", "default_user_quota", "eradication_config", "fast_remove_directory_enabled", "group_ownership", "hard_limit_enabled", "http", "multi_protocol", "nfs", "provisioned", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "writable"]
