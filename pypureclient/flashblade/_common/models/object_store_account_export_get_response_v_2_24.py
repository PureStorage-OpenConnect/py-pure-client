...
from pypureclient.flashblade._common.models.object_store_account_export_v_2_24 import ObjectStoreAccountExport


class ObjectStoreAccountExportGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ObjectStoreAccountExport)] = Field(default=None, description="A list of object store account export objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreAccountExportGetResponse:
        """Create an instance of ObjectStoreAccountExportGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreAccountExportGetResponse:
        """Create an instance of ObjectStoreAccountExportGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreAccountExportGetResponse.parse_obj(obj)

        _obj = ObjectStoreAccountExportGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [ObjectStoreAccountExport.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
