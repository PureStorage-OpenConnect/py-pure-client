...
from pypureclient.flashblade._common.models.cross_origin_resource_sharing_policy_v_2_24 import CrossOriginResourceSharingPolicy
from pypureclient.flashblade._common.models.error_context_response_errors_v_2_24 import ErrorContextResponseErrors


class CrossOriginResourceSharingPolicyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(CrossOriginResourceSharingPolicy)] = Field(default=None, description="A list of cross origin resource sharing policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CrossOriginResourceSharingPolicyGetResponse:
        """Create an instance of CrossOriginResourceSharingPolicyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CrossOriginResourceSharingPolicyGetResponse:
        """Create an instance of CrossOriginResourceSharingPolicyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CrossOriginResourceSharingPolicyGetResponse.parse_obj(obj)

        _obj = CrossOriginResourceSharingPolicyGetResponse.construct(_fields_set=None, **{
            ...
            "items": [CrossOriginResourceSharingPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
