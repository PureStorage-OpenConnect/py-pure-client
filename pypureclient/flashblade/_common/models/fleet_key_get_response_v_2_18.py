...
from pypureclient.flashblade._common.models.fleet_key_v_2_18 import FleetKey


class FleetKeyGetResponse(BaseModel):
    """
    FleetKeyGetResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FleetKeyGetResponse:
        """Create an instance of FleetKeyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FleetKeyGetResponse:
        """Create an instance of FleetKeyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FleetKeyGetResponse.parse_obj(obj)

        _obj = FleetKeyGetResponse.construct(_fields_set=None, **{
