...
class PolicyMemberContextGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyMemberContext)] = Field(default=None, description="A list of members for policies.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyMemberContextGetResponse:
        """Create an instance of PolicyMemberContextGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyMemberContextGetResponse:
        """Create an instance of PolicyMemberContextGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyMemberContextGetResponse.parse_obj(obj)

        _obj = PolicyMemberContextGetResponse.construct(_fields_set=None, **{
