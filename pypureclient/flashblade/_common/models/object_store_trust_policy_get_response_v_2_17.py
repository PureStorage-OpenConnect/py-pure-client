...
from pypureclient.flashblade._common.models.object_store_trust_policy_v_2_17 import ObjectStoreTrustPolicy


class ObjectStoreTrustPolicyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ObjectStoreTrustPolicy)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreTrustPolicyGetResponse:
        """Create an instance of ObjectStoreTrustPolicyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreTrustPolicyGetResponse:
        """Create an instance of ObjectStoreTrustPolicyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreTrustPolicyGetResponse.parse_obj(obj)

        _obj = ObjectStoreTrustPolicyGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ObjectStoreTrustPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
