...
from pypureclient.flashblade._common.models.log_targets_object_store_with_context_v_2_24 import LogTargetsObjectStoreWithContext


class LogTargetsObjectStoreGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(LogTargetsObjectStoreWithContext)] = Field(default=None, description="A list of log target objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogTargetsObjectStoreGetResponse:
        """Create an instance of LogTargetsObjectStoreGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LogTargetsObjectStoreGetResponse:
        """Create an instance of LogTargetsObjectStoreGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogTargetsObjectStoreGetResponse.parse_obj(obj)

        _obj = LogTargetsObjectStoreGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [LogTargetsObjectStoreWithContext.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
