...
from pypureclient.flashblade._common.models.support_diagnostics_settings_v_2_24 import SupportDiagnosticsSettings


class SupportDiagnosticsSettingsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SupportDiagnosticsSettings)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupportDiagnosticsSettingsGetResponse:
        """Create an instance of SupportDiagnosticsSettingsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SupportDiagnosticsSettingsGetResponse:
        """Create an instance of SupportDiagnosticsSettingsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupportDiagnosticsSettingsGetResponse.parse_obj(obj)

        _obj = SupportDiagnosticsSettingsGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [SupportDiagnosticsSettings.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
