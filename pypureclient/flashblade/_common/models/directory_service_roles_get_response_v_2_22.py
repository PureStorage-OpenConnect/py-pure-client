...
class DirectoryServiceRolesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(DirectoryServiceRole)] = Field(default=None, description="A list of directory service role mapping configuration objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryServiceRolesGetResponse:
        """Create an instance of DirectoryServiceRolesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryServiceRolesGetResponse:
        """Create an instance of DirectoryServiceRolesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryServiceRolesGetResponse.parse_obj(obj)

        _obj = DirectoryServiceRolesGetResponse.construct(_fields_set=None, **{
