...
from pypureclient.flashblade._common.models.bucket_audit_filter_with_context_v_2_22 import BucketAuditFilterWithContext
from pypureclient.flashblade._common.models.error_context_response_errors_v_2_22 import ErrorContextResponseErrors


class BucketAuditFilterGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(BucketAuditFilterWithContext)] = Field(default=None, description="A list of audit filters.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BucketAuditFilterGetResponse:
        """Create an instance of BucketAuditFilterGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> BucketAuditFilterGetResponse:
        """Create an instance of BucketAuditFilterGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BucketAuditFilterGetResponse.parse_obj(obj)

        _obj = BucketAuditFilterGetResponse.construct(_fields_set=None, **{
            ...
            "items": [BucketAuditFilterWithContext.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
