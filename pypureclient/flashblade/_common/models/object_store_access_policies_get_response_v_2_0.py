...
from pypureclient.flashblade._common.models.object_store_access_policy_v_2_0 import ObjectStoreAccessPolicy


class ObjectStoreAccessPoliciesGetResponse(BaseModel):
    """
    ObjectStoreAccessPoliciesGetResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreAccessPoliciesGetResponse:
        """Create an instance of ObjectStoreAccessPoliciesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreAccessPoliciesGetResponse:
        """Create an instance of ObjectStoreAccessPoliciesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreAccessPoliciesGetResponse.parse_obj(obj)

        _obj = ObjectStoreAccessPoliciesGetResponse.construct(_fields_set=None, **{
