...
from pypureclient.flashblade._common.models.reference_v_2_0 import Reference
...
class AuditFileSystemsPoliciesPatch(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "log_targets", "add_log_targets", "remove_log_targets"]
