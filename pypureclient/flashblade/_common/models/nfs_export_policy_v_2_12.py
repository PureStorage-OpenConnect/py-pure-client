...
from pypureclient.flashblade._common.models.nfs_export_policy_rule_in_policy_v_2_10 import NfsExportPolicyRuleInPolicy
...
class NfsExportPolicy(BaseModel):
    ...
    policy_type: Optional[StrictStr] = Field(default=None, description="Type of the policy. Valid values are `bucket-access`, `cross-origin-resource-sharing`, `nfs`, `object-access`, `smb-client`, `smb-share`, and `snapshot`.")
