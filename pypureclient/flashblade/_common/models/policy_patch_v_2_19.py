...
from pypureclient.flashblade._common.models.policy_rule_v_2_0 import PolicyRule
...
class PolicyPatch(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "context", "retention_lock", "rules", "add_rules", "remove_rules"]
