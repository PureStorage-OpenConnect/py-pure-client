...
class HardwareConnectorGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(HardwareConnector)] = Field(default=None, description="A list of connector objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HardwareConnectorGetResponse:
        """Create an instance of HardwareConnectorGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> HardwareConnectorGetResponse:
        """Create an instance of HardwareConnectorGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HardwareConnectorGetResponse.parse_obj(obj)

        _obj = HardwareConnectorGetResponse.construct(_fields_set=None, **{
