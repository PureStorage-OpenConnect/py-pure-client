...
class SmbClientPolicyRuleInPolicy(BaseModel):
    """
    ...
    __properties = ["id", "name", "client", "encryption", "permission", "policy", "policy_version", "index"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmbClientPolicyRuleInPolicy:
        """Create an instance of SmbClientPolicyRuleInPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmbClientPolicyRuleInPolicy:
        """Create an instance of SmbClientPolicyRuleInPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmbClientPolicyRuleInPolicy.parse_obj(obj)

        _obj = SmbClientPolicyRuleInPolicy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
