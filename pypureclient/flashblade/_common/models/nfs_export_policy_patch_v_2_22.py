...
from pypureclient.flashblade._common.models.nfs_export_policy_patch_rule_in_policy_v_2_22 import NfsExportPolicyPatchRuleInPolicy
...
class NfsExportPolicyPatch(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "version", "rules"]
