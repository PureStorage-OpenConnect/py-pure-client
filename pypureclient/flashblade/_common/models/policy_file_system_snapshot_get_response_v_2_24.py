...
from pypureclient.flashblade._common.models.policy_file_system_snapshot_v_2_24 import PolicyFileSystemSnapshot


class PolicyFileSystemSnapshotGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyFileSystemSnapshot)] = Field(default=None, description="A list of members for policies.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyFileSystemSnapshotGetResponse:
        """Create an instance of PolicyFileSystemSnapshotGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyFileSystemSnapshotGetResponse:
        """Create an instance of PolicyFileSystemSnapshotGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyFileSystemSnapshotGetResponse.parse_obj(obj)

        _obj = PolicyFileSystemSnapshotGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [PolicyFileSystemSnapshot.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
