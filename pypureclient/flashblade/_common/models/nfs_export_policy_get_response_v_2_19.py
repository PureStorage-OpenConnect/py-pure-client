...
from pypureclient.flashblade._common.models.nfs_export_policy_v_2_19 import NfsExportPolicy


class NfsExportPolicyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(NfsExportPolicy)] = Field(default=None, description="A list of NFS export policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NfsExportPolicyGetResponse:
        """Create an instance of NfsExportPolicyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NfsExportPolicyGetResponse:
        """Create an instance of NfsExportPolicyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NfsExportPolicyGetResponse.parse_obj(obj)

        _obj = NfsExportPolicyGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [NfsExportPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
