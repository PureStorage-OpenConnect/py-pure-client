...
class ActiveDirectory(BaseModel):
    ...
    server: Optional[FixedReference] = Field(default=None, description="The server containing this active directory account.")
    ...
    __properties = ["id", "name", "directory_servers", "global_catalog_servers", "kerberos_servers", "realms", "ca_certificate", "ca_certificate_group", "computer_name", "domain", "encryption_types", "join_ou", "server", "service_principal_names"]
