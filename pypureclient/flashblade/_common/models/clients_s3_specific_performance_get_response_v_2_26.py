...
from pypureclient.flashblade._common.models.clients_s3_specific_performance_v_2_26 import ClientsS3SpecificPerformance


class ClientsS3SpecificPerformanceGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ClientsS3SpecificPerformance)] = Field(default=None, description="A list of S3 specific array performance metrics objects.")
    total: Optional[conlist(ClientsS3SpecificPerformance)] = Field(default=None, description="Total of all records after filtering. If `total_only` query param is `true`, then no items will be returned.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientsS3SpecificPerformanceGetResponse:
        """Create an instance of ClientsS3SpecificPerformanceGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ClientsS3SpecificPerformanceGetResponse:
        """Create an instance of ClientsS3SpecificPerformanceGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientsS3SpecificPerformanceGetResponse.parse_obj(obj)

        _obj = ClientsS3SpecificPerformanceGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [ClientsS3SpecificPerformance.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "total": [ClientsS3SpecificPerformance.from_dict(_item) for _item in obj.get("total")] if obj.get("total") is not None else None
        })
        return _obj
