...
class UserGroupQuotaLimitedBy(BaseModel):
    ...
    policy: Optional[FixedReference] = Field(default=None, description="Reference to the policy.")
    rule_id: Optional[StrictStr] = Field(default=None, description="The ID of the policy rule which enforced this quota limit.")
    rule_name: Optional[StrictStr] = Field(default=None, description="The name of the policy rule which enforced this quota limit.")
    __properties = ["member", "policy", "rule_id", "rule_name"]
