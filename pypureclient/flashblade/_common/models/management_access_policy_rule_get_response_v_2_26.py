...
class ManagementAccessPolicyRuleGetResponse(BaseModel):
    """
    ManagementAccessPolicyRuleGetResponse
    """
    ...
    items: Optional[conlist(ManagementAccessPolicyRule)] = Field(default=None, description="Displays a list of all items after filtering.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagementAccessPolicyRuleGetResponse:
        """Create an instance of ManagementAccessPolicyRuleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ManagementAccessPolicyRuleGetResponse:
        """Create an instance of ManagementAccessPolicyRuleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagementAccessPolicyRuleGetResponse.parse_obj(obj)

        _obj = ManagementAccessPolicyRuleGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [ManagementAccessPolicyRule.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
