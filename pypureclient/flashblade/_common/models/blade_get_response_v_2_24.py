...
from pypureclient.flashblade._common.models.blade_v_2_24 import Blade


class BladeGetResponse(BaseModel):
    """
    BladeGetResponse
    """
    ...
    items: Optional[conlist(Blade)] = Field(default=None, description="A list of blade objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BladeGetResponse:
        """Create an instance of BladeGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> BladeGetResponse:
        """Create an instance of BladeGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BladeGetResponse.parse_obj(obj)

        _obj = BladeGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [Blade.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "total": obj.get("total")
        })
        return _obj
