...
class ObjectStoreAccessKeyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ObjectStoreAccessKey)] = Field(default=None, description="A list of object store access key objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreAccessKeyGetResponse:
        """Create an instance of ObjectStoreAccessKeyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreAccessKeyGetResponse:
        """Create an instance of ObjectStoreAccessKeyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreAccessKeyGetResponse.parse_obj(obj)

        _obj = ObjectStoreAccessKeyGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ObjectStoreAccessKey.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
