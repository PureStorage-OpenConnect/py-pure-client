...
class FileSystemSnapshotTransfer(BaseModel):
    ...
    remote: Optional[FixedReference] = Field(default=None, description="The array or realm where the remote file system snapshot is located.")
    ...
    __properties = ["id", "name", "context", "completed", "data_transferred", "direction", "local_snapshot", "progress", "remote", "remote_snapshot", "started", "status"]
