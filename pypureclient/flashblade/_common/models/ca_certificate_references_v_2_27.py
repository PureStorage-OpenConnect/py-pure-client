...
class CaCertificateReferences(BaseModel):
    """
    ...
    __properties = ["ca_certificate", "ca_certificate_group"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CaCertificateReferences:
        """Create an instance of CaCertificateReferences from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CaCertificateReferences:
        """Create an instance of CaCertificateReferences from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CaCertificateReferences.parse_obj(obj)

        _obj = CaCertificateReferences.construct(_fields_set=None, **{
