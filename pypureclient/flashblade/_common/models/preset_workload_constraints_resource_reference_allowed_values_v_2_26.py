...
class PresetWorkloadConstraintsResourceReferenceAllowedValues(BaseModel):
    """
    ...
    resource_type: StrictStr = Field(default=..., description="The type of resource the parameter references. Valid values include `servers`, `storage-classes`, and `remote-arrays`.")
    __properties = ["id", "name", "resource_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PresetWorkloadConstraintsResourceReferenceAllowedValues:
        """Create an instance of PresetWorkloadConstraintsResourceReferenceAllowedValues from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PresetWorkloadConstraintsResourceReferenceAllowedValues:
        """Create an instance of PresetWorkloadConstraintsResourceReferenceAllowedValues from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PresetWorkloadConstraintsResourceReferenceAllowedValues.parse_obj(obj)

        _obj = PresetWorkloadConstraintsResourceReferenceAllowedValues.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
