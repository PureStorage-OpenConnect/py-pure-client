...
class AuditObjectStorePoliciesPatch(BaseModel):
    """
    ...
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "log_targets", "add_log_targets", "remove_log_targets"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditObjectStorePoliciesPatch:
        """Create an instance of AuditObjectStorePoliciesPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditObjectStorePoliciesPatch:
        """Create an instance of AuditObjectStorePoliciesPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditObjectStorePoliciesPatch.parse_obj(obj)

        _obj = AuditObjectStorePoliciesPatch.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
