...
class PolicyBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyBase:
        """Create an instance of PolicyBase from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyBase:
        """Create an instance of PolicyBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyBase.parse_obj(obj)

        _obj = PolicyBase.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
