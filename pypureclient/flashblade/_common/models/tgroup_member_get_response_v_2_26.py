...
from pypureclient.flashblade._common.models.tgroup_member_v_2_26 import TgroupMember


class TgroupMemberGetResponse(BaseModel):
    """
    TgroupMemberGetResponse
    """
    ...
    items: Optional[conlist(TgroupMember)] = Field(default=None, description="Displays a list of topology group membership results.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TgroupMemberGetResponse:
        """Create an instance of TgroupMemberGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TgroupMemberGetResponse:
        """Create an instance of TgroupMemberGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TgroupMemberGetResponse.parse_obj(obj)

        _obj = TgroupMemberGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [TgroupMember.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
