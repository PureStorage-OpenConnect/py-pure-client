...
from pypureclient.flashblade._common.models.worm_data_policy_v_2_17 import WormDataPolicy


class WormDataPoliciesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(WormDataPolicy)] = Field(default=None, description="A list of worm data policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WormDataPoliciesGetResponse:
        """Create an instance of WormDataPoliciesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> WormDataPoliciesGetResponse:
        """Create an instance of WormDataPoliciesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WormDataPoliciesGetResponse.parse_obj(obj)

        _obj = WormDataPoliciesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [WormDataPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
