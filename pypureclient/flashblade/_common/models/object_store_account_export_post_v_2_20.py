...
class ObjectStoreAccountExportPost(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreAccountExportPost:
        """Create an instance of ObjectStoreAccountExportPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreAccountExportPost:
        """Create an instance of ObjectStoreAccountExportPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreAccountExportPost.parse_obj(obj)
