...
from pypureclient.flashblade._common.models.policy_rule_v_2_26 import PolicyRule


class SnapshotPolicyPatch(BaseModel):
    """
    SnapshotPolicyPatch
    """
    ...
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "add_rules", "remove_rules", "retention_lock", "rules"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnapshotPolicyPatch:
        """Create an instance of SnapshotPolicyPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SnapshotPolicyPatch:
        """Create an instance of SnapshotPolicyPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnapshotPolicyPatch.parse_obj(obj)

        _obj = SnapshotPolicyPatch.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
