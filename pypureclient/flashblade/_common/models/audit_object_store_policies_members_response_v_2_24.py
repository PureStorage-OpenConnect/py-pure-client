...
class AuditObjectStorePoliciesMembersResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditObjectStorePoliciesMembersResponse:
        """Create an instance of AuditObjectStorePoliciesMembersResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditObjectStorePoliciesMembersResponse:
        """Create an instance of AuditObjectStorePoliciesMembersResponse from a dict"""
        if obj is None:
            return None
