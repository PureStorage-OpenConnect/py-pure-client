...
from pypureclient.flashblade._common.models.certificate_use_v_2_26 import CertificateUse


class CertificateUseGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(CertificateUse)] = Field(default=None, description="A list of certificate use objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificateUseGetResponse:
        """Create an instance of CertificateUseGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CertificateUseGetResponse:
        """Create an instance of CertificateUseGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CertificateUseGetResponse.parse_obj(obj)

        _obj = CertificateUseGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [CertificateUse.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
