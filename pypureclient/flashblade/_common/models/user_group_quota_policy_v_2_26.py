...
from pypureclient.flashblade._common.models.user_group_quota_policy_rule_in_policy_v_2_26 import UserGroupQuotaPolicyRuleInPolicy


class UserGroupQuotaPolicy(BaseModel):
    """
    UserGroupQuotaPolicy
    """
    ...
    rules: Optional[conlist(UserGroupQuotaPolicyRuleInPolicy, max_items=2000)] = Field(default=None, description="All of the rules that are part of this policy.")
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "version", "context", "rules"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGroupQuotaPolicy:
        """Create an instance of UserGroupQuotaPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> UserGroupQuotaPolicy:
        """Create an instance of UserGroupQuotaPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGroupQuotaPolicy.parse_obj(obj)

        _obj = UserGroupQuotaPolicy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "rules": [UserGroupQuotaPolicyRuleInPolicy.from_dict(_item) for _item in obj.get("rules")] if obj.get("rules") is not None else None
        })
        return _obj
