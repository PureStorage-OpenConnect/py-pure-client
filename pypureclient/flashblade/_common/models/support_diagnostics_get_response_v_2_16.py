...
from pypureclient.flashblade._common.models.support_diagnostics_v_2_16 import SupportDiagnostics
...
class SupportDiagnosticsGetResponse(BaseModel):
    ...
    items: Optional[conlist(SupportDiagnostics)] = None
    ...
    def from_dict(cls, obj: dict) -> SupportDiagnosticsGetResponse:
        ...
        _obj = SupportDiagnosticsGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SupportDiagnostics.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
