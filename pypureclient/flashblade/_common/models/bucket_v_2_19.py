...
class Bucket(BaseModel):
    ...
    __properties = ["id", "name", "context", "account", "bucket_type", "created", "destroyed", "eradication_config", "hard_limit_enabled", "object_count", "object_lock_config", "public_access_config", "public_status", "quota_limit", "retention_lock", "space", "storage_class", "time_remaining", "time_remaining_status", "versioning"]
