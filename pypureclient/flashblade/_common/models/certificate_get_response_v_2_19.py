...
from pypureclient.flashblade._common.models.certificate_v_2_19 import Certificate
...
class CertificateGetResponse(BaseModel):
    ...
    items: Optional[conlist(Certificate)] = Field(default=None, description="A list of certificate objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificateGetResponse:
        """Create an instance of CertificateGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CertificateGetResponse:
        """Create an instance of CertificateGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CertificateGetResponse.parse_obj(obj)

        _obj = CertificateGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [Certificate.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
