...
class RealmSpaceStorageClass(BaseModel):
    """
    ...
    storage_class: Optional[StrictStr] = Field(default=None, description="The name of the storage-class.")
    __properties = ["id", "name", "space", "time", "storage_class"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RealmSpaceStorageClass:
        """Create an instance of RealmSpaceStorageClass from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RealmSpaceStorageClass:
        """Create an instance of RealmSpaceStorageClass from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RealmSpaceStorageClass.parse_obj(obj)

        _obj = RealmSpaceStorageClass.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
