...
from pypureclient.flashblade._common.models.smb_share_policy_v_2_24 import SmbSharePolicy


class SmbSharePolicyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SmbSharePolicy)] = Field(default=None, description="A list of SMB Share policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmbSharePolicyGetResponse:
        """Create an instance of SmbSharePolicyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmbSharePolicyGetResponse:
        """Create an instance of SmbSharePolicyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmbSharePolicyGetResponse.parse_obj(obj)

        _obj = SmbSharePolicyGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [SmbSharePolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
