...
from pypureclient.flashblade._common.models.file_system_v_2_18 import FileSystem


class FileSystemGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(FileSystem)] = Field(default=None, description="A list of file system objects.")
    ...
    total: Optional[FileSystem] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemGetResponse:
        """Create an instance of FileSystemGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemGetResponse:
        """Create an instance of FileSystemGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemGetResponse.parse_obj(obj)

        _obj = FileSystemGetResponse.construct(_fields_set=None, **{
            ...
            "total": FileSystem.from_dict(obj.get("total")) if obj.get("total") is not None else None
        })
        return _obj
