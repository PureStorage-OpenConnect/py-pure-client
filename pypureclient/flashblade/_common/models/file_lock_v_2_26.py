...
from pypureclient.flashblade._common.models.file_lock_range_v_2_26 import FileLockRange
from pypureclient.flashblade._common.models.fixed_reference_v_2_26 import FixedReference
from pypureclient.flashblade._common.models.fixed_reference_no_id_v_2_26 import FixedReferenceNoId
...
class FileLock(BaseModel):
    ...
    __properties = ["name", "context", "access_type", "client", "created_at", "inode", "path", "protocol", "range", "source"]
