...
from pypureclient.flashblade._common.models.policy_base_context_v_2_20 import PolicyBaseContext


class PolicyBaseGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyBaseContext)] = Field(default=None, description="A list of basic policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyBaseGetResponse:
        """Create an instance of PolicyBaseGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyBaseGetResponse:
        """Create an instance of PolicyBaseGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyBaseGetResponse.parse_obj(obj)

        _obj = PolicyBaseGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [PolicyBaseContext.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
