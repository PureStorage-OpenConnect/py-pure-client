...
from pypureclient.flashblade._common.models.audit_log_name_prefix_v_2_24 import AuditLogNamePrefix
from pypureclient.flashblade._common.models.audit_log_rotate_v_2_24 import AuditLogRotate
...
class LogTargetsObjectStoreWithContext(BaseModel):
    ...
    __properties = ["context", "id", "name", "bucket", "log_name_prefix", "log_rotate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogTargetsObjectStoreWithContext:
        """Create an instance of LogTargetsObjectStoreWithContext from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LogTargetsObjectStoreWithContext:
        """Create an instance of LogTargetsObjectStoreWithContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogTargetsObjectStoreWithContext.parse_obj(obj)
