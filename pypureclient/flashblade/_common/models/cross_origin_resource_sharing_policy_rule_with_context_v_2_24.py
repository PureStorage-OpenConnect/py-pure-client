...
class CrossOriginResourceSharingPolicyRuleWithContext(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CrossOriginResourceSharingPolicyRuleWithContext:
        """Create an instance of CrossOriginResourceSharingPolicyRuleWithContext from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CrossOriginResourceSharingPolicyRuleWithContext:
        """Create an instance of CrossOriginResourceSharingPolicyRuleWithContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CrossOriginResourceSharingPolicyRuleWithContext.parse_obj(obj)

        _obj = CrossOriginResourceSharingPolicyRuleWithContext.construct(_fields_set=None, **{
