...
class PolicyBaseContext(BaseModel):
    """
    PolicyBaseContext
    """
    ...
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "context"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyBaseContext:
        """Create an instance of PolicyBaseContext from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyBaseContext:
        """Create an instance of PolicyBaseContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyBaseContext.parse_obj(obj)

        _obj = PolicyBaseContext.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
