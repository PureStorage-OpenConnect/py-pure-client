...
from pypureclient.flashblade._common.models.policy_rule_object_access_v_2_17 import PolicyRuleObjectAccess
...
class ObjectStoreAccessPolicy(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "context", "account", "arn", "created", "description", "rules", "updated"]
