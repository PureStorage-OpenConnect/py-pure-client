...
from pypureclient.flashblade._common.models.network_access_policy_rule_v_2_22 import NetworkAccessPolicyRule


class NetworkAccessPolicyRuleGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(NetworkAccessPolicyRule)] = Field(default=None, description="Displays a list of all items after filtering.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkAccessPolicyRuleGetResponse:
        """Create an instance of NetworkAccessPolicyRuleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkAccessPolicyRuleGetResponse:
        """Create an instance of NetworkAccessPolicyRuleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkAccessPolicyRuleGetResponse.parse_obj(obj)

        _obj = NetworkAccessPolicyRuleGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [NetworkAccessPolicyRule.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
