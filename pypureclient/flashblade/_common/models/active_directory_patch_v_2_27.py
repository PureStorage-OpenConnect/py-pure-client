...
class ActiveDirectoryPatch(BaseModel):
    ...
    ca_certificate: Optional[Reference] = Field(default=None, description="Reference (ID, name, and resource type) of the Certificate Authority (CA) that signed the certificates of the configured servers, which is used to validate the authenticity of the servers.")
    ca_certificate_group: Optional[Reference] = Field(default=None, description="Reference (ID, name, and resource type) of a certificate group containing CA certificates that can be used to validate the authenticity of the configured servers.")
    ...
    __properties = ["directory_servers", "global_catalog_servers", "kerberos_servers", "ca_certificate", "ca_certificate_group", "encryption_types", "fqdns", "join_ou", "service_principal_names"]
