...
from pypureclient.flashblade._common.models.data_eviction_policy_v_2_22 import DataEvictionPolicy
from pypureclient.flashblade._common.models.error_context_response_errors_v_2_22 import ErrorContextResponseErrors


class DataEvictionPoliciesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(DataEvictionPolicy)] = Field(default=None, description="A list of Data Eviction policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataEvictionPoliciesGetResponse:
        """Create an instance of DataEvictionPoliciesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DataEvictionPoliciesGetResponse:
        """Create an instance of DataEvictionPoliciesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataEvictionPoliciesGetResponse.parse_obj(obj)

        _obj = DataEvictionPoliciesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [DataEvictionPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
