...
from pypureclient.flashblade._common.models.policy_member_context_v_2_17 import PolicyMemberContext
...
class AuditObjectStorePoliciesMembersGetResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditObjectStorePoliciesMembersGetResponse:
        """Create an instance of AuditObjectStorePoliciesMembersGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditObjectStorePoliciesMembersGetResponse:
        """Create an instance of AuditObjectStorePoliciesMembersGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditObjectStorePoliciesMembersGetResponse.parse_obj(obj)
