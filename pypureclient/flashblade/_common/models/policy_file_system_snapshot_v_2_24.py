...
class PolicyFileSystemSnapshot(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyFileSystemSnapshot:
        """Create an instance of PolicyFileSystemSnapshot from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyFileSystemSnapshot:
        """Create an instance of PolicyFileSystemSnapshot from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyFileSystemSnapshot.parse_obj(obj)
