...
from pypureclient.flashblade._common.models.network_access_policy_v_2_16 import NetworkAccessPolicy


class NetworkAccessPolicyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(NetworkAccessPolicy)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkAccessPolicyGetResponse:
        """Create an instance of NetworkAccessPolicyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkAccessPolicyGetResponse:
        """Create an instance of NetworkAccessPolicyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkAccessPolicyGetResponse.parse_obj(obj)

        _obj = NetworkAccessPolicyGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [NetworkAccessPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
