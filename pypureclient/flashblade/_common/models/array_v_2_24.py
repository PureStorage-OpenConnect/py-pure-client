...
from pypureclient.flashblade._common.models.array_encryption_v_2_24 import ArrayEncryption
from pypureclient.flashblade._common.models.array_eradication_config_v_2_24 import ArrayEradicationConfig
...
class Array(BaseModel):
    ...
    __properties = ["id", "name", "context", "_as_of", "banner", "default_inbound_tls_policy", "encryption", "eradication_config", "idle_timeout", "network_access_policy", "ntp_servers", "os", "product_type", "revision", "security_update", "smb_mode", "time_zone", "version"]
