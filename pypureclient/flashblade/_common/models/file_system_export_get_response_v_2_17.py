...
from pypureclient.flashblade._common.models.file_system_export_v_2_17 import FileSystemExport


class FileSystemExportGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(FileSystemExport)] = Field(default=None, description="A list of file system export objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemExportGetResponse:
        """Create an instance of FileSystemExportGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemExportGetResponse:
        """Create an instance of FileSystemExportGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemExportGetResponse.parse_obj(obj)

        _obj = FileSystemExportGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [FileSystemExport.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
