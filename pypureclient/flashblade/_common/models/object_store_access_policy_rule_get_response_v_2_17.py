...
class ObjectStoreAccessPolicyRuleGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(PolicyRuleObjectAccess)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreAccessPolicyRuleGetResponse:
        """Create an instance of ObjectStoreAccessPolicyRuleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreAccessPolicyRuleGetResponse:
        """Create an instance of ObjectStoreAccessPolicyRuleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreAccessPolicyRuleGetResponse.parse_obj(obj)

        _obj = ObjectStoreAccessPolicyRuleGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyRuleObjectAccess.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
