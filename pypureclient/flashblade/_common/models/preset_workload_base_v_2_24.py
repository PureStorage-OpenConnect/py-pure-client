...
from pypureclient.flashblade._common.models.preset_workload_directory_configuration_v_2_24 import PresetWorkloadDirectoryConfiguration
from pypureclient.flashblade._common.models.preset_workload_export_configurations_v_2_24 import PresetWorkloadExportConfigurations
from pypureclient.flashblade._common.models.preset_workload_parameter_v_2_24 import PresetWorkloadParameter
from pypureclient.flashblade._common.models.preset_workload_periodic_replication_configuration_v_2_24 import PresetWorkloadPeriodicReplicationConfiguration
from pypureclient.flashblade._common.models.preset_workload_placement_configuration_v_2_24 import PresetWorkloadPlacementConfiguration
from pypureclient.flashblade._common.models.preset_workload_qos_configuration_v_2_24 import PresetWorkloadQosConfiguration
from pypureclient.flashblade._common.models.preset_workload_quota_configuration_v_2_24 import PresetWorkloadQuotaConfiguration
from pypureclient.flashblade._common.models.preset_workload_snapshot_configuration_v_2_24 import PresetWorkloadSnapshotConfiguration
from pypureclient.flashblade._common.models.preset_workload_volume_configuration_v_2_24 import PresetWorkloadVolumeConfiguration
from pypureclient.flashblade._common.models.preset_workload_workload_tag_v_2_24 import PresetWorkloadWorkloadTag
...
class PresetWorkloadBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PresetWorkloadBase:
        """Create an instance of PresetWorkloadBase from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PresetWorkloadBase:
        """Create an instance of PresetWorkloadBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PresetWorkloadBase.parse_obj(obj)

        _obj = PresetWorkloadBase.construct(_fields_set=None, **{
