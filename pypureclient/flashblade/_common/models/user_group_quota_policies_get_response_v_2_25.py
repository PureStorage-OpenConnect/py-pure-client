...
class UserGroupQuotaPoliciesGetResponse(BaseModel):
    """
    UserGroupQuotaPoliciesGetResponse
    """
    ...
    items: Optional[conlist(UserGroupQuotaPolicy)] = Field(default=None, description="A list of user-group-quota policies.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGroupQuotaPoliciesGetResponse:
        """Create an instance of UserGroupQuotaPoliciesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> UserGroupQuotaPoliciesGetResponse:
        """Create an instance of UserGroupQuotaPoliciesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGroupQuotaPoliciesGetResponse.parse_obj(obj)

        _obj = UserGroupQuotaPoliciesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [UserGroupQuotaPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
