...
from pypureclient.flashblade._common.models.array_erasure_v_2_18 import ArrayErasure


class ArrayErasureGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ArrayErasure)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayErasureGetResponse:
        """Create an instance of ArrayErasureGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayErasureGetResponse:
        """Create an instance of ArrayErasureGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayErasureGetResponse.parse_obj(obj)

        _obj = ArrayErasureGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [ArrayErasure.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
