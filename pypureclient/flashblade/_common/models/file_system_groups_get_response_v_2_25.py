...
from pypureclient.flashblade._common.models.file_system_group_v_2_25 import FileSystemGroup


class FileSystemGroupsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(FileSystemGroup)] = Field(default=None, description="A list of quota objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemGroupsGetResponse:
        """Create an instance of FileSystemGroupsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemGroupsGetResponse:
        """Create an instance of FileSystemGroupsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemGroupsGetResponse.parse_obj(obj)

        _obj = FileSystemGroupsGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [FileSystemGroup.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
