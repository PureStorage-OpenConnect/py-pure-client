...
class TestResult(BaseModel):
    ...
    __properties = ["component_address", "component_name", "description", "destination", "enabled", "resource", "result_details", "success", "test_type"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestResult:
        """Create an instance of TestResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResult.parse_obj(obj)

        _obj = TestResult.construct(_fields_set=None, **{
