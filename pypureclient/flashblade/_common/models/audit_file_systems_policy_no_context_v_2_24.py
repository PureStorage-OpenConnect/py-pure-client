...
from pypureclient.flashblade._common.models.audit_file_systems_policy_rule_in_policy_v_2_24 import AuditFileSystemsPolicyRuleInPolicy
...
class AuditFileSystemsPolicyNoContext(BaseModel):
    """
    ...
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "control_type", "log_targets", "rules"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditFileSystemsPolicyNoContext:
        """Create an instance of AuditFileSystemsPolicyNoContext from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditFileSystemsPolicyNoContext:
        """Create an instance of AuditFileSystemsPolicyNoContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditFileSystemsPolicyNoContext.parse_obj(obj)

        _obj = AuditFileSystemsPolicyNoContext.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
