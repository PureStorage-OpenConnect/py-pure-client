...
from pypureclient.flashblade._common.models.policy_base_v_2_15 import PolicyBase
...
class PolicyBaseGetResponse(BaseModel):
    ...
    items: Optional[conlist(PolicyBase)] = Field(default=None, description="A list of basic policy objects.")
    ...
    def from_dict(cls, obj: dict) -> PolicyBaseGetResponse:
        ...
        _obj = PolicyBaseGetResponse.construct(_fields_set=None, **{
            ...
            "items": [PolicyBase.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
