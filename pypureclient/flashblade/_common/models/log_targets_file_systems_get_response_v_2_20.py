...
from pypureclient.flashblade._common.models.log_targets_file_systems_v_2_20 import LogTargetsFileSystems


class LogTargetsFileSystemsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(LogTargetsFileSystems)] = Field(default=None, description="A list of log target objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogTargetsFileSystemsGetResponse:
        """Create an instance of LogTargetsFileSystemsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LogTargetsFileSystemsGetResponse:
        """Create an instance of LogTargetsFileSystemsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogTargetsFileSystemsGetResponse.parse_obj(obj)

        _obj = LogTargetsFileSystemsGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [LogTargetsFileSystems.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
