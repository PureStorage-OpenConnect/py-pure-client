...
from pypureclient.flashblade._common.models.server_v_2_16 import Server
...
class ServerGetResponse(BaseModel):
    ...
    items: Optional[conlist(Server)] = Field(default=None, description="A list of server objects.")
