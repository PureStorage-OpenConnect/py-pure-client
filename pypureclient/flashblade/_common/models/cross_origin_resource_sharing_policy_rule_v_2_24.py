...
class CrossOriginResourceSharingPolicyRule(BaseModel):
    """
    ...
    __properties = ["context", "name", "allowed_headers", "allowed_methods", "allowed_origins", "policy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CrossOriginResourceSharingPolicyRule:
        """Create an instance of CrossOriginResourceSharingPolicyRule from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CrossOriginResourceSharingPolicyRule:
        """Create an instance of CrossOriginResourceSharingPolicyRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CrossOriginResourceSharingPolicyRule.parse_obj(obj)

        _obj = CrossOriginResourceSharingPolicyRule.construct(_fields_set=None, **{
