...
class SmtpServerGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SmtpServer)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmtpServerGetResponse:
        """Create an instance of SmtpServerGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmtpServerGetResponse:
        """Create an instance of SmtpServerGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmtpServerGetResponse.parse_obj(obj)

        _obj = SmtpServerGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [SmtpServer.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
