...
class FileSystemSnapshotsApi:
    ...
    def api28_file_system_snapshots_delete_with_http_info(
        ...
        _param = self._api28_file_system_snapshots_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api28_file_system_snapshots_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.8/file-system-snapshots',
    ...
    def api28_file_system_snapshots_get_with_http_info(
        ...
        _param = self._api28_file_system_snapshots_get_serialize(
    ...
    def _api28_file_system_snapshots_get_serialize(
        self,
        continuation_token,
        destroyed,
        filter,
    ...
    def api28_file_system_snapshots_patch_with_http_info(
        ...
        _param = self._api28_file_system_snapshots_patch_serialize(
    ...
    def _api28_file_system_snapshots_patch_serialize(
        self,
    ...
    def api28_file_system_snapshots_policies_delete_with_http_info(
        ...
        _param = self._api28_file_system_snapshots_policies_delete_serialize(
    ...
    def _api28_file_system_snapshots_policies_delete_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.8/file-system-snapshots/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api28_file_system_snapshots_policies_get_with_http_info(
        ...
        _param = self._api28_file_system_snapshots_policies_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
            member_ids = member_ids,
    ...
    def _api28_file_system_snapshots_policies_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
    ...
    def api28_file_system_snapshots_post_with_http_info(
        ...
        _param = self._api28_file_system_snapshots_post_serialize(
    ...
    def _api28_file_system_snapshots_post_serialize(
        self,
        source_ids,
        source_names,
        send,
    ...
    def api28_file_system_snapshots_transfer_delete_with_http_info(
        ...
        _param = self._api28_file_system_snapshots_transfer_delete_serialize(
            ids = ids,
            names = names,
    ...
    def _api28_file_system_snapshots_transfer_delete_serialize(
        self,
        ids,
        names,
        remote_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.8/file-system-snapshots/transfer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api28_file_system_snapshots_transfer_get_with_http_info(
        ...
        _param = self._api28_file_system_snapshots_transfer_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api28_file_system_snapshots_transfer_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
