...
from pypureclient.flashblade.FB_2_8.models.drive_get_response import DriveGetResponse
...
class DrivesApi:
    ...
    def api28_drives_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_drives_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, total_only, async_req=True)
        >>> result = thread.get()
