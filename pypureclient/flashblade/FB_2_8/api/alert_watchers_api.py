...
class AlertWatchersApi(object):
    ...
    def api28_alert_watchers_delete_with_http_info(
        ...
        >>> thread = api.api28_alert_watchers_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api28_alert_watchers_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_alert_watchers_get`, must be a value greater than or equal to `1`")
    ...
    def api28_alert_watchers_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_alert_watchers_patch_with_http_info(alert_watcher, async_req=True)
        >>> result = thread.get()
