...
from pypureclient.flashblade.FB_2_8.models.alert_watcher_get_response import AlertWatcherGetResponse
from pypureclient.flashblade.FB_2_8.models.alert_watcher_post import AlertWatcherPost
from pypureclient.flashblade.FB_2_8.models.alert_watcher_response import AlertWatcherResponse
...
class AlertWatchersApi:
    ...
    def api28_alert_watchers_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_alert_watchers_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api28_alert_watchers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_alert_watchers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_alert_watchers_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_alert_watchers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_alert_watchers_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_alert_watchers_patch_with_http_info(alert_watcher, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_alert_watchers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_alert_watchers_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_alert_watchers_post_with_http_info(names, alert_watcher, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_alert_watchers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_alert_watchers_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_alert_watchers_test_get_with_http_info(filter, ids, names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_alert_watchers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
