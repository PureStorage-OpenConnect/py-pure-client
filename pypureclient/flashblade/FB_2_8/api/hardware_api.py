...
class HardwareApi:
    ...
    def api28_hardware_get_with_http_info(
        ...
        _param = self._api28_hardware_get_serialize(
            ids = ids,
            names = names,
    ...
    def _api28_hardware_get_serialize(
        self,
        ids,
        names,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.8/hardware',
    ...
    def api28_hardware_patch_with_http_info(
        ...
        _param = self._api28_hardware_patch_serialize(
            hardware = hardware,
            ids = ids,
            names = names,
        )
    ...
    def _api28_hardware_patch_serialize(
        self,
        hardware,
        ids,
        names,
