...
from pypureclient.flashblade.FB_2_8.models.hardware_get_response import HardwareGetResponse
from pypureclient.flashblade.FB_2_8.models.hardware_response import HardwareResponse
...
class HardwareApi:
    ...
    def api28_hardware_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_hardware_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api28_hardware_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_hardware_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_hardware_patch_with_http_info(hardware, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_hardware_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
