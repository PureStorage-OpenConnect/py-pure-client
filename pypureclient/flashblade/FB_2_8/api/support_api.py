...
from pypureclient.flashblade.FB_2_8.models.support_get_response import SupportGetResponse
from pypureclient.flashblade.FB_2_8.models.support_response import SupportResponse
...
class SupportApi:
    ...
    def api28_support_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_support_get_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api28_support_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_support_test_get_with_http_info(filter, sort, test_type, async_req=True)
        >>> result = thread.get()
