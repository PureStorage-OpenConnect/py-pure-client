...
from pypureclient.flashblade.FB_2_8.models.group_quota_get_response import GroupQuotaGetResponse
from pypureclient.flashblade.FB_2_8.models.user_quota_get_response import UserQuotaGetResponse
...
class UsageApi:
    ...
    def api28_usage_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_usage_groups_get_with_http_info(continuation_token, file_system_ids, file_system_names, filter, gids, group_names, limit, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api28_usage_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_usage_users_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_usage_users_get_with_http_info(continuation_token, file_system_ids, file_system_names, filter, limit, offset, sort, uids, user_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_usage_users_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
