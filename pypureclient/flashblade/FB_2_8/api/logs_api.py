...
from pypureclient.flashblade.FB_2_8.models.logs_async_get_response import LogsAsyncGetResponse
from pypureclient.flashblade.FB_2_8.models.logs_async_response import LogsAsyncResponse
...
class LogsApi:
    ...
    def api28_logs_async_download_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_logs_async_download_get_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api28_logs_async_download_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_logs_async_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_logs_async_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_logs_async_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_logs_async_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_logs_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_logs_get_with_http_info(end_time, start_time, async_req=True)
        >>> result = thread.get()
