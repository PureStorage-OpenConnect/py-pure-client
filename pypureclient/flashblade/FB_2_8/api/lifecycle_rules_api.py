...
class LifecycleRulesApi(object):
    ...
    def api28_lifecycle_rules_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_lifecycle_rules_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api28_lifecycle_rules_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api28_lifecycle_rules_patch_with_http_info(
        ...
        if lifecycle is None:
            raise TypeError("Missing the required parameter `lifecycle` when calling `api28_lifecycle_rules_patch`")
    ...
    def api28_lifecycle_rules_post_with_http_info(
        ...
        if rule is None:
            raise TypeError("Missing the required parameter `rule` when calling `api28_lifecycle_rules_post`")
