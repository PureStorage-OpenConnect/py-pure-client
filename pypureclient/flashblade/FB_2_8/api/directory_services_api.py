...
class DirectoryServicesApi(object):
    ...
    def api28_directory_services_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_directory_services_get`, must be a value greater than or equal to `1`")
    ...
    def api28_directory_services_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_directory_services_patch_with_http_info(directory_service, async_req=True)
        >>> result = thread.get()
    ...
    def api28_directory_services_roles_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_directory_services_roles_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api28_directory_services_roles_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_directory_services_roles_patch_with_http_info(directory_service_roles, async_req=True)
        >>> result = thread.get()
    ...
    def api28_directory_services_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_directory_services_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_directory_services_test_get`, must be a value greater than or equal to `1`")
        collection_formats = {}
        path_params = {}
    ...
    def api28_directory_services_test_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_directory_services_test_patch_with_http_info(async_req=True)
        >>> result = thread.get()
