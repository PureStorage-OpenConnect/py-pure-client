...
class ObjectStoreUsersApi:
    ...
    def api28_object_store_users_delete_with_http_info(
        ...
        _param = self._api28_object_store_users_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api28_object_store_users_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.8/object-store-users',
    ...
    def api28_object_store_users_get_with_http_info(
        ...
        _param = self._api28_object_store_users_get_serialize(
    ...
    def _api28_object_store_users_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api28_object_store_users_object_store_access_policies_delete_with_http_info(
        ...
        _param = self._api28_object_store_users_object_store_access_policies_delete_serialize(
    ...
    def _api28_object_store_users_object_store_access_policies_delete_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.8/object-store-users/object-store-access-policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api28_object_store_users_object_store_access_policies_get_with_http_info(
        ...
        _param = self._api28_object_store_users_object_store_access_policies_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
            member_ids = member_ids,
    ...
    def _api28_object_store_users_object_store_access_policies_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
    ...
    def api28_object_store_users_object_store_access_policies_post_with_http_info(
        ...
        _param = self._api28_object_store_users_object_store_access_policies_post_serialize(
            member_ids = member_ids,
            member_names = member_names,
            policy_ids = policy_ids,
            policy_names = policy_names,
    ...
    def _api28_object_store_users_object_store_access_policies_post_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
    ...
    def api28_object_store_users_post_with_http_info(
        ...
        _param = self._api28_object_store_users_post_serialize(
            names = names,
    ...
    def _api28_object_store_users_post_serialize(
        self,
        names,
        full_access,
    ) -> RequestSerialized:
