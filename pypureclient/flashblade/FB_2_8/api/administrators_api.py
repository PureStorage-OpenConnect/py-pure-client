...
class AdministratorsApi(object):
    ...
    def api28_admins_api_tokens_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_admins_api_tokens_get`, must be a value greater than or equal to `1`")
    ...
    def api28_admins_cache_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_admins_cache_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api28_admins_cache_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_admins_cache_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api28_admins_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_admins_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api28_admins_settings_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_admins_settings_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api28_admins_settings_patch_with_http_info(
        ...
        if admin_setting is None:
            raise TypeError("Missing the required parameter `admin_setting` when calling `api28_admins_settings_patch`")
