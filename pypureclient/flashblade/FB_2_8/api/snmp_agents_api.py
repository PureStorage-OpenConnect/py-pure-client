...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_8.models.snmp_agent import SnmpAgent
from pypureclient.flashblade.FB_2_8.models.snmp_agent_get_response import SnmpAgentGetResponse
from pypureclient.flashblade.FB_2_8.models.snmp_agent_mib_response import SnmpAgentMibResponse
from pypureclient.flashblade.FB_2_8.models.snmp_agent_response import SnmpAgentResponse
...
class SNMPAgentsApi:
    ...
    def api28_snmp_agents_get_with_http_info(
        ...
        _param = self._api28_snmp_agents_get_serialize(
    ...
    def _api28_snmp_agents_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.8/snmp-agents',
    ...
    def api28_snmp_agents_mib_get_with_http_info(
        ...
        _param = self._api28_snmp_agents_mib_get_serialize(
        )
    ...
    def _api28_snmp_agents_mib_get_serialize(
        self,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.8/snmp-agents/mib',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api28_snmp_agents_patch_with_http_info(
        ...
        _param = self._api28_snmp_agents_patch_serialize(
    ...
    def _api28_snmp_agents_patch_serialize(
        self,
        snmp_agent,
    ) -> RequestSerialized:
