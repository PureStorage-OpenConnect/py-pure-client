...
from pypureclient.flashblade.FB_2_8.models.syslog_server_get_response import SyslogServerGetResponse
from pypureclient.flashblade.FB_2_8.models.syslog_server_post_or_patch import SyslogServerPostOrPatch
from pypureclient.flashblade.FB_2_8.models.syslog_server_response import SyslogServerResponse
from pypureclient.flashblade.FB_2_8.models.syslog_server_settings import SyslogServerSettings
from pypureclient.flashblade.FB_2_8.models.syslog_server_settings_get_response import SyslogServerSettingsGetResponse
from pypureclient.flashblade.FB_2_8.models.syslog_server_settings_response import SyslogServerSettingsResponse
from pypureclient.flashblade.FB_2_8.models.test_result_get_response import TestResultGetResponse
...
class SyslogApi:
    ...
    def api28_syslog_servers_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_syslog_servers_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api28_syslog_servers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_syslog_servers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_syslog_servers_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_syslog_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_syslog_servers_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_syslog_servers_patch_with_http_info(syslog_server, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_syslog_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_syslog_servers_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_syslog_servers_post_with_http_info(syslog_server, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_syslog_servers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_syslog_servers_settings_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_syslog_servers_settings_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_syslog_servers_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_syslog_servers_settings_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_syslog_servers_settings_patch_with_http_info(syslog_server_settings, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_syslog_servers_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_syslog_servers_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_syslog_servers_test_get_with_http_info(continuation_token, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_syslog_servers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
