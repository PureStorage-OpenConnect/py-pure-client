...
class FileSystemReplicaLinksApi(object):
    ...
    def api28_file_system_replica_links_get_with_http_info(
        ...
        >>> thread = api.api28_file_system_replica_links_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_file_system_replica_links_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api28_file_system_replica_links_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api28_file_system_replica_links_policies_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_file_system_replica_links_policies_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api28_file_system_replica_links_policies_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_file_system_replica_links_policies_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_file_system_replica_links_policies_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api28_file_system_replica_links_policies_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api28_file_system_replica_links_policies_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_file_system_replica_links_policies_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api28_file_system_replica_links_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_file_system_replica_links_post_with_http_info(file_system_replica_link, async_req=True)
        >>> result = thread.get()
        ...
        if file_system_replica_link is None:
            raise TypeError("Missing the required parameter `file_system_replica_link` when calling `api28_file_system_replica_links_post`")
    ...
    def api28_file_system_replica_links_transfer_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_file_system_replica_links_transfer_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_file_system_replica_links_transfer_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api28_file_system_replica_links_transfer_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
