...
from pypureclient.flashblade.FB_2_8.models.nfs_export_policy import NfsExportPolicy
from pypureclient.flashblade.FB_2_8.models.nfs_export_policy_get_response import NfsExportPolicyGetResponse
from pypureclient.flashblade.FB_2_8.models.nfs_export_policy_post import NfsExportPolicyPost
from pypureclient.flashblade.FB_2_8.models.nfs_export_policy_response import NfsExportPolicyResponse
from pypureclient.flashblade.FB_2_8.models.nfs_export_policy_rule import NfsExportPolicyRule
from pypureclient.flashblade.FB_2_8.models.nfs_export_policy_rule_get_response import NfsExportPolicyRuleGetResponse
from pypureclient.flashblade.FB_2_8.models.nfs_export_policy_rule_response import NfsExportPolicyRuleResponse
...
class PoliciesNFSApi:
    ...
    def api28_nfs_export_policies_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_nfs_export_policies_delete_with_http_info(ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api28_nfs_export_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_nfs_export_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_nfs_export_policies_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_nfs_export_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_nfs_export_policies_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_nfs_export_policies_patch_with_http_info(policy, ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_nfs_export_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_nfs_export_policies_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_nfs_export_policies_post_with_http_info(names, policy, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_nfs_export_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_nfs_export_policies_rules_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_nfs_export_policies_rules_delete_with_http_info(ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_nfs_export_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_nfs_export_policies_rules_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_nfs_export_policies_rules_get_with_http_info(continuation_token, filter, ids, limit, names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_nfs_export_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_nfs_export_policies_rules_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_nfs_export_policies_rules_patch_with_http_info(rule, before_rule_id, before_rule_name, ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_nfs_export_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api28_nfs_export_policies_rules_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api28_nfs_export_policies_rules_post_with_http_info(rule, before_rule_id, before_rule_name, policy_ids, policy_names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api28_nfs_export_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
