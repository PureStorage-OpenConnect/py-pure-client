...
from pypureclient.flashblade.FB_2_8.models.client_performance_get_response import ClientPerformanceGetResponse
...
class ClientsApi:
    ...
    def api28_arrays_clients_performance_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api28_arrays_clients_performance_get_with_http_info(filter, limit, names, sort, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api28_arrays_clients_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.8/arrays/clients/performance', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
