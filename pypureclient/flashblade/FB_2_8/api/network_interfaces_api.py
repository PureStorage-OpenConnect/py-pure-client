...
class NetworkInterfacesApi(object):
    ...
    def api28_network_interfaces_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_network_interfaces_get`, must be a value greater than or equal to `1`")
    ...
    def api28_network_interfaces_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_network_interfaces_patch_with_http_info(network_interface, async_req=True)
        >>> result = thread.get()
        ...
        if network_interface is None:
            raise TypeError("Missing the required parameter `network_interface` when calling `api28_network_interfaces_patch`")
    ...
    def api28_network_interfaces_ping_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_network_interfaces_ping_get_with_http_info(destination, async_req=True)
        >>> result = thread.get()
        ...
        if destination is None:
            raise TypeError("Missing the required parameter `destination` when calling `api28_network_interfaces_ping_get`")
    ...
    def api28_network_interfaces_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_network_interfaces_post_with_http_info(network_interface, names, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'network_interface' is set
        if network_interface is None:
            raise TypeError("Missing the required parameter `network_interface` when calling `api28_network_interfaces_post`")
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api28_network_interfaces_post`")
    ...
    def api28_network_interfaces_trace_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_network_interfaces_trace_get_with_http_info(destination, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'destination' is set
        if destination is None:
            raise TypeError("Missing the required parameter `destination` when calling `api28_network_interfaces_trace_get`")
