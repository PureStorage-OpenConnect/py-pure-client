...
class BucketReplicaLinkPost(BaseModel):
    """
    ...
    paused: Optional[StrictBool] = Field(default=None, description="Create link in the paused state? Defaults to `false`.")
    __properties = ["cascading_enabled", "paused"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BucketReplicaLinkPost:
        """Create an instance of BucketReplicaLinkPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> BucketReplicaLinkPost:
        """Create an instance of BucketReplicaLinkPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BucketReplicaLinkPost.parse_obj(obj)

        _obj = BucketReplicaLinkPost.construct(_fields_set=None, **{
