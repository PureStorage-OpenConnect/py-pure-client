...
from pypureclient.flashblade.FB_2_8.models.nfs_export_policy_rule_in_policy import NfsExportPolicyRuleInPolicy
...
class NfsExportPolicy(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "rules", "version"]
