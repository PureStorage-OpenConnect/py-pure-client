...
class Http(BaseModel):
    ...
    Http
    """
    enabled: Optional[StrictBool] = Field(default=None, description="Is the protocol enabled? If not specified, defaults to `false`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Http:
    ...
    def from_dict(cls, obj: dict) -> Http:
        ...
        if not isinstance(obj, dict):
            return Http.parse_obj(obj)

        _obj = Http.construct(_fields_set=None, **{
