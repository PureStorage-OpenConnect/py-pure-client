...
class BladeGetResponse(object):
    ...
    def __init__(
        ...
        total=None,  # type: object
        items=None,  # type: List[models.Blade]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `BladeGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(BladeGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BladeGetResponse):
            return False
