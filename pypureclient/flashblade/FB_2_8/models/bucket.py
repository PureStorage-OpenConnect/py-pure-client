...
class Bucket(BaseModel):
    ...
    __properties = ["id", "name", "account", "bucket_type", "created", "destroyed", "eradication_config", "hard_limit_enabled", "object_count", "object_lock_config", "quota_limit", "retention_lock", "space", "time_remaining", "versioning"]
    ...
    def from_dict(cls, obj: dict) -> Bucket:
        ...
        _obj = Bucket.construct(_fields_set=None, **{
            ...
            "space": SpaceExtended.from_dict(obj.get("space")) if obj.get("space") is not None else None,
