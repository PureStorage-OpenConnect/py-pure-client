...
class ArrayS3SpecificPerformanceGetResp(BaseModel):
    ...
    items: Optional[List[ArrayS3SpecificPerformance]] = Field(default=None, description="A list of S3 specific array performance metrics objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [ArrayS3SpecificPerformance.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
