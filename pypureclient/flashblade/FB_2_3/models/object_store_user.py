...
class ObjectStoreUser(BaseModel):
    ...
    access_keys: Optional[List[FixedReference]] = Field(default=None, description="References of the user's access keys.")
    created: Optional[StrictInt] = Field(default=None, description="Creation timestamp of the object.")
    __properties: ClassVar[List[str]] = ["name", "id", "account", "access_keys", "created"]
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded, if `include_readonly` is `False`.
        ...
        if self.access_keys and (include_readonly or "access_keys" not in excluded_fields):
            _items = []
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "access_keys": [FixedReference.from_dict(_item) for _item in obj["access_keys"]] if obj.get("access_keys") is not None else None,
