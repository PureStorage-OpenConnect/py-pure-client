...
from pypureclient.flashblade.FB_2_3.models.client_performance_get_response import ClientPerformanceGetResponse
...
class ClientsApi:
    ...
    def api23_arrays_clients_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_arrays_clients_performance_get_with_http_info(filter, limit, names, sort, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api23_arrays_clients_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
