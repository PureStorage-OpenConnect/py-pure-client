...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_3.models.api23_link_aggregation_groups_patch_request import Api23LinkAggregationGroupsPatchRequest
from pypureclient.flashblade.FB_2_3.models.link_aggregation_group import LinkAggregationGroup
from pypureclient.flashblade.FB_2_3.models.link_aggregation_group_get_response import LinkAggregationGroupGetResponse
from pypureclient.flashblade.FB_2_3.models.link_aggregation_group_response import LinkAggregationGroupResponse
...
class LinkAggregationGroupsApi:
    ...
    def api23_link_aggregation_groups_delete_with_http_info(
        ...
        _param = self._api23_link_aggregation_groups_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api23_link_aggregation_groups_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.3/link-aggregation-groups',
    ...
    def api23_link_aggregation_groups_get_with_http_info(
        ...
        _param = self._api23_link_aggregation_groups_get_serialize(
    ...
    def _api23_link_aggregation_groups_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api23_link_aggregation_groups_patch_with_http_info(
        self,
        link_aggregation_group: Api23LinkAggregationGroupsPatchRequest,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
        ...
        :type link_aggregation_group: Api23LinkAggregationGroupsPatchRequest
        :param ids: A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.
        :type ids: List[str]
        :param names: A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.
        :type names: List[str]
        ...
        _param = self._api23_link_aggregation_groups_patch_serialize(
    ...
    def _api23_link_aggregation_groups_patch_serialize(
        self,
    ...
    def api23_link_aggregation_groups_post_with_http_info(
        ...
        _param = self._api23_link_aggregation_groups_post_serialize(
            names = names,
            link_aggregation_group = link_aggregation_group,
        )
    ...
    def _api23_link_aggregation_groups_post_serialize(
        self,
        names,
        link_aggregation_group,
    ) -> RequestSerialized:
