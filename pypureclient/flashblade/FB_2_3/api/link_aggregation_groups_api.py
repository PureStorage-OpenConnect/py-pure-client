...
class LinkAggregationGroupsApi:
    ...
    def api23_link_aggregation_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_link_aggregation_groups_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api23_link_aggregation_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_link_aggregation_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_link_aggregation_groups_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_link_aggregation_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_link_aggregation_groups_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_link_aggregation_groups_patch_with_http_info(link_aggregation_group, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_link_aggregation_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_link_aggregation_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_link_aggregation_groups_post_with_http_info(names, link_aggregation_group, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_link_aggregation_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
