...
class APIClientsApi(object):
    ...
    def api23_api_clients_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api23_api_clients_get`, must be a value greater than or equal to `1`")
    ...
    def api23_api_clients_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api23_api_clients_post_with_http_info(api_client, async_req=True)
        >>> result = thread.get()
        ...
        if api_client is None:
            raise TypeError("Missing the required parameter `api_client` when calling `api23_api_clients_post`")
