...
class APIClientsApi:
    ...
    def api23_api_clients_delete_with_http_info(
        ...
        _param = self._api23_api_clients_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api23_api_clients_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.3/api-clients',
    ...
    def api23_api_clients_get_with_http_info(
        ...
        _param = self._api23_api_clients_get_serialize(
    ...
    def _api23_api_clients_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api23_api_clients_patch_with_http_info(
        ...
        _param = self._api23_api_clients_patch_serialize(
    ...
    def _api23_api_clients_patch_serialize(
        self,
        api_clients,
        ids,
        names,
    ...
    def api23_api_clients_post_with_http_info(
        ...
        _param = self._api23_api_clients_post_serialize(
    ...
    def _api23_api_clients_post_serialize(
        self,
        api_client,
        names,
    ) -> RequestSerialized:
