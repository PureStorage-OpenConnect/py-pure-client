...
class AlertWatchersApi:
    ...
    def api23_alert_watchers_delete_with_http_info(
        ...
        _param = self._api23_alert_watchers_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api23_alert_watchers_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.3/alert-watchers',
    ...
    def api23_alert_watchers_get_with_http_info(
        ...
        _param = self._api23_alert_watchers_get_serialize(
    ...
    def _api23_alert_watchers_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api23_alert_watchers_patch_with_http_info(
        ...
        _param = self._api23_alert_watchers_patch_serialize(
    ...
    def _api23_alert_watchers_patch_serialize(
        self,
        alert_watcher,
        ids,
        names,
    ...
    def api23_alert_watchers_post_with_http_info(
        ...
        _param = self._api23_alert_watchers_post_serialize(
            names = names,
            alert_watcher = alert_watcher,
        )
    ...
    def _api23_alert_watchers_post_serialize(
        self,
        names,
        alert_watcher,
    ) -> RequestSerialized:
    ...
    def api23_alert_watchers_test_get_with_http_info(
        ...
        _param = self._api23_alert_watchers_test_get_serialize(
            filter = filter,
            ids = ids,
            names = names,
            sort = sort,
    ...
    def _api23_alert_watchers_test_get_serialize(
        self,
        filter,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.3/alert-watchers/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
