...
class HardwareApi:
    ...
    def api23_hardware_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_hardware_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api23_hardware_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_hardware_patch_with_http_info(hardware, ids, names, async_req=True)
        >>> result = thread.get()
