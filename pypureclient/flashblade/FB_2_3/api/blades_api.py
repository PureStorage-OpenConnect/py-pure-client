...
class BladesApi:
    ...
    def api23_blades_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_blades_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api23_blades_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
