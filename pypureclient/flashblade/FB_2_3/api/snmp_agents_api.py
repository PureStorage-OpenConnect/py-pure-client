...
from pypureclient.flashblade.FB_2_3.models.snmp_agent_get_response import SnmpAgentGetResponse
from pypureclient.flashblade.FB_2_3.models.snmp_agent_mib_response import SnmpAgentMibResponse
from pypureclient.flashblade.FB_2_3.models.snmp_agent_response import SnmpAgentResponse
...
class SNMPAgentsApi:
    ...
    @validate_call
    def api23_snmp_agents_get_with_http_info(
        self,
        ...
        _param = self._api23_snmp_agents_get_serialize(
    ...
    def _api23_snmp_agents_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.3/snmp-agents',
    ...
    @validate_call
    def api23_snmp_agents_mib_get_with_http_info(
        self,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
        ...
        _param = self._api23_snmp_agents_mib_get_serialize(
        )
    ...
    def _api23_snmp_agents_mib_get_serialize(
        self,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.3/snmp-agents/mib',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api23_snmp_agents_patch_with_http_info(
        self,
        ...
        _param = self._api23_snmp_agents_patch_serialize(
    ...
    def _api23_snmp_agents_patch_serialize(
        self,
        snmp_agent,
    ) -> RequestSerialized:
