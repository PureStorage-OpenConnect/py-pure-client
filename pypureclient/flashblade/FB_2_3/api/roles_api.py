...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_3.models.role_get_response import RoleGetResponse
...
class RolesApi:
    ...
    @validate_call
    def api23_roles_get_with_http_info(
        self,
        ...
        _param = self._api23_roles_get_serialize(
    ...
    def _api23_roles_get_serialize(
        self,
        continuation_token,
        ids,
        filter,
