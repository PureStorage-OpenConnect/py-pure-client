...
from pypureclient.flashblade.FB_2_3.models.syslog_server_get_response import SyslogServerGetResponse
from pypureclient.flashblade.FB_2_3.models.syslog_server_post_or_patch import SyslogServerPostOrPatch
from pypureclient.flashblade.FB_2_3.models.syslog_server_response import SyslogServerResponse
from pypureclient.flashblade.FB_2_3.models.syslog_server_settings import SyslogServerSettings
from pypureclient.flashblade.FB_2_3.models.syslog_server_settings_get_response import SyslogServerSettingsGetResponse
from pypureclient.flashblade.FB_2_3.models.syslog_server_settings_response import SyslogServerSettingsResponse
...
class SyslogApi:
    ...
    def api23_syslog_servers_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api23_syslog_servers_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api23_syslog_servers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_syslog_servers_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api23_syslog_servers_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_syslog_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_syslog_servers_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api23_syslog_servers_patch_with_http_info(syslog_server, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_syslog_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_syslog_servers_post_with_http_info(
        self,
        syslog_server: SyslogServerPostOrPatch,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique name specified. Enter multiple names in comma-separated format. For example, `name01,name02`.")] = None,
        **kwargs
        ...
        >>> thread = api.api23_syslog_servers_post_with_http_info(syslog_server, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_syslog_servers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_syslog_servers_settings_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api23_syslog_servers_settings_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_syslog_servers_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.3/syslog-servers/settings', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api23_syslog_servers_settings_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api23_syslog_servers_settings_patch_with_http_info(syslog_server_settings, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_syslog_servers_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.3/syslog-servers/settings', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api23_syslog_servers_test_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.api23_syslog_servers_test_get_with_http_info(continuation_token, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_syslog_servers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.3/syslog-servers/test', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
