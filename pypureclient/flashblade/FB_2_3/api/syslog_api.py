...
class SyslogApi(object):
    ...
    def api23_syslog_servers_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api23_syslog_servers_get`, must be a value greater than or equal to `0`")
    ...
    def api23_syslog_servers_settings_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api23_syslog_servers_settings_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
