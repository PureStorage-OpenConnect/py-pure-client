...
from pypureclient.flashblade.FB_2_3.models.file_system_get_response import FileSystemGetResponse
from pypureclient.flashblade.FB_2_3.models.file_system_groups_performance_get_response import FileSystemGroupsPerformanceGetResponse
from pypureclient.flashblade.FB_2_3.models.file_system_patch import FileSystemPatch
from pypureclient.flashblade.FB_2_3.models.file_system_performance_get_response import FileSystemPerformanceGetResponse
from pypureclient.flashblade.FB_2_3.models.file_system_post import FileSystemPost
from pypureclient.flashblade.FB_2_3.models.file_system_response import FileSystemResponse
from pypureclient.flashblade.FB_2_3.models.file_system_users_performance_get_response import FileSystemUsersPerformanceGetResponse
...
class FileSystemsApi:
    ...
    def api23_file_systems_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_file_systems_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api23_file_systems_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_file_systems_get_with_http_info(continuation_token, destroyed, filter, ids, limit, names, offset, sort, total_only, async_req=True)
        >>> result = thread.get()
    ...
    def api23_file_systems_groups_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_file_systems_groups_performance_get_with_http_info(file_system_ids, file_system_names, filter, gids, group_names, limit, names, sort, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_file_systems_groups_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_file_systems_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_file_systems_patch_with_http_info(file_system, delete_link_on_eradication, discard_detailed_permissions, discard_non_snapshotted_data, ids, ignore_usage, names, async_req=True)
        >>> result = thread.get()
    ...
    def api23_file_systems_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_file_systems_performance_get_with_http_info(continuation_token, end_time, filter, ids, limit, names, offset, protocol, resolution, sort, start_time, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_file_systems_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_file_systems_policies_all_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_file_systems_policies_all_get_with_http_info(continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_file_systems_policies_all_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_file_systems_policies_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_file_systems_policies_delete_with_http_info(member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_file_systems_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_file_systems_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_file_systems_policies_get_with_http_info(continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_file_systems_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_file_systems_policies_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_file_systems_policies_post_with_http_info(member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_file_systems_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api23_file_systems_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_file_systems_post_with_http_info(names, file_system, discard_non_snapshotted_data, overwrite, async_req=True)
        >>> result = thread.get()
    ...
    def api23_file_systems_users_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_file_systems_users_performance_get_with_http_info(file_system_ids, file_system_names, filter, limit, names, sort, total_only, uids, user_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_file_systems_users_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
