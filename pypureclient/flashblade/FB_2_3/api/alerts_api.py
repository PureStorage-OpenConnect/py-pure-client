...
class AlertsApi:
    ...
    def api23_alerts_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_alerts_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api23_alerts_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_alerts_patch_with_http_info(alerts_settings, ids, names, async_req=True)
        >>> result = thread.get()
