...
class HardwareConnectorsApi:
    ...
    def api23_hardware_connectors_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_hardware_connectors_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api23_hardware_connectors_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_hardware_connectors_patch_with_http_info(hardware_connector, ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api23_hardware_connectors_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api23_hardware_connectors_performance_get_with_http_info(end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_only, async_req=True)
        >>> result = thread.get()
