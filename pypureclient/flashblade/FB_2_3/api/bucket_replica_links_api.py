...
from pypureclient.flashblade.FB_2_3.models.bucket_replica_link import BucketReplicaLink
from pypureclient.flashblade.FB_2_3.models.bucket_replica_link_get_response import BucketReplicaLinkGetResponse
from pypureclient.flashblade.FB_2_3.models.bucket_replica_link_post import BucketReplicaLinkPost
from pypureclient.flashblade.FB_2_3.models.bucket_replica_link_response import BucketReplicaLinkResponse
...
class BucketReplicaLinksApi:
    ...
    def api23_bucket_replica_links_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api23_bucket_replica_links_delete_with_http_info(ids, local_bucket_ids, local_bucket_names, remote_bucket_names, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api23_bucket_replica_links_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.3/bucket-replica-links', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api23_bucket_replica_links_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api23_bucket_replica_links_get_with_http_info(continuation_token, filter, ids, limit, local_bucket_ids, local_bucket_names, offset, remote_bucket_names, remote_ids, remote_names, sort, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_bucket_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.3/bucket-replica-links', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api23_bucket_replica_links_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api23_bucket_replica_links_patch_with_http_info(bucket_replica_link, ids, local_bucket_ids, local_bucket_names, remote_bucket_names, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_bucket_replica_links_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.3/bucket-replica-links', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api23_bucket_replica_links_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api23_bucket_replica_links_post_with_http_info(bucket_replica_link, local_bucket_ids, local_bucket_names, remote_bucket_names, remote_credentials_ids, remote_credentials_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api23_bucket_replica_links_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.3/bucket-replica-links', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
