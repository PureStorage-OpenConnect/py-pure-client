...
from pypureclient.flashblade.FB_2_24.models.preset_workload_get_response import PresetWorkloadGetResponse
from pypureclient.flashblade.FB_2_24.models.preset_workload_patch import PresetWorkloadPatch
from pypureclient.flashblade.FB_2_24.models.preset_workload_post import PresetWorkloadPost
from pypureclient.flashblade.FB_2_24.models.preset_workload_response import PresetWorkloadResponse
from typing import Optional
...
class PresetsApi:
    ...
    def api224_presets_workload_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api224_presets_workload_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.24/presets/workload', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api224_presets_workload_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_presets_workload_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api224_presets_workload_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_presets_workload_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.24/presets/workload', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api224_presets_workload_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_presets_workload_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.24/presets/workload', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api224_presets_workload_put_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_presets_workload_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
