...
from pypureclient.flashblade.FB_2_24.models.remote_arrays_response import RemoteArraysResponse
from typing import Optional
...
class RemoteArraysApi:
    ...
    def api224_remote_arrays_get_with_http_info(
        self,
