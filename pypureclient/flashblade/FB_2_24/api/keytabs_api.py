...
from pypureclient.flashblade.FB_2_24.models.keytab_get_response import KeytabGetResponse
from pypureclient.flashblade.FB_2_24.models.keytab_post import KeytabPost
from pypureclient.flashblade.FB_2_24.models.keytab_response import KeytabResponse
...
class KeytabsApi:
    ...
    def api224_keytabs_delete_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api224_keytabs_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api224_keytabs_download_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_keytabs_download_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api224_keytabs_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_keytabs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api224_keytabs_post_with_http_info(
        self,
        keytab: KeytabPost,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_keytabs_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api224_keytabs_upload_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_keytabs_upload_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
