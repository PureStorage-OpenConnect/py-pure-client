...
from pypureclient.flashblade.FB_2_24.models.log_targets_object_store import LogTargetsObjectStore
from pypureclient.flashblade.FB_2_24.models.log_targets_object_store_get_response import LogTargetsObjectStoreGetResponse
from pypureclient.flashblade.FB_2_24.models.log_targets_object_store_post import LogTargetsObjectStorePost
from pypureclient.flashblade.FB_2_24.models.log_targets_object_store_response import LogTargetsObjectStoreResponse
from typing import Optional
...
class AuditLogTargetForObjectStoreApi:
    ...
    def api224_log_targets_object_store_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api224_log_targets_object_store_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.24/log-targets/object-store', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api224_log_targets_object_store_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_log_targets_object_store_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.24/log-targets/object-store', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api224_log_targets_object_store_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_log_targets_object_store_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.24/log-targets/object-store', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api224_log_targets_object_store_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_log_targets_object_store_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.24/log-targets/object-store', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
