...
from pypureclient.flashblade.FB_2_24.models.logs_async import LogsAsync
from pypureclient.flashblade.FB_2_24.models.logs_async_get_response import LogsAsyncGetResponse
from pypureclient.flashblade.FB_2_24.models.logs_async_response import LogsAsyncResponse
...
class LogsApi:
    ...
    def api224_logs_async_download_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api224_logs_async_download_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.24/logs-async/download', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api224_logs_async_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_logs_async_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api224_logs_async_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_logs_async_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api224_logs_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_logs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
