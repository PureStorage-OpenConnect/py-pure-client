...
from pypureclient.flashblade.FB_2_24.models.network_access_policy_rule_in_policy import NetworkAccessPolicyRuleInPolicy
...
class NetworkAccessPolicy(BaseModel):
    ...
    rules: Optional[conlist(NetworkAccessPolicyRuleInPolicy, max_items=200)] = Field(default=None, description="All of the rules that are part of this policy. The order is the evaluation order. If a client does not match any rule in the policy for the interface that they are attempting to access, the default is to deny access.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkAccessPolicy:
        """Create an instance of NetworkAccessPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkAccessPolicy:
        """Create an instance of NetworkAccessPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkAccessPolicy.parse_obj(obj)

        _obj = NetworkAccessPolicy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "rules": [NetworkAccessPolicyRuleInPolicy.from_dict(_item) for _item in obj.get("rules")] if obj.get("rules") is not None else None
        })
        return _obj
