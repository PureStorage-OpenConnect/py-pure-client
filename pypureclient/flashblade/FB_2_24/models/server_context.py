...
class ServerContext(BaseModel):
    ...
    local_directory_service: Optional[Reference] = Field(default=None, description="The Local Directory Service to be associated to the server.")
    ...
    __properties = ["id", "name", "dns", "local_directory_service", "created", "directory_services", "realms", "context"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerContext:
        """Create an instance of ServerContext from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ServerContext:
        """Create an instance of ServerContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerContext.parse_obj(obj)

        _obj = ServerContext.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "dns": [Reference.from_dict(_item) for _item in obj.get("dns")] if obj.get("dns") is not None else None,
            "local_directory_service": Reference.from_dict(obj.get("local_directory_service")) if obj.get("local_directory_service") is not None else None,
