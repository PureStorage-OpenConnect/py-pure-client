...
class WormDataPolicy(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="A user-specified name. The name must be locally unique and cannot be modified.")
    ...
    policy_type: Optional[StrictStr] = Field(default=None, description="Type of the policy. Valid values include `snapshot` and `worm-data`.")
    ...
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "default_retention", "max_retention", "min_retention", "mode", "retention_lock", "context"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WormDataPolicy:
        """Create an instance of WormDataPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> WormDataPolicy:
        """Create an instance of WormDataPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WormDataPolicy.parse_obj(obj)

        _obj = WormDataPolicy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
