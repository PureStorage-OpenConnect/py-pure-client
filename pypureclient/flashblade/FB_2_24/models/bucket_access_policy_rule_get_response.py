...
from pypureclient.flashblade.FB_2_24.models.bucket_access_policy_rule_with_context import BucketAccessPolicyRuleWithContext
from pypureclient.flashblade.FB_2_24.models.error_context_response_errors import ErrorContextResponseErrors


class BucketAccessPolicyRuleGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(BucketAccessPolicyRuleWithContext)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BucketAccessPolicyRuleGetResponse:
        """Create an instance of BucketAccessPolicyRuleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> BucketAccessPolicyRuleGetResponse:
        """Create an instance of BucketAccessPolicyRuleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BucketAccessPolicyRuleGetResponse.parse_obj(obj)

        _obj = BucketAccessPolicyRuleGetResponse.construct(_fields_set=None, **{
            ...
            "items": [BucketAccessPolicyRuleWithContext.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
