...
from pypureclient.flashblade.FB_2_24.models.fixed_location_reference import FixedLocationReference
from pypureclient.flashblade.FB_2_24.models.http import Http
from pypureclient.flashblade.FB_2_24.models.multi_protocol import MultiProtocol
from pypureclient.flashblade.FB_2_24.models.nfs_patch import NfsPatch
from pypureclient.flashblade.FB_2_24.models.reference import Reference
from pypureclient.flashblade.FB_2_24.models.smb import Smb
from pypureclient.flashblade.FB_2_24.models.storage_class_info import StorageClassInfo
from pypureclient.flashblade.FB_2_24.models.workload_configuration_reference_patch import WorkloadConfigurationReferencePatch
...
class FileSystemPatch(BaseModel):
    ...
    workload: Optional[WorkloadConfigurationReferencePatch] = None
    ...
    __properties = ["id", "name", "created", "default_group_quota", "default_user_quota", "destroyed", "fast_remove_directory_enabled", "group_ownership", "hard_limit_enabled", "http", "multi_protocol", "nfs", "promotion_status", "provisioned", "qos_policy", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "storage_class", "time_remaining", "workload", "writable"]
    ...
    def from_dict(cls, obj: dict) -> FileSystemPatch:
        ...
        _obj = FileSystemPatch.construct(_fields_set=None, **{
            ...
            "workload": WorkloadConfigurationReferencePatch.from_dict(obj.get("workload")) if obj.get("workload") is not None else None,
