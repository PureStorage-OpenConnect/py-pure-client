...
from pypureclient.flashblade.FB_2_24.models.audit_file_systems_policy_rule_in_policy import AuditFileSystemsPolicyRuleInPolicy
...
class AuditFileSystemsPolicy(BaseModel):
    """
    ...
    log_targets: Optional[conlist(ReferenceWritable)] = Field(default=None, description="List of targets which will be utilized for audit log storage. These may either be file system targets or remote syslog server targets.")
    ...
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "control_type", "log_targets", "rules", "context"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditFileSystemsPolicy:
        """Create an instance of AuditFileSystemsPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditFileSystemsPolicy:
        """Create an instance of AuditFileSystemsPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditFileSystemsPolicy.parse_obj(obj)

        _obj = AuditFileSystemsPolicy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
