...
class PresetWorkloadQosConfiguration(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PresetWorkloadQosConfiguration:
        """Create an instance of PresetWorkloadQosConfiguration from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PresetWorkloadQosConfiguration:
        """Create an instance of PresetWorkloadQosConfiguration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PresetWorkloadQosConfiguration.parse_obj(obj)
