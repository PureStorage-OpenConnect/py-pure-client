...
class RealmSpace(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RealmSpace:
        """Create an instance of RealmSpace from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RealmSpace:
        """Create an instance of RealmSpace from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RealmSpace.parse_obj(obj)

        _obj = RealmSpace.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
