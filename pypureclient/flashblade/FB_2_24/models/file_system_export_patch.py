...
class FileSystemExportPatch(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemExportPatch:
        """Create an instance of FileSystemExportPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemExportPatch:
        """Create an instance of FileSystemExportPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemExportPatch.parse_obj(obj)

        _obj = FileSystemExportPatch.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
