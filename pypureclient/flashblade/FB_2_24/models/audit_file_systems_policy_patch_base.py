...
class AuditFileSystemsPolicyPatchBase(BaseModel):
    """
    ...
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "log_targets", "rules"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditFileSystemsPolicyPatchBase:
        """Create an instance of AuditFileSystemsPolicyPatchBase from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditFileSystemsPolicyPatchBase:
        """Create an instance of AuditFileSystemsPolicyPatchBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditFileSystemsPolicyPatchBase.parse_obj(obj)

        _obj = AuditFileSystemsPolicyPatchBase.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
