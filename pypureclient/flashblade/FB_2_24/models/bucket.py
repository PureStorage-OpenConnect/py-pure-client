...
from pypureclient.flashblade.FB_2_24.models.bucket_eradication_config import BucketEradicationConfig
from pypureclient.flashblade.FB_2_24.models.fixed_reference import FixedReference
from pypureclient.flashblade.FB_2_24.models.object_lock_config_response import ObjectLockConfigResponse
from pypureclient.flashblade.FB_2_24.models.public_access_config import PublicAccessConfig
from pypureclient.flashblade.FB_2_24.models.space import Space
from pypureclient.flashblade.FB_2_24.models.storage_class_info import StorageClassInfo
...
class Bucket(BaseModel):
    ...
    qos_policy: Optional[FixedReference] = Field(default=None, description="The QoS policy for the bucket defines the performance controls that can be applied to the aggregate performance of all the clients accessing the bucket. If no policy is configured for a bucket, then no performance controls are applied to it.")
    ...
    __properties = ["id", "name", "context", "account", "bucket_type", "created", "destroyed", "eradication_config", "hard_limit_enabled", "object_count", "object_lock_config", "public_access_config", "public_status", "qos_policy", "quota_limit", "retention_lock", "space", "storage_class", "time_remaining", "time_remaining_status", "versioning"]
