...
from pypureclient.flashblade.FB_2_24.models.management_authentication_policy import ManagementAuthenticationPolicy


class ManagementAuthenticationPoliciesGetResponse(BaseModel):
    """
    ManagementAuthenticationPoliciesGetResponse
    """
    ...
    items: Optional[conlist(ManagementAuthenticationPolicy)] = Field(default=None, description="A list of management authentication policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagementAuthenticationPoliciesGetResponse:
        """Create an instance of ManagementAuthenticationPoliciesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ManagementAuthenticationPoliciesGetResponse:
        """Create an instance of ManagementAuthenticationPoliciesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagementAuthenticationPoliciesGetResponse.parse_obj(obj)

        _obj = ManagementAuthenticationPoliciesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [ManagementAuthenticationPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
