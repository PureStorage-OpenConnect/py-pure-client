...
class AuditObjectStorePoliciesPost(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditObjectStorePoliciesPost:
        """Create an instance of AuditObjectStorePoliciesPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditObjectStorePoliciesPost:
        """Create an instance of AuditObjectStorePoliciesPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditObjectStorePoliciesPost.parse_obj(obj)

        _obj = AuditObjectStorePoliciesPost.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
