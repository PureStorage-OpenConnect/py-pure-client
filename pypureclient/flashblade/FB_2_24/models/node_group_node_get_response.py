...
class NodeGroupNodeGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(Member)] = Field(default=None, description="A list of node and node group relationships.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NodeGroupNodeGetResponse:
        """Create an instance of NodeGroupNodeGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NodeGroupNodeGetResponse:
        """Create an instance of NodeGroupNodeGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NodeGroupNodeGetResponse.parse_obj(obj)

        _obj = NodeGroupNodeGetResponse.construct(_fields_set=None, **{
