...
from pypureclient.flashblade.FB_2_24.models.fixed_reference_without_type import FixedReferenceWithoutType
from pypureclient.flashblade.FB_2_24.models.workload_placement_recommendation_additional_constraints import WorkloadPlacementRecommendationAdditionalConstraints
from pypureclient.flashblade.FB_2_24.models.workload_placement_recommendation_parameter import WorkloadPlacementRecommendationParameter
from pypureclient.flashblade.FB_2_24.models.workload_placement_recommendation_result import WorkloadPlacementRecommendationResult
...
class WorkloadPlacementRecommendation(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> WorkloadPlacementRecommendation:
        ...
        _obj = WorkloadPlacementRecommendation.construct(_fields_set=None, **{
            ...
            "name": obj.get("name"),
            "parameters": [WorkloadPlacementRecommendationParameter.from_dict(_item) for _item in obj.get("parameters")] if obj.get("parameters") is not None else None,
            "placement_names": obj.get("placement_names"),
            "preset": FixedReferenceWithoutType.from_dict(obj.get("preset")) if obj.get("preset") is not None else None,
