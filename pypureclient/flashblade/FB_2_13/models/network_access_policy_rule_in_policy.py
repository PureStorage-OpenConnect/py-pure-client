...
class NetworkAccessPolicyRuleInPolicy(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "effect", "client", "interfaces", "policy", "policy_version", "index"]
