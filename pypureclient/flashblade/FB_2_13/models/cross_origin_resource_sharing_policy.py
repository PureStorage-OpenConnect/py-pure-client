...
class CrossOriginResourceSharingPolicy(BaseModel):
    ...
    rules: Optional[Annotated[List[CrossOriginResourceSharingPolicyRule], Field(max_length=100)]] = None
    bucket: Optional[FixedReference] = Field(default=None, description="The bucket to which this policy belongs.")
    __properties: ClassVar[List[str]] = ["name", "id", "enabled", "is_local", "location", "policy_type", "rules", "bucket"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "rules": [CrossOriginResourceSharingPolicyRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None,
