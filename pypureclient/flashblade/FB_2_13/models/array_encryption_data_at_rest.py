...
class ArrayEncryptionDataAtRest(BaseModel):
    ...
    entropy_source: Optional[StrictStr] = Field(default=None, description="The entropy source used to generate the Data at Rest Encryption key on the array.")
    __properties = ["algorithms", "enabled", "entropy_source"]
    ...
    def from_dict(cls, obj: dict) -> ArrayEncryptionDataAtRest:
        ...
        _obj = ArrayEncryptionDataAtRest.construct(_fields_set=None, **{
            ...
            "entropy_source": obj.get("entropy_source")
        })
        return _obj
