...
class FileSystemGetResponse(BaseModel):
    ...
    items: Optional[List[FileSystem]] = Field(default=None, description="A list of file system objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "total": FileSystem.from_dict(obj["total"]) if obj.get("total") is not None else None
        })
        return _obj
