...
class NetworkAccessPolicy(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'policy_type': 'str',
        'version': 'str',
        'rules': 'list[NetworkAccessPolicyRuleInPolicy]'
    }
    ...
    def __init__(
        ...
        rules=None,  # type: List[models.NetworkAccessPolicyRuleInPolicy]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `NetworkAccessPolicy`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(NetworkAccessPolicy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkAccessPolicy):
            return False
