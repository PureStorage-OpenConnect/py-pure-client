...
class NetworkAccessPolicyRuleGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[NetworkAccessPolicyRule]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.NetworkAccessPolicyRule]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `NetworkAccessPolicyRuleGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(NetworkAccessPolicyRuleGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkAccessPolicyRuleGetResponse):
            return False
