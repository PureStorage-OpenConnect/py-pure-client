...
from pypureclient.flashblade.FB_2_13.models.policy_rule import PolicyRule
...
class Policy(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "retention_lock", "rules"]
