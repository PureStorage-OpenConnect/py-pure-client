...
from pypureclient.flashblade.FB_2_13.models.bucket_eradication_config import BucketEradicationConfig
from pypureclient.flashblade.FB_2_13.models.fixed_reference import FixedReference
from pypureclient.flashblade.FB_2_13.models.object_lock_config_response import ObjectLockConfigResponse
...
class Bucket(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "account", "created", "destroyed", "object_count", "space", "time_remaining", "versioning", "bucket_type", "eradication_config", "hard_limit_enabled", "object_lock_config", "quota_limit", "retention_lock", "public_access_config", "public_status"]
