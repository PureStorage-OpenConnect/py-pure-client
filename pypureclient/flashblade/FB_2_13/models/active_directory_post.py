...
class ActiveDirectoryPost(BaseModel):
    ...
    __properties = ["directory_servers", "global_catalog_servers", "computer_name", "domain", "encryption_types", "fqdns", "join_ou", "kerberos_servers", "password", "service_principal_names", "user"]
