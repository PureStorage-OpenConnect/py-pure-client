...
class SmbClientPolicyPost(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'policy_type': 'str',
        'rules': 'list[SmbClientPolicyRulePostInPolicy]'
    }
    ...
    def __init__(
        ...
        rules=None,  # type: List[models.SmbClientPolicyRulePostInPolicy]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `SmbClientPolicyPost`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(SmbClientPolicyPost, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SmbClientPolicyPost):
            return False
