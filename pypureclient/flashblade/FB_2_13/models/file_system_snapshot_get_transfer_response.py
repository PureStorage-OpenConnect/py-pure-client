...
class FileSystemSnapshotGetTransferResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[FileSystemSnapshotTransfer]',
        'total': 'FileSystemSnapshotTransfer'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.FileSystemSnapshotTransfer]
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `FileSystemSnapshotGetTransferResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(FileSystemSnapshotGetTransferResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileSystemSnapshotGetTransferResponse):
            return False
