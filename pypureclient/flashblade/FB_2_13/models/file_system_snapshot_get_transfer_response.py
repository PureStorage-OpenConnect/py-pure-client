...
class FileSystemSnapshotGetTransferResponse(BaseModel):
    ...
    items: Optional[List[FileSystemSnapshotTransfer]] = Field(default=None, description="A list of file system snapshot objects.")
    ...
    __properties: ClassVar[List[str]] = ["continuation_token", "total_item_count", "items", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [FileSystemSnapshotTransfer.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": FileSystemSnapshotTransfer.from_dict(obj["total"]) if obj.get("total") is not None else None
        })
        return _obj
