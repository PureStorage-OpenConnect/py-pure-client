...
class PoliciesAllApi(object):
    ...
    def api213_policies_all_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api213_policies_all_get`, must be a value greater than or equal to `0`")
    ...
    def api213_policies_all_members_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api213_policies_all_members_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
