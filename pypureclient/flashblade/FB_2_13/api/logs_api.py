...
from pypureclient.flashblade.FB_2_13.models.logs_async import LogsAsync
from pypureclient.flashblade.FB_2_13.models.logs_async_get_response import LogsAsyncGetResponse
from pypureclient.flashblade.FB_2_13.models.logs_async_response import LogsAsyncResponse
...
class LogsApi:
    ...
    def api213_logs_async_download_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api213_logs_async_download_get_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api213_logs_async_download_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.13/logs-async/download', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api213_logs_async_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api213_logs_async_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_logs_async_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_logs_async_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api213_logs_async_patch_with_http_info(logs_async, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_logs_async_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_logs_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api213_logs_get_with_http_info(end_time, start_time, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_logs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
