...
class LogsApi:
    ...
    def api213_logs_async_download_get_with_http_info(
        ...
        _param = self._api213_logs_async_download_get_serialize(
            names = names,
        )
    ...
    def _api213_logs_async_download_get_serialize(
        self,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.13/logs-async/download',
    ...
    def api213_logs_async_get_with_http_info(
        ...
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[LogsAsyncGetResponse]:
        """GET logs-async
        ...
        _param = self._api213_logs_async_get_serialize(
    ...
    def _api213_logs_async_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.13/logs-async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api213_logs_async_patch_with_http_info(
        ...
        _param = self._api213_logs_async_patch_serialize(
    ...
    def _api213_logs_async_patch_serialize(
        self,
        logs_async,
    ) -> RequestSerialized:
        ...
        # process the form parameters
        # process the body parameter
        if logs_async is not None:
            _body_params = logs_async
    ...
    def api213_logs_get_with_http_info(
        ...
        _param = self._api213_logs_get_serialize(
            end_time = end_time,
    ...
    def _api213_logs_get_serialize(
        self,
        end_time,
        start_time,
    ) -> RequestSerialized:
