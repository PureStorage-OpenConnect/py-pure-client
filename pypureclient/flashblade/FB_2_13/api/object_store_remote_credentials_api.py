...
class ObjectStoreRemoteCredentialsApi(object):
    ...
    def api213_object_store_remote_credentials_delete_with_http_info(
        ...
        >>> thread = api.api213_object_store_remote_credentials_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api213_object_store_remote_credentials_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api213_object_store_remote_credentials_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api213_object_store_remote_credentials_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api213_object_store_remote_credentials_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api213_object_store_remote_credentials_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api213_object_store_remote_credentials_patch_with_http_info(remote_credentials, async_req=True)
        >>> result = thread.get()
        ...
        if remote_credentials is None:
            raise TypeError("Missing the required parameter `remote_credentials` when calling `api213_object_store_remote_credentials_patch`")
    ...
    def api213_object_store_remote_credentials_post_with_http_info(
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api213_object_store_remote_credentials_post`")
        # verify the required parameter 'remote_credentials' is set
        if remote_credentials is None:
            raise TypeError("Missing the required parameter `remote_credentials` when calling `api213_object_store_remote_credentials_post`")
