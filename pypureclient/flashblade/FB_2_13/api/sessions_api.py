...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_13.models.session_get_response import SessionGetResponse
...
class SessionsApi:
    ...
    def api213_sessions_get_with_http_info(
        ...
        _param = self._api213_sessions_get_serialize(
    ...
    def _api213_sessions_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.13/sessions',
