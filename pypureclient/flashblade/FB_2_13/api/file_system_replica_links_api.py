...
from pypureclient.flashblade.FB_2_13.models.file_system_replica_link import FileSystemReplicaLink
from pypureclient.flashblade.FB_2_13.models.file_system_replica_link_get_response import FileSystemReplicaLinkGetResponse
from pypureclient.flashblade.FB_2_13.models.file_system_replica_link_response import FileSystemReplicaLinkResponse
from pypureclient.flashblade.FB_2_13.models.file_system_snapshot_get_transfer_response import FileSystemSnapshotGetTransferResponse
from pypureclient.flashblade.FB_2_13.models.policy_member_with_remote_get_response import PolicyMemberWithRemoteGetResponse
from pypureclient.flashblade.FB_2_13.models.policy_member_with_remote_response import PolicyMemberWithRemoteResponse
...
class FileSystemReplicaLinksApi:
    ...
    def api213_file_system_replica_links_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_file_system_replica_links_delete_with_http_info(cancel_in_progress_transfers, ids, local_file_system_ids, local_file_system_names, remote_file_system_ids, remote_file_system_names, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api213_file_system_replica_links_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_file_system_replica_links_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_file_system_replica_links_get_with_http_info(continuation_token, filter, ids, limit, local_file_system_ids, local_file_system_names, offset, remote_file_system_ids, remote_file_system_names, remote_ids, remote_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_file_system_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_file_system_replica_links_policies_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_file_system_replica_links_policies_delete_with_http_info(local_file_system_ids, local_file_system_names, member_ids, policy_ids, policy_names, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_file_system_replica_links_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_file_system_replica_links_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_file_system_replica_links_policies_get_with_http_info(continuation_token, filter, limit, local_file_system_ids, local_file_system_names, member_ids, offset, policy_ids, policy_names, remote_file_system_ids, remote_file_system_names, remote_ids, remote_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_file_system_replica_links_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_file_system_replica_links_policies_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_file_system_replica_links_policies_post_with_http_info(local_file_system_ids, local_file_system_names, member_ids, policy_ids, policy_names, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_file_system_replica_links_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_file_system_replica_links_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_file_system_replica_links_post_with_http_info(file_system_replica_link, ids, local_file_system_ids, local_file_system_names, remote_file_system_names, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_file_system_replica_links_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_file_system_replica_links_transfer_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_file_system_replica_links_transfer_get_with_http_info(continuation_token, filter, ids, limit, names_or_owner_names, offset, remote_ids, remote_names, sort, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_file_system_replica_links_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
