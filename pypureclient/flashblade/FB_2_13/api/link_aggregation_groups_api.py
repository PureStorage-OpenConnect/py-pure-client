...
class LinkAggregationGroupsApi:
    ...
    def api213_link_aggregation_groups_delete_with_http_info(
        ...
        _param = self._api213_link_aggregation_groups_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api213_link_aggregation_groups_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.13/link-aggregation-groups',
    ...
    def api213_link_aggregation_groups_get_with_http_info(
        ...
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[LinkAggregationGroupGetResponse]:
        ...
        _param = self._api213_link_aggregation_groups_get_serialize(
    ...
    def _api213_link_aggregation_groups_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api213_link_aggregation_groups_patch_with_http_info(
        ...
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[LinkAggregationGroupResponse]:
        ...
        _param = self._api213_link_aggregation_groups_patch_serialize(
    ...
    def _api213_link_aggregation_groups_patch_serialize(
        self,
        ...
        if link_aggregation_group is not None:
            _body_params = link_aggregation_group
    ...
    def api213_link_aggregation_groups_post_with_http_info(
        ...
        _param = self._api213_link_aggregation_groups_post_serialize(
            names = names,
            link_aggregation_group = link_aggregation_group,
        )
    ...
    def _api213_link_aggregation_groups_post_serialize(
        self,
        names,
        link_aggregation_group,
    ) -> RequestSerialized:
