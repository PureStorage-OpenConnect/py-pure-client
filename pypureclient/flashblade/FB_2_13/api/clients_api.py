...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_13.models.client_performance_get_response import ClientPerformanceGetResponse
...
class ClientsApi:
    ...
    @validate_call
    def api213_arrays_clients_performance_get_with_http_info(
        self,
        ...
        _param = self._api213_arrays_clients_performance_get_serialize(
            filter = filter,
            limit = limit,
            names = names,
            sort = sort,
    ...
    def _api213_arrays_clients_performance_get_serialize(
        self,
        filter,
        limit,
        names,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.13/arrays/clients/performance',
