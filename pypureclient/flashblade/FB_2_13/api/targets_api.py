...
class TargetsApi(object):
    ...
    def api213_targets_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api213_targets_get`, must be a value greater than or equal to `0`")
    ...
    def api213_targets_performance_replication_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api213_targets_performance_replication_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
