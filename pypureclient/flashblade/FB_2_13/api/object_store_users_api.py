...
from pypureclient.flashblade.FB_2_13.models.object_store_user_get_response import ObjectStoreUserGetResponse
from pypureclient.flashblade.FB_2_13.models.object_store_user_response import ObjectStoreUserResponse
...
class ObjectStoreUsersApi:
    ...
    def api213_object_store_users_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_object_store_users_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api213_object_store_users_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_object_store_users_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_object_store_users_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_object_store_users_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_object_store_users_object_store_access_policies_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_object_store_users_object_store_access_policies_delete_with_http_info(member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_object_store_users_object_store_access_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_object_store_users_object_store_access_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_object_store_users_object_store_access_policies_get_with_http_info(continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_object_store_users_object_store_access_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_object_store_users_object_store_access_policies_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_object_store_users_object_store_access_policies_post_with_http_info(member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_object_store_users_object_store_access_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_object_store_users_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_object_store_users_post_with_http_info(names, full_access, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_object_store_users_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
