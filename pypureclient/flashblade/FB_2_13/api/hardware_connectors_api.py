...
class HardwareConnectorsApi:
    ...
    def api213_hardware_connectors_get_with_http_info(
    ...
    ) -> ApiResponse[HardwareConnectorGetResponse]:
        ...
        _param = self._api213_hardware_connectors_get_serialize(
            ids = ids,
            names = names,
    ...
    def _api213_hardware_connectors_get_serialize(
        self,
        ids,
        names,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.13/hardware-connectors',
    ...
    def api213_hardware_connectors_patch_with_http_info(
        ...
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[HardwareConnectorResponse]:
        ...
        _param = self._api213_hardware_connectors_patch_serialize(
    ...
    def _api213_hardware_connectors_patch_serialize(
        self,
        hardware_connector,
        ids,
        names,
        ...
        # process the form parameters
        # process the body parameter
        if hardware_connector is not None:
            _body_params = hardware_connector
    ...
    def api213_hardware_connectors_performance_get_with_http_info(
        ...
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[HardwareConnectorPerformanceGetResponse]:
        ...
        _param = self._api213_hardware_connectors_performance_get_serialize(
            end_time = end_time,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api213_hardware_connectors_performance_get_serialize(
        self,
        end_time,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.13/hardware-connectors/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
