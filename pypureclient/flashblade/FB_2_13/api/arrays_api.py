...
from pypureclient.flashblade.FB_2_13.models.array import Array
from pypureclient.flashblade.FB_2_13.models.array_factory_reset_token_get_response import ArrayFactoryResetTokenGetResponse
from pypureclient.flashblade.FB_2_13.models.array_factory_reset_token_response import ArrayFactoryResetTokenResponse
from pypureclient.flashblade.FB_2_13.models.array_get_response import ArrayGetResponse
from pypureclient.flashblade.FB_2_13.models.array_http_specific_performance_get import ArrayHttpSpecificPerformanceGet
from pypureclient.flashblade.FB_2_13.models.array_nfs_specific_performance_get import ArrayNfsSpecificPerformanceGet
from pypureclient.flashblade.FB_2_13.models.array_performance_get_response import ArrayPerformanceGetResponse
from pypureclient.flashblade.FB_2_13.models.array_performance_replication_get_resp import ArrayPerformanceReplicationGetResp
from pypureclient.flashblade.FB_2_13.models.array_response import ArrayResponse
from pypureclient.flashblade.FB_2_13.models.array_s3_specific_performance_get_resp import ArrayS3SpecificPerformanceGetResp
from pypureclient.flashblade.FB_2_13.models.array_space_get_response import ArraySpaceGetResponse
from pypureclient.flashblade.FB_2_13.models.arrays_supported_time_zones_get_response import ArraysSupportedTimeZonesGetResponse
from pypureclient.flashblade.FB_2_13.models.eula import Eula
from pypureclient.flashblade.FB_2_13.models.eula_get_response import EulaGetResponse
from pypureclient.flashblade.FB_2_13.models.eula_response import EulaResponse
...
class ArraysApi:
    ...
    def api213_arrays_eula_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_arrays_eula_get_with_http_info(continuation_token, filter, limit, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api213_arrays_eula_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_arrays_eula_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_arrays_factory_reset_token_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_arrays_factory_reset_token_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_arrays_factory_reset_token_get_with_http_info(continuation_token, filter, limit, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_arrays_factory_reset_token_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_arrays_factory_reset_token_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_arrays_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_arrays_get_with_http_info(continuation_token, filter, limit, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_arrays_http_specific_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_arrays_http_specific_performance_get_with_http_info(end_time, resolution, start_time, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_arrays_http_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_arrays_nfs_specific_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_arrays_nfs_specific_performance_get_with_http_info(end_time, resolution, start_time, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_arrays_nfs_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_arrays_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_arrays_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_arrays_performance_get_with_http_info(end_time, protocol, resolution, start_time, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_arrays_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_arrays_performance_replication_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_arrays_performance_replication_get_with_http_info(end_time, resolution, start_time, type, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_arrays_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_arrays_s3_specific_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_arrays_s3_specific_performance_get_with_http_info(end_time, resolution, start_time, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_arrays_s3_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_arrays_space_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_arrays_space_get_with_http_info(end_time, resolution, start_time, type, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_arrays_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_arrays_supported_time_zones_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_arrays_supported_time_zones_get_with_http_info(continuation_token, filter, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_arrays_supported_time_zones_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
