...
class HardwareApi:
    ...
    def api213_hardware_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_hardware_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api213_hardware_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_hardware_patch_with_http_info(hardware, ids, names, async_req=True)
        >>> result = thread.get()
