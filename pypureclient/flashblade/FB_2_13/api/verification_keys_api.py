...
class VerificationKeysApi:
    ...
    def api213_support_verification_keys_get_with_http_info(
    ...
    ) -> ApiResponse[VerificationKeyGetResponse]:
        ...
        _param = self._api213_support_verification_keys_get_serialize(
    ...
    def _api213_support_verification_keys_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.13/support/verification-keys',
    ...
    def api213_support_verification_keys_patch_with_http_info(
        ...
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[VerificationKeyResponse]:
        ...
        _param = self._api213_support_verification_keys_patch_serialize(
            key = key,
        )
    ...
    def _api213_support_verification_keys_patch_serialize(
        self,
        key,
    ) -> RequestSerialized:
