...
class KeytabsApi:
    ...
    def api213_keytabs_delete_with_http_info(
        ...
        _param = self._api213_keytabs_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api213_keytabs_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.13/keytabs',
    ...
    def api213_keytabs_download_get_with_http_info(
        ...
        _param = self._api213_keytabs_download_get_serialize(
    ...
    def _api213_keytabs_download_get_serialize(
        self,
        keytab_ids,
        keytab_names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.13/keytabs/download',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api213_keytabs_get_with_http_info(
        ...
        _param = self._api213_keytabs_get_serialize(
    ...
    def _api213_keytabs_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api213_keytabs_post_with_http_info(
        ...
        _param = self._api213_keytabs_post_serialize(
            keytab = keytab,
    ...
    def _api213_keytabs_post_serialize(
        self,
        keytab,
        name_prefixes,
    ) -> RequestSerialized:
    ...
    def api213_keytabs_upload_post_with_http_info(
        ...
        _param = self._api213_keytabs_upload_post_serialize(
    ...
    def _api213_keytabs_upload_post_serialize(
        self,
        keytab_file,
        name_prefixes,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2.13/keytabs/upload',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
