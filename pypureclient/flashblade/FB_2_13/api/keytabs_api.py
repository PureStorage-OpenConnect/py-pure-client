...
class KeytabsApi(object):
    ...
    def api213_keytabs_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api213_keytabs_get`, must be a value greater than or equal to `0`")
    ...
    def api213_keytabs_upload_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api213_keytabs_upload_post_with_http_info(async_req=True)
        >>> result = thread.get()
