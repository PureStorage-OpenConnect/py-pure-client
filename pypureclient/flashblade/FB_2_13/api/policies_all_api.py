...
class PoliciesAllApi:
    ...
    def api213_policies_all_get_with_http_info(
        ...
        _param = self._api213_policies_all_get_serialize(
    ...
    def _api213_policies_all_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.13/policies-all',
    ...
    def api213_policies_all_members_get_with_http_info(
        ...
        _param = self._api213_policies_all_members_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
    ...
    def _api213_policies_all_members_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.13/policies-all/members',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
