...
from pypureclient.flashblade.FB_2_13.models.lifecycle_rule_get_response import LifecycleRuleGetResponse
from pypureclient.flashblade.FB_2_13.models.lifecycle_rule_patch import LifecycleRulePatch
from pypureclient.flashblade.FB_2_13.models.lifecycle_rule_post import LifecycleRulePost
from pypureclient.flashblade.FB_2_13.models.lifecycle_rule_response import LifecycleRuleResponse
...
class LifecycleRulesApi:
    ...
    def api213_lifecycle_rules_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_lifecycle_rules_delete_with_http_info(bucket_ids, bucket_names, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api213_lifecycle_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_lifecycle_rules_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_lifecycle_rules_get_with_http_info(bucket_ids, bucket_names, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_lifecycle_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_lifecycle_rules_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_lifecycle_rules_patch_with_http_info(lifecycle, bucket_ids, bucket_names, confirm_date, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_lifecycle_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api213_lifecycle_rules_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api213_lifecycle_rules_post_with_http_info(rule, confirm_date, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_lifecycle_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
