...
from pypureclient.flashblade.FB_2_13.models.object_store_account_get_response import ObjectStoreAccountGetResponse
from pypureclient.flashblade.FB_2_13.models.object_store_account_patch import ObjectStoreAccountPatch
from pypureclient.flashblade.FB_2_13.models.object_store_account_post import ObjectStoreAccountPost
from pypureclient.flashblade.FB_2_13.models.object_store_account_response import ObjectStoreAccountResponse
...
class ObjectStoreAccountsApi:
    ...
    def api213_object_store_accounts_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api213_object_store_accounts_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api213_object_store_accounts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.13/object-store-accounts', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api213_object_store_accounts_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api213_object_store_accounts_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_object_store_accounts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.13/object-store-accounts', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api213_object_store_accounts_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api213_object_store_accounts_patch_with_http_info(object_store_account, ids, ignore_usage, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_object_store_accounts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.13/object-store-accounts', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api213_object_store_accounts_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api213_object_store_accounts_post_with_http_info(names, object_store_account, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api213_object_store_accounts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.13/object-store-accounts', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
