...
class SyslogApi:
    ...
    def api215_syslog_servers_delete_with_http_info(
        ...
        _param = self._api215_syslog_servers_delete_serialize(
    ...
    def _api215_syslog_servers_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/syslog-servers',
    ...
    def api215_syslog_servers_get_with_http_info(
        ...
        _param = self._api215_syslog_servers_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_syslog_servers_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_syslog_servers_patch_with_http_info(
        ...
        _param = self._api215_syslog_servers_patch_serialize(
    ...
    def _api215_syslog_servers_patch_serialize(
        self,
        syslog_server,
        x_request_id,
        ids,
    ...
    def api215_syslog_servers_post_with_http_info(
        ...
        _param = self._api215_syslog_servers_post_serialize(
            syslog_server = syslog_server,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api215_syslog_servers_post_serialize(
        self,
        syslog_server,
        x_request_id,
        names,
    ...
    def api215_syslog_servers_settings_get_with_http_info(
        ...
        _param = self._api215_syslog_servers_settings_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
    ...
    def _api215_syslog_servers_settings_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/syslog-servers/settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api215_syslog_servers_settings_patch_with_http_info(
        ...
        _param = self._api215_syslog_servers_settings_patch_serialize(
    ...
    def _api215_syslog_servers_settings_patch_serialize(
        self,
    ...
    def api215_syslog_servers_test_get_with_http_info(
        ...
        _param = self._api215_syslog_servers_test_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
        )
    ...
    def _api215_syslog_servers_test_get_serialize(
        self,
        x_request_id,
        continuation_token,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/syslog-servers/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
