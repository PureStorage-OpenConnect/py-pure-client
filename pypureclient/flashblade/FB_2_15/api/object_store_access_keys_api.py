...
class ObjectStoreAccessKeysApi(object):
    ...
    def api215_object_store_access_keys_delete_with_http_info(
        ...
        >>> thread = api.api215_object_store_access_keys_delete_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api215_object_store_access_keys_delete`")
    ...
    def api215_object_store_access_keys_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api215_object_store_access_keys_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api215_object_store_access_keys_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api215_object_store_access_keys_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api215_object_store_access_keys_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api215_object_store_access_keys_patch_with_http_info(names, object_store_access_key, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api215_object_store_access_keys_patch`")
        # verify the required parameter 'object_store_access_key' is set
        if object_store_access_key is None:
            raise TypeError("Missing the required parameter `object_store_access_key` when calling `api215_object_store_access_keys_patch`")
    ...
    def api215_object_store_access_keys_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api215_object_store_access_keys_post_with_http_info(object_store_access_key, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'object_store_access_key' is set
        if object_store_access_key is None:
            raise TypeError("Missing the required parameter `object_store_access_key` when calling `api215_object_store_access_keys_post`")
