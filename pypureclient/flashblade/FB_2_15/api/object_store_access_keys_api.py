...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_15.models.object_store_access_key import ObjectStoreAccessKey
from pypureclient.flashblade.FB_2_15.models.object_store_access_key_get_response import ObjectStoreAccessKeyGetResponse
from pypureclient.flashblade.FB_2_15.models.object_store_access_key_post import ObjectStoreAccessKeyPost
from pypureclient.flashblade.FB_2_15.models.object_store_access_key_response import ObjectStoreAccessKeyResponse
...
class ObjectStoreAccessKeysApi:
    ...
    @validate_call
    def api215_object_store_access_keys_delete_with_http_info(
        self,
        ...
        _param = self._api215_object_store_access_keys_delete_serialize(
            names = names,
    ...
    def _api215_object_store_access_keys_delete_serialize(
        self,
        names,
        x_request_id,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/object-store-access-keys',
    ...
    @validate_call
    def api215_object_store_access_keys_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        _param = self._api215_object_store_access_keys_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_object_store_access_keys_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    @validate_call
    def api215_object_store_access_keys_patch_with_http_info(
        self,
        names: Annotated[List[StrictStr], Field(description="A comma-separated list of resource names.")],
        ...
        _param = self._api215_object_store_access_keys_patch_serialize(
            names = names,
    ...
    def _api215_object_store_access_keys_patch_serialize(
        self,
        names,
    ...
    @validate_call
    def api215_object_store_access_keys_post_with_http_info(
        self,
        ...
        _param = self._api215_object_store_access_keys_post_serialize(
            object_store_access_key = object_store_access_key,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api215_object_store_access_keys_post_serialize(
        self,
        object_store_access_key,
        x_request_id,
        names,
