...
class PublicKeysApi:
    ...
    def api215_public_keys_delete_with_http_info(
        ...
        _param = self._api215_public_keys_delete_serialize(
    ...
    def _api215_public_keys_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/public-keys',
    ...
    def api215_public_keys_get_with_http_info(
        ...
        _param = self._api215_public_keys_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_public_keys_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_public_keys_post_with_http_info(
        ...
        _param = self._api215_public_keys_post_serialize(
            names = names,
    ...
    def _api215_public_keys_post_serialize(
        self,
        names,
        public_key,
        x_request_id,
    ...
    def api215_public_keys_uses_get_with_http_info(
        ...
        _param = self._api215_public_keys_uses_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
    ...
    def _api215_public_keys_uses_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/public-keys/uses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
