...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_15.models.drive_get_response import DriveGetResponse
...
class DrivesApi:
    ...
    def api215_drives_get_with_http_info(
        ...
        _param = self._api215_drives_get_serialize(
    ...
    def _api215_drives_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
