...
from pypureclient.flashblade.FB_2_15.models.file_system_snapshot_get_response import FileSystemSnapshotGetResponse
...
from pypureclient.flashblade.FB_2_15.models.file_system_snapshot_post import FileSystemSnapshotPost
from pypureclient.flashblade.FB_2_15.models.file_system_snapshot_response import FileSystemSnapshotResponse
...
class FileSystemSnapshotsApi:
    ...
    @validate_call
    def api215_file_system_snapshots_delete_with_http_info(
        self,
        ...
        _param = self._api215_file_system_snapshots_delete_serialize(
    ...
    def _api215_file_system_snapshots_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/file-system-snapshots',
    ...
    @validate_call
    def api215_file_system_snapshots_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        _param = self._api215_file_system_snapshots_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_file_system_snapshots_get_serialize(
        self,
        x_request_id,
        continuation_token,
        destroyed,
    ...
    @validate_call
    def api215_file_system_snapshots_patch_with_http_info(
        self,
        ...
        _param = self._api215_file_system_snapshots_patch_serialize(
    ...
    def _api215_file_system_snapshots_patch_serialize(
        self,
    ...
    @validate_call
    def api215_file_system_snapshots_policies_delete_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        _param = self._api215_file_system_snapshots_policies_delete_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_file_system_snapshots_policies_delete_serialize(
        self,
        x_request_id,
        member_ids,
        member_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/file-system-snapshots/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api215_file_system_snapshots_policies_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ...
        _param = self._api215_file_system_snapshots_policies_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
    ...
    def _api215_file_system_snapshots_policies_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    @validate_call
    def api215_file_system_snapshots_post_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        _param = self._api215_file_system_snapshots_post_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_file_system_snapshots_post_serialize(
        self,
        x_request_id,
        source_ids,
        source_names,
    ...
    @validate_call
    def api215_file_system_snapshots_transfer_delete_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        ...
        _param = self._api215_file_system_snapshots_transfer_delete_serialize(
            x_request_id = x_request_id,
            ids = ids,
            names = names,
    ...
    def _api215_file_system_snapshots_transfer_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/file-system-snapshots/transfer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api215_file_system_snapshots_transfer_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ...
        _param = self._api215_file_system_snapshots_transfer_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
    ...
    def _api215_file_system_snapshots_transfer_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
