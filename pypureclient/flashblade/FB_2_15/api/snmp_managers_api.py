...
class SNMPManagersApi:
    ...
    def api215_snmp_managers_delete_with_http_info(
        ...
        _param = self._api215_snmp_managers_delete_serialize(
    ...
    def _api215_snmp_managers_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/snmp-managers',
    ...
    def api215_snmp_managers_get_with_http_info(
        ...
        _param = self._api215_snmp_managers_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_snmp_managers_get_serialize(
        self,
        x_request_id,
        continuation_token,
        ids,
    ...
    def api215_snmp_managers_patch_with_http_info(
        ...
        _param = self._api215_snmp_managers_patch_serialize(
    ...
    def _api215_snmp_managers_patch_serialize(
        self,
        snmp_manager,
        x_request_id,
        ids,
    ...
    def api215_snmp_managers_post_with_http_info(
        ...
        _param = self._api215_snmp_managers_post_serialize(
            names = names,
            snmp_manager = snmp_manager,
            x_request_id = x_request_id,
        )
    ...
    def _api215_snmp_managers_post_serialize(
        self,
        names,
        snmp_manager,
        x_request_id,
    ...
    def api215_snmp_managers_test_get_with_http_info(
        ...
        _param = self._api215_snmp_managers_test_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            ids = ids,
            filter = filter,
    ...
    def _api215_snmp_managers_test_get_serialize(
        self,
        x_request_id,
        continuation_token,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/snmp-managers/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
