...
class ObjectStoreUsersApi:
    ...
    def api215_object_store_users_delete_with_http_info(
        ...
        _param = self._api215_object_store_users_delete_serialize(
    ...
    def _api215_object_store_users_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/object-store-users',
    ...
    def api215_object_store_users_get_with_http_info(
        ...
        _param = self._api215_object_store_users_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_object_store_users_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_object_store_users_object_store_access_policies_delete_with_http_info(
        ...
        _param = self._api215_object_store_users_object_store_access_policies_delete_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_object_store_users_object_store_access_policies_delete_serialize(
        self,
        x_request_id,
        member_ids,
        member_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/object-store-users/object-store-access-policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api215_object_store_users_object_store_access_policies_get_with_http_info(
        ...
        _param = self._api215_object_store_users_object_store_access_policies_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
    ...
    def _api215_object_store_users_object_store_access_policies_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_object_store_users_object_store_access_policies_post_with_http_info(
        ...
        _param = self._api215_object_store_users_object_store_access_policies_post_serialize(
            x_request_id = x_request_id,
            member_ids = member_ids,
            member_names = member_names,
            policy_ids = policy_ids,
    ...
    def _api215_object_store_users_object_store_access_policies_post_serialize(
        self,
        x_request_id,
        member_ids,
        member_names,
    ...
    def api215_object_store_users_post_with_http_info(
        ...
        _param = self._api215_object_store_users_post_serialize(
            names = names,
            x_request_id = x_request_id,
    ...
    def _api215_object_store_users_post_serialize(
        self,
        names,
        x_request_id,
        full_access,
