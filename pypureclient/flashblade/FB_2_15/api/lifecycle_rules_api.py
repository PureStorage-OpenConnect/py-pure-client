...
class LifecycleRulesApi:
    ...
    def api215_lifecycle_rules_delete_with_http_info(
        ...
        _param = self._api215_lifecycle_rules_delete_serialize(
    ...
    def _api215_lifecycle_rules_delete_serialize(
        self,
        x_request_id,
        bucket_ids,
        bucket_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/lifecycle-rules',
    ...
    def api215_lifecycle_rules_get_with_http_info(
        ...
        _param = self._api215_lifecycle_rules_get_serialize(
            x_request_id = x_request_id,
            bucket_ids = bucket_ids,
            bucket_names = bucket_names,
    ...
    def _api215_lifecycle_rules_get_serialize(
        self,
        x_request_id,
        bucket_ids,
        bucket_names,
    ...
    def api215_lifecycle_rules_patch_with_http_info(
        ...
        _param = self._api215_lifecycle_rules_patch_serialize(
            lifecycle = lifecycle,
            x_request_id = x_request_id,
            bucket_ids = bucket_ids,
            bucket_names = bucket_names,
    ...
    def _api215_lifecycle_rules_patch_serialize(
        self,
        lifecycle,
        x_request_id,
        bucket_ids,
    ...
    def api215_lifecycle_rules_post_with_http_info(
        ...
        _param = self._api215_lifecycle_rules_post_serialize(
            rule = rule,
            x_request_id = x_request_id,
            confirm_date = confirm_date,
        )
    ...
    def _api215_lifecycle_rules_post_serialize(
        self,
        rule,
        x_request_id,
        confirm_date,
