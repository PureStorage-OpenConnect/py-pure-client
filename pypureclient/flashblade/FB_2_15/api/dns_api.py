...
from pypureclient.flashblade.FB_2_15.models.dns import Dns
from pypureclient.flashblade.FB_2_15.models.dns_get_response import DnsGetResponse
from pypureclient.flashblade.FB_2_15.models.dns_response import DnsResponse
...
class DNSApi:
    ...
    def api215_dns_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_dns_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api215_dns_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_dns_patch_with_http_info(dns, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
