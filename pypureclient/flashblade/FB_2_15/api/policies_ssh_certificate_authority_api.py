...
class PoliciesSSHCertificateAuthorityApi:
    ...
    def api215_admins_ssh_certificate_authority_policies_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_admins_ssh_certificate_authority_policies_delete_with_http_info(x_request_id, member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api215_admins_ssh_certificate_authority_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_admins_ssh_certificate_authority_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_admins_ssh_certificate_authority_policies_get_with_http_info(x_request_id, continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_admins_ssh_certificate_authority_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_admins_ssh_certificate_authority_policies_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_admins_ssh_certificate_authority_policies_post_with_http_info(x_request_id, member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_admins_ssh_certificate_authority_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_arrays_ssh_certificate_authority_policies_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_arrays_ssh_certificate_authority_policies_delete_with_http_info(x_request_id, member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_arrays_ssh_certificate_authority_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_arrays_ssh_certificate_authority_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_arrays_ssh_certificate_authority_policies_get_with_http_info(x_request_id, continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_arrays_ssh_certificate_authority_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_arrays_ssh_certificate_authority_policies_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_arrays_ssh_certificate_authority_policies_post_with_http_info(x_request_id, member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_arrays_ssh_certificate_authority_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_ssh_certificate_authority_policies_admins_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_ssh_certificate_authority_policies_admins_delete_with_http_info(x_request_id, member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_ssh_certificate_authority_policies_admins_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_ssh_certificate_authority_policies_admins_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_ssh_certificate_authority_policies_admins_get_with_http_info(x_request_id, continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_ssh_certificate_authority_policies_admins_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_ssh_certificate_authority_policies_admins_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_ssh_certificate_authority_policies_admins_post_with_http_info(x_request_id, member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_ssh_certificate_authority_policies_admins_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_ssh_certificate_authority_policies_arrays_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_ssh_certificate_authority_policies_arrays_delete_with_http_info(x_request_id, member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_ssh_certificate_authority_policies_arrays_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_ssh_certificate_authority_policies_arrays_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_ssh_certificate_authority_policies_arrays_get_with_http_info(x_request_id, continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_ssh_certificate_authority_policies_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_ssh_certificate_authority_policies_arrays_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_ssh_certificate_authority_policies_arrays_post_with_http_info(x_request_id, member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_ssh_certificate_authority_policies_arrays_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_ssh_certificate_authority_policies_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_ssh_certificate_authority_policies_delete_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_ssh_certificate_authority_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_ssh_certificate_authority_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_ssh_certificate_authority_policies_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_ssh_certificate_authority_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_ssh_certificate_authority_policies_members_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_ssh_certificate_authority_policies_members_get_with_http_info(x_request_id, continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_ssh_certificate_authority_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_ssh_certificate_authority_policies_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_ssh_certificate_authority_policies_patch_with_http_info(policy, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_ssh_certificate_authority_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_ssh_certificate_authority_policies_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_ssh_certificate_authority_policies_post_with_http_info(names, policy, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_ssh_certificate_authority_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
