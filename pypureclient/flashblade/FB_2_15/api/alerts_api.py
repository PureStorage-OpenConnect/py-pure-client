...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_15.models.alert import Alert
from pypureclient.flashblade.FB_2_15.models.alert_get_response import AlertGetResponse
from pypureclient.flashblade.FB_2_15.models.alert_response import AlertResponse
...
class AlertsApi:
    ...
    def api215_alerts_get_with_http_info(
        ...
        _param = self._api215_alerts_get_serialize(
    ...
    def _api215_alerts_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_alerts_patch_with_http_info(
        ...
        _param = self._api215_alerts_patch_serialize(
    ...
    def _api215_alerts_patch_serialize(
        self,
        alerts_settings,
        x_request_id,
        ids,
