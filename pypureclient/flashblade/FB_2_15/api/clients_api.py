...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_15.models.client_performance_get_response import ClientPerformanceGetResponse
...
class ClientsApi:
    ...
    @validate_call
    def api215_arrays_clients_performance_get_with_http_info(
        self,
        ...
        _param = self._api215_arrays_clients_performance_get_serialize(
    ...
    def _api215_arrays_clients_performance_get_serialize(
        self,
        x_request_id,
        filter,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/arrays/clients/performance',
