...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_15.models.audit_get_response import AuditGetResponse
...
class AuditsApi:
    ...
    def api215_audits_get_with_http_info(
        ...
        _param = self._api215_audits_get_serialize(
    ...
    def _api215_audits_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
