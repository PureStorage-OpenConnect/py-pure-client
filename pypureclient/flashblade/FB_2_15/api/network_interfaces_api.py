...
from pypureclient.flashblade.FB_2_15.models.network_interface import NetworkInterface
from pypureclient.flashblade.FB_2_15.models.network_interface_get_response import NetworkInterfaceGetResponse
from pypureclient.flashblade.FB_2_15.models.network_interface_patch import NetworkInterfacePatch
from pypureclient.flashblade.FB_2_15.models.network_interface_ping_get_response import NetworkInterfacePingGetResponse
from pypureclient.flashblade.FB_2_15.models.network_interface_response import NetworkInterfaceResponse
from pypureclient.flashblade.FB_2_15.models.network_interface_trace_get_response import NetworkInterfaceTraceGetResponse
...
class NetworkInterfacesApi:
    ...
    def api215_network_interfaces_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_network_interfaces_delete_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api215_network_interfaces_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_network_interfaces_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_network_interfaces_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_network_interfaces_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_network_interfaces_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_network_interfaces_patch_with_http_info(network_interface, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_network_interfaces_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_network_interfaces_ping_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api215_network_interfaces_ping_get_with_http_info(destination, x_request_id, component_name, count, packet_size, print_latency, resolve_hostname, source, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_network_interfaces_ping_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.15/network-interfaces/ping', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api215_network_interfaces_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_network_interfaces_post_with_http_info(names, network_interface, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_network_interfaces_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_network_interfaces_trace_get_with_http_info(
        self,
        destination: Annotated[StrictStr, Field(..., description="A destination specified by user to run the network diagnosis against. Can be a hostname or an IP.")],
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        component_name: Annotated[Optional[StrictStr], Field(description="Used by ping and trace to specify where to run the operation. Valid values are controllers and blades from hardware list. If not specified, defaults to all available controllers and selected blades.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api215_network_interfaces_trace_get_with_http_info(destination, x_request_id, component_name, discover_mtu, fragment_packet, method, port, resolve_hostname, source, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_network_interfaces_trace_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.15/network-interfaces/trace', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
