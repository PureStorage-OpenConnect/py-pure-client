...
class CertificateGroupsApi:
    ...
    def api215_certificate_groups_certificates_delete_with_http_info(
        ...
        _param = self._api215_certificate_groups_certificates_delete_serialize(
    ...
    def _api215_certificate_groups_certificates_delete_serialize(
        self,
        x_request_id,
        certificate_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/certificate-groups/certificates',
    ...
    def api215_certificate_groups_certificates_get_with_http_info(
        ...
        _param = self._api215_certificate_groups_certificates_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_certificate_groups_certificates_get_serialize(
        self,
        x_request_id,
        continuation_token,
        certificate_ids,
    ...
    def api215_certificate_groups_certificates_post_with_http_info(
        ...
        _param = self._api215_certificate_groups_certificates_post_serialize(
            x_request_id = x_request_id,
            certificate_ids = certificate_ids,
            certificate_group_ids = certificate_group_ids,
            certificate_group_names = certificate_group_names,
    ...
    def _api215_certificate_groups_certificates_post_serialize(
        self,
        x_request_id,
        certificate_ids,
        certificate_group_ids,
    ...
    def api215_certificate_groups_delete_with_http_info(
        ...
        _param = self._api215_certificate_groups_delete_serialize(
            x_request_id = x_request_id,
            ids = ids,
            names = names,
        )
    ...
    def _api215_certificate_groups_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/certificate-groups',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api215_certificate_groups_get_with_http_info(
        ...
        _param = self._api215_certificate_groups_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
    ...
    def _api215_certificate_groups_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_certificate_groups_post_with_http_info(
        ...
        _param = self._api215_certificate_groups_post_serialize(
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api215_certificate_groups_post_serialize(
        self,
        x_request_id,
        names,
    ) -> RequestSerialized:
    ...
    def api215_certificate_groups_uses_get_with_http_info(
        ...
        _param = self._api215_certificate_groups_uses_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
    ...
    def _api215_certificate_groups_uses_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/certificate-groups/uses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
