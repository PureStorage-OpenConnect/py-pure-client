...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_15.models.verification_key_get_response import VerificationKeyGetResponse
from pypureclient.flashblade.FB_2_15.models.verification_key_patch import VerificationKeyPatch
from pypureclient.flashblade.FB_2_15.models.verification_key_response import VerificationKeyResponse
...
class VerificationKeysApi:
    ...
    @validate_call
    def api215_support_verification_keys_get_with_http_info(
        self,
        ...
        _param = self._api215_support_verification_keys_get_serialize(
    ...
    def _api215_support_verification_keys_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/support/verification-keys',
    ...
    @validate_call
    def api215_support_verification_keys_patch_with_http_info(
        self,
        ...
        _param = self._api215_support_verification_keys_patch_serialize(
            key = key,
            x_request_id = x_request_id,
        )
    ...
    def _api215_support_verification_keys_patch_serialize(
        self,
        key,
        x_request_id,
    ) -> RequestSerialized:
