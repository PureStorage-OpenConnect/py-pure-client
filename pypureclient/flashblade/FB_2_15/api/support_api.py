...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_15.models.support import Support
from pypureclient.flashblade.FB_2_15.models.support_get_response import SupportGetResponse
from pypureclient.flashblade.FB_2_15.models.support_response import SupportResponse
...
class SupportApi:
    ...
    def api215_support_get_with_http_info(
        ...
        _param = self._api215_support_get_serialize(
    ...
    def _api215_support_get_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/support',
    ...
    def api215_support_patch_with_http_info(
        ...
        _param = self._api215_support_patch_serialize(
            support = support,
            x_request_id = x_request_id,
        )
    ...
    def _api215_support_patch_serialize(
        self,
        support,
        x_request_id,
    ) -> RequestSerialized:
    ...
    def api215_support_test_get_with_http_info(
        ...
        _param = self._api215_support_test_get_serialize(
            x_request_id = x_request_id,
            filter = filter,
            sort = sort,
            test_type = test_type,
    ...
    def _api215_support_test_get_serialize(
        self,
        x_request_id,
        filter,
        sort,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/support/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
