...
class SupportApi:
    ...
    def api215_support_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_support_get_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api215_support_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_support_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_support_patch_with_http_info(support, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_support_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_support_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_support_test_get_with_http_info(x_request_id, filter, sort, test_type, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_support_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
