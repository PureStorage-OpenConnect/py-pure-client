...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_15.models.blade_get_response import BladeGetResponse
...
class BladesApi:
    ...
    @validate_call
    def api215_blades_get_with_http_info(
        self,
        ...
        _param = self._api215_blades_get_serialize(
    ...
    def _api215_blades_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
