...
class APIClientsApi:
    ...
    def api215_api_clients_delete_with_http_info(
        ...
        _param = self._api215_api_clients_delete_serialize(
    ...
    def _api215_api_clients_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/api-clients',
    ...
    def api215_api_clients_get_with_http_info(
        ...
        _param = self._api215_api_clients_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_api_clients_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_api_clients_patch_with_http_info(
        ...
        _param = self._api215_api_clients_patch_serialize(
    ...
    def _api215_api_clients_patch_serialize(
        self,
        api_clients,
        x_request_id,
        ids,
    ...
    def api215_api_clients_post_with_http_info(
        ...
        _param = self._api215_api_clients_post_serialize(
    ...
    def _api215_api_clients_post_serialize(
        self,
        api_client,
        x_request_id,
        names,
