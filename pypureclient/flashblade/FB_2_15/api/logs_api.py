...
class LogsApi:
    ...
    def api215_logs_async_download_get_with_http_info(
        ...
        _param = self._api215_logs_async_download_get_serialize(
    ...
    def _api215_logs_async_download_get_serialize(
        self,
        x_request_id,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/logs-async/download',
    ...
    def api215_logs_async_get_with_http_info(
        ...
        _param = self._api215_logs_async_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_logs_async_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/logs-async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api215_logs_async_patch_with_http_info(
        ...
        _param = self._api215_logs_async_patch_serialize(
    ...
    def _api215_logs_async_patch_serialize(
        self,
        logs_async,
        x_request_id,
    ) -> RequestSerialized:
    ...
    def api215_logs_get_with_http_info(
        ...
        _param = self._api215_logs_get_serialize(
            x_request_id = x_request_id,
            end_time = end_time,
    ...
    def _api215_logs_get_serialize(
        self,
        x_request_id,
        end_time,
        start_time,
