...
from pypureclient.flashblade.FB_2_15.models.logs_async_get_response import LogsAsyncGetResponse
from pypureclient.flashblade.FB_2_15.models.logs_async_response import LogsAsyncResponse
...
class LogsApi:
    ...
    def api215_logs_async_download_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_logs_async_download_get_with_http_info(x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api215_logs_async_download_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_logs_async_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_logs_async_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_logs_async_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_logs_async_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_logs_async_patch_with_http_info(logs_async, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_logs_async_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_logs_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_logs_get_with_http_info(x_request_id, end_time, start_time, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_logs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
