...
class SAML2SSOApi:
    ...
    def api215_sso_saml2_idps_delete_with_http_info(
        ...
        _param = self._api215_sso_saml2_idps_delete_serialize(
    ...
    def _api215_sso_saml2_idps_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/sso/saml2/idps',
    ...
    def api215_sso_saml2_idps_get_with_http_info(
        ...
        _param = self._api215_sso_saml2_idps_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_sso_saml2_idps_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_sso_saml2_idps_patch_with_http_info(
        ...
        _param = self._api215_sso_saml2_idps_patch_serialize(
            idp = idp,
            x_request_id = x_request_id,
            ids = ids,
            names = names,
    ...
    def _api215_sso_saml2_idps_patch_serialize(
        self,
        idp,
        x_request_id,
        ids,
    ...
    def api215_sso_saml2_idps_post_with_http_info(
        ...
        _param = self._api215_sso_saml2_idps_post_serialize(
            names = names,
            idp = idp,
            x_request_id = x_request_id,
        )
    ...
    def _api215_sso_saml2_idps_post_serialize(
        self,
        names,
        idp,
        x_request_id,
