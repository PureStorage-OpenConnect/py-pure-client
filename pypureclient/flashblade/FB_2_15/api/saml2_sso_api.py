...
class SAML2SSOApi(object):
    ...
    def api215_sso_saml2_idps_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api215_sso_saml2_idps_get`, must be a value greater than or equal to `1`")
