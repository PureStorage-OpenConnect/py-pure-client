...
from pypureclient.flashblade.FB_2_15.models.saml2_sso import Saml2Sso
from pypureclient.flashblade.FB_2_15.models.saml2_sso_get_response import Saml2SsoGetResponse
from pypureclient.flashblade.FB_2_15.models.saml2_sso_post import Saml2SsoPost
from pypureclient.flashblade.FB_2_15.models.saml2_sso_response import Saml2SsoResponse
...
class SAML2SSOApi:
    ...
    def api215_sso_saml2_idps_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_sso_saml2_idps_delete_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api215_sso_saml2_idps_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_sso_saml2_idps_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_sso_saml2_idps_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_sso_saml2_idps_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_sso_saml2_idps_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_sso_saml2_idps_patch_with_http_info(idp, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_sso_saml2_idps_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_sso_saml2_idps_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_sso_saml2_idps_post_with_http_info(names, idp, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_sso_saml2_idps_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
