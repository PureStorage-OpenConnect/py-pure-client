...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_15.models.session_get_response import SessionGetResponse
...
class SessionsApi:
    ...
    def api215_sessions_get_with_http_info(
        ...
        _param = self._api215_sessions_get_serialize(
    ...
    def _api215_sessions_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/sessions',
