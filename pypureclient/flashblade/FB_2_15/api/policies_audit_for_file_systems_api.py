...
class PoliciesAuditForFileSystemsApi:
    ...
    def api215_audit_file_systems_policies_delete_with_http_info(
        ...
        _param = self._api215_audit_file_systems_policies_delete_serialize(
    ...
    def _api215_audit_file_systems_policies_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/audit-file-systems-policies',
    ...
    def api215_audit_file_systems_policies_get_with_http_info(
        ...
        _param = self._api215_audit_file_systems_policies_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_audit_file_systems_policies_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_audit_file_systems_policies_members_delete_with_http_info(
        ...
        _param = self._api215_audit_file_systems_policies_members_delete_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_audit_file_systems_policies_members_delete_serialize(
        self,
        x_request_id,
        member_ids,
        member_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/audit-file-systems-policies/members',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api215_audit_file_systems_policies_members_get_with_http_info(
        ...
        _param = self._api215_audit_file_systems_policies_members_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
    ...
    def _api215_audit_file_systems_policies_members_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_audit_file_systems_policies_members_post_with_http_info(
        ...
        _param = self._api215_audit_file_systems_policies_members_post_serialize(
            x_request_id = x_request_id,
            member_ids = member_ids,
            member_names = member_names,
            policy_ids = policy_ids,
    ...
    def _api215_audit_file_systems_policies_members_post_serialize(
        self,
        x_request_id,
        member_ids,
        member_names,
    ...
    def api215_audit_file_systems_policies_patch_with_http_info(
        ...
        _param = self._api215_audit_file_systems_policies_patch_serialize(
            policy = policy,
            x_request_id = x_request_id,
            ids = ids,
            names = names,
    ...
    def _api215_audit_file_systems_policies_patch_serialize(
        self,
        policy,
        x_request_id,
        ids,
    ...
    def api215_audit_file_systems_policies_post_with_http_info(
        ...
        _param = self._api215_audit_file_systems_policies_post_serialize(
            names = names,
            x_request_id = x_request_id,
            policy = policy,
        )
    ...
    def _api215_audit_file_systems_policies_post_serialize(
        self,
        names,
        x_request_id,
        policy,
