...
class PoliciesNetworkAccessApi:
    ...
    def api215_network_access_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_network_access_policies_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api215_network_access_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_network_access_policies_members_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_network_access_policies_members_get_with_http_info(x_request_id, continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_network_access_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_network_access_policies_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_network_access_policies_patch_with_http_info(policy, x_request_id, ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_network_access_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_network_access_policies_rules_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_network_access_policies_rules_delete_with_http_info(x_request_id, ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_network_access_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_network_access_policies_rules_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_network_access_policies_rules_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_network_access_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_network_access_policies_rules_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_network_access_policies_rules_patch_with_http_info(rule, x_request_id, before_rule_id, before_rule_name, ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_network_access_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_network_access_policies_rules_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_network_access_policies_rules_post_with_http_info(rule, x_request_id, before_rule_id, before_rule_name, policy_ids, policy_names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_network_access_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
