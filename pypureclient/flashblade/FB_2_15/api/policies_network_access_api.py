...
from pypureclient.flashblade.FB_2_15.models.network_access_policy_get_response import NetworkAccessPolicyGetResponse
from pypureclient.flashblade.FB_2_15.models.network_access_policy_response import NetworkAccessPolicyResponse
from pypureclient.flashblade.FB_2_15.models.network_access_policy_rule import NetworkAccessPolicyRule
from pypureclient.flashblade.FB_2_15.models.network_access_policy_rule_get_response import NetworkAccessPolicyRuleGetResponse
from pypureclient.flashblade.FB_2_15.models.network_access_policy_rule_post import NetworkAccessPolicyRulePost
from pypureclient.flashblade.FB_2_15.models.network_access_policy_rule_response import NetworkAccessPolicyRuleResponse
...
class PoliciesNetworkAccessApi:
    ...
    def api215_network_access_policies_get_with_http_info(
        ...
        _param = self._api215_network_access_policies_get_serialize(
    ...
    def _api215_network_access_policies_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/network-access-policies',
    ...
    def api215_network_access_policies_members_get_with_http_info(
        ...
        _param = self._api215_network_access_policies_members_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
    ...
    def _api215_network_access_policies_members_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/network-access-policies/members',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api215_network_access_policies_patch_with_http_info(
        ...
        _param = self._api215_network_access_policies_patch_serialize(
            policy = policy,
            x_request_id = x_request_id,
            ids = ids,
            names = names,
    ...
    def _api215_network_access_policies_patch_serialize(
        self,
        policy,
        x_request_id,
        ids,
    ...
    def api215_network_access_policies_rules_delete_with_http_info(
        ...
        _param = self._api215_network_access_policies_rules_delete_serialize(
            x_request_id = x_request_id,
            ids = ids,
            names = names,
            versions = versions,
    ...
    def _api215_network_access_policies_rules_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/network-access-policies/rules',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api215_network_access_policies_rules_get_with_http_info(
        ...
        _param = self._api215_network_access_policies_rules_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
    ...
    def _api215_network_access_policies_rules_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_network_access_policies_rules_patch_with_http_info(
        ...
        _param = self._api215_network_access_policies_rules_patch_serialize(
            rule = rule,
            x_request_id = x_request_id,
    ...
    def _api215_network_access_policies_rules_patch_serialize(
        self,
        rule,
        x_request_id,
        before_rule_id,
    ...
    def api215_network_access_policies_rules_post_with_http_info(
        ...
        _param = self._api215_network_access_policies_rules_post_serialize(
            rule = rule,
            x_request_id = x_request_id,
            before_rule_id = before_rule_id,
            before_rule_name = before_rule_name,
    ...
    def _api215_network_access_policies_rules_post_serialize(
        self,
        rule,
        x_request_id,
        before_rule_id,
