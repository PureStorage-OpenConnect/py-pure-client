...
from pypureclient.flashblade.FB_2_15.models.smb_share_policy_get_response import SmbSharePolicyGetResponse
from pypureclient.flashblade.FB_2_15.models.smb_share_policy_post import SmbSharePolicyPost
from pypureclient.flashblade.FB_2_15.models.smb_share_policy_response import SmbSharePolicyResponse
from pypureclient.flashblade.FB_2_15.models.smb_share_policy_rule import SmbSharePolicyRule
from pypureclient.flashblade.FB_2_15.models.smb_share_policy_rule_get_response import SmbSharePolicyRuleGetResponse
from pypureclient.flashblade.FB_2_15.models.smb_share_policy_rule_post import SmbSharePolicyRulePost
from pypureclient.flashblade.FB_2_15.models.smb_share_policy_rule_response import SmbSharePolicyRuleResponse
...
class PoliciesSMBShareApi:
    ...
    def api215_smb_share_policies_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_smb_share_policies_delete_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api215_smb_share_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_smb_share_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_smb_share_policies_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_smb_share_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_smb_share_policies_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_smb_share_policies_patch_with_http_info(policy, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_smb_share_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_smb_share_policies_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_smb_share_policies_post_with_http_info(names, x_request_id, policy, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_smb_share_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_smb_share_policies_rules_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_smb_share_policies_rules_delete_with_http_info(x_request_id, ids, names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_smb_share_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_smb_share_policies_rules_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_smb_share_policies_rules_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_smb_share_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_smb_share_policies_rules_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_smb_share_policies_rules_patch_with_http_info(rule, x_request_id, ids, names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_smb_share_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_smb_share_policies_rules_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_smb_share_policies_rules_post_with_http_info(rule, x_request_id, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_smb_share_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
