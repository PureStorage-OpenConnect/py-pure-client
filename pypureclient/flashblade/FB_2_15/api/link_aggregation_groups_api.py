...
class LinkAggregationGroupsApi:
    ...
    def api215_link_aggregation_groups_delete_with_http_info(
        ...
        _param = self._api215_link_aggregation_groups_delete_serialize(
    ...
    def _api215_link_aggregation_groups_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/link-aggregation-groups',
    ...
    def api215_link_aggregation_groups_get_with_http_info(
        ...
        _param = self._api215_link_aggregation_groups_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_link_aggregation_groups_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_link_aggregation_groups_patch_with_http_info(
        ...
        _param = self._api215_link_aggregation_groups_patch_serialize(
    ...
    def _api215_link_aggregation_groups_patch_serialize(
        self,
    ...
    def api215_link_aggregation_groups_post_with_http_info(
        ...
        _param = self._api215_link_aggregation_groups_post_serialize(
            names = names,
            link_aggregation_group = link_aggregation_group,
            x_request_id = x_request_id,
        )
    ...
    def _api215_link_aggregation_groups_post_serialize(
        self,
        names,
        link_aggregation_group,
        x_request_id,
