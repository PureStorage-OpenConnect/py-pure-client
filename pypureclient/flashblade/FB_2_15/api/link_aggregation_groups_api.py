...
from pypureclient.flashblade.FB_2_15.models.api215_link_aggregation_groups_patch_request import Api215LinkAggregationGroupsPatchRequest
from pypureclient.flashblade.FB_2_15.models.link_aggregation_group import LinkAggregationGroup
from pypureclient.flashblade.FB_2_15.models.link_aggregation_group_get_response import LinkAggregationGroupGetResponse
from pypureclient.flashblade.FB_2_15.models.link_aggregation_group_response import LinkAggregationGroupResponse
...
class LinkAggregationGroupsApi:
    ...
    def api215_link_aggregation_groups_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api215_link_aggregation_groups_delete_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api215_link_aggregation_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.15/link-aggregation-groups', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api215_link_aggregation_groups_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api215_link_aggregation_groups_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_link_aggregation_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.15/link-aggregation-groups', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api215_link_aggregation_groups_patch_with_http_info(
        self,
        link_aggregation_group: Api215LinkAggregationGroupsPatchRequest,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        **kwargs
        ...
        >>> thread = api.api215_link_aggregation_groups_patch_with_http_info(link_aggregation_group, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()

        :param link_aggregation_group: (required)
        :type link_aggregation_group: Api215LinkAggregationGroupsPatchRequest
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        :param ids: A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.
        :type ids: List[str]
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_link_aggregation_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.15/link-aggregation-groups', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api215_link_aggregation_groups_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api215_link_aggregation_groups_post_with_http_info(names, link_aggregation_group, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_link_aggregation_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.15/link-aggregation-groups', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
