...
from pypureclient.flashblade.FB_2_15.models.alert_watcher import AlertWatcher
from pypureclient.flashblade.FB_2_15.models.alert_watcher_get_response import AlertWatcherGetResponse
from pypureclient.flashblade.FB_2_15.models.alert_watcher_post import AlertWatcherPost
from pypureclient.flashblade.FB_2_15.models.alert_watcher_response import AlertWatcherResponse
...
class AlertWatchersApi:
    ...
    def api215_alert_watchers_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_alert_watchers_delete_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api215_alert_watchers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_alert_watchers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_alert_watchers_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_alert_watchers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_alert_watchers_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_alert_watchers_patch_with_http_info(alert_watcher, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_alert_watchers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_alert_watchers_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_alert_watchers_post_with_http_info(names, x_request_id, alert_watcher, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_alert_watchers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api215_alert_watchers_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api215_alert_watchers_test_get_with_http_info(x_request_id, filter, ids, names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_alert_watchers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
