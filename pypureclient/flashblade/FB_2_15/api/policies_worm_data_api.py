...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_15.models.worm_data_policies_get_response import WormDataPoliciesGetResponse
...
from pypureclient.flashblade.FB_2_15.models.worm_data_policies_response import WormDataPoliciesResponse
...
class PoliciesWORMDataApi:
    ...
    def api215_worm_data_policies_delete_with_http_info(
        ...
        _param = self._api215_worm_data_policies_delete_serialize(
    ...
    def _api215_worm_data_policies_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/worm-data-policies',
    ...
    def api215_worm_data_policies_get_with_http_info(
        ...
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[WormDataPoliciesGetResponse]:
        ...
        _param = self._api215_worm_data_policies_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_worm_data_policies_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_worm_data_policies_members_get_with_http_info(
        ...
        _param = self._api215_worm_data_policies_members_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
    ...
    def _api215_worm_data_policies_members_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/worm-data-policies/members',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api215_worm_data_policies_patch_with_http_info(
        ...
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[WormDataPoliciesResponse]:
        ...
        _param = self._api215_worm_data_policies_patch_serialize(
            x_request_id = x_request_id,
            ids = ids,
            names = names,
            policy = policy,
    ...
    def _api215_worm_data_policies_patch_serialize(
        self,
        x_request_id,
        ids,
        names,
    ...
    def api215_worm_data_policies_post_with_http_info(
        ...
        _param = self._api215_worm_data_policies_post_serialize(
            names = names,
            x_request_id = x_request_id,
            policy = policy,
        )
    ...
    def _api215_worm_data_policies_post_serialize(
        self,
        names,
        x_request_id,
        policy,
