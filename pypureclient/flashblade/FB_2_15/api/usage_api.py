...
class UsageApi:
    ...
    def api215_usage_groups_get_with_http_info(
        ...
        _param = self._api215_usage_groups_get_serialize(
    ...
    def _api215_usage_groups_get_serialize(
        self,
        x_request_id,
        continuation_token,
        file_system_ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/usage/groups',
    ...
    def api215_usage_users_get_with_http_info(
        ...
        _param = self._api215_usage_users_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            file_system_ids = file_system_ids,
            file_system_names = file_system_names,
    ...
    def _api215_usage_users_get_serialize(
        self,
        x_request_id,
        continuation_token,
        file_system_ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.15/usage/users',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
