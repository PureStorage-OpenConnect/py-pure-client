...
class ObjectStoreVirtualHostsApi:
    ...
    def api215_object_store_virtual_hosts_delete_with_http_info(
        ...
        _param = self._api215_object_store_virtual_hosts_delete_serialize(
    ...
    def _api215_object_store_virtual_hosts_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.15/object-store-virtual-hosts',
    ...
    def api215_object_store_virtual_hosts_get_with_http_info(
        ...
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[ObjectStoreVirtualHostGetResponse]:
        ...
        _param = self._api215_object_store_virtual_hosts_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api215_object_store_virtual_hosts_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api215_object_store_virtual_hosts_post_with_http_info(
        ...
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[ObjectStoreVirtualHostResponse]:
        ...
        _param = self._api215_object_store_virtual_hosts_post_serialize(
            names = names,
            x_request_id = x_request_id,
        )
    ...
    def _api215_object_store_virtual_hosts_post_serialize(
        self,
        names,
        x_request_id,
    ) -> RequestSerialized:
