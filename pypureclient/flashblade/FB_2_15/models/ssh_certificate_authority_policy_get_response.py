...
class SshCertificateAuthorityPolicyGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[SshCertificateAuthorityPolicy]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.SshCertificateAuthorityPolicy]
    ):
        """
        Keyword args:
            ...
            items (list[SshCertificateAuthorityPolicy]): A list of SSH certificate authority policy objects.
        """
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `SshCertificateAuthorityPolicyGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(SshCertificateAuthorityPolicyGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SshCertificateAuthorityPolicyGetResponse):
            return False
