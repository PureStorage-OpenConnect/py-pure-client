...
class Space(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data_reduction", "snapshots", "total_physical", "unique", "virtual", "total_provisioned", "available_provisioned", "available_ratio", "destroyed", "destroyed_virtual", "shared"]
