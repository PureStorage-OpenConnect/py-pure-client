...
class Space(BaseModel):
    ...
    __properties = ["available_provisioned", "available_ratio", "data_reduction", "destroyed", "destroyed_virtual", "shared", "snapshots", "total_physical", "total_provisioned", "unique", "virtual"]
