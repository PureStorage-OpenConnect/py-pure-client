...
class ObjectStoreRemoteCredentialsPost(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreRemoteCredentialsPost:
        """Create an instance of ObjectStoreRemoteCredentialsPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreRemoteCredentialsPost:
        """Create an instance of ObjectStoreRemoteCredentialsPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreRemoteCredentialsPost.parse_obj(obj)

        _obj = ObjectStoreRemoteCredentialsPost.construct(_fields_set=None, **{
