...
class AdminPost(BaseModel):
    ...
    role: Optional[ReferenceWritable] = Field(default=None, description="A reference to this administrator's management role.")
    __properties = ["password", "public_key", "role"]
