...
class SyslogServerPostOrPatch(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyslogServerPostOrPatch:
        """Create an instance of SyslogServerPostOrPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SyslogServerPostOrPatch:
        """Create an instance of SyslogServerPostOrPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyslogServerPostOrPatch.parse_obj(obj)

        _obj = SyslogServerPostOrPatch.construct(_fields_set=None, **{
            "uri": obj.get("uri")
        })
        return _obj
