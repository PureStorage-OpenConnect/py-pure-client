...
from pypureclient.flashblade.FB_2_15.models.target import Target
...
class TargetGetResponse(BaseModel):
    ...
    items: Optional[conlist(Target)] = Field(default=None, description="A list of target objects.")
    ...
    def from_dict(cls, obj: dict) -> TargetGetResponse:
        ...
        _obj = TargetGetResponse.construct(_fields_set=None, **{
            ...
            "items": [Target.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
