...
class LifecycleRuleGetResponse(BaseModel):
    ...
    items: Optional[List[LifecycleRule]] = Field(default=None, description="A list of lifecycle rule objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [LifecycleRule.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
