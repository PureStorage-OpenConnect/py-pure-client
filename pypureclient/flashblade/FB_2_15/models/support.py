...
from pypureclient.flashblade.FB_2_15.models.support_remote_assist_paths import SupportRemoteAssistPaths
...
class Support(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "phonehome_enabled", "proxy", "remote_assist_active", "remote_assist_opened", "remote_assist_expires", "remote_assist_status", "remote_assist_paths", "remote_assist_duration"]
