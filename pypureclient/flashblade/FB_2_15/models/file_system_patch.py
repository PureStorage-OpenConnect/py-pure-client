...
from pypureclient.flashblade.FB_2_15.models.fixed_location_reference import FixedLocationReference
...
from pypureclient.flashblade.FB_2_15.models.nfs_patch import NfsPatch
...
class FileSystemPatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "created", "default_group_quota", "default_user_quota", "destroyed", "fast_remove_directory_enabled", "hard_limit_enabled", "http", "multi_protocol", "nfs", "provisioned", "promotion_status", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "time_remaining", "writable", "group_ownership"]
