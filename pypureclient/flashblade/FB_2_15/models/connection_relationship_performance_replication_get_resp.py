...
class ConnectionRelationshipPerformanceReplicationGetResp(BaseModel):
    ...
    items: Optional[List[ConnectionRelationshipPerformanceReplication]] = None
    total: Optional[List[ConnectionRelationshipPerformanceReplication]] = Field(default=None, description="Total of all records after filtering. If `total_only` query param is `true`, then no items will be returned.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [ConnectionRelationshipPerformanceReplication.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": [ConnectionRelationshipPerformanceReplication.from_dict(_item) for _item in obj["total"]] if obj.get("total") is not None else None
        })
        return _obj
