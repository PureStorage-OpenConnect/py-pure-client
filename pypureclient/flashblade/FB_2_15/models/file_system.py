...
from pypureclient.flashblade.FB_2_15.models.file_system_eradication_config import FileSystemEradicationConfig
from pypureclient.flashblade.FB_2_15.models.http import Http
from pypureclient.flashblade.FB_2_15.models.location_reference import LocationReference
from pypureclient.flashblade.FB_2_15.models.multi_protocol import MultiProtocol
from pypureclient.flashblade.FB_2_15.models.nfs import Nfs
from pypureclient.flashblade.FB_2_15.models.smb import Smb
...
class FileSystem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "created", "default_group_quota", "default_user_quota", "destroyed", "fast_remove_directory_enabled", "hard_limit_enabled", "http", "multi_protocol", "nfs", "provisioned", "promotion_status", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "space", "time_remaining", "writable", "group_ownership", "eradication_config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "eradication_config": FileSystemEradicationConfig.from_dict(obj["eradication_config"]) if obj.get("eradication_config") is not None else None
        })
        return _obj
