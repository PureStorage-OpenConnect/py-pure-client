...
class PublicAccessConfig(BaseModel):
    ...
    __properties = ["block_new_public_policies", "block_public_access"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicAccessConfig:
        """Create an instance of PublicAccessConfig from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PublicAccessConfig:
        """Create an instance of PublicAccessConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicAccessConfig.parse_obj(obj)

        _obj = PublicAccessConfig.construct(_fields_set=None, **{
