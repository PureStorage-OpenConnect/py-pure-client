...
class FileSystemSnapshotGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        items=None,  # type: List[models.FileSystemSnapshot]
        total=None,  # type: models.FileSystemSnapshot
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `FileSystemSnapshotGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(FileSystemSnapshotGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileSystemSnapshotGetResponse):
            return False
