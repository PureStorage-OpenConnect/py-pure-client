...
class FileSystemPerformanceGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[FileSystemPerformance]',
        'total': 'list[FileSystemPerformance]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.FileSystemPerformance]
        total=None,  # type: List[models.FileSystemPerformance]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `FileSystemPerformanceGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(FileSystemPerformanceGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileSystemPerformanceGetResponse):
            return False
