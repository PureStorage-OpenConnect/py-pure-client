...
from pypureclient.flashblade.FB_2_15.models.admin_cache import AdminCache


class AdminCacheGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(AdminCache)] = Field(default=None, description="A list of admin cache entries.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdminCacheGetResponse:
        """Create an instance of AdminCacheGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AdminCacheGetResponse:
        """Create an instance of AdminCacheGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdminCacheGetResponse.parse_obj(obj)

        _obj = AdminCacheGetResponse.construct(_fields_set=None, **{
