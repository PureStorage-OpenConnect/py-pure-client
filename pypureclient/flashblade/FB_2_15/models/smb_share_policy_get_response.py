...
class SmbSharePolicyGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        items=None,  # type: List[models.SmbSharePolicy]
    ):
        """
        Keyword args:
            ...
            items (list[SmbSharePolicy]): A list of SMB Share policy objects.
        """
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `SmbSharePolicyGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(SmbSharePolicyGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SmbSharePolicyGetResponse):
            return False
