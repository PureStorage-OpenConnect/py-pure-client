...
from pypureclient.flashblade.FB_2_19.models.dns import Dns
from pypureclient.flashblade.FB_2_19.models.dns_get_response import DnsGetResponse
from pypureclient.flashblade.FB_2_19.models.dns_post import DnsPost
from pypureclient.flashblade.FB_2_19.models.dns_response import DnsResponse
from typing import Optional
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api219_dns_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_dns_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_dns_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
