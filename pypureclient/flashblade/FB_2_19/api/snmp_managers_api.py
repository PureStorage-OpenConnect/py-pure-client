...
from pypureclient.flashblade.FB_2_19.models.snmp_manager import SnmpManager
from pypureclient.flashblade.FB_2_19.models.snmp_manager_get_response import SnmpManagerGetResponse
from pypureclient.flashblade.FB_2_19.models.snmp_manager_post import SnmpManagerPost
from pypureclient.flashblade.FB_2_19.models.snmp_manager_response import SnmpManagerResponse
from pypureclient.flashblade.FB_2_19.models.test_result_get_response import TestResultGetResponse
from typing import Optional
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api219_snmp_managers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_snmp_managers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_snmp_managers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_snmp_managers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_snmp_managers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
