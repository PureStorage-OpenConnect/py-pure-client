...
from pypureclient.flashblade.FB_2_19.models.server_get_response import ServerGetResponse
from pypureclient.flashblade.FB_2_19.models.server_post import ServerPost
from pypureclient.flashblade.FB_2_19.models.server_response import ServerResponse
from typing import Optional
...
class ServersApi:
    ...
    def api219_servers_delete_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api219_servers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api219_servers_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api219_servers_patch_with_http_info(
        self,
        server: ServerPost,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api219_servers_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_servers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
