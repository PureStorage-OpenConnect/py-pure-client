...
from pypureclient.flashblade.FB_2_19.models.role_get_response import RoleGetResponse
from typing import Optional
...
class RolesApi:
    ...
    def api219_roles_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api219_roles_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
