...
from pypureclient.flashblade.FB_2_19.models.software_checks_get_response import SoftwareChecksGetResponse
from pypureclient.flashblade.FB_2_19.models.software_checks_response import SoftwareChecksResponse
from typing import Optional
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api219_software_check_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_software_check_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
