...
from pypureclient.flashblade.FB_2_19.models.array_erasure_get_response import ArrayErasureGetResponse
from pypureclient.flashblade.FB_2_19.models.array_erasure_response import ArrayErasureResponse
from pypureclient.flashblade.FB_2_19.models.array_factory_reset_token_get_response import ArrayFactoryResetTokenGetResponse
from pypureclient.flashblade.FB_2_19.models.array_factory_reset_token_response import ArrayFactoryResetTokenResponse
from pypureclient.flashblade.FB_2_19.models.array_get_response import ArrayGetResponse
from pypureclient.flashblade.FB_2_19.models.array_http_specific_performance_get import ArrayHttpSpecificPerformanceGet
from pypureclient.flashblade.FB_2_19.models.array_nfs_specific_performance_get import ArrayNfsSpecificPerformanceGet
from pypureclient.flashblade.FB_2_19.models.array_performance_get_response import ArrayPerformanceGetResponse
from pypureclient.flashblade.FB_2_19.models.array_performance_replication_get_resp import ArrayPerformanceReplicationGetResp
from pypureclient.flashblade.FB_2_19.models.array_response import ArrayResponse
from pypureclient.flashblade.FB_2_19.models.array_s3_specific_performance_get_resp import ArrayS3SpecificPerformanceGetResp
from pypureclient.flashblade.FB_2_19.models.array_space_get_response import ArraySpaceGetResponse
from pypureclient.flashblade.FB_2_19.models.array_space_storage_class_get_response import ArraySpaceStorageClassGetResponse
from pypureclient.flashblade.FB_2_19.models.arrays_supported_time_zones_get_response import ArraysSupportedTimeZonesGetResponse
from pypureclient.flashblade.FB_2_19.models.eula import Eula
from pypureclient.flashblade.FB_2_19.models.eula_get_response import EulaGetResponse
from pypureclient.flashblade.FB_2_19.models.eula_response import EulaResponse
from typing import Optional
...
class ArraysApi:
    ...
    def api219_arrays_erasures_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api219_arrays_erasures_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.19/arrays/erasures', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api219_arrays_erasures_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_arrays_erasures_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api219_arrays_erasures_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_arrays_erasures_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.19/arrays/erasures', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api219_arrays_erasures_post_with_http_info(
        self,
        eradicate_all_data: Annotated[StrictBool, Field(..., description="Set to `true` to perform a factory reset.")],
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_arrays_erasures_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api219_arrays_http_specific_performance_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_arrays_http_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.19/arrays/http-specific-performance', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api219_arrays_nfs_specific_performance_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique contexts specified. If specified, each context name must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`. Enter multiple names in comma-separated format. For example, `name01,name02`.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_arrays_nfs_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.19/arrays/nfs-specific-performance', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api219_arrays_performance_replication_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique contexts specified. If specified, each context name must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`. Enter multiple names in comma-separated format. For example, `name01,name02`.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_arrays_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.19/arrays/performance/replication', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api219_arrays_s3_specific_performance_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique contexts specified. If specified, each context name must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`. Enter multiple names in comma-separated format. For example, `name01,name02`.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_arrays_s3_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.19/arrays/s3-specific-performance', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api219_arrays_space_storage_classes_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="A token used to retrieve the next page of data with some consistency guaranteed. The token is a Base64 encoded value. Set `continuation_token` to the system-generated token taken from the `x-next-token` header field of the response. A query has reached its last page when the response does not include a token. Pagination requires the `limit` and `continuation_token` query parameters.")] = None,
        end_time: Annotated[Optional[conint(strict=True, ge=0)], Field(description="When the time window ends (in milliseconds since epoch).")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_arrays_space_storage_classes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.19/arrays/space/storage-classes', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api219_arrays_supported_time_zones_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="A token used to retrieve the next page of data with some consistency guaranteed. The token is a Base64 encoded value. Set `continuation_token` to the system-generated token taken from the `x-next-token` header field of the response. A query has reached its last page when the response does not include a token. Pagination requires the `limit` and `continuation_token` query parameters.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Narrows down the results to only the response objects that satisfy the filter criteria.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api219_arrays_supported_time_zones_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.19/arrays/supported-time-zones', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
