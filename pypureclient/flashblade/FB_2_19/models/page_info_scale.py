...
class PageInfoScale(BaseModel):
    ...
    __properties = ["continuation_token", "total_item_count", "more_items_remaining"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageInfoScale:
        """Create an instance of PageInfoScale from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PageInfoScale:
        """Create an instance of PageInfoScale from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageInfoScale.parse_obj(obj)

        _obj = PageInfoScale.construct(_fields_set=None, **{
