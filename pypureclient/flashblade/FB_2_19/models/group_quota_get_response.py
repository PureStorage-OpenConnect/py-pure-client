...
from pypureclient.flashblade.FB_2_19.models.group_quota import GroupQuota


class GroupQuotaGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(GroupQuota)] = Field(default=None, description="A list of quota objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupQuotaGetResponse:
        """Create an instance of GroupQuotaGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> GroupQuotaGetResponse:
        """Create an instance of GroupQuotaGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GroupQuotaGetResponse.parse_obj(obj)

        _obj = GroupQuotaGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [GroupQuota.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
