...
from pypureclient.flashblade.FB_2_19.models.bucket_eradication_config import BucketEradicationConfig
from pypureclient.flashblade.FB_2_19.models.object_lock_config_request_body import ObjectLockConfigRequestBody
from pypureclient.flashblade.FB_2_19.models.public_access_config import PublicAccessConfig
...
class BucketPatch(BaseModel):
    ...
    __properties = ["destroyed", "eradication_config", "hard_limit_enabled", "object_lock_config", "public_access_config", "quota_limit", "retention_lock", "storage_class", "versioning"]
