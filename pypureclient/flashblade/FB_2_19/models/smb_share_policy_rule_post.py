...
class SmbSharePolicyRulePost(BaseModel):
    ...
    __properties = ["id", "name", "change", "full_control", "principal", "read"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmbSharePolicyRulePost:
        """Create an instance of SmbSharePolicyRulePost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmbSharePolicyRulePost:
        """Create an instance of SmbSharePolicyRulePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmbSharePolicyRulePost.parse_obj(obj)

        _obj = SmbSharePolicyRulePost.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
