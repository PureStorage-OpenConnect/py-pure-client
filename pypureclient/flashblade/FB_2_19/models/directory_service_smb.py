...
class DirectoryServiceSmb(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectoryServiceSmb:
        """Create an instance of DirectoryServiceSmb from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DirectoryServiceSmb:
        """Create an instance of DirectoryServiceSmb from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectoryServiceSmb.parse_obj(obj)

        _obj = DirectoryServiceSmb.construct(_fields_set=None, **{
