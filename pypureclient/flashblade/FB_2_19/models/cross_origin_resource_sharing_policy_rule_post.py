...
class CrossOriginResourceSharingPolicyRulePost(BaseModel):
    ...
    __properties = ["allowed_headers", "allowed_methods", "allowed_origins"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CrossOriginResourceSharingPolicyRulePost:
        """Create an instance of CrossOriginResourceSharingPolicyRulePost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CrossOriginResourceSharingPolicyRulePost:
        """Create an instance of CrossOriginResourceSharingPolicyRulePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CrossOriginResourceSharingPolicyRulePost.parse_obj(obj)

        _obj = CrossOriginResourceSharingPolicyRulePost.construct(_fields_set=None, **{
