...
class PublicKeyPost(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicKeyPost:
        """Create an instance of PublicKeyPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PublicKeyPost:
        """Create an instance of PublicKeyPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicKeyPost.parse_obj(obj)

        _obj = PublicKeyPost.construct(_fields_set=None, **{
