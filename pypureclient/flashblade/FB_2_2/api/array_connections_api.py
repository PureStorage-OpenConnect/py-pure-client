...
from pypureclient.flashblade.FB_2_2.models.array_connection_get_response import ArrayConnectionGetResponse
from pypureclient.flashblade.FB_2_2.models.array_connection_key_get_response import ArrayConnectionKeyGetResponse
from pypureclient.flashblade.FB_2_2.models.array_connection_key_response import ArrayConnectionKeyResponse
from pypureclient.flashblade.FB_2_2.models.array_connection_path_get_response import ArrayConnectionPathGetResponse
from pypureclient.flashblade.FB_2_2.models.array_connection_post import ArrayConnectionPost
from pypureclient.flashblade.FB_2_2.models.array_connection_response import ArrayConnectionResponse
from pypureclient.flashblade.FB_2_2.models.connection_relationship_performance_replication_get_resp import ConnectionRelationshipPerformanceReplicationGetResp
...
class ArrayConnectionsApi:
    ...
    def api22_array_connections_connection_key_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_array_connections_connection_key_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api22_array_connections_connection_key_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_array_connections_connection_key_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_array_connections_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_array_connections_delete_with_http_info(ids, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_array_connections_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_array_connections_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_array_connections_get_with_http_info(continuation_token, filter, ids, limit, offset, remote_ids, remote_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_array_connections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_array_connections_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_array_connections_patch_with_http_info(array_connection, ids, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_array_connections_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_array_connections_path_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_array_connections_path_get_with_http_info(continuation_token, filter, ids, limit, offset, remote_ids, remote_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_array_connections_path_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_array_connections_performance_replication_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_array_connections_performance_replication_get_with_http_info(continuation_token, end_time, filter, ids, limit, offset, remote_ids, remote_names, resolution, sort, start_time, total_only, type, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_array_connections_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_array_connections_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
