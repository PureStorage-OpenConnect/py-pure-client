...
class SNMPAgentsApi(object):
    ...
    def api22_snmp_agents_get_with_http_info(
        self,
        ...
        >>> thread = api.api22_snmp_agents_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api22_snmp_agents_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api22_snmp_agents_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api22_snmp_agents_mib_get_with_http_info(
        self,
        async_req=False,  # type: bool
        _return_http_data_only=False,  # type: bool
        _preload_content=True,  # type: bool
    ...
    def api22_snmp_agents_patch_with_http_info(
        self,
        ...
        if snmp_agent is None:
            raise TypeError("Missing the required parameter `snmp_agent` when calling `api22_snmp_agents_patch`")
