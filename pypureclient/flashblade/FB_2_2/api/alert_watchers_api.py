...
class AlertWatchersApi(object):
    ...
    def api22_alert_watchers_delete_with_http_info(
        ...
        >>> thread = api.api22_alert_watchers_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api22_alert_watchers_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api22_alert_watchers_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api22_alert_watchers_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api22_alert_watchers_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api22_alert_watchers_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api22_alert_watchers_patch_with_http_info(alert_watcher, async_req=True)
        >>> result = thread.get()
        ...
        if alert_watcher is None:
            raise TypeError("Missing the required parameter `alert_watcher` when calling `api22_alert_watchers_patch`")
    ...
    def api22_alert_watchers_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api22_alert_watchers_post_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api22_alert_watchers_post`")
    ...
    def api22_alert_watchers_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api22_alert_watchers_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
