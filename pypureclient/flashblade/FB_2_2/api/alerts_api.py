...
class AlertsApi:
    ...
    def api22_alerts_get_with_http_info(
        ...
        _param = self._api22_alerts_get_serialize(
    ...
    def _api22_alerts_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api22_alerts_patch_with_http_info(
        ...
        _param = self._api22_alerts_patch_serialize(
    ...
    def _api22_alerts_patch_serialize(
        self,
        alerts_settings,
        ids,
        names,
