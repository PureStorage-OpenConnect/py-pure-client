...
class ClientsApi:
    ...
    def api22_arrays_clients_performance_get_with_http_info(
        ...
        _param = self._api22_arrays_clients_performance_get_serialize(
            filter = filter,
            limit = limit,
            names = names,
            sort = sort,
    ...
    def _api22_arrays_clients_performance_get_serialize(
        self,
        filter,
        limit,
        names,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.2/arrays/clients/performance',
