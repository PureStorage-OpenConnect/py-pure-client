...
from pypureclient.flashblade.FB_2_2.models.dns import Dns
from pypureclient.flashblade.FB_2_2.models.dns_get_response import DnsGetResponse
from pypureclient.flashblade.FB_2_2.models.dns_response import DnsResponse
...
class DNSApi:
    ...
    def api22_dns_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_dns_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api22_dns_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_dns_patch_with_http_info(dns, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_dns_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
