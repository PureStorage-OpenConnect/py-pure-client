...
from pypureclient.flashblade.FB_2_2.models.support_get_response import SupportGetResponse
from pypureclient.flashblade.FB_2_2.models.support_response import SupportResponse
...
class SupportApi:
    ...
    def api22_support_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_support_get_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api22_support_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_support_test_get_with_http_info(filter, sort, test_type, async_req=True)
        >>> result = thread.get()
