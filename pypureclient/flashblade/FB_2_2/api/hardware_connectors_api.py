...
class HardwareConnectorsApi(object):
    ...
    def api22_hardware_connectors_get_with_http_info(
        self,
        ...
        >>> thread = api.api22_hardware_connectors_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api22_hardware_connectors_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api22_hardware_connectors_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.2/hardware-connectors', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api22_hardware_connectors_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api22_hardware_connectors_patch_with_http_info(hardware_connector, async_req=True)
        >>> result = thread.get()
        ...
        if hardware_connector is None:
            raise TypeError("Missing the required parameter `hardware_connector` when calling `api22_hardware_connectors_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.2/hardware-connectors', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
