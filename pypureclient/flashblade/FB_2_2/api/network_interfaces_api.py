...
from pypureclient.flashblade.FB_2_2.models.network_interface import NetworkInterface
from pypureclient.flashblade.FB_2_2.models.network_interface_get_response import NetworkInterfaceGetResponse
from pypureclient.flashblade.FB_2_2.models.network_interface_patch import NetworkInterfacePatch
from pypureclient.flashblade.FB_2_2.models.network_interface_response import NetworkInterfaceResponse
...
class NetworkInterfacesApi:
    ...
    def api22_network_interfaces_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api22_network_interfaces_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api22_network_interfaces_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.2/network-interfaces', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api22_network_interfaces_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api22_network_interfaces_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_network_interfaces_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.2/network-interfaces', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api22_network_interfaces_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api22_network_interfaces_patch_with_http_info(network_interface, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_network_interfaces_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.2/network-interfaces', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api22_network_interfaces_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api22_network_interfaces_post_with_http_info(names, network_interface, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_network_interfaces_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.2/network-interfaces', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
