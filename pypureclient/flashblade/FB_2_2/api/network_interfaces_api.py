...
class NetworkInterfacesApi:
    ...
    def api22_network_interfaces_delete_with_http_info(
        ...
        _param = self._api22_network_interfaces_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api22_network_interfaces_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.2/network-interfaces',
    ...
    def api22_network_interfaces_get_with_http_info(
        ...
        _param = self._api22_network_interfaces_get_serialize(
    ...
    def _api22_network_interfaces_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api22_network_interfaces_patch_with_http_info(
        ...
        _param = self._api22_network_interfaces_patch_serialize(
    ...
    def _api22_network_interfaces_patch_serialize(
        self,
        network_interface,
        ids,
        names,
    ...
    def api22_network_interfaces_post_with_http_info(
        ...
        _param = self._api22_network_interfaces_post_serialize(
            names = names,
            network_interface = network_interface,
        )
    ...
    def _api22_network_interfaces_post_serialize(
        self,
        names,
        network_interface,
    ) -> RequestSerialized:
