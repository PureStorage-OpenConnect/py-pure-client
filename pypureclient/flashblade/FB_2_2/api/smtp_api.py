...
from pypureclient.flashblade.FB_2_2.models.smtp_server_get_response import SmtpServerGetResponse
from pypureclient.flashblade.FB_2_2.models.smtp_server_response import SmtpServerResponse
...
class SMTPApi:
    ...
    def api22_smtp_servers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_smtp_servers_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api22_smtp_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_smtp_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
