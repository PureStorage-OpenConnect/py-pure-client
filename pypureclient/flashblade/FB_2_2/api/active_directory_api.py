...
from pypureclient.flashblade.FB_2_2.models.active_directory_get_response import ActiveDirectoryGetResponse
from pypureclient.flashblade.FB_2_2.models.active_directory_patch import ActiveDirectoryPatch
from pypureclient.flashblade.FB_2_2.models.active_directory_post import ActiveDirectoryPost
from pypureclient.flashblade.FB_2_2.models.active_directory_response import ActiveDirectoryResponse
...
class ActiveDirectoryApi:
    ...
    def api22_active_directory_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api22_active_directory_delete_with_http_info(ids, local_only, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api22_active_directory_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.2/active-directory', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api22_active_directory_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api22_active_directory_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_active_directory_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_active_directory_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api22_active_directory_patch_with_http_info(active_directory, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_active_directory_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.2/active-directory', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api22_active_directory_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api22_active_directory_post_with_http_info(active_directory, join_existing_account, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_active_directory_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_active_directory_test_get_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        limit: Annotated[Optional[conint(strict=True, ge=0)], Field(description="Limit the size of the response to the specified number of resources. A `limit` of `0` can be used to get the number of resources without getting all of the resources. It will be returned in the `total_item_count` field. If a client asks for a page size larger than the available number, the request is still valid. In that case the server just returns the available number of items, disregarding the client's page size request.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api22_active_directory_test_get_with_http_info(filter, ids, limit, names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_active_directory_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.2/active-directory/test', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
