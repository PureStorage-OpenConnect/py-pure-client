...
from pypureclient.flashblade.FB_2_2.models.bucket_get_response import BucketGetResponse
from pypureclient.flashblade.FB_2_2.models.bucket_performance_get_response import BucketPerformanceGetResponse
from pypureclient.flashblade.FB_2_2.models.bucket_post import BucketPost
from pypureclient.flashblade.FB_2_2.models.bucket_response import BucketResponse
from pypureclient.flashblade.FB_2_2.models.bucket_s3_specific_performance_get_resp import BucketS3SpecificPerformanceGetResp
...
class BucketsApi:
    ...
    def api22_buckets_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_buckets_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api22_buckets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_buckets_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_buckets_get_with_http_info(continuation_token, destroyed, filter, ids, limit, names, offset, sort, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_buckets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_buckets_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_buckets_patch_with_http_info(bucket, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_buckets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_buckets_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_buckets_performance_get_with_http_info(continuation_token, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_buckets_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_buckets_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_buckets_post_with_http_info(names, bucket, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_buckets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api22_buckets_s3_specific_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api22_buckets_s3_specific_performance_get_with_http_info(continuation_token, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_buckets_s3_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
