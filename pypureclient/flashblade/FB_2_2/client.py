...
class Client(object):
    ...
    USER_AGENT = USER_AGENT_TEMPLATE.format(prod='FB', rest_version='2.2', sys=platform.system(), rel=platform.release())
    ...
    def delete_object_store_access_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___object_store_access_api.api22_object_store_access_policies_delete_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_object_store_access_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___object_store_access_api.api22_object_store_access_policies_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def delete_object_store_access_policies_object_store_users(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___object_store_access_api.api22_object_store_access_policies_object_store_users_delete_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_object_store_access_policies_object_store_users(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___object_store_access_api.api22_object_store_access_policies_object_store_users_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def post_object_store_access_policies_object_store_users(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___object_store_access_api.api22_object_store_access_policies_object_store_users_post_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def patch_object_store_access_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___object_store_access_api.api22_object_store_access_policies_patch_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def post_object_store_access_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___object_store_access_api.api22_object_store_access_policies_post_with_http_info
        _process_references(references, ['names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def delete_object_store_access_policies_rules(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___object_store_access_api.api22_object_store_access_policies_rules_delete_with_http_info
        _process_references(references, ['names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_object_store_access_policies_rules(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___object_store_access_api.api22_object_store_access_policies_rules_get_with_http_info
        _process_references(references, ['names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def patch_object_store_access_policies_rules(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___object_store_access_api.api22_object_store_access_policies_rules_patch_with_http_info
        _process_references(references, ['names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def post_object_store_access_policies_rules(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___object_store_access_api.api22_object_store_access_policies_rules_post_with_http_info
        _process_references(references, ['names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_object_store_access_policy_actions(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___object_store_access_api.api22_object_store_access_policy_actions_get_with_http_info
        _process_references(references, ['names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def delete_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___snapshot_api.api22_policies_delete_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def delete_policies_file_system_replica_links(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___snapshot_api.api22_policies_file_system_replica_links_delete_with_http_info
        _process_references(local_file_systems, ['local_file_system_ids', 'local_file_system_names'], kwargs)
        _process_references(members, ['member_ids'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        _process_references(remotes, ['remote_ids', 'remote_names'], kwargs)
    ...
    def get_policies_file_system_replica_links(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___snapshot_api.api22_policies_file_system_replica_links_get_with_http_info
        _process_references(local_file_systems, ['local_file_system_ids', 'local_file_system_names'], kwargs)
        _process_references(members, ['member_ids'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        _process_references(remotes, ['remote_ids', 'remote_names'], kwargs)
    ...
    def post_policies_file_system_replica_links(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___snapshot_api.api22_policies_file_system_replica_links_post_with_http_info
        _process_references(local_file_systems, ['local_file_system_ids', 'local_file_system_names'], kwargs)
        _process_references(members, ['member_ids'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        _process_references(remotes, ['remote_ids', 'remote_names'], kwargs)
    ...
    def delete_policies_file_system_snapshots(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___snapshot_api.api22_policies_file_system_snapshots_delete_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies_file_system_snapshots(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___snapshot_api.api22_policies_file_system_snapshots_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def delete_policies_file_systems(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___snapshot_api.api22_policies_file_systems_delete_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies_file_systems(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___snapshot_api.api22_policies_file_systems_get_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def post_policies_file_systems(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___snapshot_api.api22_policies_file_systems_post_with_http_info
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___snapshot_api.api22_policies_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies_members(
        ...
        member_ids=None,  # type: List[str]
        member_names=None,  # type: List[str]
        member_types=None,  # type: List[models.ModelsFB22ResourceTypeYaml]
        offset=None,  # type: int
        policy_ids=None,  # type: List[str]
        policy_names=None,  # type: List[str]
        remote_ids=None,  # type: List[str]
        ...
        Args:
            ...
            member_names (list[str], optional):
                A list of member names.
            member_types (list[ModelsFB22ResourceTypeYaml], optional):
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___snapshot_api.api22_policies_members_get_with_http_info
        _process_references(local_file_systems, ['local_file_system_ids', 'local_file_system_names'], kwargs)
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        _process_references(remotes, ['remote_ids', 'remote_names'], kwargs)
    ...
    def patch_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___snapshot_api.api22_policies_patch_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def post_policies(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies___snapshot_api.api22_policies_post_with_http_info
        _process_references(references, ['names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies_all(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies__all_api.api22_policies_all_get_with_http_info
        _process_references(references, ['ids', 'names'], kwargs)
        return self._call_api(endpoint, kwargs)
    ...
    def get_policies_all_members(
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None}
        endpoint = self._policies__all_api.api22_policies_all_members_get_with_http_info
        _process_references(local_file_systems, ['local_file_system_ids', 'local_file_system_names'], kwargs)
        _process_references(members, ['member_ids', 'member_names'], kwargs)
        _process_references(policies, ['policy_ids', 'policy_names'], kwargs)
        _process_references(remotes, ['remote_ids', 'remote_names'], kwargs)
