...
class ObjectStoreRemoteCredentialGetResp(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[ObjectStoreRemoteCredentials]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.ObjectStoreRemoteCredentials]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ObjectStoreRemoteCredentialGetResp`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ObjectStoreRemoteCredentialGetResp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectStoreRemoteCredentialGetResp):
            return False
