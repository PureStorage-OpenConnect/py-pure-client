...
from pypureclient.flashblade.FB_2_2.models.policy_rule_object_access_condition import PolicyRuleObjectAccessCondition
...
class PolicyRuleObjectAccessBulkManage(BaseModel):
    ...
    __properties = ["actions", "conditions", "resources", "name"]
