...
class ReferenceWritable(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceWritable:
        """Create an instance of ReferenceWritable from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceWritable:
        """Create an instance of ReferenceWritable from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReferenceWritable.parse_obj(obj)

        _obj = ReferenceWritable.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
