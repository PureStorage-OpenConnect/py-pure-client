...
class ArrayNfsSpecificPerformance(object):
    ...
    def __setattr__(self, key, value):
        ...
        if key == "aggregate_other_per_sec" and value is not None:
            if value < 0:
                raise ValueError("Invalid value for `aggregate_other_per_sec`, must be a value greater than or equal to `0`")
        ...
        if key == "aggregate_usec_per_other_op" and value is not None:
            if value < 0:
                raise ValueError("Invalid value for `aggregate_usec_per_other_op`, must be a value greater than or equal to `0`")
