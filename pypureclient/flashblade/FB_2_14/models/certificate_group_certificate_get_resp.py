...
class CertificateGroupCertificateGetResp(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificateGroupCertificateGetResp:
        """Create an instance of CertificateGroupCertificateGetResp from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CertificateGroupCertificateGetResp:
        """Create an instance of CertificateGroupCertificateGetResp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CertificateGroupCertificateGetResp.parse_obj(obj)

        _obj = CertificateGroupCertificateGetResp.construct(_fields_set=None, **{
