...
class LifecycleRuleConfigExtension(BaseModel):
    """
    ...
    __properties = ["abort_incomplete_multipart_uploads_after", "keep_current_version_for", "keep_current_version_until"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LifecycleRuleConfigExtension:
        """Create an instance of LifecycleRuleConfigExtension from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LifecycleRuleConfigExtension:
        """Create an instance of LifecycleRuleConfigExtension from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LifecycleRuleConfigExtension.parse_obj(obj)

        _obj = LifecycleRuleConfigExtension.construct(_fields_set=None, **{
