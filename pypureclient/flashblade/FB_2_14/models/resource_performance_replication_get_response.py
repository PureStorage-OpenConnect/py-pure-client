...
class ResourcePerformanceReplicationGetResponse(BaseModel):
    ...
    items: Optional[List[ResourcePerformanceReplication]] = None
    total: Optional[List[ResourcePerformanceReplication]] = Field(default=None, description="Total of all records after filtering. If `total_only` query param is `true`, then no items will be returned.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [ResourcePerformanceReplication.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": [ResourcePerformanceReplication.from_dict(_item) for _item in obj["total"]] if obj.get("total") is not None else None
        })
        return _obj
