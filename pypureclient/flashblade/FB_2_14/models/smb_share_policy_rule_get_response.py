...
class SmbSharePolicyRuleGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        items=None,  # type: List[models.SmbSharePolicyRule]
    ):
        """
        Keyword args:
            ...
            items (list[SmbSharePolicyRule]): A list of SMB Share policy rule objects.
        """
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `SmbSharePolicyRuleGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(SmbSharePolicyRuleGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SmbSharePolicyRuleGetResponse):
            return False
