...
from pypureclient.flashblade.FB_2_14.models.smb_share_policy_rule import SmbSharePolicyRule
...
class SmbSharePolicyRuleGetResponse(BaseModel):
    ...
    items: Optional[conlist(SmbSharePolicyRule)] = Field(default=None, description="A list of SMB Share policy rule objects.")
    ...
    def from_dict(cls, obj: dict) -> SmbSharePolicyRuleGetResponse:
        ...
        _obj = SmbSharePolicyRuleGetResponse.construct(_fields_set=None, **{
            ...
            "items": [SmbSharePolicyRule.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
