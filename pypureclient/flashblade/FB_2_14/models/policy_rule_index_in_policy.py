...
class PolicyRuleIndexInPolicy(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleIndexInPolicy:
        """Create an instance of PolicyRuleIndexInPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleIndexInPolicy:
        """Create an instance of PolicyRuleIndexInPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleIndexInPolicy.parse_obj(obj)

        _obj = PolicyRuleIndexInPolicy.construct(_fields_set=None, **{
            "index": obj.get("index")
        })
        return _obj
