...
class Session(BaseModel):
    ...
    method: Optional[StrictStr] = Field(default=None, description="Method by which the user attempted to log in. Valid values include `API token`, `password`, `ssh certificate`, and `public key`.")
    ...
    identifying_details: Optional[StrictStr] = Field(default=None, description="Additional details, depending on the authentication method used, which are necessary to uniquely identify who authenticated as a user. `null` if no additional details are needed.")
    __properties: ClassVar[List[str]] = ["name", "id", "end_time", "event", "event_count", "location", "method", "start_time", "user", "user_interface", "identifying_details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "identifying_details": obj.get("identifying_details")
        })
        return _obj
