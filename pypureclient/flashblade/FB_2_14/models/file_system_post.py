...
from pypureclient.flashblade.FB_2_14.models.multi_protocol_post import MultiProtocolPost
from pypureclient.flashblade.FB_2_14.models.nfs import Nfs
from pypureclient.flashblade.FB_2_14.models.reference import Reference
from pypureclient.flashblade.FB_2_14.models.smb_post import SmbPost
...
class FileSystemPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["default_group_quota", "default_user_quota", "fast_remove_directory_enabled", "hard_limit_enabled", "http", "multi_protocol", "nfs", "provisioned", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "writable", "group_ownership"]
