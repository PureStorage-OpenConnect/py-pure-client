...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_14.models.blade_get_response import BladeGetResponse
...
class BladesApi:
    ...
    def api214_blades_get_with_http_info(
        ...
        _param = self._api214_blades_get_serialize(
    ...
    def _api214_blades_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
