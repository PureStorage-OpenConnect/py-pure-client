...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_14.models.role_get_response import RoleGetResponse
...
class RolesApi:
    ...
    def api214_roles_get_with_http_info(
        ...
        _param = self._api214_roles_get_serialize(
    ...
    def _api214_roles_get_serialize(
        self,
        x_request_id,
        continuation_token,
        ids,
