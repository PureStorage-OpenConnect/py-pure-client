...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_14.models.object_store_virtual_host_get_response import ObjectStoreVirtualHostGetResponse
from pypureclient.flashblade.FB_2_14.models.object_store_virtual_host_response import ObjectStoreVirtualHostResponse
...
class ObjectStoreVirtualHostsApi:
    ...
    def api214_object_store_virtual_hosts_delete_with_http_info(
        ...
        _param = self._api214_object_store_virtual_hosts_delete_serialize(
    ...
    def _api214_object_store_virtual_hosts_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/object-store-virtual-hosts',
    ...
    def api214_object_store_virtual_hosts_get_with_http_info(
        ...
        _param = self._api214_object_store_virtual_hosts_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api214_object_store_virtual_hosts_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api214_object_store_virtual_hosts_post_with_http_info(
        ...
        _param = self._api214_object_store_virtual_hosts_post_serialize(
            names = names,
            x_request_id = x_request_id,
        )
    ...
    def _api214_object_store_virtual_hosts_post_serialize(
        self,
        names,
        x_request_id,
    ) -> RequestSerialized:
