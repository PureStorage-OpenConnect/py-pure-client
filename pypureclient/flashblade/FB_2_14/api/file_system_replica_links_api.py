...
class FileSystemReplicaLinksApi:
    ...
    def api214_file_system_replica_links_delete_with_http_info(
        ...
        _param = self._api214_file_system_replica_links_delete_serialize(
    ...
    def _api214_file_system_replica_links_delete_serialize(
        self,
        x_request_id,
        ids,
        local_file_system_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/file-system-replica-links',
    ...
    def api214_file_system_replica_links_get_with_http_info(
        ...
        _param = self._api214_file_system_replica_links_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api214_file_system_replica_links_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api214_file_system_replica_links_policies_delete_with_http_info(
        ...
        _param = self._api214_file_system_replica_links_policies_delete_serialize(
            x_request_id = x_request_id,
            local_file_system_ids = local_file_system_ids,
            local_file_system_names = local_file_system_names,
    ...
    def _api214_file_system_replica_links_policies_delete_serialize(
        self,
        x_request_id,
        local_file_system_ids,
        local_file_system_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/file-system-replica-links/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api214_file_system_replica_links_policies_get_with_http_info(
        ...
        _param = self._api214_file_system_replica_links_policies_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
    ...
    def _api214_file_system_replica_links_policies_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api214_file_system_replica_links_policies_post_with_http_info(
        ...
        _param = self._api214_file_system_replica_links_policies_post_serialize(
            x_request_id = x_request_id,
            local_file_system_ids = local_file_system_ids,
            local_file_system_names = local_file_system_names,
            member_ids = member_ids,
    ...
    def _api214_file_system_replica_links_policies_post_serialize(
        self,
        x_request_id,
        local_file_system_ids,
        local_file_system_names,
    ...
    def api214_file_system_replica_links_post_with_http_info(
        ...
        _param = self._api214_file_system_replica_links_post_serialize(
    ...
    def _api214_file_system_replica_links_post_serialize(
        self,
    ...
    def api214_file_system_replica_links_transfer_get_with_http_info(
        ...
        _param = self._api214_file_system_replica_links_transfer_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
    ...
    def _api214_file_system_replica_links_transfer_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.14/file-system-replica-links/transfer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
