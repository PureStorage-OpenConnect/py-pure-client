...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_14.models.hardware_connector import HardwareConnector
from pypureclient.flashblade.FB_2_14.models.hardware_connector_get_response import HardwareConnectorGetResponse
from pypureclient.flashblade.FB_2_14.models.hardware_connector_performance_get_response import HardwareConnectorPerformanceGetResponse
from pypureclient.flashblade.FB_2_14.models.hardware_connector_response import HardwareConnectorResponse
...
class HardwareConnectorsApi:
    ...
    def api214_hardware_connectors_get_with_http_info(
        ...
        _param = self._api214_hardware_connectors_get_serialize(
            ids = ids,
            names = names,
    ...
    def _api214_hardware_connectors_get_serialize(
        self,
        ids,
        names,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.14/hardware-connectors',
    ...
    def api214_hardware_connectors_patch_with_http_info(
        ...
        _param = self._api214_hardware_connectors_patch_serialize(
    ...
    def _api214_hardware_connectors_patch_serialize(
        self,
        hardware_connector,
        ids,
        names,
    ...
    def api214_hardware_connectors_performance_get_with_http_info(
        ...
        _param = self._api214_hardware_connectors_performance_get_serialize(
            x_request_id = x_request_id,
            end_time = end_time,
            filter = filter,
            ids = ids,
    ...
    def _api214_hardware_connectors_performance_get_serialize(
        self,
        x_request_id,
        end_time,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.14/hardware-connectors/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
