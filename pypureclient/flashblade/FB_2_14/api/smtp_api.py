...
from pypureclient.flashblade.FB_2_14.models.smtp_server_get_response import SmtpServerGetResponse
from pypureclient.flashblade.FB_2_14.models.smtp_server_response import SmtpServerResponse
...
class SMTPApi:
    ...
    def api214_smtp_servers_get_with_http_info(
        ...
        _param = self._api214_smtp_servers_get_serialize(
    ...
    def _api214_smtp_servers_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.14/smtp-servers',
    ...
    def api214_smtp_servers_patch_with_http_info(
        ...
        _param = self._api214_smtp_servers_patch_serialize(
            smtp = smtp,
            x_request_id = x_request_id,
        )
    ...
    def _api214_smtp_servers_patch_serialize(
        self,
        smtp,
        x_request_id,
    ) -> RequestSerialized:
