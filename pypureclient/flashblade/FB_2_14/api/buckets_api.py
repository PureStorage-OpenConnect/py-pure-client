...
class BucketsApi(object):
    ...
    def api214_buckets_bucket_access_policies_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_buckets_bucket_access_policies_get`, must be a value greater than or equal to `0`")
    ...
    def api214_buckets_bucket_access_policies_rules_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_buckets_bucket_access_policies_rules_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api214_buckets_cross_origin_resource_sharing_policies_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_buckets_cross_origin_resource_sharing_policies_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api214_buckets_cross_origin_resource_sharing_policies_rules_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_buckets_cross_origin_resource_sharing_policies_rules_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api214_buckets_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_buckets_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api214_buckets_performance_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_buckets_performance_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api214_buckets_s3_specific_performance_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_buckets_s3_specific_performance_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
