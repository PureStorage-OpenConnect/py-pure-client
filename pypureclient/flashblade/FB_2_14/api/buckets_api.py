...
class BucketsApi(object):
    ...
    def api214_buckets_bucket_access_policies_rules_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_buckets_bucket_access_policies_rules_post_with_http_info(rule, names, async_req=True)
        >>> result = thread.get()
    ...
    def api214_buckets_cross_origin_resource_sharing_policies_rules_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_buckets_cross_origin_resource_sharing_policies_rules_post_with_http_info(rule, names, async_req=True)
        >>> result = thread.get()
    ...
    def api214_buckets_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_buckets_post_with_http_info(bucket, names, async_req=True)
        >>> result = thread.get()
