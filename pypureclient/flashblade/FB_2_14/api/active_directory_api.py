...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_14.models.active_directory_get_response import ActiveDirectoryGetResponse
from pypureclient.flashblade.FB_2_14.models.active_directory_patch import ActiveDirectoryPatch
from pypureclient.flashblade.FB_2_14.models.active_directory_post import ActiveDirectoryPost
from pypureclient.flashblade.FB_2_14.models.active_directory_response import ActiveDirectoryResponse
...
class ActiveDirectoryApi:
    ...
    def api214_active_directory_delete_with_http_info(
        ...
        _param = self._api214_active_directory_delete_serialize(
    ...
    def _api214_active_directory_delete_serialize(
        self,
        x_request_id,
        ids,
        local_only,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/active-directory',
    ...
    def api214_active_directory_get_with_http_info(
        ...
        _param = self._api214_active_directory_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api214_active_directory_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    @validate_call
    def api214_active_directory_patch_with_http_info(
        self,
        ...
        _param = self._api214_active_directory_patch_serialize(
    ...
    def _api214_active_directory_patch_serialize(
        self,
        active_directory,
        x_request_id,
        ids,
    ...
    def api214_active_directory_post_with_http_info(
        ...
        _param = self._api214_active_directory_post_serialize(
            active_directory = active_directory,
            x_request_id = x_request_id,
            names = names,
    ...
    def _api214_active_directory_post_serialize(
        self,
        active_directory,
        x_request_id,
        names,
    ...
    @validate_call
    def api214_active_directory_test_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        _param = self._api214_active_directory_test_get_serialize(
            x_request_id = x_request_id,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api214_active_directory_test_get_serialize(
        self,
        x_request_id,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.14/active-directory/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
