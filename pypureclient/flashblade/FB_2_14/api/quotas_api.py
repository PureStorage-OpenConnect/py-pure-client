...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_14.models.group_quota_get_response import GroupQuotaGetResponse
from pypureclient.flashblade.FB_2_14.models.group_quota_patch import GroupQuotaPatch
from pypureclient.flashblade.FB_2_14.models.group_quota_post import GroupQuotaPost
from pypureclient.flashblade.FB_2_14.models.group_quota_response import GroupQuotaResponse
from pypureclient.flashblade.FB_2_14.models.quota_setting import QuotaSetting
from pypureclient.flashblade.FB_2_14.models.quota_setting_get_response import QuotaSettingGetResponse
from pypureclient.flashblade.FB_2_14.models.quota_setting_response import QuotaSettingResponse
from pypureclient.flashblade.FB_2_14.models.user_quota_get_response import UserQuotaGetResponse
from pypureclient.flashblade.FB_2_14.models.user_quota_patch import UserQuotaPatch
from pypureclient.flashblade.FB_2_14.models.user_quota_post import UserQuotaPost
from pypureclient.flashblade.FB_2_14.models.user_quota_response import UserQuotaResponse
...
class QuotasApi:
    ...
    @validate_call
    def api214_quotas_groups_delete_with_http_info(
        self,
        ...
        _param = self._api214_quotas_groups_delete_serialize(
    ...
    def _api214_quotas_groups_delete_serialize(
        self,
        x_request_id,
        file_system_names,
        file_system_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/quotas/groups',
    ...
    @validate_call
    def api214_quotas_groups_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        _param = self._api214_quotas_groups_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api214_quotas_groups_get_serialize(
        self,
        x_request_id,
        continuation_token,
        file_system_ids,
    ...
    @validate_call
    def api214_quotas_groups_patch_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        file_system_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of file system names. If there is not at least one resource that matches each of the elements of `file_system_names`, then an error is returned.")] = None,
        file_system_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of file system IDs. If after filtering, there is not at least one resource that matches each of the elements of `file_system_ids`, then an error is returned. This cannot be provided together with the `file_system_names` query parameter.")] = None,
        ...
        _param = self._api214_quotas_groups_patch_serialize(
            x_request_id = x_request_id,
            file_system_names = file_system_names,
            file_system_ids = file_system_ids,
            gids = gids,
    ...
    def _api214_quotas_groups_patch_serialize(
        self,
        x_request_id,
        file_system_names,
        file_system_ids,
    ...
    @validate_call
    def api214_quotas_groups_post_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        file_system_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of file system IDs. If after filtering, there is not at least one resource that matches each of the elements of `file_system_ids`, then an error is returned. This cannot be provided together with the `file_system_names` query parameter.")] = None,
        file_system_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of file system names. If there is not at least one resource that matches each of the elements of `file_system_names`, then an error is returned.")] = None,
        ...
        _param = self._api214_quotas_groups_post_serialize(
            x_request_id = x_request_id,
            file_system_ids = file_system_ids,
            file_system_names = file_system_names,
            gids = gids,
    ...
    def _api214_quotas_groups_post_serialize(
        self,
        x_request_id,
        file_system_ids,
        file_system_names,
    ...
    @validate_call
    def api214_quotas_settings_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        _param = self._api214_quotas_settings_get_serialize(
            x_request_id = x_request_id,
            ids = ids,
            names = names,
        )
    ...
    def _api214_quotas_settings_get_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.14/quotas/settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api214_quotas_settings_patch_with_http_info(
        self,
        ...
        _param = self._api214_quotas_settings_patch_serialize(
    ...
    def _api214_quotas_settings_patch_serialize(
        self,
        quota_setting,
        x_request_id,
    ) -> RequestSerialized:
    ...
    @validate_call
    def api214_quotas_users_delete_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        file_system_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of file system names. If there is not at least one resource that matches each of the elements of `file_system_names`, then an error is returned.")] = None,
        file_system_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of file system IDs. If after filtering, there is not at least one resource that matches each of the elements of `file_system_ids`, then an error is returned. This cannot be provided together with the `file_system_names` query parameter.")] = None,
        ...
        _param = self._api214_quotas_users_delete_serialize(
            x_request_id = x_request_id,
            file_system_names = file_system_names,
            file_system_ids = file_system_ids,
            names = names,
    ...
    def _api214_quotas_users_delete_serialize(
        self,
        x_request_id,
        file_system_names,
        file_system_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/quotas/users',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api214_quotas_users_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        file_system_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of file system IDs. If after filtering, there is not at least one resource that matches each of the elements of `file_system_ids`, then an error is returned. This cannot be provided together with the `file_system_names` query parameter.")] = None,
        ...
        _param = self._api214_quotas_users_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            file_system_ids = file_system_ids,
            file_system_names = file_system_names,
    ...
    def _api214_quotas_users_get_serialize(
        self,
        x_request_id,
        continuation_token,
        file_system_ids,
    ...
    @validate_call
    def api214_quotas_users_patch_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        file_system_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of file system names. If there is not at least one resource that matches each of the elements of `file_system_names`, then an error is returned.")] = None,
        file_system_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of file system IDs. If after filtering, there is not at least one resource that matches each of the elements of `file_system_ids`, then an error is returned. This cannot be provided together with the `file_system_names` query parameter.")] = None,
        ...
        _param = self._api214_quotas_users_patch_serialize(
            x_request_id = x_request_id,
            file_system_names = file_system_names,
            file_system_ids = file_system_ids,
            names = names,
    ...
    def _api214_quotas_users_patch_serialize(
        self,
        x_request_id,
        file_system_names,
        file_system_ids,
    ...
    @validate_call
    def api214_quotas_users_post_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        file_system_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of file system IDs. If after filtering, there is not at least one resource that matches each of the elements of `file_system_ids`, then an error is returned. This cannot be provided together with the `file_system_names` query parameter.")] = None,
        file_system_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of file system names. If there is not at least one resource that matches each of the elements of `file_system_names`, then an error is returned.")] = None,
        ...
        _param = self._api214_quotas_users_post_serialize(
            x_request_id = x_request_id,
            file_system_ids = file_system_ids,
            file_system_names = file_system_names,
            uids = uids,
    ...
    def _api214_quotas_users_post_serialize(
        self,
        x_request_id,
        file_system_ids,
        file_system_names,
