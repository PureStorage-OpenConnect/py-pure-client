...
class DNSApi:
    ...
    def api214_dns_get_with_http_info(
        ...
        _param = self._api214_dns_get_serialize(
    ...
    def api214_dns_patch_with_http_info(
        ...
        _param = self._api214_dns_patch_serialize(
            dns = dns,
            x_request_id = x_request_id,
            ids = ids,
            names = names,
    ...
    def _api214_dns_patch_serialize(
        self,
        dns,
        x_request_id,
        ids,
