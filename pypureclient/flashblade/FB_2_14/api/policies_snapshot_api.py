...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_14.models.policy import Policy
...
from pypureclient.flashblade.FB_2_14.models.policy_get_response import PolicyGetResponse
...
from pypureclient.flashblade.FB_2_14.models.policy_patch import PolicyPatch
from pypureclient.flashblade.FB_2_14.models.policy_response import PolicyResponse
...
class PoliciesSnapshotApi:
    ...
    def api214_policies_delete_with_http_info(
        ...
        _param = self._api214_policies_delete_serialize(
    ...
    def _api214_policies_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
    ...
    def api214_policies_file_system_replica_links_delete_with_http_info(
        ...
        _param = self._api214_policies_file_system_replica_links_delete_serialize(
            x_request_id = x_request_id,
    ...
    def _api214_policies_file_system_replica_links_delete_serialize(
        self,
        x_request_id,
        local_file_system_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/policies/file-system-replica-links',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api214_policies_file_system_replica_links_get_with_http_info(
        ...
        _param = self._api214_policies_file_system_replica_links_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api214_policies_file_system_replica_links_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api214_policies_file_system_replica_links_post_with_http_info(
        ...
        _param = self._api214_policies_file_system_replica_links_post_serialize(
            x_request_id = x_request_id,
            local_file_system_ids = local_file_system_ids,
            local_file_system_names = local_file_system_names,
            member_ids = member_ids,
    ...
    def _api214_policies_file_system_replica_links_post_serialize(
        self,
        x_request_id,
        local_file_system_ids,
        local_file_system_names,
    ...
    def api214_policies_file_system_snapshots_delete_with_http_info(
        ...
        _param = self._api214_policies_file_system_snapshots_delete_serialize(
            x_request_id = x_request_id,
            member_ids = member_ids,
    ...
    def _api214_policies_file_system_snapshots_delete_serialize(
        self,
        x_request_id,
        member_ids,
        member_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/policies/file-system-snapshots',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api214_policies_file_system_snapshots_get_with_http_info(
        ...
        _param = self._api214_policies_file_system_snapshots_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
    ...
    def _api214_policies_file_system_snapshots_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api214_policies_file_systems_delete_with_http_info(
        ...
        _param = self._api214_policies_file_systems_delete_serialize(
            x_request_id = x_request_id,
            member_ids = member_ids,
            member_names = member_names,
            policy_ids = policy_ids,
    ...
    def _api214_policies_file_systems_delete_serialize(
        self,
        x_request_id,
        member_ids,
        member_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/policies/file-systems',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api214_policies_file_systems_get_with_http_info(
        ...
        _param = self._api214_policies_file_systems_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
    ...
    def _api214_policies_file_systems_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api214_policies_file_systems_post_with_http_info(
        ...
        _param = self._api214_policies_file_systems_post_serialize(
            x_request_id = x_request_id,
            member_ids = member_ids,
            member_names = member_names,
            policy_ids = policy_ids,
    ...
    def _api214_policies_file_systems_post_serialize(
        self,
        x_request_id,
        member_ids,
        member_names,
    ...
    def api214_policies_patch_with_http_info(
        ...
        _param = self._api214_policies_patch_serialize(
            policy = policy,
            x_request_id = x_request_id,
            ids = ids,
    ...
    def _api214_policies_patch_serialize(
        self,
        policy,
        x_request_id,
        ids,
    ...
    def api214_policies_post_with_http_info(
        ...
        _param = self._api214_policies_post_serialize(
            names = names,
            x_request_id = x_request_id,
            policy = policy,
        )
    ...
    def _api214_policies_post_serialize(
        self,
        names,
        x_request_id,
        policy,
