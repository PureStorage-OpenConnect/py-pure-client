...
class DirectoryServicesApi:
    ...
    def api214_directory_services_roles_delete_with_http_info(
        ...
        _param = self._api214_directory_services_roles_delete_serialize(
            x_request_id = x_request_id,
            names = names,
            ids = ids,
        )
    ...
    def _api214_directory_services_roles_delete_serialize(
        self,
        x_request_id,
        names,
        ids,
    ...
    def api214_directory_services_roles_post_with_http_info(
        ...
        _param = self._api214_directory_services_roles_post_serialize(
            directory_service_roles = directory_service_roles,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api214_directory_services_roles_post_serialize(
        self,
        directory_service_roles,
        x_request_id,
        names,
    ...
    def api214_directory_services_test_patch_with_http_info(
        ...
        _param = self._api214_directory_services_test_patch_serialize(
            x_request_id = x_request_id,
            filter = filter,
            ids = ids,
            names = names,
    ...
    def _api214_directory_services_test_patch_serialize(
        self,
        x_request_id,
        filter,
        ids,
