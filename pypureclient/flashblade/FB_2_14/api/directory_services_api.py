...
from pypureclient.flashblade.FB_2_14.models.directory_service_get_response import DirectoryServiceGetResponse
from pypureclient.flashblade.FB_2_14.models.directory_service_response import DirectoryServiceResponse
from pypureclient.flashblade.FB_2_14.models.directory_service_role import DirectoryServiceRole
from pypureclient.flashblade.FB_2_14.models.directory_service_roles_get_response import DirectoryServiceRolesGetResponse
from pypureclient.flashblade.FB_2_14.models.directory_service_roles_response import DirectoryServiceRolesResponse
...
class DirectoryServicesApi:
    ...
    def api214_directory_services_roles_delete_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.14/directory-services/roles', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api214_directory_services_roles_post_with_http_info(
        self,
        directory_service_roles: DirectoryServiceRole,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.14/directory-services/roles', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api214_directory_services_test_patch_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.14/directory-services/test', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
