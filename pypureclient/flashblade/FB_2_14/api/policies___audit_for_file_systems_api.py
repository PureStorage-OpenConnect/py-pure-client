...
class PoliciesAuditForFileSystemsApi(object):

    def __init__(self, api_client):
        self.api_client = api_client

    def api214_audit_file_systems_policies_delete_with_http_info(
        self,
        ...
        >>> thread = api.api214_audit_file_systems_policies_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.14/audit-file-systems-policies', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api214_audit_file_systems_policies_get_with_http_info(
        self,
        x_request_id=None,  # type: str
        ...
        # type: (...) -> models.AuditFileSystemsPoliciesGetResponse
        """GET audit-file-systems-policies

        Displays a list of audit policies for file systems.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_audit_file_systems_policies_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_audit_file_systems_policies_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api214_audit_file_systems_policies_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.14/audit-file-systems-policies', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='AuditFileSystemsPoliciesGetResponse',
            auth_settings=auth_settings,
            async_req=async_req,
            _return_http_data_only=_return_http_data_only,
            _preload_content=_preload_content,
    ...
    def api214_audit_file_systems_policies_members_delete_with_http_info(
        self,
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_audit_file_systems_policies_members_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.14/audit-file-systems-policies/members', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api214_audit_file_systems_policies_members_get_with_http_info(
        self,
        x_request_id=None,  # type: str
        continuation_token=None,  # type: str
        filter=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_audit_file_systems_policies_members_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_audit_file_systems_policies_members_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api214_audit_file_systems_policies_members_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.14/audit-file-systems-policies/members', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api214_audit_file_systems_policies_members_post_with_http_info(
        self,
        x_request_id=None,  # type: str
        member_ids=None,  # type: List[str]
        member_names=None,  # type: List[str]
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_audit_file_systems_policies_members_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.14/audit-file-systems-policies/members', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api214_audit_file_systems_policies_patch_with_http_info(
        self,
        policy=None,  # type: models.AuditFileSystemsPoliciesPatch
        x_request_id=None,  # type: str
        ids=None,  # type: List[str]
        names=None,  # type: List[str]
        async_req=False,  # type: bool
        ...
        # type: (...) -> models.AuditFileSystemsPoliciesResponse
        """PATCH audit-file-systems-policies

        Modify an existing audit policy's attributes.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_audit_file_systems_policies_patch_with_http_info(policy, async_req=True)
        >>> result = thread.get()

        :param AuditFileSystemsPoliciesPatch policy: (required)
        :param str x_request_id: Supplied by client during request or generated by server.
        :param list[str] ids: A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.
        :param list[str] names: A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.
        :param bool async_req: Request runs in separate thread and method returns multiprocessing.pool.ApplyResult.
        ...
        if policy is None:
            raise TypeError("Missing the required parameter `policy` when calling `api214_audit_file_systems_policies_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.14/audit-file-systems-policies', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='AuditFileSystemsPoliciesResponse',
            auth_settings=auth_settings,
            async_req=async_req,
            _return_http_data_only=_return_http_data_only,
            _preload_content=_preload_content,
    ...
    def api214_audit_file_systems_policies_post_with_http_info(
        self,
        names=None,  # type: List[str]
        x_request_id=None,  # type: str
        policy=None,  # type: models.AuditFileSystemsPoliciesPost
        async_req=False,  # type: bool
        _return_http_data_only=False,  # type: bool
        _preload_content=True,  # type: bool
        _request_timeout=None,  # type: Optional[int]
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_audit_file_systems_policies_post_with_http_info(names, async_req=True)
        >>> result = thread.get()

        :param list[str] names: A comma-separated list of resource names. (required)
        :param str x_request_id: Supplied by client during request or generated by server.
        :param AuditFileSystemsPoliciesPost policy:
        :param bool async_req: Request runs in separate thread and method returns multiprocessing.pool.ApplyResult.
        :param bool _return_http_data_only: Returns only data field.
        :param bool _preload_content: Response is converted into objects.
        :param int _request_timeout: Total request timeout in seconds.
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api214_audit_file_systems_policies_post`")
        ...
        return self.api_client.call_api(
            '/api/2.14/audit-file-systems-policies', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
