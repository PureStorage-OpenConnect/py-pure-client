...
class VerificationKeysApi(object):
    ...
    def api214_support_verification_keys_get_with_http_info(
        self,
        ...
        >>> thread = api.api214_support_verification_keys_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_support_verification_keys_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api214_support_verification_keys_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.14/support/verification-keys', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api214_support_verification_keys_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_support_verification_keys_patch_with_http_info(key, async_req=True)
        >>> result = thread.get()
        ...
        if key is None:
            raise TypeError("Missing the required parameter `key` when calling `api214_support_verification_keys_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.14/support/verification-keys', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
