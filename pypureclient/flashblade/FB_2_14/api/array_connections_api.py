...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_14.models.array_connection import ArrayConnection
from pypureclient.flashblade.FB_2_14.models.array_connection_get_response import ArrayConnectionGetResponse
from pypureclient.flashblade.FB_2_14.models.array_connection_key_get_response import ArrayConnectionKeyGetResponse
from pypureclient.flashblade.FB_2_14.models.array_connection_key_response import ArrayConnectionKeyResponse
from pypureclient.flashblade.FB_2_14.models.array_connection_path_get_response import ArrayConnectionPathGetResponse
from pypureclient.flashblade.FB_2_14.models.array_connection_post import ArrayConnectionPost
from pypureclient.flashblade.FB_2_14.models.array_connection_response import ArrayConnectionResponse
from pypureclient.flashblade.FB_2_14.models.connection_relationship_performance_replication_get_resp import ConnectionRelationshipPerformanceReplicationGetResp
...
class ArrayConnectionsApi:
    ...
    def api214_array_connections_connection_key_get_with_http_info(
        ...
        _param = self._api214_array_connections_connection_key_get_serialize(
    ...
    def _api214_array_connections_connection_key_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.14/array-connections/connection-key',
    ...
    @validate_call
    def api214_array_connections_connection_key_post_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
        ...
        _param = self._api214_array_connections_connection_key_post_serialize(
            x_request_id = x_request_id,
        )
    ...
    def _api214_array_connections_connection_key_post_serialize(
        self,
        x_request_id,
    ) -> RequestSerialized:
    ...
    def api214_array_connections_delete_with_http_info(
        ...
        _param = self._api214_array_connections_delete_serialize(
            x_request_id = x_request_id,
            ids = ids,
    ...
    def _api214_array_connections_delete_serialize(
        self,
        x_request_id,
        ids,
        remote_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/array-connections',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api214_array_connections_get_with_http_info(
        ...
        _param = self._api214_array_connections_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
    ...
    def _api214_array_connections_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api214_array_connections_patch_with_http_info(
        ...
        _param = self._api214_array_connections_patch_serialize(
    ...
    def _api214_array_connections_patch_serialize(
        self,
        array_connection,
        x_request_id,
        ids,
    ...
    def api214_array_connections_path_get_with_http_info(
        ...
        _param = self._api214_array_connections_path_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
    ...
    def _api214_array_connections_path_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.14/array-connections/path',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api214_array_connections_performance_replication_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        ...
        _param = self._api214_array_connections_performance_replication_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            end_time = end_time,
            filter = filter,
    ...
    def _api214_array_connections_performance_replication_get_serialize(
        self,
        x_request_id,
        continuation_token,
        end_time,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.14/array-connections/performance/replication',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api214_array_connections_post_with_http_info(
        ...
        _param = self._api214_array_connections_post_serialize(
            array_connection = array_connection,
            x_request_id = x_request_id,
        )
    ...
    def _api214_array_connections_post_serialize(
        self,
        array_connection,
        x_request_id,
    ) -> RequestSerialized:
