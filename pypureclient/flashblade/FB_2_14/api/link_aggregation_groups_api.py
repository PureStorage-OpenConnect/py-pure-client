...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_14.models.api214_link_aggregation_groups_patch_request import Api214LinkAggregationGroupsPatchRequest
from pypureclient.flashblade.FB_2_14.models.link_aggregation_group import LinkAggregationGroup
from pypureclient.flashblade.FB_2_14.models.link_aggregation_group_get_response import LinkAggregationGroupGetResponse
from pypureclient.flashblade.FB_2_14.models.link_aggregation_group_response import LinkAggregationGroupResponse
...
class LinkAggregationGroupsApi:
    ...
    def api214_link_aggregation_groups_delete_with_http_info(
        ...
        _param = self._api214_link_aggregation_groups_delete_serialize(
    ...
    def _api214_link_aggregation_groups_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/link-aggregation-groups',
    ...
    def api214_link_aggregation_groups_get_with_http_info(
        ...
        _param = self._api214_link_aggregation_groups_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api214_link_aggregation_groups_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api214_link_aggregation_groups_patch_with_http_info(
        self,
        link_aggregation_group: Api214LinkAggregationGroupsPatchRequest,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
        ...
        :type link_aggregation_group: Api214LinkAggregationGroupsPatchRequest
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        :param ids: A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.
        :type ids: List[str]
        ...
        _param = self._api214_link_aggregation_groups_patch_serialize(
    ...
    def _api214_link_aggregation_groups_patch_serialize(
        self,
    ...
    def api214_link_aggregation_groups_post_with_http_info(
        ...
        _param = self._api214_link_aggregation_groups_post_serialize(
            names = names,
            link_aggregation_group = link_aggregation_group,
            x_request_id = x_request_id,
        )
    ...
    def _api214_link_aggregation_groups_post_serialize(
        self,
        names,
        link_aggregation_group,
        x_request_id,
