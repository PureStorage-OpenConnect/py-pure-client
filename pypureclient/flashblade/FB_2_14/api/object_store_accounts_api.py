...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_14.models.object_store_account_get_response import ObjectStoreAccountGetResponse
from pypureclient.flashblade.FB_2_14.models.object_store_account_patch import ObjectStoreAccountPatch
from pypureclient.flashblade.FB_2_14.models.object_store_account_post import ObjectStoreAccountPost
from pypureclient.flashblade.FB_2_14.models.object_store_account_response import ObjectStoreAccountResponse
...
class ObjectStoreAccountsApi:
    ...
    def api214_object_store_accounts_delete_with_http_info(
        ...
        _param = self._api214_object_store_accounts_delete_serialize(
    ...
    def _api214_object_store_accounts_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/object-store-accounts',
    ...
    def api214_object_store_accounts_get_with_http_info(
        ...
        _param = self._api214_object_store_accounts_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api214_object_store_accounts_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api214_object_store_accounts_patch_with_http_info(
        ...
        _param = self._api214_object_store_accounts_patch_serialize(
    ...
    def _api214_object_store_accounts_patch_serialize(
        self,
    ...
    def api214_object_store_accounts_post_with_http_info(
        ...
        _param = self._api214_object_store_accounts_post_serialize(
            names = names,
            x_request_id = x_request_id,
            object_store_account = object_store_account,
        )
    ...
    def _api214_object_store_accounts_post_serialize(
        self,
        names,
        x_request_id,
        object_store_account,
