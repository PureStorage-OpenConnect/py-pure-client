...
class ObjectStoreAccountsApi(object):
    ...
    def api214_object_store_accounts_delete_with_http_info(
        self,
        ...
        >>> thread = api.api214_object_store_accounts_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.14/object-store-accounts', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api214_object_store_accounts_get_with_http_info(
        self,
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_object_store_accounts_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_object_store_accounts_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api214_object_store_accounts_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.14/object-store-accounts', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api214_object_store_accounts_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_object_store_accounts_patch_with_http_info(object_store_account, async_req=True)
        >>> result = thread.get()
        ...
        if object_store_account is None:
            raise TypeError("Missing the required parameter `object_store_account` when calling `api214_object_store_accounts_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.14/object-store-accounts', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api214_object_store_accounts_post_with_http_info(
        self,
        names=None,  # type: List[str]
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_object_store_accounts_post_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api214_object_store_accounts_post`")
        ...
        return self.api_client.call_api(
            '/api/2.14/object-store-accounts', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
