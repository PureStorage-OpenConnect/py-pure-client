...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_14.models.object_store_remote_credential_get_resp import ObjectStoreRemoteCredentialGetResp
from pypureclient.flashblade.FB_2_14.models.object_store_remote_credentials import ObjectStoreRemoteCredentials
from pypureclient.flashblade.FB_2_14.models.object_store_remote_credentials_post import ObjectStoreRemoteCredentialsPost
from pypureclient.flashblade.FB_2_14.models.object_store_remote_credentials_resp import ObjectStoreRemoteCredentialsResp
...
class ObjectStoreRemoteCredentialsApi:
    ...
    def api214_object_store_remote_credentials_delete_with_http_info(
        ...
        _param = self._api214_object_store_remote_credentials_delete_serialize(
    ...
    def _api214_object_store_remote_credentials_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/object-store-remote-credentials',
    ...
    def api214_object_store_remote_credentials_get_with_http_info(
        ...
        _param = self._api214_object_store_remote_credentials_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api214_object_store_remote_credentials_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api214_object_store_remote_credentials_patch_with_http_info(
        ...
        _param = self._api214_object_store_remote_credentials_patch_serialize(
    ...
    def _api214_object_store_remote_credentials_patch_serialize(
        self,
        remote_credentials,
        x_request_id,
        ids,
    ...
    def api214_object_store_remote_credentials_post_with_http_info(
        ...
        _param = self._api214_object_store_remote_credentials_post_serialize(
            names = names,
            remote_credentials = remote_credentials,
            x_request_id = x_request_id,
        )
    ...
    def _api214_object_store_remote_credentials_post_serialize(
        self,
        names,
        remote_credentials,
        x_request_id,
