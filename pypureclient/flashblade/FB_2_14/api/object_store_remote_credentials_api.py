...
class ObjectStoreRemoteCredentialsApi(object):
    ...
    def api214_object_store_remote_credentials_delete_with_http_info(
        self,
        ...
        >>> thread = api.api214_object_store_remote_credentials_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.14/object-store-remote-credentials', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api214_object_store_remote_credentials_get_with_http_info(
        self,
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_object_store_remote_credentials_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_object_store_remote_credentials_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api214_object_store_remote_credentials_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.14/object-store-remote-credentials', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api214_object_store_remote_credentials_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_object_store_remote_credentials_patch_with_http_info(remote_credentials, async_req=True)
        >>> result = thread.get()
        ...
        if remote_credentials is None:
            raise TypeError("Missing the required parameter `remote_credentials` when calling `api214_object_store_remote_credentials_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.14/object-store-remote-credentials', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api214_object_store_remote_credentials_post_with_http_info(
        self,
        names=None,  # type: List[str]
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_object_store_remote_credentials_post_with_http_info(names, remote_credentials, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api214_object_store_remote_credentials_post`")
        # verify the required parameter 'remote_credentials' is set
        if remote_credentials is None:
            raise TypeError("Missing the required parameter `remote_credentials` when calling `api214_object_store_remote_credentials_post`")
        ...
        return self.api_client.call_api(
            '/api/2.14/object-store-remote-credentials', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
