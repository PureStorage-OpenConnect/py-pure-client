...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_14.models.keytab_get_response import KeytabGetResponse
from pypureclient.flashblade.FB_2_14.models.keytab_post import KeytabPost
from pypureclient.flashblade.FB_2_14.models.keytab_response import KeytabResponse
...
class KeytabsApi:
    ...
    def api214_keytabs_delete_with_http_info(
        ...
        _param = self._api214_keytabs_delete_serialize(
    ...
    def _api214_keytabs_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/keytabs',
    ...
    def api214_keytabs_download_get_with_http_info(
        ...
        _param = self._api214_keytabs_download_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api214_keytabs_download_get_serialize(
        self,
        x_request_id,
        keytab_ids,
        keytab_names,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.14/keytabs/download',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api214_keytabs_get_with_http_info(
        ...
        _param = self._api214_keytabs_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api214_keytabs_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api214_keytabs_post_with_http_info(
        ...
        _param = self._api214_keytabs_post_serialize(
            keytab = keytab,
            x_request_id = x_request_id,
    ...
    def _api214_keytabs_post_serialize(
        self,
        keytab,
        x_request_id,
        name_prefixes,
    ...
    def api214_keytabs_upload_post_with_http_info(
        ...
        _param = self._api214_keytabs_upload_post_serialize(
    ...
    def _api214_keytabs_upload_post_serialize(
        self,
        keytab_file,
        x_request_id,
        name_prefixes,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2.14/keytabs/upload',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
