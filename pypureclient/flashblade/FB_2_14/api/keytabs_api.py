...
class KeytabsApi(object):
    ...
    def api214_keytabs_delete_with_http_info(
        self,
        ...
        >>> thread = api.api214_keytabs_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api214_keytabs_download_get_with_http_info(
        self,
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_keytabs_download_get_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api214_keytabs_get_with_http_info(
        self,
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_keytabs_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_keytabs_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api214_keytabs_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api214_keytabs_post_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_keytabs_post_with_http_info(keytab, async_req=True)
        >>> result = thread.get()
        ...
        if keytab is None:
            raise TypeError("Missing the required parameter `keytab` when calling `api214_keytabs_post`")
    ...
    def api214_keytabs_upload_post_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_keytabs_upload_post_with_http_info(keytab_file, async_req=True)
        >>> result = thread.get()
        ...
        if keytab_file is None:
            raise TypeError("Missing the required parameter `keytab_file` when calling `api214_keytabs_upload_post`")
