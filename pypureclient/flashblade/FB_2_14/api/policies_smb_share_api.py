...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_14.models.smb_share_policy import SmbSharePolicy
from pypureclient.flashblade.FB_2_14.models.smb_share_policy_get_response import SmbSharePolicyGetResponse
from pypureclient.flashblade.FB_2_14.models.smb_share_policy_post import SmbSharePolicyPost
from pypureclient.flashblade.FB_2_14.models.smb_share_policy_response import SmbSharePolicyResponse
from pypureclient.flashblade.FB_2_14.models.smb_share_policy_rule import SmbSharePolicyRule
from pypureclient.flashblade.FB_2_14.models.smb_share_policy_rule_get_response import SmbSharePolicyRuleGetResponse
from pypureclient.flashblade.FB_2_14.models.smb_share_policy_rule_post import SmbSharePolicyRulePost
from pypureclient.flashblade.FB_2_14.models.smb_share_policy_rule_response import SmbSharePolicyRuleResponse
...
class PoliciesSMBShareApi:
    ...
    def api214_smb_share_policies_delete_with_http_info(
        ...
        _param = self._api214_smb_share_policies_delete_serialize(
    ...
    def _api214_smb_share_policies_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/smb-share-policies',
    ...
    def api214_smb_share_policies_get_with_http_info(
        ...
        _param = self._api214_smb_share_policies_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api214_smb_share_policies_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api214_smb_share_policies_patch_with_http_info(
        ...
        _param = self._api214_smb_share_policies_patch_serialize(
            policy = policy,
            x_request_id = x_request_id,
            ids = ids,
            names = names,
    ...
    def _api214_smb_share_policies_patch_serialize(
        self,
        policy,
        x_request_id,
        ids,
    ...
    def api214_smb_share_policies_post_with_http_info(
        ...
        _param = self._api214_smb_share_policies_post_serialize(
            names = names,
            x_request_id = x_request_id,
            policy = policy,
        )
    ...
    def _api214_smb_share_policies_post_serialize(
        self,
        names,
        x_request_id,
        policy,
    ...
    def api214_smb_share_policies_rules_delete_with_http_info(
        ...
        _param = self._api214_smb_share_policies_rules_delete_serialize(
            x_request_id = x_request_id,
            ids = ids,
            names = names,
    ...
    def _api214_smb_share_policies_rules_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.14/smb-share-policies/rules',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api214_smb_share_policies_rules_get_with_http_info(
        ...
        _param = self._api214_smb_share_policies_rules_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
    ...
    def _api214_smb_share_policies_rules_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api214_smb_share_policies_rules_patch_with_http_info(
        ...
        _param = self._api214_smb_share_policies_rules_patch_serialize(
            rule = rule,
            x_request_id = x_request_id,
            ids = ids,
            names = names,
    ...
    def _api214_smb_share_policies_rules_patch_serialize(
        self,
        rule,
        x_request_id,
        ids,
    ...
    def api214_smb_share_policies_rules_post_with_http_info(
        ...
        _param = self._api214_smb_share_policies_rules_post_serialize(
            rule = rule,
            x_request_id = x_request_id,
            policy_ids = policy_ids,
            policy_names = policy_names,
    ...
    def _api214_smb_share_policies_rules_post_serialize(
        self,
        rule,
        x_request_id,
        policy_ids,
