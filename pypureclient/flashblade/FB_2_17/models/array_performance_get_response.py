...
from pypureclient.flashblade.FB_2_17.models.array_performance import ArrayPerformance
from pypureclient.flashblade.FB_2_17.models.error_context_response_errors import ErrorContextResponseErrors


class ArrayPerformanceGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ArrayPerformance)] = Field(default=None, description="A list of array performance metrics objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayPerformanceGetResponse:
        """Create an instance of ArrayPerformanceGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayPerformanceGetResponse:
        """Create an instance of ArrayPerformanceGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayPerformanceGetResponse.parse_obj(obj)

        _obj = ArrayPerformanceGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ArrayPerformance.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
