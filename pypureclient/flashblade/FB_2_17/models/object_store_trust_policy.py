...
class ObjectStoreTrustPolicy(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        rules=None,  # type: List[models.TrustPolicyRule]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ObjectStoreTrustPolicy`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ObjectStoreTrustPolicy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectStoreTrustPolicy):
            return False
