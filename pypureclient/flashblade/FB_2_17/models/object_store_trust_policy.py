...
from pypureclient.flashblade.FB_2_17.models.trust_policy_rule import TrustPolicyRule
...
class ObjectStoreTrustPolicy(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "context", "role", "rules"]
