...
from pypureclient.flashblade.FB_2_17.models.trust_policy_rule_with_context import TrustPolicyRuleWithContext


class ObjectStoreTrustPolicyRuleGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(TrustPolicyRuleWithContext)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreTrustPolicyRuleGetResponse:
        """Create an instance of ObjectStoreTrustPolicyRuleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreTrustPolicyRuleGetResponse:
        """Create an instance of ObjectStoreTrustPolicyRuleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreTrustPolicyRuleGetResponse.parse_obj(obj)

        _obj = ObjectStoreTrustPolicyRuleGetResponse.construct(_fields_set=None, **{
            ...
            "items": [TrustPolicyRuleWithContext.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
