...
class ObjectStoreTrustPolicyRuleGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        items=None,  # type: List[models.TrustPolicyRuleWithContext]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ObjectStoreTrustPolicyRuleGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ObjectStoreTrustPolicyRuleGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectStoreTrustPolicyRuleGetResponse):
            return False
