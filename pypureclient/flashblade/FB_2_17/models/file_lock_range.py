...
class FileLockRange(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileLockRange:
        """Create an instance of FileLockRange from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileLockRange:
        """Create an instance of FileLockRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileLockRange.parse_obj(obj)

        _obj = FileLockRange.construct(_fields_set=None, **{
