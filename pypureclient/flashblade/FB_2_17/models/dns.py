...
class Dns(BaseModel):
    ...
    sources: Optional[conlist(Reference, max_items=1)] = Field(default=None, description="The network interfaces used for communication with the DNS server. The network interfaces must have the `services` value of `data`. Clear this by setting an empty list.")
    __properties = ["id", "name", "domain", "nameservers", "services", "sources"]
