...
class FileSystemOpenFilesGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        items=None,  # type: List[models.FileSystemOpenFile]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `FileSystemOpenFilesGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(FileSystemOpenFilesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileSystemOpenFilesGetResponse):
            return False
