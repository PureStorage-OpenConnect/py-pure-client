...
class FileSystemEradicationConfig(BaseModel):
    ...
    __properties = ["eradication_mode", "manual_eradication"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemEradicationConfig:
        """Create an instance of FileSystemEradicationConfig from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemEradicationConfig:
        """Create an instance of FileSystemEradicationConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemEradicationConfig.parse_obj(obj)

        _obj = FileSystemEradicationConfig.construct(_fields_set=None, **{
