...
class FileSystemPerformance(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemPerformance:
        """Create an instance of FileSystemPerformance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemPerformance:
        """Create an instance of FileSystemPerformance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemPerformance.parse_obj(obj)

        _obj = FileSystemPerformance.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
