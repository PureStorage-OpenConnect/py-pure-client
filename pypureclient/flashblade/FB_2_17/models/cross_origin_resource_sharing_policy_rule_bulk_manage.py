...
class CrossOriginResourceSharingPolicyRuleBulkManage(BaseModel):
    """
    ...
    __properties = ["allowed_headers", "allowed_methods", "allowed_origins", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CrossOriginResourceSharingPolicyRuleBulkManage:
        """Create an instance of CrossOriginResourceSharingPolicyRuleBulkManage from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CrossOriginResourceSharingPolicyRuleBulkManage:
        """Create an instance of CrossOriginResourceSharingPolicyRuleBulkManage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CrossOriginResourceSharingPolicyRuleBulkManage.parse_obj(obj)

        _obj = CrossOriginResourceSharingPolicyRuleBulkManage.construct(_fields_set=None, **{
