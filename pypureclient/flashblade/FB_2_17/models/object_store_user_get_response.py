...
from pypureclient.flashblade.FB_2_17.models.object_store_user import ObjectStoreUser


class ObjectStoreUserGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ObjectStoreUser)] = Field(default=None, description="A list of object store user objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreUserGetResponse:
        """Create an instance of ObjectStoreUserGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreUserGetResponse:
        """Create an instance of ObjectStoreUserGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreUserGetResponse.parse_obj(obj)

        _obj = ObjectStoreUserGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ObjectStoreUser.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
