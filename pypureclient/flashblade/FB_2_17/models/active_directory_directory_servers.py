...
class ActiveDirectoryDirectoryServers(BaseModel):
    ...
    __properties = ["directory_servers", "global_catalog_servers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActiveDirectoryDirectoryServers:
        """Create an instance of ActiveDirectoryDirectoryServers from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ActiveDirectoryDirectoryServers:
        """Create an instance of ActiveDirectoryDirectoryServers from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActiveDirectoryDirectoryServers.parse_obj(obj)

        _obj = ActiveDirectoryDirectoryServers.construct(_fields_set=None, **{
