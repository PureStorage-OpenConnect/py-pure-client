...
from pypureclient.flashblade.FB_2_17.models.smb_client_policy_rule import SmbClientPolicyRule


class SmbClientPolicyRuleGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SmbClientPolicyRule)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmbClientPolicyRuleGetResponse:
        """Create an instance of SmbClientPolicyRuleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmbClientPolicyRuleGetResponse:
        """Create an instance of SmbClientPolicyRuleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmbClientPolicyRuleGetResponse.parse_obj(obj)

        _obj = SmbClientPolicyRuleGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [SmbClientPolicyRule.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
