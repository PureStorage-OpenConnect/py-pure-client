...
class SmbSharePolicyRuleGetResponse(object):
    ...
    swagger_types = {
        ...
        'items': 'list[SmbSharePolicyRuleWithContext]',
    ...
    def __init__(
        ...
        items=None,  # type: List[models.SmbSharePolicyRuleWithContext]
        ...
        Keyword args:
            ...
            items (list[SmbSharePolicyRuleWithContext]): A list of SMB Share policy rule objects.
