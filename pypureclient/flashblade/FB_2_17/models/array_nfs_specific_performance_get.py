...
from pypureclient.flashblade.FB_2_17.models.array_nfs_specific_performance import ArrayNfsSpecificPerformance
from pypureclient.flashblade.FB_2_17.models.error_context_response_errors import ErrorContextResponseErrors


class ArrayNfsSpecificPerformanceGet(BaseModel):
    """
    ...
    items: Optional[conlist(ArrayNfsSpecificPerformance)] = Field(default=None, description="A list of NFS specific array performance metrics objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayNfsSpecificPerformanceGet:
        """Create an instance of ArrayNfsSpecificPerformanceGet from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArrayNfsSpecificPerformanceGet:
        """Create an instance of ArrayNfsSpecificPerformanceGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayNfsSpecificPerformanceGet.parse_obj(obj)

        _obj = ArrayNfsSpecificPerformanceGet.construct(_fields_set=None, **{
            ...
            "items": [ArrayNfsSpecificPerformance.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
