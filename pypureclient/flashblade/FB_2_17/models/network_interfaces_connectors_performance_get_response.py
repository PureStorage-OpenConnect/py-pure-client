...
class NetworkInterfacesConnectorsPerformanceGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'total': 'list[NetworkInterfacesConnectorsPerformance]',
        'items': 'list[NetworkInterfacesConnectorsPerformance]'
    }
    ...
    def __init__(
        ...
        total=None,  # type: List[models.NetworkInterfacesConnectorsPerformance]
        items=None,  # type: List[models.NetworkInterfacesConnectorsPerformance]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `NetworkInterfacesConnectorsPerformanceGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(NetworkInterfacesConnectorsPerformanceGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkInterfacesConnectorsPerformanceGetResponse):
            return False
