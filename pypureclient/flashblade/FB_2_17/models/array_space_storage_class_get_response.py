...
class ArraySpaceStorageClassGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        total=None,  # type: models.StorageClassSpace
        items=None,  # type: List[models.StorageClassSpace]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ArraySpaceStorageClassGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ArraySpaceStorageClassGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArraySpaceStorageClassGetResponse):
            return False
