...
from pypureclient.flashblade.FB_2_17.models.drive_get_response import DriveGetResponse
...
class DrivesApi:
    ...
    def api217_drives_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_drives_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_only, async_req=True)
        >>> result = thread.get()
