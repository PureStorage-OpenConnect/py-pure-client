...
from pypureclient.flashblade.FB_2_17.models.object_store_virtual_host_get_response import ObjectStoreVirtualHostGetResponse
from pypureclient.flashblade.FB_2_17.models.object_store_virtual_host_response import ObjectStoreVirtualHostResponse
...
class ObjectStoreVirtualHostsApi:
    ...
    def api217_object_store_virtual_hosts_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api217_object_store_virtual_hosts_delete_with_http_info(x_request_id, context_names, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.17/object-store-virtual-hosts', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api217_object_store_virtual_hosts_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api217_object_store_virtual_hosts_get_with_http_info(x_request_id, allow_errors, context_names, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.17/object-store-virtual-hosts', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api217_object_store_virtual_hosts_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api217_object_store_virtual_hosts_post_with_http_info(names, x_request_id, context_names, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.17/object-store-virtual-hosts', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
