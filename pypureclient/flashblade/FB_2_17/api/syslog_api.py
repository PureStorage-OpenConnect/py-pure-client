...
from pypureclient.flashblade.FB_2_17.models.syslog_server_get_response import SyslogServerGetResponse
from pypureclient.flashblade.FB_2_17.models.syslog_server_patch import SyslogServerPatch
from pypureclient.flashblade.FB_2_17.models.syslog_server_post import SyslogServerPost
from pypureclient.flashblade.FB_2_17.models.syslog_server_response import SyslogServerResponse
from pypureclient.flashblade.FB_2_17.models.syslog_server_settings import SyslogServerSettings
from pypureclient.flashblade.FB_2_17.models.syslog_server_settings_get_response import SyslogServerSettingsGetResponse
from pypureclient.flashblade.FB_2_17.models.syslog_server_settings_response import SyslogServerSettingsResponse
...
class SyslogApi:
    ...
    def api217_syslog_servers_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_syslog_servers_delete_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_syslog_servers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_syslog_servers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_syslog_servers_get_with_http_info(x_request_id, allow_errors, context_names, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_syslog_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_syslog_servers_patch_with_http_info(
        ...
        **kwargs
        ...
        Modify the URI or services of a configured syslog server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api217_syslog_servers_patch_with_http_info(syslog_server, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_syslog_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_syslog_servers_post_with_http_info(
        ...
        **kwargs
        ...
        Configure a new syslog server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api217_syslog_servers_post_with_http_info(syslog_server, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_syslog_servers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_syslog_servers_settings_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_syslog_servers_settings_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_syslog_servers_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_syslog_servers_settings_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_syslog_servers_settings_patch_with_http_info(syslog_server_settings, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_syslog_servers_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_syslog_servers_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_syslog_servers_test_get_with_http_info(x_request_id, continuation_token, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_syslog_servers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
