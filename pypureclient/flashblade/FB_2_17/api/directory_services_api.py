...
from pypureclient.flashblade.FB_2_17.models.directory_service_get_response import DirectoryServiceGetResponse
from pypureclient.flashblade.FB_2_17.models.directory_service_response import DirectoryServiceResponse
from pypureclient.flashblade.FB_2_17.models.directory_service_role import DirectoryServiceRole
from pypureclient.flashblade.FB_2_17.models.directory_service_roles_get_response import DirectoryServiceRolesGetResponse
from pypureclient.flashblade.FB_2_17.models.directory_service_roles_response import DirectoryServiceRolesResponse
...
class DirectoryServicesApi:
    ...
    def api217_directory_services_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_directory_services_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_directory_services_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_directory_services_patch_with_http_info(directory_service, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api217_directory_services_roles_delete_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        **kwargs
        ...
        >>> thread = api.api217_directory_services_roles_delete_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.17/directory-services/roles', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api217_directory_services_roles_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_directory_services_roles_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, role_ids, role_names, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_directory_services_roles_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_directory_services_roles_patch_with_http_info(directory_service_roles, x_request_id, ids, names, role_ids, role_names, async_req=True)
        >>> result = thread.get()
    ...
    def api217_directory_services_roles_post_with_http_info(
        self,
        directory_service_roles: DirectoryServiceRole,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        **kwargs
        ...
        >>> thread = api.api217_directory_services_roles_post_with_http_info(directory_service_roles, x_request_id, names, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.17/directory-services/roles', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api217_directory_services_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_directory_services_test_get_with_http_info(x_request_id, filter, ids, limit, names, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_directory_services_test_patch_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api217_directory_services_test_patch_with_http_info(x_request_id, filter, ids, names, sort, directory_service, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.17/directory-services/test', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
