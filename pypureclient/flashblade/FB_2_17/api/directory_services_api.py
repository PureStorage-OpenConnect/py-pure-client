...
class DirectoryServicesApi(object):
    ...
    def api217_directory_services_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_directory_services_patch_with_http_info(directory_service, async_req=True)
        >>> result = thread.get()
    ...
    def api217_directory_services_roles_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_directory_services_roles_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api217_directory_services_roles_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_directory_services_roles_patch_with_http_info(directory_service_roles, async_req=True)
        >>> result = thread.get()
    ...
    def api217_directory_services_roles_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_directory_services_roles_post_with_http_info(directory_service_roles, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'directory_service_roles' is set
        if directory_service_roles is None:
            raise TypeError("Missing the required parameter `directory_service_roles` when calling `api217_directory_services_roles_post`")
    ...
    def api217_directory_services_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_directory_services_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api217_directory_services_test_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_directory_services_test_patch_with_http_info(async_req=True)
        >>> result = thread.get()
