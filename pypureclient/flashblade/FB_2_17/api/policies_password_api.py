...
from pypureclient.flashblade.FB_2_17.models.password_policies_get_response import PasswordPoliciesGetResponse
from pypureclient.flashblade.FB_2_17.models.password_policies_response import PasswordPoliciesResponse
from pypureclient.flashblade.FB_2_17.models.password_policy import PasswordPolicy
...
class PoliciesPasswordApi:
    ...
    def api217_password_policies_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api217_password_policies_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: tuple(PasswordPoliciesGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_password_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "PasswordPoliciesGetResponse",
        }

        return self.api_client.call_api(
            '/api/2.17/password-policies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api217_password_policies_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api217_password_policies_patch_with_http_info(policy, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PasswordPoliciesResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_password_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "PasswordPoliciesResponse",
        }

        return self.api_client.call_api(
            '/api/2.17/password-policies', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
