...
class MaintenanceWindowsApi(object):
    ...
    def api217_maintenance_windows_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_maintenance_windows_post_with_http_info(maintenance_window, names, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api217_maintenance_windows_post`")
