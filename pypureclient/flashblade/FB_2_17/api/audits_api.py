...
from pypureclient.flashblade.FB_2_17.models.audit_get_response import AuditGetResponse
...
class AuditsApi:
    ...
    def api217_audits_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_audits_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
