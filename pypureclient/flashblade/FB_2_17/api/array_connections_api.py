...
from pypureclient.flashblade.FB_2_17.models.array_connection import ArrayConnection
from pypureclient.flashblade.FB_2_17.models.array_connection_get_response import ArrayConnectionGetResponse
from pypureclient.flashblade.FB_2_17.models.array_connection_key_get_response import ArrayConnectionKeyGetResponse
from pypureclient.flashblade.FB_2_17.models.array_connection_key_response import ArrayConnectionKeyResponse
from pypureclient.flashblade.FB_2_17.models.array_connection_path_get_response import ArrayConnectionPathGetResponse
from pypureclient.flashblade.FB_2_17.models.array_connection_post import ArrayConnectionPost
from pypureclient.flashblade.FB_2_17.models.array_connection_response import ArrayConnectionResponse
from pypureclient.flashblade.FB_2_17.models.connection_relationship_performance_replication_get_resp import ConnectionRelationshipPerformanceReplicationGetResp
...
class ArrayConnectionsApi:
    ...
    def api217_array_connections_connection_key_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_array_connections_connection_key_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_array_connections_connection_key_post_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.api217_array_connections_connection_key_post_with_http_info(x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.17/array-connections/connection-key', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api217_array_connections_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_array_connections_delete_with_http_info(x_request_id, context_names, ids, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
    ...
    def api217_array_connections_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_array_connections_get_with_http_info(x_request_id, allow_errors, context_names, continuation_token, filter, ids, limit, offset, remote_ids, remote_names, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_array_connections_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_array_connections_patch_with_http_info(array_connection, x_request_id, context_names, ids, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
    ...
    def api217_array_connections_path_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_array_connections_path_get_with_http_info(x_request_id, allow_errors, context_names, continuation_token, filter, ids, limit, offset, remote_ids, remote_names, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_array_connections_performance_replication_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api217_array_connections_performance_replication_get_with_http_info(x_request_id, continuation_token, end_time, filter, ids, limit, offset, remote_ids, remote_names, resolution, sort, start_time, total_only, type, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.17/array-connections/performance/replication', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api217_array_connections_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_array_connections_post_with_http_info(array_connection, x_request_id, context_names, async_req=True)
        >>> result = thread.get()
