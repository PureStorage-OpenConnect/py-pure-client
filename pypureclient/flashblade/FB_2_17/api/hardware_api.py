...
from pypureclient.flashblade.FB_2_17.models.hardware import Hardware
from pypureclient.flashblade.FB_2_17.models.hardware_get_response import HardwareGetResponse
from pypureclient.flashblade.FB_2_17.models.hardware_response import HardwareResponse
...
class HardwareApi:
    ...
    def api217_hardware_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_hardware_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_hardware_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_hardware_patch_with_http_info(hardware, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
