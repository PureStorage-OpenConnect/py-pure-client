...
class ServersApi(object):
    ...
    def api217_servers_delete_with_http_info(
        self,
        ...
        >>> thread = api.api217_servers_delete_with_http_info(cascade_delete, async_req=True)
        >>> result = thread.get()
        ...
        if cascade_delete is None:
            raise TypeError("Missing the required parameter `cascade_delete` when calling `api217_servers_delete`")
    ...
    def api217_servers_get_with_http_info(
        self,
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_servers_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api217_servers_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api217_servers_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api217_servers_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_servers_patch_with_http_info(server, async_req=True)
        >>> result = thread.get()
        ...
        if server is None:
            raise TypeError("Missing the required parameter `server` when calling `api217_servers_patch`")
    ...
    def api217_servers_post_with_http_info(
        self,
        server=None,  # type: models.ServerPost
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_servers_post_with_http_info(server, create_ds, names, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'server' is set
        if server is None:
            raise TypeError("Missing the required parameter `server` when calling `api217_servers_post`")
        # verify the required parameter 'create_ds' is set
        if create_ds is None:
            raise TypeError("Missing the required parameter `create_ds` when calling `api217_servers_post`")
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api217_servers_post`")
