...
from pypureclient.flashblade.FB_2_17.models.logs_async_get_response import LogsAsyncGetResponse
from pypureclient.flashblade.FB_2_17.models.logs_async_response import LogsAsyncResponse
...
class LogsApi:
    ...
    def api217_logs_async_download_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_logs_async_download_get_with_http_info(x_request_id, names, async_req=True)
        >>> result = thread.get()
    ...
    def api217_logs_async_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_logs_async_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_logs_async_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_logs_async_patch_with_http_info(logs_async, x_request_id, async_req=True)
        >>> result = thread.get()
    ...
    def api217_logs_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_logs_get_with_http_info(x_request_id, end_time, start_time, async_req=True)
        >>> result = thread.get()
