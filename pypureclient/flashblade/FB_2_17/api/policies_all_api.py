...
from pypureclient.flashblade.FB_2_17.models.policy_base_get_response import PolicyBaseGetResponse
...
class PoliciesAllApi:
    ...
    def api217_policies_all_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_policies_all_get_with_http_info(x_request_id, allow_errors, context_names, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_policies_all_members_get_with_http_info(
        ...
        **kwargs
        ...
        List policies (of all types) mapped to other entities (file systems, snapshots, file system replica links, and object store users). Note: if more than 150,000 items would be returned in the response, an error will be thrown and query parameters must be used to limit the items queried.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
