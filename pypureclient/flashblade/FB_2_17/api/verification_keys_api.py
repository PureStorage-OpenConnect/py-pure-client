...
from pypureclient.flashblade.FB_2_17.models.verification_key_get_response import VerificationKeyGetResponse
from pypureclient.flashblade.FB_2_17.models.verification_key_patch import VerificationKeyPatch
from pypureclient.flashblade.FB_2_17.models.verification_key_response import VerificationKeyResponse
...
class VerificationKeysApi:
    ...
    def api217_support_verification_keys_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_support_verification_keys_get_with_http_info(x_request_id, continuation_token, filter, limit, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_support_verification_keys_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_support_verification_keys_patch_with_http_info(key, x_request_id, async_req=True)
        >>> result = thread.get()
