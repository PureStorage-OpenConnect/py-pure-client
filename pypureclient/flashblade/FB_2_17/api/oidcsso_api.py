...
from pypureclient.flashblade.FB_2_17.models.oidc_sso_get_response import OidcSsoGetResponse
from pypureclient.flashblade.FB_2_17.models.oidc_sso_patch import OidcSsoPatch
from pypureclient.flashblade.FB_2_17.models.oidc_sso_post import OidcSsoPost
from pypureclient.flashblade.FB_2_17.models.oidc_sso_response import OidcSsoResponse
...
class OIDCSSOApi:
    ...
    def api217_sso_oidc_idps_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_sso_oidc_idps_delete_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api217_sso_oidc_idps_get_with_http_info(
        ...
        **kwargs
        ...
        Displays the OIDC SSO configuration settings in the array.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api217_sso_oidc_idps_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_sso_oidc_idps_patch_with_http_info(
        ...
        **kwargs
        ...
        Modify one or more attributes of OIDC SSO configuration.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api217_sso_oidc_idps_patch_with_http_info(idp, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api217_sso_oidc_idps_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_sso_oidc_idps_post_with_http_info(idp, x_request_id, names, async_req=True)
        >>> result = thread.get()
