...
from pypureclient.flashblade.FB_2_17.models.blade_get_response import BladeGetResponse
...
class BladesApi:
    ...
    def api217_blades_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_blades_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_only, async_req=True)
        >>> result = thread.get()
