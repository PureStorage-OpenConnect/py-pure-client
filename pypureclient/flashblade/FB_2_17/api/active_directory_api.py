...
from pypureclient.flashblade.FB_2_17.models.active_directory_get_response import ActiveDirectoryGetResponse
from pypureclient.flashblade.FB_2_17.models.active_directory_patch import ActiveDirectoryPatch
from pypureclient.flashblade.FB_2_17.models.active_directory_post import ActiveDirectoryPost
from pypureclient.flashblade.FB_2_17.models.active_directory_response import ActiveDirectoryResponse
from pypureclient.flashblade.FB_2_17.models.test_result_get_response import TestResultGetResponse
...
class ActiveDirectoryApi:
    ...
    def api217_active_directory_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_active_directory_delete_with_http_info(x_request_id, ids, local_only, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_active_directory_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_active_directory_get_with_http_info(
        ...
        **kwargs
        ...
        List Active Directory accounts and their configuration.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api217_active_directory_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_active_directory_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_active_directory_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_active_directory_patch_with_http_info(active_directory, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_active_directory_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_active_directory_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_active_directory_post_with_http_info(active_directory, x_request_id, join_existing_account, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_active_directory_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api217_active_directory_test_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api217_active_directory_test_get_with_http_info(x_request_id, filter, ids, limit, names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_active_directory_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.17/active-directory/test', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
