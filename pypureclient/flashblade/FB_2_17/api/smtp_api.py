...
from pypureclient.flashblade.FB_2_17.models.smtp_server_get_response import SmtpServerGetResponse
from pypureclient.flashblade.FB_2_17.models.smtp_server_response import SmtpServerResponse
...
class SMTPApi:
    ...
    def api217_smtp_servers_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_smtp_servers_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_smtp_servers_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_smtp_servers_patch_with_http_info(smtp, x_request_id, async_req=True)
        >>> result = thread.get()
