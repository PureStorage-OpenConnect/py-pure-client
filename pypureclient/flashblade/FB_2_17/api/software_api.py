...
from pypureclient.flashblade.FB_2_17.models.software_checks_get_response import SoftwareChecksGetResponse
from pypureclient.flashblade.FB_2_17.models.software_checks_response import SoftwareChecksResponse
...
class SoftwareApi:
    ...
    def api217_software_check_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_software_check_get_with_http_info(filter, ids, limit, names, offset, software_names, software_versions, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api217_software_check_post_with_http_info(
        ...
        **kwargs
        ...
        Creates a software check task. To create a task, use a software name and version. If a task is already running, an error is returned.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api217_software_check_post_with_http_info(x_request_id, software_names, software_versions, async_req=True)
        >>> result = thread.get()
