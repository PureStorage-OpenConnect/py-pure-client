...
class AdministratorsApi(object):
    ...
    def api217_admins_cache_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_admins_cache_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api217_admins_settings_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_admins_settings_patch_with_http_info(admin_setting, async_req=True)
        >>> result = thread.get()
        ...
        if admin_setting is None:
            raise TypeError("Missing the required parameter `admin_setting` when calling `api217_admins_settings_patch`")
