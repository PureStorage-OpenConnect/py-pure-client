...
from pypureclient.flashblade.FB_2_17.models.api217_link_aggregation_groups_patch_request import Api217LinkAggregationGroupsPatchRequest
from pypureclient.flashblade.FB_2_17.models.link_aggregation_group import LinkAggregationGroup
from pypureclient.flashblade.FB_2_17.models.link_aggregation_group_get_response import LinkAggregationGroupGetResponse
from pypureclient.flashblade.FB_2_17.models.link_aggregation_group_response import LinkAggregationGroupResponse
...
class LinkAggregationGroupsApi:
    ...
    def api217_link_aggregation_groups_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_link_aggregation_groups_delete_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api217_link_aggregation_groups_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_link_aggregation_groups_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_link_aggregation_groups_patch_with_http_info(
        self,
        link_aggregation_group: Api217LinkAggregationGroupsPatchRequest,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        **kwargs
        ...
        >>> thread = api.api217_link_aggregation_groups_patch_with_http_info(link_aggregation_group, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()

        :param link_aggregation_group: (required)
        :type link_aggregation_group: Api217LinkAggregationGroupsPatchRequest
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        :param ids: A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.
        :type ids: List[str]
    ...
    def api217_link_aggregation_groups_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_link_aggregation_groups_post_with_http_info(names, link_aggregation_group, x_request_id, async_req=True)
        >>> result = thread.get()
