...
class LinkAggregationGroupsApi(object):
    ...
    def api217_link_aggregation_groups_delete_with_http_info(
        self,
        ...
        >>> thread = api.api217_link_aggregation_groups_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.17/link-aggregation-groups', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api217_link_aggregation_groups_get_with_http_info(
        self,
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_link_aggregation_groups_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api217_link_aggregation_groups_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api217_link_aggregation_groups_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.17/link-aggregation-groups', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api217_link_aggregation_groups_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_link_aggregation_groups_patch_with_http_info(link_aggregation_group, async_req=True)
        >>> result = thread.get()
        ...
        if link_aggregation_group is None:
            raise TypeError("Missing the required parameter `link_aggregation_group` when calling `api217_link_aggregation_groups_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.17/link-aggregation-groups', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api217_link_aggregation_groups_post_with_http_info(
        self,
        link_aggregation_group=None,  # type: models.LinkAggregationGroup
        names=None,  # type: List[str]
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api217_link_aggregation_groups_post_with_http_info(link_aggregation_group, names, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'link_aggregation_group' is set
        if link_aggregation_group is None:
            raise TypeError("Missing the required parameter `link_aggregation_group` when calling `api217_link_aggregation_groups_post`")
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api217_link_aggregation_groups_post`")
        ...
        return self.api_client.call_api(
            '/api/2.17/link-aggregation-groups', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
