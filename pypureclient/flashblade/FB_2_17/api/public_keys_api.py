...
from pypureclient.flashblade.FB_2_17.models.public_key_get_response import PublicKeyGetResponse
from pypureclient.flashblade.FB_2_17.models.public_key_post import PublicKeyPost
from pypureclient.flashblade.FB_2_17.models.public_key_response import PublicKeyResponse
from pypureclient.flashblade.FB_2_17.models.public_key_use_get_response import PublicKeyUseGetResponse
...
class PublicKeysApi:
    ...
    def api217_public_keys_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_public_keys_delete_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api217_public_keys_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_public_keys_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api217_public_keys_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_public_keys_post_with_http_info(names, public_key, x_request_id, async_req=True)
        >>> result = thread.get()
    ...
    def api217_public_keys_uses_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api217_public_keys_uses_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
