...
from pypureclient.flashblade.FB_2_1.models.fixed_reference_name_only import FixedReferenceNameOnly
from pypureclient.flashblade.FB_2_1.models.reference_writable import ReferenceWritable
...
class BucketReplicaLink(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "direction", "lag", "status_details", "local_bucket", "paused", "recovery_point", "remote", "remote_bucket", "remote_credentials", "status"]
