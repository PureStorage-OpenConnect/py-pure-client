...
class Oauth210TokenPost400Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Oauth210TokenPost400Response:
        """Create an instance of Oauth210TokenPost400Response from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> Oauth210TokenPost400Response:
        """Create an instance of Oauth210TokenPost400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Oauth210TokenPost400Response.parse_obj(obj)

        _obj = Oauth210TokenPost400Response.construct(_fields_set=None, **{
            "error": obj.get("error"),
