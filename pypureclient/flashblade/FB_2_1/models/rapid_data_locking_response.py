...
class RapidDataLockingResponse(object):
    ...
    def __init__(
        self,
        items=None,  # type: List[models.RapidDataLocking]
    ):
        """
        Keyword args:
            items (list[RapidDataLocking])
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `RapidDataLockingResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(RapidDataLockingResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RapidDataLockingResponse):
            return False
