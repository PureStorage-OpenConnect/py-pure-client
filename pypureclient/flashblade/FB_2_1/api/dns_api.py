...
class DNSApi:
    ...
    def api21_dns_get_with_http_info(
        ...
        _param = self._api21_dns_get_serialize(
    ...
    def api21_dns_patch_with_http_info(
        ...
        _param = self._api21_dns_patch_serialize(
            dns = dns,
            ids = ids,
            names = names,
        )
    ...
    def _api21_dns_patch_serialize(
        self,
        dns,
        ids,
        names,
