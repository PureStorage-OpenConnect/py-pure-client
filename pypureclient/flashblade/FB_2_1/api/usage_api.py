...
class UsageApi(object):
    ...
    def api21_usage_groups_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api21_usage_groups_get`, must be a value greater than or equal to `0`")
    ...
    def api21_usage_users_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api21_usage_users_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
