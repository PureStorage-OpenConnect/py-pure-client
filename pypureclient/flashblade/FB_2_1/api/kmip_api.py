...
class KMIPApi(object):
    ...
    def api21_kmip_delete_with_http_info(
        self,
        ...
        >>> thread = api.api21_kmip_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api21_kmip_get_with_http_info(
        self,
        names=None,  # type: List[str]
        ids=None,  # type: List[str]
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_kmip_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api21_kmip_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api21_kmip_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api21_kmip_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_kmip_patch_with_http_info(kmip_server, async_req=True)
        >>> result = thread.get()
        ...
        if kmip_server is None:
            raise TypeError("Missing the required parameter `kmip_server` when calling `api21_kmip_patch`")
    ...
    def api21_kmip_post_with_http_info(
        self,
        kmip_server=None,  # type: models.KmipServer
        names=None,  # type: List[str]
        async_req=False,  # type: bool
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_kmip_post_with_http_info(kmip_server, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'kmip_server' is set
        if kmip_server is None:
            raise TypeError("Missing the required parameter `kmip_server` when calling `api21_kmip_post`")
    ...
    def api21_kmip_test_get_with_http_info(
        self,
        names=None,  # type: List[str]
        ids=None,  # type: List[str]
        async_req=False,  # type: bool
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_kmip_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
