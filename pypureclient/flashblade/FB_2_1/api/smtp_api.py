...
class SMTPApi:
    ...
    def api21_smtp_servers_get_with_http_info(
        ...
        _param = self._api21_smtp_servers_get_serialize(
    ...
    def _api21_smtp_servers_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.1/smtp-servers',
    ...
    def api21_smtp_servers_patch_with_http_info(
        ...
        _param = self._api21_smtp_servers_patch_serialize(
            smtp = smtp,
        )
    ...
    def _api21_smtp_servers_patch_serialize(
        self,
        smtp,
    ) -> RequestSerialized:
