...
class SMTPApi(object):
    ...
    def api21_smtp_servers_get_with_http_info(
        self,
        ...
        >>> thread = api.api21_smtp_servers_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api21_smtp_servers_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api21_smtp_servers_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api21_smtp_servers_patch_with_http_info(
        self,
        ...
        if smtp is None:
            raise TypeError("Missing the required parameter `smtp` when calling `api21_smtp_servers_patch`")
