...
class SubnetsApi:
    ...
    def api21_subnets_delete_with_http_info(
        ...
        _param = self._api21_subnets_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api21_subnets_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
    ...
    def api21_subnets_get_with_http_info(
        ...
        _param = self._api21_subnets_get_serialize(
    ...
    def _api21_subnets_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api21_subnets_patch_with_http_info(
        ...
        _param = self._api21_subnets_patch_serialize(
            subnet = subnet,
            ids = ids,
            names = names,
        )
    ...
    def _api21_subnets_patch_serialize(
        self,
        subnet,
        ids,
        names,
    ...
    def api21_subnets_post_with_http_info(
        ...
        _param = self._api21_subnets_post_serialize(
            names = names,
            subnet = subnet,
        )
    ...
    def _api21_subnets_post_serialize(
        self,
        names,
        subnet,
    ) -> RequestSerialized:
