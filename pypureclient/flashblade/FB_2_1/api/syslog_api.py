...
class SyslogApi(object):
    ...
    def api21_syslog_servers_delete_with_http_info(
        ...
        >>> thread = api.api21_syslog_servers_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api21_syslog_servers_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_syslog_servers_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api21_syslog_servers_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api21_syslog_servers_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api21_syslog_servers_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_syslog_servers_patch_with_http_info(syslog_server, async_req=True)
        >>> result = thread.get()
        ...
        if syslog_server is None:
            raise TypeError("Missing the required parameter `syslog_server` when calling `api21_syslog_servers_patch`")
    ...
    def api21_syslog_servers_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_syslog_servers_post_with_http_info(syslog_server, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'syslog_server' is set
        if syslog_server is None:
            raise TypeError("Missing the required parameter `syslog_server` when calling `api21_syslog_servers_post`")
    ...
    def api21_syslog_servers_settings_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_syslog_servers_settings_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api21_syslog_servers_settings_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api21_syslog_servers_settings_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api21_syslog_servers_settings_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_syslog_servers_settings_patch_with_http_info(syslog_server_settings, async_req=True)
        >>> result = thread.get()
        ...
        if syslog_server_settings is None:
            raise TypeError("Missing the required parameter `syslog_server_settings` when calling `api21_syslog_servers_settings_patch`")
    ...
    def api21_syslog_servers_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_syslog_servers_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
