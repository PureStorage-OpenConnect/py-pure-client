...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_1.models.admin_api_token_get_response import AdminApiTokenGetResponse
from pypureclient.flashblade.FB_2_1.models.admin_api_token_response import AdminApiTokenResponse
from pypureclient.flashblade.FB_2_1.models.admin_cache_get_response import AdminCacheGetResponse
...
class AdministratorsApi:
    ...
    @validate_call
    def api21_admins_api_tokens_delete_with_http_info(
        self,
        ...
        _param = self._api21_admins_api_tokens_delete_serialize(
            admin_ids = admin_ids,
    ...
    def _api21_admins_api_tokens_delete_serialize(
        self,
        admin_ids,
        admin_names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.1/admins/api-tokens',
    ...
    @validate_call
    def api21_admins_api_tokens_get_with_http_info(
        self,
        admin_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of admin IDs. If after filtering, there is not at least one admin resource that matches each of the elements, then an error is returned. This cannot be provided together with the `admin_names` query parameter.")] = None,
        admin_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of admin names. If there is not at least one admin resource that matches each of the elements, then an error is returned. This cannot be provided together with `admin_ids` query parameter.")] = None,
        ...
        _param = self._api21_admins_api_tokens_get_serialize(
            admin_ids = admin_ids,
            admin_names = admin_names,
    ...
    def _api21_admins_api_tokens_get_serialize(
        self,
        admin_ids,
        admin_names,
        continuation_token,
    ...
    @validate_call
    def api21_admins_api_tokens_post_with_http_info(
        self,
        admin_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of admin IDs. If after filtering, there is not at least one admin resource that matches each of the elements, then an error is returned. This cannot be provided together with the `admin_names` query parameter.")] = None,
        admin_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of admin names. If there is not at least one admin resource that matches each of the elements, then an error is returned. This cannot be provided together with `admin_ids` query parameter.")] = None,
        ...
        _param = self._api21_admins_api_tokens_post_serialize(
            admin_ids = admin_ids,
            admin_names = admin_names,
            timeout = timeout,
        )
    ...
    def _api21_admins_api_tokens_post_serialize(
        self,
        admin_ids,
        admin_names,
        timeout,
    ...
    @validate_call
    def api21_admins_cache_delete_with_http_info(
        self,
        ...
        _param = self._api21_admins_cache_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api21_admins_cache_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.1/admins/cache',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api21_admins_cache_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        _param = self._api21_admins_cache_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api21_admins_cache_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    @validate_call
    def api21_admins_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        expose_api_token: Annotated[Optional[StrictBool], Field(description="If `true`, exposes the API token of the current user.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ...
        _param = self._api21_admins_get_serialize(
            continuation_token = continuation_token,
            expose_api_token = expose_api_token,
            filter = filter,
            ids = ids,
    ...
    def _api21_admins_get_serialize(
        self,
        continuation_token,
        expose_api_token,
        filter,
    ...
    @validate_call
    def api21_admins_patch_with_http_info(
        self,
        admin: AdminPatch,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        ...
        _param = self._api21_admins_patch_serialize(
            admin = admin,
            ids = ids,
            names = names,
        )
    ...
    def _api21_admins_patch_serialize(
        self,
        admin,
        ids,
        names,
