...
from pypureclient.flashblade.FB_2_1.models.keytab_get_response import KeytabGetResponse
from pypureclient.flashblade.FB_2_1.models.keytab_post import KeytabPost
from pypureclient.flashblade.FB_2_1.models.keytab_response import KeytabResponse
...
class KeytabsApi:
    ...
    def api21_keytabs_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api21_keytabs_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api21_keytabs_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api21_keytabs_download_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api21_keytabs_download_get_with_http_info(keytab_ids, keytab_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_keytabs_download_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api21_keytabs_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api21_keytabs_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_keytabs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api21_keytabs_post_with_http_info(
        self,
        keytab: KeytabPost,
        ...
        **kwargs
        ...
        >>> thread = api.api21_keytabs_post_with_http_info(keytab, name_prefixes, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_keytabs_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api21_keytabs_upload_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api21_keytabs_upload_post_with_http_info(keytab_file, name_prefixes, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_keytabs_upload_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
