...
class SupportApi(object):
    ...
    def api21_support_get_with_http_info(
        ...
        >>> thread = api.api21_support_get_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api21_support_patch_with_http_info(
        ...
        if support is None:
            raise TypeError("Missing the required parameter `support` when calling `api21_support_patch`")
    ...
    def api21_support_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_support_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
