...
class ActiveDirectoryApi:
    ...
    def api21_active_directory_delete_with_http_info(
        ...
        _param = self._api21_active_directory_delete_serialize(
            ids = ids,
    ...
    def _api21_active_directory_delete_serialize(
        self,
        ids,
        local_only,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.1/active-directory',
    ...
    def api21_active_directory_get_with_http_info(
        ...
        _param = self._api21_active_directory_get_serialize(
    ...
    def _api21_active_directory_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api21_active_directory_patch_with_http_info(
        ...
        _param = self._api21_active_directory_patch_serialize(
    ...
    def _api21_active_directory_patch_serialize(
        self,
        active_directory,
        ids,
        names,
    ...
    def api21_active_directory_post_with_http_info(
        ...
        _param = self._api21_active_directory_post_serialize(
            active_directory = active_directory,
            names = names,
    ...
    def _api21_active_directory_post_serialize(
        self,
        active_directory,
        names,
    ...
    def api21_active_directory_test_get_with_http_info(
        ...
        _param = self._api21_active_directory_test_get_serialize(
            filter = filter,
            ids = ids,
            limit = limit,
            names = names,
    ...
    def _api21_active_directory_test_get_serialize(
        self,
        filter,
        ids,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.1/active-directory/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
