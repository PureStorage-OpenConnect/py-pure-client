...
class RDLApi(object):
    ...
    def api21_rapid_data_locking_get_with_http_info(
        ...
        return self.api_client.call_api(
            '/api/2.1/rapid-data-locking', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api21_rapid_data_locking_patch_with_http_info(
        ...
        if rapid_data_locking is None:
            raise TypeError("Missing the required parameter `rapid_data_locking` when calling `api21_rapid_data_locking_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.1/rapid-data-locking', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api21_rapid_data_locking_rotate_post_with_http_info(
        ...
        return self.api_client.call_api(
            '/api/2.1/rapid-data-locking/rotate', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api21_rapid_data_locking_test_get_with_http_info(
        ...
        return self.api_client.call_api(
            '/api/2.1/rapid-data-locking/test', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
