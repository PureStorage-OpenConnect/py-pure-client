...
from pypureclient.flashblade.FB_2_1.models.alert_watcher_get_response import AlertWatcherGetResponse
from pypureclient.flashblade.FB_2_1.models.alert_watcher_post import AlertWatcherPost
from pypureclient.flashblade.FB_2_1.models.alert_watcher_response import AlertWatcherResponse
...
class AlertWatchersApi:
    ...
    def api21_alert_watchers_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api21_alert_watchers_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api21_alert_watchers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api21_alert_watchers_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api21_alert_watchers_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_alert_watchers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api21_alert_watchers_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api21_alert_watchers_patch_with_http_info(alert_watcher, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_alert_watchers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api21_alert_watchers_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api21_alert_watchers_post_with_http_info(names, alert_watcher, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_alert_watchers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api21_alert_watchers_test_get_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api21_alert_watchers_test_get_with_http_info(filter, ids, names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_alert_watchers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.1/alert-watchers/test', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
