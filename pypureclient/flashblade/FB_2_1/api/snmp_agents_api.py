...
from pypureclient.flashblade.FB_2_1.models.snmp_agent_get_response import SnmpAgentGetResponse
from pypureclient.flashblade.FB_2_1.models.snmp_agent_mib_response import SnmpAgentMibResponse
from pypureclient.flashblade.FB_2_1.models.snmp_agent_response import SnmpAgentResponse
...
class SNMPAgentsApi:
    ...
    def api21_snmp_agents_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api21_snmp_agents_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api21_snmp_agents_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api21_snmp_agents_mib_get_with_http_info(
        self,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.api21_snmp_agents_mib_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_snmp_agents_mib_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api21_snmp_agents_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api21_snmp_agents_patch_with_http_info(snmp_agent, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api21_snmp_agents_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
