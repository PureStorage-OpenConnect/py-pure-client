...
class HardwareApi:
    ...
    def api21_hardware_get_with_http_info(
        ...
        _param = self._api21_hardware_get_serialize(
            ids = ids,
            names = names,
    ...
    def _api21_hardware_get_serialize(
        self,
        ids,
        names,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.1/hardware',
    ...
    def api21_hardware_patch_with_http_info(
        ...
        _param = self._api21_hardware_patch_serialize(
            hardware = hardware,
            ids = ids,
            names = names,
        )
    ...
    def _api21_hardware_patch_serialize(
        self,
        hardware,
        ids,
        names,
