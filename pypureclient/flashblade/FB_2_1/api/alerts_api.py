...
class AlertsApi:
    ...
    def api21_alerts_get_with_http_info(
        ...
        _param = self._api21_alerts_get_serialize(
    ...
    def _api21_alerts_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api21_alerts_patch_with_http_info(
        ...
        _param = self._api21_alerts_patch_serialize(
    ...
    def _api21_alerts_patch_serialize(
        self,
        alerts_settings,
        ids,
        names,
