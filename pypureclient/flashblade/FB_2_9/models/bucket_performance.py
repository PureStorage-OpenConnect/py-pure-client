...
class BucketPerformance(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BucketPerformance:
        """Create an instance of BucketPerformance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> BucketPerformance:
        """Create an instance of BucketPerformance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BucketPerformance.parse_obj(obj)

        _obj = BucketPerformance.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
