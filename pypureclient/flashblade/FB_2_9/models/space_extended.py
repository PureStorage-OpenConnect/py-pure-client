...
class SpaceExtended(BaseModel):
    ...
    __properties = ["data_reduction", "snapshots", "total_physical", "total_provisioned", "unique", "virtual"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpaceExtended:
        """Create an instance of SpaceExtended from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SpaceExtended:
        """Create an instance of SpaceExtended from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpaceExtended.parse_obj(obj)

        _obj = SpaceExtended.construct(_fields_set=None, **{
