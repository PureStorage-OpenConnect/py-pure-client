...
class SnmpV2c(BaseModel):
    ...
    """ # noqa: E501
    community: Optional[Annotated[str, Field(strict=True, max_length=32)]] = Field(default=None, description="Manager community ID under which Purity is to communicate with the specified managers.")
