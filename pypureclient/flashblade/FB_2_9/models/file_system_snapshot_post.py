...
class FileSystemSnapshotPost(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemSnapshotPost:
        """Create an instance of FileSystemSnapshotPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemSnapshotPost:
        """Create an instance of FileSystemSnapshotPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemSnapshotPost.parse_obj(obj)

        _obj = FileSystemSnapshotPost.construct(_fields_set=None, **{
