...
class SnmpAgent(BaseModel):
    ...
    engine_id: Optional[Annotated[str, Field(strict=True, max_length=32)]] = Field(default=None, description="An SNMP agent's adminstration domain unique name.")
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "engine_id", "version", "v2c", "v3"]
