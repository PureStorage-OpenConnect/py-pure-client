...
class ReplicaLinkBuiltIn(BaseModel):
    """
    ReplicaLinkBuiltIn
    """
    ...
    __properties = ["id", "direction", "lag", "status_details"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReplicaLinkBuiltIn:
        """Create an instance of ReplicaLinkBuiltIn from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ReplicaLinkBuiltIn:
        """Create an instance of ReplicaLinkBuiltIn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReplicaLinkBuiltIn.parse_obj(obj)

        _obj = ReplicaLinkBuiltIn.construct(_fields_set=None, **{
            "id": obj.get("id"),
