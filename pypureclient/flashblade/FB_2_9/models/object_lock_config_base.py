...
class ObjectLockConfigBase(BaseModel):
    ...
    __properties = ["default_retention_mode", "enabled", "freeze_locked_objects"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectLockConfigBase:
        """Create an instance of ObjectLockConfigBase from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectLockConfigBase:
        """Create an instance of ObjectLockConfigBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectLockConfigBase.parse_obj(obj)

        _obj = ObjectLockConfigBase.construct(_fields_set=None, **{
