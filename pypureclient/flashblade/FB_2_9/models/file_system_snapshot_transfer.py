...
from pypureclient.flashblade.FB_2_9.models.fixed_reference_no_resource_type import FixedReferenceNoResourceType
...
class FileSystemSnapshotTransfer(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "completed", "data_transferred", "direction", "progress", "remote", "remote_snapshot", "started", "status"]
