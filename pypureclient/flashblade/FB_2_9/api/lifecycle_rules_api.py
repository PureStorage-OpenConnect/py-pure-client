...
class LifecycleRulesApi(object):
    ...
    def api29_lifecycle_rules_delete_with_http_info(
        ...
        >>> thread = api.api29_lifecycle_rules_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api29_lifecycle_rules_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api29_lifecycle_rules_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api29_lifecycle_rules_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api29_lifecycle_rules_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api29_lifecycle_rules_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api29_lifecycle_rules_patch_with_http_info(lifecycle, async_req=True)
        >>> result = thread.get()
        ...
        if lifecycle is None:
            raise TypeError("Missing the required parameter `lifecycle` when calling `api29_lifecycle_rules_patch`")
    ...
    def api29_lifecycle_rules_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api29_lifecycle_rules_post_with_http_info(rule, async_req=True)
        >>> result = thread.get()
        ...
        if rule is None:
            raise TypeError("Missing the required parameter `rule` when calling `api29_lifecycle_rules_post`")
