...
class ObjectStoreVirtualHostsApi:
    ...
    def api29_object_store_virtual_hosts_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_object_store_virtual_hosts_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api29_object_store_virtual_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_object_store_virtual_hosts_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_object_store_virtual_hosts_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_object_store_virtual_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_object_store_virtual_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
