...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_9.models.blade_get_response import BladeGetResponse
...
class BladesApi:
    ...
    @validate_call
    def api29_blades_get_with_http_info(
        self,
        ...
        _param = self._api29_blades_get_serialize(
    ...
    def _api29_blades_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
