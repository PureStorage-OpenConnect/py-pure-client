...
class ObjectStoreAccountsApi:
    ...
    def api29_object_store_accounts_delete_with_http_info(
        ...
        _param = self._api29_object_store_accounts_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api29_object_store_accounts_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.9/object-store-accounts',
    ...
    def api29_object_store_accounts_get_with_http_info(
        ...
        _param = self._api29_object_store_accounts_get_serialize(
    ...
    def _api29_object_store_accounts_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api29_object_store_accounts_patch_with_http_info(
        ...
        _param = self._api29_object_store_accounts_patch_serialize(
    ...
    def _api29_object_store_accounts_patch_serialize(
        self,
    ...
    def api29_object_store_accounts_post_with_http_info(
        ...
        _param = self._api29_object_store_accounts_post_serialize(
            names = names,
            object_store_account = object_store_account,
        )
    ...
    def _api29_object_store_accounts_post_serialize(
        self,
        names,
        object_store_account,
    ) -> RequestSerialized:
