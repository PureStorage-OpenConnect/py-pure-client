...
from pypureclient.flashblade.FB_2_9.models.dns_get_response import DnsGetResponse
from pypureclient.flashblade.FB_2_9.models.dns_response import DnsResponse
...
class DNSApi:
    ...
    def api29_dns_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_dns_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api29_dns_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_dns_patch_with_http_info(dns, ids, names, async_req=True)
        >>> result = thread.get()
