...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_9.models.subnet import Subnet
from pypureclient.flashblade.FB_2_9.models.subnet_get_response import SubnetGetResponse
from pypureclient.flashblade.FB_2_9.models.subnet_response import SubnetResponse
...
class SubnetsApi:
    ...
    def api29_subnets_delete_with_http_info(
        ...
        _param = self._api29_subnets_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api29_subnets_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
    ...
    def api29_subnets_get_with_http_info(
        ...
        _param = self._api29_subnets_get_serialize(
    ...
    def _api29_subnets_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api29_subnets_patch_with_http_info(
        ...
        _param = self._api29_subnets_patch_serialize(
            subnet = subnet,
            ids = ids,
            names = names,
        )
    ...
    def _api29_subnets_patch_serialize(
        self,
        subnet,
        ids,
        names,
    ...
    def api29_subnets_post_with_http_info(
        ...
        _param = self._api29_subnets_post_serialize(
            names = names,
            subnet = subnet,
        )
    ...
    def _api29_subnets_post_serialize(
        self,
        names,
        subnet,
    ) -> RequestSerialized:
