...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_9.models.certificate_certificate_group_get_resp import CertificateCertificateGroupGetResp
from pypureclient.flashblade.FB_2_9.models.certificate_certificate_group_response import CertificateCertificateGroupResponse
from pypureclient.flashblade.FB_2_9.models.certificate_get_response import CertificateGetResponse
from pypureclient.flashblade.FB_2_9.models.certificate_patch import CertificatePatch
from pypureclient.flashblade.FB_2_9.models.certificate_post import CertificatePost
from pypureclient.flashblade.FB_2_9.models.certificate_response import CertificateResponse
from pypureclient.flashblade.FB_2_9.models.certificate_use_get_response import CertificateUseGetResponse
from pypureclient.flashblade.FB_2_9.api_client import ApiClient as _TransportApiClient, RequestSerialized
from pypureclient.flashblade.FB_2_9.api_response import ApiResponse
from pypureclient.flashblade.FB_2_9.rest import RESTResponseType
...
class CertificatesApi:
    ...
    @validate_call
    def api29_certificates_certificate_groups_delete_with_http_info(
        self,
        ...
        _param = self._api29_certificates_certificate_groups_delete_serialize(
    ...
    def _api29_certificates_certificate_groups_delete_serialize(
        self,
        certificate_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.9/certificates/certificate-groups',
    ...
    @validate_call
    def api29_certificates_certificate_groups_get_with_http_info(
        self,
        ...
        _param = self._api29_certificates_certificate_groups_get_serialize(
    ...
    def _api29_certificates_certificate_groups_get_serialize(
        self,
        continuation_token,
        certificate_ids,
        certificate_group_ids,
    ...
    @validate_call
    def api29_certificates_certificate_groups_post_with_http_info(
        self,
        certificate_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of certificate ids. If there is not at least one resource that matches each of the elements of `certificate_ids`, then an error is returned. This cannot be provided in conjunction with the `certificate_names` parameter.")] = None,
        certificate_group_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of certificate group ids. If there is not at least one resource that matches each of the elements of `certificate_group_ids`, then an error is returned. This cannot be provided in conjunction with the `certificate_group_names` parameter.")] = None,
        certificate_group_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of certificate group names. If there is not at least one resource that matches each of the elements of `certificate_group_names`, then an error is returned. This cannot be provided in conjunction with the `certificate_group_ids` parameter.")] = None,
        ...
        _param = self._api29_certificates_certificate_groups_post_serialize(
            certificate_ids = certificate_ids,
            certificate_group_ids = certificate_group_ids,
            certificate_group_names = certificate_group_names,
            certificate_names = certificate_names,
    ...
    def _api29_certificates_certificate_groups_post_serialize(
        self,
        certificate_ids,
        certificate_group_ids,
        certificate_group_names,
    ...
    def api29_certificates_delete_with_http_info(
        ...
        _param = self._api29_certificates_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api29_certificates_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.9/certificates',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api29_certificates_get_with_http_info(
        ...
        _param = self._api29_certificates_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api29_certificates_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api29_certificates_patch_with_http_info(
        ...
        _param = self._api29_certificates_patch_serialize(
    ...
    def _api29_certificates_patch_serialize(
        self,
        certificate,
        ids,
        names,
    ...
    def api29_certificates_post_with_http_info(
        ...
        _param = self._api29_certificates_post_serialize(
            certificate = certificate,
            names = names,
        )
    ...
    def _api29_certificates_post_serialize(
        self,
        certificate,
        names,
    ) -> RequestSerialized:
    ...
    @validate_call
    def api29_certificates_uses_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        _param = self._api29_certificates_uses_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api29_certificates_uses_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.9/certificates/uses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
