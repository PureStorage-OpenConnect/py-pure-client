...
class LinkAggregationGroupsApi(object):
    ...
    def api29_link_aggregation_groups_delete_with_http_info(
        ...
        >>> thread = api.api29_link_aggregation_groups_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api29_link_aggregation_groups_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api29_link_aggregation_groups_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api29_link_aggregation_groups_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api29_link_aggregation_groups_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api29_link_aggregation_groups_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api29_link_aggregation_groups_patch_with_http_info(link_aggregation_group, async_req=True)
        >>> result = thread.get()
        ...
        if link_aggregation_group is None:
            raise TypeError("Missing the required parameter `link_aggregation_group` when calling `api29_link_aggregation_groups_patch`")
    ...
    def api29_link_aggregation_groups_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api29_link_aggregation_groups_post_with_http_info(link_aggregation_group, names, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'link_aggregation_group' is set
        if link_aggregation_group is None:
            raise TypeError("Missing the required parameter `link_aggregation_group` when calling `api29_link_aggregation_groups_post`")
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api29_link_aggregation_groups_post`")
