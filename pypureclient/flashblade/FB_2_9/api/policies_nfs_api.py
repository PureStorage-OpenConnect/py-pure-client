...
class PoliciesNFSApi:
    ...
    def api29_nfs_export_policies_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_nfs_export_policies_delete_with_http_info(ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api29_nfs_export_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_nfs_export_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_nfs_export_policies_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_nfs_export_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_nfs_export_policies_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_nfs_export_policies_patch_with_http_info(policy, ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_nfs_export_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_nfs_export_policies_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_nfs_export_policies_post_with_http_info(names, policy, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_nfs_export_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_nfs_export_policies_rules_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_nfs_export_policies_rules_delete_with_http_info(ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_nfs_export_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_nfs_export_policies_rules_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_nfs_export_policies_rules_get_with_http_info(continuation_token, filter, ids, limit, names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_nfs_export_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_nfs_export_policies_rules_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_nfs_export_policies_rules_patch_with_http_info(rule, before_rule_id, before_rule_name, ids, names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_nfs_export_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_nfs_export_policies_rules_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_nfs_export_policies_rules_post_with_http_info(rule, before_rule_id, before_rule_name, policy_ids, policy_names, versions, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_nfs_export_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
