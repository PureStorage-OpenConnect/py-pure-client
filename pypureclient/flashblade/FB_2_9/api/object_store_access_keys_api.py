...
from pypureclient.flashblade.FB_2_9.models.object_store_access_key_get_response import ObjectStoreAccessKeyGetResponse
from pypureclient.flashblade.FB_2_9.models.object_store_access_key_post import ObjectStoreAccessKeyPost
from pypureclient.flashblade.FB_2_9.models.object_store_access_key_response import ObjectStoreAccessKeyResponse
...
class ObjectStoreAccessKeysApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api29_object_store_access_keys_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_object_store_access_keys_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_object_store_access_keys_get_with_http_info(continuation_token, filter, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_object_store_access_keys_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_object_store_access_keys_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_object_store_access_keys_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_object_store_access_keys_post_with_http_info(object_store_access_key, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_object_store_access_keys_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
