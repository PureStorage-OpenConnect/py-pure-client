...
class FileSystemReplicaLinksApi:
    ...
    def api29_file_system_replica_links_get_with_http_info(
        ...
        _param = self._api29_file_system_replica_links_get_serialize(
    ...
    def _api29_file_system_replica_links_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.9/file-system-replica-links',
    ...
    def api29_file_system_replica_links_policies_delete_with_http_info(
        ...
        _param = self._api29_file_system_replica_links_policies_delete_serialize(
            local_file_system_ids = local_file_system_ids,
            local_file_system_names = local_file_system_names,
    ...
    def _api29_file_system_replica_links_policies_delete_serialize(
        self,
        local_file_system_ids,
        local_file_system_names,
        member_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.9/file-system-replica-links/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api29_file_system_replica_links_policies_get_with_http_info(
        ...
        _param = self._api29_file_system_replica_links_policies_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
            local_file_system_ids = local_file_system_ids,
    ...
    def _api29_file_system_replica_links_policies_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
    ...
    def api29_file_system_replica_links_policies_post_with_http_info(
        ...
        _param = self._api29_file_system_replica_links_policies_post_serialize(
            local_file_system_ids = local_file_system_ids,
            local_file_system_names = local_file_system_names,
            member_ids = member_ids,
            policy_ids = policy_ids,
    ...
    def _api29_file_system_replica_links_policies_post_serialize(
        self,
        local_file_system_ids,
        local_file_system_names,
        member_ids,
    ...
    def api29_file_system_replica_links_post_with_http_info(
        ...
        _param = self._api29_file_system_replica_links_post_serialize(
    ...
    def _api29_file_system_replica_links_post_serialize(
        self,
    ...
    def api29_file_system_replica_links_transfer_get_with_http_info(
        ...
        _param = self._api29_file_system_replica_links_transfer_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api29_file_system_replica_links_transfer_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.9/file-system-replica-links/transfer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
