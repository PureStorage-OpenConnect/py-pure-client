...
class DirectoryServicesApi:
    ...
    def api29_directory_services_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_directory_services_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api29_directory_services_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_directory_services_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_directory_services_patch_with_http_info(directory_service, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_directory_services_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_directory_services_roles_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_directory_services_roles_get_with_http_info(continuation_token, filter, ids, limit, offset, role_ids, role_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_directory_services_roles_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_directory_services_roles_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_directory_services_roles_patch_with_http_info(directory_service_roles, ids, role_ids, role_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_directory_services_roles_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_directory_services_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_directory_services_test_get_with_http_info(filter, ids, limit, names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_directory_services_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api29_directory_services_test_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api29_directory_services_test_patch_with_http_info(filter, ids, names, sort, directory_service, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api29_directory_services_test_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.9/directory-services/test', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
