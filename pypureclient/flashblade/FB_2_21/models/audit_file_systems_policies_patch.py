...
from pypureclient.flashblade.FB_2_21.models.audit_file_systems_policy_rule_in_policy import AuditFileSystemsPolicyRuleInPolicy
...
class AuditFileSystemsPoliciesPatch(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "log_targets", "rules", "add_log_targets", "remove_log_targets"]
