...
from pypureclient.flashblade.FB_2_21.models.smb_share_policy_rule_with_context import SmbSharePolicyRuleWithContext


class SmbSharePolicyRuleGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SmbSharePolicyRuleWithContext)] = Field(default=None, description="A list of SMB Share policy rule objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmbSharePolicyRuleGetResponse:
        """Create an instance of SmbSharePolicyRuleGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmbSharePolicyRuleGetResponse:
        """Create an instance of SmbSharePolicyRuleGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmbSharePolicyRuleGetResponse.parse_obj(obj)

        _obj = SmbSharePolicyRuleGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [SmbSharePolicyRuleWithContext.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
