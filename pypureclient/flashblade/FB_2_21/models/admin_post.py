...
class AdminPost(BaseModel):
    ...
    """
    management_access_policies: Optional[conlist(ReferenceWritable)] = Field(default=None, description="List of management access policies associated with the administrator.")
    ...
    __properties = ["management_access_policies", "password", "public_key", "role"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdminPost:
        """Create an instance of AdminPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AdminPost:
        """Create an instance of AdminPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdminPost.parse_obj(obj)

        _obj = AdminPost.construct(_fields_set=None, **{
