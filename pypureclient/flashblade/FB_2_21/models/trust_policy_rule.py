...
from pypureclient.flashblade.FB_2_21.models.trust_policy_rule_condition import TrustPolicyRuleCondition
...
class TrustPolicyRule(BaseModel):
    ...
    __properties = ["name", "index", "actions", "conditions", "effect", "policy", "principals"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrustPolicyRule:
        """Create an instance of TrustPolicyRule from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TrustPolicyRule:
        """Create an instance of TrustPolicyRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrustPolicyRule.parse_obj(obj)

        _obj = TrustPolicyRule.construct(_fields_set=None, **{
            "name": obj.get("name"),
            "index": obj.get("index"),
