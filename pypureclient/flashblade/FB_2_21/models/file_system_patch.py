...
from pypureclient.flashblade.FB_2_21.models.fixed_location_reference import FixedLocationReference
from pypureclient.flashblade.FB_2_21.models.http import Http
from pypureclient.flashblade.FB_2_21.models.multi_protocol import MultiProtocol
from pypureclient.flashblade.FB_2_21.models.nfs_patch import NfsPatch
from pypureclient.flashblade.FB_2_21.models.reference import Reference
from pypureclient.flashblade.FB_2_21.models.smb import Smb
...
class FileSystemPatch(BaseModel):
    ...
    __properties = ["id", "name", "created", "default_group_quota", "default_user_quota", "destroyed", "fast_remove_directory_enabled", "group_ownership", "hard_limit_enabled", "http", "multi_protocol", "nfs", "promotion_status", "provisioned", "qos_policy", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "storage_class", "time_remaining", "writable"]
