...
class RealmDefaultsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(RealmDefaults)] = Field(default=None, description="A list of realm default configurations.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RealmDefaultsGetResponse:
        """Create an instance of RealmDefaultsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RealmDefaultsGetResponse:
        """Create an instance of RealmDefaultsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RealmDefaultsGetResponse.parse_obj(obj)

        _obj = RealmDefaultsGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [RealmDefaults.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
