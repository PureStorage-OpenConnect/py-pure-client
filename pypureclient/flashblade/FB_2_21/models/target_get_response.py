...
from pypureclient.flashblade.FB_2_21.models.target_with_context import TargetWithContext
...
class TargetGetResponse(BaseModel):
    ...
    items: Optional[conlist(TargetWithContext)] = Field(default=None, description="A list of target objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TargetGetResponse:
        """Create an instance of TargetGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TargetGetResponse:
        """Create an instance of TargetGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TargetGetResponse.parse_obj(obj)

        _obj = TargetGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [TargetWithContext.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
