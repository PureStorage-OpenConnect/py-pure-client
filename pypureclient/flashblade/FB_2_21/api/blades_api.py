...
from pypureclient.flashblade.FB_2_21.models.blade_get_response import BladeGetResponse
from typing import Optional
...
class BladesApi:
    ...
    def api221_blades_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api221_blades_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
