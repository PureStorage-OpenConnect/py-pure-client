...
from pypureclient.flashblade.FB_2_16.models.fixed_location_reference import FixedLocationReference
...
class FileSystemSnapshot(BaseModel):
    ...
    policies: Optional[List[FixedLocationReference]] = Field(default=None, description="An array of references to the associated policies.")
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "created", "destroyed", "owner", "owner_destroyed", "policy", "policies", "source", "suffix", "time_remaining"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "policies": [FixedLocationReference.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None,
