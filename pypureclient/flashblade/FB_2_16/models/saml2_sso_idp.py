...
class Saml2SsoIdp(BaseModel):
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.verification_certificate and (include_readonly or "verification_certificate" not in excluded_fields):
            _dict['verification_certificate'] = self.verification_certificate.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "verification_certificate": ReferenceWritable.from_dict(obj["verification_certificate"]) if obj.get("verification_certificate") is not None else None
        })
        return _obj
