...
from pypureclient.flashblade.FB_2_16.models.bucket_defaults_readonly import BucketDefaultsReadonly
from pypureclient.flashblade.FB_2_16.models.public_access_config import PublicAccessConfig
from pypureclient.flashblade.FB_2_16.models.space import Space
...
class ObjectStoreAccount(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "created", "object_count", "space", "bucket_defaults", "hard_limit_enabled", "quota_limit", "public_access_config"]
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded, if `include_readonly` is `False`.
        ...
        if self.public_access_config and (include_readonly or "public_access_config" not in excluded_fields):
            _dict['public_access_config'] = self.public_access_config.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "bucket_defaults": BucketDefaultsReadonly.from_dict(obj["bucket_defaults"]) if obj.get("bucket_defaults") is not None else None,
            "hard_limit_enabled": obj.get("hard_limit_enabled"),
            "quota_limit": obj.get("quota_limit"),
            "public_access_config": PublicAccessConfig.from_dict(obj["public_access_config"]) if obj.get("public_access_config") is not None else None
        })
        return _obj
