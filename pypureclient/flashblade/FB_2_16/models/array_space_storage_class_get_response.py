...
from pypureclient.flashblade.FB_2_16.models.storage_class_space import StorageClassSpace
...
class ArraySpaceStorageClassGetResponse(BaseModel):
    ...
    items: Optional[List[StorageClassSpace]] = Field(default=None, description="A list of array space metrics objects for each storage class.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [StorageClassSpace.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": StorageClassSpace.from_dict(obj["total"]) if obj.get("total") is not None else None
        })
        return _obj
