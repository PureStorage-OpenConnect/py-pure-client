...
class AuditFileSystemsPoliciesMembersGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        Keyword args:
            ...
            items (list[PolicyMember]): A list of members for audit policies.
        """
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `AuditFileSystemsPoliciesMembersGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(AuditFileSystemsPoliciesMembersGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuditFileSystemsPoliciesMembersGetResponse):
            return False
