...
from pypureclient.flashblade.FB_2_16.models.policy_member import PolicyMember
...
class AuditFileSystemsPoliciesMembersGetResponse(BaseModel):
    ...
    items: Optional[conlist(PolicyMember)] = Field(default=None, description="A list of members for audit policies.")
