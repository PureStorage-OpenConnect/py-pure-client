...
class Space(BaseModel):
    ...
    total_physical: Optional[conint(strict=True, ge=0)] = Field(default=None, description="Deprecated. See total_used for the newer functionality. The total physical space consumed by the file system, measured in bytes.")
    ...
    total_used: Optional[conint(strict=True, ge=0)] = Field(default=None, description="The total space consumed by customer data, measured in bytes.")
    ...
    __properties = ["available_provisioned", "available_ratio", "data_reduction", "destroyed", "destroyed_virtual", "shared", "snapshots", "total_physical", "total_provisioned", "total_used", "unique", "virtual"]
