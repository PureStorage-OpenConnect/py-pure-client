...
class Space(BaseModel):
    ...
    total_physical: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Deprecated. See total_used for the newer functionality. The total physical space consumed by the file system, measured in bytes.")
    ...
    shared: Optional[StrictInt] = Field(default=None, description="The space contributed by data that is not unique to a managed directory, or snapshot, measured in bytes.")
    total_used: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The total space consumed by customer data, measured in bytes.")
    __properties: ClassVar[List[str]] = ["data_reduction", "snapshots", "total_physical", "unique", "virtual", "total_provisioned", "available_provisioned", "available_ratio", "destroyed", "destroyed_virtual", "shared", "total_used"]
