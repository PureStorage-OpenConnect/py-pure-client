...
class BladeGetResponse(BaseModel):
    ...
    items: Optional[List[Blade]] = Field(default=None, description="A list of blade objects.")
    __properties: ClassVar[List[str]] = ["continuation_token", "total_item_count", "total", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "total": obj.get("total"),
            "items": [Blade.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
