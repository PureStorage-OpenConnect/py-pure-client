...
from pypureclient.flashblade.FB_2_16.models.bucket_access_policy_rule import BucketAccessPolicyRule
...
class BucketAccessPolicyRuleGetResponse(BaseModel):
    ...
    items: Optional[conlist(BucketAccessPolicyRule)] = None
    ...
    def from_dict(cls, obj: dict) -> BucketAccessPolicyRuleGetResponse:
        ...
        _obj = BucketAccessPolicyRuleGetResponse.construct(_fields_set=None, **{
            ...
            "items": [BucketAccessPolicyRule.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
