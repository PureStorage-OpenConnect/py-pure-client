...
class BucketReplicaLinkGetResponse(BaseModel):
    ...
    items: Optional[List[BucketReplicaLink]] = Field(default=None, description="A list of object store bucket replica link objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "total": BucketReplicaLink.from_dict(obj["total"]) if obj.get("total") is not None else None
        })
        return _obj
