...
class NetworkInterface(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "address", "enabled", "gateway", "mtu", "netmask", "services", "subnet", "type", "vlan", "server"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "type": obj.get("type"),
            "vlan": obj.get("vlan"),
            "server": Reference.from_dict(obj["server"]) if obj.get("server") is not None else None
        })
        return _obj
