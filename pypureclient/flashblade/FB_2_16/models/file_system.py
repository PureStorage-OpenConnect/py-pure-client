...
from pypureclient.flashblade.FB_2_16.models.multi_protocol import MultiProtocol
from pypureclient.flashblade.FB_2_16.models.nfs import Nfs
from pypureclient.flashblade.FB_2_16.models.smb import Smb
from pypureclient.flashblade.FB_2_16.models.space import Space
from pypureclient.flashblade.FB_2_16.models.storage_class_info import StorageClassInfo
...
class FileSystem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "created", "default_group_quota", "default_user_quota", "destroyed", "fast_remove_directory_enabled", "hard_limit_enabled", "http", "multi_protocol", "nfs", "provisioned", "promotion_status", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "space", "time_remaining", "writable", "group_ownership", "eradication_config", "storage_class"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "storage_class": StorageClassInfo.from_dict(obj["storage_class"]) if obj.get("storage_class") is not None else None
        })
        return _obj
