...
class TargetPost(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TargetPost:
        """Create an instance of TargetPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TargetPost:
        """Create an instance of TargetPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TargetPost.parse_obj(obj)

        _obj = TargetPost.construct(_fields_set=None, **{
