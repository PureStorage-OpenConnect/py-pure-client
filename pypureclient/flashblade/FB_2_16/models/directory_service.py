...
from pypureclient.flashblade.FB_2_16.models.directory_service_management import DirectoryServiceManagement
from pypureclient.flashblade.FB_2_16.models.directory_service_nfs import DirectoryServiceNfs
from pypureclient.flashblade.FB_2_16.models.directory_service_smb import DirectoryServiceSmb
...
class DirectoryService(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "base_dn", "bind_password", "bind_user", "ca_certificate", "ca_certificate_group", "enabled", "management", "nfs", "services", "uris", "smb"]
