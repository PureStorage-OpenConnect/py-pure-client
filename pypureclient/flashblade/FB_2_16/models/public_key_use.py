...
class PublicKeyUse(object):
    ...
    def __init__(
        ...
        name=None,  # type: str
        id=None,  # type: str
        use=None,  # type: models.FixedReference
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `PublicKeyUse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(PublicKeyUse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PublicKeyUse):
            return False
