...
class SmbSharePolicy(BaseModel):
    ...
    rules: Optional[Annotated[List[SmbSharePolicyRule], Field(max_length=200)]] = Field(default=None, description="All of the rules that are part of this policy.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "rules": [SmbSharePolicyRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
