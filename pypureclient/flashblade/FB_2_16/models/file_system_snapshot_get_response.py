...
class FileSystemSnapshotGetResponse(BaseModel):
    ...
    items: Optional[List[FileSystemSnapshot]] = Field(default=None, description="A list of file system snapshot objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [FileSystemSnapshot.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": FileSystemSnapshot.from_dict(obj["total"]) if obj.get("total") is not None else None
        })
        return _obj
