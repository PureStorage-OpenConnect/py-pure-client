...
class ActiveDirectory(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "computer_name", "directory_servers", "domain", "encryption_types", "join_ou", "kerberos_servers", "service_principal_names", "global_catalog_servers", "server"]
