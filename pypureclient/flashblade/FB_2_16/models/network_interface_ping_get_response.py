...
class NetworkInterfacePingGetResponse(BaseModel):
    ...
    items: Optional[List[NetworkInterfacePing]] = Field(default=None, description="A list of network ping run result.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [NetworkInterfacePing.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
