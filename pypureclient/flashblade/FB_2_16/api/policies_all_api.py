...
class PoliciesAllApi:
    ...
    def api216_policies_all_get_with_http_info(
        ...
        _param = self._api216_policies_all_get_serialize(
    ...
    def _api216_policies_all_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/policies-all',
    ...
    def api216_policies_all_members_get_with_http_info(
        ...
        _param = self._api216_policies_all_members_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
    ...
    def _api216_policies_all_members_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/policies-all/members',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
