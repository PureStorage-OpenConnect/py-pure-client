...
from pypureclient.flashblade.FB_2_16.models.drive_get_response import DriveGetResponse
...
class DrivesApi:
    ...
    def api216_drives_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_drives_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, total_only, async_req=True)
        >>> result = thread.get()
