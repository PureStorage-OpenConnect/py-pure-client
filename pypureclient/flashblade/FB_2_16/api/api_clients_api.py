...
class APIClientsApi(object):
    ...
    def api216_api_clients_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_api_clients_post_with_http_info(api_client, async_req=True)
        >>> result = thread.get()
        ...
        if api_client is None:
            raise TypeError("Missing the required parameter `api_client` when calling `api216_api_clients_post`")
