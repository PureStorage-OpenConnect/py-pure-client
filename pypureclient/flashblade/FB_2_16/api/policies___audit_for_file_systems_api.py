...
class PoliciesAuditForFileSystemsApi(object):
    ...
    def api216_audit_file_systems_policies_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api216_audit_file_systems_policies_get`, must be a value greater than or equal to `1`")
    ...
    def api216_audit_file_systems_policies_members_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api216_audit_file_systems_policies_members_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
