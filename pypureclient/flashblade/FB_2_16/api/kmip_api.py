...
class KMIPApi(object):
    ...
    def api216_kmip_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api216_kmip_get`, must be a value greater than or equal to `1`")
    ...
    def api216_kmip_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_kmip_patch_with_http_info(kmip_server, async_req=True)
        >>> result = thread.get()
        ...
        if kmip_server is None:
            raise TypeError("Missing the required parameter `kmip_server` when calling `api216_kmip_patch`")
    ...
    def api216_kmip_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_kmip_post_with_http_info(kmip_server, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'kmip_server' is set
        if kmip_server is None:
            raise TypeError("Missing the required parameter `kmip_server` when calling `api216_kmip_post`")
    ...
    def api216_kmip_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_kmip_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
