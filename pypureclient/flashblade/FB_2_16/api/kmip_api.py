...
class KMIPApi:
    ...
    def api216_kmip_delete_with_http_info(
        ...
        _param = self._api216_kmip_delete_serialize(
    ...
    def _api216_kmip_delete_serialize(
        self,
        x_request_id,
        names,
        ids,
    ...
    def api216_kmip_get_with_http_info(
        ...
        _param = self._api216_kmip_get_serialize(
            x_request_id = x_request_id,
            names = names,
            ids = ids,
            filter = filter,
    ...
    def _api216_kmip_get_serialize(
        self,
        x_request_id,
        names,
        ids,
    ...
    def api216_kmip_patch_with_http_info(
        ...
        _param = self._api216_kmip_patch_serialize(
    ...
    def _api216_kmip_patch_serialize(
        self,
        kmip_server,
        x_request_id,
        names,
    ...
    def api216_kmip_post_with_http_info(
        ...
        _param = self._api216_kmip_post_serialize(
            kmip_server = kmip_server,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api216_kmip_post_serialize(
        self,
        kmip_server,
        x_request_id,
        names,
    ...
    def api216_kmip_test_get_with_http_info(
        ...
        _param = self._api216_kmip_test_get_serialize(
            x_request_id = x_request_id,
            names = names,
            ids = ids,
        )
    ...
    def _api216_kmip_test_get_serialize(
        self,
        x_request_id,
        names,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/kmip/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
