...
class NetworkInterfacesApi:
    ...
    def api216_network_interfaces_ping_get_with_http_info(
        ...
        _param = self._api216_network_interfaces_ping_get_serialize(
    ...
    def _api216_network_interfaces_ping_get_serialize(
        self,
        destination,
        x_request_id,
        packet_size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/network-interfaces/ping',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api216_network_interfaces_trace_get_with_http_info(
        ...
        _param = self._api216_network_interfaces_trace_get_serialize(
            destination = destination,
            x_request_id = x_request_id,
    ...
    def _api216_network_interfaces_trace_get_serialize(
        self,
        destination,
        x_request_id,
        fragment_packet,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/network-interfaces/trace',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
