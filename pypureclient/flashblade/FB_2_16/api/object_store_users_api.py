...
class ObjectStoreUsersApi(object):
    ...
    def api216_object_store_users_delete_with_http_info(
        ...
        >>> thread = api.api216_object_store_users_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api216_object_store_users_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_object_store_users_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api216_object_store_users_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api216_object_store_users_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api216_object_store_users_object_store_access_policies_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_object_store_users_object_store_access_policies_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api216_object_store_users_object_store_access_policies_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_object_store_users_object_store_access_policies_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api216_object_store_users_object_store_access_policies_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api216_object_store_users_object_store_access_policies_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api216_object_store_users_object_store_access_policies_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_object_store_users_object_store_access_policies_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api216_object_store_users_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_object_store_users_post_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api216_object_store_users_post`")
