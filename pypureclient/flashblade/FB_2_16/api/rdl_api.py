...
class RDLApi(object):
    ...
    def api216_rapid_data_locking_get_with_http_info(
        ...
        >>> thread = api.api216_rapid_data_locking_get_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api216_rapid_data_locking_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_rapid_data_locking_patch_with_http_info(rapid_data_locking, async_req=True)
        >>> result = thread.get()
        ...
        if rapid_data_locking is None:
            raise TypeError("Missing the required parameter `rapid_data_locking` when calling `api216_rapid_data_locking_patch`")
    ...
    def api216_rapid_data_locking_rotate_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_rapid_data_locking_rotate_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api216_rapid_data_locking_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_rapid_data_locking_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
