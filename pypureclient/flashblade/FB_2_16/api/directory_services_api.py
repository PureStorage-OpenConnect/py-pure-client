...
class DirectoryServicesApi:
    ...
    def api216_directory_services_get_with_http_info(
        ...
        _param = self._api216_directory_services_get_serialize(
    ...
    def _api216_directory_services_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/directory-services',
    ...
    def api216_directory_services_patch_with_http_info(
        ...
        _param = self._api216_directory_services_patch_serialize(
    ...
    def _api216_directory_services_patch_serialize(
        self,
        directory_service,
        x_request_id,
        ids,
    ...
    def api216_directory_services_roles_delete_with_http_info(
        ...
        _param = self._api216_directory_services_roles_delete_serialize(
            x_request_id = x_request_id,
            names = names,
            ids = ids,
        )
    ...
    def _api216_directory_services_roles_delete_serialize(
        self,
        x_request_id,
        names,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.16/directory-services/roles',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api216_directory_services_roles_get_with_http_info(
        ...
        limit: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Limit the size of the response to the specified number of resources. A `limit` of `0` can be used to get the number of resources without getting all of the resources. It will be returned in the `total_item_count` field. If a client asks for a page size larger than the available number, the request is still valid. In that case the server just returns the available number of items, disregarding the client's page size request.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The offset of the first resource to return from a collection.")] = None,
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `names`, then an error is returned. This cannot be provided together with the `ids`, `role_names`, or `role_ids` query parameters.")] = None,
        ...
        role_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of role_names. If there is not at least one resource that matches each of the elements of `role_names`, then an error is returned. This cannot be provided together with the `ids`, `names`, or `role_ids` query parameters. This query parameter is deprecated for use with directory service roles. If this parameter is used to query or modify directory service roles, but more than 1 configuration exists with a given role name, an error will be returned in order to avoid ambiguous operation.")] = None,
        sort: Annotated[Optional[List[Annotated[str, Field(strict=True)]]], Field(description="Sort the response by the specified fields (in descending order if '-' is appended to the field name). NOTE: If you provide a sort you will not get a `continuation_token` in the response.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[DirectoryServiceRolesGetResponse]:
        ...
        _param = self._api216_directory_services_roles_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
    ...
    def _api216_directory_services_roles_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api216_directory_services_roles_patch_with_http_info(
        ...
        role_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of role_names. If there is not at least one resource that matches each of the elements of `role_names`, then an error is returned. This cannot be provided together with the `ids`, `names`, or `role_ids` query parameters. This query parameter is deprecated for use with directory service roles. If this parameter is used to query or modify directory service roles, but more than 1 configuration exists with a given role name, an error will be returned in order to avoid ambiguous operation.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[DirectoryServiceRolesResponse]:
        ...
        _param = self._api216_directory_services_roles_patch_serialize(
    ...
    def _api216_directory_services_roles_patch_serialize(
        self,
    ...
    def api216_directory_services_roles_post_with_http_info(
        ...
        _param = self._api216_directory_services_roles_post_serialize(
            directory_service_roles = directory_service_roles,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api216_directory_services_roles_post_serialize(
        self,
        directory_service_roles,
        x_request_id,
        names,
    ...
    def api216_directory_services_test_get_with_http_info(
        ...
        _param = self._api216_directory_services_test_get_serialize(
            x_request_id = x_request_id,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api216_directory_services_test_get_serialize(
        self,
        x_request_id,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/directory-services/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api216_directory_services_test_patch_with_http_info(
        ...
        _param = self._api216_directory_services_test_patch_serialize(
            x_request_id = x_request_id,
            filter = filter,
            ids = ids,
            names = names,
    ...
    def _api216_directory_services_test_patch_serialize(
        self,
        x_request_id,
        filter,
        ids,
