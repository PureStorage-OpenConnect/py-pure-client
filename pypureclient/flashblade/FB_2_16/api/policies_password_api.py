...
class PoliciesPasswordApi:
    ...
    def api216_password_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_password_policies_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api216_password_policies_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_password_policies_patch_with_http_info(policy, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
