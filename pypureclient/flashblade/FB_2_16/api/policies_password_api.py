...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_16.models.password_policies_get_response import PasswordPoliciesGetResponse
from pypureclient.flashblade.FB_2_16.models.password_policies_response import PasswordPoliciesResponse
...
class PoliciesPasswordApi:
    ...
    def api216_password_policies_get_with_http_info(
    ...
    ) -> ApiResponse[PasswordPoliciesGetResponse]:
        ...
        _param = self._api216_password_policies_get_serialize(
    ...
    def _api216_password_policies_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/password-policies',
    ...
    def api216_password_policies_patch_with_http_info(
        ...
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[PasswordPoliciesResponse]:
        ...
        _param = self._api216_password_policies_patch_serialize(
            policy = policy,
            x_request_id = x_request_id,
            ids = ids,
            names = names,
    ...
    def _api216_password_policies_patch_serialize(
        self,
        policy,
        x_request_id,
        ids,
