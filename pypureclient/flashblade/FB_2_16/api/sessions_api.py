...
from pypureclient.flashblade.FB_2_16.models.session_get_response import SessionGetResponse
...
class SessionsApi:
    ...
    def api216_sessions_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_sessions_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
