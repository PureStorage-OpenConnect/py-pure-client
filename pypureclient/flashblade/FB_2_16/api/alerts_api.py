...
from pypureclient.flashblade.FB_2_16.models.alert import Alert
from pypureclient.flashblade.FB_2_16.models.alert_get_response import AlertGetResponse
from pypureclient.flashblade.FB_2_16.models.alert_response import AlertResponse
...
class AlertsApi:
    ...
    def api216_alerts_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_alerts_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api216_alerts_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_alerts_patch_with_http_info(alerts_settings, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
