...
from pypureclient.flashblade.FB_2_16.models.support_get_response import SupportGetResponse
from pypureclient.flashblade.FB_2_16.models.support_response import SupportResponse
...
class SupportApi:
    ...
    def api216_support_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_support_get_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api216_support_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_support_patch_with_http_info(support, x_request_id, async_req=True)
        >>> result = thread.get()
    ...
    def api216_support_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_support_test_get_with_http_info(x_request_id, filter, sort, test_type, async_req=True)
        >>> result = thread.get()
