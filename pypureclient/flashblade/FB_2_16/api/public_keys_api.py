...
from pypureclient.flashblade.FB_2_16.models.public_key_get_response import PublicKeyGetResponse
from pypureclient.flashblade.FB_2_16.models.public_key_post import PublicKeyPost
from pypureclient.flashblade.FB_2_16.models.public_key_response import PublicKeyResponse
from pypureclient.flashblade.FB_2_16.models.public_key_use_get_response import PublicKeyUseGetResponse
...
class PublicKeysApi:
    ...
    def api216_public_keys_delete_with_http_info(
        ...
        **kwargs
        ...
        Deletes public key configurations.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api216_public_keys_delete_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api216_public_keys_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api216_public_keys_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_public_keys_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_public_keys_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api216_public_keys_post_with_http_info(
        ...
        **kwargs
        ...
        Creates public key configurations.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api216_public_keys_post_with_http_info(names, public_key, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_public_keys_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api216_public_keys_uses_get_with_http_info(
        ...
        **kwargs
        ...
        List how public keys are being used and by what.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api216_public_keys_uses_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_public_keys_uses_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
