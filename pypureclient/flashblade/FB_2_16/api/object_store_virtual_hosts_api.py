...
class ObjectStoreVirtualHostsApi:
    ...
    def api216_object_store_virtual_hosts_delete_with_http_info(
        ...
        _param = self._api216_object_store_virtual_hosts_delete_serialize(
    ...
    def _api216_object_store_virtual_hosts_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.16/object-store-virtual-hosts',
    ...
    def api216_object_store_virtual_hosts_get_with_http_info(
        ...
        _param = self._api216_object_store_virtual_hosts_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api216_object_store_virtual_hosts_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api216_object_store_virtual_hosts_post_with_http_info(
        ...
        _param = self._api216_object_store_virtual_hosts_post_serialize(
            names = names,
            x_request_id = x_request_id,
        )
    ...
    def _api216_object_store_virtual_hosts_post_serialize(
        self,
        names,
        x_request_id,
    ) -> RequestSerialized:
