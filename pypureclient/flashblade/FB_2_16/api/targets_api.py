...
class TargetsApi:
    ...
    def api216_targets_delete_with_http_info(
        ...
        _param = self._api216_targets_delete_serialize(
    ...
    def _api216_targets_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.16/targets',
    ...
    def api216_targets_get_with_http_info(
        ...
        _param = self._api216_targets_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api216_targets_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api216_targets_patch_with_http_info(
        ...
        _param = self._api216_targets_patch_serialize(
            target = target,
            x_request_id = x_request_id,
            ids = ids,
            names = names,
    ...
    def _api216_targets_patch_serialize(
        self,
        target,
        x_request_id,
        ids,
    ...
    def api216_targets_performance_replication_get_with_http_info(
        ...
        _param = self._api216_targets_performance_replication_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            end_time = end_time,
            filter = filter,
    ...
    def _api216_targets_performance_replication_get_serialize(
        self,
        x_request_id,
        continuation_token,
        end_time,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/targets/performance/replication',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api216_targets_post_with_http_info(
        ...
        _param = self._api216_targets_post_serialize(
            names = names,
            target = target,
            x_request_id = x_request_id,
        )
    ...
    def _api216_targets_post_serialize(
        self,
        names,
        target,
        x_request_id,
