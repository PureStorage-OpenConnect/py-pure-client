...
class HardwareApi:
    ...
    def api216_hardware_get_with_http_info(
        ...
        _param = self._api216_hardware_get_serialize(
            ids = ids,
            names = names,
    ...
    def _api216_hardware_get_serialize(
        self,
        ids,
        names,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/hardware',
    ...
    def api216_hardware_patch_with_http_info(
        ...
        _param = self._api216_hardware_patch_serialize(
            hardware = hardware,
            ids = ids,
            names = names,
            x_request_id = x_request_id,
    ...
    def _api216_hardware_patch_serialize(
        self,
        hardware,
        ids,
        names,
