...
from pypureclient.flashblade.FB_2_16.models.server_get_response import ServerGetResponse
from pypureclient.flashblade.FB_2_16.models.server_post import ServerPost
from pypureclient.flashblade.FB_2_16.models.server_response import ServerResponse
...
class ServersApi:
    ...
    def api216_servers_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api216_servers_delete_with_http_info(cascade_delete, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()

        :param cascade_delete: The resource types to delete when deleting this object. It will fail if the resources are referenced by other objects. Valid values include `directory-services`. (required)
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api216_servers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api216_servers_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api216_servers_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api216_servers_patch_with_http_info(
        self,
        server: ServerPost,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        **kwargs
        ...
        Modify the server attributes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api216_servers_patch_with_http_info(server, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api216_servers_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        Add a server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api216_servers_post_with_http_info(create_ds, names, server, x_request_id, async_req=True)
        >>> result = thread.get()

        :param create_ds: The name of the directory service object to create used for NFS access to this server. The name must be the server `name` followed by _nfs. (required)
        :type create_ds: str
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_servers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the query parameters
        _query_params = []
        if _params.get('create_ds') is not None:  # noqa: E501
            _query_params.append(('create_ds', _params['create_ds']))
