...
class ServersApi:
    ...
    def api216_servers_delete_with_http_info(
        self,
        cascade_delete: Annotated[List[StrictStr], Field(description="The resource types to delete when deleting this object. It will fail if the resources are referenced by other objects. Valid values include `directory-services`.")],
        ...
        _param = self._api216_servers_delete_serialize(
    ...
    def _api216_servers_delete_serialize(
        self,
        cascade_delete,
        x_request_id,
        ids,
        ...
        if cascade_delete is not None:
            ...
            _query_params.append(('cascade_delete', cascade_delete))
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.16/servers',
    ...
    def api216_servers_get_with_http_info(
        ...
        _param = self._api216_servers_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api216_servers_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api216_servers_patch_with_http_info(
        ...
        _param = self._api216_servers_patch_serialize(
            server = server,
            x_request_id = x_request_id,
            ids = ids,
            names = names,
    ...
    def _api216_servers_patch_serialize(
        self,
        server,
        x_request_id,
        ids,
    ...
    def api216_servers_post_with_http_info(
        ...
        _param = self._api216_servers_post_serialize(
            create_ds = create_ds,
            names = names,
            server = server,
            x_request_id = x_request_id,
    ...
    def _api216_servers_post_serialize(
        self,
        create_ds,
        names,
        server,
        ...
        # process the path parameters
        # process the query parameters
        if create_ds is not None:
            
            _query_params.append(('create_ds', create_ds))
