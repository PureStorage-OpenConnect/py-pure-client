...
class PoliciesWORMDataApi:
    ...
    def api216_worm_data_policies_delete_with_http_info(
        ...
        _param = self._api216_worm_data_policies_delete_serialize(
    ...
    def _api216_worm_data_policies_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.16/worm-data-policies',
    ...
    def api216_worm_data_policies_get_with_http_info(
        ...
        _param = self._api216_worm_data_policies_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api216_worm_data_policies_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api216_worm_data_policies_members_get_with_http_info(
        ...
        _param = self._api216_worm_data_policies_members_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
    ...
    def _api216_worm_data_policies_members_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/worm-data-policies/members',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api216_worm_data_policies_patch_with_http_info(
        ...
        _param = self._api216_worm_data_policies_patch_serialize(
            x_request_id = x_request_id,
            ids = ids,
            names = names,
            policy = policy,
    ...
    def _api216_worm_data_policies_patch_serialize(
        self,
        x_request_id,
        ids,
        names,
    ...
    def api216_worm_data_policies_post_with_http_info(
        ...
        _param = self._api216_worm_data_policies_post_serialize(
            names = names,
            x_request_id = x_request_id,
            policy = policy,
        )
    ...
    def _api216_worm_data_policies_post_serialize(
        self,
        names,
        x_request_id,
        policy,
