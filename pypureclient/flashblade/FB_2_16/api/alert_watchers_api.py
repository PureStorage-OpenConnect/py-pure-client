...
class AlertWatchersApi(object):
    ...
    def api216_alert_watchers_delete_with_http_info(
        ...
        >>> thread = api.api216_alert_watchers_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api216_alert_watchers_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_alert_watchers_patch_with_http_info(alert_watcher, async_req=True)
        >>> result = thread.get()
