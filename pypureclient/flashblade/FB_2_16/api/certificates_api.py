...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_16.models.certificate_certificate_group_get_resp import CertificateCertificateGroupGetResp
from pypureclient.flashblade.FB_2_16.models.certificate_certificate_group_response import CertificateCertificateGroupResponse
from pypureclient.flashblade.FB_2_16.models.certificate_get_response import CertificateGetResponse
from pypureclient.flashblade.FB_2_16.models.certificate_patch import CertificatePatch
from pypureclient.flashblade.FB_2_16.models.certificate_post import CertificatePost
from pypureclient.flashblade.FB_2_16.models.certificate_response import CertificateResponse
from pypureclient.flashblade.FB_2_16.models.certificate_use_get_response import CertificateUseGetResponse
...
class CertificatesApi:
    ...
    @validate_call
    def api216_certificates_certificate_groups_delete_with_http_info(
        self,
        ...
        _param = self._api216_certificates_certificate_groups_delete_serialize(
    ...
    def _api216_certificates_certificate_groups_delete_serialize(
        self,
        x_request_id,
        certificate_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.16/certificates/certificate-groups',
    ...
    @validate_call
    def api216_certificates_certificate_groups_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        _param = self._api216_certificates_certificate_groups_get_serialize(
            x_request_id = x_request_id,
    ...
    def _api216_certificates_certificate_groups_get_serialize(
        self,
        x_request_id,
        continuation_token,
        certificate_ids,
    ...
    @validate_call
    def api216_certificates_certificate_groups_post_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        certificate_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of certificate ids. If there is not at least one resource that matches each of the elements of `certificate_ids`, then an error is returned. This cannot be provided in conjunction with the `certificate_names` parameter.")] = None,
        certificate_group_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of certificate group ids. If there is not at least one resource that matches each of the elements of `certificate_group_ids`, then an error is returned. This cannot be provided in conjunction with the `certificate_group_names` parameter.")] = None,
        ...
        _param = self._api216_certificates_certificate_groups_post_serialize(
            x_request_id = x_request_id,
            certificate_ids = certificate_ids,
            certificate_group_ids = certificate_group_ids,
            certificate_group_names = certificate_group_names,
    ...
    def _api216_certificates_certificate_groups_post_serialize(
        self,
        x_request_id,
        certificate_ids,
        certificate_group_ids,
    ...
    def api216_certificates_delete_with_http_info(
        ...
        _param = self._api216_certificates_delete_serialize(
            x_request_id = x_request_id,
            ids = ids,
            names = names,
        )
    ...
    def _api216_certificates_delete_serialize(
        self,
        x_request_id,
        ids,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.16/certificates',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api216_certificates_get_with_http_info(
        ...
        _param = self._api216_certificates_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
    ...
    def _api216_certificates_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
    ...
    def api216_certificates_patch_with_http_info(
        ...
        _param = self._api216_certificates_patch_serialize(
    ...
    def _api216_certificates_patch_serialize(
        self,
        certificate,
        x_request_id,
        ids,
    ...
    def api216_certificates_post_with_http_info(
        ...
        _param = self._api216_certificates_post_serialize(
            certificate = certificate,
            x_request_id = x_request_id,
            names = names,
        )
    ...
    def _api216_certificates_post_serialize(
        self,
        certificate,
        x_request_id,
        names,
    ...
    @validate_call
    def api216_certificates_uses_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ...
        _param = self._api216_certificates_uses_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
    ...
    def _api216_certificates_uses_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/certificates/uses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
