...
class HardwareConnectorsApi:
    ...
    def api216_hardware_connectors_get_with_http_info(
        ...
        _param = self._api216_hardware_connectors_get_serialize(
            ids = ids,
            names = names,
    ...
    def _api216_hardware_connectors_get_serialize(
        self,
        ids,
        names,
        x_request_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/hardware-connectors',
    ...
    def api216_hardware_connectors_patch_with_http_info(
        ...
        _param = self._api216_hardware_connectors_patch_serialize(
    ...
    def _api216_hardware_connectors_patch_serialize(
        self,
        hardware_connector,
        ids,
        names,
    ...
    def api216_hardware_connectors_performance_get_with_http_info(
        ...
        _param = self._api216_hardware_connectors_performance_get_serialize(
            x_request_id = x_request_id,
            end_time = end_time,
            filter = filter,
            ids = ids,
    ...
    def _api216_hardware_connectors_performance_get_serialize(
        self,
        x_request_id,
        end_time,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/hardware-connectors/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
