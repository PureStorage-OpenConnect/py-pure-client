...
from pypureclient.flashblade.FB_2_16.models.hardware_connector_get_response import HardwareConnectorGetResponse
from pypureclient.flashblade.FB_2_16.models.hardware_connector_performance_get_response import HardwareConnectorPerformanceGetResponse
from pypureclient.flashblade.FB_2_16.models.hardware_connector_response import HardwareConnectorResponse
...
class HardwareConnectorsApi:
    ...
    def api216_hardware_connectors_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_hardware_connectors_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api216_hardware_connectors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api216_hardware_connectors_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_hardware_connectors_patch_with_http_info(hardware_connector, x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_hardware_connectors_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api216_hardware_connectors_performance_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_hardware_connectors_performance_get_with_http_info(x_request_id, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_hardware_connectors_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
