...
from pypureclient.flashblade.FB_2_16.models.maintenance_window_post import MaintenanceWindowPost
from pypureclient.flashblade.FB_2_16.models.maintenance_windows_get_response import MaintenanceWindowsGetResponse
from pypureclient.flashblade.FB_2_16.models.maintenance_windows_response import MaintenanceWindowsResponse
...
class MaintenanceWindowsApi:
    ...
    def api216_maintenance_windows_delete_with_http_info(
        ...
        **kwargs
        ...
        Deletes an active maintenance window before its scheduled end (`expire`) time. The `names` parameter is required and must be set to `array`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api216_maintenance_windows_delete_with_http_info(x_request_id, ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api216_maintenance_windows_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_maintenance_windows_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api216_maintenance_windows_post_with_http_info(
        ...
        **kwargs
        ...
        Creates a maintenance window that suppresses alerts for a specified period of time. A maintenance window can be manually closed at any time. The `names` and `timeout` parameters are required. Set the `names` parameter to `array`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api216_maintenance_windows_post_with_http_info(names, maintenance_window, x_request_id, async_req=True)
        >>> result = thread.get()
