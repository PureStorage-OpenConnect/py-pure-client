...
class MaintenanceWindowsApi(object):
    ...
    def api216_maintenance_windows_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api216_maintenance_windows_post_with_http_info(names, maintenance_window, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api216_maintenance_windows_post`")
