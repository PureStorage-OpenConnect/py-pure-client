...
class ClientsApi:
    ...
    def api216_arrays_clients_performance_get_with_http_info(
        ...
        _param = self._api216_arrays_clients_performance_get_serialize(
    ...
    def _api216_arrays_clients_performance_get_serialize(
        self,
        x_request_id,
        filter,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/arrays/clients/performance',
