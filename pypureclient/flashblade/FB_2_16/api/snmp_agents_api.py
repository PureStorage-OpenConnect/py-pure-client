...
from pypureclient.flashblade.FB_2_16.models.snmp_agent import SnmpAgent
from pypureclient.flashblade.FB_2_16.models.snmp_agent_get_response import SnmpAgentGetResponse
from pypureclient.flashblade.FB_2_16.models.snmp_agent_mib_response import SnmpAgentMibResponse
from pypureclient.flashblade.FB_2_16.models.snmp_agent_response import SnmpAgentResponse
...
class SNMPAgentsApi:
    ...
    def api216_snmp_agents_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_snmp_agents_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api216_snmp_agents_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api216_snmp_agents_mib_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_snmp_agents_mib_get_with_http_info(x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_snmp_agents_mib_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api216_snmp_agents_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_snmp_agents_patch_with_http_info(snmp_agent, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_snmp_agents_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
