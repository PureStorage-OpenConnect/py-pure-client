...
class SoftwareApi:
    ...
    def api216_software_check_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_software_check_get_with_http_info(filter, ids, limit, names, offset, software_names, software_versions, sort, total_item_count, async_req=True)
        >>> result = thread.get()
    ...
    def api216_software_check_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_software_check_post_with_http_info(x_request_id, software_names, software_versions, async_req=True)
        >>> result = thread.get()
