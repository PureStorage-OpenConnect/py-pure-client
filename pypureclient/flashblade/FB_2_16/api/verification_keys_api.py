...
class VerificationKeysApi:
    ...
    def api216_support_verification_keys_get_with_http_info(
        ...
        _param = self._api216_support_verification_keys_get_serialize(
    ...
    def _api216_support_verification_keys_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/support/verification-keys',
    ...
    def api216_support_verification_keys_patch_with_http_info(
        ...
        _param = self._api216_support_verification_keys_patch_serialize(
            key = key,
            x_request_id = x_request_id,
        )
    ...
    def _api216_support_verification_keys_patch_serialize(
        self,
        key,
        x_request_id,
    ) -> RequestSerialized:
