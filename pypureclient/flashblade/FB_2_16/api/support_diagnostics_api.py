...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_16.models.support_diagnostics_details_get_response import SupportDiagnosticsDetailsGetResponse
from pypureclient.flashblade.FB_2_16.models.support_diagnostics_get_response import SupportDiagnosticsGetResponse
...
class SupportDiagnosticsApi:
    ...
    def api216_support_diagnostics_details_get_with_http_info(
        ...
        _param = self._api216_support_diagnostics_details_get_serialize(
    ...
    def _api216_support_diagnostics_details_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/support-diagnostics/details',
    ...
    def api216_support_diagnostics_get_with_http_info(
        ...
        _param = self._api216_support_diagnostics_get_serialize(
            x_request_id = x_request_id,
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
    ...
    def _api216_support_diagnostics_get_serialize(
        self,
        x_request_id,
        continuation_token,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.16/support-diagnostics',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api216_support_diagnostics_post_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        analysis_period_start_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="When the analysis time window starts (in milliseconds since epoch).")] = None,
        analysis_period_end_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="When the analysis time window ends (in milliseconds since epoch).")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[SupportDiagnosticsGetResponse]:
        ...
        _param = self._api216_support_diagnostics_post_serialize(
            x_request_id = x_request_id,
    ...
    def _api216_support_diagnostics_post_serialize(
        self,
        x_request_id,
        ...
        # process the path parameters
        # process the query parameters
        if analysis_period_start_time is not None:
            
            _query_params.append(('analysis_period_start_time', analysis_period_start_time))
            
        if analysis_period_end_time is not None:
            
            _query_params.append(('analysis_period_end_time', analysis_period_end_time))
