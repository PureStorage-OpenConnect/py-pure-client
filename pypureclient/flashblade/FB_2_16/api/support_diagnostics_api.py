...
class SupportDiagnosticsApi:
    ...
    def api216_support_diagnostics_details_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_support_diagnostics_details_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api216_support_diagnostics_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_support_diagnostics_get_with_http_info(x_request_id, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api216_support_diagnostics_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api216_support_diagnostics_post_with_http_info(x_request_id, analysis_period_end_time, analysis_period_start_time, async_req=True)
        >>> result = thread.get()
