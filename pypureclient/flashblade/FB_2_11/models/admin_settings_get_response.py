...
class AdminSettingsGetResponse(BaseModel):
    ...
    items: Optional[List[AdminSetting]] = Field(default=None, description="Returns global admin settings.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [AdminSetting.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
