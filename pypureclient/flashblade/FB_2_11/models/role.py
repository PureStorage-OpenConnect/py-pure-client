...
class Role(BaseModel):
    ...
    permissions: Optional[conlist(Permission)] = Field(default=None, description="A list of permissions that the role can perform.")
    ...
    def to_dict(self, include_readonly: bool=True) -> Dict[str, Any]:
        ...
        if _include_in_dict('permissions', include_readonly, excluded_fields, none_fields):
            _items = []
    ...
    def from_dict(cls, obj: dict) -> Role:
        ...
        _obj = Role.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
