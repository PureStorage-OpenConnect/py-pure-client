...
from pypureclient.flashblade.FB_2_11.models.throttle import Throttle
...
class ArrayConnectionPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "ca_certificate_group", "encrypted", "management_address", "remote", "replication_addresses", "status", "version", "throttle", "connection_key"]
