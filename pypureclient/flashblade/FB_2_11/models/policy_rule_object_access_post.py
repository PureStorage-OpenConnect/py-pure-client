...
class PolicyRuleObjectAccessPost(object):
    """
    Attributes:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `PolicyRuleObjectAccessPost`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(PolicyRuleObjectAccessPost, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PolicyRuleObjectAccessPost):
            return False
