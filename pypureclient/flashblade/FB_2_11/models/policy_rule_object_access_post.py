...
from pypureclient.flashblade.FB_2_11.models.policy_rule_object_access_condition import PolicyRuleObjectAccessCondition
...
class PolicyRuleObjectAccessPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["actions", "conditions", "resources", "effect"]
