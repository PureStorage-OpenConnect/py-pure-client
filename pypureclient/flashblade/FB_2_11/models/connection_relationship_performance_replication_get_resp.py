...
class ConnectionRelationshipPerformanceReplicationGetResp(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'total': 'list[ConnectionRelationshipPerformanceReplication]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.ConnectionRelationshipPerformanceReplication]
        total=None,  # type: List[models.ConnectionRelationshipPerformanceReplication]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ConnectionRelationshipPerformanceReplicationGetResp`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ConnectionRelationshipPerformanceReplicationGetResp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConnectionRelationshipPerformanceReplicationGetResp):
            return False
