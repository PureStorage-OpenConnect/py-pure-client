...
class Array(BaseModel):
    ...
    __properties = ["id", "name", "_as_of", "banner", "encryption", "eradication_config", "idle_timeout", "ntp_servers", "os", "product_type", "revision", "security_update", "smb_mode", "time_zone", "version"]
