...
class NfsExportPolicy(BaseModel):
    ...
    rules: Optional[Annotated[List[NfsExportPolicyRuleInPolicy], Field(max_length=200)]] = Field(default=None, description="All of the rules that are part of this policy. The order is the evaluation order.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "rules": [NfsExportPolicyRuleInPolicy.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
