...
class Dns(BaseModel):
    ...
    domain: Optional[StrictStr] = Field(default=None, description="Domain suffix to be appended by the Array when performing DNS lookups.")
    nameservers: Optional[conlist(StrictStr, max_items=3)] = Field(default=None, description="List of DNS server IP addresses.")
    __properties = ["id", "name", "domain", "nameservers"]
