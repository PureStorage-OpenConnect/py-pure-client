...
from pypureclient.flashblade.FB_2_11.models.fixed_reference_no_resource_type import FixedReferenceNoResourceType
...
class ArrayConnectionPath(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "destination", "remote", "source", "status", "status_details"]
