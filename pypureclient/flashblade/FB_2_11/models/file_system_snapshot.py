...
from pypureclient.flashblade.FB_2_11.models.fixed_location_reference import FixedLocationReference
...
class FileSystemSnapshot(BaseModel):
    ...
    __properties = ["id", "name", "created", "destroyed", "owner", "owner_destroyed", "policy", "source", "suffix", "time_remaining"]
