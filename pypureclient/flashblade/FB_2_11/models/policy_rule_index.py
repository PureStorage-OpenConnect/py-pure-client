...
class PolicyRuleIndex(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyRuleIndex:
        """Create an instance of PolicyRuleIndex from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyRuleIndex:
        """Create an instance of PolicyRuleIndex from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyRuleIndex.parse_obj(obj)

        _obj = PolicyRuleIndex.construct(_fields_set=None, **{
            "index": obj.get("index")
        })
        return _obj
