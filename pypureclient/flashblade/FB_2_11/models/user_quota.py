...
from pypureclient.flashblade.FB_2_11.models.user import User
...
class UserQuota(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "file_system", "file_system_default_quota", "quota", "usage", "user"]
