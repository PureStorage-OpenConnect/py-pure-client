...
class PolicyFileSystemSnapshotGetResponse(BaseModel):
    ...
    items: Optional[List[PolicyFileSystemSnapshot]] = Field(default=None, description="A list of members for policies.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [PolicyFileSystemSnapshot.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
