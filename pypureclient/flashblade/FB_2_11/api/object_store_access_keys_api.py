...
class ObjectStoreAccessKeysApi:
    ...
    def api211_object_store_access_keys_delete_with_http_info(
        ...
        _param = self._api211_object_store_access_keys_delete_serialize(
            names = names,
        )
    ...
    def _api211_object_store_access_keys_delete_serialize(
        self,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/object-store-access-keys',
    ...
    def api211_object_store_access_keys_get_with_http_info(
        ...
        _param = self._api211_object_store_access_keys_get_serialize(
    ...
    def _api211_object_store_access_keys_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
    ...
    def api211_object_store_access_keys_patch_with_http_info(
        ...
        _param = self._api211_object_store_access_keys_patch_serialize(
            names = names,
    ...
    def _api211_object_store_access_keys_patch_serialize(
        self,
        names,
    ...
    def api211_object_store_access_keys_post_with_http_info(
        ...
        _param = self._api211_object_store_access_keys_post_serialize(
            object_store_access_key = object_store_access_key,
            names = names,
        )
    ...
    def _api211_object_store_access_keys_post_serialize(
        self,
        object_store_access_key,
        names,
    ) -> RequestSerialized:
