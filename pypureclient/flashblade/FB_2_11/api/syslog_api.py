...
class SyslogApi:
    ...
    def api211_syslog_servers_delete_with_http_info(
        ...
        _param = self._api211_syslog_servers_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api211_syslog_servers_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/syslog-servers',
    ...
    def api211_syslog_servers_get_with_http_info(
        ...
        _param = self._api211_syslog_servers_get_serialize(
    ...
    def _api211_syslog_servers_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api211_syslog_servers_patch_with_http_info(
        ...
        _param = self._api211_syslog_servers_patch_serialize(
    ...
    def _api211_syslog_servers_patch_serialize(
        self,
        syslog_server,
        ids,
        names,
    ...
    def api211_syslog_servers_post_with_http_info(
        ...
        _param = self._api211_syslog_servers_post_serialize(
            syslog_server = syslog_server,
            names = names,
        )
    ...
    def _api211_syslog_servers_post_serialize(
        self,
        syslog_server,
        names,
    ) -> RequestSerialized:
    ...
    def api211_syslog_servers_settings_get_with_http_info(
        ...
        _param = self._api211_syslog_servers_settings_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api211_syslog_servers_settings_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.11/syslog-servers/settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api211_syslog_servers_settings_patch_with_http_info(
        ...
        _param = self._api211_syslog_servers_settings_patch_serialize(
    ...
    def _api211_syslog_servers_settings_patch_serialize(
        self,
    ...
    def api211_syslog_servers_test_get_with_http_info(
        ...
        _param = self._api211_syslog_servers_test_get_serialize(
            continuation_token = continuation_token,
        )
    ...
    def _api211_syslog_servers_test_get_serialize(
        self,
        continuation_token,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.11/syslog-servers/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
