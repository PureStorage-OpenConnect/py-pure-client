...
from pypureclient.flashblade.FB_2_11.models.verification_key_get_response import VerificationKeyGetResponse
from pypureclient.flashblade.FB_2_11.models.verification_key_patch import VerificationKeyPatch
from pypureclient.flashblade.FB_2_11.models.verification_key_response import VerificationKeyResponse
...
class VerificationKeysApi:
    ...
    def api211_support_verification_keys_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api211_support_verification_keys_get_with_http_info(continuation_token, filter, limit, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api211_support_verification_keys_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.11/support/verification-keys', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api211_support_verification_keys_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api211_support_verification_keys_patch_with_http_info(key, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_support_verification_keys_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.11/support/verification-keys', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
