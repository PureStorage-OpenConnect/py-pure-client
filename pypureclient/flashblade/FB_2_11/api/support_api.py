...
class SupportApi:
    ...
    def api211_support_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_support_get_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api211_support_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_support_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api211_support_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_support_test_get_with_http_info(filter, sort, test_type, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api211_support_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
