...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_11.models.support import Support
from pypureclient.flashblade.FB_2_11.models.support_get_response import SupportGetResponse
from pypureclient.flashblade.FB_2_11.models.support_response import SupportResponse
...
class SupportApi:
    ...
    def api211_support_get_with_http_info(
        ...
        _param = self._api211_support_get_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api211_support_get_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.11/support',
    ...
    def api211_support_patch_with_http_info(
        ...
        _param = self._api211_support_patch_serialize(
            support = support,
        )
    ...
    def _api211_support_patch_serialize(
        self,
        support,
    ) -> RequestSerialized:
    ...
    def api211_support_test_get_with_http_info(
        ...
        _param = self._api211_support_test_get_serialize(
            filter = filter,
            sort = sort,
            test_type = test_type,
        )
    ...
    def _api211_support_test_get_serialize(
        self,
        filter,
        sort,
        test_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.11/support/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
