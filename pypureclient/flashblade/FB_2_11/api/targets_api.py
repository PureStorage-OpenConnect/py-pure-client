...
class TargetsApi:
    ...
    def api211_targets_delete_with_http_info(
        ...
        _param = self._api211_targets_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api211_targets_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/targets',
    ...
    def api211_targets_get_with_http_info(
        ...
        _param = self._api211_targets_get_serialize(
    ...
    def _api211_targets_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api211_targets_patch_with_http_info(
        ...
        _param = self._api211_targets_patch_serialize(
            target = target,
            ids = ids,
            names = names,
        )
    ...
    def _api211_targets_patch_serialize(
        self,
        target,
        ids,
        names,
    ...
    def api211_targets_performance_replication_get_with_http_info(
        ...
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[ResourcePerformanceReplicationGetResponse]:
        ...
        _param = self._api211_targets_performance_replication_get_serialize(
            continuation_token = continuation_token,
            end_time = end_time,
            filter = filter,
            ids = ids,
    ...
    def _api211_targets_performance_replication_get_serialize(
        self,
        continuation_token,
        end_time,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.11/targets/performance/replication',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api211_targets_post_with_http_info(
        ...
        _param = self._api211_targets_post_serialize(
            names = names,
            target = target,
        )
    ...
    def _api211_targets_post_serialize(
        self,
        names,
        target,
    ) -> RequestSerialized:
