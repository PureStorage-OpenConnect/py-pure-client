...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_11.models.bucket_get_response import BucketGetResponse
from pypureclient.flashblade.FB_2_11.models.bucket_patch import BucketPatch
from pypureclient.flashblade.FB_2_11.models.bucket_performance_get_response import BucketPerformanceGetResponse
...
class BucketsApi:
    ...
    def api211_buckets_delete_with_http_info(
        ...
        _param = self._api211_buckets_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api211_buckets_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/buckets',
    ...
    def api211_buckets_get_with_http_info(
        ...
        _param = self._api211_buckets_get_serialize(
    ...
    def _api211_buckets_get_serialize(
        self,
        continuation_token,
        destroyed,
        filter,
    ...
    def api211_buckets_patch_with_http_info(
        ...
        _param = self._api211_buckets_patch_serialize(
            bucket = bucket,
            ids = ids,
    ...
    def _api211_buckets_patch_serialize(
        self,
        bucket,
        ids,
        ignore_usage,
    ...
    def api211_buckets_performance_get_with_http_info(
        ...
        _param = self._api211_buckets_performance_get_serialize(
            continuation_token = continuation_token,
            end_time = end_time,
            filter = filter,
            ids = ids,
    ...
    def _api211_buckets_performance_get_serialize(
        self,
        continuation_token,
        end_time,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.11/buckets/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api211_buckets_post_with_http_info(
        ...
        _param = self._api211_buckets_post_serialize(
            names = names,
            bucket = bucket,
        )
    ...
    def _api211_buckets_post_serialize(
        self,
        names,
        bucket,
    ) -> RequestSerialized:
    ...
    def api211_buckets_s3_specific_performance_get_with_http_info(
        ...
        _param = self._api211_buckets_s3_specific_performance_get_serialize(
            continuation_token = continuation_token,
            end_time = end_time,
            filter = filter,
            ids = ids,
    ...
    def _api211_buckets_s3_specific_performance_get_serialize(
        self,
        continuation_token,
        end_time,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.11/buckets/s3-specific-performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
