...
class PoliciesSMBClientApi:
    ...
    def api211_smb_client_policies_delete_with_http_info(
        ...
        _param = self._api211_smb_client_policies_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api211_smb_client_policies_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/smb-client-policies',
    ...
    def api211_smb_client_policies_get_with_http_info(
        ...
        _param = self._api211_smb_client_policies_get_serialize(
    ...
    def _api211_smb_client_policies_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api211_smb_client_policies_patch_with_http_info(
        ...
        _param = self._api211_smb_client_policies_patch_serialize(
            policy = policy,
            ids = ids,
            names = names,
        )
    ...
    def _api211_smb_client_policies_patch_serialize(
        self,
        policy,
        ids,
        names,
    ...
    def api211_smb_client_policies_post_with_http_info(
        ...
        _param = self._api211_smb_client_policies_post_serialize(
            names = names,
            policy = policy,
        )
    ...
    def _api211_smb_client_policies_post_serialize(
        self,
        names,
        policy,
    ) -> RequestSerialized:
    ...
    def api211_smb_client_policies_rules_delete_with_http_info(
        ...
        _param = self._api211_smb_client_policies_rules_delete_serialize(
            ids = ids,
            names = names,
            versions = versions,
        )
    ...
    def _api211_smb_client_policies_rules_delete_serialize(
        self,
        ids,
        names,
        versions,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/smb-client-policies/rules',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api211_smb_client_policies_rules_get_with_http_info(
        ...
        _param = self._api211_smb_client_policies_rules_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api211_smb_client_policies_rules_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api211_smb_client_policies_rules_patch_with_http_info(
        ...
        _param = self._api211_smb_client_policies_rules_patch_serialize(
            rule = rule,
    ...
    def _api211_smb_client_policies_rules_patch_serialize(
        self,
        rule,
        before_rule_id,
        before_rule_name,
    ...
    def api211_smb_client_policies_rules_post_with_http_info(
        ...
        _param = self._api211_smb_client_policies_rules_post_serialize(
            rule = rule,
            before_rule_id = before_rule_id,
            before_rule_name = before_rule_name,
            policy_ids = policy_ids,
    ...
    def _api211_smb_client_policies_rules_post_serialize(
        self,
        rule,
        before_rule_id,
        before_rule_name,
