...
from pypureclient.flashblade.FB_2_11.api_client import ApiClient as _TransportApiClient, RequestSerialized
from pypureclient.flashblade.FB_2_11.api_response import ApiResponse
from pypureclient.flashblade.FB_2_11.rest import RESTResponseType
...
class PoliciesSMBShareApi:
    ...
    def api211_smb_share_policies_delete_with_http_info(
        ...
        _param = self._api211_smb_share_policies_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api211_smb_share_policies_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/smb-share-policies',
    ...
    def api211_smb_share_policies_get_with_http_info(
        ...
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[SmbSharePolicyGetResponse]:
        ...
        _param = self._api211_smb_share_policies_get_serialize(
    ...
    def _api211_smb_share_policies_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api211_smb_share_policies_patch_with_http_info(
        ...
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[SmbSharePolicyResponse]:
        ...
        _param = self._api211_smb_share_policies_patch_serialize(
            policy = policy,
            ids = ids,
            names = names,
        )
    ...
    def _api211_smb_share_policies_patch_serialize(
        self,
        policy,
        ids,
        names,
    ...
    def api211_smb_share_policies_post_with_http_info(
        ...
        _param = self._api211_smb_share_policies_post_serialize(
            names = names,
            policy = policy,
        )
    ...
    def _api211_smb_share_policies_post_serialize(
        self,
        names,
        policy,
    ) -> RequestSerialized:
    ...
    def api211_smb_share_policies_rules_delete_with_http_info(
        ...
        _param = self._api211_smb_share_policies_rules_delete_serialize(
            ids = ids,
            names = names,
    ...
    def _api211_smb_share_policies_rules_delete_serialize(
        self,
        ids,
        names,
        policy_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/smb-share-policies/rules',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api211_smb_share_policies_rules_get_with_http_info(
        ...
        sort: Annotated[Optional[List[Annotated[str, Field(strict=True)]]], Field(description="Sort the response by the specified fields (in descending order if '-' is appended to the field name). NOTE: If you provide a sort you will not get a `continuation_token` in the response.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[SmbSharePolicyRuleGetResponse]:
        ...
        _param = self._api211_smb_share_policies_rules_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api211_smb_share_policies_rules_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api211_smb_share_policies_rules_patch_with_http_info(
        ...
        policy_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of policy names.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[SmbSharePolicyRuleResponse]:
        ...
        _param = self._api211_smb_share_policies_rules_patch_serialize(
            rule = rule,
            ids = ids,
            names = names,
            policy_ids = policy_ids,
    ...
    def _api211_smb_share_policies_rules_patch_serialize(
        self,
        rule,
        ids,
        names,
    ...
    def api211_smb_share_policies_rules_post_with_http_info(
        ...
        _param = self._api211_smb_share_policies_rules_post_serialize(
            rule = rule,
            policy_ids = policy_ids,
            policy_names = policy_names,
        )
    ...
    def _api211_smb_share_policies_rules_post_serialize(
        self,
        rule,
        policy_ids,
        policy_names,
