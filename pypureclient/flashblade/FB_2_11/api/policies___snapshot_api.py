...
class PoliciesSnapshotApi(object):
    ...
    def api211_policies_file_system_replica_links_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api211_policies_file_system_replica_links_get`, must be a value greater than or equal to `0`")
    ...
    def api211_policies_file_system_snapshots_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api211_policies_file_system_snapshots_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api211_policies_file_systems_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api211_policies_file_systems_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
