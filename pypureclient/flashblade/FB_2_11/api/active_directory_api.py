...
class ActiveDirectoryApi:
    ...
    def api211_active_directory_patch_with_http_info(
        ...
        _param = self._api211_active_directory_patch_serialize(
    ...
    def _api211_active_directory_patch_serialize(
        self,
        active_directory,
        ids,
        names,
    ...
    def api211_active_directory_test_get_with_http_info(
        ...
        _param = self._api211_active_directory_test_get_serialize(
            filter = filter,
            ids = ids,
            limit = limit,
            names = names,
    ...
    def _api211_active_directory_test_get_serialize(
        self,
        filter,
        ids,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.11/active-directory/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
