...
class PoliciesSnapshotApi:
    ...
    def api211_policies_delete_with_http_info(
        ...
        _param = self._api211_policies_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api211_policies_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
    ...
    def api211_policies_file_system_replica_links_delete_with_http_info(
        ...
        _param = self._api211_policies_file_system_replica_links_delete_serialize(
    ...
    def _api211_policies_file_system_replica_links_delete_serialize(
        self,
        local_file_system_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/policies/file-system-replica-links',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api211_policies_file_system_replica_links_get_with_http_info(
        ...
        _param = self._api211_policies_file_system_replica_links_get_serialize(
    ...
    def _api211_policies_file_system_replica_links_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
    ...
    def api211_policies_file_system_replica_links_post_with_http_info(
        ...
        _param = self._api211_policies_file_system_replica_links_post_serialize(
            local_file_system_ids = local_file_system_ids,
            local_file_system_names = local_file_system_names,
            member_ids = member_ids,
            policy_ids = policy_ids,
    ...
    def _api211_policies_file_system_replica_links_post_serialize(
        self,
        local_file_system_ids,
        local_file_system_names,
        member_ids,
    ...
    def api211_policies_file_system_snapshots_delete_with_http_info(
        ...
        _param = self._api211_policies_file_system_snapshots_delete_serialize(
            member_ids = member_ids,
    ...
    def _api211_policies_file_system_snapshots_delete_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/policies/file-system-snapshots',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api211_policies_file_system_snapshots_get_with_http_info(
        ...
        _param = self._api211_policies_file_system_snapshots_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
            member_ids = member_ids,
    ...
    def _api211_policies_file_system_snapshots_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
    ...
    def api211_policies_file_systems_delete_with_http_info(
        ...
        _param = self._api211_policies_file_systems_delete_serialize(
            member_ids = member_ids,
            member_names = member_names,
            policy_ids = policy_ids,
            policy_names = policy_names,
    ...
    def _api211_policies_file_systems_delete_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/policies/file-systems',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api211_policies_file_systems_get_with_http_info(
        ...
        _param = self._api211_policies_file_systems_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
            member_ids = member_ids,
    ...
    def _api211_policies_file_systems_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
    ...
    def api211_policies_file_systems_post_with_http_info(
        ...
        _param = self._api211_policies_file_systems_post_serialize(
            member_ids = member_ids,
            member_names = member_names,
            policy_ids = policy_ids,
            policy_names = policy_names,
    ...
    def _api211_policies_file_systems_post_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
    ...
    def api211_policies_patch_with_http_info(
        ...
        _param = self._api211_policies_patch_serialize(
            policy = policy,
            ids = ids,
    ...
    def _api211_policies_patch_serialize(
        self,
        policy,
        ids,
        destroy_snapshots,
    ...
    def api211_policies_post_with_http_info(
        ...
        _param = self._api211_policies_post_serialize(
            names = names,
            policy = policy,
        )
    ...
    def _api211_policies_post_serialize(
        self,
        names,
        policy,
    ) -> RequestSerialized:
