...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_11.models.certificate_group_certificate_get_resp import CertificateGroupCertificateGetResp
from pypureclient.flashblade.FB_2_11.models.certificate_group_certificate_response import CertificateGroupCertificateResponse
from pypureclient.flashblade.FB_2_11.models.certificate_group_get_response import CertificateGroupGetResponse
from pypureclient.flashblade.FB_2_11.models.certificate_group_response import CertificateGroupResponse
from pypureclient.flashblade.FB_2_11.models.certificate_group_use_get_response import CertificateGroupUseGetResponse
...
class CertificateGroupsApi:
    ...
    @validate_call
    def api211_certificate_groups_certificates_delete_with_http_info(
        self,
        ...
        _param = self._api211_certificate_groups_certificates_delete_serialize(
    ...
    def _api211_certificate_groups_certificates_delete_serialize(
        self,
        certificate_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/certificate-groups/certificates',
    ...
    @validate_call
    def api211_certificate_groups_certificates_get_with_http_info(
        self,
        ...
        _param = self._api211_certificate_groups_certificates_get_serialize(
    ...
    def _api211_certificate_groups_certificates_get_serialize(
        self,
        continuation_token,
        certificate_ids,
        certificate_group_ids,
    ...
    @validate_call
    def api211_certificate_groups_certificates_post_with_http_info(
        self,
        certificate_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of certificate ids. If there is not at least one resource that matches each of the elements of `certificate_ids`, then an error is returned. This cannot be provided in conjunction with the `certificate_names` parameter.")] = None,
        certificate_group_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of certificate group ids. If there is not at least one resource that matches each of the elements of `certificate_group_ids`, then an error is returned. This cannot be provided in conjunction with the `certificate_group_names` parameter.")] = None,
        certificate_group_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of certificate group names. If there is not at least one resource that matches each of the elements of `certificate_group_names`, then an error is returned. This cannot be provided in conjunction with the `certificate_group_ids` parameter.")] = None,
        ...
        _param = self._api211_certificate_groups_certificates_post_serialize(
            certificate_ids = certificate_ids,
            certificate_group_ids = certificate_group_ids,
            certificate_group_names = certificate_group_names,
            certificate_names = certificate_names,
    ...
    def _api211_certificate_groups_certificates_post_serialize(
        self,
        certificate_ids,
        certificate_group_ids,
        certificate_group_names,
    ...
    @validate_call
    def api211_certificate_groups_delete_with_http_info(
        self,
        ...
        _param = self._api211_certificate_groups_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api211_certificate_groups_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.11/certificate-groups',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api211_certificate_groups_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        _param = self._api211_certificate_groups_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api211_certificate_groups_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    @validate_call
    def api211_certificate_groups_post_with_http_info(
        self,
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
        ...
        _param = self._api211_certificate_groups_post_serialize(
            names = names,
        )
    ...
    def _api211_certificate_groups_post_serialize(
        self,
        names,
    ) -> RequestSerialized:
    ...
    @validate_call
    def api211_certificate_groups_uses_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        _param = self._api211_certificate_groups_uses_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api211_certificate_groups_uses_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.11/certificate-groups/uses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
