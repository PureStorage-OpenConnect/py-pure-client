...
from pypureclient.flashblade.FB_2_11.models.hardware_get_response import HardwareGetResponse
from pypureclient.flashblade.FB_2_11.models.hardware_response import HardwareResponse
...
class HardwareApi:
    ...
    def api211_hardware_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_hardware_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api211_hardware_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api211_hardware_patch_with_http_info(hardware, ids, names, async_req=True)
        >>> result = thread.get()
