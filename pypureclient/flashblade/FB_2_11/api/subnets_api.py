...
class SubnetsApi(object):
    ...
    def api211_subnets_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api211_subnets_get`, must be a value greater than or equal to `1`")
    ...
    def api211_subnets_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api211_subnets_post_with_http_info(subnet, names, async_req=True)
        >>> result = thread.get()
