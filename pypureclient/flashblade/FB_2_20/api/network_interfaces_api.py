...
from pypureclient.flashblade.FB_2_20.models.hardware_connector import HardwareConnector
from pypureclient.flashblade.FB_2_20.models.network_connection_statistics_get_response import NetworkConnectionStatisticsGetResponse
from pypureclient.flashblade.FB_2_20.models.network_interface import NetworkInterface
from pypureclient.flashblade.FB_2_20.models.network_interface_get_response import NetworkInterfaceGetResponse
from pypureclient.flashblade.FB_2_20.models.network_interface_neighbor_get_response import NetworkInterfaceNeighborGetResponse
from pypureclient.flashblade.FB_2_20.models.network_interface_patch import NetworkInterfacePatch
from pypureclient.flashblade.FB_2_20.models.network_interface_ping_get_response import NetworkInterfacePingGetResponse
from pypureclient.flashblade.FB_2_20.models.network_interface_response import NetworkInterfaceResponse
from pypureclient.flashblade.FB_2_20.models.network_interface_trace_get_response import NetworkInterfaceTraceGetResponse
from pypureclient.flashblade.FB_2_20.models.network_interfaces_connectors_get_response import NetworkInterfacesConnectorsGetResponse
from pypureclient.flashblade.FB_2_20.models.network_interfaces_connectors_performance_get_response import NetworkInterfacesConnectorsPerformanceGetResponse
from pypureclient.flashblade.FB_2_20.models.network_interfaces_connectors_response import NetworkInterfacesConnectorsResponse
from pypureclient.flashblade.FB_2_20.models.network_interfaces_connectors_settings_get_response import NetworkInterfacesConnectorsSettingsGetResponse
from typing import Optional
...
class NetworkInterfacesApi:
    ...
    def api220_network_interfaces_connectors_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.20/network-interfaces/connectors', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_network_interfaces_connectors_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.20/network-interfaces/connectors', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_network_interfaces_connectors_performance_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.20/network-interfaces/connectors/performance', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_network_interfaces_connectors_settings_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="A token used to retrieve the next page of data with some consistency guaranteed. The token is a Base64 encoded value. Set `continuation_token` to the system-generated token taken from the `x-next-token` header field of the response. A query has reached its last page when the response does not include a token. Pagination requires the `limit` and `continuation_token` query parameters.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Narrows down the results to only the response objects that satisfy the filter criteria.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.20/network-interfaces/connectors/settings', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_network_interfaces_neighbors_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="A token used to retrieve the next page of data with some consistency guaranteed. The token is a Base64 encoded value. Set `continuation_token` to the system-generated token taken from the `x-next-token` header field of the response. A query has reached its last page when the response does not include a token. Pagination requires the `limit` and `continuation_token` query parameters.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Narrows down the results to only the response objects that satisfy the filter criteria.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.20/network-interfaces/neighbors', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_network_interfaces_network_connection_statistics_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.20/network-interfaces/network-connection-statistics', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_network_interfaces_ping_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.20/network-interfaces/ping', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_network_interfaces_trace_get_with_http_info(
        self,
        destination: Annotated[StrictStr, Field(..., description="A destination specified by user to run the network diagnosis against. Can be a hostname or an IP.")],
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        component_name: Annotated[Optional[StrictStr], Field(description="Used by ping and trace to specify where to run the operation. Valid values are controllers and blades from hardware list. If not specified, defaults to all available controllers and selected blades.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.20/network-interfaces/trace', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
