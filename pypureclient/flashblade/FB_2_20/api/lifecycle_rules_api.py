...
from pypureclient.flashblade.FB_2_20.models.lifecycle_rule_get_response import LifecycleRuleGetResponse
from pypureclient.flashblade.FB_2_20.models.lifecycle_rule_patch import LifecycleRulePatch
from pypureclient.flashblade.FB_2_20.models.lifecycle_rule_post import LifecycleRulePost
from pypureclient.flashblade.FB_2_20.models.lifecycle_rule_response import LifecycleRuleResponse
from typing import Optional
...
class LifecycleRulesApi:
    ...
    def api220_lifecycle_rules_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api220_lifecycle_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.20/lifecycle-rules', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_lifecycle_rules_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_lifecycle_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api220_lifecycle_rules_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_lifecycle_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.20/lifecycle-rules', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_lifecycle_rules_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_lifecycle_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
