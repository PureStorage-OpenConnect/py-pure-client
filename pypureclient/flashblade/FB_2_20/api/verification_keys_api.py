...
from pypureclient.flashblade.FB_2_20.models.verification_key_get_response import VerificationKeyGetResponse
from pypureclient.flashblade.FB_2_20.models.verification_key_patch import VerificationKeyPatch
from pypureclient.flashblade.FB_2_20.models.verification_key_response import VerificationKeyResponse
from typing import Optional
...
class VerificationKeysApi:
    ...
    def api220_support_verification_keys_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api220_support_verification_keys_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.20/support/verification-keys', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_support_verification_keys_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_support_verification_keys_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.20/support/verification-keys', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
