...
from pypureclient.flashblade.FB_2_20.models.clients_performance_get_response import ClientsPerformanceGetResponse
from pypureclient.flashblade.FB_2_20.models.clients_s3_specific_performance_get_response import ClientsS3SpecificPerformanceGetResponse
from typing import Optional
...
class ClientsApi:
    ...
    def api220_arrays_clients_performance_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api220_arrays_clients_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.20/arrays/clients/performance', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_arrays_clients_s3_specific_performance_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Narrows down the results to only the response objects that satisfy the filter criteria.")] = None,
        limit: Annotated[Optional[conint(strict=True, ge=0)], Field(description="Limits the size of the response to the specified number of objects on each page. To return the total number of resources, set `limit=0`. The total number of resources is returned as a `total_item_count` value. If the page size requested is larger than the system maximum limit, the server returns the maximum limit, disregarding the requested page size.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_arrays_clients_s3_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.20/arrays/clients/s3-specific-performance', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
