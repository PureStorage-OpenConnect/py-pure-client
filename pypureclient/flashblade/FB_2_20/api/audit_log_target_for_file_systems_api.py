...
from pypureclient.flashblade.FB_2_20.models.log_targets_file_systems import LogTargetsFileSystems
from pypureclient.flashblade.FB_2_20.models.log_targets_file_systems_get_response import LogTargetsFileSystemsGetResponse
from pypureclient.flashblade.FB_2_20.models.log_targets_file_systems_post import LogTargetsFileSystemsPost
from pypureclient.flashblade.FB_2_20.models.log_targets_file_systems_response import LogTargetsFileSystemsResponse
from typing import Optional
...
class AuditLogTargetForFileSystemsApi:
    ...
    def api220_log_targets_file_systems_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api220_log_targets_file_systems_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.20/log-targets/file-systems', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_log_targets_file_systems_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_log_targets_file_systems_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.20/log-targets/file-systems', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_log_targets_file_systems_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_log_targets_file_systems_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.20/log-targets/file-systems', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api220_log_targets_file_systems_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_log_targets_file_systems_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.20/log-targets/file-systems', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
