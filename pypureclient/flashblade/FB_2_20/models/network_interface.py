...
class NetworkInterface(BaseModel):
    ...
    realms: Optional[conlist(FixedReference)] = Field(default=None, description="The realms containing this network interface.")
    ...
    __properties = ["id", "name", "address", "attached_servers", "enabled", "gateway", "mtu", "netmask", "realms", "services", "subnet", "type", "vlan"]
