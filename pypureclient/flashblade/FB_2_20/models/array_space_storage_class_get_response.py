...
from pypureclient.flashblade.FB_2_20.models.storage_class_space import StorageClassSpace


class ArraySpaceStorageClassGetResponse(BaseModel):
    """
    ...
    total: Optional[conlist(StorageClassSpace)] = Field(default=None, description="A list of array space metrics objects for storage class totals.")
    ...
    def to_dict(self, include_readonly: bool=True) -> Dict[str, Any]:
        ...
        if _include_in_dict('total', include_readonly, excluded_fields, none_fields):
            ...
            for _item in self.total:
                if _item:
                    _total.append(_item.to_dict(include_readonly=include_readonly))
            _dict['total'] = _total
        return _dict
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArraySpaceStorageClassGetResponse:
        """Create an instance of ArraySpaceStorageClassGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ArraySpaceStorageClassGetResponse:
        """Create an instance of ArraySpaceStorageClassGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArraySpaceStorageClassGetResponse.parse_obj(obj)

        _obj = ArraySpaceStorageClassGetResponse.construct(_fields_set=None, **{
