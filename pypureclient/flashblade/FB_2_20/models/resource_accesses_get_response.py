...
from pypureclient.flashblade.FB_2_20.models.resource_access import ResourceAccess


class ResourceAccessesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ResourceAccess)] = Field(default=None, description="A list of resource access objects.")
    __properties = ["continuation_token", "total_item_count", "more_items_remaining", "items"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceAccessesGetResponse:
        """Create an instance of ResourceAccessesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ResourceAccessesGetResponse:
        """Create an instance of ResourceAccessesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceAccessesGetResponse.parse_obj(obj)

        _obj = ResourceAccessesGetResponse.construct(_fields_set=None, **{
            ...
            "items": [ResourceAccess.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
