...
class ActiveDirectory(BaseModel):
    ...
    realms: Optional[conlist(FixedReference)] = Field(default=None, description="The realms containing this active directory account.")
    ...
    __properties = ["id", "name", "computer_name", "directory_servers", "domain", "encryption_types", "global_catalog_servers", "join_ou", "kerberos_servers", "realms", "server", "service_principal_names"]
