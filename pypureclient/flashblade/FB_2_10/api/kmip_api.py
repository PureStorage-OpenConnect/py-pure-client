...
from pypureclient.flashblade.FB_2_10.models.kmip_server_response import KmipServerResponse
...
class KMIPApi:
    ...
    def api210_kmip_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api210_kmip_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api210_kmip_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api210_kmip_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api210_kmip_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_kmip_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api210_kmip_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api210_kmip_patch_with_http_info(kmip_server, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_kmip_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api210_kmip_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api210_kmip_post_with_http_info(kmip_server, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_kmip_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api210_kmip_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api210_kmip_test_get_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_kmip_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
