...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_10.models.directory_service import DirectoryService
from pypureclient.flashblade.FB_2_10.models.directory_service_get_response import DirectoryServiceGetResponse
from pypureclient.flashblade.FB_2_10.models.directory_service_response import DirectoryServiceResponse
from pypureclient.flashblade.FB_2_10.models.directory_service_role import DirectoryServiceRole
from pypureclient.flashblade.FB_2_10.models.directory_service_roles_get_response import DirectoryServiceRolesGetResponse
...
class DirectoryServicesApi:
    ...
    def api210_directory_services_get_with_http_info(
        ...
        _param = self._api210_directory_services_get_serialize(
    ...
    def _api210_directory_services_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.10/directory-services',
    ...
    def api210_directory_services_patch_with_http_info(
        ...
        _param = self._api210_directory_services_patch_serialize(
    ...
    def _api210_directory_services_patch_serialize(
        self,
        directory_service,
        ids,
        names,
    ...
    def api210_directory_services_roles_get_with_http_info(
        ...
        _param = self._api210_directory_services_roles_get_serialize(
            continuation_token = continuation_token,
            ids = ids,
            filter = filter,
            limit = limit,
    ...
    def _api210_directory_services_roles_get_serialize(
        self,
        continuation_token,
        ids,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.10/directory-services/roles',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api210_directory_services_roles_patch_with_http_info(
        ...
        _param = self._api210_directory_services_roles_patch_serialize(
    ...
    def _api210_directory_services_roles_patch_serialize(
        self,
    ...
    def api210_directory_services_test_get_with_http_info(
        ...
        _param = self._api210_directory_services_test_get_serialize(
            filter = filter,
            ids = ids,
            limit = limit,
            names = names,
    ...
    def _api210_directory_services_test_get_serialize(
        self,
        filter,
        ids,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.10/directory-services/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api210_directory_services_test_patch_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        ...
        _param = self._api210_directory_services_test_patch_serialize(
            filter = filter,
            ids = ids,
            names = names,
            sort = sort,
    ...
    def _api210_directory_services_test_patch_serialize(
        self,
        filter,
        ids,
        names,
