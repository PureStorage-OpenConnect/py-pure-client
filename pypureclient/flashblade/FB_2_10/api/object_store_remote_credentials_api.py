...
class ObjectStoreRemoteCredentialsApi:
    ...
    def api210_object_store_remote_credentials_delete_with_http_info(
        ...
        _param = self._api210_object_store_remote_credentials_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api210_object_store_remote_credentials_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.10/object-store-remote-credentials',
    ...
    def api210_object_store_remote_credentials_get_with_http_info(
        ...
        _param = self._api210_object_store_remote_credentials_get_serialize(
    ...
    def _api210_object_store_remote_credentials_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api210_object_store_remote_credentials_patch_with_http_info(
        ...
        _param = self._api210_object_store_remote_credentials_patch_serialize(
    ...
    def _api210_object_store_remote_credentials_patch_serialize(
        self,
        remote_credentials,
        ids,
        names,
    ...
    def api210_object_store_remote_credentials_post_with_http_info(
        ...
        _param = self._api210_object_store_remote_credentials_post_serialize(
            names = names,
            remote_credentials = remote_credentials,
        )
    ...
    def _api210_object_store_remote_credentials_post_serialize(
        self,
        names,
        remote_credentials,
    ) -> RequestSerialized:
