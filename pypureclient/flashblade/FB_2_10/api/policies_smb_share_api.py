...
from pypureclient.flashblade.FB_2_10.models.smb_share_policy_get_response import SmbSharePolicyGetResponse
from pypureclient.flashblade.FB_2_10.models.smb_share_policy_post import SmbSharePolicyPost
from pypureclient.flashblade.FB_2_10.models.smb_share_policy_response import SmbSharePolicyResponse
from pypureclient.flashblade.FB_2_10.models.smb_share_policy_rule import SmbSharePolicyRule
from pypureclient.flashblade.FB_2_10.models.smb_share_policy_rule_get_response import SmbSharePolicyRuleGetResponse
from pypureclient.flashblade.FB_2_10.models.smb_share_policy_rule_post import SmbSharePolicyRulePost
from pypureclient.flashblade.FB_2_10.models.smb_share_policy_rule_response import SmbSharePolicyRuleResponse
...
class PoliciesSMBShareApi:
    ...
    def api210_smb_share_policies_delete_with_http_info(
        ...
        _param = self._api210_smb_share_policies_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api210_smb_share_policies_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.10/smb-share-policies',
    ...
    def api210_smb_share_policies_get_with_http_info(
        ...
        _param = self._api210_smb_share_policies_get_serialize(
    ...
    def _api210_smb_share_policies_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api210_smb_share_policies_patch_with_http_info(
        ...
        _param = self._api210_smb_share_policies_patch_serialize(
            policy = policy,
            ids = ids,
            names = names,
        )
    ...
    def _api210_smb_share_policies_patch_serialize(
        self,
        policy,
        ids,
        names,
    ...
    def api210_smb_share_policies_post_with_http_info(
        ...
        _param = self._api210_smb_share_policies_post_serialize(
            names = names,
            policy = policy,
        )
    ...
    def _api210_smb_share_policies_post_serialize(
        self,
        names,
        policy,
    ) -> RequestSerialized:
    ...
    def api210_smb_share_policies_rules_delete_with_http_info(
        ...
        _param = self._api210_smb_share_policies_rules_delete_serialize(
            ids = ids,
            names = names,
    ...
    def _api210_smb_share_policies_rules_delete_serialize(
        self,
        ids,
        names,
        policy_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.10/smb-share-policies/rules',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api210_smb_share_policies_rules_get_with_http_info(
        ...
        _param = self._api210_smb_share_policies_rules_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api210_smb_share_policies_rules_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api210_smb_share_policies_rules_patch_with_http_info(
        ...
        _param = self._api210_smb_share_policies_rules_patch_serialize(
            rule = rule,
            ids = ids,
            names = names,
            policy_ids = policy_ids,
    ...
    def _api210_smb_share_policies_rules_patch_serialize(
        self,
        rule,
        ids,
        names,
    ...
    def api210_smb_share_policies_rules_post_with_http_info(
        ...
        _param = self._api210_smb_share_policies_rules_post_serialize(
            rule = rule,
            policy_ids = policy_ids,
            policy_names = policy_names,
        )
    ...
    def _api210_smb_share_policies_rules_post_serialize(
        self,
        rule,
        policy_ids,
        policy_names,
