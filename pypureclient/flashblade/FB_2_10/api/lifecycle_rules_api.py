...
class LifecycleRulesApi:
    ...
    def api210_lifecycle_rules_delete_with_http_info(
        ...
        _param = self._api210_lifecycle_rules_delete_serialize(
    ...
    def _api210_lifecycle_rules_delete_serialize(
        self,
        bucket_ids,
        bucket_names,
        ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.10/lifecycle-rules',
    ...
    def api210_lifecycle_rules_get_with_http_info(
        ...
        _param = self._api210_lifecycle_rules_get_serialize(
            bucket_ids = bucket_ids,
            bucket_names = bucket_names,
    ...
    def _api210_lifecycle_rules_get_serialize(
        self,
        bucket_ids,
        bucket_names,
        continuation_token,
    ...
    def api210_lifecycle_rules_patch_with_http_info(
        ...
        _param = self._api210_lifecycle_rules_patch_serialize(
            lifecycle = lifecycle,
            bucket_ids = bucket_ids,
            bucket_names = bucket_names,
            ids = ids,
    ...
    def _api210_lifecycle_rules_patch_serialize(
        self,
        lifecycle,
        bucket_ids,
        bucket_names,
    ...
    def api210_lifecycle_rules_post_with_http_info(
        ...
        _param = self._api210_lifecycle_rules_post_serialize(
            rule = rule,
            confirm_date = confirm_date,
        )
    ...
    def _api210_lifecycle_rules_post_serialize(
        self,
        rule,
        confirm_date,
    ) -> RequestSerialized:
