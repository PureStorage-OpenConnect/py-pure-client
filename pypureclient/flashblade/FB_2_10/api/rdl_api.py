...
from pypureclient.flashblade.FB_2_10.models.rapid_data_locking import RapidDataLocking
from pypureclient.flashblade.FB_2_10.models.rapid_data_locking_response import RapidDataLockingResponse
...
class RDLApi:
    ...
    def api210_rapid_data_locking_get_with_http_info(
        self,
        **kwargs
        ...
        >>> thread = api.api210_rapid_data_locking_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api210_rapid_data_locking_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.10/rapid-data-locking', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api210_rapid_data_locking_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api210_rapid_data_locking_patch_with_http_info(rapid_data_locking, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_rapid_data_locking_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.10/rapid-data-locking', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api210_rapid_data_locking_rotate_post_with_http_info(
        self,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.api210_rapid_data_locking_rotate_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_rapid_data_locking_rotate_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.10/rapid-data-locking/rotate', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api210_rapid_data_locking_test_get_with_http_info(
        self,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.api210_rapid_data_locking_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api210_rapid_data_locking_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.10/rapid-data-locking/test', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
