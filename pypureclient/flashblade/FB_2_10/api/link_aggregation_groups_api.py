...
class LinkAggregationGroupsApi:
    ...
    def api210_link_aggregation_groups_delete_with_http_info(
        ...
        _param = self._api210_link_aggregation_groups_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api210_link_aggregation_groups_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.10/link-aggregation-groups',
    ...
    def api210_link_aggregation_groups_get_with_http_info(
        ...
        _param = self._api210_link_aggregation_groups_get_serialize(
    ...
    def _api210_link_aggregation_groups_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api210_link_aggregation_groups_patch_with_http_info(
        ...
        _param = self._api210_link_aggregation_groups_patch_serialize(
    ...
    def _api210_link_aggregation_groups_patch_serialize(
        self,
    ...
    def api210_link_aggregation_groups_post_with_http_info(
        ...
        _param = self._api210_link_aggregation_groups_post_serialize(
            names = names,
            link_aggregation_group = link_aggregation_group,
        )
    ...
    def _api210_link_aggregation_groups_post_serialize(
        self,
        names,
        link_aggregation_group,
    ) -> RequestSerialized:
