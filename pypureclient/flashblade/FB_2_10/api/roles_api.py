...
from pypureclient.flashblade.FB_2_10.models.role_get_response import RoleGetResponse
...
class RolesApi:
    ...
    def api210_roles_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api210_roles_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api210_roles_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
