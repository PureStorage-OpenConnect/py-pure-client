...
class AlertsApi:
    ...
    def api210_alerts_get_with_http_info(
        ...
        _param = self._api210_alerts_get_serialize(
    ...
    def _api210_alerts_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api210_alerts_patch_with_http_info(
        ...
        _param = self._api210_alerts_patch_serialize(
    ...
    def _api210_alerts_patch_serialize(
        self,
        alerts_settings,
        ids,
        names,
