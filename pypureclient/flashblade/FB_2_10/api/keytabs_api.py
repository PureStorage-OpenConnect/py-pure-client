...
class KeytabsApi(object):
    ...
    def api210_keytabs_upload_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api210_keytabs_upload_post_with_http_info(async_req=True)
        >>> result = thread.get()

        :param str error_unknown: The keytab file to upload.
        :param str name_prefixes: The prefix to use for the names of all Kerberos keytab objects that are being created. 
        :param bool async_req: Request runs in separate thread and method returns multiprocessing.pool.ApplyResult.
        :param bool _return_http_data_only: Returns only data field.
        :param bool _preload_content: Response is converted into objects.
        ...
        if 'error_unknown' in params:
            form_params.append(('', params['error_unknown']))
