...
from pypureclient.flashblade.FB_2_10.models.file_system_snapshot_get_response import FileSystemSnapshotGetResponse
from pypureclient.flashblade.FB_2_10.models.file_system_snapshot_get_transfer_response import FileSystemSnapshotGetTransferResponse
from pypureclient.flashblade.FB_2_10.models.file_system_snapshot_post import FileSystemSnapshotPost
from pypureclient.flashblade.FB_2_10.models.file_system_snapshot_response import FileSystemSnapshotResponse
...
class FileSystemSnapshotsApi:
    ...
    @validate_call
    def api210_file_system_snapshots_delete_with_http_info(
        self,
        ...
        _param = self._api210_file_system_snapshots_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api210_file_system_snapshots_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.10/file-system-snapshots',
    ...
    @validate_call
    def api210_file_system_snapshots_get_with_http_info(
        self,
        ...
        _param = self._api210_file_system_snapshots_get_serialize(
    ...
    def _api210_file_system_snapshots_get_serialize(
        self,
        continuation_token,
        destroyed,
        filter,
    ...
    @validate_call
    def api210_file_system_snapshots_patch_with_http_info(
        self,
        ...
        _param = self._api210_file_system_snapshots_patch_serialize(
    ...
    def _api210_file_system_snapshots_patch_serialize(
        self,
    ...
    @validate_call
    def api210_file_system_snapshots_policies_delete_with_http_info(
        self,
        ...
        _param = self._api210_file_system_snapshots_policies_delete_serialize(
    ...
    def _api210_file_system_snapshots_policies_delete_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.10/file-system-snapshots/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api210_file_system_snapshots_policies_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Limit the size of the response to the specified number of resources. A `limit` of `0` can be used to get the number of resources without getting all of the resources. It will be returned in the `total_item_count` field. If a client asks for a page size larger than the available number, the request is still valid. In that case the server just returns the available number of items, disregarding the client's page size request.")] = None,
        ...
        _param = self._api210_file_system_snapshots_policies_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
            member_ids = member_ids,
    ...
    def _api210_file_system_snapshots_policies_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
    ...
    @validate_call
    def api210_file_system_snapshots_post_with_http_info(
        self,
        ...
        _param = self._api210_file_system_snapshots_post_serialize(
    ...
    def _api210_file_system_snapshots_post_serialize(
        self,
        source_ids,
        source_names,
        send,
    ...
    @validate_call
    def api210_file_system_snapshots_transfer_delete_with_http_info(
        self,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        ...
        _param = self._api210_file_system_snapshots_transfer_delete_serialize(
            ids = ids,
            names = names,
    ...
    def _api210_file_system_snapshots_transfer_delete_serialize(
        self,
        ids,
        names,
        remote_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.10/file-system-snapshots/transfer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api210_file_system_snapshots_transfer_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        _param = self._api210_file_system_snapshots_transfer_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api210_file_system_snapshots_transfer_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
