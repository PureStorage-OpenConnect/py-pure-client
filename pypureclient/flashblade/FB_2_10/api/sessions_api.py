...
from pypureclient.flashblade.FB_2_10.models.session_get_response import SessionGetResponse
...
class SessionsApi:
    ...
    def api210_sessions_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api210_sessions_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
