...
from pypureclient.flashblade.FB_2_10.models.file_system_replica_link_get_response import FileSystemReplicaLinkGetResponse
from pypureclient.flashblade.FB_2_10.models.file_system_replica_link_response import FileSystemReplicaLinkResponse
...
class FileSystemReplicaLinksApi:
    ...
    def api210_file_system_replica_links_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api210_file_system_replica_links_delete_with_http_info(cancel_in_progress_transfers, ids, local_file_system_ids, local_file_system_names, remote_file_system_ids, remote_file_system_names, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.10/file-system-replica-links', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api210_file_system_replica_links_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api210_file_system_replica_links_get_with_http_info(continuation_token, filter, ids, limit, local_file_system_ids, local_file_system_names, offset, remote_file_system_ids, remote_file_system_names, remote_ids, remote_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.10/file-system-replica-links', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api210_file_system_replica_links_policies_delete_with_http_info(
        self,
        local_file_system_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of local file system IDs. If after filtering, there is not at least one resource that matches each of the elements, then an error is returned. This cannot be provided together with the `local_file_system_names` query parameter.")] = None,
        local_file_system_names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of local file system names. If there is not at least one resource that matches each of the elements, then an error is returned. This cannot be provided together with `local_file_system_ids` query parameter.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api210_file_system_replica_links_policies_delete_with_http_info(local_file_system_ids, local_file_system_names, member_ids, policy_ids, policy_names, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.10/file-system-replica-links/policies', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api210_file_system_replica_links_policies_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        limit: Annotated[Optional[conint(strict=True, ge=0)], Field(description="Limit the size of the response to the specified number of resources. A `limit` of `0` can be used to get the number of resources without getting all of the resources. It will be returned in the `total_item_count` field. If a client asks for a page size larger than the available number, the request is still valid. In that case the server just returns the available number of items, disregarding the client's page size request.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api210_file_system_replica_links_policies_get_with_http_info(continuation_token, filter, limit, local_file_system_ids, local_file_system_names, member_ids, offset, policy_ids, policy_names, remote_file_system_ids, remote_file_system_names, remote_ids, remote_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.10/file-system-replica-links/policies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api210_file_system_replica_links_policies_post_with_http_info(
        self,
        local_file_system_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of local file system IDs. If after filtering, there is not at least one resource that matches each of the elements, then an error is returned. This cannot be provided together with the `local_file_system_names` query parameter.")] = None,
        local_file_system_names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of local file system names. If there is not at least one resource that matches each of the elements, then an error is returned. This cannot be provided together with `local_file_system_ids` query parameter.")] = None,
        member_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of member IDs. If after filtering, there is not at least one resource that matches each of the elements of `member_ids`, then an error is returned. This cannot be provided together with the `member_names` query parameter.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api210_file_system_replica_links_policies_post_with_http_info(local_file_system_ids, local_file_system_names, member_ids, policy_ids, policy_names, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.10/file-system-replica-links/policies', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api210_file_system_replica_links_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api210_file_system_replica_links_post_with_http_info(file_system_replica_link, ids, local_file_system_ids, local_file_system_names, remote_file_system_names, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.10/file-system-replica-links', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api210_file_system_replica_links_transfer_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api210_file_system_replica_links_transfer_get_with_http_info(continuation_token, filter, ids, limit, names_or_owner_names, offset, remote_ids, remote_names, sort, total_only, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.10/file-system-replica-links/transfer', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
