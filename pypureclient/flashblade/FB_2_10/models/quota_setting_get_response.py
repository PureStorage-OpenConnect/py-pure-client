...
class QuotaSettingGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(QuotaSetting)] = Field(default=None, description="A list of quota settings objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QuotaSettingGetResponse:
        """Create an instance of QuotaSettingGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> QuotaSettingGetResponse:
        """Create an instance of QuotaSettingGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QuotaSettingGetResponse.parse_obj(obj)

        _obj = QuotaSettingGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [QuotaSetting.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
