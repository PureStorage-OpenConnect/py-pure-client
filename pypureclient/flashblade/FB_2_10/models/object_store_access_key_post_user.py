...
class ObjectStoreAccessKeyPostUser(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreAccessKeyPostUser:
        """Create an instance of ObjectStoreAccessKeyPostUser from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreAccessKeyPostUser:
        """Create an instance of ObjectStoreAccessKeyPostUser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreAccessKeyPostUser.parse_obj(obj)

        _obj = ObjectStoreAccessKeyPostUser.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
