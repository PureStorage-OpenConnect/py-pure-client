...
from pypureclient.flashblade.FB_2_10.models.fixed_location_reference import FixedLocationReference
from pypureclient.flashblade.FB_2_10.models.http import Http
from pypureclient.flashblade.FB_2_10.models.multi_protocol import MultiProtocol
from pypureclient.flashblade.FB_2_10.models.nfs_patch import NfsPatch
from pypureclient.flashblade.FB_2_10.models.smb import Smb
...
class FileSystemPatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "created", "default_group_quota", "default_user_quota", "destroyed", "fast_remove_directory_enabled", "hard_limit_enabled", "http", "multi_protocol", "nfs", "provisioned", "promotion_status", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "time_remaining", "writable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "nfs": NfsPatch.from_dict(obj["nfs"]) if obj.get("nfs") is not None else None,
