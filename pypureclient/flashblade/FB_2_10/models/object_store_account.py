...
from pypureclient.flashblade.FB_2_10.models.bucket_defaults_readonly import BucketDefaultsReadonly
...
class ObjectStoreAccount(BaseModel):
    ...
    space: Optional[Dict[str, Any]] = Field(default=None, description="The space specification of the object store account.")
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "created", "object_count", "space", "bucket_defaults", "hard_limit_enabled", "quota_limit"]
