...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_0.models.object_store_virtual_host_get_response import ObjectStoreVirtualHostGetResponse
from pypureclient.flashblade.FB_2_0.models.object_store_virtual_host_response import ObjectStoreVirtualHostResponse
...
class ObjectStoreVirtualHostsApi:
    ...
    def api20_object_store_virtual_hosts_delete_with_http_info(
        ...
        _param = self._api20_object_store_virtual_hosts_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api20_object_store_virtual_hosts_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.0/object-store-virtual-hosts',
    ...
    def api20_object_store_virtual_hosts_get_with_http_info(
        ...
        _param = self._api20_object_store_virtual_hosts_get_serialize(
    ...
    def _api20_object_store_virtual_hosts_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api20_object_store_virtual_hosts_post_with_http_info(
        ...
        _param = self._api20_object_store_virtual_hosts_post_serialize(
            names = names,
        )
    ...
    def _api20_object_store_virtual_hosts_post_serialize(
        self,
        names,
    ) -> RequestSerialized:
