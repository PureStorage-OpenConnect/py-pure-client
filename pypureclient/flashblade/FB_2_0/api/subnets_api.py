...
class SubnetsApi(object):
    ...
    def api20_subnets_delete_with_http_info(
        self,
        ...
        >>> thread = api.api20_subnets_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api20_subnets_get_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_subnets_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_subnets_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api20_subnets_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api20_subnets_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_subnets_patch_with_http_info(subnet, async_req=True)
        >>> result = thread.get()
        ...
        if subnet is None:
            raise TypeError("Missing the required parameter `subnet` when calling `api20_subnets_patch`")
    ...
    def api20_subnets_post_with_http_info(
        self,
        subnet=None,  # type: models.Subnet
        names=None,  # type: List[str]
        async_req=False,  # type: bool
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_subnets_post_with_http_info(subnet, names, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'subnet' is set
        if subnet is None:
            raise TypeError("Missing the required parameter `subnet` when calling `api20_subnets_post`")
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api20_subnets_post`")
