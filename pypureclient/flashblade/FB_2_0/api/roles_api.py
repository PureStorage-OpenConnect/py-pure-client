...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_0.models.role_get_response import RoleGetResponse
...
class RolesApi:
    ...
    def api20_roles_get_with_http_info(
        ...
        _param = self._api20_roles_get_serialize(
    ...
    def _api20_roles_get_serialize(
        self,
        continuation_token,
        ids,
        filter,
