...
class BucketReplicaLinksApi(object):
    ...
    def api20_bucket_replica_links_delete_with_http_info(
        self,
        ...
        >>> thread = api.api20_bucket_replica_links_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.0/bucket-replica-links', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api20_bucket_replica_links_get_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_bucket_replica_links_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_bucket_replica_links_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api20_bucket_replica_links_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.0/bucket-replica-links', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api20_bucket_replica_links_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_bucket_replica_links_patch_with_http_info(bucket_replica_link, async_req=True)
        >>> result = thread.get()
        ...
        if bucket_replica_link is None:
            raise TypeError("Missing the required parameter `bucket_replica_link` when calling `api20_bucket_replica_links_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.0/bucket-replica-links', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api20_bucket_replica_links_post_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_bucket_replica_links_post_with_http_info(bucket_replica_link, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'bucket_replica_link' is set
        if bucket_replica_link is None:
            raise TypeError("Missing the required parameter `bucket_replica_link` when calling `api20_bucket_replica_links_post`")
        ...
        return self.api_client.call_api(
            '/api/2.0/bucket-replica-links', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
