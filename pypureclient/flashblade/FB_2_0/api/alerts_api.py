...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_0.models.alert import Alert
from pypureclient.flashblade.FB_2_0.models.alert_get_response import AlertGetResponse
from pypureclient.flashblade.FB_2_0.models.alert_response import AlertResponse
...
class AlertsApi:
    ...
    def api20_alerts_get_with_http_info(
        ...
        _param = self._api20_alerts_get_serialize(
    ...
    def _api20_alerts_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api20_alerts_patch_with_http_info(
        ...
        _param = self._api20_alerts_patch_serialize(
    ...
    def _api20_alerts_patch_serialize(
        self,
        alerts_settings,
        ids,
        names,
