...
class QuotasApi(object):
    ...
    def api20_quotas_groups_delete_with_http_info(
        ...
        >>> thread = api.api20_quotas_groups_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api20_quotas_groups_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_quotas_groups_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_quotas_groups_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api20_quotas_groups_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api20_quotas_groups_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_quotas_groups_patch_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api20_quotas_groups_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_quotas_groups_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api20_quotas_settings_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_quotas_settings_get_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api20_quotas_settings_patch_with_http_info(
        ...
        if quota_setting is None:
            raise TypeError("Missing the required parameter `quota_setting` when calling `api20_quotas_settings_patch`")
    ...
    def api20_quotas_users_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_quotas_users_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api20_quotas_users_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_quotas_users_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_quotas_users_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api20_quotas_users_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api20_quotas_users_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_quotas_users_patch_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api20_quotas_users_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_quotas_users_post_with_http_info(async_req=True)
        >>> result = thread.get()
