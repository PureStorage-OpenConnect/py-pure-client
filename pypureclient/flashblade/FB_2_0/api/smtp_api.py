...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_0.models.smtp_server import SmtpServer
from pypureclient.flashblade.FB_2_0.models.smtp_server_get_response import SmtpServerGetResponse
from pypureclient.flashblade.FB_2_0.models.smtp_server_response import SmtpServerResponse
...
class SMTPApi:
    ...
    def api20_smtp_servers_get_with_http_info(
        ...
        _param = self._api20_smtp_servers_get_serialize(
    ...
    def _api20_smtp_servers_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/smtp-servers',
    ...
    def api20_smtp_servers_patch_with_http_info(
        ...
        _param = self._api20_smtp_servers_patch_serialize(
            smtp = smtp,
        )
    ...
    def _api20_smtp_servers_patch_serialize(
        self,
        smtp,
    ) -> RequestSerialized:
