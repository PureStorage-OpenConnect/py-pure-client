...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_0.models.resource_performance_replication_get_response import ResourcePerformanceReplicationGetResponse
from pypureclient.flashblade.FB_2_0.models.target import Target
from pypureclient.flashblade.FB_2_0.models.target_get_response import TargetGetResponse
from pypureclient.flashblade.FB_2_0.models.target_post import TargetPost
from pypureclient.flashblade.FB_2_0.models.target_response import TargetResponse
...
class TargetsApi:
    ...
    def api20_targets_delete_with_http_info(
        ...
        _param = self._api20_targets_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api20_targets_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
    ...
    def api20_targets_get_with_http_info(
        ...
        _param = self._api20_targets_get_serialize(
    ...
    def _api20_targets_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api20_targets_patch_with_http_info(
        ...
        _param = self._api20_targets_patch_serialize(
            target = target,
            ids = ids,
            names = names,
        )
    ...
    def _api20_targets_patch_serialize(
        self,
        target,
        ids,
        names,
    ...
    def api20_targets_performance_replication_get_with_http_info(
        ...
        _param = self._api20_targets_performance_replication_get_serialize(
            continuation_token = continuation_token,
            end_time = end_time,
            filter = filter,
            ids = ids,
    ...
    def _api20_targets_performance_replication_get_serialize(
        self,
        continuation_token,
        end_time,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/targets/performance/replication',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api20_targets_post_with_http_info(
        ...
        _param = self._api20_targets_post_serialize(
            names = names,
            target = target,
        )
    ...
    def _api20_targets_post_serialize(
        self,
        names,
        target,
    ) -> RequestSerialized:
