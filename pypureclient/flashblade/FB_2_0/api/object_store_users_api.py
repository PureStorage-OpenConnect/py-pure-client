...
class ObjectStoreUsersApi(object):
    ...
    def api20_object_store_users_delete_with_http_info(
        self,
        ...
        >>> thread = api.api20_object_store_users_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.0/object-store-users', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api20_object_store_users_get_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_object_store_users_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_object_store_users_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api20_object_store_users_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.0/object-store-users', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api20_object_store_users_object_store_access_policies_delete_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_object_store_users_object_store_access_policies_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.0/object-store-users/object-store-access-policies', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api20_object_store_users_object_store_access_policies_get_with_http_info(
        self,
        continuation_token=None,  # type: str
        filter=None,  # type: str
        limit=None,  # type: int
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_object_store_users_object_store_access_policies_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_object_store_users_object_store_access_policies_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api20_object_store_users_object_store_access_policies_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.0/object-store-users/object-store-access-policies', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api20_object_store_users_object_store_access_policies_post_with_http_info(
        self,
        member_ids=None,  # type: List[str]
        member_names=None,  # type: List[str]
        policy_ids=None,  # type: List[str]
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_object_store_users_object_store_access_policies_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.0/object-store-users/object-store-access-policies', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api20_object_store_users_post_with_http_info(
        self,
        names=None,  # type: List[str]
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_object_store_users_post_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api20_object_store_users_post`")
        ...
        return self.api_client.call_api(
            '/api/2.0/object-store-users', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
