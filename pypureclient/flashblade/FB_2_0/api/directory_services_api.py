...
class DirectoryServicesApi(object):
    ...
    def api20_directory_services_get_with_http_info(
        ...
        >>> thread = api.api20_directory_services_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_directory_services_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api20_directory_services_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api20_directory_services_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_directory_services_patch_with_http_info(directory_service, async_req=True)
        >>> result = thread.get()
        ...
        if directory_service is None:
            raise TypeError("Missing the required parameter `directory_service` when calling `api20_directory_services_patch`")
    ...
    def api20_directory_services_roles_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_directory_services_roles_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_directory_services_roles_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api20_directory_services_roles_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api20_directory_services_roles_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_directory_services_roles_patch_with_http_info(directory_service_roles, async_req=True)
        >>> result = thread.get()
        ...
        if directory_service_roles is None:
            raise TypeError("Missing the required parameter `directory_service_roles` when calling `api20_directory_services_roles_patch`")
    ...
    def api20_directory_services_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_directory_services_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_directory_services_test_get`, must be a value greater than or equal to `1`")
        collection_formats = {}
        path_params = {}
    ...
    def api20_directory_services_test_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_directory_services_test_patch_with_http_info(async_req=True)
        >>> result = thread.get()
