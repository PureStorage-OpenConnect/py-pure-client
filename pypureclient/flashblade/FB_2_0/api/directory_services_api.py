...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_0.models.directory_service import DirectoryService
from pypureclient.flashblade.FB_2_0.models.directory_service_get_response import DirectoryServiceGetResponse
from pypureclient.flashblade.FB_2_0.models.directory_service_response import DirectoryServiceResponse
from pypureclient.flashblade.FB_2_0.models.directory_service_role import DirectoryServiceRole
from pypureclient.flashblade.FB_2_0.models.directory_service_roles_get_response import DirectoryServiceRolesGetResponse
from pypureclient.flashblade.FB_2_0.models.directory_service_roles_response import DirectoryServiceRolesResponse
from pypureclient.flashblade.FB_2_0.models.test_result_get_response import TestResultGetResponse
from pypureclient.flashblade.FB_2_0.models.test_result_response import TestResultResponse
...
class DirectoryServicesApi:
    ...
    @validate_call
    def api20_directory_services_get_with_http_info(
        self,
        ...
        _param = self._api20_directory_services_get_serialize(
    ...
    def _api20_directory_services_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/directory-services',
    ...
    @validate_call
    def api20_directory_services_patch_with_http_info(
        self,
        ...
        _param = self._api20_directory_services_patch_serialize(
    ...
    def _api20_directory_services_patch_serialize(
        self,
        directory_service,
        ids,
        names,
    ...
    @validate_call
    def api20_directory_services_roles_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        ...
        _param = self._api20_directory_services_roles_get_serialize(
            continuation_token = continuation_token,
            ids = ids,
            filter = filter,
            limit = limit,
    ...
    def _api20_directory_services_roles_get_serialize(
        self,
        continuation_token,
        ids,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/directory-services/roles',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api20_directory_services_roles_patch_with_http_info(
        self,
        ...
        _param = self._api20_directory_services_roles_patch_serialize(
    ...
    def _api20_directory_services_roles_patch_serialize(
        self,
    ...
    @validate_call
    def api20_directory_services_test_get_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Limit the size of the response to the specified number of resources. A `limit` of `0` can be used to get the number of resources without getting all of the resources. It will be returned in the `total_item_count` field. If a client asks for a page size larger than the available number, the request is still valid. In that case the server just returns the available number of items, disregarding the client's page size request.")] = None,
        ...
        _param = self._api20_directory_services_test_get_serialize(
            filter = filter,
            ids = ids,
            limit = limit,
            names = names,
    ...
    def _api20_directory_services_test_get_serialize(
        self,
        filter,
        ids,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/directory-services/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api20_directory_services_test_patch_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        ...
        _param = self._api20_directory_services_test_patch_serialize(
            filter = filter,
            ids = ids,
            names = names,
            sort = sort,
    ...
    def _api20_directory_services_test_patch_serialize(
        self,
        filter,
        ids,
        names,
