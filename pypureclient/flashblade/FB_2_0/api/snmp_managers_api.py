...
class SNMPManagersApi(object):
    ...
    def api20_snmp_managers_delete_with_http_info(
        self,
        ...
        >>> thread = api.api20_snmp_managers_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api20_snmp_managers_get_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_snmp_managers_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_snmp_managers_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api20_snmp_managers_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api20_snmp_managers_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_snmp_managers_patch_with_http_info(snmp_manager, async_req=True)
        >>> result = thread.get()

        :param SnmpManager snmp_manager: (required)
        :param list[str] ids: A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.
        :param list[str] names: A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.
        :param bool async_req: Request runs in separate thread and method returns multiprocessing.pool.ApplyResult.
        :param bool _return_http_data_only: Returns only data field.
        ...
        if snmp_manager is None:
            raise TypeError("Missing the required parameter `snmp_manager` when calling `api20_snmp_managers_patch`")
    ...
    def api20_snmp_managers_post_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_snmp_managers_post_with_http_info(snmp_manager, names, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'snmp_manager' is set
        if snmp_manager is None:
            raise TypeError("Missing the required parameter `snmp_manager` when calling `api20_snmp_managers_post`")
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api20_snmp_managers_post`")
    ...
    def api20_snmp_managers_test_get_with_http_info(
        self,
        continuation_token=None,  # type: str
        ids=None,  # type: List[str]
        filter=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_snmp_managers_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_snmp_managers_test_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api20_snmp_managers_test_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.0/snmp-managers/test', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
