...
class SNMPManagersApi(object):
    ...
    def api20_snmp_managers_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_snmp_managers_get`, must be a value greater than or equal to `0`")
    ...
    def api20_snmp_managers_test_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_snmp_managers_test_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
