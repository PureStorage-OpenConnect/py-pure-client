...
from pypureclient.flashblade.FB_2_0.models.alert_watcher import AlertWatcher
from pypureclient.flashblade.FB_2_0.models.alert_watcher_get_response import AlertWatcherGetResponse
from pypureclient.flashblade.FB_2_0.models.alert_watcher_post import AlertWatcherPost
from pypureclient.flashblade.FB_2_0.models.alert_watcher_response import AlertWatcherResponse
...
class AlertWatchersApi:
    ...
    def api20_alert_watchers_delete_with_http_info(
        self,
    ...
    def api20_alert_watchers_get_with_http_info(
        self,
    ...
    def api20_alert_watchers_patch_with_http_info(
        self,
    ...
    def api20_alert_watchers_post_with_http_info(
        self,
    ...
    def api20_alert_watchers_test_get_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.0/alert-watchers/test', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
