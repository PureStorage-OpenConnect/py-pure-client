...
from pypureclient.flashblade.FB_2_0.models.dns_get_response import DnsGetResponse
from pypureclient.flashblade.FB_2_0.models.dns_response import DnsResponse
...
class DNSApi:
    ...
    def api20_dns_get_with_http_info(
        ...
        _param = self._api20_dns_get_serialize(
    ...
    def api20_dns_patch_with_http_info(
        ...
        _param = self._api20_dns_patch_serialize(
            dns = dns,
            ids = ids,
            names = names,
        )
    ...
    def _api20_dns_patch_serialize(
        self,
        dns,
        ids,
        names,
