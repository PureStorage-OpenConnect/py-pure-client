...
class HardwareApi(object):
    ...
    def api20_hardware_get_with_http_info(
        self,
        ...
        >>> thread = api.api20_hardware_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_hardware_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api20_hardware_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api20_hardware_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api20_hardware_patch_with_http_info(hardware, async_req=True)
        >>> result = thread.get()
        ...
        if hardware is None:
            raise TypeError("Missing the required parameter `hardware` when calling `api20_hardware_patch`")
