...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_0.models.file_system_get_response import FileSystemGetResponse
from pypureclient.flashblade.FB_2_0.models.file_system_groups_performance_get_response import FileSystemGroupsPerformanceGetResponse
from pypureclient.flashblade.FB_2_0.models.file_system_patch import FileSystemPatch
from pypureclient.flashblade.FB_2_0.models.file_system_performance_get_response import FileSystemPerformanceGetResponse
from pypureclient.flashblade.FB_2_0.models.file_system_post import FileSystemPost
from pypureclient.flashblade.FB_2_0.models.file_system_response import FileSystemResponse
...
class FileSystemsApi:
    ...
    def api20_file_systems_delete_with_http_info(
        ...
        _param = self._api20_file_systems_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api20_file_systems_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.0/file-systems',
    ...
    def api20_file_systems_get_with_http_info(
        ...
        _param = self._api20_file_systems_get_serialize(
    ...
    def _api20_file_systems_get_serialize(
        self,
        continuation_token,
        destroyed,
        filter,
    ...
    def api20_file_systems_groups_performance_get_with_http_info(
        ...
        _param = self._api20_file_systems_groups_performance_get_serialize(
    ...
    def _api20_file_systems_groups_performance_get_serialize(
        self,
        file_system_ids,
        file_system_names,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/file-systems/groups/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api20_file_systems_patch_with_http_info(
        ...
        _param = self._api20_file_systems_patch_serialize(
    ...
    def _api20_file_systems_patch_serialize(
        self,
        file_system,
    ...
    def api20_file_systems_performance_get_with_http_info(
        ...
        _param = self._api20_file_systems_performance_get_serialize(
            continuation_token = continuation_token,
            end_time = end_time,
            filter = filter,
            ids = ids,
    ...
    def _api20_file_systems_performance_get_serialize(
        self,
        continuation_token,
        end_time,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/file-systems/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api20_file_systems_policies_delete_with_http_info(
        ...
        _param = self._api20_file_systems_policies_delete_serialize(
    ...
    def _api20_file_systems_policies_delete_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.0/file-systems/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api20_file_systems_policies_get_with_http_info(
        ...
        _param = self._api20_file_systems_policies_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
            member_ids = member_ids,
    ...
    def _api20_file_systems_policies_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
    ...
    def api20_file_systems_policies_post_with_http_info(
        ...
        _param = self._api20_file_systems_policies_post_serialize(
            member_ids = member_ids,
            member_names = member_names,
            policy_ids = policy_ids,
            policy_names = policy_names,
    ...
    def _api20_file_systems_policies_post_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
    ...
    def api20_file_systems_post_with_http_info(
        ...
        _param = self._api20_file_systems_post_serialize(
            names = names,
            file_system = file_system,
            discard_non_snapshotted_data = discard_non_snapshotted_data,
            overwrite = overwrite,
    ...
    def _api20_file_systems_post_serialize(
        self,
        names,
        file_system,
        discard_non_snapshotted_data,
    ...
    def api20_file_systems_users_performance_get_with_http_info(
        ...
        _param = self._api20_file_systems_users_performance_get_serialize(
            file_system_ids = file_system_ids,
            file_system_names = file_system_names,
            filter = filter,
            limit = limit,
    ...
    def _api20_file_systems_users_performance_get_serialize(
        self,
        file_system_ids,
        file_system_names,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/file-systems/users/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
