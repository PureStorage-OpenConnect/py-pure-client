...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_0.models.blade_get_response import BladeGetResponse
...
class BladesApi:
    ...
    def api20_blades_get_with_http_info(
        ...
        _param = self._api20_blades_get_serialize(
    ...
    def _api20_blades_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
