...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_0.models.support import Support
from pypureclient.flashblade.FB_2_0.models.support_get_response import SupportGetResponse
from pypureclient.flashblade.FB_2_0.models.support_response import SupportResponse
...
class SupportApi:
    ...
    @validate_call
    def api20_support_get_with_http_info(
        self,
        ...
        _param = self._api20_support_get_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api20_support_get_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
    ...
    @validate_call
    def api20_support_patch_with_http_info(
        self,
        support: Support,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
        ...
        _param = self._api20_support_patch_serialize(
            support = support,
        )
    ...
    def _api20_support_patch_serialize(
        self,
        support,
    ) -> RequestSerialized:
    ...
    @validate_call
    def api20_support_test_get_with_http_info(
        self,
        ...
        _param = self._api20_support_test_get_serialize(
            filter = filter,
            sort = sort,
            test_type = test_type,
        )
    ...
    def _api20_support_test_get_serialize(
        self,
        filter,
        sort,
        test_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/support/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
