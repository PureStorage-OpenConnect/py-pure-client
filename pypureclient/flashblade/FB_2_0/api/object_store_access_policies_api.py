...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_0.models.object_store_access_policies_get_response import ObjectStoreAccessPoliciesGetResponse
...
class ObjectStoreAccessPoliciesApi:
    ...
    def api20_object_store_access_policies_get_with_http_info(
        ...
        _param = self._api20_object_store_access_policies_get_serialize(
    ...
    def _api20_object_store_access_policies_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.0/object-store-access-policies',
    ...
    def api20_object_store_access_policies_object_store_users_delete_with_http_info(
        ...
        _param = self._api20_object_store_access_policies_object_store_users_delete_serialize(
    ...
    def _api20_object_store_access_policies_object_store_users_delete_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.0/object-store-access-policies/object-store-users',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api20_object_store_access_policies_object_store_users_get_with_http_info(
        ...
        _param = self._api20_object_store_access_policies_object_store_users_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
            member_ids = member_ids,
    ...
    def _api20_object_store_access_policies_object_store_users_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
    ...
    def api20_object_store_access_policies_object_store_users_post_with_http_info(
        ...
        _param = self._api20_object_store_access_policies_object_store_users_post_serialize(
            member_ids = member_ids,
            member_names = member_names,
            policy_ids = policy_ids,
            policy_names = policy_names,
    ...
    def _api20_object_store_access_policies_object_store_users_post_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
