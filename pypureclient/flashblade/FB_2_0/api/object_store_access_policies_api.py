...
class ObjectStoreAccessPoliciesApi(object):
    ...
    def api20_object_store_access_policies_get_with_http_info(
        self,
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_object_store_access_policies_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api20_object_store_access_policies_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.0/object-store-access-policies', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api20_object_store_access_policies_object_store_users_delete_with_http_info(
        self,
        ...
        return self.api_client.call_api(
            '/api/2.0/object-store-access-policies/object-store-users', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api20_object_store_access_policies_object_store_users_get_with_http_info(
        self,
        continuation_token=None,  # type: str
        filter=None,  # type: str
        limit=None,  # type: int
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api20_object_store_access_policies_object_store_users_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api20_object_store_access_policies_object_store_users_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.0/object-store-access-policies/object-store-users', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api20_object_store_access_policies_object_store_users_post_with_http_info(
        self,
        member_ids=None,  # type: List[str]
        member_names=None,  # type: List[str]
        policy_ids=None,  # type: List[str]
        ...
        return self.api_client.call_api(
            '/api/2.0/object-store-access-policies/object-store-users', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
