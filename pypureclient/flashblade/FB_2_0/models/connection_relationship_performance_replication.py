...
from pypureclient.flashblade.FB_2_0.models.replication_performance import ReplicationPerformance
...
class ConnectionRelationshipPerformanceReplication(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "periodic", "remote", "time"]
