...
class ObjectStoreAccountGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[ObjectStoreAccount]',
        'total': 'ObjectStoreAccount'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.ObjectStoreAccount]
        total=None,  # type: models.ObjectStoreAccount
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ObjectStoreAccountGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ObjectStoreAccountGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectStoreAccountGetResponse):
            return False
