...
from pypureclient.flashblade.FB_2_22.models.support_diagnostics_details_get_response import SupportDiagnosticsDetailsGetResponse
from pypureclient.flashblade.FB_2_22.models.support_diagnostics_get_response import SupportDiagnosticsGetResponse
from typing import Optional
...
class SupportDiagnosticsApi:
    ...
    def api222_support_diagnostics_details_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api222_support_diagnostics_details_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.22/support-diagnostics/details', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api222_support_diagnostics_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="A token used to retrieve the next page of data with some consistency guaranteed. The token is a Base64 encoded value. Set `continuation_token` to the system-generated token taken from the `x-next-token` header field of the response. A query has reached its last page when the response does not include a token. Pagination requires the `limit` and `continuation_token` query parameters.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Narrows down the results to only the response objects that satisfy the filter criteria.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_support_diagnostics_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.22/support-diagnostics', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api222_support_diagnostics_post_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_support_diagnostics_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.22/support-diagnostics', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
