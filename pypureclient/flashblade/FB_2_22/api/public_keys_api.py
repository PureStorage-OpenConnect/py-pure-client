...
from pypureclient.flashblade.FB_2_22.models.public_key_get_response import PublicKeyGetResponse
from pypureclient.flashblade.FB_2_22.models.public_key_post import PublicKeyPost
from pypureclient.flashblade.FB_2_22.models.public_key_response import PublicKeyResponse
from pypureclient.flashblade.FB_2_22.models.public_key_use_get_response import PublicKeyUseGetResponse
from typing import Optional
...
class PublicKeysApi:
    ...
    def api222_public_keys_delete_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api222_public_keys_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_public_keys_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_public_keys_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_public_keys_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_public_keys_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api222_public_keys_uses_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="A token used to retrieve the next page of data with some consistency guaranteed. The token is a Base64 encoded value. Set `continuation_token` to the system-generated token taken from the `x-next-token` header field of the response. A query has reached its last page when the response does not include a token. Pagination requires the `limit` and `continuation_token` query parameters.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Narrows down the results to only the response objects that satisfy the filter criteria.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_public_keys_uses_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
