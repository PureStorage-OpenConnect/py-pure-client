...
from pypureclient.flashblade.FB_2_22.models.smb_share_policy_get_response import SmbSharePolicyGetResponse
from pypureclient.flashblade.FB_2_22.models.smb_share_policy_patch import SmbSharePolicyPatch
from pypureclient.flashblade.FB_2_22.models.smb_share_policy_post import SmbSharePolicyPost
from pypureclient.flashblade.FB_2_22.models.smb_share_policy_response import SmbSharePolicyResponse
from pypureclient.flashblade.FB_2_22.models.smb_share_policy_rule import SmbSharePolicyRule
from pypureclient.flashblade.FB_2_22.models.smb_share_policy_rule_get_response import SmbSharePolicyRuleGetResponse
from pypureclient.flashblade.FB_2_22.models.smb_share_policy_rule_post import SmbSharePolicyRulePost
from pypureclient.flashblade.FB_2_22.models.smb_share_policy_rule_response import SmbSharePolicyRuleResponse
from typing import Optional
...
class PoliciesSMBShareApi:
    ...
    def api222_smb_share_policies_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.22/smb-share-policies', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api222_smb_share_policies_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.22/smb-share-policies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api222_smb_share_policies_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.22/smb-share-policies', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api222_smb_share_policies_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.22/smb-share-policies', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api222_smb_share_policies_rules_delete_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.22/smb-share-policies/rules', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api222_smb_share_policies_rules_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        allow_errors: Annotated[Optional[StrictBool], Field(description="If set to `true`, the API will allow the operation to continue even if there are errors. Any errors will be returned in the `errors` field of the response. If set to `false`, the operation will fail if there are any errors.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique contexts specified. If specified, each context name must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`. Enter multiple names in comma-separated format. For example, `name01,name02`.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.22/smb-share-policies/rules', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api222_smb_share_policies_rules_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.22/smb-share-policies/rules', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api222_smb_share_policies_rules_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            '/api/2.22/smb-share-policies/rules', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
