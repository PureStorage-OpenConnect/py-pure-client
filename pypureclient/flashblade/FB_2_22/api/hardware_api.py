...
from pypureclient.flashblade.FB_2_22.models.hardware_get_response import HardwareGetResponse
from pypureclient.flashblade.FB_2_22.models.hardware_response import HardwareResponse
from typing import Optional
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api222_hardware_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_hardware_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
