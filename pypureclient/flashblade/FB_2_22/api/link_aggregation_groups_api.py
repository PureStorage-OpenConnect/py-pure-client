...
from pypureclient.flashblade.FB_2_22.models.link_aggregation_group import LinkAggregationGroup
from pypureclient.flashblade.FB_2_22.models.link_aggregation_group_get_response import LinkAggregationGroupGetResponse
from pypureclient.flashblade.FB_2_22.models.link_aggregation_group_patch import LinkAggregationGroupPatch
from pypureclient.flashblade.FB_2_22.models.link_aggregation_group_response import LinkAggregationGroupResponse
from typing import Optional
...
class LinkAggregationGroupsApi:
    ...
    def api222_link_aggregation_groups_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api222_link_aggregation_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.22/link-aggregation-groups', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api222_link_aggregation_groups_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_link_aggregation_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.22/link-aggregation-groups', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api222_link_aggregation_groups_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_link_aggregation_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.22/link-aggregation-groups', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api222_link_aggregation_groups_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_link_aggregation_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.22/link-aggregation-groups', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
