...
from pypureclient.flashblade.FB_2_22.models.alert import Alert
from pypureclient.flashblade.FB_2_22.models.alert_get_response import AlertGetResponse
from pypureclient.flashblade.FB_2_22.models.alert_response import AlertResponse
from typing import Optional
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api222_alerts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_alerts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
