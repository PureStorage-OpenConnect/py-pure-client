...
from pypureclient.flashblade.FB_2_22.models.server_get_response import ServerGetResponse
from pypureclient.flashblade.FB_2_22.models.server_post import ServerPost
from pypureclient.flashblade.FB_2_22.models.server_response import ServerResponse
from typing import Optional
...
class ServersApi:
    ...
    def api222_servers_delete_with_http_info(
        self,
    ...
    def api222_servers_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
    ...
    def api222_servers_patch_with_http_info(
        self,
        server: ServerPost,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
    ...
    def api222_servers_post_with_http_info(
        self,
