...
from pypureclient.flashblade.FB_2_22.models.cross_origin_resource_sharing_policy_rule_with_context import CrossOriginResourceSharingPolicyRuleWithContext
...
class CrossOriginResourceSharingPolicy(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "context", "bucket", "rules"]
