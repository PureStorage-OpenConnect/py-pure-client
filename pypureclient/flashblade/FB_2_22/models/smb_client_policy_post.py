...
from pypureclient.flashblade.FB_2_22.models.smb_client_policy_rule_post_in_policy import SmbClientPolicyRulePostInPolicy
...
class SmbClientPolicyPost(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "access_based_enumeration_enabled", "rules"]
