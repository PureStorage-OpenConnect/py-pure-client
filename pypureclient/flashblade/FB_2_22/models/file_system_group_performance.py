...
from pypureclient.flashblade.FB_2_22.models.group import Group
...
class FileSystemGroupPerformance(BaseModel):
    ...
    __properties = ["name", "bytes_per_op", "bytes_per_read", "bytes_per_write", "file_system", "group", "others_per_sec", "read_bytes_per_sec", "reads_per_sec", "time", "usec_per_other_op", "usec_per_read_op", "usec_per_write_op", "write_bytes_per_sec", "writes_per_sec"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemGroupPerformance:
        """Create an instance of FileSystemGroupPerformance from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemGroupPerformance:
        """Create an instance of FileSystemGroupPerformance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemGroupPerformance.parse_obj(obj)

        _obj = FileSystemGroupPerformance.construct(_fields_set=None, **{
            "name": obj.get("name"),
