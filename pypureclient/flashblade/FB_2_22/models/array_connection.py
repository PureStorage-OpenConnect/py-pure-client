...
from pypureclient.flashblade.FB_2_22.models.throttle import Throttle
...
class ArrayConnection(BaseModel):
    ...
    __properties = ["id", "context", "ca_certificate_group", "encrypted", "management_address", "os", "remote", "replication_addresses", "status", "throttle", "type", "version"]
