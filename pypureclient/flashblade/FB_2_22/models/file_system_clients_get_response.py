...
from pypureclient.flashblade.FB_2_22.models.file_system_client import FileSystemClient


class FileSystemClientsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(FileSystemClient)] = Field(default=None, description="A list of file system clients.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemClientsGetResponse:
        """Create an instance of FileSystemClientsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemClientsGetResponse:
        """Create an instance of FileSystemClientsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemClientsGetResponse.parse_obj(obj)

        _obj = FileSystemClientsGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [FileSystemClient.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
