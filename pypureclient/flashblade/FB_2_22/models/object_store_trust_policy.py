...
from pypureclient.flashblade.FB_2_22.models.trust_policy_rule import TrustPolicyRule
...
class ObjectStoreTrustPolicy(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "context", "role", "rules"]
