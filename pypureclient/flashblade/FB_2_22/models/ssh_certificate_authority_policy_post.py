...
from pypureclient.flashblade.FB_2_22.models.fixed_reference import FixedReference
from pypureclient.flashblade.FB_2_22.models.reference_writable import ReferenceWritable
...
class SshCertificateAuthorityPolicyPost(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "signing_authority", "static_authorized_principals"]
