...
from pypureclient.flashblade.FB_2_22.models.s3_export_policy_all_of_rules import S3ExportPolicyAllOfRules
...
class S3ExportPolicy(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "context", "rules"]
