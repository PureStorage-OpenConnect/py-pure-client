...
from pypureclient.flashblade.FB_2_22.models.audit_file_systems_policy_rule_in_policy import AuditFileSystemsPolicyRuleInPolicy
...
class AuditFileSystemsPolicyPatchBase(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "log_targets", "rules"]
