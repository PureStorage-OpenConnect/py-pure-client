...
class PolicyMemberContext(BaseModel):
    """
    PolicyMemberContext
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyMemberContext:
        """Create an instance of PolicyMemberContext from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyMemberContext:
        """Create an instance of PolicyMemberContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyMemberContext.parse_obj(obj)

        _obj = PolicyMemberContext.construct(_fields_set=None, **{
