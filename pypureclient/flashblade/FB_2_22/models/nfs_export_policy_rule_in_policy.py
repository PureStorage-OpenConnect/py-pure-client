...
class NfsExportPolicyRuleInPolicy(BaseModel):
    ...
    __properties = ["id", "name", "access", "anongid", "anonuid", "atime", "client", "fileid_32bit", "permission", "policy", "policy_version", "required_transport_security", "secure", "security", "index"]
