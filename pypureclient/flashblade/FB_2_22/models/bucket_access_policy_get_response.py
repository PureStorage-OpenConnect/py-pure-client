...
from pypureclient.flashblade.FB_2_22.models.bucket_access_policy import BucketAccessPolicy
from pypureclient.flashblade.FB_2_22.models.error_context_response_errors import ErrorContextResponseErrors


class BucketAccessPolicyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(BucketAccessPolicy)] = Field(default=None, description="A list of bucket policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BucketAccessPolicyGetResponse:
        """Create an instance of BucketAccessPolicyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> BucketAccessPolicyGetResponse:
        """Create an instance of BucketAccessPolicyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BucketAccessPolicyGetResponse.parse_obj(obj)

        _obj = BucketAccessPolicyGetResponse.construct(_fields_set=None, **{
            ...
            "items": [BucketAccessPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
