...
class StorageClassSpace(BaseModel):
    """
    StorageClassSpace
    """
    ...
    __properties = ["name", "capacity", "space", "time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StorageClassSpace:
        """Create an instance of StorageClassSpace from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> StorageClassSpace:
        """Create an instance of StorageClassSpace from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StorageClassSpace.parse_obj(obj)

        _obj = StorageClassSpace.construct(_fields_set=None, **{
            "name": obj.get("name"),
