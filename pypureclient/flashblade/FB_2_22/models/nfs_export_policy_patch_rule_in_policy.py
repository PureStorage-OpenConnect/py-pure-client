...
class NfsExportPolicyPatchRuleInPolicy(BaseModel):
    """
    NfsExportPolicyPatchRuleInPolicy
    """
    ...
    __properties = ["id", "name", "access", "anongid", "anonuid", "atime", "client", "fileid_32bit", "permission", "required_transport_security", "secure", "security", "index"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NfsExportPolicyPatchRuleInPolicy:
        """Create an instance of NfsExportPolicyPatchRuleInPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NfsExportPolicyPatchRuleInPolicy:
        """Create an instance of NfsExportPolicyPatchRuleInPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NfsExportPolicyPatchRuleInPolicy.parse_obj(obj)

        _obj = NfsExportPolicyPatchRuleInPolicy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
