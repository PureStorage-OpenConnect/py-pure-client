...
class AuditObjectStorePolicy(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditObjectStorePolicy:
        """Create an instance of AuditObjectStorePolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditObjectStorePolicy:
        """Create an instance of AuditObjectStorePolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditObjectStorePolicy.parse_obj(obj)

        _obj = AuditObjectStorePolicy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
