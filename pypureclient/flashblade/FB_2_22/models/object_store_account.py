...
from pypureclient.flashblade.FB_2_22.models.bucket_defaults_readonly import BucketDefaultsReadonly
from pypureclient.flashblade.FB_2_22.models.fixed_reference import FixedReference
from pypureclient.flashblade.FB_2_22.models.public_access_config import PublicAccessConfig
from pypureclient.flashblade.FB_2_22.models.space import Space
...
class ObjectStoreAccount(BaseModel):
    ...
    quota_limit: Optional[StrictInt] = Field(default=None, description="The effective quota limit applied against the size of the account, displayed in bytes. If unset, the account is unlimited in size.")
    realms: Optional[conlist(FixedReference)] = Field(default=None, description="The realms containing this account.")
    space: Optional[Space] = Field(default=None, description="The space specification of the object store account.")
    __properties = ["id", "name", "context", "bucket_defaults", "created", "hard_limit_enabled", "object_count", "public_access_config", "quota_limit", "realms", "space"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreAccount:
        """Create an instance of ObjectStoreAccount from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreAccount:
        """Create an instance of ObjectStoreAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreAccount.parse_obj(obj)
