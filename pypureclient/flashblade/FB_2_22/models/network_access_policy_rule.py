...
class NetworkAccessPolicyRule(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkAccessPolicyRule:
        """Create an instance of NetworkAccessPolicyRule from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkAccessPolicyRule:
        """Create an instance of NetworkAccessPolicyRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkAccessPolicyRule.parse_obj(obj)

        _obj = NetworkAccessPolicyRule.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
