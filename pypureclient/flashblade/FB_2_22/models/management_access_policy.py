...
from pypureclient.flashblade.FB_2_22.models.management_access_policy_rule_in_policy import ManagementAccessPolicyRuleInPolicy
...
class ManagementAccessPolicy(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "realms", "version", "aggregation_strategy", "rules"]
