...
from pypureclient.flashblade.FB_2_22.models.continuous_replication_performance import ContinuousReplicationPerformance
from pypureclient.flashblade.FB_2_22.models.fixed_reference import FixedReference
from pypureclient.flashblade.FB_2_22.models.replication_performance import ReplicationPerformance
...
class RelationshipPerformanceReplication(BaseModel):
    ...
    __properties = ["id", "context", "aggregate", "continuous", "periodic", "time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelationshipPerformanceReplication:
        """Create an instance of RelationshipPerformanceReplication from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> RelationshipPerformanceReplication:
        """Create an instance of RelationshipPerformanceReplication from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelationshipPerformanceReplication.parse_obj(obj)
