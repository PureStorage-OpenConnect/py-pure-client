...
from pypureclient.flashblade.FB_2_22.models.bucket_eradication_config import BucketEradicationConfig
from pypureclient.flashblade.FB_2_22.models.object_lock_config_request_body import ObjectLockConfigRequestBody
...
from pypureclient.flashblade.FB_2_22.models.storage_class_info import StorageClassInfo
...
class BucketPatch(BaseModel):
    ...
    __properties = ["destroyed", "eradication_config", "hard_limit_enabled", "object_lock_config", "public_access_config", "qos_policy", "quota_limit", "retention_lock", "storage_class", "versioning"]
