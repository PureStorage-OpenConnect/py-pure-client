...
class SyslogServer(BaseModel):
    ...
    __properties = ["uri", "services", "sources", "id", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyslogServer:
        """Create an instance of SyslogServer from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SyslogServer:
        """Create an instance of SyslogServer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyslogServer.parse_obj(obj)

        _obj = SyslogServer.construct(_fields_set=None, **{
            "uri": obj.get("uri"),
