...
from pypureclient.flashblade.FB_2_22.models.trust_policy_rule_condition import TrustPolicyRuleCondition


class TrustPolicyRuleWithContext(BaseModel):
    """
    TrustPolicyRuleWithContext
    """
    name: Optional[StrictStr] = Field(default=None, description="Name of the object (e.g., a file system or snapshot).")
    index: Optional[StrictInt] = Field(default=None, description="Index of the object in the containing array.")
    actions: Optional[conlist(StrictStr)] = Field(default=None, description="The list of role-assumption actions granted by this rule to the respective role. Currently we support `sts:AssumeRoleWithSAML` and `sts:AssumeRoleWithWebIdentity` actions.")
    conditions: Optional[conlist(TrustPolicyRuleCondition)] = Field(default=None, description="Conditions used to limit the scope which this rule applies to.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrustPolicyRuleWithContext:
        """Create an instance of TrustPolicyRuleWithContext from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TrustPolicyRuleWithContext:
        """Create an instance of TrustPolicyRuleWithContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrustPolicyRuleWithContext.parse_obj(obj)

        _obj = TrustPolicyRuleWithContext.construct(_fields_set=None, **{
            "name": obj.get("name"),
            "index": obj.get("index"),
            "actions": obj.get("actions"),
            "conditions": [TrustPolicyRuleCondition.from_dict(_item) for _item in obj.get("conditions")] if obj.get("conditions") is not None else None,
