...
from pypureclient.flashblade.FB_2_5.models.http import Http
from pypureclient.flashblade.FB_2_5.models.location_reference import LocationReference
from pypureclient.flashblade.FB_2_5.models.multi_protocol import MultiProtocol
from pypureclient.flashblade.FB_2_5.models.nfs import Nfs
from pypureclient.flashblade.FB_2_5.models.smb import Smb
from pypureclient.flashblade.FB_2_5.models.space import Space
...
class FileSystem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "created", "default_group_quota", "default_user_quota", "destroyed", "fast_remove_directory_enabled", "hard_limit_enabled", "http", "multi_protocol", "nfs", "provisioned", "promotion_status", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "space", "time_remaining", "writable"]
