...
class MultiProtocol(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MultiProtocol:
        """Create an instance of MultiProtocol from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> MultiProtocol:
        """Create an instance of MultiProtocol from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MultiProtocol.parse_obj(obj)

        _obj = MultiProtocol.construct(_fields_set=None, **{
