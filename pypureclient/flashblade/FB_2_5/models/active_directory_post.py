...
class ActiveDirectoryPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["computer_name", "directory_servers", "domain", "encryption_types", "fqdns", "join_ou", "kerberos_servers", "password", "service_principal_names", "user"]
