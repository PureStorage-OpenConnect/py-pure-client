...
class BucketS3SpecificPerformanceGetResp(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[BucketS3SpecificPerformance]',
    ...
    def __init__(
        ...
        items=None,  # type: List[models.BucketS3SpecificPerformance]
        total=None,  # type: List[models.BucketS3SpecificPerformance]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `BucketS3SpecificPerformanceGetResp`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(BucketS3SpecificPerformanceGetResp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BucketS3SpecificPerformanceGetResp):
            return False
