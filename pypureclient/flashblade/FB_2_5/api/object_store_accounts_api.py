...
class ObjectStoreAccountsApi:
    ...
    def api25_object_store_accounts_delete_with_http_info(
        ...
        _param = self._api25_object_store_accounts_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api25_object_store_accounts_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.5/object-store-accounts',
    ...
    def api25_object_store_accounts_get_with_http_info(
        ...
        _param = self._api25_object_store_accounts_get_serialize(
    ...
    def _api25_object_store_accounts_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api25_object_store_accounts_post_with_http_info(
        ...
        _param = self._api25_object_store_accounts_post_serialize(
            names = names,
        )
    ...
    def _api25_object_store_accounts_post_serialize(
        self,
        names,
    ) -> RequestSerialized:
