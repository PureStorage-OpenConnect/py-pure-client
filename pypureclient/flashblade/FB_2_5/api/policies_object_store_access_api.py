...
from pypureclient.flashblade.FB_2_5.models.object_store_access_policy_action_get_response import ObjectStoreAccessPolicyActionGetResponse
from pypureclient.flashblade.FB_2_5.models.object_store_access_policy_get_response import ObjectStoreAccessPolicyGetResponse
from pypureclient.flashblade.FB_2_5.models.object_store_access_policy_patch import ObjectStoreAccessPolicyPatch
from pypureclient.flashblade.FB_2_5.models.object_store_access_policy_post import ObjectStoreAccessPolicyPost
from pypureclient.flashblade.FB_2_5.models.object_store_access_policy_response import ObjectStoreAccessPolicyResponse
from pypureclient.flashblade.FB_2_5.models.object_store_access_policy_rule_get_response import ObjectStoreAccessPolicyRuleGetResponse
from pypureclient.flashblade.FB_2_5.models.object_store_access_policy_rule_response import ObjectStoreAccessPolicyRuleResponse
...
from pypureclient.flashblade.FB_2_5.models.policy_rule_object_access_post import PolicyRuleObjectAccessPost
...
class PoliciesObjectStoreAccessApi:
    ...
    def api25_object_store_access_policies_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_object_store_access_policies_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api25_object_store_access_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_object_store_access_policies_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_object_store_access_policies_get_with_http_info(continuation_token, exclude_rules, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_object_store_access_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_object_store_access_policies_object_store_users_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_object_store_access_policies_object_store_users_delete_with_http_info(member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_object_store_access_policies_object_store_users_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_object_store_access_policies_object_store_users_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_object_store_access_policies_object_store_users_get_with_http_info(continuation_token, filter, limit, member_ids, member_names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_object_store_access_policies_object_store_users_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_object_store_access_policies_object_store_users_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_object_store_access_policies_object_store_users_post_with_http_info(member_ids, member_names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_object_store_access_policies_object_store_users_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_object_store_access_policies_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_object_store_access_policies_patch_with_http_info(enforce_action_restrictions, ids, names, policy, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_object_store_access_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_object_store_access_policies_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_object_store_access_policies_post_with_http_info(names, enforce_action_restrictions, policy, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_object_store_access_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_object_store_access_policies_rules_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_object_store_access_policies_rules_delete_with_http_info(names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_object_store_access_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_object_store_access_policies_rules_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_object_store_access_policies_rules_get_with_http_info(continuation_token, filter, limit, names, offset, policy_ids, policy_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_object_store_access_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_object_store_access_policies_rules_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_object_store_access_policies_rules_patch_with_http_info(rule, enforce_action_restrictions, names, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_object_store_access_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_object_store_access_policies_rules_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_object_store_access_policies_rules_post_with_http_info(names, rule, enforce_action_restrictions, policy_ids, policy_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_object_store_access_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_object_store_access_policy_actions_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_object_store_access_policy_actions_get_with_http_info(continuation_token, filter, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_object_store_access_policy_actions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
