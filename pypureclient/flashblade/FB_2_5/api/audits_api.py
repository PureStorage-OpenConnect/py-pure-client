...
from pypureclient.flashblade.FB_2_5.models.audit_get_response import AuditGetResponse
...
class AuditsApi:
    ...
    def api25_audits_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_audits_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
