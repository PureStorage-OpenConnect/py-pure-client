...
class HardwareConnectorsApi:
    ...
    def api25_hardware_connectors_get_with_http_info(
        ...
        _param = self._api25_hardware_connectors_get_serialize(
            ids = ids,
            names = names,
    ...
    def _api25_hardware_connectors_get_serialize(
        self,
        ids,
        names,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.5/hardware-connectors',
    ...
    def api25_hardware_connectors_patch_with_http_info(
        ...
        _param = self._api25_hardware_connectors_patch_serialize(
    ...
    def _api25_hardware_connectors_patch_serialize(
        self,
        hardware_connector,
        ids,
        names,
    ...
    def api25_hardware_connectors_performance_get_with_http_info(
        ...
        _param = self._api25_hardware_connectors_performance_get_serialize(
            end_time = end_time,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api25_hardware_connectors_performance_get_serialize(
        self,
        end_time,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.5/hardware-connectors/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
