...
class HardwareConnectorsApi(object):
    ...
    def api25_hardware_connectors_get_with_http_info(
        self,
        ...
        >>> thread = api.api25_hardware_connectors_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api25_hardware_connectors_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api25_hardware_connectors_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.5/hardware-connectors', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api25_hardware_connectors_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api25_hardware_connectors_patch_with_http_info(hardware_connector, async_req=True)
        >>> result = thread.get()
        ...
        if hardware_connector is None:
            raise TypeError("Missing the required parameter `hardware_connector` when calling `api25_hardware_connectors_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.5/hardware-connectors', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api25_hardware_connectors_performance_get_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api25_hardware_connectors_performance_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'end_time' in params and params['end_time'] < 0:
            raise ValueError("Invalid value for parameter `end_time` when calling `api25_hardware_connectors_performance_get`, must be a value greater than or equal to `0`")
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api25_hardware_connectors_performance_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api25_hardware_connectors_performance_get`, must be a value greater than or equal to `0`")
        if 'resolution' in params and params['resolution'] < 0:
            raise ValueError("Invalid value for parameter `resolution` when calling `api25_hardware_connectors_performance_get`, must be a value greater than or equal to `0`")
        if 'start_time' in params and params['start_time'] < 0:
            raise ValueError("Invalid value for parameter `start_time` when calling `api25_hardware_connectors_performance_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.5/hardware-connectors/performance', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
