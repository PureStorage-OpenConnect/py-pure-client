...
from pypureclient.flashblade.FB_2_5.models.alert import Alert
from pypureclient.flashblade.FB_2_5.models.alert_get_response import AlertGetResponse
from pypureclient.flashblade.FB_2_5.models.alert_response import AlertResponse
...
class AlertsApi:
    ...
    def api25_alerts_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_alerts_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api25_alerts_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_alerts_patch_with_http_info(alerts_settings, ids, names, async_req=True)
        >>> result = thread.get()
