...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_5.models.object_store_access_key import ObjectStoreAccessKey
from pypureclient.flashblade.FB_2_5.models.object_store_access_key_get_response import ObjectStoreAccessKeyGetResponse
from pypureclient.flashblade.FB_2_5.models.object_store_access_key_post import ObjectStoreAccessKeyPost
from pypureclient.flashblade.FB_2_5.models.object_store_access_key_response import ObjectStoreAccessKeyResponse
...
class ObjectStoreAccessKeysApi:
    ...
    @validate_call
    def api25_object_store_access_keys_delete_with_http_info(
        self,
        ...
        _param = self._api25_object_store_access_keys_delete_serialize(
            names = names,
        )
    ...
    def _api25_object_store_access_keys_delete_serialize(
        self,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.5/object-store-access-keys',
    ...
    @validate_call
    def api25_object_store_access_keys_get_with_http_info(
        self,
        ...
        _param = self._api25_object_store_access_keys_get_serialize(
    ...
    def _api25_object_store_access_keys_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
    ...
    @validate_call
    def api25_object_store_access_keys_patch_with_http_info(
        self,
        names: Annotated[List[StrictStr], Field(description="A comma-separated list of resource names.")],
        ...
        _param = self._api25_object_store_access_keys_patch_serialize(
            names = names,
    ...
    def _api25_object_store_access_keys_patch_serialize(
        self,
        names,
    ...
    @validate_call
    def api25_object_store_access_keys_post_with_http_info(
        self,
        ...
        _param = self._api25_object_store_access_keys_post_serialize(
            object_store_access_key = object_store_access_key,
            names = names,
        )
    ...
    def _api25_object_store_access_keys_post_serialize(
        self,
        object_store_access_key,
        names,
    ) -> RequestSerialized:
