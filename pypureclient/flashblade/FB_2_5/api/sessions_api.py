...
from pypureclient.flashblade.FB_2_5.models.session_get_response import SessionGetResponse
...
class SessionsApi:
    ...
    def api25_sessions_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_sessions_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
