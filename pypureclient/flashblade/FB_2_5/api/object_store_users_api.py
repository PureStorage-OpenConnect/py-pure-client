...
class ObjectStoreUsersApi(object):
    ...
    def api25_object_store_users_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api25_object_store_users_get`, must be a value greater than or equal to `0`")
    ...
    def api25_object_store_users_object_store_access_policies_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api25_object_store_users_object_store_access_policies_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
