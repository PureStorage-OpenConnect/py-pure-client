...
from pypureclient.flashblade.FB_2_5.models.support_get_response import SupportGetResponse
from pypureclient.flashblade.FB_2_5.models.support_response import SupportResponse
...
class SupportApi:
    ...
    def api25_support_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_support_get_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api25_support_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_support_test_get_with_http_info(filter, sort, test_type, async_req=True)
        >>> result = thread.get()
