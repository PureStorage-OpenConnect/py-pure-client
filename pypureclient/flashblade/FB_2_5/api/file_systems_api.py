...
class FileSystemsApi:
    ...
    def api25_file_systems_groups_performance_get_with_http_info(
        ...
        _param = self._api25_file_systems_groups_performance_get_serialize(
    ...
    def _api25_file_systems_groups_performance_get_serialize(
        self,
        file_system_ids,
        file_system_names,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.5/file-systems/groups/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api25_file_systems_performance_get_with_http_info(
        ...
        _param = self._api25_file_systems_performance_get_serialize(
            continuation_token = continuation_token,
            end_time = end_time,
            filter = filter,
            ids = ids,
    ...
    def _api25_file_systems_performance_get_serialize(
        self,
        continuation_token,
        end_time,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.5/file-systems/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api25_file_systems_policies_all_get_with_http_info(
        ...
        _param = self._api25_file_systems_policies_all_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
    ...
    def _api25_file_systems_policies_all_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.5/file-systems/policies-all',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api25_file_systems_policies_delete_with_http_info(
        ...
        _param = self._api25_file_systems_policies_delete_serialize(
            member_ids = member_ids,
            member_names = member_names,
            policy_ids = policy_ids,
            policy_names = policy_names,
    ...
    def _api25_file_systems_policies_delete_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.5/file-systems/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api25_file_systems_policies_get_with_http_info(
        ...
        _param = self._api25_file_systems_policies_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
            member_ids = member_ids,
    ...
    def _api25_file_systems_policies_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
    ...
    def api25_file_systems_policies_post_with_http_info(
        ...
        _param = self._api25_file_systems_policies_post_serialize(
            member_ids = member_ids,
            member_names = member_names,
            policy_ids = policy_ids,
            policy_names = policy_names,
    ...
    def _api25_file_systems_policies_post_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
    ...
    def api25_file_systems_users_performance_get_with_http_info(
        ...
        _param = self._api25_file_systems_users_performance_get_serialize(
            file_system_ids = file_system_ids,
            file_system_names = file_system_names,
            filter = filter,
            limit = limit,
    ...
    def _api25_file_systems_users_performance_get_serialize(
        self,
        file_system_ids,
        file_system_names,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.5/file-systems/users/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
