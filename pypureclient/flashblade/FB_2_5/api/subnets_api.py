...
from pypureclient.flashblade.FB_2_5.models.subnet import Subnet
from pypureclient.flashblade.FB_2_5.models.subnet_get_response import SubnetGetResponse
from pypureclient.flashblade.FB_2_5.models.subnet_response import SubnetResponse
...
class SubnetsApi:
    ...
    def api25_subnets_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_subnets_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api25_subnets_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_subnets_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api25_subnets_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_subnets_patch_with_http_info(subnet, ids, names, async_req=True)
        >>> result = thread.get()
