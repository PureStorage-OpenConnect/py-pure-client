...
from pypureclient.flashblade.FB_2_5.models.array_connection import ArrayConnection
from pypureclient.flashblade.FB_2_5.models.array_connection_get_response import ArrayConnectionGetResponse
from pypureclient.flashblade.FB_2_5.models.array_connection_key_get_response import ArrayConnectionKeyGetResponse
from pypureclient.flashblade.FB_2_5.models.array_connection_key_response import ArrayConnectionKeyResponse
from pypureclient.flashblade.FB_2_5.models.array_connection_path_get_response import ArrayConnectionPathGetResponse
from pypureclient.flashblade.FB_2_5.models.array_connection_post import ArrayConnectionPost
from pypureclient.flashblade.FB_2_5.models.array_connection_response import ArrayConnectionResponse
from pypureclient.flashblade.FB_2_5.models.connection_relationship_performance_replication_get_resp import ConnectionRelationshipPerformanceReplicationGetResp
...
class ArrayConnectionsApi:
    ...
    def api25_array_connections_connection_key_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_array_connections_connection_key_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api25_array_connections_connection_key_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_array_connections_connection_key_post_with_http_info(
        self,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.api25_array_connections_connection_key_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_array_connections_connection_key_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.5/array-connections/connection-key', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api25_array_connections_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_array_connections_delete_with_http_info(ids, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_array_connections_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_array_connections_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_array_connections_get_with_http_info(continuation_token, filter, ids, limit, offset, remote_ids, remote_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_array_connections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_array_connections_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_array_connections_patch_with_http_info(array_connection, ids, remote_ids, remote_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_array_connections_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_array_connections_path_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_array_connections_path_get_with_http_info(continuation_token, filter, ids, limit, offset, remote_ids, remote_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_array_connections_path_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_array_connections_performance_replication_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api25_array_connections_performance_replication_get_with_http_info(continuation_token, end_time, filter, ids, limit, offset, remote_ids, remote_names, resolution, sort, start_time, total_only, type, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_array_connections_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.5/array-connections/performance/replication', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_array_connections_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
