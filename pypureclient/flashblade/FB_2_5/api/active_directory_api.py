...
from pypureclient.flashblade.FB_2_5.models.active_directory_get_response import ActiveDirectoryGetResponse
from pypureclient.flashblade.FB_2_5.models.active_directory_patch import ActiveDirectoryPatch
from pypureclient.flashblade.FB_2_5.models.active_directory_post import ActiveDirectoryPost
from pypureclient.flashblade.FB_2_5.models.active_directory_response import ActiveDirectoryResponse
...
class ActiveDirectoryApi:
    ...
    def api25_active_directory_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_active_directory_delete_with_http_info(ids, local_only, names, async_req=True)
        >>> result = thread.get()
    ...
    def api25_active_directory_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_active_directory_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api25_active_directory_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_active_directory_patch_with_http_info(active_directory, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_active_directory_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_active_directory_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_active_directory_post_with_http_info(active_directory, join_existing_account, names, async_req=True)
        >>> result = thread.get()
    ...
    def api25_active_directory_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_active_directory_test_get_with_http_info(filter, ids, limit, names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_active_directory_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
