...
from pypureclient.flashblade.FB_2_5.models.lifecycle_rule_get_response import LifecycleRuleGetResponse
from pypureclient.flashblade.FB_2_5.models.lifecycle_rule_patch import LifecycleRulePatch
from pypureclient.flashblade.FB_2_5.models.lifecycle_rule_post import LifecycleRulePost
from pypureclient.flashblade.FB_2_5.models.lifecycle_rule_response import LifecycleRuleResponse
...
class LifecycleRulesApi:
    ...
    def api25_lifecycle_rules_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api25_lifecycle_rules_delete_with_http_info(bucket_ids, bucket_names, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api25_lifecycle_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.5/lifecycle-rules', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api25_lifecycle_rules_get_with_http_info(
        self,
        bucket_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of bucket IDs. If after filtering, there is not at least one resource that matches each of the elements of `bucket_ids`, then an error is returned. This cannot be provided together with the `bucket_names` query parameter. This can be provided with the `ids` query parameter but not with `names`.")] = None,
        bucket_names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of bucket names. If there is not at least one resource that matches each of the elements of `bucket_names`, then an error is returned. This cannot be provided together with the `bucket_ids` query parameter. This can be provided with the `ids` query parameter but not with `names`.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api25_lifecycle_rules_get_with_http_info(bucket_ids, bucket_names, continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_lifecycle_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_lifecycle_rules_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api25_lifecycle_rules_patch_with_http_info(lifecycle, bucket_ids, bucket_names, confirm_date, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_lifecycle_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_lifecycle_rules_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api25_lifecycle_rules_post_with_http_info(rule, confirm_date, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_lifecycle_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
