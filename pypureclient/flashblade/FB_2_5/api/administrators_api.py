...
from pypureclient.flashblade.FB_2_5.models.admin_api_token_get_response import AdminApiTokenGetResponse
from pypureclient.flashblade.FB_2_5.models.admin_api_token_response import AdminApiTokenResponse
from pypureclient.flashblade.FB_2_5.models.admin_cache_get_response import AdminCacheGetResponse
from pypureclient.flashblade.FB_2_5.models.admin_get_response import AdminGetResponse
from pypureclient.flashblade.FB_2_5.models.admin_patch import AdminPatch
from pypureclient.flashblade.FB_2_5.models.admin_response import AdminResponse
from pypureclient.flashblade.FB_2_5.models.admin_setting import AdminSetting
from pypureclient.flashblade.FB_2_5.models.admin_settings_get_response import AdminSettingsGetResponse
from pypureclient.flashblade.FB_2_5.models.admin_settings_response import AdminSettingsResponse
...
class AdministratorsApi:
    ...
    def api25_admins_api_tokens_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_admins_api_tokens_delete_with_http_info(admin_ids, admin_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api25_admins_api_tokens_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_admins_api_tokens_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_admins_api_tokens_get_with_http_info(admin_ids, admin_names, continuation_token, expose_api_token, filter, limit, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_admins_api_tokens_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_admins_api_tokens_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_admins_api_tokens_post_with_http_info(admin_ids, admin_names, timeout, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_admins_api_tokens_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_admins_cache_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_admins_cache_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_admins_cache_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_admins_cache_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_admins_cache_get_with_http_info(continuation_token, filter, ids, limit, names, offset, refresh, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_admins_cache_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_admins_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_admins_get_with_http_info(continuation_token, expose_api_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_admins_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_admins_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_admins_patch_with_http_info(admin, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_admins_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_admins_settings_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_admins_settings_get_with_http_info(continuation_token, filter, limit, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_admins_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api25_admins_settings_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api25_admins_settings_patch_with_http_info(admin_setting, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api25_admins_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
