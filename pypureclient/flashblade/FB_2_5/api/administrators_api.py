...
class AdministratorsApi:
    ...
    def api25_admins_api_tokens_delete_with_http_info(
        ...
        _param = self._api25_admins_api_tokens_delete_serialize(
            admin_ids = admin_ids,
    ...
    def _api25_admins_api_tokens_delete_serialize(
        self,
        admin_ids,
        admin_names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.5/admins/api-tokens',
    ...
    def api25_admins_api_tokens_get_with_http_info(
        ...
        _param = self._api25_admins_api_tokens_get_serialize(
            admin_ids = admin_ids,
            admin_names = admin_names,
    ...
    def _api25_admins_api_tokens_get_serialize(
        self,
        admin_ids,
        admin_names,
        continuation_token,
    ...
    def api25_admins_api_tokens_post_with_http_info(
        ...
        _param = self._api25_admins_api_tokens_post_serialize(
            admin_ids = admin_ids,
            admin_names = admin_names,
            timeout = timeout,
        )
    ...
    def _api25_admins_api_tokens_post_serialize(
        self,
        admin_ids,
        admin_names,
        timeout,
    ...
    def api25_admins_cache_delete_with_http_info(
        ...
        _param = self._api25_admins_cache_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api25_admins_cache_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.5/admins/cache',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api25_admins_cache_get_with_http_info(
        ...
        _param = self._api25_admins_cache_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api25_admins_cache_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api25_admins_get_with_http_info(
        ...
        _param = self._api25_admins_get_serialize(
            continuation_token = continuation_token,
            expose_api_token = expose_api_token,
            filter = filter,
            ids = ids,
    ...
    def _api25_admins_get_serialize(
        self,
        continuation_token,
        expose_api_token,
        filter,
    ...
    def api25_admins_patch_with_http_info(
        ...
        _param = self._api25_admins_patch_serialize(
            admin = admin,
            ids = ids,
            names = names,
        )
    ...
    def _api25_admins_patch_serialize(
        self,
        admin,
        ids,
        names,
    ...
    def api25_admins_settings_get_with_http_info(
        ...
        _param = self._api25_admins_settings_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
            offset = offset,
    ...
    def _api25_admins_settings_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.5/admins/settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api25_admins_settings_patch_with_http_info(
        ...
        _param = self._api25_admins_settings_patch_serialize(
    ...
    def _api25_admins_settings_patch_serialize(
        self,
        admin_setting,
    ) -> RequestSerialized:
