...
class LogsApi(object):
    ...
    def api25_logs_async_download_get_with_http_info(
        self,
        ...
        >>> thread = api.api25_logs_async_download_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.5/logs-async/download', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api25_logs_async_get_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api25_logs_async_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api25_logs_async_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api25_logs_async_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api25_logs_async_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api25_logs_async_patch_with_http_info(logs_async, async_req=True)
        >>> result = thread.get()
        ...
        if logs_async is None:
            raise TypeError("Missing the required parameter `logs_async` when calling `api25_logs_async_patch`")
    ...
    def api25_logs_get_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api25_logs_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'end_time' in params and params['end_time'] < 0:
            raise ValueError("Invalid value for parameter `end_time` when calling `api25_logs_get`, must be a value greater than or equal to `0`")
        if 'start_time' in params and params['start_time'] < 0:
            raise ValueError("Invalid value for parameter `start_time` when calling `api25_logs_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
