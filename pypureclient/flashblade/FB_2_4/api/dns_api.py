...
class DNSApi:
    ...
    def api24_dns_get_with_http_info(
        ...
        _param = self._api24_dns_get_serialize(
    ...
    def api24_dns_patch_with_http_info(
        ...
        _param = self._api24_dns_patch_serialize(
            dns = dns,
            ids = ids,
            names = names,
        )
    ...
    def _api24_dns_patch_serialize(
        self,
        dns,
        ids,
        names,
