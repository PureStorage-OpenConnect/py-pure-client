...
class SyslogApi(object):
    ...
    def api24_syslog_servers_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api24_syslog_servers_get`, must be a value greater than or equal to `1`")
    ...
    def api24_syslog_servers_settings_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api24_syslog_servers_settings_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
