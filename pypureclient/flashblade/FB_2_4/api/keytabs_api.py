...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_4.models.keytab_get_response import KeytabGetResponse
from pypureclient.flashblade.FB_2_4.models.keytab_post import KeytabPost
from pypureclient.flashblade.FB_2_4.models.keytab_response import KeytabResponse
...
class KeytabsApi:
    ...
    @validate_call
    def api24_keytabs_delete_with_http_info(
        self,
        ...
        _param = self._api24_keytabs_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api24_keytabs_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
    ...
    @validate_call
    def api24_keytabs_download_get_with_http_info(
        self,
        ...
        _param = self._api24_keytabs_download_get_serialize(
    ...
    def _api24_keytabs_download_get_serialize(
        self,
        keytab_ids,
        keytab_names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.4/keytabs/download',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api24_keytabs_get_with_http_info(
        self,
        ...
        _param = self._api24_keytabs_get_serialize(
    ...
    def _api24_keytabs_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    @validate_call
    def api24_keytabs_post_with_http_info(
        self,
        keytab: KeytabPost,
        ...
        _param = self._api24_keytabs_post_serialize(
            keytab = keytab,
    ...
    def _api24_keytabs_post_serialize(
        self,
        keytab,
        name_prefixes,
    ) -> RequestSerialized:
    ...
    @validate_call
    def api24_keytabs_upload_post_with_http_info(
        self,
        ...
        _param = self._api24_keytabs_upload_post_serialize(
    ...
    def _api24_keytabs_upload_post_serialize(
        self,
        keytab_file,
        name_prefixes,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2.4/keytabs/upload',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
