...
class NetworkInterfacesApi(object):
    ...
    def api24_network_interfaces_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api24_network_interfaces_patch_with_http_info(network_interface, async_req=True)
        >>> result = thread.get()
        ...
        if network_interface is None:
            raise TypeError("Missing the required parameter `network_interface` when calling `api24_network_interfaces_patch`")
    ...
    def api24_network_interfaces_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api24_network_interfaces_post_with_http_info(network_interface, names, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'network_interface' is set
        if network_interface is None:
            raise TypeError("Missing the required parameter `network_interface` when calling `api24_network_interfaces_post`")
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api24_network_interfaces_post`")
