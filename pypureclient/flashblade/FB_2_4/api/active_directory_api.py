...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_4.models.active_directory_get_response import ActiveDirectoryGetResponse
from pypureclient.flashblade.FB_2_4.models.active_directory_patch import ActiveDirectoryPatch
...
class ActiveDirectoryApi:
    ...
    def api24_active_directory_delete_with_http_info(
        ...
        _param = self._api24_active_directory_delete_serialize(
            ids = ids,
    ...
    def _api24_active_directory_delete_serialize(
        self,
        ids,
        local_only,
        names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.4/active-directory',
    ...
    def api24_active_directory_get_with_http_info(
        ...
        _param = self._api24_active_directory_get_serialize(
    ...
    def _api24_active_directory_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    @validate_call
    def api24_active_directory_patch_with_http_info(
        self,
        ...
        _param = self._api24_active_directory_patch_serialize(
    ...
    def _api24_active_directory_patch_serialize(
        self,
        active_directory,
        ids,
        names,
    ...
    def api24_active_directory_post_with_http_info(
        ...
        _param = self._api24_active_directory_post_serialize(
            active_directory = active_directory,
            names = names,
    ...
    def _api24_active_directory_post_serialize(
        self,
        active_directory,
        names,
    ...
    @validate_call
    def api24_active_directory_test_get_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Limit the size of the response to the specified number of resources. A `limit` of `0` can be used to get the number of resources without getting all of the resources. It will be returned in the `total_item_count` field. If a client asks for a page size larger than the available number, the request is still valid. In that case the server just returns the available number of items, disregarding the client's page size request.")] = None,
        ...
        _param = self._api24_active_directory_test_get_serialize(
            filter = filter,
            ids = ids,
            limit = limit,
            names = names,
    ...
    def _api24_active_directory_test_get_serialize(
        self,
        filter,
        ids,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.4/active-directory/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
