...
from pypureclient.flashblade.FB_2_4.models.alert_get_response import AlertGetResponse
from pypureclient.flashblade.FB_2_4.models.alert_response import AlertResponse
...
class AlertsApi:
    ...
    def api24_alerts_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_alerts_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api24_alerts_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_alerts_patch_with_http_info(alerts_settings, ids, names, async_req=True)
        >>> result = thread.get()
