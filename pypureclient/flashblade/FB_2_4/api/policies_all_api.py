...
from pypureclient.flashblade.FB_2_4.models.policy_base_get_response import PolicyBaseGetResponse
...
class PoliciesAllApi:
    ...
    def api24_policies_all_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_policies_all_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api24_policies_all_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_policies_all_members_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_policies_all_members_get_with_http_info(continuation_token, filter, limit, local_file_system_ids, local_file_system_names, member_ids, member_names, member_types, offset, policy_ids, policy_names, remote_file_system_ids, remote_file_system_names, remote_ids, remote_names, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_policies_all_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
