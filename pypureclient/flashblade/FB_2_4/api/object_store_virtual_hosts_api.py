...
from pypureclient.flashblade.FB_2_4.models.object_store_virtual_host_get_response import ObjectStoreVirtualHostGetResponse
from pypureclient.flashblade.FB_2_4.models.object_store_virtual_host_response import ObjectStoreVirtualHostResponse
...
class ObjectStoreVirtualHostsApi:
    ...
    def api24_object_store_virtual_hosts_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api24_object_store_virtual_hosts_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api24_object_store_virtual_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.4/object-store-virtual-hosts', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api24_object_store_virtual_hosts_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api24_object_store_virtual_hosts_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_object_store_virtual_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.4/object-store-virtual-hosts', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api24_object_store_virtual_hosts_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api24_object_store_virtual_hosts_post_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_object_store_virtual_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.4/object-store-virtual-hosts', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
