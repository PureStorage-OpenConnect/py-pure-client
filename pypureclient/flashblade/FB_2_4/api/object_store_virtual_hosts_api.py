...
class ObjectStoreVirtualHostsApi:
    ...
    def api24_object_store_virtual_hosts_delete_with_http_info(
        ...
        _param = self._api24_object_store_virtual_hosts_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api24_object_store_virtual_hosts_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.4/object-store-virtual-hosts',
    ...
    def api24_object_store_virtual_hosts_get_with_http_info(
        ...
        _param = self._api24_object_store_virtual_hosts_get_serialize(
    ...
    def _api24_object_store_virtual_hosts_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api24_object_store_virtual_hosts_post_with_http_info(
        ...
        _param = self._api24_object_store_virtual_hosts_post_serialize(
            names = names,
        )
    ...
    def _api24_object_store_virtual_hosts_post_serialize(
        self,
        names,
    ) -> RequestSerialized:
