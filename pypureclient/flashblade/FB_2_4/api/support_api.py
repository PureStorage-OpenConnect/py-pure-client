...
class SupportApi:
    ...
    def api24_support_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_support_get_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api24_support_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_support_test_get_with_http_info(filter, sort, test_type, async_req=True)
        >>> result = thread.get()
