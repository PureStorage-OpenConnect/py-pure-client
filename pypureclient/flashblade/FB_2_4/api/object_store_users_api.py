...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_4.models.object_store_user_get_response import ObjectStoreUserGetResponse
...
class ObjectStoreUsersApi:
    ...
    @validate_call
    def api24_object_store_users_delete_with_http_info(
        self,
        ...
        _param = self._api24_object_store_users_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api24_object_store_users_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.4/object-store-users',
    ...
    @validate_call
    def api24_object_store_users_get_with_http_info(
        self,
        ...
        _param = self._api24_object_store_users_get_serialize(
    ...
    def _api24_object_store_users_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    @validate_call
    def api24_object_store_users_object_store_access_policies_delete_with_http_info(
        self,
        ...
        _param = self._api24_object_store_users_object_store_access_policies_delete_serialize(
    ...
    def _api24_object_store_users_object_store_access_policies_delete_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.4/object-store-users/object-store-access-policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api24_object_store_users_object_store_access_policies_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Limit the size of the response to the specified number of resources. A `limit` of `0` can be used to get the number of resources without getting all of the resources. It will be returned in the `total_item_count` field. If a client asks for a page size larger than the available number, the request is still valid. In that case the server just returns the available number of items, disregarding the client's page size request.")] = None,
        ...
        _param = self._api24_object_store_users_object_store_access_policies_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            limit = limit,
            member_ids = member_ids,
    ...
    def _api24_object_store_users_object_store_access_policies_get_serialize(
        self,
        continuation_token,
        filter,
        limit,
    ...
    @validate_call
    def api24_object_store_users_object_store_access_policies_post_with_http_info(
        self,
        member_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of member IDs. If after filtering, there is not at least one resource that matches each of the elements of `member_ids`, then an error is returned. This cannot be provided together with the `member_names` query parameter.")] = None,
        member_names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of member names.")] = None,
        policy_ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of policy IDs. If after filtering, there is not at least one resource that matches each of the elements of `policy_ids`, then an error is returned. This cannot be provided together with the `policy_names` query parameter.")] = None,
        ...
        _param = self._api24_object_store_users_object_store_access_policies_post_serialize(
            member_ids = member_ids,
            member_names = member_names,
            policy_ids = policy_ids,
            policy_names = policy_names,
    ...
    def _api24_object_store_users_object_store_access_policies_post_serialize(
        self,
        member_ids,
        member_names,
        policy_ids,
    ...
    @validate_call
    def api24_object_store_users_post_with_http_info(
        self,
        ...
        _param = self._api24_object_store_users_post_serialize(
            names = names,
    ...
    def _api24_object_store_users_post_serialize(
        self,
        names,
        full_access,
    ) -> RequestSerialized:
