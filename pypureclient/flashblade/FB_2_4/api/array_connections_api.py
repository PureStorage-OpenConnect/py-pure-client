...
class ArrayConnectionsApi(object):
    ...
    def api24_array_connections_connection_key_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api24_array_connections_connection_key_get`, must be a value greater than or equal to `0`")
    ...
    def api24_array_connections_performance_replication_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api24_array_connections_performance_replication_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
