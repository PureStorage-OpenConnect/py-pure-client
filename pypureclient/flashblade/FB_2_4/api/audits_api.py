...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_4.models.audit_get_response import AuditGetResponse
...
class AuditsApi:
    ...
    def api24_audits_get_with_http_info(
        ...
        _param = self._api24_audits_get_serialize(
    ...
    def _api24_audits_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
