...
from pypureclient.flashblade.FB_2_4.models.api_client import ApiClient
from pypureclient.flashblade.FB_2_4.models.api_clients_post import ApiClientsPost
from pypureclient.flashblade.FB_2_4.models.api_clients_response import ApiClientsResponse
...
class APIClientsApi:
    ...
    def api24_api_clients_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_api_clients_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api24_api_clients_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_api_clients_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_api_clients_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_api_clients_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_api_clients_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_api_clients_patch_with_http_info(api_clients, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_api_clients_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_api_clients_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_api_clients_post_with_http_info(api_client, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_api_clients_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
