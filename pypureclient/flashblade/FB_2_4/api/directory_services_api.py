...
class DirectoryServicesApi(object):
    ...
    def api24_directory_services_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api24_directory_services_patch_with_http_info(directory_service, async_req=True)
        >>> result = thread.get()
    ...
    def api24_directory_services_roles_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api24_directory_services_roles_patch_with_http_info(directory_service_roles, async_req=True)
        >>> result = thread.get()
    ...
    def api24_directory_services_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api24_directory_services_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api24_directory_services_test_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api24_directory_services_test_patch_with_http_info(async_req=True)
        >>> result = thread.get()
