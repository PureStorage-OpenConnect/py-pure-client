...
from pypureclient.flashblade.FB_2_4.models.directory_service_get_response import DirectoryServiceGetResponse
from pypureclient.flashblade.FB_2_4.models.directory_service_response import DirectoryServiceResponse
from pypureclient.flashblade.FB_2_4.models.directory_service_role import DirectoryServiceRole
from pypureclient.flashblade.FB_2_4.models.directory_service_roles_get_response import DirectoryServiceRolesGetResponse
from pypureclient.flashblade.FB_2_4.models.directory_service_roles_response import DirectoryServiceRolesResponse
...
class DirectoryServicesApi:
    ...
    def api24_directory_services_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_directory_services_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api24_directory_services_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_directory_services_patch_with_http_info(directory_service, ids, names, async_req=True)
        >>> result = thread.get()
    ...
    def api24_directory_services_roles_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_directory_services_roles_get_with_http_info(continuation_token, filter, ids, limit, offset, role_ids, role_names, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api24_directory_services_roles_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_directory_services_roles_patch_with_http_info(directory_service_roles, ids, role_ids, role_names, async_req=True)
        >>> result = thread.get()
    ...
    def api24_directory_services_test_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_directory_services_test_get_with_http_info(filter, ids, limit, names, sort, async_req=True)
        >>> result = thread.get()
    ...
    def api24_directory_services_test_patch_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api24_directory_services_test_patch_with_http_info(filter, ids, names, sort, directory_service, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_directory_services_test_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.4/directory-services/test', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
