...
from pypureclient.flashblade.FB_2_4.models.resource_performance_replication_get_response import ResourcePerformanceReplicationGetResponse
from pypureclient.flashblade.FB_2_4.models.target import Target
from pypureclient.flashblade.FB_2_4.models.target_get_response import TargetGetResponse
from pypureclient.flashblade.FB_2_4.models.target_post import TargetPost
from pypureclient.flashblade.FB_2_4.models.target_response import TargetResponse
...
class TargetsApi:
    ...
    def api24_targets_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_targets_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api24_targets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_targets_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_targets_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_targets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_targets_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_targets_patch_with_http_info(target, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_targets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api24_targets_performance_replication_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api24_targets_performance_replication_get_with_http_info(continuation_token, end_time, filter, ids, limit, names, offset, resolution, sort, start_time, total_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_targets_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api24_targets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
