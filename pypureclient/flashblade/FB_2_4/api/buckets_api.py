...
class BucketsApi:
    ...
    def api24_buckets_delete_with_http_info(
        ...
        _param = self._api24_buckets_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api24_buckets_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
    ...
    def api24_buckets_get_with_http_info(
        ...
        _param = self._api24_buckets_get_serialize(
    ...
    def _api24_buckets_get_serialize(
        self,
        continuation_token,
        destroyed,
        filter,
    ...
    def api24_buckets_patch_with_http_info(
        ...
        _param = self._api24_buckets_patch_serialize(
            bucket = bucket,
            ids = ids,
            names = names,
        )
    ...
    def _api24_buckets_patch_serialize(
        self,
        bucket,
        ids,
        names,
    ...
    def api24_buckets_performance_get_with_http_info(
        ...
        _param = self._api24_buckets_performance_get_serialize(
            continuation_token = continuation_token,
            end_time = end_time,
            filter = filter,
            ids = ids,
    ...
    def _api24_buckets_performance_get_serialize(
        self,
        continuation_token,
        end_time,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.4/buckets/performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api24_buckets_post_with_http_info(
        ...
        _param = self._api24_buckets_post_serialize(
            names = names,
            bucket = bucket,
        )
    ...
    def _api24_buckets_post_serialize(
        self,
        names,
        bucket,
    ) -> RequestSerialized:
    ...
    def api24_buckets_s3_specific_performance_get_with_http_info(
        ...
        _param = self._api24_buckets_s3_specific_performance_get_serialize(
            continuation_token = continuation_token,
            end_time = end_time,
            filter = filter,
            ids = ids,
    ...
    def _api24_buckets_s3_specific_performance_get_serialize(
        self,
        continuation_token,
        end_time,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.4/buckets/s3-specific-performance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
