...
class ArrayEncryptionDataAtRest(BaseModel):
    ...
    """ # noqa: E501
    algorithms: Optional[List[StrictStr]] = Field(default=None, description="The algorithms used to encrypt data at rest on the array.")
    ...
    __properties: ClassVar[List[str]] = ["algorithms", "enabled", "entropy_source"]
