...
class AdminApiToken(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["api_token", "admin"]
    ...
    def to_dict(self, include_readonly: bool = False) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.admin and (include_readonly or "admin" not in excluded_fields):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "admin": Reference.from_dict(obj["admin"]) if obj.get("admin") is not None else None
        })
        return _obj
