...
from pypureclient.flashblade.FB_2_12.models.reference_writable import ReferenceWritable
...
class LifecycleRulePost(BaseModel):
    ...
    __properties = ["abort_incomplete_multipart_uploads_after", "keep_current_version_for", "keep_current_version_until", "bucket", "keep_previous_version_for", "prefix", "rule_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LifecycleRulePost:
        """Create an instance of LifecycleRulePost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LifecycleRulePost:
        """Create an instance of LifecycleRulePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LifecycleRulePost.parse_obj(obj)

        _obj = LifecycleRulePost.construct(_fields_set=None, **{
            ...
            "bucket": ReferenceWritable.from_dict(obj.get("bucket")) if obj.get("bucket") is not None else None,
