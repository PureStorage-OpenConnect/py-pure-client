...
from pypureclient.flashblade.FB_2_12.models.cross_origin_resource_sharing_policy_rule import CrossOriginResourceSharingPolicyRule
...
class CrossOriginResourceSharingPolicyRuleGetResponse(BaseModel):
    ...
    items: Optional[conlist(CrossOriginResourceSharingPolicyRule)] = None
    ...
    def from_dict(cls, obj: dict) -> CrossOriginResourceSharingPolicyRuleGetResponse:
        ...
        _obj = CrossOriginResourceSharingPolicyRuleGetResponse.construct(_fields_set=None, **{
            ...
            "items": [CrossOriginResourceSharingPolicyRule.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
