...
from pypureclient.flashblade.FB_2_12.models.policy_rule import PolicyRule
...
class PolicyPatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "enabled", "is_local", "location", "policy_type", "rules", "retention_lock", "add_rules", "remove_rules"]
