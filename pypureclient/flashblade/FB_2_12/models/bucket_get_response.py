...
from pypureclient.flashblade.FB_2_12.models.bucket import Bucket
...
class BucketGetResponse(BaseModel):
    ...
    items: Optional[List[Bucket]] = Field(default=None, description="A list of bucket objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "items": [Bucket.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": Bucket.from_dict(obj["total"]) if obj.get("total") is not None else None
        })
        return _obj
