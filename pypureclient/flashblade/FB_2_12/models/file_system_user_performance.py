...
from pypureclient.flashblade.FB_2_12.models.user import User
...
class FileSystemUserPerformance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "bytes_per_op", "bytes_per_read", "bytes_per_write", "file_system", "others_per_sec", "read_bytes_per_sec", "reads_per_sec", "time", "usec_per_other_op", "usec_per_read_op", "usec_per_write_op", "user", "write_bytes_per_sec", "writes_per_sec"]
