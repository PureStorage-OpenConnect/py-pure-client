...
class SmbClientPolicyRulePost(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmbClientPolicyRulePost:
        """Create an instance of SmbClientPolicyRulePost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmbClientPolicyRulePost:
        """Create an instance of SmbClientPolicyRulePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmbClientPolicyRulePost.parse_obj(obj)

        _obj = SmbClientPolicyRulePost.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
