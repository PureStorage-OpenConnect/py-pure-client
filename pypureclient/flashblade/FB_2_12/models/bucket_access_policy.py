...
class BucketAccessPolicy(BaseModel):
    ...
    rules: Optional[List[BucketAccessPolicyRule]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(_fields_set=None, **{
            ...
            "rules": [BucketAccessPolicyRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None,
