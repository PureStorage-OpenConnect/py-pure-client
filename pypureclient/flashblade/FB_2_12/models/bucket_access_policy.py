...
class BucketAccessPolicy(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        rules=None,  # type: List[models.BucketAccessPolicyRule]
    ):
        """
        Keyword args:
            ...
            policy_type (str): Type of the policy. Valid values are `bucket-access`, `cross-origin-resource-sharing`, `nfs`, `object-access`, `smb-client`, `smb-share`, and `snapshot`.
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `BucketAccessPolicy`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(BucketAccessPolicy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BucketAccessPolicy):
            return False
