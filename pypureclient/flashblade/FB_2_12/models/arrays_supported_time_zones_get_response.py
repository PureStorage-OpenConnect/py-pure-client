...
class ArraysSupportedTimeZonesGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        items=None,  # type: List[models.TimeZone]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ArraysSupportedTimeZonesGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ArraysSupportedTimeZonesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArraysSupportedTimeZonesGetResponse):
            return False
