...
from pypureclient.flashblade.FB_2_12.models.object_lock_config_request_body import ObjectLockConfigRequestBody
...
class BucketPatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["destroyed", "hard_limit_enabled", "object_lock_config", "quota_limit", "retention_lock", "versioning", "public_access_config"]
