...
from pypureclient.flashblade.FB_2_12.models.snmp_manager_get_response import SnmpManagerGetResponse
...
class SNMPManagersApi:
    ...
    def api212_snmp_managers_delete_with_http_info(
        ...
        _param = self._api212_snmp_managers_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api212_snmp_managers_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.12/snmp-managers',
    ...
    def api212_snmp_managers_get_with_http_info(
        ...
        _param = self._api212_snmp_managers_get_serialize(
    ...
    def _api212_snmp_managers_get_serialize(
        self,
        continuation_token,
        ids,
        filter,
    ...
    def api212_snmp_managers_patch_with_http_info(
        ...
        _param = self._api212_snmp_managers_patch_serialize(
    ...
    def _api212_snmp_managers_patch_serialize(
        self,
        snmp_manager,
        ids,
        names,
    ...
    def api212_snmp_managers_post_with_http_info(
        ...
        _param = self._api212_snmp_managers_post_serialize(
            names = names,
            snmp_manager = snmp_manager,
        )
    ...
    def _api212_snmp_managers_post_serialize(
        self,
        names,
        snmp_manager,
    ) -> RequestSerialized:
    ...
    def api212_snmp_managers_test_get_with_http_info(
        ...
        _param = self._api212_snmp_managers_test_get_serialize(
            continuation_token = continuation_token,
            ids = ids,
            filter = filter,
            limit = limit,
    ...
    def _api212_snmp_managers_test_get_serialize(
        self,
        continuation_token,
        ids,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.12/snmp-managers/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
