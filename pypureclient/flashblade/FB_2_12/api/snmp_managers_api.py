...
class SNMPManagersApi(object):
    ...
    def api212_snmp_managers_delete_with_http_info(
        self,
        ...
        >>> thread = api.api212_snmp_managers_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api212_snmp_managers_get_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api212_snmp_managers_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_snmp_managers_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api212_snmp_managers_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api212_snmp_managers_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api212_snmp_managers_patch_with_http_info(snmp_manager, async_req=True)
        >>> result = thread.get()
        ...
        if snmp_manager is None:
            raise TypeError("Missing the required parameter `snmp_manager` when calling `api212_snmp_managers_patch`")
    ...
    def api212_snmp_managers_post_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api212_snmp_managers_post_with_http_info(snmp_manager, names, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'snmp_manager' is set
        if snmp_manager is None:
            raise TypeError("Missing the required parameter `snmp_manager` when calling `api212_snmp_managers_post`")
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api212_snmp_managers_post`")
    ...
    def api212_snmp_managers_test_get_with_http_info(
        self,
        continuation_token=None,  # type: str
        ids=None,  # type: List[str]
        filter=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api212_snmp_managers_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_snmp_managers_test_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api212_snmp_managers_test_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.12/snmp-managers/test', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
