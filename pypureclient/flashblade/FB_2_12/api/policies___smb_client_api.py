...
class PoliciesSMBClientApi(object):
    ...
    def api212_smb_client_policies_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_smb_client_policies_get`, must be a value greater than or equal to `0`")
    ...
    def api212_smb_client_policies_rules_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_smb_client_policies_rules_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
