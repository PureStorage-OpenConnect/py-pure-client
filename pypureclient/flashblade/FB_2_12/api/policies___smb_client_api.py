...
class PoliciesSMBClientApi(object):
    ...
    def api212_smb_client_policies_delete_with_http_info(
        ...
        >>> thread = api.api212_smb_client_policies_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api212_smb_client_policies_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api212_smb_client_policies_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_smb_client_policies_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api212_smb_client_policies_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api212_smb_client_policies_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api212_smb_client_policies_patch_with_http_info(policy, async_req=True)
        >>> result = thread.get()
        ...
        if policy is None:
            raise TypeError("Missing the required parameter `policy` when calling `api212_smb_client_policies_patch`")
    ...
    def api212_smb_client_policies_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api212_smb_client_policies_post_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api212_smb_client_policies_post`")
    ...
    def api212_smb_client_policies_rules_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api212_smb_client_policies_rules_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api212_smb_client_policies_rules_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api212_smb_client_policies_rules_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_smb_client_policies_rules_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api212_smb_client_policies_rules_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api212_smb_client_policies_rules_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api212_smb_client_policies_rules_patch_with_http_info(rule, async_req=True)
        >>> result = thread.get()
        ...
        if rule is None:
            raise TypeError("Missing the required parameter `rule` when calling `api212_smb_client_policies_rules_patch`")
    ...
    def api212_smb_client_policies_rules_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api212_smb_client_policies_rules_post_with_http_info(rule, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'rule' is set
        if rule is None:
            raise TypeError("Missing the required parameter `rule` when calling `api212_smb_client_policies_rules_post`")
