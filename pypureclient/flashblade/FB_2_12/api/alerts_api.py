...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_12.models.alert import Alert
from pypureclient.flashblade.FB_2_12.models.alert_get_response import AlertGetResponse
from pypureclient.flashblade.FB_2_12.models.alert_response import AlertResponse
...
class AlertsApi:
    ...
    @validate_call
    def api212_alerts_get_with_http_info(
        self,
        ...
        _param = self._api212_alerts_get_serialize(
    ...
    def _api212_alerts_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    @validate_call
    def api212_alerts_patch_with_http_info(
        self,
        ...
        _param = self._api212_alerts_patch_serialize(
    ...
    def _api212_alerts_patch_serialize(
        self,
        alerts_settings,
        ids,
        names,
