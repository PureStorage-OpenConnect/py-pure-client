...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_12.models.blade_get_response import BladeGetResponse
...
class BladesApi:
    ...
    @validate_call
    def api212_blades_get_with_http_info(
        self,
        ...
        _param = self._api212_blades_get_serialize(
    ...
    def _api212_blades_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
