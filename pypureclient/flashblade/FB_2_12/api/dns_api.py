...
class DNSApi(object):
    ...
    def api212_dns_get_with_http_info(
        self,
        ...
        >>> thread = api.api212_dns_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_dns_get`, must be a value greater than or equal to `1`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api212_dns_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api212_dns_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api212_dns_patch_with_http_info(dns, async_req=True)
        >>> result = thread.get()
        ...
        if dns is None:
            raise TypeError("Missing the required parameter `dns` when calling `api212_dns_patch`")
