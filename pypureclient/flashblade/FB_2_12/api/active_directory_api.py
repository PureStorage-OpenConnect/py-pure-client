...
class ActiveDirectoryApi(object):
    ...
    def api212_active_directory_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_active_directory_get`, must be a value greater than or equal to `0`")
    ...
    def api212_active_directory_test_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_active_directory_test_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
