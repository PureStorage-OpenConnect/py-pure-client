...
class CertificateGroupsApi:
    ...
    def api212_certificate_groups_certificates_delete_with_http_info(
        ...
        _param = self._api212_certificate_groups_certificates_delete_serialize(
    ...
    def _api212_certificate_groups_certificates_delete_serialize(
        self,
        certificate_ids,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.12/certificate-groups/certificates',
    ...
    def api212_certificate_groups_certificates_get_with_http_info(
        ...
        _param = self._api212_certificate_groups_certificates_get_serialize(
    ...
    def _api212_certificate_groups_certificates_get_serialize(
        self,
        continuation_token,
        certificate_ids,
        certificate_group_ids,
    ...
    def api212_certificate_groups_certificates_post_with_http_info(
        ...
        _param = self._api212_certificate_groups_certificates_post_serialize(
            certificate_ids = certificate_ids,
            certificate_group_ids = certificate_group_ids,
            certificate_group_names = certificate_group_names,
            certificate_names = certificate_names,
    ...
    def _api212_certificate_groups_certificates_post_serialize(
        self,
        certificate_ids,
        certificate_group_ids,
        certificate_group_names,
    ...
    def api212_certificate_groups_delete_with_http_info(
        ...
        _param = self._api212_certificate_groups_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api212_certificate_groups_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.12/certificate-groups',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api212_certificate_groups_get_with_http_info(
        ...
        _param = self._api212_certificate_groups_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api212_certificate_groups_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api212_certificate_groups_post_with_http_info(
        ...
        _param = self._api212_certificate_groups_post_serialize(
            names = names,
        )
    ...
    def _api212_certificate_groups_post_serialize(
        self,
        names,
    ) -> RequestSerialized:
    ...
    def api212_certificate_groups_uses_get_with_http_info(
        ...
        _param = self._api212_certificate_groups_uses_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api212_certificate_groups_uses_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.12/certificate-groups/uses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
