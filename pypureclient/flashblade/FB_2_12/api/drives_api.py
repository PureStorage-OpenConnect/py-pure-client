...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_12.models.drive_get_response import DriveGetResponse
...
class DrivesApi:
    ...
    @validate_call
    def api212_drives_get_with_http_info(
        self,
        ...
        _param = self._api212_drives_get_serialize(
    ...
    def _api212_drives_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
