...
class LinkAggregationGroupsApi:
    ...
    def api212_link_aggregation_groups_delete_with_http_info(
        ...
        _param = self._api212_link_aggregation_groups_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api212_link_aggregation_groups_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.12/link-aggregation-groups',
    ...
    def api212_link_aggregation_groups_get_with_http_info(
        ...
        _param = self._api212_link_aggregation_groups_get_serialize(
    ...
    def _api212_link_aggregation_groups_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api212_link_aggregation_groups_patch_with_http_info(
        ...
        _param = self._api212_link_aggregation_groups_patch_serialize(
    ...
    def _api212_link_aggregation_groups_patch_serialize(
        self,
    ...
    def api212_link_aggregation_groups_post_with_http_info(
        ...
        _param = self._api212_link_aggregation_groups_post_serialize(
            names = names,
            link_aggregation_group = link_aggregation_group,
        )
    ...
    def _api212_link_aggregation_groups_post_serialize(
        self,
        names,
        link_aggregation_group,
    ) -> RequestSerialized:
