...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_12.models.keytab_get_response import KeytabGetResponse
from pypureclient.flashblade.FB_2_12.models.keytab_post import KeytabPost
from pypureclient.flashblade.FB_2_12.models.keytab_response import KeytabResponse
...
class KeytabsApi:
    ...
    @validate_call
    def api212_keytabs_delete_with_http_info(
        self,
        ...
        _param = self._api212_keytabs_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api212_keytabs_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.12/keytabs',
    ...
    @validate_call
    def api212_keytabs_download_get_with_http_info(
        self,
        ...
        _param = self._api212_keytabs_download_get_serialize(
    ...
    def _api212_keytabs_download_get_serialize(
        self,
        keytab_ids,
        keytab_names,
    ) -> RequestSerialized:
        ...
        if keytab_ids is not None:
            ...
            _query_params.append(('keytab_ids', keytab_ids))
            
        if keytab_names is not None:
            
            _query_params.append(('keytab_names', keytab_names))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.12/keytabs/download',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api212_keytabs_get_with_http_info(
        self,
        ...
        _param = self._api212_keytabs_get_serialize(
    ...
    def _api212_keytabs_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    @validate_call
    def api212_keytabs_post_with_http_info(
        self,
        keytab: KeytabPost,
        ...
        _param = self._api212_keytabs_post_serialize(
            keytab = keytab,
    ...
    def _api212_keytabs_post_serialize(
        self,
        keytab,
        name_prefixes,
    ) -> RequestSerialized:
        ...
        if name_prefixes is not None:
            ...
            _query_params.append(('name_prefixes', name_prefixes))
    ...
    @validate_call
    def api212_keytabs_upload_post_with_http_info(
        self,
        ...
        _param = self._api212_keytabs_upload_post_serialize(
    ...
    def _api212_keytabs_upload_post_serialize(
        self,
        keytab_file,
        name_prefixes,
    ) -> RequestSerialized:
        ...
        if keytab_file is not None:
            _form_params.append(('keytab_file', keytab_file))
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2.12/keytabs/upload',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
