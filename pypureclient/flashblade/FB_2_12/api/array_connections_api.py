...
class ArrayConnectionsApi:
    ...
    def api212_array_connections_connection_key_get_with_http_info(
        ...
        _param = self._api212_array_connections_connection_key_get_serialize(
    ...
    def _api212_array_connections_connection_key_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.12/array-connections/connection-key',
    ...
    def api212_array_connections_connection_key_post_with_http_info(
        ...
        _param = self._api212_array_connections_connection_key_post_serialize(
        )
    ...
    def _api212_array_connections_connection_key_post_serialize(
        self,
    ) -> RequestSerialized:
    ...
    def api212_array_connections_delete_with_http_info(
        ...
        _param = self._api212_array_connections_delete_serialize(
            ids = ids,
    ...
    def _api212_array_connections_delete_serialize(
        self,
        ids,
        remote_ids,
        remote_names,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.12/array-connections',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api212_array_connections_get_with_http_info(
        ...
        _param = self._api212_array_connections_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api212_array_connections_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api212_array_connections_patch_with_http_info(
        ...
        _param = self._api212_array_connections_patch_serialize(
    ...
    def _api212_array_connections_patch_serialize(
        self,
        array_connection,
        ids,
        remote_ids,
    ...
    def api212_array_connections_path_get_with_http_info(
        ...
        _param = self._api212_array_connections_path_get_serialize(
            continuation_token = continuation_token,
            filter = filter,
            ids = ids,
            limit = limit,
    ...
    def _api212_array_connections_path_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.12/array-connections/path',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api212_array_connections_performance_replication_get_with_http_info(
        ...
        _param = self._api212_array_connections_performance_replication_get_serialize(
            continuation_token = continuation_token,
            end_time = end_time,
            filter = filter,
            ids = ids,
    ...
    def _api212_array_connections_performance_replication_get_serialize(
        self,
        continuation_token,
        end_time,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.12/array-connections/performance/replication',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api212_array_connections_post_with_http_info(
        ...
        _param = self._api212_array_connections_post_serialize(
            array_connection = array_connection,
        )
    ...
    def _api212_array_connections_post_serialize(
        self,
        array_connection,
    ) -> RequestSerialized:
