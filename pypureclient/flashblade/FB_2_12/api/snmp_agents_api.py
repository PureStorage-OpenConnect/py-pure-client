...
class SNMPAgentsApi:
    ...
    def api212_snmp_agents_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api212_snmp_agents_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api212_snmp_agents_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_snmp_agents_mib_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api212_snmp_agents_mib_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_snmp_agents_mib_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_snmp_agents_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api212_snmp_agents_patch_with_http_info(snmp_agent, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_snmp_agents_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
