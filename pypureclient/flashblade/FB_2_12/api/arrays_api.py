...
from pypureclient.flashblade.FB_2_12.models.array_factory_reset_token_get_response import ArrayFactoryResetTokenGetResponse
from pypureclient.flashblade.FB_2_12.models.array_factory_reset_token_response import ArrayFactoryResetTokenResponse
from pypureclient.flashblade.FB_2_12.models.array_get_response import ArrayGetResponse
from pypureclient.flashblade.FB_2_12.models.array_http_specific_performance_get import ArrayHttpSpecificPerformanceGet
from pypureclient.flashblade.FB_2_12.models.array_nfs_specific_performance_get import ArrayNfsSpecificPerformanceGet
from pypureclient.flashblade.FB_2_12.models.array_performance_get_response import ArrayPerformanceGetResponse
from pypureclient.flashblade.FB_2_12.models.array_performance_replication_get_resp import ArrayPerformanceReplicationGetResp
from pypureclient.flashblade.FB_2_12.models.array_response import ArrayResponse
from pypureclient.flashblade.FB_2_12.models.array_s3_specific_performance_get_resp import ArrayS3SpecificPerformanceGetResp
from pypureclient.flashblade.FB_2_12.models.array_space_get_response import ArraySpaceGetResponse
from pypureclient.flashblade.FB_2_12.models.arrays_supported_time_zones_get_response import ArraysSupportedTimeZonesGetResponse
from pypureclient.flashblade.FB_2_12.models.eula import Eula
from pypureclient.flashblade.FB_2_12.models.eula_get_response import EulaGetResponse
from pypureclient.flashblade.FB_2_12.models.eula_response import EulaResponse
...
class ArraysApi:
    ...
    def api212_arrays_eula_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api212_arrays_eula_get_with_http_info(continuation_token, filter, limit, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api212_arrays_eula_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_arrays_eula_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api212_arrays_eula_patch_with_http_info(eula, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_arrays_eula_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_arrays_factory_reset_token_delete_with_http_info(
        self,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.api212_arrays_factory_reset_token_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_arrays_factory_reset_token_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.12/arrays/factory-reset-token', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api212_arrays_factory_reset_token_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        limit: Annotated[Optional[conint(strict=True, ge=0)], Field(description="Limit the size of the response to the specified number of resources. A `limit` of `0` can be used to get the number of resources without getting all of the resources. It will be returned in the `total_item_count` field. If a client asks for a page size larger than the available number, the request is still valid. In that case the server just returns the available number of items, disregarding the client's page size request.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api212_arrays_factory_reset_token_get_with_http_info(continuation_token, filter, limit, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_arrays_factory_reset_token_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.12/arrays/factory-reset-token', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api212_arrays_factory_reset_token_post_with_http_info(
        self,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.api212_arrays_factory_reset_token_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_arrays_factory_reset_token_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.12/arrays/factory-reset-token', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api212_arrays_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        limit: Annotated[Optional[conint(strict=True, ge=0)], Field(description="Limit the size of the response to the specified number of resources. A `limit` of `0` can be used to get the number of resources without getting all of the resources. It will be returned in the `total_item_count` field. If a client asks for a page size larger than the available number, the request is still valid. In that case the server just returns the available number of items, disregarding the client's page size request.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api212_arrays_get_with_http_info(continuation_token, filter, limit, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_arrays_http_specific_performance_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api212_arrays_http_specific_performance_get_with_http_info(end_time, resolution, start_time, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_arrays_http_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.12/arrays/http-specific-performance', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api212_arrays_nfs_specific_performance_get_with_http_info(
        self,
        end_time: Annotated[Optional[conint(strict=True, ge=0)], Field(description="When the time window ends (in milliseconds since epoch).")] = None,
        resolution: Annotated[Optional[conint(strict=True, ge=0)], Field(description="The desired ms between samples. Available resolutions may depend on data type, `start_time` and `end_time`. In general `1000`, `30000`, `300000`, `1800000`, `7200000`, and `86400000` are possible values.")] = None,
        start_time: Annotated[Optional[conint(strict=True, ge=0)], Field(description="When the time window starts (in milliseconds since epoch).")] = None,
        **kwargs
        ...
        >>> thread = api.api212_arrays_nfs_specific_performance_get_with_http_info(end_time, resolution, start_time, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_arrays_nfs_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.12/arrays/nfs-specific-performance', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api212_arrays_patch_with_http_info(
        self,
        array: Array,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.api212_arrays_patch_with_http_info(array, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_arrays_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_arrays_performance_get_with_http_info(
        self,
        end_time: Annotated[Optional[conint(strict=True, ge=0)], Field(description="When the time window ends (in milliseconds since epoch).")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api212_arrays_performance_get_with_http_info(end_time, protocol, resolution, start_time, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_arrays_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.12/arrays/performance', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api212_arrays_performance_replication_get_with_http_info(
        self,
        end_time: Annotated[Optional[conint(strict=True, ge=0)], Field(description="When the time window ends (in milliseconds since epoch).")] = None,
        resolution: Annotated[Optional[conint(strict=True, ge=0)], Field(description="The desired ms between samples. Available resolutions may depend on data type, `start_time` and `end_time`. In general `1000`, `30000`, `300000`, `1800000`, `7200000`, and `86400000` are possible values.")] = None,
        start_time: Annotated[Optional[conint(strict=True, ge=0)], Field(description="When the time window starts (in milliseconds since epoch).")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api212_arrays_performance_replication_get_with_http_info(end_time, resolution, start_time, type, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_arrays_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.12/arrays/performance/replication', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api212_arrays_s3_specific_performance_get_with_http_info(
        self,
        end_time: Annotated[Optional[conint(strict=True, ge=0)], Field(description="When the time window ends (in milliseconds since epoch).")] = None,
        resolution: Annotated[Optional[conint(strict=True, ge=0)], Field(description="The desired ms between samples. Available resolutions may depend on data type, `start_time` and `end_time`. In general `1000`, `30000`, `300000`, `1800000`, `7200000`, and `86400000` are possible values.")] = None,
        start_time: Annotated[Optional[conint(strict=True, ge=0)], Field(description="When the time window starts (in milliseconds since epoch).")] = None,
        **kwargs
        ...
        >>> thread = api.api212_arrays_s3_specific_performance_get_with_http_info(end_time, resolution, start_time, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_arrays_s3_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.12/arrays/s3-specific-performance', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api212_arrays_space_get_with_http_info(
        self,
        end_time: Annotated[Optional[conint(strict=True, ge=0)], Field(description="When the time window ends (in milliseconds since epoch).")] = None,
        resolution: Annotated[Optional[conint(strict=True, ge=0)], Field(description="The desired ms between samples. Available resolutions may depend on data type, `start_time` and `end_time`. In general `1000`, `30000`, `300000`, `1800000`, `7200000`, and `86400000` are possible values.")] = None,
        start_time: Annotated[Optional[conint(strict=True, ge=0)], Field(description="When the time window starts (in milliseconds since epoch).")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api212_arrays_space_get_with_http_info(end_time, resolution, start_time, type, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_arrays_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_arrays_supported_time_zones_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Exclude resources that don't match the specified criteria.")] = None,
        limit: Annotated[Optional[conint(strict=True, ge=0)], Field(description="Limit the size of the response to the specified number of resources. A `limit` of `0` can be used to get the number of resources without getting all of the resources. It will be returned in the `total_item_count` field. If a client asks for a page size larger than the available number, the request is still valid. In that case the server just returns the available number of items, disregarding the client's page size request.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api212_arrays_supported_time_zones_get_with_http_info(continuation_token, filter, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_arrays_supported_time_zones_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.12/arrays/supported-time-zones', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
