...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_12.models.session_get_response import SessionGetResponse
...
class SessionsApi:
    ...
    @validate_call
    def api212_sessions_get_with_http_info(
        self,
        ...
        _param = self._api212_sessions_get_serialize(
    ...
    def _api212_sessions_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.12/sessions',
