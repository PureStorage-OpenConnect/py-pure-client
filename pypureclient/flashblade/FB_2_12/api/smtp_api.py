...
from pypureclient.flashblade.FB_2_12.models.smtp_server_get_response import SmtpServerGetResponse
from pypureclient.flashblade.FB_2_12.models.smtp_server_response import SmtpServerResponse
...
class SMTPApi:
    ...
    @validate_call
    def api212_smtp_servers_get_with_http_info(
        self,
        ...
        _param = self._api212_smtp_servers_get_serialize(
    ...
    def _api212_smtp_servers_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.12/smtp-servers',
    ...
    @validate_call
    def api212_smtp_servers_patch_with_http_info(
        self,
        smtp: SmtpServer,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
        ...
        _param = self._api212_smtp_servers_patch_serialize(
            smtp = smtp,
        )
    ...
    def _api212_smtp_servers_patch_serialize(
        self,
        smtp,
    ) -> RequestSerialized:
