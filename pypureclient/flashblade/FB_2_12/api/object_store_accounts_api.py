...
class ObjectStoreAccountsApi:
    ...
    def api212_object_store_accounts_delete_with_http_info(
        ...
        _param = self._api212_object_store_accounts_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api212_object_store_accounts_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.12/object-store-accounts',
    ...
    def api212_object_store_accounts_get_with_http_info(
        ...
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[ObjectStoreAccountGetResponse]:
        ...
        _param = self._api212_object_store_accounts_get_serialize(
    ...
    def _api212_object_store_accounts_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api212_object_store_accounts_patch_with_http_info(
        ...
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[ObjectStoreAccountResponse]:
        ...
        _param = self._api212_object_store_accounts_patch_serialize(
    ...
    def _api212_object_store_accounts_patch_serialize(
        self,
        ...
        if object_store_account is not None:
            _body_params = object_store_account
    ...
    def api212_object_store_accounts_post_with_http_info(
        ...
        _param = self._api212_object_store_accounts_post_serialize(
            names = names,
            object_store_account = object_store_account,
        )
    ...
    def _api212_object_store_accounts_post_serialize(
        self,
        names,
        object_store_account,
    ) -> RequestSerialized:
