...
class FileSystemsApi(object):
    ...
    def api212_file_systems_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_file_systems_get`, must be a value greater than or equal to `0`")
    ...
    def api212_file_systems_groups_performance_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_file_systems_groups_performance_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api212_file_systems_locks_clients_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_file_systems_locks_clients_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api212_file_systems_locks_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_file_systems_locks_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api212_file_systems_performance_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_file_systems_performance_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api212_file_systems_policies_all_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_file_systems_policies_all_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api212_file_systems_policies_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_file_systems_policies_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api212_file_systems_sessions_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_file_systems_sessions_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api212_file_systems_users_performance_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api212_file_systems_users_performance_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
