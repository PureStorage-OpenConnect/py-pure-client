...
from pypureclient.flashblade.FB_2_12.models.group_quota_get_response import GroupQuotaGetResponse
from pypureclient.flashblade.FB_2_12.models.group_quota_patch import GroupQuotaPatch
from pypureclient.flashblade.FB_2_12.models.group_quota_post import GroupQuotaPost
from pypureclient.flashblade.FB_2_12.models.group_quota_response import GroupQuotaResponse
from pypureclient.flashblade.FB_2_12.models.quota_setting import QuotaSetting
from pypureclient.flashblade.FB_2_12.models.quota_setting_get_response import QuotaSettingGetResponse
from pypureclient.flashblade.FB_2_12.models.quota_setting_response import QuotaSettingResponse
from pypureclient.flashblade.FB_2_12.models.user_quota_get_response import UserQuotaGetResponse
from pypureclient.flashblade.FB_2_12.models.user_quota_patch import UserQuotaPatch
from pypureclient.flashblade.FB_2_12.models.user_quota_post import UserQuotaPost
from pypureclient.flashblade.FB_2_12.models.user_quota_response import UserQuotaResponse
...
class QuotasApi:
    ...
    def api212_quotas_groups_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api212_quotas_groups_delete_with_http_info(file_system_ids, file_system_names, gids, group_names, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api212_quotas_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_quotas_groups_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api212_quotas_groups_get_with_http_info(continuation_token, file_system_ids, file_system_names, filter, gids, group_names, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_quotas_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_quotas_groups_patch_with_http_info(
        self,
        file_system_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system IDs. If after filtering, there is not at least one resource that matches each of the elements of `file_system_ids`, then an error is returned. This cannot be provided together with the `file_system_names` query parameter.")] = None,
        file_system_names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system names. If there is not at least one resource that matches each of the elements of `file_system_names`, then an error is returned.")] = None,
        gids: Annotated[Optional[conlist(StrictInt)], Field(description="A comma-separated list of group IDs. If there is not at least one resource that matches each of the elements of `gids`, then an error is returned. This cannot be provided together with `group_names` query parameter.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api212_quotas_groups_patch_with_http_info(file_system_ids, file_system_names, gids, group_names, names, quota, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_quotas_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_quotas_groups_post_with_http_info(
        self,
        file_system_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system IDs. If after filtering, there is not at least one resource that matches each of the elements of `file_system_ids`, then an error is returned. This cannot be provided together with the `file_system_names` query parameter.")] = None,
        file_system_names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system names. If there is not at least one resource that matches each of the elements of `file_system_names`, then an error is returned.")] = None,
        gids: Annotated[Optional[conlist(StrictInt)], Field(description="A comma-separated list of group IDs. If there is not at least one resource that matches each of the elements of `gids`, then an error is returned. This cannot be provided together with `group_names` query parameter.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api212_quotas_groups_post_with_http_info(file_system_ids, file_system_names, gids, group_names, quota, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_quotas_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_quotas_settings_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api212_quotas_settings_get_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_quotas_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_quotas_settings_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api212_quotas_settings_patch_with_http_info(quota_setting, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_quotas_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.12/quotas/settings', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api212_quotas_users_delete_with_http_info(
        self,
        file_system_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system IDs. If after filtering, there is not at least one resource that matches each of the elements of `file_system_ids`, then an error is returned. This cannot be provided together with the `file_system_names` query parameter.")] = None,
        file_system_names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system names. If there is not at least one resource that matches each of the elements of `file_system_names`, then an error is returned.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api212_quotas_users_delete_with_http_info(file_system_ids, file_system_names, names, uids, user_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_quotas_users_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_quotas_users_get_with_http_info(
        self,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        file_system_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system IDs. If after filtering, there is not at least one resource that matches each of the elements of `file_system_ids`, then an error is returned. This cannot be provided together with the `file_system_names` query parameter.")] = None,
        file_system_names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system names. If there is not at least one resource that matches each of the elements of `file_system_names`, then an error is returned.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api212_quotas_users_get_with_http_info(continuation_token, file_system_ids, file_system_names, filter, limit, names, offset, sort, uids, user_names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_quotas_users_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_quotas_users_patch_with_http_info(
        self,
        file_system_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system IDs. If after filtering, there is not at least one resource that matches each of the elements of `file_system_ids`, then an error is returned. This cannot be provided together with the `file_system_names` query parameter.")] = None,
        file_system_names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system names. If there is not at least one resource that matches each of the elements of `file_system_names`, then an error is returned.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api212_quotas_users_patch_with_http_info(file_system_ids, file_system_names, names, uids, user_names, quota, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_quotas_users_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_quotas_users_post_with_http_info(
        self,
        file_system_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system IDs. If after filtering, there is not at least one resource that matches each of the elements of `file_system_ids`, then an error is returned. This cannot be provided together with the `file_system_names` query parameter.")] = None,
        file_system_names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system names. If there is not at least one resource that matches each of the elements of `file_system_names`, then an error is returned.")] = None,
        uids: Annotated[Optional[conlist(StrictInt)], Field(description="A comma-separated list of user IDs. If there is not at least one resource that matches each of the elements of `uids`, then an error is returned. This cannot be provided together with `user_names` query parameter.")] = None,
        ...
        **kwargs
        ...
        >>> thread = api.api212_quotas_users_post_with_http_info(file_system_ids, file_system_names, uids, user_names, quota, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_quotas_users_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
