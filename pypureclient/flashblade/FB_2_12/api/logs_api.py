...
class LogsApi:
    ...
    def api212_logs_async_download_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api212_logs_async_download_get_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api212_logs_async_download_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_logs_async_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api212_logs_async_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_logs_async_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_logs_async_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_logs_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api212_logs_get_with_http_info(end_time, start_time, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_logs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
