...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_12.models.hardware import Hardware
from pypureclient.flashblade.FB_2_12.models.hardware_get_response import HardwareGetResponse
from pypureclient.flashblade.FB_2_12.models.hardware_response import HardwareResponse
...
class HardwareApi:
    ...
    @validate_call
    def api212_hardware_get_with_http_info(
        self,
    ...
    ) -> ApiResponse[HardwareGetResponse]:
        """GET hardware
        ...
        _param = self._api212_hardware_get_serialize(
            ids = ids,
            names = names,
    ...
    def _api212_hardware_get_serialize(
        self,
        ids,
        names,
        continuation_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.12/hardware',
    ...
    @validate_call
    def api212_hardware_patch_with_http_info(
        self,
        hardware: Hardware,
        ids: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[List[StrictStr]], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat, Field(gt=0)], Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]]] = None
    ) -> ApiResponse[HardwareResponse]:
        """PATCH hardware
        ...
        _param = self._api212_hardware_patch_serialize(
            hardware = hardware,
            ids = ids,
            names = names,
        )
    ...
    def _api212_hardware_patch_serialize(
        self,
        hardware,
        ids,
        names,
