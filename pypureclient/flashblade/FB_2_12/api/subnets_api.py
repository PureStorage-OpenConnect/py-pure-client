...
class SubnetsApi:
    ...
    def api212_subnets_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api212_subnets_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api212_subnets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_subnets_get_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api212_subnets_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_subnets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_subnets_patch_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api212_subnets_patch_with_http_info(subnet, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_subnets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_subnets_post_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.api212_subnets_post_with_http_info(names, subnet, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_subnets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
