...
from typing_extensions import Annotated
from pypureclient.flashblade.FB_2_12.models.subnet import Subnet
from pypureclient.flashblade.FB_2_12.models.subnet_get_response import SubnetGetResponse
from pypureclient.flashblade.FB_2_12.models.subnet_response import SubnetResponse
...
class SubnetsApi:
    ...
    def api212_subnets_delete_with_http_info(
        ...
        _param = self._api212_subnets_delete_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api212_subnets_delete_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2.12/subnets',
    ...
    def api212_subnets_get_with_http_info(
        ...
        _param = self._api212_subnets_get_serialize(
    ...
    def _api212_subnets_get_serialize(
        self,
        continuation_token,
        filter,
        ids,
    ...
    def api212_subnets_patch_with_http_info(
        ...
        _param = self._api212_subnets_patch_serialize(
            subnet = subnet,
            ids = ids,
            names = names,
        )
    ...
    def _api212_subnets_patch_serialize(
        self,
        subnet,
        ids,
        names,
    ...
    def api212_subnets_post_with_http_info(
        ...
        _param = self._api212_subnets_post_serialize(
            names = names,
            subnet = subnet,
        )
    ...
    def _api212_subnets_post_serialize(
        self,
        names,
        subnet,
    ) -> RequestSerialized:
