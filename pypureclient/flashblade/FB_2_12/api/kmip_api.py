...
from pypureclient.flashblade.FB_2_12.models.kmip_server import KmipServer
from pypureclient.flashblade.FB_2_12.models.kmip_server_response import KmipServerResponse
...
class KMIPApi:
    ...
    def api212_kmip_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api212_kmip_delete_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api212_kmip_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_kmip_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api212_kmip_get_with_http_info(continuation_token, filter, ids, limit, names, offset, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_kmip_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_kmip_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.api212_kmip_patch_with_http_info(kmip_server, ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_kmip_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_kmip_post_with_http_info(
        self,
        kmip_server: KmipServer,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        **kwargs
        ...
        >>> thread = api.api212_kmip_post_with_http_info(kmip_server, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_kmip_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api212_kmip_test_get_with_http_info(
        self,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        **kwargs
        ...
        >>> thread = api.api212_kmip_test_get_with_http_info(ids, names, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api212_kmip_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
