...
class SupportApi:
    ...
    def api212_support_get_with_http_info(
        ...
        _param = self._api212_support_get_serialize(
            ids = ids,
            names = names,
        )
    ...
    def _api212_support_get_serialize(
        self,
        ids,
        names,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.12/support',
    ...
    def api212_support_patch_with_http_info(
        ...
        _param = self._api212_support_patch_serialize(
            support = support,
        )
    ...
    def _api212_support_patch_serialize(
        self,
        support,
    ) -> RequestSerialized:
    ...
    def api212_support_test_get_with_http_info(
        ...
        _param = self._api212_support_test_get_serialize(
            filter = filter,
            sort = sort,
            test_type = test_type,
        )
    ...
    def _api212_support_test_get_serialize(
        self,
        filter,
        sort,
        test_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2.12/support/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
