...
from pypureclient.flashblade.FB_2_25.models.object_store_remote_credential_get_resp import ObjectStoreRemoteCredentialGetResp
from pypureclient.flashblade.FB_2_25.models.object_store_remote_credentials import ObjectStoreRemoteCredentials
from pypureclient.flashblade.FB_2_25.models.object_store_remote_credentials_post import ObjectStoreRemoteCredentialsPost
from pypureclient.flashblade.FB_2_25.models.object_store_remote_credentials_resp import ObjectStoreRemoteCredentialsResp
from typing import Optional
...
class ObjectStoreRemoteCredentialsApi:
    ...
    def api225_object_store_remote_credentials_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api225_object_store_remote_credentials_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.25/object-store-remote-credentials', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api225_object_store_remote_credentials_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_object_store_remote_credentials_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.25/object-store-remote-credentials', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api225_object_store_remote_credentials_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_object_store_remote_credentials_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.25/object-store-remote-credentials', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api225_object_store_remote_credentials_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_object_store_remote_credentials_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/2.25/object-store-remote-credentials', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
