...
from pypureclient.flashblade.FB_2_25.models.maintenance_window_post import MaintenanceWindowPost
from pypureclient.flashblade.FB_2_25.models.maintenance_windows_get_response import MaintenanceWindowsGetResponse
from pypureclient.flashblade.FB_2_25.models.maintenance_windows_response import MaintenanceWindowsResponse
from typing import Optional
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api225_maintenance_windows_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_maintenance_windows_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_maintenance_windows_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
