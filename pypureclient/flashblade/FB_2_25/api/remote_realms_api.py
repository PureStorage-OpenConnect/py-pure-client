...
from pypureclient.flashblade.FB_2_25.models.remote_realms_response import RemoteRealmsResponse
from typing import Optional
...
class RemoteRealmsApi:
    ...
    def api225_remote_realms_get_with_http_info(
        self,
