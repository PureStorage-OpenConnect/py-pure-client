...
from pypureclient.flashblade.FB_2_25.models.snmp_agent_get_response import SnmpAgentGetResponse
from pypureclient.flashblade.FB_2_25.models.snmp_agent_mib_response import SnmpAgentMibResponse
from pypureclient.flashblade.FB_2_25.models.snmp_agent_response import SnmpAgentResponse
from typing import Optional
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api225_snmp_agents_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_snmp_agents_mib_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_snmp_agents_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
