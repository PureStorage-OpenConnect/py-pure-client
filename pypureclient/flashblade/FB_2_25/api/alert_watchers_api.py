...
from pypureclient.flashblade.FB_2_25.models.alert_watcher import AlertWatcher
from pypureclient.flashblade.FB_2_25.models.alert_watcher_get_response import AlertWatcherGetResponse
from pypureclient.flashblade.FB_2_25.models.alert_watcher_post import AlertWatcherPost
from pypureclient.flashblade.FB_2_25.models.alert_watcher_response import AlertWatcherResponse
from pypureclient.flashblade.FB_2_25.models.test_result_response import TestResultResponse
from typing import Optional
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api225_alert_watchers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_alert_watchers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_alert_watchers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_alert_watchers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api225_alert_watchers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
