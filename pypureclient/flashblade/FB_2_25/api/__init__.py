...
__class_apis_dict = { 
    ...
    'AuditLogTargetForFileSystemsApi': __LazyApiLoader('audit_log_target_for_file_systems_api', 'AuditLogTargetForFileSystemsApi'),
    'AuditLogTargetForObjectStoreApi': __LazyApiLoader('audit_log_target_for_object_store_api', 'AuditLogTargetForObjectStoreApi'),
    ...
    'FileSystemJunctionsApi': __LazyApiLoader('file_system_junctions_api', 'FileSystemJunctionsApi'),
    ...
    'ObjectStoreAccountExportsApi': __LazyApiLoader('object_store_account_exports_api', 'ObjectStoreAccountExportsApi'),
    ...
    'PoliciesAuditForObjectStoreApi': __LazyApiLoader('policies_audit_for_object_store_api', 'PoliciesAuditForObjectStoreApi'),
    'PoliciesDataEvictionApi': __LazyApiLoader('policies_data_eviction_api', 'PoliciesDataEvictionApi'),
    'PoliciesManagementAccessApi': __LazyApiLoader('policies_management_access_api', 'PoliciesManagementAccessApi'),
    'PoliciesManagementAuthenticationApi': __LazyApiLoader('policies_management_authentication_api', 'PoliciesManagementAuthenticationApi'),
    ...
    'PoliciesS3ExportApi': __LazyApiLoader('policies_s3_export_api', 'PoliciesS3ExportApi'),
    ...
    'PoliciesUserAndGroupQuotaPolicyApi': __LazyApiLoader('policies_user_and_group_quota_policy_api', 'PoliciesUserAndGroupQuotaPolicyApi'),
    'PoliciesWORMDataApi': __LazyApiLoader('policies_worm_data_api', 'PoliciesWORMDataApi'),
    'PresetsApi': __LazyApiLoader('presets_api', 'PresetsApi'),
    ...
    'RealmConnectionsApi': __LazyApiLoader('realm_connections_api', 'RealmConnectionsApi'),
    'RealmsApi': __LazyApiLoader('realms_api', 'RealmsApi'),
    'RemoteArraysApi': __LazyApiLoader('remote_arrays_api', 'RemoteArraysApi'),
    'RemoteRealmsApi': __LazyApiLoader('remote_realms_api', 'RemoteRealmsApi'),
    'ResiliencyGroupsApi': __LazyApiLoader('resiliency_groups_api', 'ResiliencyGroupsApi'),
    'ResourceAccessesApi': __LazyApiLoader('resource_accesses_api', 'ResourceAccessesApi'),
    ...
    'UserGroupQuotasApi': __LazyApiLoader('user_group_quotas_api', 'UserGroupQuotasApi'),
    'VerificationKeysApi': __LazyApiLoader('verification_keys_api', 'VerificationKeysApi'),
    'WorkloadsApi': __LazyApiLoader('workloads_api', 'WorkloadsApi'),
}
