...
from pypureclient.flashblade.FB_2_25.models.file_lock import FileLock


class FileLockGetResponse(BaseModel):
    """
    FileLockGetResponse
    """
    ...
    items: Optional[conlist(FileLock)] = Field(default=None, description="A list of file locks.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileLockGetResponse:
        """Create an instance of FileLockGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileLockGetResponse:
        """Create an instance of FileLockGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileLockGetResponse.parse_obj(obj)

        _obj = FileLockGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [FileLock.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
