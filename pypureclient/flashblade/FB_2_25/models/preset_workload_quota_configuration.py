...
from pypureclient.flashblade.FB_2_25.models.preset_workload_quota_rule import PresetWorkloadQuotaRule


class PresetWorkloadQuotaConfiguration(BaseModel):
    """
    ...
    rules: conlist(PresetWorkloadQuotaRule, max_items=1, min_items=1) = Field(default=..., description="Rules describe the desired quota limit and enforcement.")
    __properties = ["policy_action", "name", "naming_patterns", "rules"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PresetWorkloadQuotaConfiguration:
        """Create an instance of PresetWorkloadQuotaConfiguration from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PresetWorkloadQuotaConfiguration:
        """Create an instance of PresetWorkloadQuotaConfiguration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PresetWorkloadQuotaConfiguration.parse_obj(obj)

        _obj = PresetWorkloadQuotaConfiguration.construct(_fields_set=None, **{
            ...
            "rules": [PresetWorkloadQuotaRule.from_dict(_item) for _item in obj.get("rules")] if obj.get("rules") is not None else None
        })
        return _obj
