...
from pypureclient.flashblade.FB_2_25.models.location_reference import LocationReference
from pypureclient.flashblade.FB_2_25.models.member_link import MemberLink
...
class PolicyMemberWithRemote(BaseModel):
    ...
    policy: Optional[LocationReference] = Field(default=None, description="Reference to the policy. Location can be array or realm.")
    ...
    __properties = ["context", "member", "policy", "link"]
    ...
    def to_dict(self, include_readonly: bool=True) -> Dict[str, Any]:
        ...
        if _include_in_dict('link', include_readonly, excluded_fields, none_fields):
            _dict['link'] = self.link.to_dict(include_readonly=include_readonly)
        return _dict
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyMemberWithRemote:
        """Create an instance of PolicyMemberWithRemote from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> PolicyMemberWithRemote:
        """Create an instance of PolicyMemberWithRemote from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyMemberWithRemote.parse_obj(obj)

        _obj = PolicyMemberWithRemote.construct(_fields_set=None, **{
            ...
            "link": MemberLink.from_dict(obj.get("link")) if obj.get("link") is not None else None
        })
        return _obj
