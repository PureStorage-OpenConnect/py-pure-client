...
class FixedReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixedReference:
        """Create an instance of FixedReference from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FixedReference:
        """Create an instance of FixedReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FixedReference.parse_obj(obj)

        _obj = FixedReference.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
