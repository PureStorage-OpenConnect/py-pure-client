...
from pypureclient.flashblade.FB_2_25.models.admin_api_token import AdminApiToken
from pypureclient.flashblade.FB_2_25.models.error_context_response_errors import ErrorContextResponseErrors


class AdminApiTokenGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(AdminApiToken)] = Field(default=None, description="A list of administrator API tokens.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdminApiTokenGetResponse:
        """Create an instance of AdminApiTokenGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AdminApiTokenGetResponse:
        """Create an instance of AdminApiTokenGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdminApiTokenGetResponse.parse_obj(obj)

        _obj = AdminApiTokenGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [AdminApiToken.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
