...
class FixedReferenceWithIsLocal(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixedReferenceWithIsLocal:
        """Create an instance of FixedReferenceWithIsLocal from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FixedReferenceWithIsLocal:
        """Create an instance of FixedReferenceWithIsLocal from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FixedReferenceWithIsLocal.parse_obj(obj)

        _obj = FixedReferenceWithIsLocal.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
