...
from pypureclient.flashblade.FB_2_25.models.trust_policy_rule_condition import TrustPolicyRuleCondition
...
class TrustPolicyRulePost(BaseModel):
    ...
    __properties = ["actions", "conditions", "effect", "policy", "principals"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrustPolicyRulePost:
        """Create an instance of TrustPolicyRulePost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TrustPolicyRulePost:
        """Create an instance of TrustPolicyRulePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrustPolicyRulePost.parse_obj(obj)

        _obj = TrustPolicyRulePost.construct(_fields_set=None, **{
