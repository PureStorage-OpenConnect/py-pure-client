...
class SshCertificateAuthorityPolicyGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SshCertificateAuthorityPolicy)] = Field(default=None, description="A list of SSH certificate authority policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SshCertificateAuthorityPolicyGetResponse:
        """Create an instance of SshCertificateAuthorityPolicyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SshCertificateAuthorityPolicyGetResponse:
        """Create an instance of SshCertificateAuthorityPolicyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SshCertificateAuthorityPolicyGetResponse.parse_obj(obj)

        _obj = SshCertificateAuthorityPolicyGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [SshCertificateAuthorityPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
