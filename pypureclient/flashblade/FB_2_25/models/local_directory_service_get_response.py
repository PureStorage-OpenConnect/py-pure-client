...
from pypureclient.flashblade.FB_2_25.models.local_directory_service import LocalDirectoryService


class LocalDirectoryServiceGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(LocalDirectoryService)] = Field(default=None, description="Displays a list of all items after filtering. The values are displayed for each name, if meaningful.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LocalDirectoryServiceGetResponse:
        """Create an instance of LocalDirectoryServiceGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> LocalDirectoryServiceGetResponse:
        """Create an instance of LocalDirectoryServiceGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LocalDirectoryServiceGetResponse.parse_obj(obj)

        _obj = LocalDirectoryServiceGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [LocalDirectoryService.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
