...
from pypureclient.flashblade.FB_2_25.models.file_system_user_quota import FileSystemUserQuota


class FileSystemUserQuotaGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(FileSystemUserQuota)] = Field(default=None, description="A list of users and rules enforceable on them.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemUserQuotaGetResponse:
        """Create an instance of FileSystemUserQuotaGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemUserQuotaGetResponse:
        """Create an instance of FileSystemUserQuotaGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemUserQuotaGetResponse.parse_obj(obj)

        _obj = FileSystemUserQuotaGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [FileSystemUserQuota.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
