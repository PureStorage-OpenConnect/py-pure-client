...
from pypureclient.flashblade.FB_2_25.models.trust_policy_rule import TrustPolicyRule


class ObjectStoreTrustPolicy(BaseModel):
    """
    ...
    role: Optional[FixedReference] = Field(default=None, description="Object Store Role to which the Trust Policy applies.")
    rules: Optional[conlist(TrustPolicyRule)] = Field(default=None, description="List of rules establishing the trust policy")
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "context", "role", "rules"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectStoreTrustPolicy:
        """Create an instance of ObjectStoreTrustPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ObjectStoreTrustPolicy:
        """Create an instance of ObjectStoreTrustPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectStoreTrustPolicy.parse_obj(obj)

        _obj = ObjectStoreTrustPolicy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "rules": [TrustPolicyRule.from_dict(_item) for _item in obj.get("rules")] if obj.get("rules") is not None else None
        })
        return _obj
