...
from pypureclient.flashblade.FB_2_25.models.qos_policy import QosPolicy


class QosPoliciesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(QosPolicy)] = Field(default=None, description="A list of QoS policy objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QosPoliciesGetResponse:
        """Create an instance of QosPoliciesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> QosPoliciesGetResponse:
        """Create an instance of QosPoliciesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QosPoliciesGetResponse.parse_obj(obj)

        _obj = QosPoliciesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [QosPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
