...
class SmbSharePolicyPost(BaseModel):
    """
    SmbSharePolicyPost
    """
    ...
    rules: Optional[conlist(SmbSharePolicyRulePost, max_items=200)] = Field(default=None, description="All of the rules that are part of this policy.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmbSharePolicyPost:
        """Create an instance of SmbSharePolicyPost from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmbSharePolicyPost:
        """Create an instance of SmbSharePolicyPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmbSharePolicyPost.parse_obj(obj)

        _obj = SmbSharePolicyPost.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "rules": [SmbSharePolicyRulePost.from_dict(_item) for _item in obj.get("rules")] if obj.get("rules") is not None else None
        })
        return _obj
