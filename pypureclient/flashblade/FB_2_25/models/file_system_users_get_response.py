...
from pypureclient.flashblade.FB_2_25.models.file_system_user import FileSystemUser


class FileSystemUsersGetResponse(BaseModel):
    """
    FileSystemUsersGetResponse
    """
    ...
    items: Optional[conlist(FileSystemUser)] = Field(default=None, description="A list of quota objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemUsersGetResponse:
        """Create an instance of FileSystemUsersGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemUsersGetResponse:
        """Create an instance of FileSystemUsersGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemUsersGetResponse.parse_obj(obj)

        _obj = FileSystemUsersGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [FileSystemUser.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
