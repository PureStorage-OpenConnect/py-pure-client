...
class AuditObjectStorePolicyWithContext(BaseModel):
    """
    ...
    __properties = ["context", "id", "name", "realms", "enabled", "is_local", "location", "policy_type", "log_targets"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditObjectStorePolicyWithContext:
        """Create an instance of AuditObjectStorePolicyWithContext from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditObjectStorePolicyWithContext:
        """Create an instance of AuditObjectStorePolicyWithContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditObjectStorePolicyWithContext.parse_obj(obj)

        _obj = AuditObjectStorePolicyWithContext.construct(_fields_set=None, **{
