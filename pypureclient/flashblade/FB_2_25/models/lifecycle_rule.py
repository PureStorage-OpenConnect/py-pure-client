...
class LifecycleRule(BaseModel):
    ...
    __properties = ["id", "name", "context", "abort_incomplete_multipart_uploads_after", "keep_current_version_for", "keep_current_version_until", "bucket", "cleanup_expired_object_delete_marker", "enabled", "keep_previous_version_for", "prefix", "rule_id"]
