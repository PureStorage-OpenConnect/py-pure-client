...
from pypureclient.flashblade.FB_2_25.models.smb_client_policy_rule_in_policy import SmbClientPolicyRuleInPolicy


class SmbClientPolicyPatch(BaseModel):
    """
    ...
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "version", "access_based_enumeration_enabled", "rules"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmbClientPolicyPatch:
        """Create an instance of SmbClientPolicyPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SmbClientPolicyPatch:
        """Create an instance of SmbClientPolicyPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmbClientPolicyPatch.parse_obj(obj)

        _obj = SmbClientPolicyPatch.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
