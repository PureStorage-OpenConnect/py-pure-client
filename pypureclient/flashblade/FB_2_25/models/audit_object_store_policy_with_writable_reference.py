...
class AuditObjectStorePolicyWithWritableReference(BaseModel):
    """
    ...
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "log_targets"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditObjectStorePolicyWithWritableReference:
        """Create an instance of AuditObjectStorePolicyWithWritableReference from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AuditObjectStorePolicyWithWritableReference:
        """Create an instance of AuditObjectStorePolicyWithWritableReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditObjectStorePolicyWithWritableReference.parse_obj(obj)

        _obj = AuditObjectStorePolicyWithWritableReference.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
