...
from pypureclient.flashblade.FB_2_25.models.smb_client_policy_rule_post_in_policy import SmbClientPolicyRulePostInPolicy
...
class SmbClientPolicyPost(BaseModel):
    ...
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "access_based_enumeration_enabled", "rules"]
