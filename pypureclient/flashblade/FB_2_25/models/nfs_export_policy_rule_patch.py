...
class NfsExportPolicyRulePatch(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NfsExportPolicyRulePatch:
        """Create an instance of NfsExportPolicyRulePatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> NfsExportPolicyRulePatch:
        """Create an instance of NfsExportPolicyRulePatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NfsExportPolicyRulePatch.parse_obj(obj)

        _obj = NfsExportPolicyRulePatch.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
