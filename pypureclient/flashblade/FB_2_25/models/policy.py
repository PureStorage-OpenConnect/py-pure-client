...
from pypureclient.flashblade.FB_2_25.models.policy_rule import PolicyRule
from pypureclient.flashblade.FB_2_25.models.workload_configuration_fixed_reference import WorkloadConfigurationFixedReference
...
class Policy(BaseModel):
    ...
    __properties = ["id", "name", "realms", "enabled", "is_local", "location", "policy_type", "context", "retention_lock", "rules", "workload"]
    ...
    def from_dict(cls, obj: dict) -> Policy:
        ...
        _obj = Policy.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
